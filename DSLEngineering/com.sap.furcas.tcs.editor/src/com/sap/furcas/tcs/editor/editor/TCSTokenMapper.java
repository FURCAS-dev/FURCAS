...
public class TCSTokenMapper implements ITokenMapper {

    @Override
    public TextAttribute mapColor(Token t) {
        switch (t.getType()) {
        case TCSLexer.COMMENT:
            return new TextAttribute(new Color(null, new RGB(50, 150, 50)),
                    null, SWT.ITALIC);
        case TCSLexer.INT:
        case TCSLexer.FLOAT:
            return new TextAttribute(new Color(null, new RGB(0, 0, 255)), null,
                    SWT.BOLD);
        ...
        case TCSLexer.SEMI:
            return new TextAttribute(new Color(null, new RGB(20, 0, 200)),
                    null, SWT.NONE);
        case TCSLexer.NAME:
            return new TextAttribute(new Color(null, new RGB(0, 0, 0)), null,
                    SWT.NONE);
        case TCSLexer.STRING:
            return new TextAttribute(new Color(null, new RGB(10, 100, 150)),
                    null, SWT.NONE);
        default:
            return new TextAttribute(new Color(null, new RGB(150, 60, 150)),
                    null, SWT.BOLD);
        }
    }
