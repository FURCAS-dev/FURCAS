...
/**
 * to be thrown when syntax definition is invalid. Use for either internal inconsistency
 * (i.e. referenced template does not exist) or for inconsistency to a given metamodel
 * (i.e. class type does not exist)
 * 
 * @author C5107456
 */
public class SyntaxDefValidationException extends SyntaxElementException {
