/**
 * to test the import of the template OCLExpression of OCL.tcs in TCS.tcs 
...
public class TCSImportsOCLTest extends GeneratedParserBasedTest {
	private static final String LANGUAGE = "TCSImportsOCL";
	private static final List<File> LANGUAGE2 = new ArrayList<File>();

	private static final File TCS = ScenarioFixtureData.TCS_IMPORTS_OCL_TCS;
	...
	public static void setupParser() throws Exception {
		...
		for (TCSSyntaxContainerBean tcsSyntaxContainerBean : syntaxBean) {
			if (tcsSyntaxContainerBean.getSyntax().getName()
					.equalsIgnoreCase("TCSImportsOCL")) {
