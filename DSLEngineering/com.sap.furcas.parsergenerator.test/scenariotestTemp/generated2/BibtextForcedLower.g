...
org.antlr.runtime.Token firstToken=input.LT(1);
  ...
  :
  ({_beforeSeqEl();}(({_beforeSeqEl();}( temp=bibtext_bibtextentry {setProperty(ret, "entries", temp);} ( temp=bibtext_bibtextentry {setProperty(ret, "entries", temp);}) ( temp=bibtext_bibtextentry {setProperty(ret, "entries", temp);})+){_afterSeqEl();})){_afterSeqEl();})
  {
