...
org.antlr.runtime.Token firstToken=input.LT(1);
  ...
  :
  ({_beforeSeqEl();}(({_beforeSeqEl();} ({_enterAlt(0);} ({_beforeSeqEl();}( temp=bibtext_bibtextentry_single {setProperty(ret, "entries", temp);}){_afterSeqEl();}){_exitAlt();}  | {_enterAlt(1);} ({_beforeSeqEl();}( temp=bibtext_bibtextentry {setProperty(ret, "entries", temp);} ( temp=bibtext_bibtextentry {setProperty(ret, "entries", temp);})* )? {_afterSeqEl();}){_exitAlt();} )
{_afterSeqEl();})){_afterSeqEl();})
  {
...
bibtext_bibtextentry_single returns[Object ret2]
  :
...
org.antlr.runtime.Token firstToken=input.LT(1);
  ...
  :
  ({_beforeSeqEl();}'article'{_afterSeqEl();}{_beforeSeqEl();} LCURLY {_afterSeqEl();}{_beforeSeqEl();}( temp=identifier {setProperty(ret, "key", temp);}){_afterSeqEl();}{_beforeSeqEl();} COMA {_afterSeqEl();}{_beforeSeqEl();}( temp=identifier {setRef(ret, "author", list("BibText","Author"), "name", temp, null, "never", null, false, null);}){_afterSeqEl();}{_beforeSeqEl();} RCURLY {_afterSeqEl();}{_beforeSeqEl();}';'{_afterSeqEl();})
  {
...
bibtext_article_single returns[Object ret2] @init{List<String> metaType=list("BibText","Article");
onEnterTemplateRule(metaType,"single");
IModelElementProxy ret=(getBacktrackingLevel()==0) ? createModelElementProxy(metaType, false, false) : null;
org.antlr.runtime.Token firstToken=input.LT(1);
}
  :
  ({_beforeSeqEl();}'article'{_afterSeqEl();}{_beforeSeqEl();} LCURLY {_afterSeqEl();}{_beforeSeqEl();}( temp=identifier {setProperty(ret, "key", temp);}){_afterSeqEl();}{_beforeSeqEl();} RCURLY {_afterSeqEl();})
  {
ret2 = commitCreation(ret, firstToken, false);
...
bibtext_author_single returns[Object ret2] @init{List<String> metaType=list("BibText","Author");
onEnterTemplateRule(metaType,"single");
IModelElementProxy ret=(getBacktrackingLevel()==0) ? createModelElementProxy(metaType, false, true) : null;
org.antlr.runtime.Token firstToken=input.LT(1);
}
  :
  ({_beforeSeqEl();}'author'{_afterSeqEl();}{_beforeSeqEl();}'='{_afterSeqEl();}{_beforeSeqEl();}( temp=identifier {setProperty(ret, "name", temp);}){_afterSeqEl();})
  {
ret2 = commitCreation(ret, firstToken, false);
