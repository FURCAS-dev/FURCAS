...
public class EnumerationAutoTest extends GeneratedParserBasedTest {

    private static final String LANGUAGE = "EnumerationFeature";
    private static final File TCS = FixtureData.ENUMAUTO_FEATURE_TCS;
    ...
    public void testEnum() throws Exception {
        ...
        parsingHelper.parseString("FOO", 0);
        parsingHelper.parseString("BAR", 0);
        
        parsingHelper.parseString("foobar", 1);
