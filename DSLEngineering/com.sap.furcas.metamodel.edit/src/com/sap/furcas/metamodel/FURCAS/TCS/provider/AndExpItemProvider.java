...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.TCS.AndExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndExpItemProvider
	 ...
	 */
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TCSPackage.Literals.AND_EXP__EXPRESSIONS);
		}
	 ...
	 */
		...
		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.AND_EXP__EXPRESSIONS,
				 TCSFactory.eINSTANCE.createEqualsExp()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.AND_EXP__EXPRESSIONS,
				 TCSFactory.eINSTANCE.createBooleanPropertyExp()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.AND_EXP__EXPRESSIONS,
				 TCSFactory.eINSTANCE.createIsDefinedExp()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.AND_EXP__EXPRESSIONS,
				 TCSFactory.eINSTANCE.createOneExp()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.AND_EXP__EXPRESSIONS,
				 TCSFactory.eINSTANCE.createInstanceOfExp()));
	}
