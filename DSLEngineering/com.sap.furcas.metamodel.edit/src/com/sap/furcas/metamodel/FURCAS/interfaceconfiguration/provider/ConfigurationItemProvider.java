...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.interfaceconfiguration.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InterfaceconfigurationPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InterfaceconfigurationPackage.Literals.CONFIGURATION__BINDINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Configuration.class)) {
			case InterfaceconfigurationPackage.CONFIGURATION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case InterfaceconfigurationPackage.CONFIGURATION__BINDINGS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InterfaceconfigurationPackage.Literals.CONFIGURATION__BINDINGS,
				 InterfaceconfigurationFactory.eINSTANCE.createBinding()));
	}
