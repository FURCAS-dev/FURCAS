        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Operator_postfix_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Operator_postfix_feature", "_UI_Operator_type"),
                 TCSPackage.Literals.OPERATOR__POSTFIX,
                 true,
                 false,
                 false,
