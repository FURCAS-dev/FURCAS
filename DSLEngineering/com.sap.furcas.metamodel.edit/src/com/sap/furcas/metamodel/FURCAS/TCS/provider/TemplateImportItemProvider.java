...
public class TemplateImportItemProvider
	...
	protected void addModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TemplateImport_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TemplateImport_mode_feature", "_UI_TemplateImport_type"),
				 TCSPackage.Literals.TEMPLATE_IMPORT__MODE,
				 true,
				 false,
				 false,
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TemplateImport.class)) {
