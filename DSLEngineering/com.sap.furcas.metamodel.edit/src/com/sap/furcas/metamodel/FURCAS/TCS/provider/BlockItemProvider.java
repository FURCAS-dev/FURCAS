...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.TCS.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider
	 ...
	 */
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TCSPackage.Literals.BLOCK__BLOCK_SEQUENCE);
			childrenFeatures.add(TCSPackage.Literals.BLOCK__BLOCK_ARGS);
		}
	 ...
	 */
		...
		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.BLOCK__BLOCK_SEQUENCE,
		...
		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.BLOCK__BLOCK_ARGS,
				 TCSFactory.eINSTANCE.createNbNLBArg()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.BLOCK__BLOCK_ARGS,
				 TCSFactory.eINSTANCE.createIndentIncrBArg()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.BLOCK__BLOCK_ARGS,
				 TCSFactory.eINSTANCE.createStartNLBArg()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.BLOCK__BLOCK_ARGS,
				 TCSFactory.eINSTANCE.createStartNbNLBArg()));

		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.BLOCK__BLOCK_ARGS,
				 TCSFactory.eINSTANCE.createEndNLBArg()));
	}
