...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.TCS.AtomExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomExpItemProvider
         ...
         * @generated
         */
        public AtomExpItemProvider(AdapterFactory adapterFactory) {
                ...
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 getResourceLocator(),
                                 getString("_UI_AtomExp_propertyName_feature"),
                                 getString("_UI_PropertyDescriptor_description", "_UI_AtomExp_propertyName_feature", "_UI_AtomExp_type"),
                                 TCSPackage.Literals.ATOM_EXP__PROPERTY_NAME,
                                 true,
                                 false,
                                 false,
        ...
        public String getText(Object object) {
                String label = ((AtomExp)object).getPropertyName();
                return label == null || label.length() == 0 ?
                        getString("_UI_AtomExp_type") :
                        getString("_UI_AtomExp_type") + " " + label;
        }
        ...
        public void notifyChanged(Notification notification) {
                ...
                switch (notification.getFeatureID(AtomExp.class)) {
