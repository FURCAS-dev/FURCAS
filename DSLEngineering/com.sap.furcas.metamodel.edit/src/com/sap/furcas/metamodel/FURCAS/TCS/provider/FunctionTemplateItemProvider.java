...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.TCS.FunctionTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionTemplateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionTemplate_functionName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionTemplate_functionName_feature", "_UI_FunctionTemplate_type"),
				 TCSPackage.Literals.FUNCTION_TEMPLATE__FUNCTION_NAME,
				 true,
				 false,
				 false,
	 ...
	 */
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TCSPackage.Literals.FUNCTION_TEMPLATE__FUNCTION_SEQUENCE);
		}
	 ...
	 */
		...
		String label = ((FunctionTemplate)object).getFunctionName();
	 ...
	 */
		...
		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.FUNCTION_TEMPLATE__FUNCTION_SEQUENCE,
