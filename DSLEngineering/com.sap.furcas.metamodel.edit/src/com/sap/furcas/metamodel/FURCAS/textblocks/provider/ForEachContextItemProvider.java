 ...
 * @generated
 */
public class ForEachContextItemProvider
     ...
     * @generated
     */
        public ForEachContextItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ForEachContext_foreachPedicatePropertyInit_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ForEachContext_foreachPedicatePropertyInit_feature", "_UI_ForEachContext_type"),
                 TextblocksPackage.Literals.FOR_EACH_CONTEXT__FOREACH_PEDICATE_PROPERTY_INIT,
                 true,
                 false,
                 true,
                 null,
     ...
     */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ForEachContext_contextElement_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ForEachContext_contextElement_feature", "_UI_ForEachContext_type"),
                 TextblocksPackage.Literals.FOR_EACH_CONTEXT__CONTEXT_ELEMENT,
                 true,
                 false,
                 true,
                 null,
     ...
     */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ForEachContext_resultModelElement_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ForEachContext_resultModelElement_feature", "_UI_ForEachContext_type"),
                 TextblocksPackage.Literals.FOR_EACH_CONTEXT__RESULT_MODEL_ELEMENT,
                 true,
                 false,
                 true,
                 null,
     ...
     */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ForEachContext_sourceModelElement_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ForEachContext_sourceModelElement_feature", "_UI_ForEachContext_type"),
                 TextblocksPackage.Literals.FOR_EACH_CONTEXT__SOURCE_MODEL_ELEMENT,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addTemplateUsedForProductionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ForEachContext_templateUsedForProduction_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ForEachContext_templateUsedForProduction_feature", "_UI_ForEachContext_type"),
                 TextblocksPackage.Literals.FOR_EACH_CONTEXT__TEMPLATE_USED_FOR_PRODUCTION,
                 true,
                 false,
                 true,
                 null,
     ...
     */
        ...
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ForEachContext"));
    }
