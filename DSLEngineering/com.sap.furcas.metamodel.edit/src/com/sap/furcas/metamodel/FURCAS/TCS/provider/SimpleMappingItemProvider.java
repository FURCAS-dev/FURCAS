...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.TCS.SimpleMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleMapping_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleMapping_key_feature", "_UI_SimpleMapping_type"),
				 TCSPackage.Literals.SIMPLE_MAPPING__KEY,
				 true,
				 false,
				 false,
    ...
    protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleMapping_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleMapping_value_feature", "_UI_SimpleMapping_type"),
				 TCSPackage.Literals.SIMPLE_MAPPING__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
