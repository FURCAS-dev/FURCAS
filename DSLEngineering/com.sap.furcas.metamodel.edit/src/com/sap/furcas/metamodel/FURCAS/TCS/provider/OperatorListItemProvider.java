...
/**
 * This is the item provider adapter for a {@link com.sap.furcas.metamodel.FURCAS.TCS.OperatorList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatorListItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatorList_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatorList_name_feature", "_UI_OperatorList_type"),
				 TCSPackage.Literals.OPERATOR_LIST__NAME,
				 true,
				 false,
				 false,
	 ...
	 */
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TCSPackage.Literals.OPERATOR_LIST__PRIORITIES);
		}
	 ...
	 */
		...
		String label = ((OperatorList)object).getName();
	 ...
	 */
		...
		newChildDescriptors.add
			(createChildParameter
				(TCSPackage.Literals.OPERATOR_LIST__PRIORITIES,
				 TCSFactory.eINSTANCE.createPriority()));
	}
