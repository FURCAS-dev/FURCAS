...
/**
 * This is the item provider adapter for a {@link TCS.OperatorTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addIsContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatorTemplate_isContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatorTemplate_isContext_feature", "_UI_OperatorTemplate_type"),
				 TCSPackage.Literals.OPERATOR_TEMPLATE__IS_CONTEXT,
				 true,
				 false,
				 false,
