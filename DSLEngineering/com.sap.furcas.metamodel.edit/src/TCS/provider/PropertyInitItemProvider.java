...
/**
 * This is the item provider adapter for a {@link TCS.PropertyInit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyInitItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyInit_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyInit_name_feature", "_UI_PropertyInit_type"),
				 TCSPackage.Literals.PROPERTY_INIT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TCSPackage.Literals.PROPERTY_INIT__VALUE);
		}
	...
	public String getText(Object object) {
		String label = ((PropertyInit)object).getName();
