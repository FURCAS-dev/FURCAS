...
/**
 * This is the item provider adapter for a {@link TCS.ClassTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addIsContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassTemplate_isContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassTemplate_isContext_feature", "_UI_ClassTemplate_type"),
				 TCSPackage.Literals.CLASS_TEMPLATE__IS_CONTEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addIsAddToContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassTemplate_isAddToContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassTemplate_isAddToContext_feature", "_UI_ClassTemplate_type"),
				 TCSPackage.Literals.CLASS_TEMPLATE__IS_ADD_TO_CONTEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
