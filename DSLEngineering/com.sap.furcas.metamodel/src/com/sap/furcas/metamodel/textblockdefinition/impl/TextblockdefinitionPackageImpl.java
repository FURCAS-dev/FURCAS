...
public class TextblockdefinitionPackageImpl extends EPackageImpl implements TextblockdefinitionPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTextblockDefinition_DefaultTemplate(), theEcorePackage.getEString(), "defaultTemplate", "", 0, 1, TextblockDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTextblockDefinition_Name(), theEcorePackage.getEString(), "name", null, 0, 1, TextblockDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
