 ...
 * <ul>
 *   <li>{@link com.sap.furcas.metamodel.TCS.impl.CreateInPArgImpl#getPropertyName <em>Property Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CreateInPArgImpl extends PropertyArgImpl implements CreateInPArg {
	...
	public EList<String> getPropertyName() {
		if (propertyName == null) {
			propertyName = new EDataTypeEList<String>(String.class, this, TCSPackage.CREATE_IN_PARG__PROPERTY_NAME);
		}
		return propertyName;
	}
