...
public class TCSFactoryImpl extends EFactoryImpl implements TCSFactory {
	 ...
	 */
		...
		switch (eClass.getClassifierID()) {
			...
			case TCSPackage.CONCRETE_SYNTAX_IMPORT: return createConcreteSyntaxImport();
			case TCSPackage.TEMPLATE_IMPORT: return createTemplateImport();
			case TCSPackage.REQUIRED_INTERFACE_TEMPLATE: return createRequiredInterfaceTemplate();
			default:
	 ...
	 */
		...
		switch (eDataType.getClassifierID()) {
			...
			case TCSPackage.VISIBILITY_ENUM:
	 ...
	 * @generated
	 */
    public ConcreteSyntaxImport createConcreteSyntaxImport() {
		ConcreteSyntaxImportImpl concreteSyntaxImport = new ConcreteSyntaxImportImpl();
		return concreteSyntaxImport;
	}
	 ...
	 * @generated
	 */
    public TemplateImport createTemplateImport() {
		TemplateImportImpl templateImport = new TemplateImportImpl();
	 ...
	 * @generated
	 */
	public RequiredInterfaceTemplate createRequiredInterfaceTemplate() {
		RequiredInterfaceTemplateImpl requiredInterfaceTemplate = new RequiredInterfaceTemplateImpl();
		return requiredInterfaceTemplate;
	}
