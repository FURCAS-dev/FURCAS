...
public class TCSSwitch<T> {
	 ...
	 */
		...
		switch (classifierID) {
			...
			case TCSPackage.IMPORT_DECLARATION: {
				ImportDeclaration importDeclaration = (ImportDeclaration)theEObject;
				T result = caseImportDeclaration(importDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TCSPackage.CONCRETE_SYNTAX_IMPORT: {
				ConcreteSyntaxImport concreteSyntaxImport = (ConcreteSyntaxImport)theEObject;
				T result = caseConcreteSyntaxImport(concreteSyntaxImport);
				if (result == null) result = caseImportDeclaration(concreteSyntaxImport);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TCSPackage.TEMPLATE_IMPORT: {
				TemplateImport templateImport = (TemplateImport)theEObject;
				T result = caseTemplateImport(templateImport);
				if (result == null) result = caseImportDeclaration(templateImport);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TCSPackage.REQUIRED_INTERFACE_TEMPLATE: {
				RequiredInterfaceTemplate requiredInterfaceTemplate = (RequiredInterfaceTemplate)theEObject;
				T result = caseRequiredInterfaceTemplate(requiredInterfaceTemplate);
				if (result == null) result = caseTemplate(requiredInterfaceTemplate);
				if (result == null) result = caseQualifiedNamedElement(requiredInterfaceTemplate);
				if (result == null) result = caseLocatedElement(requiredInterfaceTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
    ...
    public T caseImportDeclaration(ImportDeclaration object) {
        ...
        /**
	 * Returns the result of interpreting the object as an instance of '<em>Concrete Syntax Import</em>'.
	 * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Concrete Syntax Import</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
    public T caseConcreteSyntaxImport(ConcreteSyntaxImport object) {
		return null;
	}

        /**
	 * Returns the result of interpreting the object as an instance of '<em>Template Import</em>'.
	 * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Template Import</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
    public T caseTemplateImport(TemplateImport object) {
		return null;
	}

        /**
	 * Returns the result of interpreting the object as an instance of '<em>Required Interface Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Required Interface Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRequiredInterfaceTemplate(RequiredInterfaceTemplate object) {
		return null;
	}
