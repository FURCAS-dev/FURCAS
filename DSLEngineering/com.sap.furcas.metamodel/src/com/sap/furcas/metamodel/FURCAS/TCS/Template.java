 ...
 *   <li>{@link com.sap.furcas.metamodel.FURCAS.TCS.Template#getTemplateVisibility <em>Template Visibility</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Template extends QualifiedNamedElement {
	...
	void setTextBlockDefinition(TextBlockDefinition value);
                                ...
                                /**
	 * Returns the value of the '<em><b>Template Visibility</b></em>' attribute.
	 * The literals are from the enumeration {@link com.sap.furcas.metamodel.FURCAS.TCS.VisibilityEnum}.
	 * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Template Visibility</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
	 * @return the value of the '<em>Template Visibility</em>' attribute.
	 * @see com.sap.furcas.metamodel.FURCAS.TCS.VisibilityEnum
	 * @see #setTemplateVisibility(VisibilityEnum)
	 * @see com.sap.furcas.metamodel.FURCAS.TCS.TCSPackage#getTemplate_TemplateVisibility()
	 * @model
	 * @generated
	 */
    VisibilityEnum getTemplateVisibility();

                                /**
	 * Sets the value of the '{@link com.sap.furcas.metamodel.FURCAS.TCS.Template#getTemplateVisibility <em>Template Visibility</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Template Visibility</em>' attribute.
	 * @see com.sap.furcas.metamodel.FURCAS.TCS.VisibilityEnum
	 * @see #getTemplateVisibility()
	 * @generated
	 */
	void setTemplateVisibility(VisibilityEnum value);
