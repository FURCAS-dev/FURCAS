...
public class TCSAdapterFactory extends AdapterFactoryImpl {
	 ...
	 */
        protected TCSSwitch<Adapter> modelSwitch =
			...
			@Override
			public Adapter caseConcreteSyntaxImport(ConcreteSyntaxImport object) {
				return createConcreteSyntaxImportAdapter();
			}
			@Override
			public Adapter caseTemplateImport(TemplateImport object) {
				return createTemplateImportAdapter();
			}
			@Override
			public Adapter caseRequiredInterfaceTemplate(RequiredInterfaceTemplate object) {
				return createRequiredInterfaceTemplateAdapter();
			}
			@Override
	 ...
	 */
        ...
        /**
	 * Creates a new adapter for an object of class '{@link com.sap.furcas.metamodel.FURCAS.TCS.ImportDeclaration <em>Import Declaration</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    public Adapter createImportDeclarationAdapter() {
        ...
        /**
	 * Creates a new adapter for an object of class '{@link com.sap.furcas.metamodel.FURCAS.TCS.ConcreteSyntaxImport <em>Concrete Syntax Import</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    public Adapter createConcreteSyntaxImportAdapter() {
        ...
        /**
	 * Creates a new adapter for an object of class '{@link com.sap.furcas.metamodel.FURCAS.TCS.TemplateImport <em>Template Import</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    public Adapter createTemplateImportAdapter() {
        ...
        /**
	 * Creates a new adapter for an object of class '{@link com.sap.furcas.metamodel.FURCAS.TCS.RequiredInterfaceTemplate <em>Required Interface Template</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
