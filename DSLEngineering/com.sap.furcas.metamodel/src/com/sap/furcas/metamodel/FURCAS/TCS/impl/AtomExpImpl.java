...
public abstract class AtomExpImpl extends LocatedElementImpl implements AtomExp {
    ...
    public NotificationChain basicSetPropertyReference(PropertyReference newPropertyReference, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TCSPackage.ATOM_EXP__PROPERTY_REFERENCE, oldPropertyReference, newPropertyReference);
     ...
     */
        ...
        if (newPropertyReference != propertyReference) {
            ...
            if (propertyReference != null)
                msgs = ((InternalEObject)propertyReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TCSPackage.ATOM_EXP__PROPERTY_REFERENCE, null, msgs);
            if (newPropertyReference != null)
                msgs = ((InternalEObject)newPropertyReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TCSPackage.ATOM_EXP__PROPERTY_REFERENCE, null, msgs);
