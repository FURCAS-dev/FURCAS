...
public class TextblockdefinitionPackageImpl extends EPackageImpl implements TextblockdefinitionPackage {
	 ...
	 */
		...
		initEReference(getTextBlockDefinition_ParseRule(), theTCSPackage.getTemplate(), theTCSPackage.getTemplate_TextBlockDefinition(), "parseRule", null, 0, 1, TextBlockDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEmofAnnotations() {
		...
		addAnnotation
		  (getTextBlockDefinition_ParseRule(), 
		   source, 
		   new String[] {
			 "Property.oppositeRoleName", "textBlockDefinition"
		   });
	}
