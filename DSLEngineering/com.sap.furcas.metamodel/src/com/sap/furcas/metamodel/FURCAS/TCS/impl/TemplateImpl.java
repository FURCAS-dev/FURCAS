 ...
 *   <li>{@link com.sap.furcas.metamodel.FURCAS.TCS.impl.TemplateImpl#getTemplateVisibility <em>Template Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TemplateImpl extends QualifiedNamedElementImpl implements Template {
	...
	protected TextBlockDefinition textBlockDefinition;
								...
								/**
	 * The default value of the '{@link #getTemplateVisibility() <em>Template Visibility</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see #getTemplateVisibility()
	 * @generated
	 * @ordered
	 */
    protected static final VisibilityEnum TEMPLATE_VISIBILITY_EDEFAULT = VisibilityEnum.PRIVATE;

                                /**
	 * The cached value of the '{@link #getTemplateVisibility() <em>Template Visibility</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see #getTemplateVisibility()
	 * @generated
	 * @ordered
	 */
    protected VisibilityEnum templateVisibility = TEMPLATE_VISIBILITY_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setTemplateVisibility(VisibilityEnum newTemplateVisibility) {
		VisibilityEnum oldTemplateVisibility = templateVisibility;
		templateVisibility = newTemplateVisibility == null ? TEMPLATE_VISIBILITY_EDEFAULT : newTemplateVisibility;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY, oldTemplateVisibility, templateVisibility));
	}
	 ...
	 */
		...
		switch (featureID) {
			...
			case TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY:
				return getTemplateVisibility();
		}
	 ...
	 */
		...
		switch (featureID) {
			...
			case TCSPackage.TEMPLATE__TEXT_BLOCK_DEFINITION:
				...
				return;
			case TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY:
				setTemplateVisibility((VisibilityEnum)newValue);
				return;
		}
	 ...
	 */
		...
		switch (featureID) {
			...
			case TCSPackage.TEMPLATE__TEXT_BLOCK_DEFINITION:
				...
				return;
			case TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY:
				setTemplateVisibility(TEMPLATE_VISIBILITY_EDEFAULT);
				return;
		}
	 ...
	 */
		...
		switch (featureID) {
			...
			case TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY:
				return templateVisibility != TEMPLATE_VISIBILITY_EDEFAULT;
		}
	 ...
	 */
		...
		result.append(semDisambiguate);
		result.append(", templateVisibility: ");
		result.append(templateVisibility);
		result.append(')');
