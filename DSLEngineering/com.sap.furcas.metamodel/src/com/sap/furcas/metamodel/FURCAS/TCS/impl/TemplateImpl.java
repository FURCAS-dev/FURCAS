...
public abstract class TemplateImpl extends QualifiedNamedElementImpl implements Template {
     ...
     * @ordered
     */
    protected static final String TEMPLATE_VISIBILITY_EDEFAULT = null;
     ...
     * @ordered
     */
    protected String templateVisibility = TEMPLATE_VISIBILITY_EDEFAULT;
     ...
     * @generated
     */
    public void setTemplateVisibility(String newTemplateVisibility) {
        String oldTemplateVisibility = templateVisibility;
        templateVisibility = newTemplateVisibility;
        if (eNotificationRequired())
     ...
     */
        ...
        switch (featureID) {
            ...
            case TCSPackage.TEMPLATE__TEXT_BLOCK_DEFINITION:
                ...
                return;
            case TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY:
                setTemplateVisibility((String)newValue);
                return;
        }
     ...
     */
        ...
        switch (featureID) {
            ...
            case TCSPackage.TEMPLATE__TEMPLATE_VISIBILITY:
                return TEMPLATE_VISIBILITY_EDEFAULT == null ? templateVisibility != null : !TEMPLATE_VISIBILITY_EDEFAULT.equals(templateVisibility);
        }
