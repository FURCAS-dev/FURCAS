...
public class TCSPackageImpl extends EPackageImpl implements TCSPackage {
	 ...
	 * @generated
	 */
	public EAttribute getPropertyReference_IsOppositeEnd() {
		return (EAttribute)propertyReferenceEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
		...
		createEAttribute(propertyReferenceEClass, PROPERTY_REFERENCE__IS_OPPOSITE_END);
	 ...
	 */
		...
		initEAttribute(getPropertyReference_IsOppositeEnd(), ecorePackage.getEBoolean(), "isOppositeEnd", "false", 1, 1, PropertyReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
