 ...
 * <ul>
 *   <li>{@link TCS.Operator#isIsPostfix <em>Is Postfix</em>}</li>
 *   <li>{@link TCS.Operator#getArity <em>Arity</em>}</li>
 *   <li>{@link TCS.Operator#getLiteral <em>Literal</em>}</li>
 *   <li>{@link TCS.Operator#getPriority <em>Priority</em>}</li>
 *   <li>{@link TCS.Operator#getTemplates <em>Templates</em>}</li>
 * </ul>
 * </p>
 *
 * @see TCS.TCSPackage#getOperator()
 * @model
 * @generated
 */
public interface Operator extends NamedElement {
	 ...
	 * @see TCS.TCSPackage#getOperator_IsPostfix()
	...
	/**
	 * Sets the value of the '{@link TCS.Operator#isIsPostfix <em>Is Postfix</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setArity(int)
	 * @see TCS.TCSPackage#getOperator_Arity()
	 * @model unique="false" required="true" ordered="false"
	 * @generated
	 */
	int getArity();
	...
	/**
	 * Sets the value of the '{@link TCS.Operator#getArity <em>Arity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link TCS.Literal#getOperators <em>Operators</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see TCS.TCSPackage#getOperator_Literal()
	...
	/**
	 * Sets the value of the '{@link TCS.Operator#getLiteral <em>Literal</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link TCS.Priority#getOperators <em>Operators</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see TCS.TCSPackage#getOperator_Priority()
	...
	/**
	 * Sets the value of the '{@link TCS.Operator#getPriority <em>Priority</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link TCS.OperatorTemplate}.
	 * It is bidirectional and its opposite is '{@link TCS.OperatorTemplate#getOperators <em>Operators</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see TCS.TCSPackage#getOperator_Templates()
