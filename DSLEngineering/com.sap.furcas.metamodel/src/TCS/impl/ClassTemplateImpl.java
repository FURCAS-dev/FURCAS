 ...
 * <ul>
 *   <li>{@link TCS.impl.ClassTemplateImpl#getTemplateSequence <em>Template Sequence</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsDeep <em>Is Deep</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#getPrefixSequence <em>Prefix Sequence</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsOperatored <em>Is Operatored</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#getOperatorList <em>Operator List</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsMain <em>Is Main</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsMulti <em>Is Multi</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsContext <em>Is Context</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsAddToContext <em>Is Add To Context</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#isIsNonPrimary <em>Is Non Primary</em>}</li>
 *   <li>{@link TCS.impl.ClassTemplateImpl#getMode <em>Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassTemplateImpl extends TemplateImpl implements ClassTemplate {
	/**
	...
	public void setIsContext(boolean newIsContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TCSPackage.CLASS_TEMPLATE__IS_CONTEXT, oldIsContext, isContext));
	}
	...
	public void setIsAddToContext(boolean newIsAddToContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TCSPackage.CLASS_TEMPLATE__IS_ADD_TO_CONTEXT, oldIsAddToContext, isAddToContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TCSPackage.CLASS_TEMPLATE__IS_MULTI:
				return isIsMulti();
			case TCSPackage.CLASS_TEMPLATE__IS_CONTEXT:
				return isIsContext();
			case TCSPackage.CLASS_TEMPLATE__IS_ADD_TO_CONTEXT:
