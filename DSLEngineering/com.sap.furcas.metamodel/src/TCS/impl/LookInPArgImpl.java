 ...
 * <ul>
 *   <li>{@link TCS.impl.LookInPArgImpl#getPropertyName <em>Property Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LookInPArgImpl extends PropertyArgImpl implements LookInPArg {
	...
	public EList<String> getPropertyName() {
		if (propertyName == null) {
			propertyName = new EDataTypeEList<String>(String.class, this, TCSPackage.LOOK_IN_PARG__PROPERTY_NAME);
		}
		return propertyName;
	}
