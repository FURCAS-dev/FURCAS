 ...
 * <ul>
 *   <li>{@link TCS.impl.CreateAsPArgImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CreateAsPArgImpl extends PropertyArgImpl implements CreateAsPArg {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TCSPackage.CREATE_AS_PARG__NAME, oldName, name));
	}
