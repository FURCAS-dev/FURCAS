 ...
 * <ul>
 *   <li>{@link TCS.impl.PrimitiveTemplateImpl#getTemplateName <em>Template Name</em>}</li>
 *   <li>{@link TCS.impl.PrimitiveTemplateImpl#isIsDefault <em>Is Default</em>}</li>
 *   <li>{@link TCS.impl.PrimitiveTemplateImpl#getTokenName <em>Token Name</em>}</li>
 *   <li>{@link TCS.impl.PrimitiveTemplateImpl#getValue <em>Value</em>}</li>
 *   <li>{@link TCS.impl.PrimitiveTemplateImpl#getSerializer <em>Serializer</em>}</li>
 *   <li>{@link TCS.impl.PrimitiveTemplateImpl#isOrKeyword <em>Or Keyword</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
