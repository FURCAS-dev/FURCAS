 ...
 * <ul>
 *   <li>{@link TCS.impl.SequenceImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getTemplateContainer <em>Template Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getPrefixContainer <em>Prefix Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getFunctionContainer <em>Function Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getBlockContainer <em>Block Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getThenContainer <em>Then Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getElseContainer <em>Else Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getSeparatorContainer <em>Separator Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getOtContainer <em>Ot Container</em>}</li>
 *   <li>{@link TCS.impl.SequenceImpl#getAlternativeContainer <em>Alternative Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
