...
public interface Constants {
	...
	/** extention for files which the builder will attempt to handle when changed. */
	...
	/** used to configure a project to use a certain way of referring to a metamodel. */
    ...
    String DSL_SYNTAX_ERROR_MARKER_TYPE = 
        Activator.class.getPackage().getName() + ".dslProblem";
}
