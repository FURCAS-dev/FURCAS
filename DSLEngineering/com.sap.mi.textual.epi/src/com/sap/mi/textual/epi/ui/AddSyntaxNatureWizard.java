...
public class AddSyntaxNatureWizard extends org.eclipse.jface.wizard.Wizard {
	...
	public void addPages()	{
		ReferenceMetaModelSelectionWizardPage page2 = new ReferenceMetaModelSelectionWizardPage(
                Messages.AddNatureWizardTitle, myTargetProject);
        addPage(page2);
	}
	...
	private class ReferenceMetaModelSelectionWizardPage extends WizardPage implements IWizardPage {
		 ...
		 * @param targetProject the target project
		 */
		public ReferenceMetaModelSelectionWizardPage(String pageName,
