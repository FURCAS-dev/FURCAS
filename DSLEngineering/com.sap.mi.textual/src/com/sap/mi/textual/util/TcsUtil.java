package com.sap.mi.textual.util;
...
//	 * resolve the subElement Property and then the property "name" of the type
//	 * of this property.
//	 * 
//	 * @param <Type>
//	 * @param prop
...
//	 */
//	 public static <Type> ResolvedNameAndReferenceBean<Type> getReferencedTypeWithNavigation(SequenceElement prop, 
//			 	ResolvedNameAndReferenceBean<Type> metaModelTypeOfPropertyReference, String name,
...
//			 ResolvedNameAndReferenceBean<Type> navigationStep = metaModelTypeOfPropertyReference;
//			 for (int i = 0; i < navigation.length-1; i++) {
//				 navigationStep = metaLookup.getFeatureClassReference(navigationStep , navigation[i]);	 
//			}
//			return navigationStep;
//		 } else {
//			 return metaLookup.getFeatureClassReference(metaModelTypeOfPropertyReference , name);
//		 }
//		 
//	 }
	 /**
     * util method that looks up the type of a referenced object, and also considers the context
    ...
    public static <Type> ResolvedNameAndReferenceBean<Type> getReferencedType(SequenceElement prop,
        ...
        if (substitutePropertyType != null ) {
            // check in Metamodel that new ownername is subclass of previous one, else error
