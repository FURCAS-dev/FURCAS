 ...
 * and makes all elements available through protected members. This Variant 
 * sets up a fixture having gaps between the tokens.
 * 
 * @author D052602
 * 
 */
public class UtilFixtureBaseWithGaps extends TextBlockTest {
	...
	private void initFixtureStructure() {
	    ...
	    // blanks are merely represented by distance between tokens, no blank tokens are being used
	    // TextBlock Tree =
		// main
		// - bos
