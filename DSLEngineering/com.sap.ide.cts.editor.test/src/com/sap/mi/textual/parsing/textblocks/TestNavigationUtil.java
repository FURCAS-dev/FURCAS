 ...
 * 
 */
public class TestNavigationUtil extends UtilFixtureBase {
	...
	public void testGetSubNodes() {
		...
		assertEquals(expectedNodesFromRight, TbNavigationUtil
				.getSubNodes(right));
	}
	...
	public void testGetSubNodesBug() {
		...
		parent.getTokens().add(t);
		parent.getSubBlocks().add(tb);

		expectedNodes.add(t);
		expectedNodes.add(tb);

		assertEquals(expectedNodes, TbNavigationUtil.getSubNodes(parent));
	}
	...
	public void testReplaceSubTree() {
		...
		middleNew.getTokens().add(lexed3New);
		...
		assertEquals(null, middle.getParentBlock());
		assertEquals(main, middleNew.getParentBlock());
		assertEquals(middleNew, lexed3New.getParentBlock());
	}
