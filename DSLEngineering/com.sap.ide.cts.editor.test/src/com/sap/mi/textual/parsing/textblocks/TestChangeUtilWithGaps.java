 ...
 * 
 */
public class TestChangeUtilWithGaps extends UtilFixtureBaseWithGaps {
	...
	@Test
	@Ignore // implementation TbUtil.replaceTokenContents to be changed not to support gaps anyways.
