...
public class StubModelAdapter implements IModelAdapter, IBareModelAdapter {
     ...
     * 
     * @see
     * com.sap.mi.textual.grammar.IModelAdapter#createOrResolveElement(java.
     * util.List, java.util.Map,
     * com.sap.mi.textual.grammar.antlr3.ANTLR3LocationToken,
     * com.sap.mi.textual.grammar.antlr3.ANTLR3LocationToken, boolean, boolean)
     */
    @Override
