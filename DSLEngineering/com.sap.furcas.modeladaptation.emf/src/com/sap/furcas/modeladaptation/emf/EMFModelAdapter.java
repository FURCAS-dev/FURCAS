 ...
 * arguments led to them being thrown.
 * 
 */
public class EMFModelAdapter implements IBareModelAdapter {
    ...
    /**
     * Creates a new ModelAdapter which creates MOIN ModelElements. The
     * referenceScope will implicitly include the URI of the root element and
     * the visible URIs of the ResourceSet.
     * 
     * @param root
     ...
     */
    public EMFModelAdapter(EPackage root, final ResourceSet ResourceSet,
	...
	delegate = new EMFModelAdapterDelegate(root, ResourceSet, referenceScope, additionalURIScope);
     ...
     * 
     * @see
     * com.sap.mi.textual.grammar.IModelAdapter#createEnumLiteral(java.util.
     ...
     * (non-Javadoc)
     * 
     * @see com.sap.mi.textual.grammar.IModelAdapter#getString(java.lang.Object,
     * java.lang.String)
     */
    @Deprecated
    public String getString(Object modelElement, String propertyName) throws ModelAdapterException {
	if (modelElement == null || propertyName == null) {
	    throw new IllegalArgumentException("One of the following was null: " + modelElement + "," + propertyName);
	}
	...
	if (modelElement instanceof EObject) {
		...
		throw new RuntimeException("Exception while getting String property " + getCutToString(modelElement) + "."
			+ propertyName, re);
	    }
	} else {
	    throw new IllegalArgumentException("Unknown Model Element type " + modelElement.getClass());
    ...
    /**
     * Sets within context of an element, if not null, contextElement must be a
     * subtype of type MOF::Namespace (thus containing other modelElements)
     * 
     * @see com.sap.furcas.runtime.parser.IModelAdapter#setWithinContextObject(java.lang.Object,
    ...
    /**
     * Checks if <tt>o</tt>'s Java type qualifies as a primitive type in MOF. In
     * particular, those types are {@link Boolean}, {@link String},
     * {@link Float}, {@link Long}, {@link Integer} and {@link Double}.
     */
