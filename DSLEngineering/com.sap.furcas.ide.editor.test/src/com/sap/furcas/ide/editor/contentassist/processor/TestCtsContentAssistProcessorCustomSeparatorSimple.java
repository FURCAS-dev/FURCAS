...
public class TestCtsContentAssistProcessorCustomSeparatorSimple extends CtsContentAssistProcessorEditorTestMetamodelTestBase {

    @BeforeClass
    public static void generateParser() throws Exception {
        initMetamodelTestbase("CustomSeparator");
    }
