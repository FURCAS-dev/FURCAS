 ...
 */
public interface OmittedToken extends textblocks.AbstractToken {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, textblocks.OmittedToken> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, textblocks.OmittedToken>("480716BCBE2DC5430C5F11DD998800016CE99C52", "demo.sap.com/tcsmeta", "textblocks", "OmittedToken"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
