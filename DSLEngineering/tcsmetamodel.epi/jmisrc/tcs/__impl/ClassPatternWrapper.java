...
public class ClassPatternWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.ClassPatternImpl> implements tcs.ClassPattern,com.sap.tc.moin.repository.Partitionable {
    ...
    public ClassPatternWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.ClassPatternImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.ClassPatternImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.ClassPatternImpl) resolved;
    }
    
    public tcs.__impl.ClassPatternImpl unwrap() {
        return (tcs.__impl.ClassPatternImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "tcs.ClassPattern (Java Type)\nTCS.ClassPattern (MOF Type)"; //$NON-NLS-1$
    }    
}