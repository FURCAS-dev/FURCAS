...
public class BooleanPropertyExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.BooleanPropertyExpImpl> implements tcs.BooleanPropertyExp,com.sap.tc.moin.repository.Partitionable {
    ...
    public BooleanPropertyExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.BooleanPropertyExpImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.BooleanPropertyExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.BooleanPropertyExpImpl) resolved;
    }
    
    public tcs.__impl.BooleanPropertyExpImpl unwrap() {
        return (tcs.__impl.BooleanPropertyExpImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "tcs.BooleanPropertyExp (Java Type)\nTCS.BooleanPropertyExp (MOF Type)"; //$NON-NLS-1$
    }    
}