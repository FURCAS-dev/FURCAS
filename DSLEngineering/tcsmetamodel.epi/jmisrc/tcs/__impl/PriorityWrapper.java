...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    public PriorityWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.PriorityImpl baseObject, boolean synchronize) {
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    private tcs.__impl.PriorityImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.PriorityImpl) resolved;
    }
    
    public tcs.__impl.PriorityImpl unwrap() {
        return (tcs.__impl.PriorityImpl) getWrappedObject();
    }
    ...
    public tcs.Associativity getAssociativity() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getAssociativity();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getAssociativity();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setAssociativity(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<tcs.Operator>) wrapResult(getCastWrappedObject().getOperators(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    protected String metaObjectToString() {
        return "tcs.Priority (Java Type)\nTCS.Priority (MOF Type)"; //$NON-NLS-1$
    }    
}