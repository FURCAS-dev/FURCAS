...
public class SymbolWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.SymbolImpl> implements tcs.Symbol,com.sap.tc.moin.repository.Partitionable {
    ...
    public SymbolWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.SymbolImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.SymbolImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.SymbolImpl) resolved;
    }
    
    public tcs.__impl.SymbolImpl unwrap() {
        return (tcs.__impl.SymbolImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<tcs.SpaceKind>) wrapResult(getCastWrappedObject().getSpaces(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "tcs.Symbol (Java Type)\nTCS.Symbol (MOF Type)"; //$NON-NLS-1$
    }    
}