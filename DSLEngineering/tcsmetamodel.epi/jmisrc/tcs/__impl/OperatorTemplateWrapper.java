...
public class OperatorTemplateWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.OperatorTemplateImpl> implements tcs.OperatorTemplate,com.sap.tc.moin.repository.Partitionable {
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    public OperatorTemplateWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.OperatorTemplateImpl baseObject, boolean synchronize) {
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    private tcs.__impl.OperatorTemplateImpl getCastWrappedObject() {
        return (tcs.__impl.OperatorTemplateImpl) getWrappedObject();
    }
    
    private tcs.__impl.OperatorTemplateImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.OperatorTemplateImpl) resolved;
    }
    
    public tcs.__impl.OperatorTemplateImpl unwrap() {
        return (tcs.__impl.OperatorTemplateImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (tcs.Sequence) wrapResult(getCastWrappedObject().getOtSequence(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setOtSequence(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<tcs.Operator>) wrapResult(getCastWrappedObject().getOperators(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (tcs.PropertyReference) wrapResult(getCastWrappedObject().getStoreOperatorTo(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setStoreOperatorTo(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (tcs.PropertyReference) wrapResult(getCastWrappedObject().getStoreRightSideTo(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setStoreRightSideTo(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (tcs.PropertyReference) wrapResult(getCastWrappedObject().getStoreLeftSideTo(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setStoreLeftSideTo(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    protected String metaObjectToString() {
        return "tcs.OperatorTemplate (Java Type)\nTCS.OperatorTemplate (MOF Type)"; //$NON-NLS-1$
    }    
}