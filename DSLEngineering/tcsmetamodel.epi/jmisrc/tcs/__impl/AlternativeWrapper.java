...
public class AlternativeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.AlternativeImpl> implements tcs.Alternative,com.sap.tc.moin.repository.Partitionable {
    ...
    public AlternativeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.AlternativeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private tcs.__impl.AlternativeImpl getCastWrappedObject() {
        return (tcs.__impl.AlternativeImpl) getWrappedObject();
    }
    
    private tcs.__impl.AlternativeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.AlternativeImpl) resolved;
    }
    
    public tcs.__impl.AlternativeImpl unwrap() {
        return (tcs.__impl.AlternativeImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<tcs.SequenceInAlternative>) wrapResult(getCastWrappedObject().getSequences(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "tcs.Alternative (Java Type)\nTCS.Alternative (MOF Type)"; //$NON-NLS-1$
    }    
}