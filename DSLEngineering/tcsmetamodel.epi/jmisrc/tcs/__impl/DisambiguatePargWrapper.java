...
public class DisambiguatePargWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.DisambiguatePargImpl> implements tcs.DisambiguateParg,com.sap.tc.moin.repository.Partitionable {
    ...
    public DisambiguatePargWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.DisambiguatePargImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.DisambiguatePargImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.DisambiguatePargImpl) resolved;
    }
    
    public tcs.__impl.DisambiguatePargImpl unwrap() {
        return (tcs.__impl.DisambiguatePargImpl) getWrappedObject();
    }
    ...
    public java.lang.String getDisambiguation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getDisambiguation();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getDisambiguation();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDisambiguation(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "tcs.DisambiguateParg (Java Type)\nTCS.DisambiguatePArg (MOF Type)"; //$NON-NLS-1$
    }    
}