...
public class FilterPargWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.FilterPargImpl> implements tcs.FilterParg,com.sap.tc.moin.repository.Partitionable {
    ...
    public FilterPargWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.FilterPargImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.FilterPargImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.FilterPargImpl) resolved;
    }
    
    public tcs.__impl.FilterPargImpl unwrap() {
        return (tcs.__impl.FilterPargImpl) getWrappedObject();
    }
    ...
    public java.lang.String getFilter() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getFilter();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getFilter();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setFilter(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.String getInvert() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getInvert();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getInvert();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setInvert(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "tcs.FilterParg (Java Type)\nTCS.FilterPArg (MOF Type)"; //$NON-NLS-1$
    }    
}