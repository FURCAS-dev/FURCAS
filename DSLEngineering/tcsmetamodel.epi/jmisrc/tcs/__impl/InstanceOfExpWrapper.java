...
public class InstanceOfExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.InstanceOfExpImpl> implements tcs.InstanceOfExp,com.sap.tc.moin.repository.Partitionable {
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    public InstanceOfExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.InstanceOfExpImpl baseObject, boolean synchronize) {
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    private tcs.__impl.InstanceOfExpImpl getCastWrappedObject() {
        return (tcs.__impl.InstanceOfExpImpl) getWrappedObject();
    }
    
    private tcs.__impl.InstanceOfExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.InstanceOfExpImpl) resolved;
    }
    
    public tcs.__impl.InstanceOfExpImpl unwrap() {
        return (tcs.__impl.InstanceOfExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<java.lang.String>) wrapResult(getCastWrappedObject().getSupertype(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
...
>>>>>>> e04eb9c33a214a29f23acac04720aff53a6082b7
    ...
    protected String metaObjectToString() {
        return "tcs.InstanceOfExp (Java Type)\nTCS.InstanceOfExp (MOF Type)"; //$NON-NLS-1$
    }    
}