...
public class EnumLiteralValWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.EnumLiteralValImpl> implements tcs.EnumLiteralVal,com.sap.tc.moin.repository.Partitionable {
    ...
    public EnumLiteralValWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.EnumLiteralValImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.EnumLiteralValImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.EnumLiteralValImpl) resolved;
    }
    
    public tcs.__impl.EnumLiteralValImpl unwrap() {
        return (tcs.__impl.EnumLiteralValImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "tcs.EnumLiteralVal (Java Type)\nTCS.EnumLiteralVal (MOF Type)"; //$NON-NLS-1$
    }    
}