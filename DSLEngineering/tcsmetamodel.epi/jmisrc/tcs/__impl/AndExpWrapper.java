...
public class AndExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.AndExpImpl> implements tcs.AndExp,com.sap.tc.moin.repository.Partitionable {
    ...
    public AndExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.AndExpImpl baseObject, boolean synchronize) {
    ...
    private tcs.__impl.AndExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.AndExpImpl) resolved;
    }
    
    public tcs.__impl.AndExpImpl unwrap() {
        return (tcs.__impl.AndExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<tcs.AtomExp>) wrapResult(getCastWrappedObject().getExpressions(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "tcs.AndExp (Java Type)\nTCS.AndExp (MOF Type)"; //$NON-NLS-1$
    }    
}