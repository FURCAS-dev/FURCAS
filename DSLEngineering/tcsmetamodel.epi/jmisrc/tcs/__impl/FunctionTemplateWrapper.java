...
public class FunctionTemplateWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<tcs.__impl.FunctionTemplateImpl> implements tcs.FunctionTemplate,com.sap.tc.moin.repository.Partitionable {
    ...
    public FunctionTemplateWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, tcs.__impl.FunctionTemplateImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private tcs.__impl.FunctionTemplateImpl getCastWrappedObject() {
        return (tcs.__impl.FunctionTemplateImpl) getWrappedObject();
    }
    
    private tcs.__impl.FunctionTemplateImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (tcs.__impl.FunctionTemplateImpl) resolved;
    }
    
    public tcs.__impl.FunctionTemplateImpl unwrap() {
        return (tcs.__impl.FunctionTemplateImpl) getWrappedObject();
    }
    ...
    public java.lang.String getFunctionName() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getFunctionName();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getFunctionName();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setFunctionName(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (tcs.Sequence) wrapResult(getCastWrappedObject().getFunctionSequence(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setFunctionSequence(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "tcs.FunctionTemplate (Java Type)\nTCS.FunctionTemplate (MOF Type)"; //$NON-NLS-1$
    }    
}