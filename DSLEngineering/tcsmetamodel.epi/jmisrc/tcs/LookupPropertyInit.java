 ...
 */
public interface LookupPropertyInit extends tcs.PropertyInit {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, tcs.LookupPropertyInit> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, tcs.LookupPropertyInit>("49257B29BCF35C30B71311DD84A600016CE99C52", "demo.sap.com/tcsmeta", "TCS", "LookupPropertyInit"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
