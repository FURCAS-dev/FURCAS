...
public class CtsDocumentProvider extends AbstractDocumentProvider {
    ...
    public CtsDocumentProvider(
            FurcasDocumentSetupParticpant documentSetupParticipant,
    ...
    public void doSaveDocument(IProgressMonitor monitor, Object element,
        ...
        if (element instanceof ModelEditorInput) {
            ModelEditorInput mei = (ModelEditorInput) element;
            ElementInfo info = getElementInfo(mei);
            try {
                CtsDocument ctsDocument = ((CtsDocument) info.fDocument);
                if (TbVersionUtil.getOtherVersion(ctsDocument.getRootBlock(),
    ...
    protected void disposeElementInfo(Object element, ElementInfo info) {
        if (element instanceof ModelEditorInput) {
            CtsDocument ctsDocument = ((CtsDocument) info.fDocument);
            TextBlock newRoot = (TextBlock) TbChangeUtil.cleanUp(ctsDocument
                    .getRootBlock());
            ctsDocument.setRootBlock(newRoot);
    ...
    protected IDocument createDocument(Object element) {
        ...
        if (document != null) {
            ...
            if (extension
                    .getDocumentPartitioner(FurcasDocumentSetupParticpant.PARTITIONING) == null) {
