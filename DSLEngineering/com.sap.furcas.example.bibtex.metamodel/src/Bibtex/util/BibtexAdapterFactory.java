...
public class BibtexAdapterFactory extends AdapterFactoryImpl {
    ...
    protected BibtexSwitch<Adapter> modelSwitch =
        new BibtexSwitch<Adapter>() {
            @Override
            public Adapter caseLiteratureDb(LiteratureDb object) {
                return createLiteratureDbAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link Bibtex.LiteratureDb <em>Literature Db</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createLiteratureDbAdapter() {
        return null;
    }
