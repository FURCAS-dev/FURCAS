...
public class BibtexPackageImpl extends EPackageImpl implements BibtexPackage {
    ...
    public void initializePackageContents() {
		...
		initEReference(getLiteratureDb_Author(), this.getAuthor(), this.getAuthor_Literaturedb(), "author", null, 0, -1, LiteratureDb.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLiteratureDb_Entries(), this.getEntry(), this.getEntry_Literaturedb(), "entries", null, 0, -1, LiteratureDb.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntry_Literaturedb(), this.getLiteratureDb(), this.getLiteratureDb_Entries(), "literaturedb", null, 1, 1, Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAuthor_Literaturedb(), this.getLiteratureDb(), this.getLiteratureDb_Author(), "literaturedb", null, 1, 1, Author.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    protected void createOCLAnnotations() {
		...
		addAnnotation
		  (literatureDbEClass, 
		   source, 
		   new String[] {
			 "uniqueName", "LiteratureDb.allInstances()->select(db | db.name = self.name)->size() = 1"
		   });			
		addAnnotation
		  (entryEClass, 
		   source, 
