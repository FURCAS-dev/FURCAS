...
public class LiteratureDbImpl extends EObjectImpl implements LiteratureDb {
    ...
    public EList<Author> getAuthor() {
		if (author == null) {
			author = new EObjectContainmentWithInverseEList<Author>(Author.class, this, BibtexPackage.LITERATURE_DB__AUTHOR, BibtexPackage.AUTHOR__LITERATUREDB);
		}
		return author;
	}
    ...
    public EList<Entry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentWithInverseEList<Entry>(Entry.class, this, BibtexPackage.LITERATURE_DB__ENTRIES, BibtexPackage.ENTRY__LITERATUREDB);
		}
		return entries;
	}
