...
public class TestIncrementalParser extends GeneratedParserAndFactoryBasedTest {
	...
	private static final String MM_PACKAGE = BibtexPackage.eNS_URI;
	...
	public static void setupParser() throws Exception {
		testConfig = new GeneratedParserTestConfiguration(
				LANGUAGE, TCS, GENERATION_TEMP + File.separator + PACKAGE_NAME + File.separator, PACKAGE_NAME, METAMODELS);
		...
		generationHelper = new ParserGenerationTestHelper(
				GENERATION_TEMP,
		...
		EditingDomain editingDomain = new AdapterFactoryEditingDomain(
				new BibtexAdapterFactory(), new BasicCommandStack(), resourceSet);
