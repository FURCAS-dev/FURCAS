...
//
//		IModelAdapter adapter = new TextBlocksAwareModelAdapter(new EMFModelAdapter(FURCASPackage.eINSTANCE, ScopeHelper.createResourceSet(), ScopeHelper.createReferenceScope()));
