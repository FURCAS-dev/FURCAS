...
public class TestIncrementalLexer extends TextBlockTest {
    ...
    public void testWithInitialContentTokenValueOnlyChange() throws Exception {
        ...
        // TbUtil.createNewCopy(editedVersion.getTokens().get(1),
        ...
        //
        //
        // TbVersionUtil.getOtherVersion(editedVersion.getTokens().get(2),
        // Version.CURRENT).refDelete();
        // TextBlock currentTB = TbVersionUtil.getOtherVersion(editedVersion,
        // Version.CURRENT);
        ...
        MockLexerAdapterWithLookaheadLLStar mockLexerAdapter = new MockLexerAdapterWithLookaheadLLStar(
            ...
            public List<AbstractToken> moreTokens() {
                ...
                if (o.getValue().equals("tok3")) {
                    ...
                    // this needs to be done as tok3 will be simulated as being
                    // reused but its offset needs
