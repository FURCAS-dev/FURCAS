...
@Ignore("Not yet ported. Tests require a TCS syntax. The following should allow us to get it (best: move it to tcs test helper):" +
        "                                                                                    " +
	"     TCSParserGenerator tcsParserGenerator = TCSParserGeneratorFactory.INSTANCE.createTCSParserGenerator();"+
        "     GrammarGenerationSourceConfiguration sourceConfiguration = new GrammarGenerationSourceConfiguration("+
        "               ScopeHelper.createResourceSet(), ScopeHelper.createFURCASReferenceScope());" +
        "     TCSSyntaxContainerBean syntaxBean = tcsParserGenerator.parseSyntax(sourceConfiguration, TCSSyntaxDefinition.TCS_TCS);" +
        "                                                                                                                               ")
public class TestTextBlocksObserver extends FixtureProvidingTextBlockTest {
