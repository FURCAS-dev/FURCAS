...
/**
 * FIXME: This class needs to be adapted to work with the current pretty printer
 * implementation. 
 * 
...
//     */
//    public void prettyPrint(EObject modelElementToPrint, TextBlock oldTextBlock,  Template template) {
//        // Incremental mode
...
//
//        
//        PrettyPrinter printer = new PrettyPrinter(syntax, metamodelLookup, oclEvaluator, parserFactory)
//        
