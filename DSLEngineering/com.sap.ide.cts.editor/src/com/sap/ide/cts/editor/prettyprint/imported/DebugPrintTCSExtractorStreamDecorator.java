...
public class DebugPrintTCSExtractorStreamDecorator implements TCSExtractorStream {

    TCSExtractorStream target;

    public DebugPrintTCSExtractorStreamDecorator(TCSExtractorStream target) {
	this.target = target;
    }
