...
public class CtsTextBlockTCSExtractorStream implements TCSExtractorStream {
    ...
    public CtsTextBlockTCSExtractorStream(TextblocksPackage pack, ModelPartition partitionForTextBlocks,
    ...
    void addNextTextBlock(RefObject correspondingModelElement, Template template, SequenceElement se, int handle) {
	if (debug) {
