...
public class StubModelAdapter implements IBareModelAdapter {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sap.mi.textual.grammar.IModelAdapter#setMQLReference(java.lang.Object,
	...
	public Object setWithinContextObject(Object modelElement,
	    ...
	    if (contextObject instanceof StubModelElement) {
            ...
            // in this object,look for an object of the given type having given attribute with given value.
            Collection<Object> contents = context.getAllContained();
            for (Iterator<Object> iterator = contents.iterator(); iterator.hasNext();) {
                ...
                if (object instanceof StubModelElement) {
                    ...
                    if (contentElement.type.equals(targetType)) {
                        ...
                        if (candidateKeyValue != null && candidateKeyValue.equals(keyValue) ) {
                            ((StubModelElement)modelElement).set(propertyName, contentElement);
	    ...
	    throw new ReferenceSettingException("StubModelAdapter could not set reference.");
