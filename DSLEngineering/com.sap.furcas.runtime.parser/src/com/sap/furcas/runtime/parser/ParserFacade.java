...
/**
 * The parser Facade provides access to the model injecting capabilities of a generated parser. The facade is initialized by
 * looking up a generated instance of org.antlr.Parser and Lexer, then allows to use these for parsing of inputStreams any number
 * of times.
 */
public class ParserFacade {
     ...
     *            may be null, then main will be used
     * @param bean
     *            may be null, then default will be used
     * @param observer
     *            may be null
     * @return a result containing the root parsed modelElement (or a Collection of roots), errors, and a map of text locations
     *         for elements
     * @throws IOException
    ...
    public ModelParsingResult parseProductionRule(InputStream in, IModelAdapter modelHandler, String productionRule,
            InjectionOptionsBean bean, IParsingObserver observer) throws IOException, UnknownProductionRuleException {
    ...
    public ModelParsingResult parseProductionRule(InputStream in, IModelAdapter modelHandler, String productionRule,
            InjectionOptionsBean bean, IParsingObserver observer, boolean setDelayedReferences) throws IOException,
