...
public abstract class ObservableInjectingParser extends ObservablePatchedParser implements ContextBuilder {
     ...
     * @return
     */
    protected final IModelElementProxy createModelElementProxy(List<String> name, boolean context, boolean addToContext,
            String... tags) {
    ...
    public final boolean setDelayedReferencesAfterParsing() {
        ...
        if (injector.getErrorList().size() == 0) {
            ...
            while (!delayedReferenceList.isEmpty() && resolvedNewReference || !unResolvedDelayedReferenceList.isEmpty()) {
                ...
                for (Iterator<DelayedReference> iterator = delayedReferenceList.iterator(); iterator.hasNext();) {
                    ...
                    try {
                        ...
                        boolean newlyResolved = injector.resolveReference(reference, contextManager, this);
                        if (newlyResolved) {
                            iterator.remove();
    ...
    public final void setSemDisambiguate(Object proxy, Object opTemplateLefthand, String opName, Object element,
        ...
        DelayedReference ref = new DelayedReference(getCurrentContextElement(), DelayedReference.SEMANTIC_DISAMBIGUATE, proxy,
                element, opTemplateLefthand, opName, preds, lastToken, firstToken, hasContext, true);
    ...
    public final void setRef(Object modelElement, String propertyName, List<String> valueTypeName, String keyName,
            Object keyValue, String lookIn, String autoCreate, List<String> createAs, boolean importContext, String createIn) {
        //if (keyValue == null) return;

        ANTLR3LocationToken lastToken = (ANTLR3LocationToken) input.LT(-1);

        DelayedReference ref = new DelayedReference(getCurrentContextElement(), getCurrentForeachElement(), modelElement,
                propertyName, valueTypeName, keyName, keyValue, lookIn, autoCreate, createAs, importContext, createIn, false,
                lastToken);
    ...
    public final void setRef(Object modelElement, String propertyName, List<String> valueTypeName, String keyName,
        ...
        DelayedReference ref = new DelayedReference(getCurrentContextElement(), getCurrentForeachElement(), modelElement,
                propertyName, valueTypeName, keyName, keyValue, lookIn, autoCreate, createAs, importContext, createIn,
    ...
    public final void setOclRef(Object object, String propertyName, String keyName, Object keyValue, String query) {
        ...
        DelayedReference ref = new DelayedReference(getCurrentContextElement(), getCurrentForeachElement(), object, propertyName,
    ...
    public final void setPredicateRef(Object object, String propertyName, String mode, String query,
        ...
        ANTLR3LocationToken lastToken = (ANTLR3LocationToken) input.LT(-1);
        DelayedReference ref = new DelayedReference(getCurrentContextElement(), getCurrentForeachElement(),
                DelayedReference.TYPE_SEMANTIC_PREDICATE, object, propertyName, query, mode, preds, ruleNameFinder, lastToken,
