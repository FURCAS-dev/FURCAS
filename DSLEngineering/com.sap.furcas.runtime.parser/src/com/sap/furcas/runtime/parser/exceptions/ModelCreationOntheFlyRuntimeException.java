...
/**
 * To be used for Exceptions that occur during model creation while
 * parsing.Runtime Exception is used as the Parser thread and code should not
 * need to know about these exceptions happening.
 * 
 * @author C5107456
 */
