...
/**
 * 
 * Encapsulates all methods providing source code needed in the process of
 * creating a new DSL with the {@link TCSProjectsWizard}. All information needed
 * for the generic source code generation is retrieved from the associated
 * {@link ProjectInfo}.
 * 
...
public class SourceCodeFactory {
	...
	protected String createEditorCode(ProjectInfo pi) {
		String capLangName = CreateProject.capitalizeFirstChar(pi
				.getLanguageName());
		StringTemplate tcsTemp = null;
		String templateString = null;
		try {
