			...
			if (subNode instanceof TextBlockProxy) {
				if (((TextBlockProxy) subNode).getSubNodes().size() > 0) {
				    ...
				    if(subBlock.reuseType.equals(ReuseType.COMPLETE)) {
    				        ...
    				        TokenRelocationUtil.updateTextBlockLocationAfterRemoval(firstToken.getParentBlock());
    				        TokenRelocationUtil.updateParentsAscendingAfterRemoval(firstToken.getParentBlock());
