...
public class OclOperatorSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OclOperatorPackage.OCL_OPERATOR: {
				OclOperator oclOperator = (OclOperator)theEObject;
				T result = caseOclOperator(oclOperator);
				if (result == null) result = caseOperator(oclOperator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OclOperatorPackage.OCL_OPTION_OBJECT: {
				OclOptionObject oclOptionObject = (OclOptionObject)theEObject;
				T result = caseOclOptionObject(oclOptionObject);
				if (result == null) result = caseOptionObject(oclOptionObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OclOperatorPackage.OCL_UTIL: {
				OclUtil oclUtil = (OclUtil)theEObject;
				T result = caseOclUtil(oclUtil);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ocl Option Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ocl Option Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOclOptionObject(OclOptionObject object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ocl Util</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ocl Util</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOclUtil(OclUtil object) {
		return null;
	}
