 ...
 * @model annotation="http://de.hpi.sam.bp2009.OCL DistinctClassNamesPerPackage='self.classes->forAll( i, j | i <> j implies i.name <> j.name )'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='DistinctClassNamesPerPackage'"
 * @generated
 */
