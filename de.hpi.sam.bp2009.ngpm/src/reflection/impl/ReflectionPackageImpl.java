 ...
 * @generated
 */
public class ReflectionPackageImpl extends EPackageImpl implements ReflectionPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see reflection.ReflectionPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ReflectionPackageImpl()
  {
    super(eNS_URI, ReflectionFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link ReflectionPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ReflectionPackage init()
  {
    if (isInited) return (ReflectionPackage)EPackage.Registry.INSTANCE.getEPackage(ReflectionPackage.eNS_URI);

    // Obtain or create and register package
    ReflectionPackageImpl theReflectionPackage = (ReflectionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ReflectionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ReflectionPackageImpl());
    ...
    theReflectionPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ReflectionPackage.eNS_URI, theReflectionPackage);
    return theReflectionPackage;
  }
  ...
  {
    return (ReflectionFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(objectEClass, reflection.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getObject_Type(), theClassesPackage.getSapClass(), theClassesPackage.getSapClass_Instances(), "type", null, 1, 1, reflection.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
