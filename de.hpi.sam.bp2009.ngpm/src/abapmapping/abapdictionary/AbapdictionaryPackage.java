...
public interface AbapdictionaryPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Xsd Type</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * The feature id for the '<em><b>Language Dependent Description</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int CODE_VALUE__LANGUAGE_DEPENDENT_DESCRIPTION = 0;
   ...
   * @ordered
   */
  int CODE_VALUE_FEATURE_COUNT = 4;
  ...
  /**
   * The feature id for the '<em><b>Extensible</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for the containment reference '{@link abapmapping.abapdictionary.XsdType#getXsdType <em>Xsd Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Xsd Type</em>'.
   * @see abapmapping.abapdictionary.XsdType#getXsdType()
   * @see #getXsdType()
   * @generated
   */
  EReference getXsdType_XsdType();
  ...
  /**
   * Returns the meta object for the containment reference '{@link abapmapping.abapdictionary.XsdType#getPattern <em>Pattern</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the reference '{@link abapmapping.abapdictionary.CodeValue#getLanguageDependentDescription <em>Language Dependent Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Language Dependent Description</em>'.
   * @see abapmapping.abapdictionary.CodeValue#getLanguageDependentDescription()
   * @see #getCodeValue()
   * @generated
   */
  EReference getCodeValue_LanguageDependentDescription();

  /**
   * Returns the meta object for the containment reference '{@link abapmapping.abapdictionary.CodeValue#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference '{@link abapmapping.abapdictionary.Code#getExtensible <em>Extensible</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Extensible</em>'.
   * @see abapmapping.abapdictionary.Code#getExtensible()
   * @see #getCode()
   * @generated
   */
  EReference getCode_Extensible();
  ...
  /**
   * Returns the meta object for the containment reference '{@link abapmapping.abapdictionary.AbapType#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference '{@link abapmapping.abapdictionary.AbapStructureField#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Name</em>'.
   ...
   * @generated
   */
  EReference getAbapStructureField_Name();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Xsd Type</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference XSD_TYPE__XSD_TYPE = eINSTANCE.getXsdType_XsdType();
     ...
     * @generated
     */
    EReference XSD_TYPE__PATTERN = eINSTANCE.getXsdType_Pattern();
    ...
    /**
     * The meta object literal for the '<em><b>Language Dependent Description</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference CODE_VALUE__LANGUAGE_DEPENDENT_DESCRIPTION = eINSTANCE.getCodeValue_LanguageDependentDescription();
     ...
     * @generated
     */
    EReference CODE_VALUE__VALUE = eINSTANCE.getCodeValue_Value();
    ...
    /**
     * The meta object literal for the '<em><b>Extensible</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference CODE__EXTENSIBLE = eINSTANCE.getCode_Extensible();
     ...
     * @generated
     */
    EReference ABAP_TYPE__NAME = eINSTANCE.getAbapType_Name();
     ...
     * @generated
     */
    EReference ABAP_STRUCTURE_FIELD__NAME = eINSTANCE.getAbapStructureField_Name();
