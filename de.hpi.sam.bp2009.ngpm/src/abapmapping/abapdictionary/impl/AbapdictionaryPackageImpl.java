...
public class AbapdictionaryPackageImpl extends EPackageImpl implements AbapdictionaryPackage
{
   ...
   * @generated
   */
  public EReference getXsdType_XsdType()
  {
    return (EReference)xsdTypeEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getXsdType_Pattern()
  {
    return (EReference)xsdTypeEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getCodeValue_LanguageDependentDescription()
  {
    return (EReference)codeValueEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getCodeValue_Value()
  {
  ...
  {
    return (EReference)codeValueEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getCode_Extensible()
  {
   ...
   * @generated
   */
  public EReference getAbapType_Name()
  {
    return (EReference)abapTypeEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getAbapStructureField_Name()
  {
    return (EReference)abapStructureFieldEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(xsdTypeEClass, XSD_TYPE__XSD_TYPE);
    createEAttribute(xsdTypeEClass, XSD_TYPE__LENGTH);
    createEReference(xsdTypeEClass, XSD_TYPE__PATTERN);
    ...
    createEReference(codeValueEClass, CODE_VALUE__LANGUAGE_DEPENDENT_DESCRIPTION);
    createEReference(codeValueEClass, CODE_VALUE__VALUE);
    createEReference(codeValueEClass, CODE_VALUE__DESCRIPTION);
    createEReference(codeValueEClass, CODE_VALUE__TYPE);

    codeEClass = createEClass(CODE);
    createEReference(codeEClass, CODE__EXTENSIBLE);
    ...
    createEReference(abapTypeEClass, ABAP_TYPE__NAME);
    ...
    createEReference(abapStructureFieldEClass, ABAP_STRUCTURE_FIELD__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    Sproxy_contentPackage theSproxy_contentPackage = (Sproxy_contentPackage)EPackage.Registry.INSTANCE.getEPackage(Sproxy_contentPackage.eNS_URI);
    ...
    initEReference(getXsdType_XsdType(), thePrimitivetypesPackage_1.getString(), null, "xsdType", null, 0, 1, XsdType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getXsdType_Length(), thePrimitivetypesPackage.getInteger(), "length", null, 0, 1, XsdType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getXsdType_Pattern(), thePrimitivetypesPackage_1.getString(), null, "pattern", null, 0, 1, XsdType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getXsdType_TotalDigits(), thePrimitivetypesPackage.getInteger(), "totalDigits", null, 0, 1, XsdType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getXsdType_FractionDigits(), thePrimitivetypesPackage.getInteger(), "fractionDigits", null, 0, 1, XsdType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getCodeValue_LanguageDependentDescription(), theSproxy_contentPackage.getLanguageDependentText(), null, "languageDependentDescription", null, 1, 1, CodeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCodeValue_Value(), thePrimitivetypesPackage_1.getString(), null, "value", null, 0, 1, CodeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCodeValue_Description(), theLocalizationPackage.getTranslatableText(), null, "description", null, 0, 1, CodeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getCode_Extensible(), thePrimitivetypesPackage_1.getBoolean(), null, "extensible", null, 0, 1, Code.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAbapType_Name(), thePrimitivetypesPackage_1.getString(), null, "name", null, 0, 1, AbapType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAbapStructureField_Name(), thePrimitivetypesPackage_1.getString(), null, "name", null, 0, 1, AbapStructureField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAbapPrimtiveType_Length(), thePrimitivetypesPackage.getInteger(), "length", null, 0, 1, AbapPrimtiveType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createEmofAnnotations()
  {
    ...
    addAnnotation
      (getCodeValue_LanguageDependentDescription(), 
       source, 
       new String[] 
       {
