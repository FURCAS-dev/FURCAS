...
import reflect.Element;
import reflect.ReflectFactory;
...
public class ReflectPackageImpl extends EPackageImpl implements ReflectPackage
{
   ...
   * @see reflect.ReflectPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * 
   * <p>This method is used to initialize {@link ReflectPackage#eINSTANCE} when that field is accessed.
  ...
  public static ReflectPackage init()
  {
    ...
    ReflectPackageImpl theReflectPackage = (ReflectPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ReflectPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ReflectPackageImpl());
    ...
    EPackage.Registry.INSTANCE.put(ReflectPackage.eNS_URI, theReflectPackage);
