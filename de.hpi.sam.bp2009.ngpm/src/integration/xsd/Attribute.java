...
public interface Attribute extends NamedElement
{
   ...
   * @see #setVal(runtime.primitivetypes.String)
   * @see integration.xsd.XsdPackage#getAttribute_Val()
   * @model containment="true"
   * @generated
   */
  runtime.primitivetypes.String getVal();

  /**
   * Sets the value of the '{@link integration.xsd.Attribute#getVal <em>Val</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setVal(runtime.primitivetypes.String value);
