...
public class XsdPackageImpl extends EPackageImpl implements XsdPackage
{
   ...
   * @generated
   */
  public EReference getNotation_PublicDec()
  {
   ...
   * @generated
   */
  public EReference getNotation_SystemDec()
  {
   ...
   * @generated
   */
  public EReference getSimpleContent_Base()
  {
    return (EReference)simpleContentEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getSimpleContent_EnumVals()
  {
    return (EReference)simpleContentEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getComplexContent_Mixed()
  {
    return (EReference)complexContentEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(rootEClass, ROOT__ID);
    createEReference(rootEClass, ROOT__ANNO);

    groupEClass = createEClass(GROUP);

    annotationEClass = createEClass(ANNOTATION);
    createEReference(annotationEClass, ANNOTATION__DOCUMENTATION);
    createEReference(annotationEClass, ANNOTATION__APP_INFO);

    notationEClass = createEClass(NOTATION);
    createEReference(notationEClass, NOTATION__PUBLIC_DEC);
    createEReference(notationEClass, NOTATION__SYSTEM_DEC);
    ...
    createEReference(simpleContentEClass, SIMPLE_CONTENT__BASE);
    createEReference(simpleContentEClass, SIMPLE_CONTENT__ENUM_VALS);

    complexContentEClass = createEClass(COMPLEX_CONTENT);
    createEReference(complexContentEClass, COMPLEX_CONTENT__MIXED);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getNamedElement_Name(), thePrimitivetypesPackage_1.getString(), null, "name", null, 0, 1, NamedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getContainable_MinOccurs(), thePrimitivetypesPackage.getInteger(), "minOccurs", null, 0, 1, Containable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getContainable_MaxOccurs(), thePrimitivetypesPackage.getInteger(), "maxOccurs", null, 0, 1, Containable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(attributeEClass, Attribute.class, "Attribute", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAttribute_Use(), this.getAttUseType(), "use", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAttribute_Val(), thePrimitivetypesPackage_1.getString(), null, "val", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRoot_Id(), thePrimitivetypesPackage_1.getString(), null, "id", null, 0, 1, Root.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAnnotation_Documentation(), thePrimitivetypesPackage_1.getString(), null, "documentation", null, 0, 1, Annotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotation_AppInfo(), thePrimitivetypesPackage_1.getString(), null, "appInfo", null, 0, 1, Annotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(notationEClass, Notation.class, "Notation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNotation_PublicDec(), thePrimitivetypesPackage_1.getString(), null, "publicDec", null, 0, 1, Notation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNotation_SystemDec(), thePrimitivetypesPackage_1.getString(), null, "systemDec", null, 0, 1, Notation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSimpleContent_Base(), thePrimitivetypesPackage_1.getString(), null, "base", null, 0, 1, SimpleContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSimpleContent_EnumVals(), thePrimitivetypesPackage_1.getString(), null, "enumVals", null, 0, 1, SimpleContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(complexContentEClass, ComplexContent.class, "ComplexContent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getComplexContent_Mixed(), thePrimitivetypesPackage_1.getBoolean(), null, "mixed", null, 0, 1, ComplexContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
