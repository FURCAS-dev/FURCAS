...
public class AttributeImpl extends NamedElementImpl implements Attribute
{
   ...
   * @ordered
   */
  protected runtime.primitivetypes.String val;
   ...
   * @generated
   */
  public runtime.primitivetypes.String getVal()
  {
    return val;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetVal(runtime.primitivetypes.String newVal, NotificationChain msgs)
  {
    runtime.primitivetypes.String oldVal = val;
    val = newVal;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XsdPackage.ATTRIBUTE__VAL, oldVal, newVal);
   ...
   * @generated
   */
  public void setVal(runtime.primitivetypes.String newVal)
  {
    if (newVal != val)
    {
      NotificationChain msgs = null;
      if (val != null)
        msgs = ((InternalEObject)val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XsdPackage.ATTRIBUTE__VAL, null, msgs);
      if (newVal != null)
        msgs = ((InternalEObject)newVal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XsdPackage.ATTRIBUTE__VAL, null, msgs);
      msgs = basicSetVal(newVal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XsdPackage.ATTRIBUTE__VAL, newVal, newVal));
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case XsdPackage.ATTRIBUTE__USE:
        ...
        return;
      case XsdPackage.ATTRIBUTE__VAL:
        setVal((runtime.primitivetypes.String)newValue);
        return;
      case XsdPackage.ATTRIBUTE__TYPE:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case XsdPackage.ATTRIBUTE__USE:
        ...
        return;
      case XsdPackage.ATTRIBUTE__VAL:
        setVal((runtime.primitivetypes.String)null);
        return;
      case XsdPackage.ATTRIBUTE__TYPE:
