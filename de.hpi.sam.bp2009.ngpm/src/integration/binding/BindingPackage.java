...
public interface BindingPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference '{@link integration.binding.SimpleUrlPattern#getBaseUrl <em>Base Url</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  EReference getSimpleUrlPattern_BaseUrl();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference SIMPLE_URL_PATTERN__BASE_URL = eINSTANCE.getSimpleUrlPattern_BaseUrl();
