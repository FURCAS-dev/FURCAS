 ...
 * <ul>
 *   <li>{@link runtime.testwithroles.impl.SupplierImpl#getSalesOrder <em>Sales Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SupplierImpl extends EObjectImpl implements Supplier
{
  ...
  {
    return TestwithrolesPackage.Literals.SUPPLIER;
  }
  ...
  public EList<SalesOrder> getSalesOrder()
  {
    if (salesOrder == null)
    {
      salesOrder = new EObjectWithInverseResolvingEList<SalesOrder>(SalesOrder.class, this, TestwithrolesPackage.SUPPLIER__SALES_ORDER, TestwithrolesPackage.SALES_ORDER__SELLER);
    }
    return salesOrder;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TestwithrolesPackage.SUPPLIER__SALES_ORDER:
