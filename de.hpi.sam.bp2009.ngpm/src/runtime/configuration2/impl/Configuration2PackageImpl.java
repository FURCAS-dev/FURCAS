 ...
 * @generated
 */
public class Configuration2PackageImpl extends EPackageImpl implements Configuration2Package
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass numberRangeImplEClass = null;
   ...
   * @generated
   */
  private EClass purchaseOrderNumberRangesEClass = null;
   ...
   * @generated
   */
  private EClass salesOrderNumberRangesEClass = null;
   ...
   * @see runtime.configuration2.Configuration2Package#eNS_URI
   * @see #init()
   * @generated
   */
  private Configuration2PackageImpl()
  {
    super(eNS_URI, Configuration2Factory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link Configuration2Package#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Configuration2Package init()
  {
    if (isInited) return (Configuration2Package)EPackage.Registry.INSTANCE.getEPackage(Configuration2Package.eNS_URI);

    // Obtain or create and register package
    Configuration2PackageImpl theConfiguration2Package = (Configuration2PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Configuration2PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Configuration2PackageImpl());
    ...
    theConfiguration2Package.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Configuration2Package.eNS_URI, theConfiguration2Package);
    return theConfiguration2Package;
  }
   ...
   * @generated
   */
  public EReference getSalesOrder_NumberRange()
  {
   ...
   * @generated
   */
  public EClass getNumberRangeImpl()
  {
    return numberRangeImplEClass;
  }
   ...
   * @generated
   */
  public EReference getPurchaseOrder_NumberRange()
  {
   ...
   * @generated
   */
  public EClass getPurchaseOrderNumberRanges()
  {
    return purchaseOrderNumberRangesEClass;
  }
   ...
   * @generated
   */
  public EReference getPurchaseOrderNumberRanges_Nr1()
  {
    return (EReference)purchaseOrderNumberRangesEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getPurchaseOrderNumberRanges_Nr2()
  {
    return (EReference)purchaseOrderNumberRangesEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EClass getSalesOrderNumberRanges()
  {
    return salesOrderNumberRangesEClass;
  }
   ...
   * @generated
   */
  public EReference getSalesOrderNumberRanges_Nr1()
  {
    return (EReference)salesOrderNumberRangesEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getSalesOrderNumberRanges_Nr2()
  {
    return (EReference)salesOrderNumberRangesEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public Configuration2Factory getConfiguration2Factory()
  {
    return (Configuration2Factory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(salesOrderEClass, SALES_ORDER__NUMBER_RANGE);

    numberRangeImplEClass = createEClass(NUMBER_RANGE_IMPL);

    purchaseOrderEClass = createEClass(PURCHASE_ORDER);
    createEReference(purchaseOrderEClass, PURCHASE_ORDER__NUMBER_RANGE);

    numberRangeEClass = createEClass(NUMBER_RANGE);

    purchaseOrderNumberRangesEClass = createEClass(PURCHASE_ORDER_NUMBER_RANGES);
    createEReference(purchaseOrderNumberRangesEClass, PURCHASE_ORDER_NUMBER_RANGES__NR1);
    createEReference(purchaseOrderNumberRangesEClass, PURCHASE_ORDER_NUMBER_RANGES__NR2);

    salesOrderNumberRangesEClass = createEClass(SALES_ORDER_NUMBER_RANGES);
    createEReference(salesOrderNumberRangesEClass, SALES_ORDER_NUMBER_RANGES__NR1);
    createEReference(salesOrderNumberRangesEClass, SALES_ORDER_NUMBER_RANGES__NR2);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getSalesOrder_NumberRange(), this.getNumberRange(), null, "numberRange", null, 0, -1, SalesOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numberRangeImplEClass, NumberRangeImpl.class, "NumberRangeImpl", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(purchaseOrderEClass, PurchaseOrder.class, "PurchaseOrder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPurchaseOrder_NumberRange(), this.getNumberRange(), null, "numberRange", null, 0, -1, PurchaseOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numberRangeEClass, NumberRange.class, "NumberRange", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(purchaseOrderNumberRangesEClass, PurchaseOrderNumberRanges.class, "PurchaseOrderNumberRanges", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPurchaseOrderNumberRanges_Nr1(), thePrimitivetypesPackage_1.getString(), null, "nr1", null, 0, 1, PurchaseOrderNumberRanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPurchaseOrderNumberRanges_Nr2(), thePrimitivetypesPackage_1.getString(), null, "nr2", null, 0, 1, PurchaseOrderNumberRanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(salesOrderNumberRangesEClass, SalesOrderNumberRanges.class, "SalesOrderNumberRanges", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSalesOrderNumberRanges_Nr1(), thePrimitivetypesPackage_1.getString(), null, "nr1", null, 0, 1, SalesOrderNumberRanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSalesOrderNumberRanges_Nr2(), thePrimitivetypesPackage_1.getString(), null, "nr2", null, 0, 1, SalesOrderNumberRanges.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
