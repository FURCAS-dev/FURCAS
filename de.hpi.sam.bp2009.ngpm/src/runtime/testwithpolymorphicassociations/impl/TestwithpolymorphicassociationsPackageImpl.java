...
import runtime.testwithpolymorphicassociations.TestwithpolymorphicassociationsFactory;
 ...
 * @generated
 */
public class TestwithpolymorphicassociationsPackageImpl extends EPackageImpl implements TestwithpolymorphicassociationsPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see runtime.testwithpolymorphicassociations.TestwithpolymorphicassociationsPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private TestwithpolymorphicassociationsPackageImpl()
  {
    super(eNS_URI, TestwithpolymorphicassociationsFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link TestwithpolymorphicassociationsPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static TestwithpolymorphicassociationsPackage init()
  {
    if (isInited) return (TestwithpolymorphicassociationsPackage)EPackage.Registry.INSTANCE.getEPackage(TestwithpolymorphicassociationsPackage.eNS_URI);

    // Obtain or create and register package
    TestwithpolymorphicassociationsPackageImpl theTestwithpolymorphicassociationsPackage = (TestwithpolymorphicassociationsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TestwithpolymorphicassociationsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TestwithpolymorphicassociationsPackageImpl());
    ...
    theTestwithpolymorphicassociationsPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(TestwithpolymorphicassociationsPackage.eNS_URI, theTestwithpolymorphicassociationsPackage);
    return theTestwithpolymorphicassociationsPackage;
  }
   ...
   * @generated
   */
  public TestwithpolymorphicassociationsFactory getTestwithpolymorphicassociationsFactory()
  {
    return (TestwithpolymorphicassociationsFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(aEClass, A__ATO_B);
    createEReference(aEClass, A__B);

    cEClass = createEClass(C);
    createEAttribute(cEClass, C__CTO_D);
    createEAttribute(cEClass, C__ATO_B);
    ...
    createEAttribute(eEClass, E__ETO_F);
    createEReference(eEClass, E__B);

    fEClass = createEClass(F);
    createEReference(fEClass, F__A);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(aEClass, runtime.testwithpolymorphicassociations.A.class, "A", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getA_AtoB(), ecorePackage.getEString(), "AtoB", null, 0, 1, runtime.testwithpolymorphicassociations.A.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getA_B(), this.getB(), this.getB_A(), "b", null, 0, -1, runtime.testwithpolymorphicassociations.A.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(aEClass, null, "a", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(cEClass, runtime.testwithpolymorphicassociations.C.class, "C", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getC_CtoD(), ecorePackage.getEString(), "CtoD", null, 0, 1, runtime.testwithpolymorphicassociations.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getC_AtoB(), ecorePackage.getEString(), "AtoB", null, 0, 1, runtime.testwithpolymorphicassociations.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getC_B(), this.getD(), this.getD_A(), "b", null, 0, -1, runtime.testwithpolymorphicassociations.C.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(cEClass, null, "a", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(cEClass, null, "c", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(bEClass, runtime.testwithpolymorphicassociations.B.class, "B", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getB_A(), this.getA(), this.getA_B(), "a", null, 0, -1, runtime.testwithpolymorphicassociations.B.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(bEClass, null, "b", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(dEClass, runtime.testwithpolymorphicassociations.D.class, "D", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getD_A(), this.getC(), this.getC_B(), "a", null, 0, -1, runtime.testwithpolymorphicassociations.D.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(dEClass, null, "b", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(dEClass, null, "d", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(eEClass, runtime.testwithpolymorphicassociations.E.class, "E", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getE_EtoF(), ecorePackage.getEString(), "EtoF", null, 0, 1, runtime.testwithpolymorphicassociations.E.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getE_B(), this.getF(), this.getF_A(), "b", null, 0, -1, runtime.testwithpolymorphicassociations.E.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(eEClass, null, "a", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(eEClass, null, "c", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(eEClass, null, "e", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(fEClass, runtime.testwithpolymorphicassociations.F.class, "F", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getF_A(), this.getE(), this.getE_B(), "a", null, 0, -1, runtime.testwithpolymorphicassociations.F.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(fEClass, null, "b", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(fEClass, null, "d", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(fEClass, null, "f", 0, 1, IS_UNIQUE, IS_ORDERED);
...
} //TestwithpolymorphicassociationsPackageImpl
