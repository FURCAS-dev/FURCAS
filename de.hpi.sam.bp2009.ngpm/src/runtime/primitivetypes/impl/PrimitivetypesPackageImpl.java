...
public class PrimitivetypesPackageImpl extends EPackageImpl implements PrimitivetypesPackage
{
   ...
   * @see runtime.primitivetypes.PrimitivetypesPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static PrimitivetypesPackage init()
  {
    ...
    primitivetypes.impl.PrimitivetypesPackageImpl thePrimitivetypesPackage_1 = (primitivetypes.impl.PrimitivetypesPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(primitivetypes.PrimitivetypesPackage.eNS_URI) instanceof primitivetypes.impl.PrimitivetypesPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(primitivetypes.PrimitivetypesPackage.eNS_URI) : primitivetypes.PrimitivetypesPackage.eINSTANCE);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(booleanEClass, runtime.primitivetypes.Boolean.class, "Boolean", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(dateTimeEClass, DateTime.class, "DateTime", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(numberEClass, runtime.primitivetypes.Number.class, "Number", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(stringEClass, runtime.primitivetypes.String.class, "String", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
