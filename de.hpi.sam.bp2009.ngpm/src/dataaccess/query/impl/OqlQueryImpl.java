...
public class OqlQueryImpl extends ExpressionImpl implements OqlQuery {
	...
	public EList<FromClause> getFromClauses() {
		if (fromClauses == null) {
			fromClauses = new EObjectContainmentWithInverseEList<FromClause>(FromClause.class, this, QueryPackage.OQL_QUERY__FROM_CLAUSES, QueryPackage.FROM_CLAUSE__FROM_CLAUSE_OF_OQL_QUERY);
		}
		return fromClauses;
	}
