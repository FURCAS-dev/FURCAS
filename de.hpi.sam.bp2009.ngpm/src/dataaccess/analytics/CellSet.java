...
public interface CellSet extends FunctionSignatureImplementation
{
   ...
   * @model opposite="cellSet" containment="true" required="true"
   * @generated
   */
   ...
   * @model opposite="cellSetForValueFunction" containment="true"
   * @generated
   */
   ...
   * @model opposite="cellSetForAggregationFunction" containment="true" required="true"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='if self.valueFunction->isEmpty() then    self.factsType  else    self.valueFunction.output  endif'"
   ...
   *        annotation="http://de.hpi.sam.bp2009.OCL body='self.dimensions->forAll(d|d.characteristicFunction.sideEffectFree) and  (self.valueFunction->notEmpty() implies self.valueFunction.sideEffectFree) and  self.aggregationFunction.sideEffectFree'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
