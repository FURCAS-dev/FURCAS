...
public class AnalyticsPackageImpl extends EPackageImpl implements AnalyticsPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    addEOperation(cellSetEClass, thePrimitivetypesPackage.getBoolean(), "localIsSideEffectFree", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    addEOperation(dimensionDefinitionEClass, thePrimitivetypesPackage.getString(), "getName", 0, 1, IS_UNIQUE, IS_ORDERED);
  ...
  protected void createDeAnnotations()
  {
    ...
    addAnnotation
      (cellSetEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "if self.valueFunction->isEmpty() then    self.factsType  else    self.valueFunction.output  endif"
       });				
    addAnnotation
      (cellSetEClass.getEOperations().get(1), 
       source, 
    ...
    addAnnotation
      (cellSetEClass.getEOperations().get(2), 
       ...
       new String[] 
       {
       "body", "self.dimensions->forAll(d|d.characteristicFunction.sideEffectFree) and  (self.valueFunction->notEmpty() implies self.valueFunction.sideEffectFree) and  self.aggregationFunction.sideEffectFree"
       });					
    addAnnotation
      (dimensionExpressionEClass, 
       source, 
