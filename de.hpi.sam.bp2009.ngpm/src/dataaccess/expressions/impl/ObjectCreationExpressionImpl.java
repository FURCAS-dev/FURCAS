...
public class ObjectCreationExpressionImpl extends ExpressionImpl implements ObjectCreationExpression {
	...
	public EList<MethodCallExpression> getInitializers() {
		if (initializers == null) {
			initializers = new EObjectContainmentWithInverseEList<MethodCallExpression>(MethodCallExpression.class, this, ExpressionsPackage.OBJECT_CREATION_EXPRESSION__INITIALIZERS, ExpressionsPackage.METHOD_CALL_EXPRESSION__CREATION_EXPRESSION);
		}
		return initializers;
	}
