...
public class ExpressionsValidator extends EObjectValidator
{
   ...
   * @generated
   */
  protected static final String MAP__ARGUMENT_MUST_BE_SINGLE_ARGUMENT_FUNCTION_WITH_NON_VOID_OUTPUT__EEXPRESSION = "let fstd = self.argument.getType() in \n  fstd.oclIsKindOf(FunctionSignatureTypeDefinition) and \n  (let sig = fstd.oclAsType(FunctionSignatureTypeDefinition).signature in \n  (sig.output->notEmpty() and \n  sig.input->size() = 1))";
