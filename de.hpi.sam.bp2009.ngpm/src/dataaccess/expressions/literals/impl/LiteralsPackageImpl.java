...
public class LiteralsPackageImpl extends EPackageImpl implements LiteralsPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getLiteral_Literal(), thePrimitivetypesPackage.getString(), "literal", null, 0, 1, Literal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    EOperation op = addEOperation(objectLiteralEClass, thePrimitivetypesPackage.getBoolean(), "isEqualTo", 0, 1, IS_UNIQUE, IS_ORDERED);
  ...
  protected void createDeAnnotations()
  {
    ...
    addAnnotation
      (objectLiteralEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "self.valueClass = o.valueClass and  self.propertyValues->size() = o.propertyValues->size() and  self.propertyValues->forAll(pv | o.propertyValues->exists(opv | opv.forEnd = pv.forEnd and opv.value.evaluatesToEqualAs(pv.value)))"
       });						
    addAnnotation
      (valueInitEClass, 
       source, 
