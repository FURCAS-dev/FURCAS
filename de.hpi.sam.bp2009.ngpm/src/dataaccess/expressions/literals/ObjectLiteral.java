...
public interface ObjectLiteral extends Expression
{
   ...
   *        annotation="http://de.hpi.sam.bp2009.OCL body='self.valueClass = o.valueClass and  self.propertyValues->size() = o.propertyValues->size() and  self.propertyValues->forAll(pv | o.propertyValues->exists(opv | opv.forEnd = pv.forEnd and opv.value.evaluatesToEqualAs(pv.value)))'"
