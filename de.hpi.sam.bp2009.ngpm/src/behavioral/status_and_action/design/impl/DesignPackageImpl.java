...
public class DesignPackageImpl extends EPackageImpl implements DesignPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getAbstractStatusVariable_IsAgent(), thePrimitivetypesPackage.getBoolean(), "isAgent", null, 0, 1, AbstractStatusVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAbstractStatusVariable_IsStateGuarded(), thePrimitivetypesPackage.getBoolean(), "isStateGuarded", null, 0, 1, AbstractStatusVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAbstractStatusValue_IsInitial(), thePrimitivetypesPackage.getBoolean(), "isInitial", null, 0, 1, AbstractStatusValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAbstractStatusValue_IsInhibiting(), thePrimitivetypesPackage.getBoolean(), "isInhibiting", null, 0, 1, AbstractStatusValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAbstractStatusValue_IsStateGuarded(), thePrimitivetypesPackage.getBoolean(), "isStateGuarded", null, 0, 1, AbstractStatusValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(abstractActionEClass, AbstractAction.class, "AbstractAction", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAbstractAction_IsAgent(), thePrimitivetypesPackage.getBoolean(), "isAgent", null, 0, 1, AbstractAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAbstractAction_IsPreconditionFixed(), thePrimitivetypesPackage.getBoolean(), "isPreconditionFixed", null, 0, 1, AbstractAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
