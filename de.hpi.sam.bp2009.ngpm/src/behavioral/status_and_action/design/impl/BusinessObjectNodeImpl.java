...
public class BusinessObjectNodeImpl extends NamedElementImpl implements BusinessObjectNode
{
  ...
  public EList<StatusVariable> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentEList<StatusVariable>(StatusVariable.class, this, DesignPackage.BUSINESS_OBJECT_NODE__VARIABLES);
    }
    return variables;
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, DesignPackage.BUSINESS_OBJECT_NODE__ACTIONS);
    }
    return actions;
  }
