...
public class Status_and_action_oldPackageImpl extends EPackageImpl implements Status_and_action_oldPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getSAMAction_Name(), thePrimitivetypesPackage.getString(), "name", null, 0, 1, SAMAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSAMAction_IsAgentAction(), thePrimitivetypesPackage.getBoolean(), "isAgentAction", null, 0, 1, SAMAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMStatusVariable_Name(), thePrimitivetypesPackage.getString(), "name", null, 0, 1, SAMStatusVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSAMStatusVariable_IsAgentVariable(), thePrimitivetypesPackage.getBoolean(), "isAgentVariable", null, 0, 1, SAMStatusVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMDerivator_Kind(), this.getSAMDerivatorKindEnum(), "kind", null, 0, 1, SAMDerivator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMStatusValue_Name(), thePrimitivetypesPackage.getString(), "name", null, 0, 1, SAMStatusValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMStatusSchema_Name(), thePrimitivetypesPackage.getString(), "name", null, 0, 1, SAMStatusSchema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMOperator_Kind(), this.getSAMOperatorKindEnum(), "kind", null, 0, 1, SAMOperator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMSchemaVariable_HasStateGuard(), thePrimitivetypesPackage.getBoolean(), "hasStateGuard", null, 0, 1, SAMSchemaVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSAMSchemaValue_IsInitial(), thePrimitivetypesPackage.getBoolean(), "isInitial", null, 0, 1, SAMSchemaValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSAMSchemaValue_IsInhibiting(), thePrimitivetypesPackage.getBoolean(), "isInhibiting", null, 0, 1, SAMSchemaValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
