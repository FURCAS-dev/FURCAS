...
public class Status_and_action_oldPackageImpl extends EPackageImpl implements Status_and_action_oldPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSAMAction_Name(), theEcorePackage.getEString(), "name", null, 0, 1, SAMAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSAMAction_IsAgentAction(), theEcorePackage.getEBoolean(), "isAgentAction", null, 0, 1, SAMAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSAMStatusVariable_Name(), theEcorePackage.getEString(), "name", null, 0, 1, SAMStatusVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSAMStatusVariable_IsAgentVariable(), theEcorePackage.getEBoolean(), "isAgentVariable", null, 0, 1, SAMStatusVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSAMStatusValue_Name(), theEcorePackage.getEString(), "name", null, 0, 1, SAMStatusValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSAMStatusSchema_Name(), theEcorePackage.getEString(), "name", null, 0, 1, SAMStatusSchema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSAMSchemaVariable_HasStateGuard(), theEcorePackage.getEBoolean(), "hasStateGuard", null, 0, 1, SAMSchemaVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSAMSchemaValue_IsInitial(), theEcorePackage.getEBoolean(), "isInitial", null, 0, 1, SAMSchemaValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSAMSchemaValue_IsInhibiting(), theEcorePackage.getEBoolean(), "isInhibiting", null, 0, 1, SAMSchemaValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
