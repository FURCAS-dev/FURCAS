...
public class SAMStatusSchemaImpl extends EObjectImpl implements SAMStatusSchema {
	...
	public EList<SAMOperator> getSamOperators() {
		if (samOperators == null) {
			samOperators = new EObjectContainmentWithInverseEList<SAMOperator>(SAMOperator.class, this, Status_and_action_oldPackage.SAM_STATUS_SCHEMA__SAM_OPERATORS, Status_and_action_oldPackage.SAM_OPERATOR__SAM_STATUS_SCHEMA);
		}
		return samOperators;
	}
	...
	public EList<SAMSchemaVariable> getSamSchemaVariables() {
		if (samSchemaVariables == null) {
			samSchemaVariables = new EObjectContainmentWithInverseEList<SAMSchemaVariable>(SAMSchemaVariable.class, this, Status_and_action_oldPackage.SAM_STATUS_SCHEMA__SAM_SCHEMA_VARIABLES, Status_and_action_oldPackage.SAM_SCHEMA_VARIABLE__SAM_STATUS_SCHEMA);
		}
	...
	public EList<SAMSchemaAction> getSamSchemaActions() {
		if (samSchemaActions == null) {
			samSchemaActions = new EObjectContainmentWithInverseEList<SAMSchemaAction>(SAMSchemaAction.class, this, Status_and_action_oldPackage.SAM_STATUS_SCHEMA__SAM_SCHEMA_ACTIONS, Status_and_action_oldPackage.SAM_SCHEMA_ACTION__SAM_STATUS_SCHEMA);
		}
	...
	public EList<SAMSchemaDerivator> getSamSchemaDerivators() {
		if (samSchemaDerivators == null) {
			samSchemaDerivators = new EObjectContainmentWithInverseEList<SAMSchemaDerivator>(SAMSchemaDerivator.class, this, Status_and_action_oldPackage.SAM_STATUS_SCHEMA__SAM_SCHEMA_DERIVATORS, Status_and_action_oldPackage.SAM_SCHEMA_DERIVATOR__SAM_STATUS_SCHEMA);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Status_and_action_oldPackage.SAM_STATUS_SCHEMA__BUSINESS_OBJECT_NODE:
				return getBusinessObjectNode() != null;
			case Status_and_action_oldPackage.SAM_STATUS_SCHEMA__SAM_OPERATORS:
