...
public class SAMStatusVariableImpl extends EObjectImpl implements SAMStatusVariable {
	...
	public EList<SAMStatusValue> getSamStatusValues() {
		if (samStatusValues == null) {
			samStatusValues = new EObjectContainmentWithInverseEList<SAMStatusValue>(SAMStatusValue.class, this, Status_and_action_oldPackage.SAM_STATUS_VARIABLE__SAM_STATUS_VALUES, Status_and_action_oldPackage.SAM_STATUS_VALUE__SAM_STATUS_VARIABLE);
		}
