...
public class SAMSchemaVariableImpl extends EObjectImpl implements SAMSchemaVariable
{
  ...
  public EList<SAMSchemaValue> getSamSchemaValues()
  {
    ...
    {
      samSchemaValues = new EObjectContainmentWithInverseEList<SAMSchemaValue>(SAMSchemaValue.class, this, Status_and_action_oldPackage.SAM_SCHEMA_VARIABLE__SAM_SCHEMA_VALUES, Status_and_action_oldPackage.SAM_SCHEMA_VALUE__SAM_SCHEMA_VARIABLE);
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case Status_and_action_oldPackage.SAM_SCHEMA_VARIABLE__SAM_STATUS_SCHEMA:
        return getSamStatusSchema() != null;
      case Status_and_action_oldPackage.SAM_SCHEMA_VARIABLE__SAM_SCHEMA_VALUES:
