...
public class WhileLoopImpl extends ConditionalStatementImpl implements WhileLoop
{
  ...
  public EList<Block> getNestedBlocks()
  {
    ...
    {
      nestedBlocks = new EObjectContainmentWithInverseEList<Block>(Block.class, this, ActionsPackage.WHILE_LOOP__NESTED_BLOCKS, ActionsPackage.BLOCK__OWNING_STATEMENT);
    }
    return nestedBlocks;
  }
