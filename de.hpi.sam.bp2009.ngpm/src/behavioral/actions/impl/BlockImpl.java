...
public class BlockImpl extends FunctionSignatureImplementationImpl implements Block
{
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentWithInverseEList<Statement>(Statement.class, this, ActionsPackage.BLOCK__STATEMENTS, ActionsPackage.STATEMENT__BLOCK);
    }
    return statements;
  }
  ...
  public EList<NamedValue> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentWithInverseEList<NamedValue>(NamedValue.class, this, ActionsPackage.BLOCK__VARIABLES, ClassesPackage.NAMED_VALUE__OWNER);
    }
    return variables;
  }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case ActionsPackage.BLOCK__OWNING_STATEMENT:
        return getOwningStatement() != null;
    }
