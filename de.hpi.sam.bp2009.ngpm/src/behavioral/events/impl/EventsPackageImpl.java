	...
	protected void createDeAnnotations() {
		...
		addAnnotation
		  (subscriptionEClass, 
		   source, 
		   new String[] {
			 "SubscribingClassMatchProducer", "self.producer.notificationSignatures->forAll(ms:MethodSignature |\n    self.subscribingClass.allSignatures()->exists(s:MethodSignature|s.conformsTo(ms)))"
		   });				
		addAnnotation
		  (eventFilterEClass, 
		   source, 
		   new String[] {
			 "FilterBlockSignatureMatchNotificationSignature", "self.subscription.producer.notificationSignatures->exists(ms:MethodSignature |\n    ms.conformsTo(self.test.getImplementedSignature()))"
		   });		
	}
