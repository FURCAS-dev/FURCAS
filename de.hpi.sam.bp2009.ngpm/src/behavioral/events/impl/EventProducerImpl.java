...
public abstract class EventProducerImpl extends EObjectImpl implements EventProducer {
	...
	public EList<MethodSignature> getNotificationSignatures() {
		if (notificationSignatures == null) {
			notificationSignatures = new EObjectContainmentWithInverseEList<MethodSignature>(MethodSignature.class, this, EventsPackage.EVENT_PRODUCER__NOTIFICATION_SIGNATURES, ClassesPackage.METHOD_SIGNATURE__PRODUCER);
		}
