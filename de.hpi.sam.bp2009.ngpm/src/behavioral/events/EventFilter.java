 ...
 * @model annotation="http://de.hpi.sam.bp2009.OCL FilterBlockSignatureMatchNotificationSignature='self.subscription.producer.notificationSignatures->exists(ms:MethodSignature |\n    ms.conformsTo(self.test.getImplementedSignature()))'"
