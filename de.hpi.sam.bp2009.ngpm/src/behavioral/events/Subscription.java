 ...
 * @model annotation="http://de.hpi.sam.bp2009.OCL SubscribingClassMatchProducer='self.producer.notificationSignatures->forAll(ms:MethodSignature |\r\n    self.subscribingClass.allSignatures()->exists(s:MethodSignature|s.conformsTo(ms)))'"
...
public interface Subscription extends NamedElement
{
   ...
   * @model opposite="subscription" containment="true"
   * @generated
   */
