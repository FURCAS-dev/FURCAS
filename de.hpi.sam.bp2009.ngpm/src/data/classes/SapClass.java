 ...
 * <ul>
 *   <li>{@link data.classes.SapClass#getInstances <em>Instances</em>}</li>
...
public interface SapClass extends SignatureOwner, EventProducer
{
   ...
   * The list contents are of type {@link reflection.Object}.
   * It is bidirectional and its opposite is '{@link reflection.Object#getType <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see data.classes.ClassesPackage#getSapClass_Instances()
   * @see reflection.Object#getType
   * @model opposite="type"
   * @generated
   */
  EList<reflection.Object> getInstances();
   ...
   * @model opposite="subscribingClass" containment="true"
   * @generated
   */
   ...
   * @model opposite="businessObjectNode" containment="true"
   * @generated
   */
   ...
   * @model opposite="businessObject" containment="true"
   * @generated
   */
   ...
   * @model opposite="adapted" containment="true"
   * @generated
   */
   ...
   *        annotation="http://schema.omg.org/spec/MOF/2.0/emof.xml Property.oppositeRoleName='parameterOfClass'"
   * @generated
   */
   ...
   * @model opposite="theClass" containment="true"
   * @generated
   */
   ...
   * @model opposite="owningClassDefinition" containment="true"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model dataType="primitivetypes.Boolean"
   *        annotation="http://de.hpi.sam.bp2009.OCL body='if self.oclIsUndefined() then    false  else    self.conformsToExcluding(type, Sequence{}, Sequence{})  endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='if self.oclIsKindOf(ParameterizedClassInstantiation) then    self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.delegatesTo()  else    if self.oclIsKindOf(FormalTypeParameter) then      self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.delegatesTo())->flatten()->asSet()    else      self.getAssociationEnds().otherEnd()->select(delegation->notEmpty()).type.clazz->reject(c|c=self)->asSet()    endif  endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  SapClass delegatesTo();
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='self.signaturesWithDelegationExcluding(Set{})'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  MethodSignature signaturesWithDelegation();
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='self.delegatesTo().signaturesWithDelegation()->flatten()->asSet()'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  MethodSignature delegatedSignatures();
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='self.adaptedSignaturesExcluding(Set{})'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  MethodSignature adaptedSignatures();
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='if excluding->count(self)=0 then    if self.oclIsKindOf(ParameterizedClassInstantiation) then      self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.adaptedSignaturesExcluding(excluding->including(self))    else      if self.oclIsKindOf(FormalTypeParameter) then        self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.adaptedSignaturesExcluding(excluding->including(self)))->flatten()->asSet()      else        self.adapters.allSignaturesExcluding(excluding->including(self))          ->select(s | not self.ownedSignatures->exists(os | os.conformsTo(s)))          ->flatten()->asSet()      endif    endif  else    Set{}  endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  MethodSignature adaptedSignaturesExcluding(SapClass excluding);
   ...
   * Computes all locally-defined signatures plus those signatures offered by any Class (directly, or by delegation or recursively by type adaptation) attached to this class as a type adapter, plus allSignatures() recursively of all classes to which this class delegates.
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='if excluding->count(self)=0 then    if self.oclIsKindOf(ParameterizedClassInstantiation) then      self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.allSignaturesExcluding(excluding->including(self))    else      if self.oclIsKindOf(FormalTypeParameter) then        self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.allSignaturesExcluding(excluding->including(self)))->flatten()->asSet()      else        self.signaturesWithDelegationExcluding(excluding)->union(self.adaptedSignaturesExcluding(excluding))      endif    endif  else    Set{}      endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
   ...
   * Signature declared directly by this class and those signatures obtained by delegation, recursively.
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='if excluding->count(self)=0 then     if self.oclIsKindOf(ParameterizedClassInstantiation) then      self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.signaturesWithDelegationExcluding(excluding->including(self))    else      if self.oclIsKindOf(FormalTypeParameter) then        self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.signaturesWithDelegationExcluding(excluding->including(self)))->flatten()->asSet()      else        self.ownedSignatures->union(self.delegatesTo().signaturesWithDelegationExcluding(excluding->including(self)))->flatten()->asSet()      endif    endifelse  Set{}endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  MethodSignature signaturesWithDelegationExcluding(SapClass excluding);
   ...
   * Signatures obtained by delegation recursively.
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='if excluding->count(self)=0 then  self.delegatesTo().signaturesWithDelegationExcluding(excluding->including(self))->flatten()->asSet()else  Set{}endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  MethodSignature delegatedSignaturesExcluding(SapClass excluding);
   ...
   * @generated
   */
  AssociationEnd getEqualityRelevantAssociationEnds();
   ...
   * @generated
   */
  AssociationEnd getConformsToAssociationEnds();
   ...
   * @generated
   */
  AssociationEnd getConformsToCompositeParentAssociationEnds();
   ...
   * @generated
   */
  AssociationEnd getConformsToCompositeChildAssociationEnds();
