...
public interface InScope extends EObject
{
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='inner->union(outer->select(o | not inner->exists(i | i.name = o.name))->asSet())'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
  NamedValue addNamedValuesWithNewNames(NamedValue inner, NamedValue outer);
