...
public interface ClassTypeDefinition extends TypeDefinition
{
   ...
   * @model opposite="owningClassTypeDefinition" containment="true"
   * @generated
   */
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='self.objectParameters.value->flatten()->asSequence()->union(     Sequence{(self.objectParameters->size()+1)..(self.clazz.formalObjectParameters->size())}->collect(i |              self.clazz.formalObjectParameters->at(i).defaultValue->flatten()->asSequence()))->flatten()->asSequence()'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
