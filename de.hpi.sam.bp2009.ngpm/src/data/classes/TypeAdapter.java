...
public interface TypeAdapter extends SignatureOwner
{
   ...
   *        annotation="http://de.hpi.sam.bp2009.OCL body='type.signaturesWithDelegation()->forAll(typeSig:MethodSignature |    self.allSignatures()->exists(selfSig:MethodSignature |       selfSig.conformsToExcluding(typeSig, Sequence{self.to}, Sequence{type})))'"
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://de.hpi.sam.bp2009.OCL body='self.to.allSignaturesExcluding(excluding)->select(s |    not self.ownedSignatures->exists(os | os.conformsTo(s)))->union(  self.ownedSignatures)'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
