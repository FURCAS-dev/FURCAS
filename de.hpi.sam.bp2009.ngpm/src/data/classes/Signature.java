...
public interface Signature extends EObject
{
   ...
   * @model opposite="ownerSignature" containment="true"
   * @generated
   */
   ...
   * <!-- end-user-doc -->
   * @model dataType="primitivetypes.Boolean"
   *        annotation="http://de.hpi.sam.bp2009.OCL body='if self = s then    true  else    self.conformsToExcluding(s, Sequence{}, Sequence{})  endif'"
   ...
   * <!-- end-user-doc -->
   * @model kind="operation"
   *        annotation="http://de.hpi.sam.bp2009.OCL body='if self.oclIsKindOf(MethodSignature) then    let owner = self.oclAsType(MethodSignature).owner in    if owner.oclIsKindOf(SapClass) then      owner.oclAsType(SapClass)    else      null    -- e.g., TypeAdapter    endif  else    self.oclAsType(FunctionSignature).getImplementedAnonymousFunctionExpression().getOwningClass()  endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
