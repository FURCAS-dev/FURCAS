...
public class ClassTypeDefinitionImpl extends TypeDefinitionImpl implements ClassTypeDefinition {
	...
	public EList<ActualObjectParameter> getOwnedObjectParameters() {
		if (ownedObjectParameters == null) {
			ownedObjectParameters = new EObjectContainmentWithInverseEList<ActualObjectParameter>(ActualObjectParameter.class, this, ClassesPackage.CLASS_TYPE_DEFINITION__OWNED_OBJECT_PARAMETERS, ClassesPackage.ACTUAL_OBJECT_PARAMETER__OWNING_CLASS_TYPE_DEFINITION);
		}
