...
public class AssociationImpl extends NamedElementImpl implements Association {
	...
	public EList<AssociationEnd> getEnds() {
		if (ends == null) {
			ends = new EObjectContainmentWithInverseEList<AssociationEnd>(AssociationEnd.class, this, ClassesPackage.ASSOCIATION__ENDS, ClassesPackage.ASSOCIATION_END__ASSOCIATION);
		}
		return ends;
	}
