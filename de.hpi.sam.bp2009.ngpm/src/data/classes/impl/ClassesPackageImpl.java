...
public class ClassesPackageImpl extends EPackageImpl implements ClassesPackage
{
   ...
   * @generated
   */
  public EReference getSapClass_Instances()
  {
  ...
  {
    return (EReference)sapClassEClass.getEStructuralFeatures().get(6);
  }
  ...
  {
    return (EAttribute)sapClassEClass.getEStructuralFeatures().get(7);
  }
  ...
  {
    return (EReference)sapClassEClass.getEStructuralFeatures().get(18);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(sapClassEClass, SAP_CLASS__INSTANCES);
  ...
  public void initializePackageContents()
  {
    ...
    ReflectionPackage theReflectionPackage = (ReflectionPackage)EPackage.Registry.INSTANCE.getEPackage(ReflectionPackage.eNS_URI);
    ...
    initEAttribute(getSignature_SideEffectFree(), thePrimitivetypesPackage.getBoolean(), "sideEffectFree", null, 0, 1, Signature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    EOperation op = addEOperation(signatureEClass, thePrimitivetypesPackage.getBoolean(), "conformsTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSignature(), "s", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(signatureEClass, thePrimitivetypesPackage.getBoolean(), "conformsToExcluding", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSignature(), "s", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getAssociationEnd_Navigable(), thePrimitivetypesPackage.getBoolean(), "navigable", null, 0, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAssociationEnd_Composite(), thePrimitivetypesPackage.getBoolean(), "composite", null, 0, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAssociationEnd_ContributesToEquality(), thePrimitivetypesPackage.getBoolean(), "contributesToEquality", null, 0, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSapClass_Instances(), theReflectionPackage.getObject(), theReflectionPackage.getObject_Type(), "instances", null, 0, -1, SapClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getSapClass_ValueType(), thePrimitivetypesPackage.getBoolean(), "valueType", null, 0, 1, SapClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEOperation(sapClassEClass, thePrimitivetypesPackage.getBoolean(), "isAbstract", 0, 1, IS_UNIQUE, IS_ORDERED);

    addEOperation(sapClassEClass, thePrimitivetypesPackage.getBoolean(), "isParameterizedClassDefinition", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(sapClassEClass, thePrimitivetypesPackage.getBoolean(), "conformsTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    op = addEOperation(sapClassEClass, thePrimitivetypesPackage.getBoolean(), "conformsToExcluding", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "type", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingConforming", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getDelegation_AllFeatures(), thePrimitivetypesPackage.getBoolean(), "allFeatures", null, 0, 1, Delegation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    op = addEOperation(typedElementEClass, thePrimitivetypesPackage.getBoolean(), "conformsTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getMultiplicity_LowerMultiplicity(), thePrimitivetypesPackage.getInteger(), "lowerMultiplicity", null, 0, 1, Multiplicity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMultiplicity_UpperMultiplicity(), thePrimitivetypesPackage.getInteger(), "upperMultiplicity", null, 0, 1, Multiplicity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMultiplicity_Ordered(), thePrimitivetypesPackage.getBoolean(), "ordered", null, 0, 1, Multiplicity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMultiplicity_Unique(), thePrimitivetypesPackage.getBoolean(), "unique", null, 0, 1, Multiplicity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    addEOperation(multiplicityEClass, thePrimitivetypesPackage.getBoolean(), "isMany", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    op = addEOperation(classTypeDefinitionEClass, thePrimitivetypesPackage.getBoolean(), "objectParametersConformTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    op = addEOperation(typeDefinitionEClass, thePrimitivetypesPackage.getBoolean(), "conformsTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getTypeDefinition(), "typeDef", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(typeDefinitionEClass, thePrimitivetypesPackage.getBoolean(), "conformsToExcluding", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getTypeDefinition(), "td", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingConforming", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingTo", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(typeDefinitionEClass, thePrimitivetypesPackage.getBoolean(), "multiplicityConformsTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getTypeDefinition(), "td", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(typeDefinitionEClass, thePrimitivetypesPackage.getBoolean(), "conformsToIgnoringMultiplicityExcluding", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getTypeDefinition(), "td", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingConforming", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingTo", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(typeDefinitionEClass, thePrimitivetypesPackage.getBoolean(), "conformsToIgnoringMultiplicity", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getTypeDefinition(), "typeDef", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    addEOperation(typeDefinitionEClass, thePrimitivetypesPackage.getInteger(), "getNestingLevel", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getNestedTypeDefinition_Op(), thePrimitivetypesPackage.getString(), "op", null, 0, 1, NestedTypeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEOperation(methodSignatureEClass, thePrimitivetypesPackage.getBoolean(), "isAbstract", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    addEOperation(functionSignatureEClass, thePrimitivetypesPackage.getBoolean(), "isAbstract", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    op = addEOperation(typeAdapterEClass, thePrimitivetypesPackage.getBoolean(), "conformsTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "type", 0, 1, IS_UNIQUE, IS_ORDERED);

    op = addEOperation(typeAdapterEClass, thePrimitivetypesPackage.getBoolean(), "conformsToExcluding", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "type", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingConforming", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, this.getSapClass(), "excludingTo", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getPlatformSpecificImplementation_TargetPlatform(), thePrimitivetypesPackage.getString(), "targetPlatform", null, 0, 1, PlatformSpecificImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPlatformSpecificImplementation_Implementation(), thePrimitivetypesPackage.getString(), "implementation", null, 0, 1, PlatformSpecificImplementation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEOperation(functionSignatureImplementationEClass, thePrimitivetypesPackage.getBoolean(), "isSideEffectFree", 0, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getLinkManipulationAtPosition_At(), thePrimitivetypesPackage.getInteger(), "at", null, 0, 1, LinkManipulationAtPosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createDeAnnotations()
  {
    ...
    addAnnotation
      (signatureEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "if self = s then    true  else    self.conformsToExcluding(s, Sequence{}, Sequence{})  endif"
       });			
    addAnnotation
      (signatureEClass.getEOperations().get(1), 
       source, 
    ...
    addAnnotation
      (signatureEClass.getEOperations().get(3), 
       ...
       new String[] 
       {
       "body", "if self.oclIsKindOf(MethodSignature) then    let owner = self.oclAsType(MethodSignature).owner in    if owner.oclIsKindOf(SapClass) then      owner.oclAsType(SapClass)    else      null    -- e.g., TypeAdapter    endif  else    self.oclAsType(FunctionSignature).getImplementedAnonymousFunctionExpression().getOwningClass()  endif"
       });							
    addAnnotation
      (associationEndEClass, 
       source, 
    ...
    addAnnotation
      (sapClassEClass.getEOperations().get(2), 
       ...
       new String[] 
       {
       "body", "if self.oclIsUndefined() then    false  else    self.conformsToExcluding(type, Sequence{}, Sequence{})  endif"
       });				
    addAnnotation
      (sapClassEClass.getEOperations().get(3), 
       source, 
    ...
    addAnnotation
      (sapClassEClass.getEOperations().get(4), 
       ...
       new String[] 
       {
       "body", "if self.oclIsKindOf(ParameterizedClassInstantiation) then    self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.delegatesTo()  else    if self.oclIsKindOf(FormalTypeParameter) then      self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.delegatesTo())->flatten()->asSet()    else      self.getAssociationEnds().otherEnd()->select(delegation->notEmpty()).type.clazz->reject(c|c=self)->asSet()    endif  endif"
       });				
    addAnnotation
      (sapClassEClass.getEOperations().get(5), 
       source, 
    ...
    addAnnotation
      (sapClassEClass.getEOperations().get(9), 
       ...
       new String[] 
       {
       "body", "if excluding->count(self)=0 then    if self.oclIsKindOf(ParameterizedClassInstantiation) then      self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.adaptedSignaturesExcluding(excluding->including(self))    else      if self.oclIsKindOf(FormalTypeParameter) then        self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.adaptedSignaturesExcluding(excluding->including(self)))->flatten()->asSet()      else        self.adapters.allSignaturesExcluding(excluding->including(self))          ->select(s | not self.ownedSignatures->exists(os | os.conformsTo(s)))          ->flatten()->asSet()      endif    endif  else    Set{}  endif"
       });				
    addAnnotation
      (sapClassEClass.getEOperations().get(10), 
       source, 
       new String[] 
       {
       "body", "if excluding->count(self)=0 then    if self.oclIsKindOf(ParameterizedClassInstantiation) then      self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.allSignaturesExcluding(excluding->including(self))    else      if self.oclIsKindOf(FormalTypeParameter) then        self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.allSignaturesExcluding(excluding->including(self)))->flatten()->asSet()      else        self.signaturesWithDelegationExcluding(excluding)->union(self.adaptedSignaturesExcluding(excluding))      endif    endif  else    Set{}      endif"
       });				
    addAnnotation
      (sapClassEClass.getEOperations().get(11), 
       source, 
       new String[] 
       {
       "body", "if excluding->count(self)=0 then     if self.oclIsKindOf(ParameterizedClassInstantiation) then      self.oclAsType(ParameterizedClassInstantiation).parameterizedClass.signaturesWithDelegationExcluding(excluding->including(self))    else      if self.oclIsKindOf(FormalTypeParameter) then        self.oclAsType(FormalTypeParameter).typeConstraint->collect(c:SapClass | c.signaturesWithDelegationExcluding(excluding->including(self)))->flatten()->asSet()      else        self.ownedSignatures->union(self.delegatesTo().signaturesWithDelegationExcluding(excluding->including(self)))->flatten()->asSet()      endif    endifelse  Set{}endif"
       });				
    addAnnotation
      (sapClassEClass.getEOperations().get(12), 
       source, 
       new String[] 
       {
       "body", "if excluding->count(self)=0 then  self.delegatesTo().signaturesWithDelegationExcluding(excluding->including(self))->flatten()->asSet()else  Set{}endif"
       });				
    addAnnotation
      (sapClassEClass.getEOperations().get(13), 
       source, 
    ...
    addAnnotation
      (typedElementEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "self = typedElement or  self.getType().conformsTo(typedElement.getType())"
       });				
    addAnnotation
      (typedElementEClass.getEOperations().get(1), 
       source, 
    ...
    addAnnotation
      (signatureImplementationEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "if self.oclIsKindOf(FunctionSignatureImplementation) then    if self.oclAsType(FunctionSignatureImplementation).functionSignature->notEmpty() then      self.oclAsType(FunctionSignatureImplementation).functionSignature    else      self.implements_    endif  else    self.implements_  endif"
       });					
    addAnnotation
      (linkTraversalEClass, 
       source, 
    ...
    addAnnotation
      (classTypeDefinitionEClass.getEOperations().get(1), 
       ...
       new String[] 
       {
       "body", "self.objectParameters.value->flatten()->asSequence()->union(     Sequence{(self.objectParameters->size()+1)..(self.clazz.formalObjectParameters->size())}->collect(i |              self.clazz.formalObjectParameters->at(i).defaultValue->flatten()->asSequence()))->flatten()->asSequence()"
       });			
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(0), 
       source, 
       new String[] 
       {
       "body", "if self.oclIsUndefined() then    false  else if self = typeDef then    true  else    self.conformsToExcluding(typeDef, Sequence{}, Sequence{})  endif  endif"
       });			
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(1), 
       source, 
       new String[] 
       {
       "body", "if oclIsUndefined() then    false  else  if self = td then    true  else   self.multiplicityConformsTo(td) and   self.conformsToIgnoringMultiplicityExcluding(td, excludingConforming, excludingTo)  endif endif"
       });				
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(2), 
       source, 
    ...
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(4), 
       ...
       new String[] 
       {
       "body", "if self = typeDef then   true  else    self.conformsToIgnoringMultiplicityExcluding(typeDef, Sequence{}, Sequence{})  endif"
       });			
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(5), 
       source, 
    ...
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(6), 
       ...
       new String[] 
       {
       "body", "if self.oclIsKindOf(NestedTypeDefinition) then    self.oclAsType(NestedTypeDefinition).type.getInnermost()  else    self  endif"
       });				
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(7), 
       source, 
       new String[] 
       {
       "body", "if self.oclIsKindOf(NestedTypeDefinition) then    self.oclAsType(NestedTypeDefinition).type.getNestingLevel() + 1  else    0  endif"
       });			
    addAnnotation
      (typeDefinitionEClass.getEOperations().get(8), 
       source, 
    ...
    addAnnotation
      (functionSignatureEClass.getEOperations().get(1), 
       ...
       new String[] 
       {
       "body", "let candidates = self.typeDefinition.ownerTypedElement.oclAsType(AnonymousFunctionExpr)->asSequence() in  if candidates->isEmpty() then    null  else    candidates->at(1)  endif"
       });				
    addAnnotation
      (linkSettingEClass, 
       source, 
    ...
    addAnnotation
      (typeAdapterEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "type.signaturesWithDelegation()->forAll(typeSig:MethodSignature |    self.allSignatures()->exists(selfSig:MethodSignature |       selfSig.conformsToExcluding(typeSig, Sequence{self.to}, Sequence{type})))"
       });				
    addAnnotation
      (typeAdapterEClass.getEOperations().get(1), 
       source, 
    ...
    addAnnotation
      (typeAdapterEClass.getEOperations().get(3), 
       ...
       new String[] 
       {
       "body", "self.to.allSignaturesExcluding(excluding)->select(s |    not self.ownedSignatures->exists(os | os.conformsTo(s)))->union(  self.ownedSignatures)"
       });				
    addAnnotation
      (parameterEClass, 
       source, 
    ...
    addAnnotation
      (namedValueEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "self.owner.getNamedValuesInScope()->union(    if self.oclIsKindOf(Parameter) then      self.oclAsType(Parameter).ownerSignature.getNamedValuesInScope()    else      if self.oclIsKindOf(Iterator) then        self.oclAsType(Iterator).boundToFor.getNamedValuesInScope()->asSet()->union(        self.oclAsType(Iterator).\"iterate\".getNamedValuesInScope()->asSet())      else        if self.oclIsKindOf(Constant) then          self.oclAsType(Constant).\"iterate\".getNamedValuesInScope()        else          Set{}    -- TODO further cases?        endif      endif    endif    )"
       });					
    addAnnotation
      (extentModifyingAssociationEndSignatureImplementationEClass, 
       source, 
    ...
    addAnnotation
      (functionSignatureImplementationEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "if self.oclIsKindOf(Block) then    self.oclAsType(Block).localIsSideEffectFree()  else    if self.oclIsKindOf(CellSet) then      self.oclAsType(CellSet).localIsSideEffectFree()    else      false    endif  endif"
       });						
    addAnnotation
      (converterBetweenParametrizationsEClass, 
       source, 
