...
public abstract class SignatureImpl extends EObjectImpl implements Signature {
	...
	public EList<Parameter> getInput() {
		if (input == null) {
			input = new EObjectContainmentWithInverseEList<Parameter>(Parameter.class, this, ClassesPackage.SIGNATURE__INPUT, ClassesPackage.PARAMETER__OWNER_SIGNATURE);
		}
		return input;
	}
	...
	public EList<Constraint> getPostconditions() {
		if (postconditions == null) {
			postconditions = new EObjectContainmentEList<Constraint>(Constraint.class, this, ClassesPackage.SIGNATURE__POSTCONDITIONS);
		}
