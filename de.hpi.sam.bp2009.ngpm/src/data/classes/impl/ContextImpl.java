...
public class ContextImpl extends NamedElementImpl implements Context {
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, ClassesPackage.CONTEXT__CONSTRAINTS, ConstraintsPackage.CONSTRAINT__THE_CONTEXT);
		}
		return constraints;
	}
