 ...
 *   <li>{@link data.classes.impl.SapClassImpl#getInstances <em>Instances</em>}</li>
...
public class SapClassImpl extends SignatureOwnerImpl implements SapClass
{
   ...
   * @ordered
   */
  protected EList<reflection.Object> instances;
  ...
  public EList<MethodSignature> getNotificationSignatures()
  {
    ...
    {
      notificationSignatures = new EObjectContainmentWithInverseEList<MethodSignature>(MethodSignature.class, this, ClassesPackage.SAP_CLASS__NOTIFICATION_SIGNATURES, ClassesPackage.METHOD_SIGNATURE__PRODUCER);
    }
   ...
   * @generated
   */
  public EList<reflection.Object> getInstances()
  {
    if (instances == null)
    {
      instances = new EObjectWithInverseResolvingEList<reflection.Object>(reflection.Object.class, this, ClassesPackage.SAP_CLASS__INSTANCES, ReflectionPackage.OBJECT__TYPE);
    }
    return instances;
  }
  ...
  public EList<Subscription> getSubscription()
  {
    ...
    {
      subscription = new EObjectContainmentWithInverseEList<Subscription>(Subscription.class, this, ClassesPackage.SAP_CLASS__SUBSCRIPTION, EventsPackage.SUBSCRIPTION__SUBSCRIBING_CLASS);
    }
    return subscription;
  }
  ...
  public EList<SAMAction> getSamActions()
  {
    if (samActions == null)
    {
      samActions = new EObjectContainmentWithInverseEList<SAMAction>(SAMAction.class, this, ClassesPackage.SAP_CLASS__SAM_ACTIONS, Status_and_action_oldPackage.SAM_ACTION__BUSINESS_OBJECT_NODE);
    }
    return samActions;
  }
  ...
  public EList<SAMStatusVariable> getSamStatusVariables()
  {
    ...
    {
      samStatusVariables = new EObjectContainmentWithInverseEList<SAMStatusVariable>(SAMStatusVariable.class, this, ClassesPackage.SAP_CLASS__SAM_STATUS_VARIABLES, Status_and_action_oldPackage.SAM_STATUS_VARIABLE__BUSINESS_OBJECT_NODE);
    }
  ...
  public EList<SAMDerivator> getSamDerivators()
  {
    ...
    {
      samDerivators = new EObjectContainmentWithInverseEList<SAMDerivator>(SAMDerivator.class, this, ClassesPackage.SAP_CLASS__SAM_DERIVATORS, Status_and_action_oldPackage.SAM_DERIVATOR__BUSINESS_OBJECT);
    }
  ...
  public EList<SAMStatusSchema> getSamStatusSchema()
  {
    ...
    {
      samStatusSchema = new EObjectContainmentWithInverseEList<SAMStatusSchema>(SAMStatusSchema.class, this, ClassesPackage.SAP_CLASS__SAM_STATUS_SCHEMA, Status_and_action_oldPackage.SAM_STATUS_SCHEMA__BUSINESS_OBJECT_NODE);
    }
  ...
  public EList<TypeAdapter> getAdapters()
  {
    if (adapters == null)
    {
      adapters = new EObjectContainmentWithInverseEList<TypeAdapter>(TypeAdapter.class, this, ClassesPackage.SAP_CLASS__ADAPTERS, ClassesPackage.TYPE_ADAPTER__ADAPTED);
    }
    return adapters;
  }
  ...
  public EList<Constraint> getConstraints()
  {
    if (constraints == null)
    {
      constraints = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, ClassesPackage.SAP_CLASS__CONSTRAINTS, ConstraintsPackage.CONSTRAINT__CONSTRAINED_TYPE);
    }
    return constraints;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case ClassesPackage.SAP_CLASS__INSTANCES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ClassesPackage.SAP_CLASS__CONVERTER_BETWEEN_PARAMETRIZATIONS:
        return getConverterBetweenParametrizations();
      case ClassesPackage.SAP_CLASS__CONSTRAINTS:
        return getConstraints();
      case ClassesPackage.SAP_CLASS__TIME_DEPENDENCY:
        return getTimeDependency();
      case ClassesPackage.SAP_CLASS__PARAMETERIZATION:
        return getParameterization();
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ClassesPackage.SAP_CLASS__INSTANCES:
        getInstances().clear();
        getInstances().addAll((Collection<? extends reflection.Object>)newValue);
        return;
      case ClassesPackage.SAP_CLASS__SUBSCRIPTION:
