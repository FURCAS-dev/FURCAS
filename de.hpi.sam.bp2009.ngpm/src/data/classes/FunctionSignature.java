...
public interface FunctionSignature extends Signature
{
   ...
   * @model opposite="functionSignature" containment="true"
   * @generated
   */
   ...
   *        annotation="http://de.hpi.sam.bp2009.OCL body='let candidates = self.typeDefinition.ownerTypedElement.oclAsType(AnonymousFunctionExpr)->asSequence() in  if candidates->isEmpty() then    null  else    candidates->at(1)  endif'"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='body'"
   * @generated
   */
