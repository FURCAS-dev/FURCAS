...
public interface ClassesPackage extends EPackage
{
   ...
   * @ordered
   */
  int SAP_CLASS__INSTANCES = SIGNATURE_OWNER_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int SAP_CLASS__SUBSCRIPTION = SIGNATURE_OWNER_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int SAP_CLASS__SAM_ACTIONS = SIGNATURE_OWNER_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int SAP_CLASS__SAM_STATUS_VARIABLES = SIGNATURE_OWNER_FEATURE_COUNT + 5;
   ...
   * @ordered
   */
  int SAP_CLASS__SAM_DERIVATORS = SIGNATURE_OWNER_FEATURE_COUNT + 6;
   ...
   * @ordered
   */
  int SAP_CLASS__SAM_STATUS_SCHEMA = SIGNATURE_OWNER_FEATURE_COUNT + 7;
   ...
   * @ordered
   */
  int SAP_CLASS__BEHAVIOURAL_MODEL = SIGNATURE_OWNER_FEATURE_COUNT + 8;
   ...
   * @ordered
   */
  int SAP_CLASS__VALUE_TYPE = SIGNATURE_OWNER_FEATURE_COUNT + 9;
   ...
   * @ordered
   */
  int SAP_CLASS__SIGNATURES_WITH_FAULT = SIGNATURE_OWNER_FEATURE_COUNT + 10;
   ...
   * @ordered
   */
  int SAP_CLASS__ELEMENTS_OF_TYPE = SIGNATURE_OWNER_FEATURE_COUNT + 11;
   ...
   * @ordered
   */
  int SAP_CLASS__PACKAGE_ = SIGNATURE_OWNER_FEATURE_COUNT + 12;
   ...
   * @ordered
   */
  int SAP_CLASS__ADAPTED_BY = SIGNATURE_OWNER_FEATURE_COUNT + 13;
   ...
   * @ordered
   */
  int SAP_CLASS__ADAPTERS = SIGNATURE_OWNER_FEATURE_COUNT + 14;
   ...
   * @ordered
   */
  int SAP_CLASS__FORMAL_OBJECT_PARAMETERS = SIGNATURE_OWNER_FEATURE_COUNT + 15;
   ...
   * @ordered
   */
  int SAP_CLASS__CONVERTER_BETWEEN_PARAMETRIZATIONS = SIGNATURE_OWNER_FEATURE_COUNT + 16;
   ...
   * @ordered
   */
  int SAP_CLASS__CONSTRAINTS = SIGNATURE_OWNER_FEATURE_COUNT + 17;
   ...
   * @ordered
   */
  int SAP_CLASS__TIME_DEPENDENCY = SIGNATURE_OWNER_FEATURE_COUNT + 18;
   ...
   * @ordered
   */
  int SAP_CLASS__PARAMETERIZATION = SIGNATURE_OWNER_FEATURE_COUNT + 19;
   ...
   * @ordered
   */
  int SAP_CLASS__ABAP_ANNOTATION = SIGNATURE_OWNER_FEATURE_COUNT + 20;
   ...
   * @ordered
   */
  int SAP_CLASS_FEATURE_COUNT = SIGNATURE_OWNER_FEATURE_COUNT + 21;
  ...
  /**
   * Returns the meta object for the reference list '{@link data.classes.SapClass#getInstances <em>Instances</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  EReference getSapClass_Instances();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference SAP_CLASS__INSTANCES = eINSTANCE.getSapClass_Instances();
