...
public interface GenericsPackage extends EPackage
{
   ...
   * @ordered
   */
  int FORMAL_TYPE_PARAMETER__INSTANCES = ClassesPackage.SAP_CLASS__INSTANCES;
   ...
   * @ordered
   */
  int PARAMETERIZED_CLASS_INSTANTIATION__INSTANCES = ClassesPackage.SAP_CLASS__INSTANCES;
