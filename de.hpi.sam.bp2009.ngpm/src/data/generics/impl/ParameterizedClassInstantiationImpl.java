...
public class ParameterizedClassInstantiationImpl extends SapClassImpl implements ParameterizedClassInstantiation
{
  ...
  public EList<ActualTypeParameter> getActualTypeParametersForInstantiation()
  {
    ...
    {
      actualTypeParametersForInstantiation = new EObjectContainmentWithInverseEList<ActualTypeParameter>(ActualTypeParameter.class, this, GenericsPackage.PARAMETERIZED_CLASS_INSTANTIATION__ACTUAL_TYPE_PARAMETERS_FOR_INSTANTIATION, GenericsPackage.ACTUAL_TYPE_PARAMETER__PARAMETERIZED_CLASS_INSTANTIATION);
    }
