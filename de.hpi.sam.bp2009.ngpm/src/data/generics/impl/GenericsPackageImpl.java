  ...
  protected void createDeAnnotations()
  {
    ...
    addAnnotation
      (parameterizedClassInstantiationEClass.getEOperations().get(0), 
       ...
       new String[] 
       {
       "body", "self.actualTypeParametersForInstantiation->select(atp:ActualTypeParameter |    atp.formalTypeParameter = ftp)->asSequence()->at(1).type"
       });				
    addAnnotation
      (parameterizedClassInstantiationEClass.getEOperations().get(1), 
       source, 
