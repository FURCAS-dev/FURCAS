...
public class ClassParameterizationImpl extends EObjectImpl implements ClassParameterization {
	...
	public EList<FormalTypeParameter> getFormalTypeParameters() {
		if (formalTypeParameters == null) {
			formalTypeParameters = new EObjectContainmentWithInverseEList<FormalTypeParameter>(FormalTypeParameter.class, this, GenericsPackage.CLASS_PARAMETERIZATION__FORMAL_TYPE_PARAMETERS, GenericsPackage.FORMAL_TYPE_PARAMETER__PARAMETER_OF);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GenericsPackage.CLASS_PARAMETERIZATION__OWNING_CLASS_DEFINITION:
				return getOwningClassDefinition();
			case GenericsPackage.CLASS_PARAMETERIZATION__PACKAGE_:
				return getPackage_();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case GenericsPackage.CLASS_PARAMETERIZATION__OWNING_CLASS_DEFINITION:
				return getOwningClassDefinition() != null;
			case GenericsPackage.CLASS_PARAMETERIZATION__PACKAGE_:
