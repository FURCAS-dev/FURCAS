...
public class ConstraintImpl extends NamedElementImpl implements Constraint
{
  ...
  public EList<SeverityInState> getSeverityInState()
  {
    ...
    {
      severityInState = new EObjectContainmentEList<SeverityInState>(SeverityInState.class, this, ConstraintsPackage.CONSTRAINT__SEVERITY_IN_STATE);
    }
