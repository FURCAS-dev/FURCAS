...
public class ContextCategoryValueImpl extends ContextCategoryImpl implements ContextCategoryValue
{
  ...
  public EList<ContextCategoryValue> getChildren()
  {
    if (children == null)
    {
      children = new EObjectContainmentWithInverseEList<ContextCategoryValue>(ContextCategoryValue.class, this, Context_driversPackage.CONTEXT_CATEGORY_VALUE__CHILDREN, Context_driversPackage.CONTEXT_CATEGORY_VALUE__PARENT);
    }
    return children;
  }
