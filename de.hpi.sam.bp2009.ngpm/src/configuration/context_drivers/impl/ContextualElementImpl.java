...
public class ContextualElementImpl extends EObjectImpl implements ContextualElement {
	...
	public EList<ContexConfiguration> getContextualElementConfiguration() {
		if (contextualElementConfiguration == null) {
			contextualElementConfiguration = new EObjectContainmentWithInverseEList<ContexConfiguration>(ContexConfiguration.class, this, Context_driversPackage.CONTEXTUAL_ELEMENT__CONTEXTUAL_ELEMENT_CONFIGURATION, Context_driversPackage.CONTEX_CONFIGURATION__CONFIGURED_ELEMENT);
		}
