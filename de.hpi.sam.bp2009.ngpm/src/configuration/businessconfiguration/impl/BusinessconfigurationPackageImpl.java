...
public class BusinessconfigurationPackageImpl extends EPackageImpl implements BusinessconfigurationPackage
{
   ...
   * @generated
   */
  public EReference getValueSetEntry_CanBeChanged()
  {
    return (EReference)valueSetEntryEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getValueSetEntry_CanBeDeleted()
  {
    return (EReference)valueSetEntryEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(valueSetEClass, VALUE_SET__EXTENSIBLE);
    ...
    createEReference(valueSetEntryEClass, VALUE_SET_ENTRY__CAN_BE_CHANGED);
    createEReference(valueSetEntryEClass, VALUE_SET_ENTRY__CAN_BE_DELETED);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getValueSet_Extensible(), thePrimitivetypesPackage_1.getBoolean(), null, "extensible", null, 0, 1, ValueSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getValueSetEntry_CanBeChanged(), thePrimitivetypesPackage_1.getBoolean(), null, "canBeChanged", null, 0, 1, ValueSetEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getValueSetEntry_CanBeDeleted(), thePrimitivetypesPackage_1.getBoolean(), null, "canBeDeleted", null, 0, 1, ValueSetEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
