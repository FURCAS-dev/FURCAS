 ...
 *   <li>{@link configuration.businessconfiguration.impl.ValueSetImpl#getExtensible <em>Extensible</em>}</li>
...
public class ValueSetImpl extends NamedElementImpl implements ValueSet
{
  ...
  public NotificationChain basicSetExtensible(runtime.primitivetypes.Boolean newExtensible, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BusinessconfigurationPackage.VALUE_SET__EXTENSIBLE, oldExtensible, newExtensible);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExtensible(runtime.primitivetypes.Boolean newExtensible)
  {
    if (newExtensible != extensible)
    {
      NotificationChain msgs = null;
      if (extensible != null)
        msgs = ((InternalEObject)extensible).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BusinessconfigurationPackage.VALUE_SET__EXTENSIBLE, null, msgs);
      if (newExtensible != null)
        msgs = ((InternalEObject)newExtensible).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BusinessconfigurationPackage.VALUE_SET__EXTENSIBLE, null, msgs);
      msgs = basicSetExtensible(newExtensible, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BusinessconfigurationPackage.VALUE_SET__EXTENSIBLE, newExtensible, newExtensible));
  }
  ...
  public EList<ValueSetEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentWithInverseEList<ValueSetEntry>(ValueSetEntry.class, this, BusinessconfigurationPackage.VALUE_SET__ENTRIES, BusinessconfigurationPackage.VALUE_SET_ENTRY__VALUE_SET);
    }
    return entries;
  }
