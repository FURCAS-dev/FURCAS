...
public interface BusinessconfigurationPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Can Be Changed</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * The feature id for the '<em><b>Can Be Deleted</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for the containment reference '{@link configuration.businessconfiguration.ValueSet#getExtensible <em>Extensible</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Extensible</em>'.
   * @see configuration.businessconfiguration.ValueSet#getExtensible()
   * @see #getValueSet()
   * @generated
   */
  EReference getValueSet_Extensible();
  ...
  /**
   * Returns the meta object for the containment reference '{@link configuration.businessconfiguration.ValueSetEntry#getCanBeChanged <em>Can Be Changed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Can Be Changed</em>'.
   * @see configuration.businessconfiguration.ValueSetEntry#getCanBeChanged()
   * @see #getValueSetEntry()
   * @generated
   */
  EReference getValueSetEntry_CanBeChanged();

  /**
   * Returns the meta object for the containment reference '{@link configuration.businessconfiguration.ValueSetEntry#getCanBeDeleted <em>Can Be Deleted</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Can Be Deleted</em>'.
   * @see configuration.businessconfiguration.ValueSetEntry#getCanBeDeleted()
   * @see #getValueSetEntry()
   * @generated
   */
  EReference getValueSetEntry_CanBeDeleted();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference VALUE_SET__EXTENSIBLE = eINSTANCE.getValueSet_Extensible();
    ...
    /**
     * The meta object literal for the '<em><b>Can Be Changed</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference VALUE_SET_ENTRY__CAN_BE_CHANGED = eINSTANCE.getValueSetEntry_CanBeChanged();

    /**
     * The meta object literal for the '<em><b>Can Be Deleted</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference VALUE_SET_ENTRY__CAN_BE_DELETED = eINSTANCE.getValueSetEntry_CanBeDeleted();
