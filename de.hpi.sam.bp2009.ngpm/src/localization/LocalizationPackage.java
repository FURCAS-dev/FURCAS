...
public interface LocalizationPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Hint For Translator</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for the containment reference '{@link localization.TranslatableText#getText <em>Text</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  EReference getTranslatableText_Text();

  /**
   * Returns the meta object for the containment reference '{@link localization.TranslatableText#getHintForTranslator <em>Hint For Translator</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Hint For Translator</em>'.
   * @see localization.TranslatableText#getHintForTranslator()
   * @see #getTranslatableText()
   * @generated
   */
  EReference getTranslatableText_HintForTranslator();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference TRANSLATABLE_TEXT__TEXT = eINSTANCE.getTranslatableText_Text();

    /**
     * The meta object literal for the '<em><b>Hint For Translator</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference TRANSLATABLE_TEXT__HINT_FOR_TRANSLATOR = eINSTANCE.getTranslatableText_HintForTranslator();
