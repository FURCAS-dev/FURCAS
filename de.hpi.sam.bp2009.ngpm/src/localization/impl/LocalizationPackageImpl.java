...
public class LocalizationPackageImpl extends EPackageImpl implements LocalizationPackage
{
   ...
   * @generated
   */
  public EReference getTranslatableText_Text()
  {
    return (EReference)translatableTextEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getTranslatableText_HintForTranslator()
  {
    return (EReference)translatableTextEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(translatableTextEClass, TRANSLATABLE_TEXT__TEXT);
    createEReference(translatableTextEClass, TRANSLATABLE_TEXT__HINT_FOR_TRANSLATOR);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getTranslatableText_Text(), thePrimitivetypesPackage_1.getString(), null, "text", null, 0, 1, TranslatableText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTranslatableText_HintForTranslator(), thePrimitivetypesPackage_1.getString(), null, "hintForTranslator", null, 0, 1, TranslatableText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
