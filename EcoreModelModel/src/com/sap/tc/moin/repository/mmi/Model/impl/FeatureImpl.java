 ...
 * <ul>
 *   <li>{@link com.sap.tc.moin.repository.mmi.Model.impl.FeatureImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link com.sap.tc.moin.repository.mmi.Model.impl.FeatureImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FeatureImpl extends ModelElementImpl implements Feature {
	 ...
	 * @ordered
	 */
	protected static final ScopeKind SCOPE_EDEFAULT = ScopeKind.INSTANCE_LEVEL;
	...
	public void setScope(ScopeKind newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FEATURE__SCOPE, oldScope, scope));
	}
	...
	public void setVisibility(VisibilityKind newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FEATURE__VISIBILITY, oldVisibility, visibility));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.FEATURE__SCOPE:
				return getScope();
			case ModelPackage.FEATURE__VISIBILITY:
