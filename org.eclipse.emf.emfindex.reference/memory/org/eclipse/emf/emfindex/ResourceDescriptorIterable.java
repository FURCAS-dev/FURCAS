 ...
 * @author koehnlein
 */
public class ResourceDescriptorIterable extends AbstractPruningIterator<ResourceDescriptor> {

	public ResourceDescriptorIterable(Iterable<?> initialContents) {
		super(initialContents);
	}
	
	public ResourceDescriptorIterable(Object initialElement) {
	...
	protected boolean isReturnType(Object next) {
		return next instanceof ResourceDescriptor;
	}
