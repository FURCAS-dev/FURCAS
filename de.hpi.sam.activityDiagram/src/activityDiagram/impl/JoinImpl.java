 ...
 * <ul>
 *   <li>{@link activityDiagram.impl.JoinImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link activityDiagram.impl.JoinImpl#getIncomings <em>Incomings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinImpl extends ElementImpl implements Join {
		...
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityDiagramPackage.JOIN__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public void setOutgoing(ControlFlow newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramPackage.JOIN__OUTGOING, oldOutgoing, outgoing));
	}
	...
	public EList<ControlFlow> getIncomings() {
		if (incomings == null) {
			incomings = new EObjectResolvingEList<ControlFlow>(ControlFlow.class, this, ActivityDiagramPackage.JOIN__INCOMINGS);
		}
		return incomings;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityDiagramPackage.JOIN__OUTGOING:
				if (resolve) return getOutgoing();
				return basicGetOutgoing();
			case ActivityDiagramPackage.JOIN__INCOMINGS:
				return getIncomings();
		}
