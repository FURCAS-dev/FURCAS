...
public class ExecutionTimeBenchmarkerPackageImpl extends EPackageImpl implements ExecutionTimeBenchmarkerPackage {
	 ...
	 * @generated
	 */
	private EClass executionTimeBenchmarkerEClass = null;
	 ...
	 * @generated
	 */
	public EClass getExecutionTimeBenchmarker() {
		return executionTimeBenchmarkerEClass;
	}
	...
	public void createPackageContents() {
		...
		executionTimeBenchmarkerEClass = createEClass(EXECUTION_TIME_BENCHMARKER);
	...
	public void initializePackageContents() {
		...
		executionTimeBenchmarkerEClass.getESuperTypes().add(theBenchframeworkPackage.getBenchMarker());
		jetmResultObjectEClass.getESuperTypes().add(theBenchframeworkPackage.getResultObject());

		// Initialize classes and features; add operations and parameters
		initEClass(executionTimeBenchmarkerEClass, ExecutionTimeBenchmarker.class, "ExecutionTimeBenchmarker", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
