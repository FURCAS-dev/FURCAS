...
public class ExecutionTimeBenchmarkerAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExecutionTimeBenchmarkerSwitch<Adapter> modelSwitch =
		new ExecutionTimeBenchmarkerSwitch<Adapter>() {
			@Override
			public Adapter caseExecutionTimeBenchmarker(ExecutionTimeBenchmarker object) {
				return createExecutionTimeBenchmarkerAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseBenchMarker(BenchMarker object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link executionTimeBenchmarker.ExecutionTimeBenchmarker <em>Execution Time Benchmarker</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExecutionTimeBenchmarkerAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.benchframework.BenchMarker <em>Bench Marker</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
