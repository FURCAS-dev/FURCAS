...
public class ExecutionTimeBenchmarkerPackageImpl extends EPackageImpl implements ExecutionTimeBenchmarkerPackage {
	...
	public EAttribute getExecutionTimeBenchmarkerStart_Monitor() {
		return (EAttribute)executionTimeBenchmarkerStartEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getJETMMultiResultObject_Results() {
		return (EReference)jetmMultiResultObjectEClass.getEStructuralFeatures().get(0);
	}
	...
	public void initializePackageContents() {
		...
		executionTimeBenchmarkerStartEClass.getESuperTypes().add(theBenchframeworkPackage.getStartOperator());
		executionTimeBenchmarkerEndEClass.getESuperTypes().add(theBenchframeworkPackage.getEndOperator());
