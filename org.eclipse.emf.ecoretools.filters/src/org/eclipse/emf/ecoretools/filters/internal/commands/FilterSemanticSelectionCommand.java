 ...
 * 
 * $Id: FilterSemanticSelectionCommand.java,v 1.4 2008/04/28 09:55:15 jlescot Exp $
 **********************************************************************/
 ...
 *         Cannenterre</a>
 */
public class FilterSemanticSelectionCommand extends AbstractTransactionalCommand {

	private Diagram diagramToFilter;

	private List<EObject> typesToFilter;
	...
	public FilterSemanticSelectionCommand(TransactionalEditingDomain domain, Diagram diagramToFilter, List<EObject> typesToFilter, boolean show) {
		super(domain, Messages.FilterSemanticSelectionCommand_FilterSemantic, null);
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) {
		for (TreeIterator<EObject> it = diagramToFilter.eAllContents(); it.hasNext();) {
			...
			if (DiagramFilterUtil.isFilteredSemantic((View) currentDiagramElement, typesToFilter)) {
