...
import com.sap.ide.cts.parser.incremental.ITextBlockReuseStrategy;
...
public class ANTLRLexerAdapter implements LexerAdapter {
	...
	private ITextBlockReuseStrategy reuseStrategy = null;

	public Lexer getANTLRLexer() {
		return antlrLexer;
	}

	public ANTLRLexerAdapter(Lexer antlrLexer, ITextBlockReuseStrategy reuseStrategy, Connection conn) {
	...
	public int getState() {
		// TODO Does ANTLR support lexer states?
		return 0;
	}
	...
	public List<AbstractToken> moreTokens() {
		...
		if (nextToken == Token.EOF_TOKEN) {
			tokens.add((AbstractToken) TbVersionUtil.getOtherVersion(
