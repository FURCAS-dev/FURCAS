...
public interface IReferenceHandler {
	 ...
	 * @param subNode
	 */
	void setNewPrimitiveFeature(TextBlockProxy newVersion,
	...
	/**
	 * Uses the newly computed PropertyInits stored in the proxy that is
	 * attached to the <code>newVersion</code> to apply them to an existing model
	 * element. 
	 * It is important that the correct sequence of alternatives is chosen to find
	 * out which properties need to be transferred to the new element.  
	 * 
	 * @param oldVersion
	 * @param newVersion
	 */
	void reEvaluatePropertyInits(TextBlock oldVersion,
	 ...
	 * 
	 * @param the {@link SetNewFeatureBean} to unset.
	 */
	 ...
	 * 
	 * @param modelElement the model element from which the value should be retrieved.
	 * @param featureName the feature to get the value for.
	 * @return the value of the given feature from the given model element.
	 */
	Object getFeatureValue(RefObject modelElement,
		String featureName);
}
