...
public class DepartmentImpl extends EObjectImpl implements Department {
    ...
    /**
     * The cached value of the '{@link #getBoss() <em>Boss</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getBoss()
     * @generated
    ...
    public EList<Employee> getEmployee() {
        if (employee == null) {
            employee = new EObjectContainmentEList<Employee>(Employee.class, this, CompanyPackage.DEPARTMENT__EMPLOYEE);
        }
        return employee;
    }
    ...
    public void setBoss(Employee newBoss) {
        if (newBoss != boss) {
            ...
            if (boss != null)
                msgs = ((InternalEObject)boss).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompanyPackage.DEPARTMENT__BOSS, null, msgs);
            if (newBoss != null)
                msgs = ((InternalEObject)newBoss).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompanyPackage.DEPARTMENT__BOSS, null, msgs);
