...
public class CompanyValidator extends EObjectValidator {
     ...
     * @generated
     */
    protected static final String EMPLOYEE__DIV_BOSS_SECRETARY__EEXPRESSION = "if self.directed->isEmpty() then self.secretary.oclIsUndefined() else not self.secretary.oclIsUndefined() endif";
     ...
     * @generated
     */
    protected static final String EMPLOYEE__SECRETARY_OLDER_THAN_BOSS__EEXPRESSION = "if self.directed->notEmpty() and not self.secretary.oclIsUndefined() then self.age < self.secretary.age  else true endif";
     ...
     * @generated
     */
    protected static final String EMPLOYEE__SECRETARY10_YEARS_OLDER_THAN_BOSS__EEXPRESSION = "if self.directed->notEmpty() and not self.secretary.oclIsUndefined() then self.age + 10 < self.secretary.age  else true endif";
     ...
     * @generated
     */
    protected static final String DEPARTMENT__MAX_JUNIORS__EEXPRESSION = "self.employee->select(e|e.age < 25)->size() <self.maxJuniors";
     ...
     * @generated
     */
    protected static final String DEPARTMENT__BOSS10_YEARS_OLDER_THAN_JUNIOR__EEXPRESSION = "let t:Tuple(boss:Employee,junior:Employee)= Tuple{boss=self.boss, junior=self.employee->sortedBy(age)->first()} in t.boss.age > t.junior.age + 10";
     ...
     * @generated
     */
    protected static final String DEPARTMENT__MAX_JUNIORS_WARNING__EEXPRESSION = "if self.maxJuniors > 1 then self.employee->select(e|e.age < 25)->size() <self.maxJuniors - 1 else true endif";
     ...
     * @generated
     */
    protected static final String DIVISION__NASTY__EEXPRESSION = "self.department->collect(d|  d.employee->including(d.boss)).salary->sum() < budget";
