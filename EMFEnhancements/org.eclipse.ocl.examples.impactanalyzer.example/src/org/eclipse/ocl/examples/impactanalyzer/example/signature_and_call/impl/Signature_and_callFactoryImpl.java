...
public class Signature_and_callFactoryImpl extends EFactoryImpl implements Signature_and_callFactory {
    ...
    public static Signature_and_callFactory init() {
        try {
            Signature_and_callFactory theSignature_and_callFactory = (Signature_and_callFactory)EPackage.Registry.INSTANCE.getEFactory("http://eclipse.org/ocl/impactananalyzer/example/sac"); 
