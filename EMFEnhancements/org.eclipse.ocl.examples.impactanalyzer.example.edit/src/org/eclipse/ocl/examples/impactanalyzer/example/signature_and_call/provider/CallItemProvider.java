...
/**
 * This is the item provider adapter for a {@link org.eclipse.ocl.examples.impactanalyzer.example.signature_and_call.Call} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Call_signature_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Call_signature_feature", "_UI_Call_type"),
                 Signature_and_callPackage.Literals.CALL__SIGNATURE,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addArgumentsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Call_arguments_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Call_arguments_feature", "_UI_Call_type"),
                 Signature_and_callPackage.Literals.CALL__ARGUMENTS,
                 true,
                 false,
                 false,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(Signature_and_callPackage.Literals.CALL__ARGUMENTS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (Signature_and_callPackage.Literals.CALL__ARGUMENTS,
                 Signature_and_callFactory.eINSTANCE.createCall()));

        newChildDescriptors.add
            (createChildParameter
                (Signature_and_callPackage.Literals.CALL__ARGUMENTS,
                 Signature_and_callFactory.eINSTANCE.createStringLiteral()));
    }
