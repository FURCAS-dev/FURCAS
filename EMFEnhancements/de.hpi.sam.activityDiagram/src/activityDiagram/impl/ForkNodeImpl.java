 ...
 *   <li>{@link activityDiagram.impl.ForkNodeImpl#getOutgoings <em>Outgoings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForkNodeImpl extends NodeImpl implements ForkNode {
	...
	public EList<ControlFlow> getOutgoings() {
		if (outgoings == null) {
			outgoings = new EObjectResolvingEList<ControlFlow>(ControlFlow.class, this, ActivityDiagramPackage.FORK_NODE__OUTGOINGS);
		}
		return outgoings;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ActivityDiagramPackage.FORK_NODE__OUTGOINGS:
				return getOutgoings();
		}
