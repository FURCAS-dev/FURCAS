 ...
 * </copyright>
 *
 * $Id: ExpressionInOCLImpl.java,v 1.1 2007/01/25 18:29:09 cdamus Exp $
 */
...
public class ExpressionInOCLImpl extends EObjectImpl implements ExpressionInOCL {
    ...
    public NotificationChain basicSetBodyExpression(OCLExpression<EClassifier> newBodyExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcorePackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, oldBodyExpression, newBodyExpression);
    ...
    public void setBodyExpression(OCLExpression<EClassifier> newBodyExpression) {
        if (newBodyExpression != bodyExpression) {
            ...
            if (bodyExpression != null)
                msgs = ((InternalEObject)bodyExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcorePackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, null, msgs);
            if (newBodyExpression != null)
                msgs = ((InternalEObject)newBodyExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcorePackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, null, msgs);
            msgs = basicSetBodyExpression(newBodyExpression, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, newBodyExpression, newBodyExpression));
    }
    ...
    public NotificationChain basicSetContextVariable(Variable<EClassifier, EParameter> newContextVariable, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcorePackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, oldContextVariable, newContextVariable);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setContextVariable(Variable<EClassifier, EParameter> newContextVariable) {
        if (newContextVariable != contextVariable) {
            ...
            if (contextVariable != null)
                msgs = ((InternalEObject)contextVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcorePackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, null, msgs);
            if (newContextVariable != null)
                msgs = ((InternalEObject)newContextVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcorePackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, null, msgs);
            msgs = basicSetContextVariable(newContextVariable, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, newContextVariable, newContextVariable));
    }
    ...
    public NotificationChain basicSetResultVariable(Variable<EClassifier, EParameter> newResultVariable, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcorePackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, oldResultVariable, newResultVariable);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setResultVariable(Variable<EClassifier, EParameter> newResultVariable) {
        if (newResultVariable != resultVariable) {
            ...
            if (resultVariable != null)
                msgs = ((InternalEObject)resultVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcorePackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, null, msgs);
            if (newResultVariable != null)
                msgs = ((InternalEObject)newResultVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcorePackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, null, msgs);
            msgs = basicSetResultVariable(newResultVariable, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, newResultVariable, newResultVariable));
    }
    ...
    public EList<Variable<EClassifier, EParameter>> getParameterVariable() {
        if (parameterVariable == null) {
            parameterVariable = new EObjectContainmentEList<Variable<EClassifier, EParameter>>(Variable.class, this, EcorePackage.EXPRESSION_IN_OCL__PARAMETER_VARIABLE);
        }
