 ...
 * </copyright>
 *
 * $Id: CollectionItemImpl.java,v 1.4 2008/03/28 20:33:41 cdamus Exp $
 */
...
public class CollectionItemImpl extends CollectionLiteralPartImpl implements CollectionItem {
     ...
     * @generated
     */
	public NotificationChain basicSetItem(OCLExpression<EClassifier> newItem, NotificationChain msgs) {
        OCLExpression<EClassifier> oldItem = item;
        item = newItem;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcorePackage.COLLECTION_ITEM__ITEM, oldItem, newItem);
	...
	public void setItem(OCLExpression<EClassifier> newItem) {
        if (newItem != item) {
            ...
            if (item != null)
                msgs = ((InternalEObject)item).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcorePackage.COLLECTION_ITEM__ITEM, null, msgs);
            if (newItem != null)
                msgs = ((InternalEObject)newItem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcorePackage.COLLECTION_ITEM__ITEM, null, msgs);
            msgs = basicSetItem(newItem, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.COLLECTION_ITEM__ITEM, newItem, newItem));
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == org.eclipse.ocl.expressions.CollectionItem.class) {
            switch (derivedFeatureID) {
                case EcorePackage.COLLECTION_ITEM__ITEM: return ExpressionsPackage.COLLECTION_ITEM__ITEM;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == org.eclipse.ocl.expressions.CollectionItem.class) {
            switch (baseFeatureID) {
                case ExpressionsPackage.COLLECTION_ITEM__ITEM: return EcorePackage.COLLECTION_ITEM__ITEM;
                default: return -1;
            }
        }
