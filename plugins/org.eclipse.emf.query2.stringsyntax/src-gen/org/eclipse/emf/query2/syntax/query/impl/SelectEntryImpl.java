 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.syntax.query.impl.SelectEntryImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.syntax.query.impl.SelectEntryImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectEntryImpl extends MinimalEObjectImpl.Container implements SelectEntry
{
  ...
  {
    return QueryPackage.Literals.SELECT_ENTRY;
  }
    ...
    if (select != null && select.eIsProxy())
    {
      ...
      if (select != oldSelect)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.SELECT_ENTRY__SELECT, oldSelect, select));
      }
    }
    return select;
  }
  ...
  public void setSelect(FromEntry newSelect)
  {
    ...
    select = newSelect;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.SELECT_ENTRY__SELECT, oldSelect, select));
  }
  ...
  public EAttribute getAttribute()
  {
    if (attribute != null && attribute.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.SELECT_ENTRY__ATTRIBUTE, oldAttribute, attribute));
      }
    }
    return attribute;
  }
  ...
  public void setAttribute(EAttribute newAttribute)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.SELECT_ENTRY__ATTRIBUTE, oldAttribute, attribute));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QueryPackage.SELECT_ENTRY__SELECT:
        if (resolve) return getSelect();
        return basicGetSelect();
      case QueryPackage.SELECT_ENTRY__ATTRIBUTE:
