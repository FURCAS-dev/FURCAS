 ...
 * </copyright>
 *
 * $Id: VariableImpl.java,v 1.7 2008/04/27 23:48:06 cdamus Exp $
 */
...
public class VariableImpl extends TypedElementImpl implements Variable {
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__END_POSITION, oldEndPosition, endPosition));
	}
	...
	public void setTypeStartPosition(int newTypeStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__TYPE_START_POSITION, oldTypeStartPosition, typeStartPosition));
	}
	...
	public void setTypeEndPosition(int newTypeEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__TYPE_END_POSITION, oldTypeEndPosition, typeEndPosition));
	}
	...
	public NotificationChain basicSetInitExpression(OCLExpression<Classifier> newInitExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__INIT_EXPRESSION, oldInitExpression, newInitExpression);
	...
	public void setInitExpression(OCLExpression<Classifier> newInitExpression) {
		if (newInitExpression != initExpression) {
			...
			if (initExpression != null)
				msgs = ((InternalEObject)initExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLPackage.VARIABLE__INIT_EXPRESSION, null, msgs);
			if (newInitExpression != null)
				msgs = ((InternalEObject)newInitExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.VARIABLE__INIT_EXPRESSION, null, msgs);
			msgs = basicSetInitExpression(newInitExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__INIT_EXPRESSION, newInitExpression, newInitExpression));
	}
	...
	public Parameter getRepresentedParameter() {
		if (representedParameter != null && ((EObject)representedParameter).eIsProxy()) {
			...
			if (representedParameter != oldRepresentedParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.VARIABLE__REPRESENTED_PARAMETER, oldRepresentedParameter, representedParameter));
			}
		}
	...
	public void setRepresentedParameter(Parameter newRepresentedParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VARIABLE__REPRESENTED_PARAMETER, oldRepresentedParameter, representedParameter));
	}
    ...
    public boolean checkInitType(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return org.eclipse.ocl.expressions.operations.VariableOperations.checkInitType(this, diagnostics, context);
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ASTNode.class) {
			switch (derivedFeatureID) {
				case UMLPackage.VARIABLE__START_POSITION: return UtilitiesPackage.AST_NODE__START_POSITION;
				case UMLPackage.VARIABLE__END_POSITION: return UtilitiesPackage.AST_NODE__END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == TypedASTNode.class) {
			switch (derivedFeatureID) {
				case UMLPackage.VARIABLE__TYPE_START_POSITION: return UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION;
				case UMLPackage.VARIABLE__TYPE_END_POSITION: return UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == org.eclipse.ocl.expressions.Variable.class) {
			switch (derivedFeatureID) {
				case UMLPackage.VARIABLE__INIT_EXPRESSION: return ExpressionsPackage.VARIABLE__INIT_EXPRESSION;
				case UMLPackage.VARIABLE__REPRESENTED_PARAMETER: return ExpressionsPackage.VARIABLE__REPRESENTED_PARAMETER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ASTNode.class) {
			switch (baseFeatureID) {
				case UtilitiesPackage.AST_NODE__START_POSITION: return UMLPackage.VARIABLE__START_POSITION;
				case UtilitiesPackage.AST_NODE__END_POSITION: return UMLPackage.VARIABLE__END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == TypedASTNode.class) {
			switch (baseFeatureID) {
				case UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION: return UMLPackage.VARIABLE__TYPE_START_POSITION;
				case UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION: return UMLPackage.VARIABLE__TYPE_END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == org.eclipse.ocl.expressions.Variable.class) {
			switch (baseFeatureID) {
				case ExpressionsPackage.VARIABLE__INIT_EXPRESSION: return UMLPackage.VARIABLE__INIT_EXPRESSION;
				case ExpressionsPackage.VARIABLE__REPRESENTED_PARAMETER: return UMLPackage.VARIABLE__REPRESENTED_PARAMETER;
				default: return -1;
			}
		}
