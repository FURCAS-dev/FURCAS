 ...
 * </copyright>
 *
 * $Id: MessageTypeImpl.java,v 1.9 2008/04/27 23:48:06 cdamus Exp $
 */
...
public class MessageTypeImpl extends ClassifierImpl implements MessageType {
    ...
    public boolean checkExclusiveSignature(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return org.eclipse.ocl.types.operations.MessageTypeOperations.checkExclusiveSignature(this, diagnostics, context);
	}
    ...
    public boolean checkOperationParameters(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return org.eclipse.ocl.types.operations.MessageTypeOperations.checkOperationParameters(this, diagnostics, context);
	}
    ...
    public boolean checkSignalAttributes(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return org.eclipse.ocl.types.operations.MessageTypeOperations.checkSignalAttributes(this, diagnostics, context);
	}
