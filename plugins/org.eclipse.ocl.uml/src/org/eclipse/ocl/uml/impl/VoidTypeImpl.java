 ...
 * </copyright>
 *
 * $Id: VoidTypeImpl.java,v 1.6 2008/03/28 20:26:21 cdamus Exp $
 */
...
public class VoidTypeImpl extends ClassifierImpl implements VoidType {
    ...
    public EList<Operation> getOwnedOperations() {
        if (ownedOperations == null) {
            ownedOperations = new EObjectContainmentEList<Operation>(Operation.class, this, UMLPackage.VOID_TYPE__OWNED_OPERATION);
        }
    ...
    @Override
        ...
        if (cache != null) {
            ...
            if (features == null) {
                cache.put(eResource, this, org.eclipse.uml2.uml.UMLPackage.Literals.CLASSIFIER__FEATURE, features = new DerivedUnionEObjectEList<Feature>(Feature.class, this, UMLPackage.VOID_TYPE__FEATURE, FEATURE_ESUBSETS));
            }
            return features;
        }
        return new DerivedUnionEObjectEList<Feature>(Feature.class, this, UMLPackage.VOID_TYPE__FEATURE, FEATURE_ESUBSETS);
    }
     ...
     * @ordered
     */
    protected static final int[] FEATURE_ESUBSETS = new int[] {UMLPackage.VOID_TYPE__ATTRIBUTE, UMLPackage.VOID_TYPE__OWNED_OPERATION};
