 ...
 * </copyright>
 *
 * $Id: MessageExpImpl.java,v 1.4 2007/10/11 23:04:56 cdamus Exp $
 */
 ...
 * @generated
 */
public class MessageExpImpl<C, COA, SSA> extends OCLExpressionImpl<C> implements MessageExp<C, COA, SSA> {
	/**
     ...
     * @generated
     */
	public NotificationChain basicSetTarget(OCLExpression<C> newTarget, NotificationChain msgs) {
	...
	public EList<OCLExpression<C>> getArgument() {
        if (argument == null) {
            argument = new EObjectContainmentEList<OCLExpression<C>>(OCLExpression.class, this, ExpressionsPackage.MESSAGE_EXP__ARGUMENT);
        }
        return argument;
    }
     ...
     * @generated
     */
	public NotificationChain basicSetCalledOperation(COA newCalledOperation, NotificationChain msgs) {
     ...
     * @generated
     */
	public NotificationChain basicSetSentSignal(SSA newSentSignal, NotificationChain msgs) {
	...
	public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case ExpressionsPackage.MESSAGE_EXP__ARGUMENT:
                getArgument().clear();
                getArgument().addAll((Collection<? extends OCLExpression<C>>)newValue);
                return;
            case ExpressionsPackage.MESSAGE_EXP__CALLED_OPERATION:
