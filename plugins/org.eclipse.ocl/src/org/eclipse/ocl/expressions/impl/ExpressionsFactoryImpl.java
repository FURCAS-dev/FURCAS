 ...
 * </copyright>
 *
 * $Id: ExpressionsFactoryImpl.java,v 1.1 2007/01/25 18:24:38 cdamus Exp $
 */
...
public class ExpressionsFactoryImpl extends EFactoryImpl implements ExpressionsFactory {
	...
	public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case ExpressionsPackage.COLLECTION_LITERAL_PART: return createCollectionLiteralPart();
     ...
     * @generated
     */
	public <C> CollectionLiteralPart<C> createCollectionLiteralPart() {
        CollectionLiteralPartImpl<C> collectionLiteralPart = new CollectionLiteralPartImpl<C>();
