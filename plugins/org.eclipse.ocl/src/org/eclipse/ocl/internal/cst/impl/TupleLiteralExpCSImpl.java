 ...
 * </copyright>
 *
 * $Id: TupleLiteralExpCSImpl.java,v 1.1 2007/01/25 18:24:37 cdamus Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.internal.cst.impl.TupleLiteralExpCSImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleLiteralExpCSImpl extends LiteralExpCSImpl implements TupleLiteralExpCS {
	...
	public EList<VariableCS> getVariables() {
        if (variables == null) {
            variables = new EObjectResolvingEList<VariableCS>(VariableCS.class, this, CSTPackage.TUPLE_LITERAL_EXP_CS__VARIABLES);
        }
        return variables;
    }
