 ...
 * </copyright>
 *
 * $Id: CSTPackageImpl.java,v 1.4 2007/04/30 12:38:59 cdamus Exp $
 */
...
public class CSTPackageImpl extends EPackageImpl implements CSTPackage {
	...
	public void initializePackageContents() {
        ...
        initEAttribute(getCSTNode_StartOffset(), ecorePackage.getEInt(), "startOffset", "0", 0, 1, CSTNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
        initEAttribute(getCSTNode_EndOffset(), ecorePackage.getEInt(), "endOffset", "0", 0, 1, CSTNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
