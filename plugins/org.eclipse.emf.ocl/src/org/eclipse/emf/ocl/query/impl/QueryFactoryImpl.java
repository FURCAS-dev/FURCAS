 ...
 * </copyright>
 *
 * $Id: QueryFactoryImpl.java,v 1.3 2007/02/14 14:45:40 cdamus Exp $
 */
...
public class QueryFactoryImpl extends EFactoryImpl implements QueryFactory {
	...
	public static QueryFactory init() {
		try {
			QueryFactory theQueryFactory = (QueryFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/OCL2/1.0.0/ocl/query"); //$NON-NLS-1$ 
