 ...
 * </copyright>
 *
 * $Id: MessageExpCSImpl.java,v 1.1 2006/04/04 18:09:04 cdamus Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ocl.internal.cst.impl.MessageExpCSImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.eclipse.emf.ocl.internal.cst.impl.MessageExpCSImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.eclipse.emf.ocl.internal.cst.impl.MessageExpCSImpl#getSimpleNameCS <em>Simple Name CS</em>}</li>
 *   <li>{@link org.eclipse.emf.ocl.internal.cst.impl.MessageExpCSImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageExpCSImpl extends OCLExpressionCSImpl implements MessageExpCS {
	 ...
	 * @ordered
	 */
	protected OCLExpressionCS target = null;
	...
	public SimpleNameCS getSimpleNameCS() {
		if (simpleNameCS != null && simpleNameCS.eIsProxy()) {
			...
			if (simpleNameCS != oldSimpleNameCS) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CSTPackage.MESSAGE_EXP_CS__SIMPLE_NAME_CS, oldSimpleNameCS, simpleNameCS));
			}
		}
		return simpleNameCS;
	}
	...
	public void setSimpleNameCS(SimpleNameCS newSimpleNameCS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSTPackage.MESSAGE_EXP_CS__SIMPLE_NAME_CS, oldSimpleNameCS, simpleNameCS));
	}
	...
	public EList getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList(OCLMessageArgCS.class, this, CSTPackage.MESSAGE_EXP_CS__ARGUMENTS);
		}
		return arguments;
	}
