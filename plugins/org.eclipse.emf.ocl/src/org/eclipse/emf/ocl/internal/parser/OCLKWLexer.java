...
* </copyright>
*
* $Id: OCLKWLexer.java,v 1.1 2006/04/04 18:09:05 cdamus Exp $
*/
...
public class OCLKWLexer extends OCLKWLexerprs implements OCLLPGParsersym
{
    ...
    public OCLKWLexer(char[] inputChars, int identifierKind)
    {
        ...
        //
        // Rule 52:  KeyWord ::= R e a l
        //
		keywordKind[52] = (TK_Real);
	  
	
        //
        // Rule 53:  KeyWord ::= B o o l e a n
        //
		keywordKind[53] = (TK_Boolean);
	  
	
        //
        // Rule 54:  KeyWord ::= T u p l e
        //
		keywordKind[54] = (TK_Tuple);
	  
	
        //
        // Rule 55:  KeyWord ::= O c l A n y
        //
		keywordKind[55] = (TK_OclAny);
	  
	
        //
        // Rule 56:  KeyWord ::= O c l V o i d
        //
		keywordKind[56] = (TK_OclVoid);
	  
	
        //
        // Rule 57:  KeyWord ::= I n v a l i d
        //
		keywordKind[57] = (TK_Invalid);
	  
	
        //
        // Rule 58:  KeyWord ::= O c l M e s s a g e
        //
		keywordKind[58] = (TK_OclMessage);
	  
	
        //
        // Rule 59:  KeyWord ::= n u l l
        //
		keywordKind[59] = (TK_null);
	  
	
        //
        // Rule 60:  KeyWord ::= O c l I n v a l i d
        //
		keywordKind[60] = (TK_OclInvalid);
