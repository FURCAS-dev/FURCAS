...
public class OclEnginePlugin
	...
	//The shared instance.
	private static OclEnginePlugin INSTANCE = new OclEnginePlugin();
	 ...
	 */
	public static OclEnginePlugin getInstance() {
		return INSTANCE;
	}
	...
	public static void catching(Class clazz, String methodName,
		Throwable throwable) {
		if (shouldTrace(OclEngineDebugOptions.EXCEPTIONS_CATCHING)) {
	...
	public static void throwing(Class clazz, String methodName,
		Throwable throwable) {
		if (shouldTrace(OclEngineDebugOptions.EXCEPTIONS_THROWING)) {
	...
	public static void info(String message) {
		info(OclEngineStatusCodes.OK, message);
	}
