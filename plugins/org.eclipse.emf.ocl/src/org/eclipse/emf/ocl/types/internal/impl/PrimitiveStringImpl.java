...
public class PrimitiveStringImpl extends PrimitiveTypeImpl implements PrimitiveString {
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getPrimitiveString();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case TypesPackage.PRIMITIVE_STRING__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case TypesPackage.PRIMITIVE_STRING__EPACKAGE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, TypesPackage.PRIMITIVE_STRING__EPACKAGE, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case TypesPackage.PRIMITIVE_STRING__EPACKAGE:
					return eBasicSetContainer(null, TypesPackage.PRIMITIVE_STRING__EPACKAGE, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case TypesPackage.PRIMITIVE_STRING__NAME:
				return getName();
			case TypesPackage.PRIMITIVE_STRING__INSTANCE_CLASS_NAME:
				return getInstanceClassName();
			case TypesPackage.PRIMITIVE_STRING__INSTANCE_CLASS:
				return getInstanceClass();
			case TypesPackage.PRIMITIVE_STRING__DEFAULT_VALUE:
				return getDefaultValue();
			case TypesPackage.PRIMITIVE_STRING__EPACKAGE:
				return getEPackage();
			case TypesPackage.PRIMITIVE_STRING__SERIALIZABLE:
