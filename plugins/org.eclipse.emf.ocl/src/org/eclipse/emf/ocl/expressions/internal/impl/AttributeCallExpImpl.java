...
public class AttributeCallExpImpl extends ModelPropertyCallExpImpl implements AttributeCallExp {
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.eINSTANCE.getAttributeCallExp();
	}
	...
	public EAttribute getReferredAttribute() {
		if (referredAttribute != null && referredAttribute.eIsProxy()) {
			...
			referredAttribute = (EAttribute)eResolveProxy((InternalEObject)referredAttribute);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__APPLIED_PROPERTY:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, ExpressionsPackage.ATTRIBUTE_CALL_EXP__APPLIED_PROPERTY, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__INITIALIZED_VARIABLE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, ExpressionsPackage.ATTRIBUTE_CALL_EXP__INITIALIZED_VARIABLE, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__PARENT_OPERATION:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, ExpressionsPackage.ATTRIBUTE_CALL_EXP__PARENT_OPERATION, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__SOURCE:
					if (source != null)
						msgs = ((InternalEObject)source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.ATTRIBUTE_CALL_EXP__SOURCE, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__APPLIED_PROPERTY:
					return eBasicSetContainer(null, ExpressionsPackage.ATTRIBUTE_CALL_EXP__APPLIED_PROPERTY, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__INITIALIZED_VARIABLE:
					return eBasicSetContainer(null, ExpressionsPackage.ATTRIBUTE_CALL_EXP__INITIALIZED_VARIABLE, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__PARENT_OPERATION:
					return eBasicSetContainer(null, ExpressionsPackage.ATTRIBUTE_CALL_EXP__PARENT_OPERATION, msgs);
				case ExpressionsPackage.ATTRIBUTE_CALL_EXP__SOURCE:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__NAME:
				return getName();
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__START_POSITION:
				return new Integer(getStartPosition());
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__END_POSITION:
			...
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__PROPERTY_START_POSITION:
				return new Integer(getPropertyStartPosition());
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__PROPERTY_END_POSITION:
				return new Integer(getPropertyEndPosition());
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__SOURCE:
				return getSource();
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP__MARKED_PRE:
