 ...
 * </copyright>
 *
 * $Id: CollectionLiteralExpImpl.java,v 1.2 2007/02/14 14:45:39 cdamus Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ocl.expressions.impl.CollectionLiteralExpImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.eclipse.emf.ocl.expressions.impl.CollectionLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionLiteralExpImpl
	...
	public EList getPart() {
		if (part == null) {
			part = new EObjectContainmentEList(CollectionLiteralPart.class, this, ExpressionsPackage.COLLECTION_LITERAL_EXP__PART);
		}
		return part;
	}
