...
public abstract class LiteralExpImpl extends OclExpressionImpl implements LiteralExp {
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.eINSTANCE.getLiteralExp();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case ExpressionsPackage.LITERAL_EXP__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case ExpressionsPackage.LITERAL_EXP__APPLIED_PROPERTY:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, ExpressionsPackage.LITERAL_EXP__APPLIED_PROPERTY, msgs);
				case ExpressionsPackage.LITERAL_EXP__INITIALIZED_VARIABLE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, ExpressionsPackage.LITERAL_EXP__INITIALIZED_VARIABLE, msgs);
				case ExpressionsPackage.LITERAL_EXP__PARENT_OPERATION:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, ExpressionsPackage.LITERAL_EXP__PARENT_OPERATION, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case ExpressionsPackage.LITERAL_EXP__APPLIED_PROPERTY:
					return eBasicSetContainer(null, ExpressionsPackage.LITERAL_EXP__APPLIED_PROPERTY, msgs);
				case ExpressionsPackage.LITERAL_EXP__INITIALIZED_VARIABLE:
					return eBasicSetContainer(null, ExpressionsPackage.LITERAL_EXP__INITIALIZED_VARIABLE, msgs);
				case ExpressionsPackage.LITERAL_EXP__PARENT_OPERATION:
					return eBasicSetContainer(null, ExpressionsPackage.LITERAL_EXP__PARENT_OPERATION, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case ExpressionsPackage.LITERAL_EXP__NAME:
				return getName();
			case ExpressionsPackage.LITERAL_EXP__START_POSITION:
				return new Integer(getStartPosition());
			case ExpressionsPackage.LITERAL_EXP__END_POSITION:
			...
			case ExpressionsPackage.LITERAL_EXP__TYPE:
