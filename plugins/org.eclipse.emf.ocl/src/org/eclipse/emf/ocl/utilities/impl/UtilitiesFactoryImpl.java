 ...
 * </copyright>
 *
 * $Id: UtilitiesFactoryImpl.java,v 1.3 2007/02/14 14:45:40 cdamus Exp $
 */
...
public class UtilitiesFactoryImpl
	...
	public static UtilitiesFactory init() {
		try {
			UtilitiesFactory theUtilitiesFactory = (UtilitiesFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/OCL2/1.0.0/ocl/utilities"); //$NON-NLS-1$ 
