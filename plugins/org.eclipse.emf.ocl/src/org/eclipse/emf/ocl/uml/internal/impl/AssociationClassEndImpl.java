...
public class AssociationClassEndImpl extends EReferenceImpl implements AssociationClassEnd {
	...
	protected EClass eStaticClass() {
		return UmlPackage.eINSTANCE.getAssociationClassEnd();
	}
	...
	public EClass getAssociationClass() {
		if (associationClass != null && associationClass.eIsProxy()) {
			...
			associationClass = (EClass)eResolveProxy((InternalEObject)associationClass);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int structuralFeatureID, Class baseClass, NotificationChain msgs) {
		if (structuralFeatureID >= 0) {
			switch (eDerivedStructuralFeatureID(structuralFeatureID, baseClass)) {
				case UmlPackage.ASSOCIATION_CLASS_END__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case UmlPackage.ASSOCIATION_CLASS_END__ECONTAINING_CLASS:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UmlPackage.ASSOCIATION_CLASS_END__ECONTAINING_CLASS, msgs);
				default:
	 ...
	 * @generated
	 */
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int structuralFeatureID, Class baseClass, NotificationChain msgs) {
		if (structuralFeatureID >= 0) {
			switch (eDerivedStructuralFeatureID(structuralFeatureID, baseClass)) {
				case UmlPackage.ASSOCIATION_CLASS_END__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicRemove(otherEnd, msgs);
				case UmlPackage.ASSOCIATION_CLASS_END__ECONTAINING_CLASS:
					return eBasicSetContainer(null, UmlPackage.ASSOCIATION_CLASS_END__ECONTAINING_CLASS, msgs);
				default:
					return eDynamicInverseRemove(otherEnd, structuralFeatureID, baseClass, msgs);
			}
		}
		return eBasicSetContainer(null, structuralFeatureID, msgs);
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UmlPackage.ASSOCIATION_CLASS_END__NAME:
				return getName();
			case UmlPackage.ASSOCIATION_CLASS_END__ORDERED:
				return isOrdered() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__UNIQUE:
				return isUnique() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__LOWER_BOUND:
				return new Integer(getLowerBound());
			case UmlPackage.ASSOCIATION_CLASS_END__UPPER_BOUND:
				return new Integer(getUpperBound());
			case UmlPackage.ASSOCIATION_CLASS_END__MANY:
				return isMany() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__REQUIRED:
				return isRequired() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__ETYPE:
				if (resolve) return getEType();
				return basicGetEType();
			case UmlPackage.ASSOCIATION_CLASS_END__CHANGEABLE:
				return isChangeable() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__VOLATILE:
				return isVolatile() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__TRANSIENT:
				return isTransient() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__DEFAULT_VALUE_LITERAL:
				return getDefaultValueLiteral();
			case UmlPackage.ASSOCIATION_CLASS_END__DEFAULT_VALUE:
				return getDefaultValue();
			case UmlPackage.ASSOCIATION_CLASS_END__UNSETTABLE:
				return isUnsettable() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__DERIVED:
				return isDerived() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__ECONTAINING_CLASS:
				return getEContainingClass();
			case UmlPackage.ASSOCIATION_CLASS_END__CONTAINMENT:
				return isContainment() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__CONTAINER:
				return isContainer() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__RESOLVE_PROXIES:
				return isResolveProxies() ? Boolean.TRUE : Boolean.FALSE;
			case UmlPackage.ASSOCIATION_CLASS_END__EOPPOSITE:
				if (resolve) return getEOpposite();
				return basicGetEOpposite();
			case UmlPackage.ASSOCIATION_CLASS_END__EREFERENCE_TYPE:
