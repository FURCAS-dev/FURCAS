package org.eclipse.emf.query.index.ui.view;
...
import org.eclipse.emf.query.index.ui.view.legends.impl.IndexViewLegendManager;
...
public class IndexView extends ViewPart implements IDoubleClickListener, IndexChangeListener {
	...
	public void createPartControl(Composite parent) {
		...
		propertiesPage.createControl(propertiesContainer);
		new Label(composite, SWT.NONE);

		propertiesPage.getControl().setLayoutData(new GridData(GridData.FILL_HORIZONTAL | GridData.FILL_VERTICAL | GridData.GRAB_HORIZONTAL | GridData.GRAB_VERTICAL));
		try {
			IViewPart PropertiesPart = this.getSite().getPage().showView(IPageLayout.ID_PROP_SHEET);
			this.getSite().getPage().hideView(PropertiesPart);
