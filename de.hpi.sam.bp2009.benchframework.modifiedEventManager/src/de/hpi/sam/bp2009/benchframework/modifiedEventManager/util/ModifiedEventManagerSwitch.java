 ...
 * @generated
 */
public class ModifiedEventManagerSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public ModifiedEventManagerSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModifiedEventManagerPackage.MODIFIED_EVENT_MANAGER: {
				ModifiedEventManager modifiedEventManager = (ModifiedEventManager)theEObject;
				T result = caseModifiedEventManager(modifiedEventManager);
				if (result == null) result = caseEventManager(modifiedEventManager);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Modified Event Manager</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Modified Event Manager</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseModifiedEventManager(ModifiedEventManager object) {
		return null;
	}
