...
public class ConnectionDecoratorWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl> implements com.sap.mi.gfw.mm.pictograms.ConnectionDecorator,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public ConnectionDecoratorWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl getCastWrappedObject() {
        return (com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl) getWrappedObject();
    }
    
    private com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl) resolved;
    }
    
    public com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl unwrap() {
        return (com.sap.mi.gfw.mm.pictograms.__impl.ConnectionDecoratorImpl) getWrappedObject();
    }
    ...
    public boolean isLocationRelative() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isLocationRelative();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isLocationRelative();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setLocationRelative(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (com.sap.mi.gfw.mm.pictograms.Connection) wrapResult(getCastWrappedObject().getConnection(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setConnection(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "com.sap.mi.gfw.mm.pictograms.ConnectionDecorator (Java Type)\npictograms.ConnectionDecorator (MOF Type)"; //$NON-NLS-1$
    }    
}