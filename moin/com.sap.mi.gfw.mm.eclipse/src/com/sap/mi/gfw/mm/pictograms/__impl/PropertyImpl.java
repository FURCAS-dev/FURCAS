...
public final class PropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.mi.gfw.mm.pictograms.Property
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "pictograms", "Property" })); //$NON-NLS-1$ //$NON-NLS-2$
