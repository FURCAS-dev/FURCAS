...
public final class ModelClassMethodSettingImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ModelClassMethod", Integer.valueOf(6)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E;
    ...
    // default constructor
    public ModelClassMethodSettingImpl() {
        super();
    }
    
    // specific constructor
    public ModelClassMethodSettingImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelClassMethod() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF0341BDC62DFE48802BAE998722BFD8EA" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelClassMethod(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF0341BDC62DFE48802BAE998722BFD8EA" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setModelClassMethod(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF0341BDC62DFE48802BAE998722BFD8EA", /* mofId of reference */ "45DDACEF373EE91E21B1477C35D8E48C330E82ED" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setModelClassMethod(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF0341BDC62DFE48802BAE998722BFD8EA", /* mofId of reference */ "45DDACEF373EE91E21B1477C35D8E48C330E82ED" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFE7881E620B414B3D2B7DF691BE9BAB8C", /* mofId of reference */ "45DDACEF328CF85C55E14F7E24BBB2CB99ACFAC5" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFE7881E620B414B3D2B7DF691BE9BAB8C", /* mofId of reference */ "45DDACEF328CF85C55E14F7E24BBB2CB99ACFAC5" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getModelClassMethod(connection);
                break;
            case 7: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 6:
                ___changeReference(connection, "45DDACEF0341BDC62DFE48802BAE998722BFD8EA" /* mofId of association */, "45DDACEF373EE91E21B1477C35D8E48C330E82ED" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeReference(connection, "45DDACEFE7881E620B414B3D2B7DF691BE9BAB8C" /* mofId of association */, "45DDACEF328CF85C55E14F7E24BBB2CB99ACFAC5" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "45DDACEFE2159FE4A4DF46433399C4B11B6D673E" ) { __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E = value; return; } //$NON-NLS-1$ 
    }
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFE2159FE4A4DF46433399C4B11B6D673E" ) { return __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E); __A_SettingDefinition_modelClassMethodSetting_SettingDefinition_45DDACEFE2159FE4A4DF46433399C4B11B6D673E = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.model.ModelClassMethodSetting> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.model.ModelClassMethodSetting.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.model.__impl.ModelClassMethodSettingImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.model.__impl.ModelClassMethodSettingWrapper(conn, this, synchronize);
    }
