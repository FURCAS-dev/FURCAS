...
public final class JavaNativeTypeImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("javaPackage", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("arrayDimensions", Integer.valueOf(5)); //$NON-NLS-1$
    }
    ...
    private int __arrayDimensions = 0;
    ...
    // default constructor
    public JavaNativeTypeImpl() {
        super();
    }
    
    // specific constructor
    public JavaNativeTypeImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEFB854F44C98EE42910E1AFF0764CEFA11", __javaPackage, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEFB854F44C98EE42910E1AFF0764CEFA11", __javaPackage, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF755D2BBA38A749C53947EBC5FA07609C", __arrayDimensions, newValue); //$NON-NLS-1$
    }
    public void setArrayDimensions(com.sap.tc.moin.repository.core.CoreConnection connection, int newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF755D2BBA38A749C53947EBC5FA07609C", __arrayDimensions, newValue); //$NON-NLS-1$
    }
    ...
    private void set__ArrayDimensions(int newValue) {
            __arrayDimensions = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEFB854F44C98EE42910E1AFF0764CEFA11", __javaPackage, value); //$NON-NLS-1$
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF755D2BBA38A749C53947EBC5FA07609C", __arrayDimensions, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            ...
            case 4:
                ...
                break;
            case 5:
                set__ArrayDimensions((java.lang.Integer) value);     
                break;
            default:
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.type.JavaNativeType> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.type.JavaNativeType.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeWrapper(conn, this, synchronize);
    }
