...
public class MainConfigObjReferenceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl> implements com.sap.ide.metamodel.webdynpro.configuration.MainConfigObjReference,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public MainConfigObjReferenceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<com.sap.ide.metamodel.webdynpro.configuration.MainConfigObject>) wrapResult(getCastWrappedObject().getMainConfigurationObjects(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.configuration.MainConfigObjReference (Java Type)\nWebDynpro.configuration.MainConfigObjReference (MOF Type)"; //$NON-NLS-1$
    }    
}