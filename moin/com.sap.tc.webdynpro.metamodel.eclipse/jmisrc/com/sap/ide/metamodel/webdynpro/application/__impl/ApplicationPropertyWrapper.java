...
public class ApplicationPropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl> implements com.sap.ide.metamodel.webdynpro.application.ApplicationProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ApplicationPropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.application.__impl.ApplicationPropertyImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (com.sap.ide.metamodel.webdynpro.application.Application) wrapResult(getCastWrappedObject().getApplication(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setApplication(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (com.sap.ide.metamodel.webdynpro.framework.ApplicationPropertyDefinition) wrapResult(getCastWrappedObject().getPropertyDefinition(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setPropertyDefinition(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.application.ApplicationProperty (Java Type)\nWebDynpro.application.ApplicationProperty (MOF Type)"; //$NON-NLS-1$
    }    
}