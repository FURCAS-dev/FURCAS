...
public class JavaNativeTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl> implements com.sap.ide.metamodel.webdynpro.type.JavaNativeType,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public JavaNativeTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.type.__impl.JavaNativeTypeImpl) getWrappedObject();
    }
    ...
    public int getArrayDimensions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getArrayDimensions();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getArrayDimensions();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setArrayDimensions(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.type.JavaNativeType (Java Type)\nWebDynpro.type.JavaNativeType (MOF Type)"; //$NON-NLS-1$
    }    
}