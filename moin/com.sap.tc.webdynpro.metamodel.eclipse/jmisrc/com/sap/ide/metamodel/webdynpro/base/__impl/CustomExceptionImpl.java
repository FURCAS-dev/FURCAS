...
public final class CustomExceptionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("javaPackage", Integer.valueOf(5)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private java.lang.String __javaPackage = null;
    ...
    public CustomExceptionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEEE01A5458113E473535E7932801C5B526", __javaPackage, newValue); //$NON-NLS-1$
    }
    public void setJavaPackage(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEEE01A5458113E473535E7932801C5B526", __javaPackage, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEED2BEB04578E94A831642CB14C3412B7A" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEED2BEB04578E94A831642CB14C3412B7A", /* mofId of reference */ "45DDACEEDCC1687FED1941F332D4B6CBFBBF1754" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEED2BEB04578E94A831642CB14C3412B7A", /* mofId of reference */ "45DDACEEDCC1687FED1941F332D4B6CBFBBF1754" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__JavaPackage(java.lang.String newValue) {
            __javaPackage = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEED2BEB04578E94A831642CB14C3412B7A" /* mofId of association */, "45DDACEEDCC1687FED1941F332D4B6CBFBBF1754" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEEE01A5458113E473535E7932801C5B526", __javaPackage, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 5:
                set__JavaPackage((java.lang.String) value);     
                break;
            default:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.base.__impl.CustomExceptionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.base.__impl.CustomExceptionWrapper(conn, this, synchronize);
    }
