...
public class ModelClassSettingDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.framework.ModelClassSettingDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ModelClassSettingDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassSettingDefinitionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.ModelClassSettingDefinition (Java Type)\nWebDynpro.framework.ModelClassSettingDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}