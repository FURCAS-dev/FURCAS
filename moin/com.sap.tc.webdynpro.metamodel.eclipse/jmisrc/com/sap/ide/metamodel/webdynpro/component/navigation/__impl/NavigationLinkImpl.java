...
public final class NavigationLinkImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("TargetReferences", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("SourceViewUsage", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("Source", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5;
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74;

    // links for multiplicity-n association ends
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277;
    ...
    // default constructor
    public NavigationLinkImpl() {
        super();
    }
    
    // specific constructor
    public NavigationLinkImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.util.List getTargetReferences() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getTargetReferences(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }


    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getSourceViewUsage() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getSourceViewUsage(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5);
       
    }
    public void setSourceViewUsage(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEECDFC73B30F9640A911659626101221B4", /* mofId of reference */ "45DDACEE1588D7B4BC6E411E336AEEC7E1AB6E67" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setSourceViewUsage(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEECDFC73B30F9640A911659626101221B4", /* mofId of reference */ "45DDACEE1588D7B4BC6E411E336AEEC7E1AB6E67" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65C71CA3B50A70444B425B3C4B615507004", /* mofId of reference */ "460CC65CD08E389B194246FF008798DD008F5657" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "460CC65C71CA3B50A70444B425B3C4B615507004", /* mofId of reference */ "460CC65CD08E389B194246FF008798DD008F5657" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getTargetReferences(connection);
                break;
            case 5: 
                result = getSourceViewUsage(connection);
                break;
            case 6: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3" /* mofId of association */, "45DDACEEE2B8FAE18621420A0B1AA23AD4BF794F" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEECDFC73B30F9640A911659626101221B4" /* mofId of association */, "45DDACEE1588D7B4BC6E411E336AEEC7E1AB6E67" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "460CC65C71CA3B50A70444B425B3C4B615507004" /* mofId of association */, "460CC65CD08E389B194246FF008798DD008F5657" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE1F9FD9621143466337168EFA23470AD5" ) { __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5 = value; return; } //$NON-NLS-1$ 
        ...
        if ( associationEndMofId == "460CC65C1DBB468E8C9B4E5139DFA809DB35EA74" ) { __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74 = value; return; } //$NON-NLS-1$ 
    }
    
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE1F9FD9621143466337168EFA23470AD5" ) { return __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5; } //$NON-NLS-1$ 
        ...
        if ( associationEndMofId == "460CC65C1DBB468E8C9B4E5139DFA809DB35EA74" ) { return __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5); } 
        ...
        if ( __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74); } 
        if ( __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277" ) { return __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277" ) { __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277 = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5); __A_SourceViewUsage_navigationLink_SourceViewUsage_45DDACEE1F9FD9621143466337168EFA23470AD5 = null; } 
        if ( __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372); __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372 = null; } 
        if ( __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74); __A_Source_navigationLink_Source_460CC65C1DBB468E8C9B4E5139DFA809DB35EA74 = null; } 
        if ( __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277); __A_TargetReferences_NavigationLink_TargetReferences_45DDACEEDA6D6F1EBC914A230BD1D6667F0A9277 = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.component.navigation.NavigationLink> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.component.navigation.NavigationLink.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.navigation.__impl.NavigationLinkImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.navigation.__impl.NavigationLinkWrapper(conn, this, synchronize);
    }
