 ...
 */
public interface Layout extends com.sap.ide.metamodel.webdynpro.component.view.uielement.ViewElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.Layout> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.Layout>("45DDACEE6430FA030C5541EB1101FB50DF4E55CB", "sap.com/tc/moin/webdynpro", "WebDynpro", "component", "view", "uielement", "Layout"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.component.view.uielement.Layout,com.sap.ide.metamodel.webdynpro.component.view.uielement.UielementContainer> __uielementContainer;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.component.view.uielement.Layout,com.sap.ide.metamodel.webdynpro.component.view.uielement.UielementContainer> UIELEMENT_CONTAINER( ) {
            if ( __uielementContainer == null ) {
                __uielementContainer = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.component.view.uielement.Layout,com.sap.ide.metamodel.webdynpro.component.view.uielement.UielementContainer>( "45DDACEEC30503DA7B42427D1351BDD0FCEA096B", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "Layout", "UIElementContainer" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __uielementContainer;
        }
    }
}    