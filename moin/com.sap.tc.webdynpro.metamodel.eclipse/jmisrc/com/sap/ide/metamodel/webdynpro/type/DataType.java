...
/**
 * Abstract superclass for everything that can be used as type, except model classes and controllers.
 * This interface is not intended to be implemented by clients.
 */
public interface DataType extends com.sap.ide.metamodel.common.Type {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.type.DataType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.type.DataType>("45DDACEF9528AA3CD6864C1038C198D9582D2294", "sap.com/tc/moin/webdynpro", "WebDynpro", "type", "DataType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
