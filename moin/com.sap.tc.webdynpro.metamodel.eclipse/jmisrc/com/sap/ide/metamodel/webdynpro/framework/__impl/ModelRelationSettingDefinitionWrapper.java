...
public class ModelRelationSettingDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.framework.ModelRelationSettingDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ModelRelationSettingDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationSettingDefinitionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.ModelRelationSettingDefinition (Java Type)\nWebDynpro.framework.ModelRelationSettingDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}