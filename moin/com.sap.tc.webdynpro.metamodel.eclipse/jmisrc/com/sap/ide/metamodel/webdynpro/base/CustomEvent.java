...
/**
 * Application-defined event (in contrast to framework event). Thrown via application code, caught by application-defined event-handlers.
 * This interface is not intended to be implemented by clients.
 */
public interface CustomEvent extends com.sap.ide.metamodel.webdynpro.event.OutgoingEvent {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.CustomEvent> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.CustomEvent>("45DDACEE56CF1153C958451C1990EB5F8CD10C6A", "sap.com/tc/moin/webdynpro", "WebDynpro", "base", "CustomEvent"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
