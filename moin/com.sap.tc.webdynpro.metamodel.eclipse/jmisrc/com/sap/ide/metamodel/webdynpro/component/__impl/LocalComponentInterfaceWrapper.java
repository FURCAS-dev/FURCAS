...
public class LocalComponentInterfaceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl> implements com.sap.ide.metamodel.webdynpro.component.LocalComponentInterface,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public LocalComponentInterfaceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.__impl.LocalComponentInterfaceImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.LocalComponentInterface (Java Type)\nWebDynpro.component.LocalComponentInterface (MOF Type)"; //$NON-NLS-1$
    }    
}