...
/**
 * Error-handling procedure. Called if an event handler execution failed. Controller event handlers fail, if the validation of field groups associated to the event handler was not successful.
 * This interface is not intended to be implemented by clients.
 */
public interface ErrorHandler extends com.sap.ide.metamodel.webdynpro.base.Procedure {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.ErrorHandler> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.ErrorHandler>("45DDACEE98C0781438E4497F1459B09CC6C2BF38", "sap.com/tc/moin/webdynpro", "WebDynpro", "base", "ErrorHandler"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
