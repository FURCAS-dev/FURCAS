 ...
 */
public interface AbstractSeries extends com.sap.ide.metamodel.webdynpro.component.view.uielement.ViewElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractSeries> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractSeries>("45DDACEEFB55FBEC8C0F4D760931D2016A4F42B1", "sap.com/tc/moin/webdynpro", "WebDynpro", "component", "view", "uielement", "AbstractSeries"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractSeries,com.sap.ide.metamodel.webdynpro.component.view.uielement.BusinessGraphics> __businessGraphics;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractSeries,com.sap.ide.metamodel.webdynpro.component.view.uielement.BusinessGraphics> BUSINESS_GRAPHICS( ) {
            if ( __businessGraphics == null ) {
                __businessGraphics = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractSeries,com.sap.ide.metamodel.webdynpro.component.view.uielement.BusinessGraphics>( "45DDACEE24F6F4F7280A4A7A3B25B4270FE603FB", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "AbstractSeries", "BusinessGraphics" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
