...
public final class ModelRelationRoleImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ModelClass", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("ModelRelation", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("navigable", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("cardinality", Integer.valueOf(8)); //$NON-NLS-1$
        FEATURE_IDS.put("aggregate", Integer.valueOf(9)); //$NON-NLS-1$
    }
    ...
    private boolean __aggregate = false;
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044;

    // default constructor
    public ModelRelationRoleImpl() {
        super();
    }
    
    // specific constructor
    public ModelRelationRoleImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 7, "45DDACEF9E6D9BC2A541471136FBD91C19A61954", __navigable, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 7, "45DDACEF9E6D9BC2A541471136FBD91C19A61954", __navigable, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 8, "45DDACEF64C866F36D7244AD25A8F68946D604C0", __cardinality, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 8, "45DDACEF64C866F36D7244AD25A8F68946D604C0", __cardinality, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 9, "45DDACEF8DED0DAF489642E51CD8AA54EB9E457B", __aggregate, newValue); //$NON-NLS-1$
    }
    public void setAggregate(com.sap.tc.moin.repository.core.CoreConnection connection, boolean newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 9, "45DDACEF8DED0DAF489642E51CD8AA54EB9E457B", __aggregate, newValue); //$NON-NLS-1$
    }
    ...
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEF68166D73870E4B9026A9A881C116A35E" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEF68166D73870E4B9026A9A881C116A35E" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65CAE7144B3A6A14F7925B487C9637E9AA4", /* mofId of reference */ "460CC65CF141CD5AFAE8412306E2BCE51CDE5087" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "460CC65CAE7144B3A6A14F7925B487C9637E9AA4", /* mofId of reference */ "460CC65CF141CD5AFAE8412306E2BCE51CDE5087" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelRelation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "460CC65CB4D107F402764A191E57A29C7B28F2E4" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelRelation(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "460CC65CB4D107F402764A191E57A29C7B28F2E4" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setModelRelation(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65CB4D107F402764A191E57A29C7B28F2E4", /* mofId of reference */ "460CC65C6009E2B2B9BE47EA38ACFE4A45723E91" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setModelRelation(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "460CC65CB4D107F402764A191E57A29C7B28F2E4", /* mofId of reference */ "460CC65C6009E2B2B9BE47EA38ACFE4A45723E91" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__Aggregate(boolean newValue) {
            __aggregate = newValue;
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getModelRelation(connection);
                break;
            case 7: 
                result = isNavigable();
                break;
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF68166D73870E4B9026A9A881C116A35E" /* mofId of association */, "45DDACEFA17C9F05073A4A9B3202D45450423469" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "460CC65CAE7144B3A6A14F7925B487C9637E9AA4" /* mofId of association */, "460CC65CF141CD5AFAE8412306E2BCE51CDE5087" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "460CC65CB4D107F402764A191E57A29C7B28F2E4" /* mofId of association */, "460CC65C6009E2B2B9BE47EA38ACFE4A45723E91" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeDataTypeAttribute(connection, 7, "45DDACEF9E6D9BC2A541471136FBD91C19A61954", __navigable, value); //$NON-NLS-1$
                break;
                    
            case 8:
                ___changeDataTypeAttribute(connection, 8, "45DDACEF64C866F36D7244AD25A8F68946D604C0", __cardinality, value); //$NON-NLS-1$
                break;
                    
            case 9:
                ___changeDataTypeAttribute(connection, 9, "45DDACEF8DED0DAF489642E51CD8AA54EB9E457B", __aggregate, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            ...
            case 8:
                ...
                break;
            case 9:
                set__Aggregate((java.lang.Boolean) value);     
                break;
            default:
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "460CC65CB822A92346C94A051217B0089D49AC0F" ) { __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F = value; return; } //$NON-NLS-1$ 
    }
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "460CC65CB822A92346C94A051217B0089D49AC0F" ) { return __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F); } 
        ...
        if ( __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFAA110C2409FB426F1BC7EC9ED994B044" ) { return __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFAA110C2409FB426F1BC7EC9ED994B044" ) { __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044 = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F); __A_ModelClass_modelRelationRole_ModelClass_460CC65CB822A92346C94A051217B0089D49AC0F = null; } 
        ...
        if ( __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044); __A_Settings_ModelRelationRole_Settings_45DDACEFAA110C2409FB426F1BC7EC9ED994B044 = null; } 
        return result;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.model.__impl.ModelRelationRoleImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.model.__impl.ModelRelationRoleWrapper(conn, this, synchronize);
    }
