...
public final class DimensionDefinitionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ViewsetDefintion", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    // default constructor
    public DimensionDefinitionImpl() {
        super();
    }
    
    // specific constructor
    public DimensionDefinitionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getViewsetDefintion() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getViewsetDefintion(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setViewsetDefintion(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F", /* mofId of reference */ "45DDACEE104E8D1472EA41331994F44CEE8DF4C3" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setViewsetDefintion(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F", /* mofId of reference */ "45DDACEE104E8D1472EA41331994F44CEE8DF4C3" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getViewsetDefintion(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 6:
                ___changeReference(connection, "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F" /* mofId of association */, "45DDACEE104E8D1472EA41331994F44CEE8DF4C3" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.DimensionDefinition> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.DimensionDefinition.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionWrapper(conn, this, synchronize);
    }
