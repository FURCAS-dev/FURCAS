...
public final class ContextRecursionNodeImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("RepeatedNode", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4;
    ...
    // default constructor
    public ContextRecursionNodeImpl() {
        super();
    }
    
    // specific constructor
    public ContextRecursionNodeImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getRepeatedNode() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getRepeatedNode(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4);
       
    }
    public void setRepeatedNode(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEBDA05D393D514C213322AE5C4C0F8F6C", /* mofId of reference */ "45DDACEE6DDC14742C284AD70273BC40779139A0" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setRepeatedNode(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEBDA05D393D514C213322AE5C4C0F8F6C", /* mofId of reference */ "45DDACEE6DDC14742C284AD70273BC40779139A0" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getRepeatedNode(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 6:
                ___changeReference(connection, "45DDACEEBDA05D393D514C213322AE5C4C0F8F6C" /* mofId of association */, "45DDACEE6DDC14742C284AD70273BC40779139A0" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE388A8AEAB76E451207639D7D6B72DEA4" ) { __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4 = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE388A8AEAB76E451207639D7D6B72DEA4" ) { return __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4); __A_RepeatedNode_contextRecursionNode_RepeatedNode_45DDACEE388A8AEAB76E451207639D7D6B72DEA4 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.controller.__impl.ContextRecursionNodeImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.controller.__impl.ContextRecursionNodeWrapper(conn, this, synchronize);
    }
