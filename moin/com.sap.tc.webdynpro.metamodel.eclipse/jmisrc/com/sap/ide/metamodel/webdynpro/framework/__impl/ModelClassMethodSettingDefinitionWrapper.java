...
public class ModelClassMethodSettingDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.framework.ModelClassMethodSettingDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ModelClassMethodSettingDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelClassMethodSettingDefinitionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.ModelClassMethodSettingDefinition (Java Type)\nWebDynpro.framework.ModelClassMethodSettingDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}