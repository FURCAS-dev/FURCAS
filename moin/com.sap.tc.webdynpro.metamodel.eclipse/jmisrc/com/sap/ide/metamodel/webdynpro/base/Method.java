...
/**
 * Represents standard methods of controllers or model classes.
 * This interface is not intended to be implemented by clients.
 */
public interface Method extends com.sap.ide.metamodel.webdynpro.base.Procedure {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.Method> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.Method>("45DDACEE960F1D23D6A84D420B85CD6F2FA2A7FC", "sap.com/tc/moin/webdynpro", "WebDynpro", "base", "Method"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 

    
    // references
    public java.util.List<com.sap.ide.metamodel.webdynpro.base.CustomException> getExceptions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.base.Method,java.util.List<com.sap.ide.metamodel.webdynpro.base.CustomException>> __exceptions;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.base.Method,java.util.List<com.sap.ide.metamodel.webdynpro.base.CustomException>> EXCEPTIONS( ) {
            if ( __exceptions == null ) {
                __exceptions = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.base.Method,java.util.List<com.sap.ide.metamodel.webdynpro.base.CustomException>>( "45DDACEE38D708F540584C39232B86C0D40035B6", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "base", "Method", "Exceptions" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __exceptions;
        }
    }
