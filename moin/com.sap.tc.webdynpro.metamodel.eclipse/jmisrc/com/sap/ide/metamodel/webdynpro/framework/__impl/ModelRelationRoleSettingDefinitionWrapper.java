...
public class ModelRelationRoleSettingDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.framework.ModelRelationRoleSettingDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ModelRelationRoleSettingDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelRelationRoleSettingDefinitionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.ModelRelationRoleSettingDefinition (Java Type)\nWebDynpro.framework.ModelRelationRoleSettingDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}