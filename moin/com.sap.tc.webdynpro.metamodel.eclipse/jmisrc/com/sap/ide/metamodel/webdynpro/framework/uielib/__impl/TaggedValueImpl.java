...
public final class TaggedValueImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    public TaggedValueImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEF79671EAB6A924C2F02CAE6DC87F45C0F", __value, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEF79671EAB6A924C2F02CAE6DC87F45C0F", __value, newValue); //$NON-NLS-1$
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEF79671EAB6A924C2F02CAE6DC87F45C0F", __value, value); //$NON-NLS-1$
                break;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueWrapper(conn, this, synchronize);
    }
