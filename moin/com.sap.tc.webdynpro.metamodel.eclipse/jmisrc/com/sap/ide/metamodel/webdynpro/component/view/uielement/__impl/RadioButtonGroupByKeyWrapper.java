...
public class RadioButtonGroupByKeyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByKey,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public RadioButtonGroupByKeyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.RadioButtonGroupByKeyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByKey (Java Type)\nWebDynpro.component.view.uielement.RadioButtonGroupByKey (MOF Type)"; //$NON-NLS-1$
    }    
}