...
public class TransparentContainerWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.TransparentContainer,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public TransparentContainerWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TransparentContainerImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.TransparentContainer (Java Type)\nWebDynpro.component.view.uielement.TransparentContainer (MOF Type)"; //$NON-NLS-1$
    }    
}