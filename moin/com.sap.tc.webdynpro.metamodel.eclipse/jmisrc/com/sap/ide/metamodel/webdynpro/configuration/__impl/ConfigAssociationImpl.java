...
public final class ConfigAssociationImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("AssociatedConfigObjects", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48;
    ...
    // default constructor
    public ConfigAssociationImpl() {
        super();
    }
    
    // specific constructor
    public ConfigAssociationImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEC615D7A600C24F750FD29993731F40F1" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEC615D7A600C24F750FD29993731F40F1", /* mofId of reference */ "45DDACEE960763955B2D47DB39CCFDD372BE991B" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEC615D7A600C24F750FD29993731F40F1", /* mofId of reference */ "45DDACEE960763955B2D47DB39CCFDD372BE991B" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getAssociatedConfigObjects() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEEF52F53AC2D0A4FF517FA81DA74B7F9DB" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getAssociatedConfigObjects(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEEF52F53AC2D0A4FF517FA81DA74B7F9DB" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getAssociatedConfigObjects(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "45DDACEEC615D7A600C24F750FD29993731F40F1" /* mofId of association */, "45DDACEE960763955B2D47DB39CCFDD372BE991B" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEEF52F53AC2D0A4FF517FA81DA74B7F9DB" /* mofId of association */, "45DDACEE2FFF4DB9D55E43E22010BC8AE613FC07" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE0A63ACB5E142447C0541C87D69E84C48" ) { return __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE0A63ACB5E142447C0541C87D69E84C48" ) { __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48 = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48); __A_AssociatedConfigObjects_configAssociation_AssociatedConfigObjects_45DDACEE0A63ACB5E142447C0541C87D69E84C48 = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.configuration.ConfigAssociation> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.configuration.ConfigAssociation.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.configuration.__impl.ConfigAssociationImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.configuration.__impl.ConfigAssociationWrapper(conn, this, synchronize);
    }
