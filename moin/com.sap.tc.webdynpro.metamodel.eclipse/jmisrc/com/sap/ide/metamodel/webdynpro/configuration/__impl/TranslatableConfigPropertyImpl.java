...
public final class TranslatableConfigPropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ConfigModelProperty", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("ParentObject", Integer.valueOf(5)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9;
    ...
    // default constructor
    public TranslatableConfigPropertyImpl() {
        super();
    }
    
    // specific constructor
    public TranslatableConfigPropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeObjectAttribute(get___CurrentConnection(), "45DDACEE5101789B093E48F31525E99ABBA3B658", newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(connection, "45DDACEE5101789B093E48F31525E99ABBA3B658", newValue); //$NON-NLS-1$
    }
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getConfigModelProperty() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getConfigModelProperty(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9);
       
    }
    public void setConfigModelProperty(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEECB4AAD1BD1C546A72388C4D85C3662BD", /* mofId of reference */ "45DDACEE7340B54982F042F61331F658554337DD" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setConfigModelProperty(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEECB4AAD1BD1C546A72388C4D85C3662BD", /* mofId of reference */ "45DDACEE7340B54982F042F61331F658554337DD" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getParentObject() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE81010E149946476C0A0DEAB9AF736157" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getParentObject(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE81010E149946476C0A0DEAB9AF736157" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setParentObject(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE81010E149946476C0A0DEAB9AF736157", /* mofId of reference */ "45DDACEEEAD047F1899D48BD393CE33D671E5312" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setParentObject(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE81010E149946476C0A0DEAB9AF736157", /* mofId of reference */ "45DDACEEEAD047F1899D48BD393CE33D671E5312" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.Object newValue) {
        ___loadLinks(session, "45DDACEE5101789B093E48F31525E99ABBA3B658" /* "value" */, newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getConfigModelProperty(connection);
                break;
            case 5: 
                result = getParentObject(connection);
                break;
            case 6: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEECB4AAD1BD1C546A72388C4D85C3662BD" /* mofId of association */, "45DDACEE7340B54982F042F61331F658554337DD" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEE81010E149946476C0A0DEAB9AF736157" /* mofId of association */, "45DDACEEEAD047F1899D48BD393CE33D671E5312" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeObjectAttribute(connection, "45DDACEE5101789B093E48F31525E99ABBA3B658", value); //$NON-NLS-1$
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE73D5376FA1C045233E4B815838D39AD9" ) { __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9 = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE73D5376FA1C045233E4B815838D39AD9" ) { return __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9; } //$NON-NLS-1$ 
    ...
    public void set___AttributeLink( String attributeMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( attributeMofId == "45DDACEE5101789B093E48F31525E99ABBA3B658" ) { __value = value; return; } //$NON-NLS-1$ 
    }

    public com.sap.tc.moin.repository.core.EndStorageLink get___AttributeLink( String attributeMofId ) {
        if ( attributeMofId == "45DDACEE5101789B093E48F31525E99ABBA3B658" ) { return __value; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9); __A_ConfigModelProperty_configProperty_ConfigModelProperty_45DDACEE73D5376FA1C045233E4B815838D39AD9 = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.configuration.TranslatableConfigProperty> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.configuration.TranslatableConfigProperty.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.configuration.__impl.TranslatableConfigPropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.configuration.__impl.TranslatableConfigPropertyWrapper(conn, this, synchronize);
    }
