...
public class EmptyViewWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl> implements com.sap.ide.metamodel.webdynpro.component.view.EmptyView,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public EmptyViewWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.__impl.EmptyViewImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.EmptyView (Java Type)\nWebDynpro.component.view.EmptyView (MOF Type)"; //$NON-NLS-1$
    }    
}