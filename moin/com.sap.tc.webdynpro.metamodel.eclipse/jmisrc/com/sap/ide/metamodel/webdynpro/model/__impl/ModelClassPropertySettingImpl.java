...
public final class ModelClassPropertySettingImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("translatableValue", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("ModelClassProperty", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("SettingDefinition", Integer.valueOf(7)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7;
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __translatableValue;

    // default constructor
    public ModelClassPropertySettingImpl() {
        super();
    }
    
    // specific constructor
    public ModelClassPropertySettingImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEF6C008D13365C4ECD0045C9B793FCF84D", __value, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEF6C008D13365C4ECD0045C9B793FCF84D", __value, newValue); //$NON-NLS-1$
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getTranslatableValue() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __translatableValue);
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getTranslatableValue(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __translatableValue);
    }
    public void setTranslatableValue(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeObjectAttribute(get___CurrentConnection(), "45DDACEF13CA0B4D40BD4BCA1B46D9FA71401D68", newValue); //$NON-NLS-1$
    }
    public void setTranslatableValue(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeObjectAttribute(connection, "45DDACEF13CA0B4D40BD4BCA1B46D9FA71401D68", newValue); //$NON-NLS-1$
    }
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelClassProperty() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF56CB86AB00804A6D37A8939F5DC58B21" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelClassProperty(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF56CB86AB00804A6D37A8939F5DC58B21" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setModelClassProperty(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF56CB86AB00804A6D37A8939F5DC58B21", /* mofId of reference */ "45DDACEF9B6458DC7A80432F16AD98DC9FCE0EBA" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setModelClassProperty(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF56CB86AB00804A6D37A8939F5DC58B21", /* mofId of reference */ "45DDACEF9B6458DC7A80432F16AD98DC9FCE0EBA" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getSettingDefinition() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getSettingDefinition(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7);
       
    }
    public void setSettingDefinition(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF447E9B74E58048DF3B92AF0E2D12C19C", /* mofId of reference */ "45DDACEF5337ABE6D97548B30AF5E6F798D97A22" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setSettingDefinition(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF447E9B74E58048DF3B92AF0E2D12C19C", /* mofId of reference */ "45DDACEF5337ABE6D97548B30AF5E6F798D97A22" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__TranslatableValue(com.sap.tc.moin.repository.core.CoreSession session, java.lang.Object newValue) {
        ___loadLinks(session, "45DDACEF13CA0B4D40BD4BCA1B46D9FA71401D68" /* "translatableValue" */, newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getTranslatableValue(connection);
                break;
            case 6: 
                result = getModelClassProperty(connection);
                break;
            case 7: 
                result = getSettingDefinition(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEF6C008D13365C4ECD0045C9B793FCF84D", __value, value); //$NON-NLS-1$
                break;
                    
            case 5:
                ___changeObjectAttribute(connection, "45DDACEF13CA0B4D40BD4BCA1B46D9FA71401D68", value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEF56CB86AB00804A6D37A8939F5DC58B21" /* mofId of association */, "45DDACEF9B6458DC7A80432F16AD98DC9FCE0EBA" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeReference(connection, "45DDACEF447E9B74E58048DF3B92AF0E2D12C19C" /* mofId of association */, "45DDACEF5337ABE6D97548B30AF5E6F798D97A22" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            ...
            case 4:
                ...
                break;
            case 5:
                set__TranslatableValue(session, value);     
                break;
            default:
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "45DDACEFD89353E17C124F633A86EB04B6482FA7" ) { __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7 = value; return; } //$NON-NLS-1$ 
    }
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFD89353E17C124F633A86EB04B6482FA7" ) { return __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7; } //$NON-NLS-1$ 
        return null;
    }
    public void set___AttributeLink( String attributeMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( attributeMofId == "45DDACEF13CA0B4D40BD4BCA1B46D9FA71401D68" ) { __translatableValue = value; return; } //$NON-NLS-1$ 
    }

    public com.sap.tc.moin.repository.core.EndStorageLink get___AttributeLink( String attributeMofId ) {
        if ( attributeMofId == "45DDACEF13CA0B4D40BD4BCA1B46D9FA71401D68" ) { return __translatableValue; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7); } 
        ...
        if ( __translatableValue != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __translatableValue); } 
        return result;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7); __A_SettingDefinition_modelClassPropertySetting_SettingDefinition_45DDACEFD89353E17C124F633A86EB04B6482FA7 = null; } 
        ...
        if ( __translatableValue != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __translatableValue); __translatableValue = null; } 
        return result;

    }
    // get the JMI interface
    @SuppressWarnings("unchecked")
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.model.ModelClassPropertySetting> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.model.ModelClassPropertySetting.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.model.__impl.ModelClassPropertySettingImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.model.__impl.ModelClassPropertySettingWrapper(conn, this, synchronize);
    }
