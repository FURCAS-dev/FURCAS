...
public final class UielementEventBindingImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ParameterMappings", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("ViewElement", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("BoundAction", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("UIElementEvent", Integer.valueOf(7)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163;
    private com.sap.tc.moin.repository.core.EndStorageLink __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD;

    // links for multiplicity-n association ends
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB;
    ...
    // default constructor
    public UielementEventBindingImpl() {
        super();
    }
    
    // specific constructor
    public UielementEventBindingImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.util.Collection getParameterMappings() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEE8ED7F84DC1B140612FE2A8E4FF3A0B1A" /* attribute or association */, 1 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.Collection getParameterMappings(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEE8ED7F84DC1B140612FE2A8E4FF3A0B1A" /* attribute or association */, 1 ) ) ; //$NON-NLS-1$
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEED77D8546425456834F7B5D28201AA9C" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEED77D8546425456834F7B5D28201AA9C", /* mofId of reference */ "45DDACEE77F9F315B8B8465F3C92D49A9C8F3322" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEED77D8546425456834F7B5D28201AA9C", /* mofId of reference */ "45DDACEE77F9F315B8B8465F3C92D49A9C8F3322" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getBoundAction() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getBoundAction(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD);
       
    }
    public void setBoundAction(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65C0C11DF44B73F4EF8352FE7D4A8E648AB", /* mofId of reference */ "460CC65C23276D097BCB44762DF0C85C7ADDC376" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setBoundAction(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "460CC65C0C11DF44B73F4EF8352FE7D4A8E648AB", /* mofId of reference */ "460CC65C23276D097BCB44762DF0C85C7ADDC376" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getUielementEvent() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getUielementEvent(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163);
       
    }
    public void setUielementEvent(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65CD9A09A83470349F81F2CBF28E7F164E3", /* mofId of reference */ "460CC65CE2B0D36731D84C092E6496DAEBC26D05" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setUielementEvent(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "460CC65CD9A09A83470349F81F2CBF28E7F164E3", /* mofId of reference */ "460CC65CE2B0D36731D84C092E6496DAEBC26D05" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getParameterMappings(connection);
                break;
            case 5: 
                result = getViewElement(connection);
                break;
            case 6: 
                result = getBoundAction(connection);
                break;
            case 7: 
                result = getUielementEvent(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEE8ED7F84DC1B140612FE2A8E4FF3A0B1A" /* mofId of association */, "45DDACEE79C6C7571B62426639E3AC62283D1130" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEEED77D8546425456834F7B5D28201AA9C" /* mofId of association */, "45DDACEE77F9F315B8B8465F3C92D49A9C8F3322" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "460CC65C0C11DF44B73F4EF8352FE7D4A8E648AB" /* mofId of association */, "460CC65C23276D097BCB44762DF0C85C7ADDC376" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeReference(connection, "460CC65CD9A09A83470349F81F2CBF28E7F164E3" /* mofId of association */, "460CC65CE2B0D36731D84C092E6496DAEBC26D05" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "460CC65C5439C3F3B1354E0A2555FB3664A78163" ) { __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163 = value; return; } //$NON-NLS-1$ 
        if ( associationEndMofId == "460CC65CCAF5D63EBB57452D0EA2B62647A737CD" ) { __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD = value; return; } //$NON-NLS-1$ 
    }
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "460CC65C5439C3F3B1354E0A2555FB3664A78163" ) { return __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163; } //$NON-NLS-1$ 
        if ( associationEndMofId == "460CC65CCAF5D63EBB57452D0EA2B62647A737CD" ) { return __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163); } 
        if ( __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD); } 
        if ( __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE95147A0186CD4A40066EC2C55F18DDCB" ) { return __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE95147A0186CD4A40066EC2C55F18DDCB" ) { __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163); __A_UIElementEvent_uIElementEventBinding_UIElementEvent_460CC65C5439C3F3B1354E0A2555FB3664A78163 = null; } 
        if ( __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD); __A_BoundAction_uIElementEventBinding_BoundAction_460CC65CCAF5D63EBB57452D0EA2B62647A737CD = null; } 
        if ( __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB); __A_EventBinding_ParameterMappings_ParameterMappings_45DDACEE95147A0186CD4A40066EC2C55F18DDCB = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.view.__impl.UielementEventBindingImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.view.__impl.UielementEventBindingWrapper(conn, this, synchronize);
    }
