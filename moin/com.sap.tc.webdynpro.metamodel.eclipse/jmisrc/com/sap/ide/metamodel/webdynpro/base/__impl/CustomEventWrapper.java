...
public class CustomEventWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl> implements com.sap.ide.metamodel.webdynpro.base.CustomEvent,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public CustomEventWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.base.__impl.CustomEventImpl) getWrappedObject();
    }
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.base.CustomEvent> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.base.CustomEvent.class;
    }

    // to String
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.base.CustomEvent (Java Type)\nWebDynpro.base.CustomEvent (MOF Type)"; //$NON-NLS-1$
    }    
}