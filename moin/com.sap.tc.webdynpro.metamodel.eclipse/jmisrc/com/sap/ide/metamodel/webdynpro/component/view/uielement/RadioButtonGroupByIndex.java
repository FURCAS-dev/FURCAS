 ...
 * <p>
 * @see <<interface>>AbstractDropDownByIndex
 * This interface is not intended to be implemented by clients.
 */
public interface RadioButtonGroupByIndex extends com.sap.ide.metamodel.webdynpro.component.view.uielement.Uielement {
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,java.lang.Integer> __colCount;
        /**
         * Returns the descriptor for the <code>colCount</code> attribute.
         * @return  the descriptor for the <code>colCount</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,java.lang.Integer> COL_COUNT( ) {
            if ( __colCount == null ) {
                __colCount = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,java.lang.Integer>( "45DDACEEAA5E7F2B4B5E4F1411C89E6D4FD1E58D", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "RadioButtonGroupByIndex", "colCount" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __colCount;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,com.sap.ide.metamodel.webdynpro.component.view.uielement.State> __state;
        /**
         * Returns the descriptor for the <code>state</code> attribute.
         * @return  the descriptor for the <code>state</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,com.sap.ide.metamodel.webdynpro.component.view.uielement.State> STATE( ) {
            if ( __state == null ) {
                __state = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,com.sap.ide.metamodel.webdynpro.component.view.uielement.State>( "45DDACEECF931D0689F44D1C09D2D1168CFAF14F", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "RadioButtonGroupByIndex", "state" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __state;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,java.lang.String> __width;
        /**
         * Returns the descriptor for the <code>width</code> attribute.
         * @return  the descriptor for the <code>width</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,java.lang.String> WIDTH( ) {
            if ( __width == null ) {
                __width = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.RadioButtonGroupByIndex,java.lang.String>( "45DDACEE29C78D1C5BE841450392F644B5CE58BB", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "RadioButtonGroupByIndex", "width" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __width;
        }
        /**
