...
public class UielementContainerWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.UielementContainer,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public UielementContainerWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.UielementContainerImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.UielementContainer (Java Type)\nWebDynpro.component.view.uielement.UIElementContainer (MOF Type)"; //$NON-NLS-1$
    }    
}