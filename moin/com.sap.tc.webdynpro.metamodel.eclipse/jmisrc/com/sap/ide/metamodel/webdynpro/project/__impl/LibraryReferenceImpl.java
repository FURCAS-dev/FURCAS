...
public final class LibraryReferenceImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("libraryName", Integer.valueOf(4)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private java.lang.String __libraryName = null;
    ...
    // default constructor
    public LibraryReferenceImpl() {
        super();
    }
    
    // specific constructor
    public LibraryReferenceImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEF87BE79266F5B4BB824DE83B75F6E2918", __libraryName, newValue); //$NON-NLS-1$
    }
    public void setLibraryName(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEF87BE79266F5B4BB824DE83B75F6E2918", __libraryName, newValue); //$NON-NLS-1$
    }
    ...
    private void set__LibraryName(java.lang.String newValue) {
            __libraryName = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEF87BE79266F5B4BB824DE83B75F6E2918", __libraryName, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 4:
                set__LibraryName((java.lang.String) value);     
                break;
            default:
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.project.LibraryReference> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.project.LibraryReference.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.project.__impl.LibraryReferenceImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.project.__impl.LibraryReferenceWrapper(conn, this, synchronize);
    }
