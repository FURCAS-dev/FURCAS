...
public class TaggedValueWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl> implements com.sap.ide.metamodel.webdynpro.framework.uielib.TaggedValue,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public TaggedValueWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.uielib.__impl.TaggedValueImpl) getWrappedObject();
    }
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.framework.uielib.TaggedValue> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.framework.uielib.TaggedValue.class;
    }

    // to String
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.uielib.TaggedValue (Java Type)\nWebDynpro.framework.uielib.TaggedValue (MOF Type)"; //$NON-NLS-1$
    }    
}