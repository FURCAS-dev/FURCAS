...
public final class ConfigAggregationImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ConfigModelTargetRole", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("ParentObject", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("AggregatedConfigObjects", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F;
    ...
    // default constructor
    public ConfigAggregationImpl() {
        super();
    }
    
    // specific constructor
    public ConfigAggregationImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getConfigModelTargetRole() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getConfigModelTargetRole(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C);
       
    }
    public void setConfigModelTargetRole(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE7DF228F08BF44A4F3FE9A3A39684777C", /* mofId of reference */ "45DDACEE8761B6D9309D4AEE389BA4A7D8FC5167" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setConfigModelTargetRole(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE7DF228F08BF44A4F3FE9A3A39684777C", /* mofId of reference */ "45DDACEE8761B6D9309D4AEE389BA4A7D8FC5167" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE4A477318D2F5425B0E8C9DDC5B1533EA" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE4A477318D2F5425B0E8C9DDC5B1533EA", /* mofId of reference */ "45DDACEE66DA341745A7414F0312F272E09F4E65" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE4A477318D2F5425B0E8C9DDC5B1533EA", /* mofId of reference */ "45DDACEE66DA341745A7414F0312F272E09F4E65" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getAggregatedConfigObjects() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEE250D714BE0554F1F11E1977E535A5588" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getAggregatedConfigObjects(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEE250D714BE0554F1F11E1977E535A5588" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getConfigModelTargetRole(connection);
                break;
            case 5: 
                result = getParentObject(connection);
                break;
            case 6: 
                result = getAggregatedConfigObjects(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEE7DF228F08BF44A4F3FE9A3A39684777C" /* mofId of association */, "45DDACEE8761B6D9309D4AEE389BA4A7D8FC5167" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEE4A477318D2F5425B0E8C9DDC5B1533EA" /* mofId of association */, "45DDACEE66DA341745A7414F0312F272E09F4E65" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEE250D714BE0554F1F11E1977E535A5588" /* mofId of association */, "45DDACEE4FC1590EC7774CF5230BF48949F690E5" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEEC6268976AC8842672787AE096909A25C" ) { __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEEC6268976AC8842672787AE096909A25C" ) { return __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C); } 
        ...
        if ( __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE397FD03CB47644E60AC0A81FC433CB6F" ) { return __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE397FD03CB47644E60AC0A81FC433CB6F" ) { __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C); __A_ConfigModelTargetRole_configRelation_ConfigModelTargetRole_45DDACEEC6268976AC8842672787AE096909A25C = null; } 
        if ( __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372); __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372 = null; } 
        if ( __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F); __A_AggregatedConfigObjects_IncomingAggregation_AggregatedConfigObjects_45DDACEE397FD03CB47644E60AC0A81FC433CB6F = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.configuration.ConfigAggregation> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.configuration.ConfigAggregation.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.configuration.__impl.ConfigAggregationImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.configuration.__impl.ConfigAggregationWrapper(conn, this, synchronize);
    }
