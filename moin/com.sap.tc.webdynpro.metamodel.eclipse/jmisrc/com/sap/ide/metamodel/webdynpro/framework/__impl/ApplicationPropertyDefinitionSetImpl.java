...
public final class ApplicationPropertyDefinitionSetImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("PropertyDefinitions", Integer.valueOf(4)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB;
    ...
    // default constructor
    public ApplicationPropertyDefinitionSetImpl() {
        super();
    }
    
    // specific constructor
    public ApplicationPropertyDefinitionSetImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.util.List getPropertyDefinitions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEFADDE8283CEC9462E0FCE847071AE4E38" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getPropertyDefinitions(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEFADDE8283CEC9462E0FCE847071AE4E38" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getPropertyDefinitions(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEFADDE8283CEC9462E0FCE847071AE4E38" /* mofId of association */, "45DDACEF397C0D2C37CC4C7A029A83B1DE11BB66" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF0119B771CEEA415D2A73A991E39CBCDB" ) { return __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF0119B771CEEA415D2A73A991E39CBCDB" ) { __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB); __A_PropertyDefinitions_DefinitionSet_PropertyDefinitions_45DDACEF0119B771CEEA415D2A73A991E39CBCDB = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.framework.__impl.ApplicationPropertyDefinitionSetImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.framework.__impl.ApplicationPropertyDefinitionSetWrapper(conn, this, synchronize);
    }
