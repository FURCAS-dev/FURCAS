...
public final class ModelRelationRoleSettingImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ModelRelationRole", Integer.valueOf(6)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF;
    ...
    // default constructor
    public ModelRelationRoleSettingImpl() {
        super();
    }
    
    // specific constructor
    public ModelRelationRoleSettingImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelRelationRole() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF68166D73870E4B9026A9A881C116A35E" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getModelRelationRole(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF68166D73870E4B9026A9A881C116A35E" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setModelRelationRole(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF68166D73870E4B9026A9A881C116A35E", /* mofId of reference */ "45DDACEFCDB2CB975AF641B41339EABF49A0958A" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setModelRelationRole(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF68166D73870E4B9026A9A881C116A35E", /* mofId of reference */ "45DDACEFCDB2CB975AF641B41339EABF49A0958A" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFA75DF23368564E2C149D95882A99AB20", /* mofId of reference */ "45DDACEF11D47EEFA3C84C3A0C1EF628D3100D0E" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFA75DF23368564E2C149D95882A99AB20", /* mofId of reference */ "45DDACEF11D47EEFA3C84C3A0C1EF628D3100D0E" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getModelRelationRole(connection);
                break;
            case 7: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 6:
                ___changeReference(connection, "45DDACEF68166D73870E4B9026A9A881C116A35E" /* mofId of association */, "45DDACEFCDB2CB975AF641B41339EABF49A0958A" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeReference(connection, "45DDACEFA75DF23368564E2C149D95882A99AB20" /* mofId of association */, "45DDACEF11D47EEFA3C84C3A0C1EF628D3100D0E" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "45DDACEFC3A8A479E0D4434926F68129340864EF" ) { __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF = value; return; } //$NON-NLS-1$ 
    }
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFC3A8A479E0D4434926F68129340864EF" ) { return __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF); __A_SettingDefinition_modelRelationRoleSetting_SettingDefinition_45DDACEFC3A8A479E0D4434926F68129340864EF = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.model.ModelRelationRoleSetting> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.model.ModelRelationRoleSetting.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.model.__impl.ModelRelationRoleSettingImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.model.__impl.ModelRelationRoleSettingWrapper(conn, this, synchronize);
    }
