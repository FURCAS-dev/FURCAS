...
/**
 * Procedure for validating state before further processing. Used in controllers for fieldgroup validation.
 * This interface is not intended to be implemented by clients.
 */
public interface Validator extends com.sap.ide.metamodel.webdynpro.base.Procedure {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.Validator> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.Validator>("45DDACEEFA0216042921403F0B21BF1FF463550E", "sap.com/tc/moin/webdynpro", "WebDynpro", "base", "Validator"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
