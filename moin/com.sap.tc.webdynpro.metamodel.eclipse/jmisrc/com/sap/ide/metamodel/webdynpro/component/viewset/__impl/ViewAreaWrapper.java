...
public class ViewAreaWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl> implements com.sap.ide.metamodel.webdynpro.component.viewset.ViewArea,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ViewAreaWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.viewset.__impl.ViewAreaImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.viewset.ViewArea (Java Type)\nWebDynpro.component.viewset.ViewArea (MOF Type)"; //$NON-NLS-1$
    }    
}