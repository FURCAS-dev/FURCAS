...
public class DropDownByIndexWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownByIndex,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DropDownByIndexWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.DropDownByIndexImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownByIndex (Java Type)\nWebDynpro.component.view.uielement.DropDownByIndex (MOF Type)"; //$NON-NLS-1$
    }    
}