...
public final class SupplyFunctionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Controller", Integer.valueOf(9)); //$NON-NLS-1$
        FEATURE_IDS.put("SuppliedNode", Integer.valueOf(10)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B;
    ...
    // default constructor
    public SupplyFunctionImpl() {
        super();
    }
    
    // specific constructor
    public SupplyFunctionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE29D4C3A57A9E4A671482832D7B4D9677" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE29D4C3A57A9E4A671482832D7B4D9677", /* mofId of reference */ "45DDACEE0E284FB4DE38449C2305C5CABB5032B3" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE29D4C3A57A9E4A671482832D7B4D9677", /* mofId of reference */ "45DDACEE0E284FB4DE38449C2305C5CABB5032B3" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getSuppliedNode() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getSuppliedNode(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B);
       
    }
    public void setSuppliedNode(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE9391B5C161DD43112044A3330D29282C", /* mofId of reference */ "45DDACEE601E9335332547DB186DC86B433D89BA" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setSuppliedNode(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE9391B5C161DD43112044A3330D29282C", /* mofId of reference */ "45DDACEE601E9335332547DB186DC86B433D89BA" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 9: 
                ...
                break;
            case 10: 
                result = getSuppliedNode(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 9:
                ___changeReference(connection, "45DDACEE29D4C3A57A9E4A671482832D7B4D9677" /* mofId of association */, "45DDACEE0E284FB4DE38449C2305C5CABB5032B3" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 10:
                ___changeReference(connection, "45DDACEE9391B5C161DD43112044A3330D29282C" /* mofId of association */, "45DDACEE601E9335332547DB186DC86B433D89BA" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "45DDACEED7C3153E35AE41C1035FE7334A5F531B" ) { __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEED7C3153E35AE41C1035FE7334A5F531B" ) { return __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B); __A_SupplyFunction_SuppliedNode_SuppliedNode_45DDACEED7C3153E35AE41C1035FE7334A5F531B = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.component.controller.SupplyFunction> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.component.controller.SupplyFunction.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.controller.__impl.SupplyFunctionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.controller.__impl.SupplyFunctionWrapper(conn, this, synchronize);
    }
