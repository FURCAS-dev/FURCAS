...
public class ToolBarDropDownByKeyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByKey,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ToolBarDropDownByKeyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByKeyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByKey (Java Type)\nWebDynpro.component.view.uielement.ToolBarDropDownByKey (MOF Type)"; //$NON-NLS-1$
    }    
}