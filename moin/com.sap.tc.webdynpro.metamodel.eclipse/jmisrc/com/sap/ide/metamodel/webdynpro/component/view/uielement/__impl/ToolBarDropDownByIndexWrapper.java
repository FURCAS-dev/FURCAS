...
public class ToolBarDropDownByIndexWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByIndex,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ToolBarDropDownByIndexWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarDropDownByIndexImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByIndex (Java Type)\nWebDynpro.component.view.uielement.ToolBarDropDownByIndex (MOF Type)"; //$NON-NLS-1$
    }    
}