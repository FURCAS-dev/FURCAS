...
/**
 * TreeItemType is the type of tree nodes that may not have nested nodes.
 * This interface is not intended to be implemented by clients.
 */
public interface TreeItemType extends com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractTreeNodeType {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.TreeItemType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.TreeItemType>("45DDACEE113365E8FFCD42E511D7CB2CCF3870DD", "sap.com/tc/moin/webdynpro", "WebDynpro", "component", "view", "uielement", "TreeItemType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
