...
public final class ModelRelationImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Model", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("ModelRelationRoles", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240;
    ...
    public ModelRelationImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEFC99534E7F7334DCB0470DF3DEB227032" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEFC99534E7F7334DCB0470DF3DEB227032" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "460CC65C291B97877D6F47443AE0D4222727FE21" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65C291B97877D6F47443AE0D4222727FE21", /* mofId of reference */ "460CC65C9ABF5E69E0A14E89359CA2BC4AEC586D" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "460CC65C291B97877D6F47443AE0D4222727FE21", /* mofId of reference */ "460CC65C9ABF5E69E0A14E89359CA2BC4AEC586D" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getModelRelationRoles() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "460CC65CB4D107F402764A191E57A29C7B28F2E4" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getModelRelationRoles(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "460CC65CB4D107F402764A191E57A29C7B28F2E4" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 5: 
                ...
                break;
            case 6: 
                result = getModelRelationRoles(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEFC99534E7F7334DCB0470DF3DEB227032" /* mofId of association */, "45DDACEF358A26406D0944431B198FF841FBD56E" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "460CC65C291B97877D6F47443AE0D4222727FE21" /* mofId of association */, "460CC65C9ABF5E69E0A14E89359CA2BC4AEC586D" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "460CC65CB4D107F402764A191E57A29C7B28F2E4" /* mofId of association */, "460CC65CF76B9E1A794D458D0127EA4E2E2CD3F1" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852); } 
        ...
        if ( __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF2DB5321168BE45C227C0A6DD8AFEC852" ) { return __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852; } //$NON-NLS-1$ 
        ...
        if ( associationEndMofId == "460CC65C703F24F8F62E47740BB6A3DEDE329240" ) { return __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF2DB5321168BE45C227C0A6DD8AFEC852" ) { __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852 = links; return; } //$NON-NLS-1$ 
        ...
        if ( associationEndMofId == "460CC65C703F24F8F62E47740BB6A3DEDE329240" ) { __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240 = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852); __A_Settings_ModelRelation_Settings_45DDACEF2DB5321168BE45C227C0A6DD8AFEC852 = null; } 
        ...
        if ( __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240); __A_ModelRelationRoles_ModelRelation_ModelRelationRoles_460CC65C703F24F8F62E47740BB6A3DEDE329240 = null; } 
        return result;

    }
    // get the JMI interface
    @SuppressWarnings("unchecked")
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.model.ModelRelation> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.model.ModelRelation.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.model.__impl.ModelRelationImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.model.__impl.ModelRelationWrapper(conn, this, synchronize);
    }
