...
public class DimensionDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.DimensionDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DimensionDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.DimensionDefinitionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.ViewsetDefinition) wrapResult(getCastWrappedObject().getViewsetDefintion(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setViewsetDefintion(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.DimensionDefinition (Java Type)\nWebDynpro.framework.viewsetdefinition.DimensionDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}