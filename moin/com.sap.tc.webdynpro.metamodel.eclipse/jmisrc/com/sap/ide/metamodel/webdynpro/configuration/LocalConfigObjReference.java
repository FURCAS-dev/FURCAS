 ...
 */
public interface LocalConfigObjReference extends com.sap.ide.metamodel.webdynpro.configuration.ConfigurationObjectReference {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObjReference> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObjReference>("45DDACEEA5E03E11F81C48A41D7CE1C97F4E35F2", "sap.com/tc/moin/webdynpro", "WebDynpro", "configuration", "LocalConfigObjReference"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObjReference,java.util.List<com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObject>> __localConfigurationObjects;
        /**
         * Returns the descriptor for the <code>localConfigurationObjects</code> reference.
         * @return  the descriptor for the <code>localConfigurationObjects</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObjReference,java.util.List<com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObject>> LOCAL_CONFIGURATION_OBJECTS( ) {
            if ( __localConfigurationObjects == null ) {
                __localConfigurationObjects = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObjReference,java.util.List<com.sap.ide.metamodel.webdynpro.configuration.LocalConfigObject>>( "45DDACEEAFC31435107F485C0E1796A9D7D29256", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "configuration", "LocalConfigObjReference", "LocalConfigurationObjects" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __localConfigurationObjects;
        }
    }
}    