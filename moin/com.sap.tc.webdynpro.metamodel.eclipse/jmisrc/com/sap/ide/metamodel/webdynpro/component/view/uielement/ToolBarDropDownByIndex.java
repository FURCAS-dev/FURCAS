...
/**
 * A drop-down list with index binding to be used in a tool bar.
 * This interface is not intended to be implemented by clients.
 */
public interface ToolBarDropDownByIndex extends com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractDropDownByIndex {
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByIndex,com.sap.ide.metamodel.common.TranslatableText> __labelText;
        /**
         * Returns the descriptor for the <code>labelText</code> attribute.
         * @return  the descriptor for the <code>labelText</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByIndex,com.sap.ide.metamodel.common.TranslatableText> LABEL_TEXT( ) {
            if ( __labelText == null ) {
                __labelText = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarDropDownByIndex,com.sap.ide.metamodel.common.TranslatableText>( "45DDACEEFFAEEF969AB64B34354EE8051BA77FF6", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "ToolBarDropDownByIndex", "labelText" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __labelText;
        }
        /**
