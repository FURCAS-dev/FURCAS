...
public final class LocalConfigObjReferenceImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("LocalConfigurationObjects", Integer.valueOf(5)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921;
    ...
    // default constructor
    public LocalConfigObjReferenceImpl() {
        super();
    }
    
    // specific constructor
    public LocalConfigObjReferenceImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.util.List getLocalConfigurationObjects() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEE5286E3864817411E300FE869778FFF40" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getLocalConfigurationObjects(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEE5286E3864817411E300FE869778FFF40" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getLocalConfigurationObjects(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "45DDACEE5286E3864817411E300FE869778FFF40" /* mofId of association */, "45DDACEEAFC31435107F485C0E1796A9D7D29256" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEEE9CECEEA268140D93CCEDD233DD28921" ) { return __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEEE9CECEEA268140D93CCEDD233DD28921" ) { __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921 = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921); __A_LocalConfigurationObjects_localConfigObjReference_LocalConfigurationObjects_45DDACEEE9CECEEA268140D93CCEDD233DD28921 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.configuration.__impl.LocalConfigObjReferenceImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.configuration.__impl.LocalConfigObjReferenceWrapper(conn, this, synchronize);
    }
