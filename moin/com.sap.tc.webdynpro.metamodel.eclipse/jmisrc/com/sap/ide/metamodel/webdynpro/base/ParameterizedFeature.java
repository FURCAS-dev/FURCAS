...
/**
 * Abstract superclass for development objects containing parameters, such as events and procedures.
 * This interface is not intended to be implemented by clients.
 */
public interface ParameterizedFeature extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.ParameterizedFeature> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.base.ParameterizedFeature>("45DDACEE5635DE2606A6445B28FFCCF7126EB703", "sap.com/tc/moin/webdynpro", "WebDynpro", "base", "ParameterizedFeature"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.base.ParameterizedFeature,java.util.List<com.sap.ide.metamodel.webdynpro.base.Parameter>> __parameters;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.base.ParameterizedFeature,java.util.List<com.sap.ide.metamodel.webdynpro.base.Parameter>> PARAMETERS( ) {
            if ( __parameters == null ) {
                __parameters = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.webdynpro.base.ParameterizedFeature,java.util.List<com.sap.ide.metamodel.webdynpro.base.Parameter>>( "460CC65B51B3E22033B54D8B3DE9E4638892F3A3", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "base", "ParameterizedFeature", "Parameters" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __parameters;
        }
    }
