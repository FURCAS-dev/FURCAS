...
public class ModelSettingDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.framework.ModelSettingDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ModelSettingDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.framework.__impl.ModelSettingDefinitionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.framework.ModelSettingDefinition (Java Type)\nWebDynpro.framework.ModelSettingDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}