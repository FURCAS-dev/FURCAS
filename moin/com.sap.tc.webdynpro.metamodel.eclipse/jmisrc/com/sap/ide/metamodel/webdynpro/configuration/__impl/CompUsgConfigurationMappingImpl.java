...
public final class CompUsgConfigurationMappingImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Source", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("Target", Integer.valueOf(5)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2;
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E;
    ...
    // default constructor
    public CompUsgConfigurationMappingImpl() {
        super();
    }
    
    // specific constructor
    public CompUsgConfigurationMappingImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE7252C33D4727495513D883AC45E38F76", /* mofId of reference */ "45DDACEE1F1841A5EBB34094196CE47143F31EAD" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE7252C33D4727495513D883AC45E38F76", /* mofId of reference */ "45DDACEE1F1841A5EBB34094196CE47143F31EAD" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE84D93D615EA349752F9BE92C9B1B7E39", /* mofId of reference */ "45DDACEEC9EEDE7BA9024BAE3A40C3EB981F7051" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE84D93D615EA349752F9BE92C9B1B7E39", /* mofId of reference */ "45DDACEEC9EEDE7BA9024BAE3A40C3EB981F7051" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEE7252C33D4727495513D883AC45E38F76" /* mofId of association */, "45DDACEE1F1841A5EBB34094196CE47143F31EAD" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEE84D93D615EA349752F9BE92C9B1B7E39" /* mofId of association */, "45DDACEEC9EEDE7BA9024BAE3A40C3EB981F7051" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE65C459A7CB4E47B020C8F3DFA60789F2" ) { __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2 = value; return; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E" ) { __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE65C459A7CB4E47B020C8F3DFA60789F2" ) { return __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E" ) { return __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2); } 
        if ( __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2); __A_Source_compUsgConfigurationMapping_Source_45DDACEE65C459A7CB4E47B020C8F3DFA60789F2 = null; } 
        if ( __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E); __A_Target_compUsgConfigurationMapping_Target_45DDACEEE1C75F3A2FD5453704C2CA29A35CA96E = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.configuration.__impl.CompUsgConfigurationMappingImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.configuration.__impl.CompUsgConfigurationMappingWrapper(conn, this, synchronize);
    }
