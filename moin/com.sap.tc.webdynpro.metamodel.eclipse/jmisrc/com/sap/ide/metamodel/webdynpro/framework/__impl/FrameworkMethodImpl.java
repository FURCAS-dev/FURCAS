...
public final class FrameworkMethodImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("FrameworkObject", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("ReturnType", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1;
    ...
    // default constructor
    public FrameworkMethodImpl() {
        super();
    }
    
    // specific constructor
    public FrameworkMethodImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getFrameworkObject() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF18D37B4D4E3744D70685CB4807D51D30" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getFrameworkObject(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF18D37B4D4E3744D70685CB4807D51D30" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setFrameworkObject(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF18D37B4D4E3744D70685CB4807D51D30", /* mofId of reference */ "45DDACEFD8CC43580D1043B8107EC12DC13B8002" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setFrameworkObject(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF18D37B4D4E3744D70685CB4807D51D30", /* mofId of reference */ "45DDACEFD8CC43580D1043B8107EC12DC13B8002" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFC21DB14857D247ED3ABCCE6AE1D89FDE", /* mofId of reference */ "45DDACEF1AD7517F825F4D7415FD851897B41FFF" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFC21DB14857D247ED3ABCCE6AE1D89FDE", /* mofId of reference */ "45DDACEF1AD7517F825F4D7415FD851897B41FFF" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getFrameworkObject(connection);
                break;
            case 6: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "45DDACEF18D37B4D4E3744D70685CB4807D51D30" /* mofId of association */, "45DDACEFD8CC43580D1043B8107EC12DC13B8002" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEFC21DB14857D247ED3ABCCE6AE1D89FDE" /* mofId of association */, "45DDACEF1AD7517F825F4D7415FD851897B41FFF" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEF6D1A3306381C44DD0640E559E6B1A8E1" ) { __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1 = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF6D1A3306381C44DD0640E559E6B1A8E1" ) { return __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1); __A_ReturnType_frameworkMethod_ReturnType_45DDACEF6D1A3306381C44DD0640E559E6B1A8E1 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.framework.__impl.FrameworkMethodImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.framework.__impl.FrameworkMethodWrapper(conn, this, synchronize);
    }
