...
public final class TranslatableViewElementPropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Owner", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("isDependent", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("Definition", Integer.valueOf(6)); //$NON-NLS-1$
    ...
    private boolean __isDependent = false;
    private int __maxLength = 0;

    // links for multiplicity-1 association ends
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65;
    ...
    // default constructor
    public TranslatableViewElementPropertyImpl() {
        super();
    }
    
    // specific constructor
    public TranslatableViewElementPropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEE1E26AB67DCD0405A1DBDC8FBAB21548A", __isDependent, newValue); //$NON-NLS-1$
    }
    public void setDependent(com.sap.tc.moin.repository.core.CoreConnection connection, boolean newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEE1E26AB67DCD0405A1DBDC8FBAB21548A", __isDependent, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(get___CurrentConnection(), "45DDACEEEA627FA85D9240060DF186E92E0FFE92", newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(connection, "45DDACEEEA627FA85D9240060DF186E92E0FFE92", newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 8, "45DDACEEE04D24F4698B4490377487F2F3125146", __maxLength, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 8, "45DDACEEE04D24F4698B4490377487F2F3125146", __maxLength, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEF514171C9D1D48101950EC744425E57C" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEF514171C9D1D48101950EC744425E57C", /* mofId of reference */ "45DDACEEBDCBFCA9F09C4DC33B93C15C8B43A8E8" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEF514171C9D1D48101950EC744425E57C", /* mofId of reference */ "45DDACEEBDCBFCA9F09C4DC33B93C15C8B43A8E8" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEB3F3B6C61E5941870A649290B5E666BE", /* mofId of reference */ "45DDACEEBC93F5ABBB43423901F88EC805F3493E" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEB3F3B6C61E5941870A649290B5E666BE", /* mofId of reference */ "45DDACEEBC93F5ABBB43423901F88EC805F3493E" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__Dependent(boolean newValue) {
            __isDependent = newValue;
    }

    private void set__Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.Object newValue) {
        ___loadLinks(session, "45DDACEEEA627FA85D9240060DF186E92E0FFE92" /* "value" */, newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEEF514171C9D1D48101950EC744425E57C" /* mofId of association */, "45DDACEEBDCBFCA9F09C4DC33B93C15C8B43A8E8" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEE1E26AB67DCD0405A1DBDC8FBAB21548A", __isDependent, value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEEB3F3B6C61E5941870A649290B5E666BE" /* mofId of association */, "45DDACEEBC93F5ABBB43423901F88EC805F3493E" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeObjectAttribute(connection, "45DDACEEEA627FA85D9240060DF186E92E0FFE92", value); //$NON-NLS-1$
                break;
                    
            case 8:
                ___changeDataTypeAttribute(connection, 8, "45DDACEEE04D24F4698B4490377487F2F3125146", __maxLength, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 5:
                set__Dependent((java.lang.Boolean) value);     
                break;
            case 7:
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE30E89A4B59584DF60B4380497E789A65" ) { __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65 = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE30E89A4B59584DF60B4380497E789A65" ) { return __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65; } //$NON-NLS-1$ 
    ...
    public void set___AttributeLink( String attributeMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( attributeMofId == "45DDACEEEA627FA85D9240060DF186E92E0FFE92" ) { __value = value; return; } //$NON-NLS-1$ 
    }

    public com.sap.tc.moin.repository.core.EndStorageLink get___AttributeLink( String attributeMofId ) {
        if ( attributeMofId == "45DDACEEEA627FA85D9240060DF186E92E0FFE92" ) { return __value; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65); __A_Definition_translatableViewElementProperty_Definition_45DDACEE30E89A4B59584DF60B4380497E789A65 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TranslatableViewElementPropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.TranslatableViewElementPropertyWrapper(conn, this, synchronize);
    }
