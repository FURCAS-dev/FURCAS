...
public final class ViewsetDefinitionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("ViewAreaDefinitions", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("SimplePropertyDefinitions", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("DimensionDefinitions", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510;
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D;
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8;
    ...
    // default constructor
    public ViewsetDefinitionImpl() {
        super();
    }
    
    // specific constructor
    public ViewsetDefinitionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.util.List getViewAreaDefinitions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEE78BAAACE6B474117092DB4A5214C8921" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getViewAreaDefinitions(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEE78BAAACE6B474117092DB4A5214C8921" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }


    public java.util.List getSimplePropertyDefinitions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEEF146D98339AE42561D08F8F141D389B5" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getSimplePropertyDefinitions(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEEF146D98339AE42561D08F8F141D389B5" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }


    public java.util.List getDimensionDefinitions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getDimensionDefinitions(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getViewAreaDefinitions(connection);
                break;
            case 5: 
                result = getSimplePropertyDefinitions(connection);
                break;
            case 6: 
                result = getDimensionDefinitions(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEE78BAAACE6B474117092DB4A5214C8921" /* mofId of association */, "45DDACEE284A4D7DDD4543E60C55A271692B4E1D" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEEF146D98339AE42561D08F8F141D389B5" /* mofId of association */, "45DDACEE7A722175D0124C0901A99D33B888C532" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEE6B87AF7C67FE45D63D169CA5D49D305F" /* mofId of association */, "45DDACEE08480A54455A4B952F42F197F6FF6BAE" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510); } 
        if ( __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D); } 
        if ( __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510" ) { return __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEE7BB0E8A6885E4D3922A2A2559109237D" ) { return __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEE9E55270BF0AF4D4C24D19817648F23B8" ) { return __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510" ) { __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510 = links; return; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEE7BB0E8A6885E4D3922A2A2559109237D" ) { __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D = links; return; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEE9E55270BF0AF4D4C24D19817648F23B8" ) { __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8 = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510); __A_DimensionDefinitions_ViewsetDefintion_DimensionDefinitions_45DDACEE414B74D5A16A4C6A387AB9AB7EEB6510 = null; } 
        if ( __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D); __A_ViewAreaDefinitions_ViewsetDefinition_ViewAreaDefinitions_45DDACEE7BB0E8A6885E4D3922A2A2559109237D = null; } 
        if ( __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8); __A_SimplePropertyDefinitions_ViewsetDefinition_SimplePropertyDefinitions_45DDACEE9E55270BF0AF4D4C24D19817648F23B8 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.ViewsetDefinitionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.framework.viewsetdefinition.__impl.ViewsetDefinitionWrapper(conn, this, synchronize);
    }
