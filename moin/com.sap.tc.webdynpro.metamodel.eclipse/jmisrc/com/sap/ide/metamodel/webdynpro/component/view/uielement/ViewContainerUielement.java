...
/**
 * ViewContainerUIElement is a placeholder that may contain another view.
 * This interface is not intended to be implemented by clients.
 */
public interface ViewContainerUielement extends com.sap.ide.metamodel.webdynpro.component.view.uielement.Uielement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.ViewContainerUielement> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.ViewContainerUielement>("45DDACEECC6AE637638A4B3B15ABF320008BF0BD", "sap.com/tc/moin/webdynpro", "WebDynpro", "component", "view", "uielement", "ViewContainerUIElement"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
