...
public final class ActionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("EventHandler", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("Controller", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("type", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("text", Integer.valueOf(8)); //$NON-NLS-1$
        FEATURE_IDS.put("imageSource", Integer.valueOf(9)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private com.sap.ide.metamodel.webdynpro.enums.ActionTypeEnum __type = null;
    private java.lang.String __imageSource = null;

    // links for multiplicity-1 association ends
    private com.sap.tc.moin.repository.core.EndStorageLink __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B;
    ...
    public ActionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 7, "45DDACEE4EDB83F59B0647650F56CAC7FAB6A365", __type, newValue); //$NON-NLS-1$
    }
    public void setType(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.ide.metamodel.webdynpro.enums.ActionTypeEnum newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 7, "45DDACEE4EDB83F59B0647650F56CAC7FAB6A365", __type, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(get___CurrentConnection(), "45DDACEE09C82EDA49464E302CCDD9FFF01F44E9", newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(connection, "45DDACEE09C82EDA49464E302CCDD9FFF01F44E9", newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 9, "45DDACEEEC60016F2AB84A000CB6AA4D189EACDE", __imageSource, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 9, "45DDACEEEC60016F2AB84A000CB6AA4D189EACDE", __imageSource, newValue); //$NON-NLS-1$
    }
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getEventHandler() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getEventHandler(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B);
       
    }
    public void setEventHandler(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE4D2AA61DEB3545852B0CFC6868F9E79B", /* mofId of reference */ "45DDACEEB0C22372792A43A72EA6A9618A9EB046" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setEventHandler(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE4D2AA61DEB3545852B0CFC6868F9E79B", /* mofId of reference */ "45DDACEEB0C22372792A43A72EA6A9618A9EB046" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEB9F91703F5154BF0327BF074E5A15080" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEB9F91703F5154BF0327BF074E5A15080", /* mofId of reference */ "45DDACEE9D1B071089764A8A3153F836F3D5BFD2" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEB9F91703F5154BF0327BF074E5A15080", /* mofId of reference */ "45DDACEE9D1B071089764A8A3153F836F3D5BFD2" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__Type(com.sap.ide.metamodel.webdynpro.enums.ActionTypeEnum newValue) {
            __type = newValue;
    }

    private void set__Text(com.sap.tc.moin.repository.core.CoreSession session, java.lang.Object newValue) {
        ___loadLinks(session, "45DDACEE09C82EDA49464E302CCDD9FFF01F44E9" /* "text" */, newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getEventHandler(connection);
                break;
            case 6: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "45DDACEE4D2AA61DEB3545852B0CFC6868F9E79B" /* mofId of association */, "45DDACEEB0C22372792A43A72EA6A9618A9EB046" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEEB9F91703F5154BF0327BF074E5A15080" /* mofId of association */, "45DDACEE9D1B071089764A8A3153F836F3D5BFD2" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeDataTypeAttribute(connection, 7, "45DDACEE4EDB83F59B0647650F56CAC7FAB6A365", __type, value); //$NON-NLS-1$
                break;
                    
            case 8:
                ___changeObjectAttribute(connection, "45DDACEE09C82EDA49464E302CCDD9FFF01F44E9", value); //$NON-NLS-1$
                break;
                    
            case 9:
                ___changeDataTypeAttribute(connection, 9, "45DDACEEEC60016F2AB84A000CB6AA4D189EACDE", __imageSource, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 7:
                set__Type((com.sap.ide.metamodel.webdynpro.enums.ActionTypeEnum) value);     
                break;
            case 8:
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE647197E879F94179370897C410FD187B" ) { __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE647197E879F94179370897C410FD187B" ) { return __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B; } //$NON-NLS-1$ 
    ...
    public void set___AttributeLink( String attributeMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( attributeMofId == "45DDACEE09C82EDA49464E302CCDD9FFF01F44E9" ) { __text = value; return; } //$NON-NLS-1$ 
    }

    public com.sap.tc.moin.repository.core.EndStorageLink get___AttributeLink( String attributeMofId ) {
        if ( attributeMofId == "45DDACEE09C82EDA49464E302CCDD9FFF01F44E9" ) { return __text; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B); __A_incomingEvent_EventHandler_EventHandler_45DDACEE647197E879F94179370897C410FD187B = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.controller.__impl.ActionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.controller.__impl.ActionWrapper(conn, this, synchronize);
    }
