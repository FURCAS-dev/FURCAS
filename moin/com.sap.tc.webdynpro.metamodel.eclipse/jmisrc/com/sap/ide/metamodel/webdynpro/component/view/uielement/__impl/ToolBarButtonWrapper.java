...
public class ToolBarButtonWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarButton,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ToolBarButtonWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ToolBarButtonImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.ToolBarButton (Java Type)\nWebDynpro.component.view.uielement.ToolBarButton (MOF Type)"; //$NON-NLS-1$
    }    
}