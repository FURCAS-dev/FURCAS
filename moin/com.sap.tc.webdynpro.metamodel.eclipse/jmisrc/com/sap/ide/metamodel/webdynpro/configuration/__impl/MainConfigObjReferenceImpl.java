...
public final class MainConfigObjReferenceImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Configuration", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("MainConfigurationObjects", Integer.valueOf(5)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0;
    ...
    // default constructor
    public MainConfigObjReferenceImpl() {
        super();
    }
    
    // specific constructor
    public MainConfigObjReferenceImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getConfiguration() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE52418E305D844F121753CF22DFF19C40" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getConfiguration(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE52418E305D844F121753CF22DFF19C40" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setConfiguration(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE52418E305D844F121753CF22DFF19C40", /* mofId of reference */ "45DDACEEE99B6C268C8D4AD537A1F33AA7A20B75" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setConfiguration(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE52418E305D844F121753CF22DFF19C40", /* mofId of reference */ "45DDACEEE99B6C268C8D4AD537A1F33AA7A20B75" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getMainConfigurationObjects() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEED8CD58C1E2FB4E4735BF867A96DB7D84" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getMainConfigurationObjects(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEED8CD58C1E2FB4E4735BF867A96DB7D84" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getMainConfigurationObjects(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEE52418E305D844F121753CF22DFF19C40" /* mofId of association */, "45DDACEEE99B6C268C8D4AD537A1F33AA7A20B75" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEED8CD58C1E2FB4E4735BF867A96DB7D84" /* mofId of association */, "45DDACEEFDD392E731C34BF30F02C319F00186AD" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE502C310CB00044850D44F218F4109CD0" ) { return __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE502C310CB00044850D44F218F4109CD0" ) { __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0 = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0); __A_MainConfigurationObjects_mainConfigObjReference_MainConfigurationObjects_45DDACEE502C310CB00044850D44F218F4109CD0 = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.configuration.MainConfigObjReference> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.configuration.MainConfigObjReference.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.configuration.__impl.MainConfigObjReferenceWrapper(conn, this, synchronize);
    }
