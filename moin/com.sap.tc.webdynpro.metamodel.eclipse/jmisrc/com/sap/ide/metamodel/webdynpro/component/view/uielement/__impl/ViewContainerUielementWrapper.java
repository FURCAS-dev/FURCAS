...
public class ViewContainerUielementWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl> implements com.sap.ide.metamodel.webdynpro.component.view.uielement.ViewContainerUielement,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ViewContainerUielementWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.component.view.uielement.__impl.ViewContainerUielementImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.component.view.uielement.ViewContainerUielement (Java Type)\nWebDynpro.component.view.uielement.ViewContainerUIElement (MOF Type)"; //$NON-NLS-1$
    }    
}