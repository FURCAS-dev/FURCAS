...
public class StereotypeDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl> implements com.sap.ide.metamodel.webdynpro.model.StereotypeDefinition,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public StereotypeDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.model.__impl.StereotypeDefinitionImpl) getWrappedObject();
    }
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.model.StereotypeDefinition> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.model.StereotypeDefinition.class;
    }

    // to String
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.model.StereotypeDefinition (Java Type)\nWebDynpro.model.StereotypeDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}