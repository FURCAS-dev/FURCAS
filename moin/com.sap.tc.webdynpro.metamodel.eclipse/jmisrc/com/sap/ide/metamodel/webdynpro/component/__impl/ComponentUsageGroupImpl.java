...
public final class ComponentUsageGroupImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Members", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("cardinality", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873;
    ...
    // default constructor
    public ComponentUsageGroupImpl() {
        super();
    }
    
    // specific constructor
    public ComponentUsageGroupImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEE93BF9E46098240683B16EFD0096AEE85", __cardinality, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEE93BF9E46098240683B16EFD0096AEE85", __cardinality, newValue); //$NON-NLS-1$
    }
    ...
    public java.util.Collection getMembers() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEE506C4453E37A44022E67A63E39B6AF76" /* attribute or association */, 1 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.Collection getMembers(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEE506C4453E37A44022E67A63E39B6AF76" /* attribute or association */, 1 ) ) ; //$NON-NLS-1$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "45DDACEE506C4453E37A44022E67A63E39B6AF76" /* mofId of association */, "45DDACEEA595ABC3ED7343660425C028CD54E7EF" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEE93BF9E46098240683B16EFD0096AEE85", __cardinality, value); //$NON-NLS-1$
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE1269BB096DAD4D642537D7AC717D0873" ) { return __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE1269BB096DAD4D642537D7AC717D0873" ) { __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873 = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873); __A_componentUsageGroup_Members_Members_45DDACEE1269BB096DAD4D642537D7AC717D0873 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.__impl.ComponentUsageGroupImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.__impl.ComponentUsageGroupWrapper(conn, this, synchronize);
    }
