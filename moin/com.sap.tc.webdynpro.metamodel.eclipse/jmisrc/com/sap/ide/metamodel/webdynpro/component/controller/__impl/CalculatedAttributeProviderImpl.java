...
public final class CalculatedAttributeProviderImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Controller", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("Accessor", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("Attribute", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("Mutator", Integer.valueOf(7)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3;
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E;
    ...
    // default constructor
    public CalculatedAttributeProviderImpl() {
        super();
    }
    
    // specific constructor
    public CalculatedAttributeProviderImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getController() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE56F40C7D0B4745881676B566BAB387B7" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getController(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEE56F40C7D0B4745881676B566BAB387B7" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setController(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE56F40C7D0B4745881676B566BAB387B7", /* mofId of reference */ "45DDACEE2C7285065F4944B437E38491B6F87534" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setController(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE56F40C7D0B4745881676B566BAB387B7", /* mofId of reference */ "45DDACEE2C7285065F4944B437E38491B6F87534" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getAccessor() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getAccessor(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3);
       
    }
    public void setAccessor(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE25D01613B12C454D19EDAD7428D6EFA9", /* mofId of reference */ "45DDACEE083C1DBC2F9C40981F80D9B5B2216828" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setAccessor(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE25D01613B12C454D19EDAD7428D6EFA9", /* mofId of reference */ "45DDACEE083C1DBC2F9C40981F80D9B5B2216828" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getAttribute() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEFA0E46FDFEDE41B812CEE9517F72AFDC" /* attribute or association */, 0 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getAttribute(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEFA0E46FDFEDE41B812CEE9517F72AFDC" /* attribute or association */, 0 ); //$NON-NLS-1$
    ...
    public void setAttribute(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEFA0E46FDFEDE41B812CEE9517F72AFDC", /* mofId of reference */ "45DDACEE976D333026614740252F94893C3B8BC1" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setAttribute(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEFA0E46FDFEDE41B812CEE9517F72AFDC", /* mofId of reference */ "45DDACEE976D333026614740252F94893C3B8BC1" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getMutator() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getMutator(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E);
       
    }
    public void setMutator(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEE60DED6EA2DE9490804A1AEC62B3AA70D", /* mofId of reference */ "45DDACEEE45FDFEA88DC475A20D7D5DE5A4CA6D3" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setMutator(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEE60DED6EA2DE9490804A1AEC62B3AA70D", /* mofId of reference */ "45DDACEEE45FDFEA88DC475A20D7D5DE5A4CA6D3" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getController(connection);
                break;
            case 5: 
                result = getAccessor(connection);
                break;
            case 6: 
                result = getAttribute(connection);
                break;
            case 7: 
                result = getMutator(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEE56F40C7D0B4745881676B566BAB387B7" /* mofId of association */, "45DDACEE2C7285065F4944B437E38491B6F87534" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEE25D01613B12C454D19EDAD7428D6EFA9" /* mofId of association */, "45DDACEE083C1DBC2F9C40981F80D9B5B2216828" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEEFA0E46FDFEDE41B812CEE9517F72AFDC" /* mofId of association */, "45DDACEE976D333026614740252F94893C3B8BC1" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeReference(connection, "45DDACEE60DED6EA2DE9490804A1AEC62B3AA70D" /* mofId of association */, "45DDACEEE45FDFEA88DC475A20D7D5DE5A4CA6D3" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3" ) { __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3 = value; return; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEE8D17ED5DAAF8494523F5854B47050A5E" ) { __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3" ) { return __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3; } //$NON-NLS-1$ 
        if ( associationEndMofId == "45DDACEE8D17ED5DAAF8494523F5854B47050A5E" ) { return __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3); } 
        if ( __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3); __A_Accessor_calculatedAttributeProvider_Accessor_45DDACEE344AD0610CC24CF317DEFAEAAD9B6AB3 = null; } 
        if ( __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E); __A_Mutator_calculatedAttributeProvider_Mutator_45DDACEE8D17ED5DAAF8494523F5854B47050A5E = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.component.controller.CalculatedAttributeProvider> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.component.controller.CalculatedAttributeProvider.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.controller.__impl.CalculatedAttributeProviderImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.controller.__impl.CalculatedAttributeProviderWrapper(conn, this, synchronize);
    }
