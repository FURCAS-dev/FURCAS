...
public final class NavigationTargetReferenceImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("NavigationLink", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("TargetViewUsage", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("Target", Integer.valueOf(7)); //$NON-NLS-1$
    }
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1;
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237;
    ...
    // default constructor
    public NavigationTargetReferenceImpl() {
        super();
    }
    
    // specific constructor
    public NavigationTargetReferenceImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getNavigationLink() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getNavigationLink(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setNavigationLink(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3", /* mofId of reference */ "45DDACEE200B972DBD1B449A183DD9DFC45BC8A9" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setNavigationLink(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3", /* mofId of reference */ "45DDACEE200B972DBD1B449A183DD9DFC45BC8A9" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getTargetViewUsage() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getTargetViewUsage(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1);
       
    }
    public void setTargetViewUsage(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEEAA26F358D67E42E10772DBC547603BC8", /* mofId of reference */ "45DDACEE18CCF09F186445A80E40956FD08CA599" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setTargetViewUsage(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEEAA26F358D67E42E10772DBC547603BC8", /* mofId of reference */ "45DDACEE18CCF09F186445A80E40956FD08CA599" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "460CC65CC4334EEBB2D342EF119E81444201456E", /* mofId of reference */ "460CC65CC9CC7A3BF0284342209181D5726ADBD7" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "460CC65CC4334EEBB2D342EF119E81444201456E", /* mofId of reference */ "460CC65CC9CC7A3BF0284342209181D5726ADBD7" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getNavigationLink(connection);
                break;
            case 6: 
                result = getTargetViewUsage(connection);
                break;
            case 7: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "45DDACEEDAFF8F1C7E80495A1C21CB5A2ACC20D3" /* mofId of association */, "45DDACEE200B972DBD1B449A183DD9DFC45BC8A9" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "45DDACEEAA26F358D67E42E10772DBC547603BC8" /* mofId of association */, "45DDACEE18CCF09F186445A80E40956FD08CA599" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 7:
                ___changeReference(connection, "460CC65CC4334EEBB2D342EF119E81444201456E" /* mofId of association */, "460CC65CC9CC7A3BF0284342209181D5726ADBD7" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( associationEndMofId == "45DDACEEB6AB50849EEA44E121DD94892809CEC1" ) { __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1 = value; return; } //$NON-NLS-1$ 
        ...
        if ( associationEndMofId == "460CC65C7ED2FEF018CC488F2B02F0B520FBB237" ) { __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237 = value; return; } //$NON-NLS-1$ 
    }
    
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEEB6AB50849EEA44E121DD94892809CEC1" ) { return __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1; } //$NON-NLS-1$ 
        ...
        if ( associationEndMofId == "460CC65C7ED2FEF018CC488F2B02F0B520FBB237" ) { return __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1); } 
        ...
        if ( __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> result = null;
        if ( __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1); __A_TargetViewUsage_navigationTargetReference_TargetViewUsage_45DDACEEB6AB50849EEA44E121DD94892809CEC1 = null; } 
        if ( __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372); __A_DocumentationObject_commonDevelopmentObject_DocumentationObject_45DDACEFC2A0C1CA72084C5D2DCACA7DBD913372 = null; } 
        if ( __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237); __A_Target_navigationTargetReference_Target_460CC65C7ED2FEF018CC488F2B02F0B520FBB237 = null; } 
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.component.navigation.__impl.NavigationTargetReferenceImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.component.navigation.__impl.NavigationTargetReferenceWrapper(conn, this, synchronize);
    }
