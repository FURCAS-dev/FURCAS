 ...
 */
public interface DropDownByKey extends com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractDropDownByKey {
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownByKey,com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownListBoxSize> __size;
        /**
         * Returns the descriptor for the <code>size</code> attribute.
         * @return  the descriptor for the <code>size</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownByKey,com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownListBoxSize> SIZE( ) {
            if ( __size == null ) {
                __size = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownByKey,com.sap.ide.metamodel.webdynpro.component.view.uielement.DropDownListBoxSize>( "45DDACEEC9A4B6D311AD487A25CBB8F62485F62B", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "DropDownByKey", "size" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __size;
        }
        /**
