...
public final class TextPackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    static {
        ...
        FEATURE_IDS.put("UIText", Integer.valueOf(0)); //$NON-NLS-1$
    }

    // constructors    
    public TextPackageImpl()
    {
        super();
    }
    public TextPackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    // nested packages
    // classes
    public com.sap.tc.moin.repository.mmi.reflect.RefClass getUitext(com.sap.tc.moin.repository.core.CoreConnection connection) {
        return  refClass(connection, "UIText"); //$NON-NLS-1$
    }
    // associations
    ...
    protected java.lang.Object create___Extent(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
        ...
        try {
            switch (FEATURE_IDS.get(name)) {
                case 0:
                    return new com.sap.tc.moin.repository.core.jmi.reflect.RefClassImpl(workspace, mofId, immediatePackage, metaObject, Class.forName("com.sap.ide.metamodel.webdynpro.text.__impl.UitextImpl")); //$NON-NLS-1$
                default:
    ...
    protected void initialize() {
        ...
        if (___refClasses == null) {
            ...
            name = "UIText"; //$NON-NLS-1$
            rcan = new RefClassAndName(name, "com.sap.ide.metamodel.webdynpro.text.Uitext"); //$NON-NLS-1$
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.text.__impl.TextPackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.text.__impl.TextPackageWrapper(conn, this, synchronize);
    }
