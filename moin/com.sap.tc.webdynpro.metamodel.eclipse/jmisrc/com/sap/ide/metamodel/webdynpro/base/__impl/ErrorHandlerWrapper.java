...
public class ErrorHandlerWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl> implements com.sap.ide.metamodel.webdynpro.base.ErrorHandler,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public ErrorHandlerWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl) resolved;
    }
    
    public com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl unwrap() {
        return (com.sap.ide.metamodel.webdynpro.base.__impl.ErrorHandlerImpl) getWrappedObject();
    }
    ...
    public java.lang.Class<com.sap.ide.metamodel.webdynpro.base.ErrorHandler> get___JmiInterface() {
        return com.sap.ide.metamodel.webdynpro.base.ErrorHandler.class;
    }

    // to String
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.webdynpro.base.ErrorHandler (Java Type)\nWebDynpro.base.ErrorHandler (MOF Type)"; //$NON-NLS-1$
    }    
}