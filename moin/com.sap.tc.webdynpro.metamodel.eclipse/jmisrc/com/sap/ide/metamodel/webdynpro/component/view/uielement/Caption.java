...
/**
 * Caption is a concrete subclass of AbstractCaption.
 * It is used by UI elements that may display a caption.
 * <p>
 * @see <<interface>>Group
 * @see <<interface>>Tab
 * @see <<interface>>Table
 * @see <<interface>>TableColumn
 * @see <<interface>>Tray 
 * This interface is not intended to be implemented by clients.
 */
public interface Caption extends com.sap.ide.metamodel.webdynpro.component.view.uielement.AbstractCaption {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption>("45DDACEE7300FA218BB84DCC3B44EF945799670A", "sap.com/tc/moin/webdynpro", "WebDynpro", "component", "view", "uielement", "Caption"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption,com.sap.ide.metamodel.common.TranslatableText> __text;
        /**
         * Returns the descriptor for the <code>text</code> attribute.
         * @return  the descriptor for the <code>text</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption,com.sap.ide.metamodel.common.TranslatableText> TEXT( ) {
            if ( __text == null ) {
                __text = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption,com.sap.ide.metamodel.common.TranslatableText>( "45DDACEE5337CAB3AFFC43D6032AC1FA642DB4C3", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "Caption", "text" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
            return __text;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption,java.lang.Boolean> __textIsDependent;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption,java.lang.Boolean> TEXT_IS_DEPENDENT( ) {
            if ( __textIsDependent == null ) {
                __textIsDependent = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.ide.metamodel.webdynpro.component.view.uielement.Caption,java.lang.Boolean>( "45DDACEE68E6FEBD0A73423B3B51DC65701D77AF", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "WebDynpro", "component", "view", "uielement", "Caption", "text_isDependent" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ 
            }
