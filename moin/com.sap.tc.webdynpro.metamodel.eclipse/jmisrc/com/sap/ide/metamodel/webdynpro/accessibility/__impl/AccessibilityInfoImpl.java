...
public final class AccessibilityInfoImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("accessibilityRelevant", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("accessibilityCompliant", Integer.valueOf(5)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityRelevanceEnum __accessibilityRelevant = null;
    private com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityComplianceEnum __accessibilityCompliant = null;
    ...
    // default constructor
    public AccessibilityInfoImpl() {
        super();
    }
    
    // specific constructor
    public AccessibilityInfoImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEE61BCFA4944B9450B288580BF63C170AC", __accessibilityRelevant, newValue); //$NON-NLS-1$
    }
    public void setAccessibilityRelevant(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityRelevanceEnum newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEE61BCFA4944B9450B288580BF63C170AC", __accessibilityRelevant, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEEC34CFAE55D2949A2272896942801514F", __accessibilityCompliant, newValue); //$NON-NLS-1$
    }
    public void setAccessibilityCompliant(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityComplianceEnum newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEEC34CFAE55D2949A2272896942801514F", __accessibilityCompliant, newValue); //$NON-NLS-1$
    }
    ...
    private void set__AccessibilityRelevant(com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityRelevanceEnum newValue) {
            __accessibilityRelevant = newValue;
    }

    private void set__AccessibilityCompliant(com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityComplianceEnum newValue) {
            __accessibilityCompliant = newValue;
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getAccessibilityRelevant();
                break;
            case 5: 
                result = getAccessibilityCompliant();
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEE61BCFA4944B9450B288580BF63C170AC", __accessibilityRelevant, value); //$NON-NLS-1$
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEEC34CFAE55D2949A2272896942801514F", __accessibilityCompliant, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 4:
                set__AccessibilityRelevant((com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityRelevanceEnum) value);     
                break;
            case 5:
                set__AccessibilityCompliant((com.sap.ide.metamodel.webdynpro.accessibility.AccessibilityComplianceEnum) value);     
                break;
            default:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.webdynpro.accessibility.__impl.AccessibilityInfoImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.webdynpro.accessibility.__impl.AccessibilityInfoWrapper(conn, this, synchronize);
    }
