 ...
 */
public interface DtDb4IndexProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb4IndexProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb4IndexProperty>("45DDACEF5459D1C81BB049810A4BF76590A75D62", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtDb4IndexProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb4IndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> __dbIndex;
        /**
         * Returns the descriptor for the <code>dbIndex</code> reference.
         * @return  the descriptor for the <code>dbIndex</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb4IndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> DB_INDEX( ) {
            if ( __dbIndex == null ) {
                __dbIndex = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb4IndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex>( "45DDACEFFD4A03508ADA490004DCE1F7ED40CA91", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtDb4IndexProperty", "DbIndex" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbIndex;
        }
    }
