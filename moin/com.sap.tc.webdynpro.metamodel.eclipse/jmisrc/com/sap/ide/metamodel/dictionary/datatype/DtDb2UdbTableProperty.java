 ...
 */
public interface DtDb2UdbTableProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty>("45DDACEF6E2BC7473E1E47891ACCD3685A622888", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtDb2UdbTableProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> __dbTable;
        /**
         * Returns the descriptor for the <code>dbTable</code> reference.
         * @return  the descriptor for the <code>dbTable</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> DB_TABLE( ) {
            if ( __dbTable == null ) {
                __dbTable = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable>( "45DDACEFF889E44D0F6B46BE23FF90662949E87C", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtDb2UdbTableProperty", "DbTable" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbTable;
        }
    }
