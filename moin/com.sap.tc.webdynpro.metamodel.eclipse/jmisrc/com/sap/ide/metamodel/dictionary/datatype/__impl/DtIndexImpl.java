...
public final class DtIndexImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("DependentTypes", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("DataType", Integer.valueOf(5)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14;
    ...
    public DtIndexImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.util.List getDependentTypes() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEF5F147927196F49F8352EE6533399DC25" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getDependentTypes(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEF5F147927196F49F8352EE6533399DC25" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF8626068488994BB026C4C9432EC048B1" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF8626068488994BB026C4C9432EC048B1", /* mofId of reference */ "45DDACEF1711C761212B40B90A7D9E8D0442B0DE" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF8626068488994BB026C4C9432EC048B1", /* mofId of reference */ "45DDACEF1711C761212B40B90A7D9E8D0442B0DE" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getDependentTypes(connection);
                break;
            case 5: 
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF5F147927196F49F8352EE6533399DC25" /* mofId of association */, "45DDACEFBD2CD1688FC343BE338DECAEF6D5C5A3" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEF8626068488994BB026C4C9432EC048B1" /* mofId of association */, "45DDACEF1711C761212B40B90A7D9E8D0442B0DE" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14" ) { return __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14" ) { __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14 = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14); __A_DependentTypes_dtIndex_DependentTypes_45DDACEFE6CD414FE57A4CF51D45C1030C5A5F14 = null; } 
        return result;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtIndexImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtIndexWrapper(conn, this, synchronize);
    }
