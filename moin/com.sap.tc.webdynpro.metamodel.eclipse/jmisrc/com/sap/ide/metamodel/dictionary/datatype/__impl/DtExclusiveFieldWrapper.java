...
public class DtExclusiveFieldWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtExclusiveField,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtExclusiveFieldWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtExclusiveField (Java Type)\nDictionary.datatype.DtExclusiveField (MOF Type)"; //$NON-NLS-1$
    }    
}