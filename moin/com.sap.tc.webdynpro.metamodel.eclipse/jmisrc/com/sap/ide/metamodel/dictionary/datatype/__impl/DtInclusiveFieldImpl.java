...
public final class DtInclusiveFieldImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("newName", Integer.valueOf(5)); //$NON-NLS-1$
    ...
    private java.lang.String __newName = null;
    ...
    // default constructor
    public DtInclusiveFieldImpl() {
        super();
    }
    
    // specific constructor
    public DtInclusiveFieldImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF51D4EE9348DD48203C338459F9E24A8A", __newName, newValue); //$NON-NLS-1$
    }
    public void setNewName(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF51D4EE9348DD48203C338459F9E24A8A", __newName, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEFB780C24A0DF64598019EF7E11BD38AA1", __position, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEFB780C24A0DF64598019EF7E11BD38AA1", __position, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEFBC2AC5B026B4481F2473C80136BE9844" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFBC2AC5B026B4481F2473C80136BE9844", /* mofId of reference */ "45DDACEF1A71E56D858D46B50398D2018CE40EE8" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFBC2AC5B026B4481F2473C80136BE9844", /* mofId of reference */ "45DDACEF1A71E56D858D46B50398D2018CE40EE8" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__NewName(java.lang.String newValue) {
            __newName = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEFBC2AC5B026B4481F2473C80136BE9844" /* mofId of association */, "45DDACEF1A71E56D858D46B50398D2018CE40EE8" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF51D4EE9348DD48203C338459F9E24A8A", __newName, value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEFB780C24A0DF64598019EF7E11BD38AA1", __position, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 5:
                set__NewName((java.lang.String) value);     
                break;
            case 6:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtInclusiveFieldImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtInclusiveFieldWrapper(conn, this, synchronize);
    }
