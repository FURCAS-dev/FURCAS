 ...
 */
public interface DtSapDbIndexProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty>("45DDACEFDCC20DCB29EC45870FC98DD0F7E02EEF", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtSapDbIndexProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> __dbIndex;
        /**
         * Returns the descriptor for the <code>dbIndex</code> reference.
         * @return  the descriptor for the <code>dbIndex</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> DB_INDEX( ) {
            if ( __dbIndex == null ) {
                __dbIndex = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex>( "45DDACEFAC5C30A23EDB442A25A59B85A172E734", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtSapDbIndexProperty", "DbIndex" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbIndex;
        }
    }
