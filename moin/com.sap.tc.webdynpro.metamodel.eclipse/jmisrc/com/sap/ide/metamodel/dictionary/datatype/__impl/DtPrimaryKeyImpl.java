...
public final class DtPrimaryKeyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("KeyElements", Integer.valueOf(5)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C;
    ...
    // default constructor
    public DtPrimaryKeyImpl() {
        super();
    }
    
    // specific constructor
    public DtPrimaryKeyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF4EBE6F77AD7C42821184EB51E659AD21" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF4EBE6F77AD7C42821184EB51E659AD21", /* mofId of reference */ "45DDACEFD93F0D9115E6413B28E78045DD98599C" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF4EBE6F77AD7C42821184EB51E659AD21", /* mofId of reference */ "45DDACEFD93F0D9115E6413B28E78045DD98599C" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getKeyElements() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEFECA6A1B6DF3C4255156A8220BC1D64AB" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getKeyElements(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEFECA6A1B6DF3C4255156A8220BC1D64AB" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getKeyElements(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF4EBE6F77AD7C42821184EB51E659AD21" /* mofId of association */, "45DDACEFD93F0D9115E6413B28E78045DD98599C" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEFECA6A1B6DF3C4255156A8220BC1D64AB" /* mofId of association */, "45DDACEF9BF21225ACA44810260FAD02B71C50A9" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C); } 
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF08DF53E6613C46752F0BC888E292408C" ) { return __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C; } //$NON-NLS-1$ 
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "45DDACEF08DF53E6613C46752F0BC888E292408C" ) { __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C = links; return; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C); __A_KeyElements_PrimaryKey_KeyElements_45DDACEF08DF53E6613C46752F0BC888E292408C = null; } 
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyWrapper(conn, this, synchronize);
    }
