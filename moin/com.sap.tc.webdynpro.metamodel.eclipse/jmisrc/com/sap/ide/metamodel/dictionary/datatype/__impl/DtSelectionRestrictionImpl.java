...
public final class DtSelectionRestrictionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("restrictionText", Integer.valueOf(6)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private java.lang.String __restrictionText = null;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57;

    // default constructor
    public DtSelectionRestrictionImpl() {
        super();
    }
    
    // specific constructor
    public DtSelectionRestrictionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEF5FAE2F2E4FFF4C1D1AD8F6BAD5AF814E", __restrictionText, newValue); //$NON-NLS-1$
    }
    public void setRestrictionText(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEF5FAE2F2E4FFF4C1D1AD8F6BAD5AF814E", __restrictionText, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEFE3E9F6A4F555447A1F8F9D002A219702" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFE3E9F6A4F555447A1F8F9D002A219702", /* mofId of reference */ "45DDACEF5C5908928D9E4B481ECAAB8F4393021E" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFE3E9F6A4F555447A1F8F9D002A219702", /* mofId of reference */ "45DDACEF5C5908928D9E4B481ECAAB8F4393021E" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getConditions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEF5BAE1C8CBB984D4B0180E519158B62FD" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEF5BAE1C8CBB984D4B0180E519158B62FD" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    private void set__RestrictionText(java.lang.String newValue) {
            __restrictionText = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEFE3E9F6A4F555447A1F8F9D002A219702" /* mofId of association */, "45DDACEF5C5908928D9E4B481ECAAB8F4393021E" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEF5BAE1C8CBB984D4B0180E519158B62FD" /* mofId of association */, "45DDACEF21401CFA3A6C47301888939C1F1E1313" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEF5FAE2F2E4FFF4C1D1AD8F6BAD5AF814E", __restrictionText, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 6:
                set__RestrictionText((java.lang.String) value);     
                break;
            default:
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEF8CBECFF3A1784B941A46B450CB13EA57" ) { return __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEF8CBECFF3A1784B941A46B450CB13EA57" ) { __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57 = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57); __A_Conditions_SelectionRestriction_Conditions_45DDACEF8CBECFF3A1784B941A46B450CB13EA57 = null; } 
        return result;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtSelectionRestrictionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtSelectionRestrictionWrapper(conn, this, synchronize);
    }
