...
public final class DtEnumerationValueImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("SchemaType", Integer.valueOf(4)); //$NON-NLS-1$
    ...
    // default constructor
    public DtEnumerationValueImpl() {
        super();
    }
    
    // specific constructor
    public DtEnumerationValueImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF7948BA878D954CAE1A219311B8D7C6C2", __value, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF7948BA878D954CAE1A219311B8D7C6C2", __value, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(get___CurrentConnection(), "45DDACEF4AA88FE6B00047EB0CABFC689775ADD6", newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeObjectAttribute(connection, "45DDACEF4AA88FE6B00047EB0CABFC689775ADD6", newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF4ADF29179DD44EAC3D97BFE33106E878" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF4ADF29179DD44EAC3D97BFE33106E878", /* mofId of reference */ "45DDACEFB306E47F998446BE3845830814784FF8" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF4ADF29179DD44EAC3D97BFE33106E878", /* mofId of reference */ "45DDACEFB306E47F998446BE3845830814784FF8" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__Description(com.sap.tc.moin.repository.core.CoreSession session, java.lang.Object newValue) {
        ___loadLinks(session, "45DDACEF4AA88FE6B00047EB0CABFC689775ADD6" /* "description" */, newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF4ADF29179DD44EAC3D97BFE33106E878" /* mofId of association */, "45DDACEFB306E47F998446BE3845830814784FF8" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF7948BA878D954CAE1A219311B8D7C6C2", __value, value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeObjectAttribute(connection, "45DDACEF4AA88FE6B00047EB0CABFC689775ADD6", value); //$NON-NLS-1$
                break;
    ...
    public void set___AttributeLink( String attributeMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        if ( attributeMofId == "45DDACEF4AA88FE6B00047EB0CABFC689775ADD6" ) { __description = value; return; } //$NON-NLS-1$ 
    }

    public com.sap.tc.moin.repository.core.EndStorageLink get___AttributeLink( String attributeMofId ) {
        if ( attributeMofId == "45DDACEF4AA88FE6B00047EB0CABFC689775ADD6" ) { return __description; } //$NON-NLS-1$ 
        return null;
    }
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtEnumerationValueImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtEnumerationValueWrapper(conn, this, synchronize);
    }
