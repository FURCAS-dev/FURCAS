 ...
 */
public interface DtMssqlTableProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> __dbTable;
        /**
         * Returns the descriptor for the <code>dbTable</code> reference.
         * @return  the descriptor for the <code>dbTable</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> DB_TABLE( ) {
            if ( __dbTable == null ) {
                __dbTable = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable>( "45DDACEF624B831A9F304945375FBF0F6CD09F7B", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtMssqlTableProperty", "DbTable" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbTable;
        }
    }
