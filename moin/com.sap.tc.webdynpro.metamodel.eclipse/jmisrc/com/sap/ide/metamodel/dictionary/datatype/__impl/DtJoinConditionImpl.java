...
public final class DtJoinConditionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("Join", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("fieldnameL", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("fieldnameR", Integer.valueOf(6)); //$NON-NLS-1$
    ...
    private java.lang.String __fieldnameL = null;
    private java.lang.String __fieldnameR = null;
    ...
    // default constructor
    public DtJoinConditionImpl() {
        super();
    }
    
    // specific constructor
    public DtJoinConditionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF334BD9BDB34649500108F4BF1B8F229A", __fieldnameL, newValue); //$NON-NLS-1$
    }
    public void setFieldnameL(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF334BD9BDB34649500108F4BF1B8F229A", __fieldnameL, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEFD663D847DB4145AB3EACB7DEA5CF0880", __fieldnameR, newValue); //$NON-NLS-1$
    }
    public void setFieldnameR(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEFD663D847DB4145AB3EACB7DEA5CF0880", __fieldnameR, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 7, "45DDACEF2840EA78AFB1406821EAB2F7EA28A342", __operator, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 7, "45DDACEF2840EA78AFB1406821EAB2F7EA28A342", __operator, newValue); //$NON-NLS-1$
    }
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getJoin() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getJoin(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setJoin(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA", /* mofId of reference */ "45DDACEFC2F52A2E6B4E4FE912CDE685E6DAA486" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setJoin(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA", /* mofId of reference */ "45DDACEFC2F52A2E6B4E4FE912CDE685E6DAA486" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__FieldnameL(java.lang.String newValue) {
            __fieldnameL = newValue;
    }

    private void set__FieldnameR(java.lang.String newValue) {
            __fieldnameR = newValue;
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 3: 
                ...
                break;
            case 4: 
                result = getJoin(connection);
                break;
            case 5: 
                result = getFieldnameL();
                break;
            case 6: 
                result = getFieldnameR();
                break;
            case 7: 
                result = getOperator();
                break;
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA" /* mofId of association */, "45DDACEFC2F52A2E6B4E4FE912CDE685E6DAA486" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF334BD9BDB34649500108F4BF1B8F229A", __fieldnameL, value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEFD663D847DB4145AB3EACB7DEA5CF0880", __fieldnameR, value); //$NON-NLS-1$
                break;
                    
            case 7:
                ___changeDataTypeAttribute(connection, 7, "45DDACEF2840EA78AFB1406821EAB2F7EA28A342", __operator, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 5:
                set__FieldnameL((java.lang.String) value);     
                break;
            case 6:
                set__FieldnameR((java.lang.String) value);     
                break;
            case 7:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtJoinConditionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtJoinConditionWrapper(conn, this, synchronize);
    }
