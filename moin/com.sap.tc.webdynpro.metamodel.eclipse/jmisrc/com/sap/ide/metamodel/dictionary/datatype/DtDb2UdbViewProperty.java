 ...
 */
public interface DtDb2UdbViewProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbViewProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbViewProperty>("45DDACEFCFDF0C3D4FA0401F0854A4CC9E16F8D4", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtDb2UdbViewProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbViewProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbView> __dbView;
        /**
         * Returns the descriptor for the <code>dbView</code> reference.
         * @return  the descriptor for the <code>dbView</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbViewProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbView> DB_VIEW( ) {
            if ( __dbView == null ) {
                __dbView = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbViewProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbView>( "45DDACEF4A2413E0F12046CD3CC1B52B5D197A2B", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtDb2UdbViewProperty", "DbView" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbView;
        }
    }
