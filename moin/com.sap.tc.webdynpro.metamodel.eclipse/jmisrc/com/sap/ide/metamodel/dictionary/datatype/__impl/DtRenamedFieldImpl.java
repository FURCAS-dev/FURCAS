...
public final class DtRenamedFieldImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // default constructor
    public DtRenamedFieldImpl() {
        super();
    }
    
    // specific constructor
    public DtRenamedFieldImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF9091613387EE4DE127FFAEF2CBDA5F4E", __newName, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF9091613387EE4DE127FFAEF2CBDA5F4E", __newName, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF3B7EFCF324684ED13A54B5803BDC955F" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF3B7EFCF324684ED13A54B5803BDC955F", /* mofId of reference */ "45DDACEF0CCB4F382D0D4B6E3910D5FA395D4EC7" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF3B7EFCF324684ED13A54B5803BDC955F", /* mofId of reference */ "45DDACEF0CCB4F382D0D4B6E3910D5FA395D4EC7" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF3B7EFCF324684ED13A54B5803BDC955F" /* mofId of association */, "45DDACEF0CCB4F382D0D4B6E3910D5FA395D4EC7" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF9091613387EE4DE127FFAEF2CBDA5F4E", __newName, value); //$NON-NLS-1$
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtRenamedField> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtRenamedField.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldWrapper(conn, this, synchronize);
    }
