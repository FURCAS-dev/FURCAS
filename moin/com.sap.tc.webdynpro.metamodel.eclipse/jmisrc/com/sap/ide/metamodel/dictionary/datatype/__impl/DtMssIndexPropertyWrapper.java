...
public class DtMssIndexPropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtMssIndexPropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssIndexPropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty (Java Type)\nDictionary.datatype.DtMssIndexProperty (MOF Type)"; //$NON-NLS-1$
    }    
}