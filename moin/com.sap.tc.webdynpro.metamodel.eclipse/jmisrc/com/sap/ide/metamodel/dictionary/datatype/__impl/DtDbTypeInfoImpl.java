...
public final class DtDbTypeInfoImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("jdbcTypeName", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("database", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("databaseTypeName", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    private java.lang.String __databaseTypeName = null;
    ...
    // default constructor
    public DtDbTypeInfoImpl() {
        super();
    }
    
    // specific constructor
    public DtDbTypeInfoImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEF7751F7344DC3475B2994B3701DE1D39D", __jdbcTypeName, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEF7751F7344DC3475B2994B3701DE1D39D", __jdbcTypeName, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF35447E1F0B414263378698AEF46FE6FB", __database, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF35447E1F0B414263378698AEF46FE6FB", __database, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEF2856F0737C2E468F1AB9F936AA54036D", __databaseTypeName, newValue); //$NON-NLS-1$
    }
    public void setDatabaseTypeName(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEF2856F0737C2E468F1AB9F936AA54036D", __databaseTypeName, newValue); //$NON-NLS-1$
    }
    ...
    private void set__DatabaseTypeName(java.lang.String newValue) {
            __databaseTypeName = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEF7751F7344DC3475B2994B3701DE1D39D", __jdbcTypeName, value); //$NON-NLS-1$
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF35447E1F0B414263378698AEF46FE6FB", __database, value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEF2856F0737C2E468F1AB9F936AA54036D", __databaseTypeName, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            ...
            case 5:
                ...
                break;
            case 6:
                set__DatabaseTypeName((java.lang.String) value);     
                break;
            default:
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtDbTypeInfo> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtDbTypeInfo.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoWrapper(conn, this, synchronize);
    }
