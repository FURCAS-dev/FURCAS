...
public class DtDbTypeInfoWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtDbTypeInfo,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtDbTypeInfoWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbTypeInfoImpl) getWrappedObject();
    }
    ...
    public java.lang.String getDatabaseTypeName() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getDatabaseTypeName();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getDatabaseTypeName();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDatabaseTypeName(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtDbTypeInfo (Java Type)\nDictionary.datatype.DtDbTypeInfo (MOF Type)"; //$NON-NLS-1$
    }    
}