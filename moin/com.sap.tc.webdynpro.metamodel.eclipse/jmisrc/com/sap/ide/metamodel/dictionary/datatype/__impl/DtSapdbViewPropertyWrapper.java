...
public class DtSapdbViewPropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtSapdbViewProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtSapdbViewPropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapdbViewPropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtSapdbViewProperty (Java Type)\nDictionary.datatype.DtSapdbViewProperty (MOF Type)"; //$NON-NLS-1$
    }    
}