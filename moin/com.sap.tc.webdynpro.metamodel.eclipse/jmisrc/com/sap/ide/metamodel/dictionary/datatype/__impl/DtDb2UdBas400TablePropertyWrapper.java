...
public class DtDb2UdBas400TablePropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtDb2UdBas400TableProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtDb2UdBas400TablePropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdBas400TablePropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtDb2UdBas400TableProperty (Java Type)\nDictionary.datatype.DtDb2UdBAs400TableProperty (MOF Type)"; //$NON-NLS-1$
    }    
}