...
public final class DtLogicalDictionaryImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("logicalSystemName", Integer.valueOf(4)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private java.lang.String __logicalSystemName = null;
    ...
    // default constructor
    public DtLogicalDictionaryImpl() {
        super();
    }
    
    // specific constructor
    public DtLogicalDictionaryImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 4, "45DDACEF50C46650451742F42796C4DA76794567", __logicalSystemName, newValue); //$NON-NLS-1$
    }
    public void setLogicalSystemName(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 4, "45DDACEF50C46650451742F42796C4DA76794567", __logicalSystemName, newValue); //$NON-NLS-1$
    }
    ...
    private void set__LogicalSystemName(java.lang.String newValue) {
            __logicalSystemName = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeDataTypeAttribute(connection, 4, "45DDACEF50C46650451742F42796C4DA76794567", __logicalSystemName, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 4:
                set__LogicalSystemName((java.lang.String) value);     
                break;
            default:
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtLogicalDictionary> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtLogicalDictionary.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtLogicalDictionaryImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtLogicalDictionaryWrapper(conn, this, synchronize);
    }
