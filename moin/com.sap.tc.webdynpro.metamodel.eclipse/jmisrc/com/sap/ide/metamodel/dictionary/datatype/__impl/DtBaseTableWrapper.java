...
public class DtBaseTableWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtBaseTable,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtBaseTableWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtBaseTable (Java Type)\nDictionary.datatype.DtBaseTable (MOF Type)"; //$NON-NLS-1$
    }    
}