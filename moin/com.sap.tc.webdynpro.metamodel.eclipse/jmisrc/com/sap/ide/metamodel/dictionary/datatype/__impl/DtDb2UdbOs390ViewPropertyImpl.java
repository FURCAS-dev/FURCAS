...
public final class DtDb2UdbOs390ViewPropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // default constructor
    public DtDb2UdbOs390ViewPropertyImpl() {
        super();
    }
    
    // specific constructor
    public DtDb2UdbOs390ViewPropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF59FAA9AE4A024CF02DD2E6A2802C8E07" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF59FAA9AE4A024CF02DD2E6A2802C8E07", /* mofId of reference */ "45DDACEF39EFB31B812D4D09105BA0297F7CE196" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF59FAA9AE4A024CF02DD2E6A2802C8E07", /* mofId of reference */ "45DDACEF39EFB31B812D4D09105BA0297F7CE196" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF59FAA9AE4A024CF02DD2E6A2802C8E07" /* mofId of association */, "45DDACEF39EFB31B812D4D09105BA0297F7CE196" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390ViewPropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390ViewPropertyWrapper(conn, this, synchronize);
    }
