...
public final class DtTechnicalInfoImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("withClass", Integer.valueOf(5)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private boolean __withClass = false;
    ...
    // default constructor
    public DtTechnicalInfoImpl() {
        super();
    }
    
    // specific constructor
    public DtTechnicalInfoImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEF35C7A2BECAEE430C15BCC98D1008FE86", __withClass, newValue); //$NON-NLS-1$
    }
    public void setWithClass(com.sap.tc.moin.repository.core.CoreConnection connection, boolean newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEF35C7A2BECAEE430C15BCC98D1008FE86", __withClass, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF294EF80F1BE242C431A68429C2D1C855" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF294EF80F1BE242C431A68429C2D1C855", /* mofId of reference */ "45DDACEF3F81E4B1C83A4373268FF040EE2D40B3" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF294EF80F1BE242C431A68429C2D1C855", /* mofId of reference */ "45DDACEF3F81E4B1C83A4373268FF040EE2D40B3" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__WithClass(boolean newValue) {
            __withClass = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF294EF80F1BE242C431A68429C2D1C855" /* mofId of association */, "45DDACEF3F81E4B1C83A4373268FF040EE2D40B3" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEF35C7A2BECAEE430C15BCC98D1008FE86", __withClass, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 5:
                set__WithClass((java.lang.Boolean) value);     
                break;
            default:
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtTechnicalInfo> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtTechnicalInfo.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtTechnicalInfoImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtTechnicalInfoWrapper(conn, this, synchronize);
    }
