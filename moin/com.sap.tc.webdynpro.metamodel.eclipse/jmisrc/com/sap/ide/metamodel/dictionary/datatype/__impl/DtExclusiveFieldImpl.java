...
public final class DtExclusiveFieldImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // default constructor
    public DtExclusiveFieldImpl() {
        super();
    }
    
    // specific constructor
    public DtExclusiveFieldImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF299F668197134AE83776C34444B21BA8" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF299F668197134AE83776C34444B21BA8", /* mofId of reference */ "45DDACEFE0C9DDB33418469F02B9ED21DC78539E" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF299F668197134AE83776C34444B21BA8", /* mofId of reference */ "45DDACEFE0C9DDB33418469F02B9ED21DC78539E" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF299F668197134AE83776C34444B21BA8" /* mofId of association */, "45DDACEFE0C9DDB33418469F02B9ED21DC78539E" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtExclusiveField> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtExclusiveField.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtExclusiveFieldWrapper(conn, this, synchronize);
    }
