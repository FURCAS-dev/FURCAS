...
public class DtOracleTablePropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtOracleTablePropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtOracleTablePropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty (Java Type)\nDictionary.datatype.DtOracleTableProperty (MOF Type)"; //$NON-NLS-1$
    }    
}