...
public class DtDb2UdbAs400ViewPropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbAs400ViewProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtDb2UdbAs400ViewPropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbAs400ViewPropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbAs400ViewProperty (Java Type)\nDictionary.datatype.DtDb2UdbAs400ViewProperty (MOF Type)"; //$NON-NLS-1$
    }    
}