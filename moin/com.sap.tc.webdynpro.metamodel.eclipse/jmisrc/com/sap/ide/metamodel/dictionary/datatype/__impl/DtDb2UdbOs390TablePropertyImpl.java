...
public final class DtDb2UdbOs390TablePropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // default constructor
    public DtDb2UdbOs390TablePropertyImpl() {
        super();
    }
    
    // specific constructor
    public DtDb2UdbOs390TablePropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF7A6C29542D8C476935EE9107BDDBE044" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF7A6C29542D8C476935EE9107BDDBE044", /* mofId of reference */ "45DDACEF9A7BDE2E518B450E3C4DF9D0B012A6FD" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF7A6C29542D8C476935EE9107BDDBE044", /* mofId of reference */ "45DDACEF9A7BDE2E518B450E3C4DF9D0B012A6FD" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF7A6C29542D8C476935EE9107BDDBE044" /* mofId of association */, "45DDACEF9A7BDE2E518B450E3C4DF9D0B012A6FD" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbOs390TableProperty> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbOs390TableProperty.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyWrapper(conn, this, synchronize);
    }
