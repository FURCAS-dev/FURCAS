...
public final class DtSapDbIndexPropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("DbIndex", Integer.valueOf(4)); //$NON-NLS-1$
    }
    ...
    // default constructor
    public DtSapDbIndexPropertyImpl() {
        super();
    }
    
    // specific constructor
    public DtSapDbIndexPropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getDbIndex() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF2660C43F78A849012369807096125000" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getDbIndex(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF2660C43F78A849012369807096125000" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    public void setDbIndex(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF2660C43F78A849012369807096125000", /* mofId of reference */ "45DDACEFAC5C30A23EDB442A25A59B85A172E734" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public void setDbIndex(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF2660C43F78A849012369807096125000", /* mofId of reference */ "45DDACEFAC5C30A23EDB442A25A59B85A172E734" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF2660C43F78A849012369807096125000" /* mofId of association */, "45DDACEFAC5C30A23EDB442A25A59B85A172E734" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtSapDbIndexProperty.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapDbIndexPropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtSapDbIndexPropertyWrapper(conn, this, synchronize);
    }
