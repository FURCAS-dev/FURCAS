 ...
 */
public interface DtOracleIndexProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtOracleIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> __dbIndex;
        /**
         * Returns the descriptor for the <code>dbIndex</code> reference.
         * @return  the descriptor for the <code>dbIndex</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtOracleIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> DB_INDEX( ) {
            if ( __dbIndex == null ) {
                __dbIndex = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtOracleIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex>( "45DDACEF4FC8FA024F844B7A089AD6E341FE5918", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtOracleIndexProperty", "DbIndex" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbIndex;
        }
    }
