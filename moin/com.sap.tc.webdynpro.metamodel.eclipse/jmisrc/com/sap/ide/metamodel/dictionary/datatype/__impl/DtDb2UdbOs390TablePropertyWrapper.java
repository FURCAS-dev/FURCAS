...
public class DtDb2UdbOs390TablePropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbOs390TableProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtDb2UdbOs390TablePropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbOs390TablePropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbOs390TableProperty (Java Type)\nDictionary.datatype.DtDb2UdbOs390TableProperty (MOF Type)"; //$NON-NLS-1$
    }    
}