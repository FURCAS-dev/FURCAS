...
public class DtDb2IndexPropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtDb2IndexPropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2IndexPropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty (Java Type)\nDictionary.datatype.DtDb2IndexProperty (MOF Type)"; //$NON-NLS-1$
    }    
}