...
public final class DtDbPropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("TypeInfos", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("jdbcTypeName", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("notNull", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("dbDefault", Integer.valueOf(8)); //$NON-NLS-1$
    }
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4;

    // default constructor
    public DtDbPropertyImpl() {
        super();
    }
    
    // specific constructor
    public DtDbPropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEFC42639CED2514B853E60A3FD7FE4D8A8", __jdbcTypeName, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEFC42639CED2514B853E60A3FD7FE4D8A8", __jdbcTypeName, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 7, "45DDACEFB115FE5E4F584E2D2EB8E9CD3AF00A05", __notNull, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 7, "45DDACEFB115FE5E4F584E2D2EB8E9CD3AF00A05", __notNull, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 8, "45DDACEF48167855FFCA48CE163AFA048E16AC00", __dbDefault, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 8, "45DDACEF48167855FFCA48CE163AFA048E16AC00", __dbDefault, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF9276B3238D674DFC3359CD08C0B1D5D4" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF9276B3238D674DFC3359CD08C0B1D5D4", /* mofId of reference */ "45DDACEF37BE37164EAE480F3ED1C35B3D51776C" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF9276B3238D674DFC3359CD08C0B1D5D4", /* mofId of reference */ "45DDACEF37BE37164EAE480F3ED1C35B3D51776C" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getTypeInfos() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEF3CCEEBD5575745CB35E1A8913435DC12" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEF3CCEEBD5575745CB35E1A8913435DC12" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF9276B3238D674DFC3359CD08C0B1D5D4" /* mofId of association */, "45DDACEF37BE37164EAE480F3ED1C35B3D51776C" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEF3CCEEBD5575745CB35E1A8913435DC12" /* mofId of association */, "45DDACEFED399C9A106D4094066B9D6863120EBD" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEFC42639CED2514B853E60A3FD7FE4D8A8", __jdbcTypeName, value); //$NON-NLS-1$
                break;
                    
            case 7:
                ___changeDataTypeAttribute(connection, 7, "45DDACEFB115FE5E4F584E2D2EB8E9CD3AF00A05", __notNull, value); //$NON-NLS-1$
                break;
                    
            case 8:
                ___changeDataTypeAttribute(connection, 8, "45DDACEF48167855FFCA48CE163AFA048E16AC00", __dbDefault, value); //$NON-NLS-1$
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFB2FCD743EC9A409F0856D5F3D57263A4" ) { return __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFB2FCD743EC9A409F0856D5F3D57263A4" ) { __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4 = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4); __A_TypeInfos_dtDbProperty_TypeInfos_45DDACEFB2FCD743EC9A409F0856D5F3D57263A4 = null; } 
        return result;

    }
    // get the JMI interface
    @SuppressWarnings("unchecked")
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtDbProperty> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtDbProperty.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbPropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtDbPropertyWrapper(conn, this, synchronize);
    }
