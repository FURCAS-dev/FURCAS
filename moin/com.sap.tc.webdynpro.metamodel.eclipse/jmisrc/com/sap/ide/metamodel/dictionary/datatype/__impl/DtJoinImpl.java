...
public final class DtJoinImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("DbView", Integer.valueOf(4)); //$NON-NLS-1$
        FEATURE_IDS.put("Conditions", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("joinText", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("joinType", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("tabnameL", Integer.valueOf(8)); //$NON-NLS-1$
        FEATURE_IDS.put("tabnameR", Integer.valueOf(9)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private java.lang.String __joinText = null;
    private java.lang.String __joinType = null;
    private java.lang.String __tabnameL = null;
    private java.lang.String __tabnameR = null;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E;
    ...
    public DtJoinImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEF9EA53447C41A40611B3EA55F28219718", __joinText, newValue); //$NON-NLS-1$
    }
    public void setJoinText(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEF9EA53447C41A40611B3EA55F28219718", __joinText, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 7, "45DDACEF3318D70F090142172C60C04D45384788", __joinType, newValue); //$NON-NLS-1$
    }
    public void setJoinType(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 7, "45DDACEF3318D70F090142172C60C04D45384788", __joinType, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 8, "45DDACEFE5BEC559BC834DC634E985C577A614B1", __tabnameL, newValue); //$NON-NLS-1$
    }
    public void setTabnameL(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 8, "45DDACEFE5BEC559BC834DC634E985C577A614B1", __tabnameL, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 9, "45DDACEF65EAC24C91B243C50CFDAE24A8AFEF88", __tabnameR, newValue); //$NON-NLS-1$
    }
    public void setTabnameR(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 9, "45DDACEF65EAC24C91B243C50CFDAE24A8AFEF88", __tabnameR, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF0D1AABD566234D1A2916ABC401D30D59" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF0D1AABD566234D1A2916ABC401D30D59", /* mofId of reference */ "45DDACEF6B8DC136207B4EE8303AFB5CFF403D66" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF0D1AABD566234D1A2916ABC401D30D59", /* mofId of reference */ "45DDACEF6B8DC136207B4EE8303AFB5CFF403D66" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$

    }
    public java.util.List getConditions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getConditions(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    private void set__JoinText(java.lang.String newValue) {
            __joinText = newValue;
    }

    private void set__JoinType(java.lang.String newValue) {
            __joinType = newValue;
    }

    private void set__TabnameL(java.lang.String newValue) {
            __tabnameL = newValue;
    }

    private void set__TabnameR(java.lang.String newValue) {
            __tabnameR = newValue;
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getConditions(connection);
                break;
            case 6: 
                result = getJoinText();
                break;
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF0D1AABD566234D1A2916ABC401D30D59" /* mofId of association */, "45DDACEF6B8DC136207B4EE8303AFB5CFF403D66" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeReference(connection, "45DDACEF5F22A0C3EE2F4E6024A9DF4C778DCCBA" /* mofId of association */, "45DDACEF96289ECFFCEB487D30B1C0EE921E1514" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEF9EA53447C41A40611B3EA55F28219718", __joinText, value); //$NON-NLS-1$
                break;
                    
            case 7:
                ___changeDataTypeAttribute(connection, 7, "45DDACEF3318D70F090142172C60C04D45384788", __joinType, value); //$NON-NLS-1$
                break;
                    
            case 8:
                ___changeDataTypeAttribute(connection, 8, "45DDACEFE5BEC559BC834DC634E985C577A614B1", __tabnameL, value); //$NON-NLS-1$
                break;
                    
            case 9:
                ___changeDataTypeAttribute(connection, 9, "45DDACEF65EAC24C91B243C50CFDAE24A8AFEF88", __tabnameR, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 6:
                set__JoinText((java.lang.String) value);     
                break;
            case 7:
                set__JoinType((java.lang.String) value);     
                break;
            case 8:
                set__TabnameL((java.lang.String) value);     
                break;
            case 9:
                set__TabnameR((java.lang.String) value);     
                break;
            default:
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E" ) { return __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        ...
        if ( associationEndMofId == "45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E" ) { __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E); __A_Conditions_Join_Conditions_45DDACEFFCF490D6BB5B494F32ACF5E1E0BEFF7E = null; } 
        return result;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtJoinImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtJoinWrapper(conn, this, synchronize);
    }
