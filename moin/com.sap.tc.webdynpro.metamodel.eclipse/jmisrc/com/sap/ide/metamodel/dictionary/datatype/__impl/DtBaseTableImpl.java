...
public final class DtBaseTableImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // default constructor
    public DtBaseTableImpl() {
        super();
    }
    
    // specific constructor
    public DtBaseTableImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEF6E0CC103F2334AED03BCE0B0DF742BCE" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEF6E0CC103F2334AED03BCE0B0DF742BCE", /* mofId of reference */ "45DDACEF9F0DBB4B1C2547230BDDD67583A5E353" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEF6E0CC103F2334AED03BCE0B0DF742BCE", /* mofId of reference */ "45DDACEF9F0DBB4B1C2547230BDDD67583A5E353" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEF6E0CC103F2334AED03BCE0B0DF742BCE" /* mofId of association */, "45DDACEF9F0DBB4B1C2547230BDDD67583A5E353" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtBaseTable> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtBaseTable.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtBaseTableWrapper(conn, this, synchronize);
    }
