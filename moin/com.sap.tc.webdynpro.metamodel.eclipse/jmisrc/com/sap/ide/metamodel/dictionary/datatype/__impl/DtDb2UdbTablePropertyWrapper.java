...
public class DtDb2UdbTablePropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtDb2UdbTablePropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtDb2UdbTablePropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtDb2UdbTableProperty (Java Type)\nDictionary.datatype.DtDb2UdbTableProperty (MOF Type)"; //$NON-NLS-1$
    }    
}