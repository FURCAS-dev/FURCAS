 ...
 */
public interface DtList extends com.sap.ide.metamodel.dictionary.datatype.DtComplexType {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtList> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtList>("45DDACEF5571926D595B458D3BF5B7E2536A814C", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtList"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtList,com.sap.ide.metamodel.dictionary.datatype.DtDataType> __usedType;
        /**
         * Returns the descriptor for the <code>usedType</code> reference.
         * @return  the descriptor for the <code>usedType</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtList,com.sap.ide.metamodel.dictionary.datatype.DtDataType> USED_TYPE( ) {
            if ( __usedType == null ) {
                __usedType = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtList,com.sap.ide.metamodel.dictionary.datatype.DtDataType>( "45DDACEFB1F7531AFC5447360F958289A560054C", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtList", "UsedType" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __usedType;
        }
    }
