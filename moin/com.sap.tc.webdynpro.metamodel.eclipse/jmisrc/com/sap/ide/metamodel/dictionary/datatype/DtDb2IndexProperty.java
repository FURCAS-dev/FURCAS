 ...
 */
public interface DtDb2IndexProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty>("45DDACEF9187A40324BA4B8C276B8827D854713B", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtDb2IndexProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> __dbIndex;
        /**
         * Returns the descriptor for the <code>dbIndex</code> reference.
         * @return  the descriptor for the <code>dbIndex</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> DB_INDEX( ) {
            if ( __dbIndex == null ) {
                __dbIndex = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtDb2IndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex>( "45DDACEF3854B4BC6DC34012037A92CAE116C9AA", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtDb2IndexProperty", "DbIndex" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbIndex;
        }
    }
