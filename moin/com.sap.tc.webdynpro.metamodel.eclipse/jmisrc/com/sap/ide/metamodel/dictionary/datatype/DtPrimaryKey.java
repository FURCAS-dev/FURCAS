 ...
 */
public interface DtPrimaryKey extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey>("45DDACEFDAE1407CB4844D30055486299473E6AF", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtPrimaryKey"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public java.util.List<com.sap.ide.metamodel.dictionary.datatype.DtStructureElement> getKeyElements() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> __dbTable;
        /**
         * Returns the descriptor for the <code>dbTable</code> reference.
         * @return  the descriptor for the <code>dbTable</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> DB_TABLE( ) {
            if ( __dbTable == null ) {
                __dbTable = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,com.sap.ide.metamodel.dictionary.datatype.DtDbTable>( "45DDACEFD93F0D9115E6413B28E78045DD98599C", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtPrimaryKey", "DbTable" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbTable;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,java.util.List<com.sap.ide.metamodel.dictionary.datatype.DtStructureElement>> __keyElements;
        /**
         * Returns the descriptor for the <code>keyElements</code> reference.
         * @return  the descriptor for the <code>keyElements</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,java.util.List<com.sap.ide.metamodel.dictionary.datatype.DtStructureElement>> KEY_ELEMENTS( ) {
            if ( __keyElements == null ) {
                __keyElements = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,java.util.List<com.sap.ide.metamodel.dictionary.datatype.DtStructureElement>>( "45DDACEF9BF21225ACA44810260FAD02B71C50A9", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtPrimaryKey", "KeyElements" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __keyElements;
        }
    }
}    