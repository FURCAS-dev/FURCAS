...
public final class DtExternalRepresentationImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("format", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("uppercase", Integer.valueOf(6)); //$NON-NLS-1$
        FEATURE_IDS.put("readOnly", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("maxExternalLength", Integer.valueOf(8)); //$NON-NLS-1$
        FEATURE_IDS.put("defaultValue", Integer.valueOf(9)); //$NON-NLS-1$
        FEATURE_IDS.put("translateFlag", Integer.valueOf(10)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private java.lang.String __format = null;
    private com.sap.ide.metamodel.dictionary.datatype.BooleanEnum __uppercase = null;
    private com.sap.ide.metamodel.dictionary.datatype.BooleanEnum __readOnly = null;
    private int __maxExternalLength = 0;
    private java.lang.String __defaultValue = null;
    private com.sap.ide.metamodel.dictionary.datatype.BooleanEnum __translateFlag = null;
    ...
    // default constructor
    public DtExternalRepresentationImpl() {
        super();
    }
    
    // specific constructor
    public DtExternalRepresentationImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 5, "45DDACEFE0BB514AC3CC47F5254EE152961641D2", __format, newValue); //$NON-NLS-1$
    }
    public void setFormat(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 5, "45DDACEFE0BB514AC3CC47F5254EE152961641D2", __format, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 6, "45DDACEF94E250DBF3CA43902327BE268CD8A1F1", __uppercase, newValue); //$NON-NLS-1$
    }
    public void setUppercase(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.ide.metamodel.dictionary.datatype.BooleanEnum newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 6, "45DDACEF94E250DBF3CA43902327BE268CD8A1F1", __uppercase, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 7, "45DDACEF776A4C0623664D1F1F05F19495A0C6E2", __readOnly, newValue); //$NON-NLS-1$
    }
    public void setReadOnly(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.ide.metamodel.dictionary.datatype.BooleanEnum newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 7, "45DDACEF776A4C0623664D1F1F05F19495A0C6E2", __readOnly, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 8, "45DDACEFA325BBE7BEF843080731C1341071152A", __maxExternalLength, newValue); //$NON-NLS-1$
    }
    public void setMaxExternalLength(com.sap.tc.moin.repository.core.CoreConnection connection, int newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 8, "45DDACEFA325BBE7BEF843080731C1341071152A", __maxExternalLength, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 9, "45DDACEFFB228A43FA8A40F60AA2DE4C37F903B0", __defaultValue, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 9, "45DDACEFFB228A43FA8A40F60AA2DE4C37F903B0", __defaultValue, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 10, "45DDACEFD24C5281ECD14D782B2BBED2867FF740", __translateFlag, newValue); //$NON-NLS-1$
    }
    public void setTranslateFlag(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.ide.metamodel.dictionary.datatype.BooleanEnum newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeDataTypeAttribute(connection, 10, "45DDACEFD24C5281ECD14D782B2BBED2867FF740", __translateFlag, newValue); //$NON-NLS-1$
    }
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEFBAD56EADC8B8469F17DFCF9A40DFB2AA" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFBAD56EADC8B8469F17DFCF9A40DFB2AA", /* mofId of reference */ "45DDACEFCD9C4C703F31468F3A2B9B5988CC7B5C" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFBAD56EADC8B8469F17DFCF9A40DFB2AA", /* mofId of reference */ "45DDACEFCD9C4C703F31468F3A2B9B5988CC7B5C" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void set__Format(java.lang.String newValue) {
            __format = newValue;
    }

    private void set__Uppercase(com.sap.ide.metamodel.dictionary.datatype.BooleanEnum newValue) {
            __uppercase = newValue;
    }

    private void set__ReadOnly(com.sap.ide.metamodel.dictionary.datatype.BooleanEnum newValue) {
            __readOnly = newValue;
    }

    private void set__MaxExternalLength(int newValue) {
            __maxExternalLength = newValue;
    }
    ...
    private void set__TranslateFlag(com.sap.ide.metamodel.dictionary.datatype.BooleanEnum newValue) {
            __translateFlag = newValue;
    }
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 7: 
                ...
                break;
            case 8: 
                result = getMaxExternalLength();
                break;
            case 9: 
                result = getDefaultValue();
                break;
            case 10: 
                result = getTranslateFlag();
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEFBAD56EADC8B8469F17DFCF9A40DFB2AA" /* mofId of association */, "45DDACEFCD9C4C703F31468F3A2B9B5988CC7B5C" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 5:
                ___changeDataTypeAttribute(connection, 5, "45DDACEFE0BB514AC3CC47F5254EE152961641D2", __format, value); //$NON-NLS-1$
                break;
                    
            case 6:
                ___changeDataTypeAttribute(connection, 6, "45DDACEF94E250DBF3CA43902327BE268CD8A1F1", __uppercase, value); //$NON-NLS-1$
                break;
                    
            case 7:
                ___changeDataTypeAttribute(connection, 7, "45DDACEF776A4C0623664D1F1F05F19495A0C6E2", __readOnly, value); //$NON-NLS-1$
                break;
                    
            case 8:
                ___changeDataTypeAttribute(connection, 8, "45DDACEFA325BBE7BEF843080731C1341071152A", __maxExternalLength, value); //$NON-NLS-1$
                break;
                    
            case 9:
                ___changeDataTypeAttribute(connection, 9, "45DDACEFFB228A43FA8A40F60AA2DE4C37F903B0", __defaultValue, value); //$NON-NLS-1$
                break;
                    
            case 10:
                ___changeDataTypeAttribute(connection, 10, "45DDACEFD24C5281ECD14D782B2BBED2867FF740", __translateFlag, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 3:
                ...
                break;
            case 5:
                set__Format((java.lang.String) value);     
                break;
            case 6:
                set__Uppercase((com.sap.ide.metamodel.dictionary.datatype.BooleanEnum) value);     
                break;
            case 7:
                set__ReadOnly((com.sap.ide.metamodel.dictionary.datatype.BooleanEnum) value);     
                break;
            case 8:
                set__MaxExternalLength((java.lang.Integer) value);     
                break;
            case 9:
                set__DefaultValue((java.lang.String) value);     
                break;
            case 10:
                set__TranslateFlag((com.sap.ide.metamodel.dictionary.datatype.BooleanEnum) value);     
                break;
            default:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtExternalRepresentationImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtExternalRepresentationWrapper(conn, this, synchronize);
    }
