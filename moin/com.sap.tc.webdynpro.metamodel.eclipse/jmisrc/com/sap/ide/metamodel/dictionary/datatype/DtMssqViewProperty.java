 ...
 */
public interface DtMssqViewProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtMssqViewProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtMssqViewProperty>("45DDACEFBD30CD1B233B4A051388B471A9125375", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtMssqViewProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssqViewProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbView> __dbView;
        /**
         * Returns the descriptor for the <code>dbView</code> reference.
         * @return  the descriptor for the <code>dbView</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssqViewProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbView> DB_VIEW( ) {
            if ( __dbView == null ) {
                __dbView = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssqViewProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbView>( "45DDACEF69B626E95777458B3375B253ABF97A14", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtMssqViewProperty", "DbView" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbView;
        }
    }
