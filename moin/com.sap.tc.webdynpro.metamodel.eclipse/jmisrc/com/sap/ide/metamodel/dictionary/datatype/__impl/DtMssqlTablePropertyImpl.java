...
public final class DtMssqlTablePropertyImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // default constructor
    public DtMssqlTablePropertyImpl() {
        super();
    }
    
    // specific constructor
    public DtMssqlTablePropertyImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        com.sap.tc.moin.repository.core.EndAndMetaObject endAndMetaObject = get___EndAndMetaObject( "45DDACEFA083D87F8A014EA818F691FFFC9F4E93" /* attribute or association */, 1 ); //$NON-NLS-1$
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "45DDACEFA083D87F8A014EA818F691FFFC9F4E93", /* mofId of reference */ "45DDACEF624B831A9F304945375FBF0F6CD09F7B" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "45DDACEFA083D87F8A014EA818F691FFFC9F4E93", /* mofId of reference */ "45DDACEF624B831A9F304945375FBF0F6CD09F7B" , newValue, 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 4:
                ___changeReference(connection, "45DDACEFA083D87F8A014EA818F691FFFC9F4E93" /* mofId of association */, "45DDACEF624B831A9F304945375FBF0F6CD09F7B" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.lang.Class<com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty> get___JmiInterface() {
        return com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyWrapper(conn, this, synchronize);
    }
