 ...
 */
public interface DtBaseTable extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtBaseTable> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtBaseTable>("45DDACEFEC30786137CA4F163BC8AA144593519D", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtBaseTable"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtBaseTable,com.sap.ide.metamodel.dictionary.datatype.DtDbView> __dbView;
        /**
         * Returns the descriptor for the <code>dbView</code> reference.
         * @return  the descriptor for the <code>dbView</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtBaseTable,com.sap.ide.metamodel.dictionary.datatype.DtDbView> DB_VIEW( ) {
            if ( __dbView == null ) {
                __dbView = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtBaseTable,com.sap.ide.metamodel.dictionary.datatype.DtDbView>( "45DDACEF9F0DBB4B1C2547230BDDD67583A5E353", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtBaseTable", "DbView" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbView;
        }
    }
