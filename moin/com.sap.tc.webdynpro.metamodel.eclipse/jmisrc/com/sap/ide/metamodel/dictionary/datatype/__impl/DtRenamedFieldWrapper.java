...
public class DtRenamedFieldWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtRenamedField,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtRenamedFieldWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtRenamedFieldImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtRenamedField (Java Type)\nDictionary.datatype.DtRenamedField (MOF Type)"; //$NON-NLS-1$
    }    
}