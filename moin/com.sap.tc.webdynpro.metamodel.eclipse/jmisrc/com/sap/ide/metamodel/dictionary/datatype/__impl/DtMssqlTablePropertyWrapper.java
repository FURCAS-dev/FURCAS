...
public class DtMssqlTablePropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtMssqlTablePropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtMssqlTablePropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtMssqlTableProperty (Java Type)\nDictionary.datatype.DtMssqlTableProperty (MOF Type)"; //$NON-NLS-1$
    }    
}