 ...
 */
public interface DtOracleTableProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty>("45DDACEFE749D505C20349AD2F31FF46467D1B46", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtOracleTableProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> __dbTable;
        /**
         * Returns the descriptor for the <code>dbTable</code> reference.
         * @return  the descriptor for the <code>dbTable</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable> DB_TABLE( ) {
            if ( __dbTable == null ) {
                __dbTable = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtOracleTableProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbTable>( "45DDACEF234CA49F6B064D661108A02427F55ADA", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtOracleTableProperty", "DbTable" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbTable;
        }
    }
