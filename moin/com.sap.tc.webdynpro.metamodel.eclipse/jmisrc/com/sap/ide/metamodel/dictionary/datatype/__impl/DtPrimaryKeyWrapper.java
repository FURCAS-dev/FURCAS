...
public class DtPrimaryKeyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl> implements com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public DtPrimaryKeyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl getCastWrappedObject() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl) getWrappedObject();
    }
    
    private com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl) resolved;
    }
    
    public com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl unwrap() {
        return (com.sap.ide.metamodel.dictionary.datatype.__impl.DtPrimaryKeyImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<com.sap.ide.metamodel.dictionary.datatype.DtStructureElement>) wrapResult(getCastWrappedObject().getKeyElements(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "com.sap.ide.metamodel.dictionary.datatype.DtPrimaryKey (Java Type)\nDictionary.datatype.DtPrimaryKey (MOF Type)"; //$NON-NLS-1$
    }    
}