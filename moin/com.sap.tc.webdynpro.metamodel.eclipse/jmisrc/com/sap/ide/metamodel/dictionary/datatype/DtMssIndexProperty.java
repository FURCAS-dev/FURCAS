 ...
 */
public interface DtMssIndexProperty extends com.sap.ide.metamodel.common.CommonDevelopmentObject {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty>("45DDACEFF66908BFF06F46132846AD91966F13AA", "sap.com/tc/moin/webdynpro", "Dictionary", "datatype", "DtMssIndexProperty"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> __dbIndex;
        /**
         * Returns the descriptor for the <code>dbIndex</code> reference.
         * @return  the descriptor for the <code>dbIndex</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex> DB_INDEX( ) {
            if ( __dbIndex == null ) {
                __dbIndex = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,com.sap.ide.metamodel.dictionary.datatype.DtMssIndexProperty,com.sap.ide.metamodel.dictionary.datatype.DtDbIndex>( "45DDACEFC1582F885AEE414D2B9C80CC1AE3262A", "sap.com/tc/moin/webdynpro", new java.lang.String[] { "Dictionary", "datatype", "DtMssIndexProperty", "DbIndex" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __dbIndex;
        }
    }
