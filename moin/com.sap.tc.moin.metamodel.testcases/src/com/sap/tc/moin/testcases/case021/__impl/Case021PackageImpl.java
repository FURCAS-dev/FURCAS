...
public final class Case021PackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    static {
        ...
        FEATURE_IDS.put("A21Abstract", Integer.valueOf(0)); //$NON-NLS-1$
    }

    // constructors    
    public Case021PackageImpl()
    {
        super();
    }
    public Case021PackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    // nested packages
    // classes
    public com.sap.tc.moin.repository.mmi.reflect.RefClass getA21Abstract(com.sap.tc.moin.repository.core.CoreConnection connection) {
        return  refClass(connection, "A21Abstract"); //$NON-NLS-1$
    }
    // associations
    ...
    protected void initialize() {
        ...
        if (___refClasses == null) {
            ...
            name = "A21Abstract"; //$NON-NLS-1$
            rcan = new RefClassAndName(name, "com.sap.tc.moin.testcases.case021.A21Abstract"); //$NON-NLS-1$
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.tc.moin.testcases.case021.__impl.Case021PackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.tc.moin.testcases.case021.__impl.Case021PackageWrapper(conn, this, synchronize);
    }
