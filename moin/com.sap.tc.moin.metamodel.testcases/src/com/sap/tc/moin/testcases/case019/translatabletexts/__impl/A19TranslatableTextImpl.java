...
public final class A19TranslatableTextImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.testcases.case019.translatabletexts.A19TranslatableText
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "testcases", "case019", "translatabletexts", "A19TranslatableText" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    // default constructor
    public A19TranslatableTextImpl() {
        super();
    }
    // JMI constructor
    public A19TranslatableTextImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
