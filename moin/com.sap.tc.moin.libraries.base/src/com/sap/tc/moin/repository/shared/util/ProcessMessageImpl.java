...
public abstract class ProcessMessageImpl implements ProcessMessage, Serializable {
    ...
    private transient MoinLocalizedString pattern;
    ...
    ProcessMessageImpl( MoinLocalizedString actMessage, Object... args ) {
    ...
    ProcessMessageImpl( Exception actException, int actStartLine, int actStartColumn, int actEndLine, int actEndColumn, int actStartPos, int actEndPos ) {

        this( actException );

        if ( actException instanceof MoinLocalizedBaseException || actException instanceof MoinLocalizedBaseRuntimeException ) {
    ...
    ProcessMessageImpl( int actStartLine, int actStartColumn, int actEndLine, int actEndColumn, int actStartPosition, int actEndPosition, MoinLocalizedString actMessage, Object... args ) {
    ...
    private boolean parameterCountOk( MoinLocalizedString actMessage, Object... args ) {
