 ...
 * <ol>
 * <li>LPG_AST_BUILDER_JMIEXCEPTION_XMSG: A JMI Exception was reported by the AST Builder, error message: {0}</li>
 * <li>LPG_AST_BUILDER_ERROR_XMSG: An internal error was reported by the AST Builder, error message: {0}</li>
 * <li>LPG_BAD_SYMFILE_XMSG: Bad Parser Symbol File "{0}". Regenerate "{1}".</li>
 * <li>LPG_BUG_UNKNOWN_ESCAPE_XMSG: Bug in OCL parser: Unknown Escape in identifier definition</li>
 ...
 * <li>LPG_LEX_DOESNTIMPLEMENT_EOF_XMSG: The Lexer does not implement the Eof symbol {0}</li>
 * <li>LPG_WILL_NOT_SCAN_XMSG: The Lexer will not scan the following token(s): {0}</li>
 * <li>LPG_NONEXISTING_DOWN_PROPERTY_XMSG: Trying to access non-existing down property "{0}" for node "{1}"</li>
 * <li>LPG_NONEXISTING_UP_PROPERTY_XMSG: Trying to access non-existing up property "{0}" for node "{1}"</li>
 * <li>LPG_GET_DEFAULT_NOT_ALLOWED_XMSG: Trying to get the default property for node "{0}" where this is not allowed</li>
 * <li>LPG_DEFAULT_NOT_EXPLICIT_XMSG: Trying to set the default property for node "{0}" explicitly, this is forbidden</li>
 ...
 * </ol>
 * <p>
 * <p>Message Constants generated from LPGMessages.properties
 */
 
public enum LPGMessages implements MoinLocalizedString {


    /**
     * Message: "An internal error was reported by the AST Builder, error message: {0}"
     */
    LPG_AST_BUILDER_ERROR("LPG_AST_BUILDER_ERROR_XMSG"), //$NON-NLS-1$

    /**
     * Message: "A JMI Exception was reported by the AST Builder, error message: {0}"
     */
    ...
    /**
     * Message: "Trying to set the default property for node "{0}" explicitly, this is forbidden"
     */
    ...
    /**
     * Message: "Trying to get the default property for node "{0}" where this is not allowed"
     */
    ...
    /**
     * Message: "Trying to access non-existing down property "{0}" for node "{1}""
     */
