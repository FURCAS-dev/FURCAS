...
abstract public class AbstractAstBuilder {
    ...
    private Map<RefObject, Map<Object, CstNode>> reverseErrorLookupMap;
    ...
    public AbstractAstBuilder( ) {
        ...
        this.reverseErrorLookupMap = new HashMap<RefObject, Map<Object, CstNode>>( );
    }
    ...
    protected void addReverseLookup( RefObject obj, Object detail, CstNode n ) {
    ...
    protected CstNode lookupReverseNode( RefObject obj, Object detail ) {
    ...
    protected boolean hasReverseNode( RefObject obj, Object detail ) {
    ...
    protected void reportInternalError( MoinLocalizedBaseException errExn, CstNode n ) {
     ...
     * parser.
     */
    protected void reportInternalError( CstNode n, MoinLocalizedString message, Object... args ) {

        MoinLocalizedBaseRuntimeException exn = new MoinLocalizedBaseRuntimeException( message, args );
    ...
    protected ProcessMessage reportMessage( MoinLocalizedBaseRuntimeException e, CstNode n, MessageType mt ) {
    ...
    protected ProcessMessage reportMessage( MoinLocalizedBaseException e, CstNode n, MessageType mt ) {
    ...
    protected ProcessMessage reportError( MoinLocalizedBaseException e, CstNode n ) {

        return this.reportMessage( e, n, MessageType.ERROR );
    }

    protected ProcessMessage reportWarning( MoinLocalizedBaseException e, CstNode n ) {

        return this.reportMessage( e, n, MessageType.WARNING );
    }

    protected ProcessMessage reportFatalError( MoinLocalizedBaseException e, CstNode n ) {

        return this.reportMessage( e, n, MessageType.FATAL );
    }

    protected ProcessMessage reportFatalError( MoinLocalizedBaseRuntimeException e, CstNode n ) {
