...
public class MofPackageWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl> implements com.sap.tc.moin.repository.mmi.model.MofPackage,com.sap.tc.moin.repository.Partitionable {
    ...
    public MofPackageWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofPackageImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.MofPackage (Java Type)\nModel.Package (MOF Type)"; //$NON-NLS-1$
    }    
}