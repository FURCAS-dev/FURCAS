...
public class AssociationEndWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl> implements com.sap.tc.moin.repository.mmi.model.AssociationEnd,com.sap.tc.moin.repository.Partitionable {
    ...
    public AssociationEndWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AssociationEndImpl) getWrappedObject();
    }
    ...
    public com.sap.tc.moin.repository.mmi.model.MultiplicityType getMultiplicity() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getMultiplicity();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getMultiplicity();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setMultiplicity(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public boolean isChangeable() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isChangeable();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isChangeable();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setChangeable(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.AssociationEnd (Java Type)\nModel.AssociationEnd (MOF Type)"; //$NON-NLS-1$
    }    
}