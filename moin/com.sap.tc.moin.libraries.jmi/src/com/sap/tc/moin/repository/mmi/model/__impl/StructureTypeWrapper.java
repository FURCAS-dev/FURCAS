...
public class StructureTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl> implements com.sap.tc.moin.repository.mmi.model.StructureType,com.sap.tc.moin.repository.Partitionable {
    ...
    public StructureTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.StructureTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.StructureType (Java Type)\nModel.StructureType (MOF Type)"; //$NON-NLS-1$
    }    
}