...
public class EnumerationTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl> implements com.sap.tc.moin.repository.mmi.model.EnumerationType,com.sap.tc.moin.repository.Partitionable {
    ...
    public EnumerationTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.EnumerationTypeImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getLabels(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.EnumerationType (Java Type)\nModel.EnumerationType (MOF Type)"; //$NON-NLS-1$
    }    
}