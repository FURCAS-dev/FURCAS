...
public class AttributeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl> implements com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.Partitionable {
    ...
    public AttributeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AttributeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.Attribute (Java Type)\nModel.Attribute (MOF Type)"; //$NON-NLS-1$
    }    
}