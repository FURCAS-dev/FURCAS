...
public class MofExceptionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl> implements com.sap.tc.moin.repository.mmi.model.MofException,com.sap.tc.moin.repository.Partitionable {
    ...
    public MofExceptionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofExceptionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.MofException (Java Type)\nModel.Exception (MOF Type)"; //$NON-NLS-1$
    }    
}