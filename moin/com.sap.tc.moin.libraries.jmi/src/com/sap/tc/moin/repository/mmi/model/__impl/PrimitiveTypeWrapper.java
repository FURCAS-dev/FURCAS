...
public class PrimitiveTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl> implements com.sap.tc.moin.repository.mmi.model.PrimitiveType,com.sap.tc.moin.repository.Partitionable {
    ...
    public PrimitiveTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.PrimitiveTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.PrimitiveType (Java Type)\nModel.PrimitiveType (MOF Type)"; //$NON-NLS-1$
    }    
}