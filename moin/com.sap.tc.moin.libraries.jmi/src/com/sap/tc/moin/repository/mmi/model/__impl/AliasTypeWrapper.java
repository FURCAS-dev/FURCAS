...
public class AliasTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl> implements com.sap.tc.moin.repository.mmi.model.AliasType,com.sap.tc.moin.repository.Partitionable {
    ...
    public AliasTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AliasTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.AliasType (Java Type)\nModel.AliasType (MOF Type)"; //$NON-NLS-1$
    }    
}