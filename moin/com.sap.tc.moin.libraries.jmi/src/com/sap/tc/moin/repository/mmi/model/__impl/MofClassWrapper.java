...
public class MofClassWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl> implements com.sap.tc.moin.repository.mmi.model.MofClass,com.sap.tc.moin.repository.Partitionable {
    ...
    public MofClassWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.MofClassImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.MofClass (Java Type)\nModel.Class (MOF Type)"; //$NON-NLS-1$
    }    
}