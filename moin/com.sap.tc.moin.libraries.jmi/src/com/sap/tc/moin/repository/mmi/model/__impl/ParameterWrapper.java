...
public class ParameterWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl> implements com.sap.tc.moin.repository.mmi.model.Parameter,com.sap.tc.moin.repository.Partitionable {
    ...
    public ParameterWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.ParameterImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.Parameter (Java Type)\nModel.Parameter (MOF Type)"; //$NON-NLS-1$
    }    
}