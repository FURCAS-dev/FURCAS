...
public class AssociationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl> implements com.sap.tc.moin.repository.mmi.model.Association,com.sap.tc.moin.repository.Partitionable {
    ...
    public AssociationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.AssociationImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.Association (Java Type)\nModel.Association (MOF Type)"; //$NON-NLS-1$
    }    
}