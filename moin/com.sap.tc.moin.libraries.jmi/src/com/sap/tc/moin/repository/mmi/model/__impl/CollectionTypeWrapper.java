...
public class CollectionTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl> implements com.sap.tc.moin.repository.mmi.model.CollectionType,com.sap.tc.moin.repository.Partitionable {
    ...
    public CollectionTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl getCastWrappedObject() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl) getWrappedObject();
    }
    
    private com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl) resolved;
    }
    
    public com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl unwrap() {
        return (com.sap.tc.moin.repository.mmi.model.__impl.CollectionTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "com.sap.tc.moin.repository.mmi.model.CollectionType (Java Type)\nModel.CollectionType (MOF Type)"; //$NON-NLS-1$
    }    
}