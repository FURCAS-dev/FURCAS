...
public class IntegerLiteralExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl> implements org.omg.ocl.expressions.IntegerLiteralExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public IntegerLiteralExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl) getWrappedObject();
    }
    ...
    public int getIntegerSymbol() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getIntegerSymbol();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getIntegerSymbol();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setIntegerSymbol(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.Class<org.omg.ocl.expressions.IntegerLiteralExp> get___JmiInterface() {
        return org.omg.ocl.expressions.IntegerLiteralExp.class;
    }

    // to String
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.IntegerLiteralExp (Java Type)\nOCL.Expressions.IntegerLiteralExp (MOF Type)"; //$NON-NLS-1$
    }    
}