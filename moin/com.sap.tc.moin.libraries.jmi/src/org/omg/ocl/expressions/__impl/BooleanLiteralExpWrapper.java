...
public class BooleanLiteralExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl> implements org.omg.ocl.expressions.BooleanLiteralExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public BooleanLiteralExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.BooleanLiteralExpImpl) getWrappedObject();
    }
    ...
    public boolean isBooleanSymbol() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isBooleanSymbol();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isBooleanSymbol();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setBooleanSymbol(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.Class<org.omg.ocl.expressions.BooleanLiteralExp> get___JmiInterface() {
        return org.omg.ocl.expressions.BooleanLiteralExp.class;
    }

    // to String
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.BooleanLiteralExp (Java Type)\nOCL.Expressions.BooleanLiteralExp (MOF Type)"; //$NON-NLS-1$
    }    
}