...
public final class RealLiteralExpImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl implements org.omg.ocl.expressions.RealLiteralExp,org.omg.ocl.expressions.__impl.RealLiteralExpInternal {
    ...
    static {
        ...
        FEATURE_IDS.put("realSymbol", Integer.valueOf(9)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private double __realSymbol = 0d;
    ...
    public RealLiteralExpImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 9, "45ED2E2953B70511E2594AC6060AA2B78FC76412", __realSymbol, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 9, "45ED2E2953B70511E2594AC6060AA2B78FC76412", __realSymbol, newValue); //$NON-NLS-1$
    }
    ...
    private void set__RealSymbol(double newValue) {
            __realSymbol = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 9:
                ___changeDataTypeAttribute(connection, 9, "45ED2E2953B70511E2594AC6060AA2B78FC76412", __realSymbol, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 0:
                ...
                break;
            case 9:
                set__RealSymbol((java.lang.Double) value);     
                break;
            default:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<org.omg.ocl.expressions.__impl.RealLiteralExpImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new org.omg.ocl.expressions.__impl.RealLiteralExpWrapper(conn, this, synchronize);
    }
