...
public class StringLiteralExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.StringLiteralExpImpl> implements org.omg.ocl.expressions.StringLiteralExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public StringLiteralExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.StringLiteralExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.StringLiteralExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.StringLiteralExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.StringLiteralExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.StringLiteralExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.StringLiteralExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.StringLiteralExpImpl) getWrappedObject();
    }
    ...
    public java.lang.String getStringSymbol() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getStringSymbol();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getStringSymbol();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setStringSymbol(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.Class<org.omg.ocl.expressions.StringLiteralExp> get___JmiInterface() {
        return org.omg.ocl.expressions.StringLiteralExp.class;
    }

    // to String
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.StringLiteralExp (Java Type)\nOCL.Expressions.StringLiteralExp (MOF Type)"; //$NON-NLS-1$
    }    
}