...
public class TupleLiteralExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.TupleLiteralExpImpl> implements org.omg.ocl.expressions.TupleLiteralExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public TupleLiteralExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.TupleLiteralExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.TupleLiteralExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.TupleLiteralExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.TupleLiteralExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.TupleLiteralExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.TupleLiteralExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.TupleLiteralExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getTuplePart(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.TupleLiteralExp (Java Type)\nOCL.Expressions.TupleLiteralExp (MOF Type)"; //$NON-NLS-1$
    }    
}