...
public final class IntegerLiteralExpImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl implements org.omg.ocl.expressions.IntegerLiteralExp,org.omg.ocl.expressions.__impl.IntegerLiteralExpInternal {
    ...
    static {
        ...
        FEATURE_IDS.put("integerSymbol", Integer.valueOf(9)); //$NON-NLS-1$
    }
    
    
    // variable declarations
    private java.lang.String __name = null;
    private int __integerSymbol = 0;
    ...
    public IntegerLiteralExpImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 9, "45ED2E2942323B24085047AC1540D70592AB03B9", __integerSymbol, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 9, "45ED2E2942323B24085047AC1540D70592AB03B9", __integerSymbol, newValue); //$NON-NLS-1$
    }
    ...
    private void set__IntegerSymbol(int newValue) {
            __integerSymbol = newValue;
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 9:
                ___changeDataTypeAttribute(connection, 9, "45ED2E2942323B24085047AC1540D70592AB03B9", __integerSymbol, value); //$NON-NLS-1$
                break;
    ...
    public void set___Value(com.sap.tc.moin.repository.core.CoreSession session, java.lang.String featureName, java.lang.Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            case 0:
                ...
                break;
            case 9:
                set__IntegerSymbol((java.lang.Integer) value);     
                break;
            default:
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<org.omg.ocl.expressions.__impl.IntegerLiteralExpImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new org.omg.ocl.expressions.__impl.IntegerLiteralExpWrapper(conn, this, synchronize);
    }
