...
public class RealLiteralExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.RealLiteralExpImpl> implements org.omg.ocl.expressions.RealLiteralExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public RealLiteralExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.RealLiteralExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.RealLiteralExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.RealLiteralExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.RealLiteralExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.RealLiteralExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.RealLiteralExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.RealLiteralExpImpl) getWrappedObject();
    }
    ...
    public double getRealSymbol() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getRealSymbol();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getRealSymbol();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setRealSymbol(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.Class<org.omg.ocl.expressions.RealLiteralExp> get___JmiInterface() {
        return org.omg.ocl.expressions.RealLiteralExp.class;
    }

    // to String
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.RealLiteralExp (Java Type)\nOCL.Expressions.RealLiteralExp (MOF Type)"; //$NON-NLS-1$
    }    
}