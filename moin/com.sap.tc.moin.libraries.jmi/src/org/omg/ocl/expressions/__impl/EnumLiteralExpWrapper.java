...
public class EnumLiteralExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.EnumLiteralExpImpl> implements org.omg.ocl.expressions.EnumLiteralExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public EnumLiteralExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.EnumLiteralExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.EnumLiteralExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.EnumLiteralExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.EnumLiteralExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.EnumLiteralExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.EnumLiteralExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.EnumLiteralExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getReferredEnum(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setReferredEnum(connection, unwrapArg(newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.EnumLiteralExp (Java Type)\nOCL.Expressions.EnumLiteralExp (MOF Type)"; //$NON-NLS-1$
    }    
}