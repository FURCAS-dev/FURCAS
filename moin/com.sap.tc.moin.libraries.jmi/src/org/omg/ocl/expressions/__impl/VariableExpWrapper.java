...
public class VariableExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.VariableExpImpl> implements org.omg.ocl.expressions.VariableExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public VariableExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.VariableExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.VariableExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.VariableExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.VariableExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.VariableExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.VariableExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.VariableExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getReferredVariable(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setReferredVariable(connection, unwrapArg(newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.VariableExp (Java Type)\nOCL.Expressions.VariableExp (MOF Type)"; //$NON-NLS-1$
    }    
}