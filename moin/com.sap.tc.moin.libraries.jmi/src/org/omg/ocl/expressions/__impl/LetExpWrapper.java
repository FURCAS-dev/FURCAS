...
public class LetExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.LetExpImpl> implements org.omg.ocl.expressions.LetExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public LetExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.LetExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.LetExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.LetExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.LetExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.LetExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.LetExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.LetExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getIn(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setIn(connection, unwrapArg(newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getVariable(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setVariable(connection, unwrapArg(newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.LetExp (Java Type)\nOCL.Expressions.LetExp (MOF Type)"; //$NON-NLS-1$
    }    
}