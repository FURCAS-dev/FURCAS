...
public class TypeExpWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.expressions.__impl.TypeExpImpl> implements org.omg.ocl.expressions.TypeExp,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public TypeExpWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.expressions.__impl.TypeExpImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.expressions.__impl.TypeExpImpl getCastWrappedObject() {
        return (org.omg.ocl.expressions.__impl.TypeExpImpl) getWrappedObject();
    }
    
    private org.omg.ocl.expressions.__impl.TypeExpImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.expressions.__impl.TypeExpImpl) resolved;
    }
    
    public org.omg.ocl.expressions.__impl.TypeExpImpl unwrap() {
        return (org.omg.ocl.expressions.__impl.TypeExpImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getReferredType(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setReferredType(connection, unwrapArg(newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.expressions.TypeExp (Java Type)\nOCL.Expressions.TypeExp (MOF Type)"; //$NON-NLS-1$
    }    
}