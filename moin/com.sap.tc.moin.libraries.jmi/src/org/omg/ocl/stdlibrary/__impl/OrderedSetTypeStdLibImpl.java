...
public final class OrderedSetTypeStdLibImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl implements org.omg.ocl.stdlibrary.OrderedSetTypeStdLib,org.omg.ocl.stdlibrary.__impl.OrderedSetTypeStdLibInternal {
    ...
    // default constructor
    public OrderedSetTypeStdLibImpl() {
        super();
    }
    
    // specific constructor
    public OrderedSetTypeStdLibImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public org.omg.ocl.types.OrderedSetType append(com.sap.tc.moin.repository.mmi.model.Classifier o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            parameterList.add(o);
            return (org.omg.ocl.types.OrderedSetType)___invokeOperation(get___CurrentConnection(), 26, "45ED2E2986D411619FAA4AC01518F21E604B7914", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public org.omg.ocl.types.OrderedSetType prepend(com.sap.tc.moin.repository.mmi.model.Classifier o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            parameterList.add(o);
            return (org.omg.ocl.types.OrderedSetType)___invokeOperation(get___CurrentConnection(), 27, "45ED2E296E79DE1E02D74039138AEDE45B6CE247", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public org.omg.ocl.types.OrderedSetType insertAt(int index, com.sap.tc.moin.repository.mmi.model.Classifier o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            ...
            parameterList.add(o);
            return (org.omg.ocl.types.OrderedSetType)___invokeOperation(get___CurrentConnection(), 28, "45ED2E296F734C71AD7C49340BDDADB3A2D3C670", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public org.omg.ocl.types.OrderedSetType subOrderedSet(int lower, int upper) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            ...
            return (org.omg.ocl.types.OrderedSetType)___invokeOperation(get___CurrentConnection(), 29, "45ED2E29EB6AA7B00EFF47072D87AA81DABC0478", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public com.sap.tc.moin.repository.mmi.model.Classifier at(int i) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            parameterList.add(i);
            return (com.sap.tc.moin.repository.mmi.model.Classifier)___invokeOperation(get___CurrentConnection(), 30, "45ED2E29DC7FA207612E4920142FCEF019265D4F", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public int indexOf(com.sap.tc.moin.repository.mmi.model.Classifier o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            parameterList.add(o);
            return (java.lang.Integer)___invokeOperation(get___CurrentConnection(), 31, "45ED2E29EAB48D05F9034707224EB8E582FBD3CD", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public com.sap.tc.moin.repository.mmi.model.Classifier first() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (com.sap.tc.moin.repository.mmi.model.Classifier)___invokeOperation(get___CurrentConnection(), 32, "45ED2E2902A735586F3548F8057C9565451FAB95", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public com.sap.tc.moin.repository.mmi.model.Classifier last() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (com.sap.tc.moin.repository.mmi.model.Classifier)___invokeOperation(get___CurrentConnection(), 33, "45ED2E29EEE0677D4C4A49F40491B5D729F94D77", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    public boolean equalsStdLib(org.omg.ocl.types.OrderedSetType o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            parameterList.add(o);
            return (java.lang.Boolean)___invokeOperation(get___CurrentConnection(), 34, "45ED2E2993D699203EDF4D261C7CEC50D9748B7A", parameterList); //$NON-NLS-1$
        }
        catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<org.omg.ocl.stdlibrary.__impl.OrderedSetTypeStdLibImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new org.omg.ocl.stdlibrary.__impl.OrderedSetTypeStdLibWrapper(conn, this, synchronize);
    }
