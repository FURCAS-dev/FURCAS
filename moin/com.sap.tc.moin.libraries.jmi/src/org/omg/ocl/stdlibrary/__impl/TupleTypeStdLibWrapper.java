...
public class TupleTypeStdLibWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl> implements org.omg.ocl.stdlibrary.TupleTypeStdLib,com.sap.tc.moin.repository.Partitionable {
    ...
    public TupleTypeStdLibWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl getCastWrappedObject() {
        return (org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl) getWrappedObject();
    }
    
    private org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl) resolved;
    }
    
    public org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl unwrap() {
        return (org.omg.ocl.stdlibrary.__impl.TupleTypeStdLibImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.stdlibrary.TupleTypeStdLib (Java Type)\nOCL.StdLibrary.TupleTypeStdLib (MOF Type)"; //$NON-NLS-1$
    }    
}