...
public class SetTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.types.__impl.SetTypeImpl> implements org.omg.ocl.types.SetType,com.sap.tc.moin.repository.Partitionable {
    ...
    public SetTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.types.__impl.SetTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.types.__impl.SetTypeImpl getCastWrappedObject() {
        return (org.omg.ocl.types.__impl.SetTypeImpl) getWrappedObject();
    }
    
    private org.omg.ocl.types.__impl.SetTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.types.__impl.SetTypeImpl) resolved;
    }
    
    public org.omg.ocl.types.__impl.SetTypeImpl unwrap() {
        return (org.omg.ocl.types.__impl.SetTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.types.SetType (Java Type)\nOCL.Types.SetType (MOF Type)"; //$NON-NLS-1$
    }    
}