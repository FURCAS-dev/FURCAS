...
public class BagTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.types.__impl.BagTypeImpl> implements org.omg.ocl.types.BagType,com.sap.tc.moin.repository.Partitionable {
    ...
    public BagTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.types.__impl.BagTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.types.__impl.BagTypeImpl getCastWrappedObject() {
        return (org.omg.ocl.types.__impl.BagTypeImpl) getWrappedObject();
    }
    
    private org.omg.ocl.types.__impl.BagTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.types.__impl.BagTypeImpl) resolved;
    }
    
    public org.omg.ocl.types.__impl.BagTypeImpl unwrap() {
        return (org.omg.ocl.types.__impl.BagTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.types.BagType (Java Type)\nOCL.Types.BagType (MOF Type)"; //$NON-NLS-1$
    }    
}