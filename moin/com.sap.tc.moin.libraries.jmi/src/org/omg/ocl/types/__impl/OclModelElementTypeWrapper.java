...
public class OclModelElementTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.types.__impl.OclModelElementTypeImpl> implements org.omg.ocl.types.OclModelElementType,com.sap.tc.moin.repository.Partitionable {
    ...
    public OclModelElementTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.types.__impl.OclModelElementTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.types.__impl.OclModelElementTypeImpl getCastWrappedObject() {
        return (org.omg.ocl.types.__impl.OclModelElementTypeImpl) getWrappedObject();
    }
    
    private org.omg.ocl.types.__impl.OclModelElementTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.types.__impl.OclModelElementTypeImpl) resolved;
    }
    
    public org.omg.ocl.types.__impl.OclModelElementTypeImpl unwrap() {
        return (org.omg.ocl.types.__impl.OclModelElementTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.types.OclModelElementType (Java Type)\nOCL.Types.OclModelElementType (MOF Type)"; //$NON-NLS-1$
    }    
}