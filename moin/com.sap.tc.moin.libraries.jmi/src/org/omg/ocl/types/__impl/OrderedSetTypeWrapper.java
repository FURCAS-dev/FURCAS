...
public class OrderedSetTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.types.__impl.OrderedSetTypeImpl> implements org.omg.ocl.types.OrderedSetType,com.sap.tc.moin.repository.Partitionable {
    ...
    public OrderedSetTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.types.__impl.OrderedSetTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.types.__impl.OrderedSetTypeImpl getCastWrappedObject() {
        return (org.omg.ocl.types.__impl.OrderedSetTypeImpl) getWrappedObject();
    }
    
    private org.omg.ocl.types.__impl.OrderedSetTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.types.__impl.OrderedSetTypeImpl) resolved;
    }
    
    public org.omg.ocl.types.__impl.OrderedSetTypeImpl unwrap() {
        return (org.omg.ocl.types.__impl.OrderedSetTypeImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return  wrapResult(getCastWrappedObject().getElementType(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setElementType(connection, unwrapArg(newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.types.OrderedSetType (Java Type)\nOCL.Types.OrderedSetType (MOF Type)"; //$NON-NLS-1$
    }    
}