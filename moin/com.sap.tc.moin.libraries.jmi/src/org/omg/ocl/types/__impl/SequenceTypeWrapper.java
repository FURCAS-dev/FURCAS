...
public class SequenceTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.types.__impl.SequenceTypeImpl> implements org.omg.ocl.types.SequenceType,com.sap.tc.moin.repository.Partitionable {
    ...
    public SequenceTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.types.__impl.SequenceTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.types.__impl.SequenceTypeImpl getCastWrappedObject() {
        return (org.omg.ocl.types.__impl.SequenceTypeImpl) getWrappedObject();
    }
    
    private org.omg.ocl.types.__impl.SequenceTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.types.__impl.SequenceTypeImpl) resolved;
    }
    
    public org.omg.ocl.types.__impl.SequenceTypeImpl unwrap() {
        return (org.omg.ocl.types.__impl.SequenceTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.types.SequenceType (Java Type)\nOCL.Types.SequenceType (MOF Type)"; //$NON-NLS-1$
    }    
}