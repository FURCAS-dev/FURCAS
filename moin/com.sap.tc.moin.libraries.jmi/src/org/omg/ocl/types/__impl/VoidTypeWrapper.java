...
public class VoidTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<org.omg.ocl.types.__impl.VoidTypeImpl> implements org.omg.ocl.types.VoidType,com.sap.tc.moin.repository.Partitionable {
    ...
    public VoidTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, org.omg.ocl.types.__impl.VoidTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private org.omg.ocl.types.__impl.VoidTypeImpl getCastWrappedObject() {
        return (org.omg.ocl.types.__impl.VoidTypeImpl) getWrappedObject();
    }
    
    private org.omg.ocl.types.__impl.VoidTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (org.omg.ocl.types.__impl.VoidTypeImpl) resolved;
    }
    
    public org.omg.ocl.types.__impl.VoidTypeImpl unwrap() {
        return (org.omg.ocl.types.__impl.VoidTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "org.omg.ocl.types.VoidType (Java Type)\nOCL.Types.VoidType (MOF Type)"; //$NON-NLS-1$
    }    
}