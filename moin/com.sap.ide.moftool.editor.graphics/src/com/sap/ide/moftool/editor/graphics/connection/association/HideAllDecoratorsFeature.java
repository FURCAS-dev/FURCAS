...
public class HideAllDecoratorsFeature extends AbstractCustomFeature {
	
    private String mName = Messages.HideAllDecoratorsFeature_0_xbut;
    private String mDescription = Messages.HideAllDecoratorsFeature_1_xmsg;

    public HideAllDecoratorsFeature(IFeatureProvider fp) {
        super(fp);
    }
