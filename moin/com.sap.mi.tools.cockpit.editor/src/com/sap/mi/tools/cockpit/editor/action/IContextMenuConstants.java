...
/**
 * Constants for menu groups used in context menus for Model Browser and editors.
 * <p>
...
public interface IContextMenuConstants {
	...
	/**
	 * Pop-up menu: name of group for code generation or refactoring actions ( value <code>"group.generate"</code>).
	 */
