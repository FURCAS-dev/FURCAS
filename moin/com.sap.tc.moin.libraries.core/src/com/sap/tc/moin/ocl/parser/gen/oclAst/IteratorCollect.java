...
/**
 *<b>
 *<li>Rule 157:  iteratorExp ::= collect ( iterContents )
 *</b>
 */
public class IteratorCollect extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorCollect(IToken leftIToken, IToken rightIToken,
