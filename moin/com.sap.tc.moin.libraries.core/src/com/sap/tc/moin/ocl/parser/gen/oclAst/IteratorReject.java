...
/**
 *<b>
 *<li>Rule 159:  iteratorExp ::= reject ( iterContents )
 *</b>
 */
public class IteratorReject extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorReject(IToken leftIToken, IToken rightIToken,
