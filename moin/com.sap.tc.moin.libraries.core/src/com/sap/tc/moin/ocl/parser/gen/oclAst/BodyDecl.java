...
/**
 *<b>
 *<li>Rule 75:  prePostOrBodyDecl ::= body identifierOpt : oclExpression
 *</b>
 */
public class BodyDecl extends Node implements IprePostOrBodyDecl
{
    ...
    public BodyDecl(IToken leftIToken, IToken rightIToken,
