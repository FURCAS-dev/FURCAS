...
/**
 * Needed to implement the JMI calls generated for OCL operation bodies (the JMI
 * call expects the Java objects in the collection)
 */
public class UnWrappingHashBag implements Collection<Object> {

    /** The backing map of objects to their count. */
    private final Map<Object, Integer> elementCountMap = new HashMap<Object, Integer>( );

    /**
     * Creates a Bag with no entries.
     */
    public UnWrappingHashBag( ) {
     ...
     */
    public UnWrappingHashBag( Collection<OclAny> c ) {
    ...
    public boolean retainAll( Collection<?> a ) {
        ...
        boolean changed = false;
        Iterator<Object> i = this.elementCountMap.keySet( ).iterator( );
        while ( i.hasNext( ) ) {
            Object key = i.next( );
            if ( !a.contains( key ) ) {
                i.remove( );
    ...
    private ArrayList<Object> toArrayList( ) {
        ...
        Iterator<Map.Entry<Object, Integer>> i = this.elementCountMap.entrySet( ).iterator( );
        while ( i.hasNext( ) ) {
            Map.Entry<Object, Integer> entry = i.next( );
     ...
     * the current bag.
     */
    private static final class BagIterator implements Iterator<Object> {

        // an iterator for the internal map
        private Iterator<Map.Entry<Object, Integer>> myElementCountMapIterator;
         ...
         * encapsulating class.
         */
        BagIterator( Iterator<Map.Entry<Object, Integer>> elementCountMapIterator ) {
