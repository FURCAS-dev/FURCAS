...
/**
 *<b>
 *<li>Rule 94:  booleanExpression ::= booleanExpression xor relationalExpression
 *</b>
 */
public class XorBooleanExpression extends Node implements IbooleanExpression
{
    ...
    public XorBooleanExpression(IToken leftIToken, IToken rightIToken,
