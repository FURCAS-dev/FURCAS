...
/**
 *<b>
 *<li>Rule 152:  iteratorExp ::= forAll ( iterContents )
 *</b>
 */
public class IteratorForAll extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorForAll(IToken leftIToken, IToken rightIToken,
