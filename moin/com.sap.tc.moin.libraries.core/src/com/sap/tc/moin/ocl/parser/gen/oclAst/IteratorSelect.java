...
/**
 *<b>
 *<li>Rule 158:  iteratorExp ::= select ( iterContents )
 *</b>
 */
public class IteratorSelect extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorSelect(IToken leftIToken, IToken rightIToken,
