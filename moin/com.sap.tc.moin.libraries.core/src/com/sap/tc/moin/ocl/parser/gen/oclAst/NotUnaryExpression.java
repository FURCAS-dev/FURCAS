...
/**
 *<b>
 *<li>Rule 113:  unaryExpression ::= not unaryExpression
 *</b>
 */
public class NotUnaryExpression extends Node implements IunaryExpression
{
    private IunaryExpression _unaryExpression;

    public IunaryExpression getunaryExpression() { return _unaryExpression; }

    public NotUnaryExpression(IToken leftIToken, IToken rightIToken,
