...
/**
 *<b>
 *<li>Rule 155:  iteratorExp ::= one ( iterContents )
 *</b>
 */
public class IteratorOne extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorOne(IToken leftIToken, IToken rightIToken,
