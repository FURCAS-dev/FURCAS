...
/**
 *<b>
 *<li>Rule 153:  iteratorExp ::= exists ( iterContents )
 *</b>
 */
public class IteratorExists extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorExists(IToken leftIToken, IToken rightIToken,
