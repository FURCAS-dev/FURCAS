...
/**
 *<b>
 *<li>Rule 73:  prePostOrBodyDecl ::= pre identifierOpt : oclExpression
 *</b>
 */
public class PreConditionDecl extends Node implements IprePostOrBodyDecl
{
    ...
    public PreConditionDecl(IToken leftIToken, IToken rightIToken,
