...
/**
 *<b>
 *<li>Rule 161:  iteratorExp ::= sortedBy ( iterContents )
 *</b>
 */
public class IteratorSortedBy extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorSortedBy(IToken leftIToken, IToken rightIToken,
