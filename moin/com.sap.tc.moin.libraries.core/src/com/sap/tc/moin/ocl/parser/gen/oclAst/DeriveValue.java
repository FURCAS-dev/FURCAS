...
/**
 *<b>
 *<li>Rule 61:  initOrDerValue ::= derive : oclExpression
 *</b>
 */
public class DeriveValue extends Node implements IinitOrDerValue
{
    private IoclExpression _oclExpression;

    public IoclExpression getoclExpression() { return _oclExpression; }

    public DeriveValue(IToken leftIToken, IToken rightIToken,
