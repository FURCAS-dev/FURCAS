...
public class OclLexerGen extends LpgLexStream implements OclParserGensym, OclLexerGensym, RuleAction
{
    private static ParseTable prs = new OclLexerGenprs();
    ...
    public OclLexerGen(String filename, int tab) throws java.io.IOException 
    {
        super(filename, tab);
    }

    public OclLexerGen(char[] input_chars, String filename, int tab)
    {
        super(input_chars, filename, tab);
    }

    public OclLexerGen(char[] input_chars, String filename)
    {
    ...
    public String[] orderedExportedSymbols() { return OclParserGensym.orderedTerminalSymbols; }
    ...
    //
    OclKeywordLexer kwLexer;
    boolean printTokens;
    private final static int ECLIPSE_TAB_VALUE = 4;

    public int [] getKeywordKinds() { return kwLexer.getKeywordKinds(); }

    public OclLexerGen(String filename) throws java.io.IOException
    {
        this(filename, ECLIPSE_TAB_VALUE);
        this.kwLexer = new OclKeywordLexer(getInputChars(), TK_IDENTIFIER);
    }
