...
/**
 *<b>
 *<li>Rule 154:  iteratorExp ::= isUnique ( iterContents )
 *</b>
 */
public class IteratorIsUnique extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorIsUnique(IToken leftIToken, IToken rightIToken,
