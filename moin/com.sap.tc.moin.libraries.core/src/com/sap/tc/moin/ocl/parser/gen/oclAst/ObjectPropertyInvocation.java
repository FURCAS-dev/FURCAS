...
/**
 *<b>
 *<li>Rule 120:  propertyInvocation ::= . propertyCall
 *</b>
 */
public class ObjectPropertyInvocation extends Node implements IpropertyInvocation
{
    private IpropertyCall _propertyCall;

    public IpropertyCall getpropertyCall() { return _propertyCall; }

    public ObjectPropertyInvocation(IToken leftIToken, IToken rightIToken,
