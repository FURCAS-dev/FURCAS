...
/**
 *<b>
 *<li>Rule 160:  iteratorExp ::= collectNested ( iterContents )
 *</b>
 */
public class IteratorCollectNested extends Node implements IiteratorExp
{
    private IiterContents _iterContents;

    public IiterContents getiterContents() { return _iterContents; }

    public IteratorCollectNested(IToken leftIToken, IToken rightIToken,
