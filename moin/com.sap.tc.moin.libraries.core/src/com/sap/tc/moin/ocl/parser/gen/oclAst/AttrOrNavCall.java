...
/**
 *<b>
 *<li>Rule 146:  attrOrNavCall ::= pathName timeExpressionOpt associationQualifierOpt
 *</b>
 */
public class AttrOrNavCall extends Node implements IattrOrNavCall
{
    ...
    public AttrOrNavCall(IToken leftIToken, IToken rightIToken,
                         IpathName _pathName,
