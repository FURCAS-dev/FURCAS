...
/**
 *<b>
 *<li>Rule 125:  operationCall ::= pathName timeExpressionOpt arguments
 *</b>
 */
public class OperationCall extends Node implements IoperationCall
{
    ...
    public OperationCall(IToken leftIToken, IToken rightIToken,
                         IpathName _pathName,
