...
public class MqlKeywordLexer extends MqlKeywordLexerprs implements MqlParserGensym
{
    ...
    private final int keywordKind[] = new int[18 + 1];
    ...
    public MqlKeywordLexer(char[] inputChars, int identifierKind)
    {
        ...
        //
        // Rule 14:  MqlKeyWord ::= p a r t i t i o n s
        //
		keywordKind[14] = (TK_partitions);
	  
	
        //
        // Rule 15:  MqlKeyWord ::= c o n t a i n e r s
        //
		keywordKind[15] = (TK_containers);
	  
	
        //
        // Rule 16:  MqlKeyWord ::= e l e m e n t s
        //
		keywordKind[16] = (TK_elements);
	  
	
        //
        // Rule 17:  MqlKeyWord ::= f o r
        //
		keywordKind[17] = (TK_for);
	  
	
        //
        // Rule 18:  MqlKeyWord ::= l i k e
        //
		keywordKind[18] = (TK_like);
