...
public class DeregisterChangeListenerAction extends AbstractAction {

    private final ChangeListener listener;

    private final EventFilter eventFilterTree;

    public DeregisterChangeListenerAction( CoreConnection connection, ChangeListener listener, EventFilter eventFilterTree ) {
    ...
    public void revert( ) throws UnrecoverableExecutionException {
        ...
        connection.getSession( ).getEventRegistry( ).registerListener( listener, eventFilterTree );
