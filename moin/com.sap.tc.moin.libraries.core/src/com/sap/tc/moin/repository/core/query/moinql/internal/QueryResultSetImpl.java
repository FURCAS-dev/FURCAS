...
public final class QueryResultSetImpl implements SpiFqlQueryResultSet {
    ...
    public int addEntriesFromResultSet( SpiFqlQueryResultSet queryResultSet ) {
        ...
        if ( queryResultSet.getRowSize( ) != this.rowSize ) {
            throw new MQLBugException( MQLBugMessages.RESULT_SET_OF_DIFFERENT_ROW_SIZES );
        }
    ...
    public void setMri( int resultPos, int numberOfSelection, MRI mri ) {
    ...
    public MRI getMri( int resultPos, int numberOfSelection ) {

        Object[] horizontalObjectArray = this.resultSet.get( resultPos );
        return (MRI) horizontalObjectArray[this.getMriPositionInResultRow( numberOfSelection )];
    }
    ...
    public void setAttributeValue( int resultPos, int numberOfSelection, int numberOfAttributeInSelection, Object value ) {
        ...
        if ( numberOfAttributeInSelection < 0 ) {
            throw new MQLBugException( MQLBugMessages.NUMBER_OF_ATTRS_IN_SELECT_LIST_NEGATIVE, numberOfAttributeInSelection );
        }
        if ( value instanceof MRI ) {
            throw new MQLBugException( MQLBugMessages.ATTR_VALUES_SHOULD_NOT_BE_MRIS, value );
        }
        Object[] horizontalObjectArray = this.resultSet.get( resultPos );
    ...
    public static final class RowComparator implements Comparator<Object[]> {
        ...
        public int compare( Object[] row1, Object[] row2 ) {
            ...
            for ( int i = 0; i < row1.length; i++ ) {
                ...
                String row1Element = ( obj1 == null ? MQLAuxServices.EMPTYSTR : obj1.toString( ) );
                String row2Element = ( obj2 == null ? MQLAuxServices.EMPTYSTR : obj2.toString( ) );
