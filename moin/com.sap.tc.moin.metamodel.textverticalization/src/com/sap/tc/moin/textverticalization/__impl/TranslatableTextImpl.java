...
public final class TranslatableTextImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.textverticalization.TranslatableText
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "textverticalization", "TranslatableText" })); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    // JMI constructor
    public TranslatableTextImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
