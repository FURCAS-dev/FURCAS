...
final public class LocalWhereEntry extends WhereEntry {
     ...
     * 
     * @param _aliasName the alias name which is being constraint by the where
     * clause
     * @param _whereClause the where clause which constrains the relevant
     * instances of the from type denoted by the alias
     */
