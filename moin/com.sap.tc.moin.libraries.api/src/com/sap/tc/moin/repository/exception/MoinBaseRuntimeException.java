 ...
 */
public abstract class MoinBaseRuntimeException extends RuntimeException {
    ...
    /**
     * @param rootCause see {@link RuntimeException#getCause()}
     */
    public MoinBaseRuntimeException( MoinLocalizedBaseException rootCause ) {
     ...
     * @param rootCause see {@link RuntimeException#getCause()}
     */
    public MoinBaseRuntimeException( MoinLocalizedBaseRuntimeException rootCause ) {
     ...
     * @param rootCause see {@link RuntimeException#getCause()}
     */
    public MoinBaseRuntimeException( MoinBaseException rootCause ) {
    ...
    /**
     * @param message see {@link RuntimeException#getMessage()}
     * @param rootCause see {@link RuntimeException#getCause()}
     */
    public MoinBaseRuntimeException( String message, Throwable rootCause ) {
     ...
     * @param message see {@link RuntimeException#getMessage()}
     */
    public MoinBaseRuntimeException( String message ) {
     ...
     */
    public MoinBaseRuntimeException( MoinExternalizedString message, Object... args ) {
     ...
     * @param args the arguments for message parameter replacement
     */
    public MoinBaseRuntimeException( Throwable cause, MoinExternalizedString message, Object... args ) {
