...
final public class FromFixedSet extends FromType {
     ...
     * @param _qName of the common supertype of the fixed elements
     * @param _containerName the optional container name of the common supertype
     * of the fixed elements
     * @param _elements the actual fixed elements, encoded as MRIs
     */
    public FromFixedSet( String _aliasName, String[] _qName, String _containerName, MRI[] _elements ) {

        super( _aliasName, _qName, _containerName, false );
     ...
     * @param _elements the actual fixed elements, encoded as MRIs
     */
    public FromFixedSet( String _aliasName, String[] _qName, String _containerName, Set<MRI> _elements ) {
