 ...
 */
public interface Feature extends com.sap.tc.moin.repository.mmi.model.ModelElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.Feature> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.Feature>("45ED2E2940E706B100F94EAB3A7A96E85382BF86", "sap.com/tc/moin/mof_1.4", "Model", "Feature"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.Feature,com.sap.tc.moin.repository.mmi.model.ScopeKind> __scope;
        /**
         * Returns the descriptor for the <code>scope</code> attribute.
         * @return  the descriptor for the <code>scope</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.Feature,com.sap.tc.moin.repository.mmi.model.ScopeKind> SCOPE( ) {
            if ( __scope == null ) {
                __scope = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.Feature,com.sap.tc.moin.repository.mmi.model.ScopeKind>( "45ED2E291339EB0E185240843D7EB11318EA2EB4", "sap.com/tc/moin/mof_1.4", new java.lang.String[] { "Model", "Feature", "scope" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __scope;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.Feature,com.sap.tc.moin.repository.mmi.model.VisibilityKind> __visibility;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.Feature,com.sap.tc.moin.repository.mmi.model.VisibilityKind> VISIBILITY( ) {
            if ( __visibility == null ) {
                __visibility = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.Feature,com.sap.tc.moin.repository.mmi.model.VisibilityKind>( "45ED2E29DEAA28F0D64248241F53F24DAC1ED07E", "sap.com/tc/moin/mof_1.4", new java.lang.String[] { "Model", "Feature", "visibility" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __visibility;
        }
        /**
