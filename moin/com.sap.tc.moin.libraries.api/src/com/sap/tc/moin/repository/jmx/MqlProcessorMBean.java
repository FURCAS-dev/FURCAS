...
/**
 * The JMX instrumentation of {@link MQLProcessor} instances.
 * <p>
 * 
...
public interface MqlProcessorMBean {
     ...
     */
    public static final String[] ALL_NOTIFICATION_TYPES = new String[] { QUERY_PREPARE_START, QUERY_PREPARE_END, QUERY_EXECUTE_START, QUERY_EXECUTE_END, LEAF_QUERY_EXECUTED, MQL_FORMAT_ERROR };
     ...
     * 
     * @param mqlString the query to execute given as a concrete syntax String
     * @return a TabularData instance representing either the
     * {@link MQLResultSet} or the error reported by the {@link MQLProcessor}
     * @throws IOException in case of network communication issues
     */
