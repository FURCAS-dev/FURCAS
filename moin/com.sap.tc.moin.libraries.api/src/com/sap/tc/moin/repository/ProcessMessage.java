...
public interface ProcessMessage {
     ...
     * Sets start column.
     * 
     * @param startColumn start column to be set.
     */
     ...
     * Sets start line.
     * 
     * @param startLine start line to be set.
     */
     ...
     * Sets end column.
     * 
     * @param endColumn end column to be set.
     */
     ...
     * Sets end line.
     * 
     * @param endLine end line to be set.
     */
     ...
     * Sets start position.
     * 
     * @param startPosition start position to be set.
     */
     ...
     * Sets end position.
     * 
     * @param endPosition end position to be set.
     */
