 ...
 */
public interface PrimitiveType extends com.sap.tc.moin.repository.mmi.model.DataType {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.PrimitiveType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.PrimitiveType>("45ED2E29173C68FD5A6C4BF42864A453CFA3A06A", "sap.com/tc/moin/mof_1.4", "Model", "PrimitiveType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
