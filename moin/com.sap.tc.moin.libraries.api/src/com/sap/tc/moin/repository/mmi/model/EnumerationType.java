 ...
 */
public interface EnumerationType extends com.sap.tc.moin.repository.mmi.model.DataType {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.EnumerationType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.EnumerationType>("45ED2E298AE1492A468A47C708BCEF140B9DFA3F", "sap.com/tc/moin/mof_1.4", "Model", "EnumerationType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.EnumerationType,java.util.List<java.lang.String>> __labels;
        /**
         * Returns the descriptor for the <code>labels</code> attribute.
         * @return  the descriptor for the <code>labels</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.EnumerationType,java.util.List<java.lang.String>> LABELS( ) {
            if ( __labels == null ) {
                __labels = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,com.sap.tc.moin.repository.mmi.model.EnumerationType,java.util.List<java.lang.String>>( "45ED2E295728B688966243441ECCA79B99376E48", "sap.com/tc/moin/mof_1.4", new java.lang.String[] { "Model", "EnumerationType", "labels" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __labels;
        }
        /**
