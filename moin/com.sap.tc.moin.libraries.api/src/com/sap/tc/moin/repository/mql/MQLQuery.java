 ...
 */
final public class MQLQuery extends MQLElement {
     ...
     * 
     * @param _selectEntries the select entries of the select-clause.
     * @param _fromEntries the from entries of the from-clause.
     */
    public MQLQuery( SelectEntry[] _selectEntries, FromEntry[] _fromEntries ) {
     ...
     * @param _fromEntries the from entries of the from-clause.
     */
    public MQLQuery( List<SelectEntry> _selectEntries, List<FromEntry> _fromEntries ) {

        this( _selectEntries.toArray( new SelectEntry[_selectEntries.size( )] ), _fromEntries.toArray( new FromEntry[_fromEntries.size( )] ), new WhereEntry[0] );
    }
     ...
     * @param _selectEntries the select entries of the select-clause.
     * @param _fromEntries the from entries of the from-clause.
     * @param _whereEntries the different where entries
     */
     ...
     * @param _whereEntries the different where entries
     */
    public MQLQuery( List<SelectEntry> _selectEntries, List<FromEntry> _fromEntries, List<WhereEntry> _whereEntries ) {
