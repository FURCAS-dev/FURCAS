 ...
 */
public interface MofPackage extends com.sap.tc.moin.repository.mmi.model.GeneralizableElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.MofPackage> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, com.sap.tc.moin.repository.mmi.model.MofPackage>("45ED2E2925D14D728A6546C630BDE3FB4BDA77C3", "sap.com/tc/moin/mof_1.4", "Model", "Package"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
