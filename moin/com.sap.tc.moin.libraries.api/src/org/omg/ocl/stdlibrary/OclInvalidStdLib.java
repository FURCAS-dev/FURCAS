 ...
 */
public interface OclInvalidStdLib extends org.omg.ocl.stdlibrary.OclAnyStdLib {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.OclInvalidStdLib> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.OclInvalidStdLib>("4670DA1FEE757FB01A3C11DC842C00199904B925", "sap.com/tc/moin/mof_1.4", "OCL", "StdLibrary", "OclInvalidStdLib"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
