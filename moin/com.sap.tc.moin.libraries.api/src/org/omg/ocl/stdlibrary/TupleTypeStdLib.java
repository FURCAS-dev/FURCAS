 ...
 */
public interface TupleTypeStdLib extends com.sap.tc.moin.repository.mmi.model.Classifier {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.TupleTypeStdLib> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.TupleTypeStdLib>("45ED2E292C74CA2C6E214A2E03D5BEDF8F8014F2", "sap.com/tc/moin/mof_1.4", "OCL", "StdLibrary", "TupleTypeStdLib"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
