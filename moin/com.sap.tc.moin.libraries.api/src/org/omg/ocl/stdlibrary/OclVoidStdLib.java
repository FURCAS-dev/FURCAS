 ...
 */
public interface OclVoidStdLib extends org.omg.ocl.stdlibrary.OclAnyStdLib {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.OclVoidStdLib> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.OclVoidStdLib>("45ED2E290CAFA8D16B86466B3F7DA09CB90428FF", "sap.com/tc/moin/mof_1.4", "OCL", "StdLibrary", "OclVoidStdLib"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
