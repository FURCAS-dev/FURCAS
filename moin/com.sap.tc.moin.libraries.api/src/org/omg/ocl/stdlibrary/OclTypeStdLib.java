 ...
 */
public interface OclTypeStdLib extends org.omg.ocl.stdlibrary.OclAnyStdLib {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.OclTypeStdLib> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.stdlibrary.OclTypeStdLib>("45ED2E29CF01CC07E0044EF30C8AB75BA10A62E3", "sap.com/tc/moin/mof_1.4", "OCL", "StdLibrary", "OclTypeStdLib"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,org.omg.ocl.stdlibrary.OclTypeStdLib,org.omg.ocl.types.SetType> __allInstances;
        /**
         * Returns the descriptor for the <code>allInstances</code> operation.
         * @return  the descriptor for the <code>allInstances</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,org.omg.ocl.stdlibrary.OclTypeStdLib,org.omg.ocl.types.SetType> ALL_INSTANCES( ) {
            if ( __allInstances == null ) {
                __allInstances = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,org.omg.ocl.stdlibrary.OclTypeStdLib,org.omg.ocl.types.SetType>( "45ED2E29E9098671B38B4EC32F3FFD3228A12A76", "sap.com/tc/moin/mof_1.4", new java.lang.String[] { "OCL", "StdLibrary", "OclTypeStdLib", "allInstances" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
