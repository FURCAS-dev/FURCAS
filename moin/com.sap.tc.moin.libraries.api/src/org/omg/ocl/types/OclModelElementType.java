 ...
 */
public interface OclModelElementType extends com.sap.tc.moin.repository.mmi.model.Classifier {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.types.OclModelElementType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.types.OclModelElementType>("45ED2E297F20E178A39B4A0109E1E1D76AD0D153", "sap.com/tc/moin/mof_1.4", "OCL", "Types", "OclModelElementType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
