 ...
 */
public interface CollectionType extends com.sap.tc.moin.repository.mmi.model.DataType {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.types.CollectionType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.types.CollectionType>("45ED2E296F266090621A4E09296BBEBF68DB3853", "sap.com/tc/moin/mof_1.4", "OCL", "Types", "CollectionType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,org.omg.ocl.types.CollectionType,com.sap.tc.moin.repository.mmi.model.Classifier> __elementType;
        /**
         * Returns the descriptor for the <code>elementType</code> reference.
         * @return  the descriptor for the <code>elementType</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,org.omg.ocl.types.CollectionType,com.sap.tc.moin.repository.mmi.model.Classifier> ELEMENT_TYPE( ) {
            if ( __elementType == null ) {
                __elementType = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,org.omg.ocl.types.CollectionType,com.sap.tc.moin.repository.mmi.model.Classifier>( "45ED2E29D86DDC7FE7A1473714F491DDA67C9D2F", "sap.com/tc/moin/mof_1.4", new java.lang.String[] { "OCL", "Types", "CollectionType", "elementType" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
