 ...
 */
public interface TupleType extends com.sap.tc.moin.repository.mmi.model.DataType {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.types.TupleType> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, org.omg.ocl.types.TupleType>("45ED2E29264CA5434DDC4F0333D8C92FC76E550B", "sap.com/tc/moin/mof_1.4", "OCL", "Types", "TupleType"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
