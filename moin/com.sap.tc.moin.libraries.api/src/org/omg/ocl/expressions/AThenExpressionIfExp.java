 ...
 */
public interface AThenExpressionIfExp extends com.sap.tc.moin.repository.mmi.reflect.RefAssociation
{
    // association extent descriptor
    /**
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.AssociationDescriptor<org.omg.ocl.expressions.AThenExpressionIfExp> ASSOCIATION_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.AssociationDescriptor<org.omg.ocl.expressions.AThenExpressionIfExp>("45ED2E297FC22AF1C85C470F38138E009DBBF185", "sap.com/tc/moin/mof_1.4", "OCL", "Expressions", "A_thenExpression_ifExp"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
