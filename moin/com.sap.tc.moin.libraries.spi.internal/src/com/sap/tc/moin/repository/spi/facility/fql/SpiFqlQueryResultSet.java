...
public interface SpiFqlQueryResultSet {
     ...
     */
    void setMri( int position, int selectionPosition, MRI mri );
     ...
     */
    MRI getMri( int position, int selectionPosition );
     ...
     * 
     * @param numberOfSelection number of the selection starting with 0
     ...
     * 
     * @param numberOfSelection number of the selection starting with 0
     * @param numberOfAttributeInSelection number of the attribute in the
     * selection starting with 0
     * @return position in the result row
     */
