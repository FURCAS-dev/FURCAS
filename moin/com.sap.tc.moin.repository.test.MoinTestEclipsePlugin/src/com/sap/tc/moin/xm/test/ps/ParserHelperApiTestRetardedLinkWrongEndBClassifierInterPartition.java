...
/**
 * Tests the the creation of a retarded inter-partition link with a wrong end B
 * classifier. This will not cause an Exception at the end of the parsing.
 */
@SuppressWarnings( "nls" )
public class ParserHelperApiTestRetardedLinkWrongEndBClassifierInterPartition extends com.sap.tc.moin.repository.xm.parser.XmParserHandlerAbstract {
     ...
     */
    public ParserHelperApiTestRetardedLinkWrongEndBClassifierInterPartition( ) {
...
/**
     * Creates a retarded inter-partition link with a wrong end B classifier.
    ...
    private void testCreateLinkLogicalKey( ) throws XmException {
        ...
        try {
            helper.createLink( ServiceReferenceAssociation.ASSOCIATION_DESCRIPTOR, "logicalSystem", serviceRef, ServiceReference.CLASS_DESCRIPTOR, "test" );
