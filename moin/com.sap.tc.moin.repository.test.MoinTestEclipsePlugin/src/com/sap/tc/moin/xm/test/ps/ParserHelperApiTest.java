...
/**
 * Tests the Exception of the ParserHelper API.
 */
@SuppressWarnings( "nls" )
public class ParserHelperApiTest extends com.sap.tc.moin.repository.xm.parser.XmParserHandlerAbstract {
    ...
    public com.sap.tc.moin.repository.xm.parser.ComplexTypeHandler getRootComplexTypeHandler( final java.lang.String localName, final java.lang.String prefix ) throws com.sap.tc.moin.repository.xm.XmException {
        ...
        try {
            this.testGetOrCreateModelElement( errors );

            this.testCreateLink( errors );

            this.testCreateLinkLogicalKey( errors );
        } catch ( Exception e ) {
     ...
     * or
     * {@link ParserHelper#createLink(com.sap.tc.moin.repository.mmi.descriptors.AssociationDescriptor, String, com.sap.tc.moin.repository.xm.parser.PModelElementHandle, com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor, String...)}
     * 
     * @param errors
     */
    private void testGetOrCreateModelElement( StringBuilder errors ) {
        ...
        try {
            helper.getOrCreateModelElement( null );
        } catch ( NullPointerException e ) {
            success = true;
        }
        if ( !success ) {
            errors.append( "getOrCreateModelElement(ClassDescriptor) has not thrown an expected NullPointerException\n" );
        }
        success = false;
        try {
            helper.getOrCreateModelElement( null, "test" );
        } catch ( NullPointerException e ) {
            success = true;
        }
        if ( !success ) {
            errors.append( "getOrCreateModelElement has not thrown an expected NullPointerException\n" );
        }
        success = false;

        try {
            helper.getOrCreateModelElement( null, null );
        } catch ( NullPointerException e ) {
            success = true;
        }
        if ( !success ) {
        ...
        success = false;
        try {
            helper.getOrCreateModelElement( LogicalSystem.CLASS_DESCRIPTOR, new String[] {} );
        } catch ( IllegalArgumentException e ) {
            success = true;
        }
        if ( !success ) {
            errors.append( "getOrCreateModelElement has not thrown an expected IllegalArgumentException\n" );
        }
    }
...
/**
    ...
    private void testCreateLinkLogicalKey( StringBuilder errors ) throws XmException {
        ...
        try {
            ...
            // TODO can we change this so that the exception is thrown immediately?
