...
/**
 * Implements <code>com.tssap.util.trace.TracerI</code> and adds <code>entering</code> to allow trace entries with any kind of parameters
 * when a specific method is entered and <code>exiting</code> to allow trace entries with any kind of parameters when a method is exited. To
 * create an instance, use the static method <code>T.racer()</code> from the concrete sub classes <code>com.sap.mi.gfw.util.T</code> or
 * <code>com.sap.mi.gfw.eclipse.T</code> depending on the package you want to trace.
 * 
 * @see com.tssap.util.trace.TracerI
 */
public abstract class AbstractTracer implements TracerI {
	...
	private TracerI t = null;

	public AbstractTracer(String location) {
		t = TracingManager.getTracer(location);
	}
	...
	public void entering(Class clazz, String signature, Object... args) {
		t.info(clazz, signature, createTraceMsg(ENTERING_MSG + signature, args));
	}
	...
	public void exiting(Class clazz, String signature) {
		t.info(clazz, signature, FULL_EXITING_MSG.replaceFirst(SIGNATURE_PATTERN, signature));
	}
	...
	public void exiting(Class clazz, String signature, Object res) {
		...
		t.info(clazz, signature, createTraceMsg(EXITING_MSG + signature, new Object[] { result }));
	}
	...
	public void error(String methodName, String msg) {
		t.error(methodName, msg);
	}

	public void error(String msg, Throwable throwable) {
		t.error(msg, throwable);
	}
	...
	public void info(String className, String methodName, String msg) {
		t.info(className, methodName, msg);
	}
