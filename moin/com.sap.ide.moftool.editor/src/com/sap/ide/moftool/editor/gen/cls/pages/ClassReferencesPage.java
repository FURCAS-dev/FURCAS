...
public class ClassReferencesPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "cls.pages.classReferences"; //$NON-NLS-1$

	public ClassReferencesPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new ClassReferencesPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.ClassReferencesPage_References);
		}
	...
	private class DetailsPageProvider extends ModelDetailsPageProvider {
		...
		public IDetailsPage getPage(Object key) {
			...
			if (com.sap.tc.moin.repository.mmi.model.Reference.class.equals(key)) {
				return new com.sap.ide.moftool.editor.sections.ReferencesSection.DetailsPage(getManagedForm());
			}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeClassReferences();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeClassReferences();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTClassReferences provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTClassReferences();
			provider.init(part);
			return provider;
		}
