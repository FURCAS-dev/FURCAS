...
import com.sap.ide.moftool.editor.tree.tcdt.men.NodeTCDT_NodeClass;
...
public class TreeProviderTreeClassDataTypes extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof MofClass) {
			ITreeNode<?> newNode = new NodeTCDT_NodeClass(inputElement, (MofClass)inputElement);
