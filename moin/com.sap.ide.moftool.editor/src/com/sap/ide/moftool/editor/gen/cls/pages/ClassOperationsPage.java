...
public class ClassOperationsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "cls.pages.classOperations"; //$NON-NLS-1$

	public ClassOperationsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new ClassOperationsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.ClassOperationsPage_Operations);
		}
	...
	private class DetailsPageProvider extends ModelDetailsPageProvider {
		...
		public IDetailsPage getPage(Object key) {
			...
			if (com.sap.tc.moin.repository.mmi.model.Operation.class.equals(key)) {
				return new com.sap.ide.moftool.editor.gen.sections.OperationsSection.DetailsPage(getManagedForm());
			}
		...
		public Object getPageKeyInternal(RefObject object) {
			...
			if (object instanceof com.sap.tc.moin.repository.mmi.model.Operation) {
				return com.sap.tc.moin.repository.mmi.model.Operation.class;
			}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeClassOperations();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeClassOperations();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTClassOperations provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTClassOperations();
			provider.init(part);
			return provider;
		}
