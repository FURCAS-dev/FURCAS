 ...
 * @generated modified
 */
public class ActionActionCreateOutParameterForOperations implements IObjectActionDelegate {
	 ...
	 * @generated
	 */
	private static final TracerI sTracer = TracingManager.getTracer(ActionActionCreateOutParameterForOperations.class);
	 ...
	 * @generated
	 */
	public ActionActionCreateOutParameterForOperations() {
		super();
	}
...

		{
			...
			if (ro instanceof RefBaseObject) {
				...
				MOFToolEditorPlugin.getDefault().getExecMOFToolDefault()
						.execActionCreateOutParameter((BehavioralFeature) rbo);
