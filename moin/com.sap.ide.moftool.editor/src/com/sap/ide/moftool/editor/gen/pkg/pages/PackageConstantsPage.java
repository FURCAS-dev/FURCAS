...
public class PackageConstantsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "pkg.pages.packageConstants"; //$NON-NLS-1$

	public PackageConstantsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new PackageConstantsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.PackageConstantsPage_Constants);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreePackageConstants();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreePackageConstants();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageConstants provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageConstants();
			provider.init(part);
			return provider;
		}
