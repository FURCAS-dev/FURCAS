...
import com.sap.ide.moftool.editor.tree.tce.men.NodeTCE_NodeClass;
...
public class TreeProviderTreeClassExceptions extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof MofClass) {
			ITreeNode<?> newNode = new NodeTCE_NodeClass(inputElement, (MofClass) inputElement);
