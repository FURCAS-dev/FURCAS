...
public class ClassExceptionsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "cls.pages.classExceptions"; //$NON-NLS-1$

	public ClassExceptionsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new ClassExceptionsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.ClassExceptionsPage_Exceptions);
		}
	...
	private class DetailsPageProvider extends ModelDetailsPageProvider {
		...
		public IDetailsPage getPage(Object key) {
			...
			if (com.sap.tc.moin.repository.mmi.model.MofException.class.equals(key)) {
				return new com.sap.ide.moftool.editor.gen.sections.ExceptionsSection.DetailsPage(getManagedForm());
			}

			if (com.sap.tc.moin.repository.mmi.model.Parameter.class.equals(key)) {
				return new com.sap.ide.moftool.editor.gen.sections.ParametersSection.DetailsPage(getManagedForm());
			}
		...
		public Object getPageKeyInternal(RefObject object) {
			...
			if (object instanceof com.sap.tc.moin.repository.mmi.model.MofException) {
				return com.sap.tc.moin.repository.mmi.model.MofException.class;
			}

			if (object instanceof com.sap.tc.moin.repository.mmi.model.Parameter) {
				return com.sap.tc.moin.repository.mmi.model.Parameter.class;
			}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeClassExceptions();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeClassExceptions();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTClassExceptions provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTClassExceptions();
			provider.init(part);
			return provider;
		}
