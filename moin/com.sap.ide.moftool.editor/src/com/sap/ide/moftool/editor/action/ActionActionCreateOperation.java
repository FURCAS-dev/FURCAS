 ...
 * @generated modified
 */
public class ActionActionCreateOperation extends AbstractMoftoolAction<MofClass> {

	public ActionActionCreateOperation(IStructuredSelection selection,
			MofClass inputObject) {
		super(selection, inputObject, Messages.ActionActionCreateOperation_0_xbut, "ACTION_ActionCreateOperation"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public ActionActionCreateOperation() {
	...
	public  void runWithSelection(MofClass inputObject,
			...
			MOFToolEditorPlugin
					...
					.execActionCreateOperation((MofClass) inputObject);
