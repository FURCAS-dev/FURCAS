...
public class TreeProviderTreeClassAttributes extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof MofClass) {
			ITreeNode<?> newNode = new NodeTCA_NodeClass(inputElement, (MofClass)inputElement);
