 ...
 * @generated modified
 */
public class ActionActionCreateConstant extends AbstractMoftoolAction<Namespace> {

	public ActionActionCreateConstant(IStructuredSelection selection,
			Namespace inputObject) {
		super(selection, inputObject, Messages.ActionActionCreateConstant_0_xbut,"ACTION_ActionCreateConstant"); //$NON-NLS-1$
	}

	/**
	 * @generated
	 */
	public ActionActionCreateConstant() {
	...
	public void runWithSelection(Namespace inputObject,
			...
			MOFToolEditorPlugin.getDefault().getExecMOFToolDefault()
					.execActionCreateConstant(inputObject);
