...
public class AddExceptionToOperationCommand extends Command {
	
	private Operation mOperation = null;
	private MofException mException = null;

	public AddExceptionToOperationCommand(Operation operation, MofException exception,
			Connection connection) {
		super(connection, LocalizationMessages.AddExceptionToOperationCommand_0_XMIT);
	...
	public void doExecute() {		
		mOperation.getExceptions().add(mException);
