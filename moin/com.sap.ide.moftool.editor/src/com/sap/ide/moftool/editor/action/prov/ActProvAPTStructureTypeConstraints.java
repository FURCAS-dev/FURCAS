...
import com.sap.ide.moftool.editor.action.ActionActionCreateConstraint;
 ...
 * @generated
 */
public class ActProvAPTStructureTypeConstraints extends AbstractActionProvider {

	@Override
	protected void createActionsInternal(ActionContext context) {
		addToContextMenu(new ActionActionCreateConstraint((IStructuredSelection) context.getSelection(), (Namespace) context
				.getInput()));
