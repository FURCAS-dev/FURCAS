 ...
 * @generated modified
 */
public class ActionActionCreateInParameterForOperations implements IObjectActionDelegate {

	// this is the suggested pattern, but the variable may be moved to the plugin in the future for GC-reasons.
	/**
	 * @generated
	 */
	private static final TracerI sTracer = TracingManager.getTracer(ActionActionCreateInParameterForOperations.class);
	 ...
	 * @generated
	 */
	public ActionActionCreateInParameterForOperations() {
		super();
	}
	...
	public static void runWithContext(IWorkbenchPart part, IAction action, ISelection selection) {
...

		{
			...
			if (ro instanceof RefBaseObject) {
				...
				MOFToolEditorPlugin.getDefault().getExecMOFToolDefault().execActionCreateInParameter(
						(BehavioralFeature) rbo);
