...
public class PackageImportsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "pkg.pages.packageImports"; //$NON-NLS-1$

	public PackageImportsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new PackageImportsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.PackageImportsPage_Imports);
		}
	...
	private class DetailsPageProvider extends ModelDetailsPageProvider {
		...
		public IDetailsPage getPage(Object key) {
			...
			if (com.sap.tc.moin.repository.mmi.model.Import.class.equals(key)) {
				return new com.sap.ide.moftool.editor.gen.sections.ImportSection.DetailsPage(getManagedForm());
			}
		...
		public Object getPageKeyInternal(RefObject object) {
			...
			if (object instanceof com.sap.tc.moin.repository.mmi.model.Import) {
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreePackageImports();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreePackageImports();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageImports provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageImports();
			provider.init(part);
			return provider;
		}
