...
public class TreeProviderTreePackageTags extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof MofPackage) {
			ITreeNode<?> newNode = new NodeTPT_NodePackage(inputElement, (MofPackage) inputElement);
