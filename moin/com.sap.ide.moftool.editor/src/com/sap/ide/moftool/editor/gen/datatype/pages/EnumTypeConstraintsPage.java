...
public class EnumTypeConstraintsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "datatype.pages.enumTypeConstraints"; //$NON-NLS-1$

	public EnumTypeConstraintsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new EnumTypeConstraintsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.EnumTypeConstraintsPage_Constraints);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeEnumTypeConstraints();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeEnumTypeConstraints();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTEnumTypeConstraints provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTEnumTypeConstraints();
			provider.init(part);
			return provider;
		}
