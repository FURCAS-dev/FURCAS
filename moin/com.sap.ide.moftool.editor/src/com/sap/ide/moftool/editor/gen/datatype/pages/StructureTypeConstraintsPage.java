...
public class StructureTypeConstraintsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "datatype.pages.structureTypeConstraints"; //$NON-NLS-1$

	public StructureTypeConstraintsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new StructureTypeConstraintsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.StructureTypeConstraintsPage_Constraints);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeStructureTypeConstraints();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeStructureTypeConstraints();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTStructureTypeConstraints provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTStructureTypeConstraints();
			provider.init(part);
			return provider;
		}
