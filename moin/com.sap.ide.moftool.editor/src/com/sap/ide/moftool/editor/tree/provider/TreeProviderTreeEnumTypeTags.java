...
import com.sap.ide.moftool.editor.tree.tett.men.NodeTETT_NodeEnumType;
...
public class TreeProviderTreeEnumTypeTags extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof EnumerationType) {
			ITreeNode<?> newNode = new NodeTETT_NodeEnumType(inputElement, (EnumerationType)inputElement);
