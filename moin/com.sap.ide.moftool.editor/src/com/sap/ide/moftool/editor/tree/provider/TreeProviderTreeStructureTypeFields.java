...
import com.sap.ide.moftool.editor.tree.tstf.men.NodeTSTF_NodeStructureType;
...
public class TreeProviderTreeStructureTypeFields extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof StructureType) {
			ITreeNode<?> newNode = new NodeTSTF_NodeStructureType(inputElement, (StructureType)inputElement);
