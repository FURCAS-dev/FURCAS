...
import com.sap.ide.moftool.editor.tree.tcr.men.NodeTCR_NodeClass;
...
public class TreeProviderTreeClassReferences extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof MofClass) {
			ITreeNode<?> newNode = new NodeTCR_NodeClass(inputElement, (MofClass)inputElement);
