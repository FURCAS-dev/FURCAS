...
public class PackageTagsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "pkg.pages.packageTags"; //$NON-NLS-1$

	public PackageTagsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new PackageTagsPage.TreeSectionImpl(getPage(), parent, managedForm, Messages.PackageTagsPage_Tags);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreePackageTags();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreePackageTags();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageTags provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageTags();
			provider.init(part);
			return provider;
		}
