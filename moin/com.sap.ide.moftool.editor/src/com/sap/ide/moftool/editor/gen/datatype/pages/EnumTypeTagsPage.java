...
public class EnumTypeTagsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "datatype.pages.enumTypeTags"; //$NON-NLS-1$

	public EnumTypeTagsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new EnumTypeTagsPage.TreeSectionImpl(getPage(), parent, managedForm, Messages.EnumTypeTagsPage_Tags);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeEnumTypeTags();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeEnumTypeTags();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTEnumTypeTags provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTEnumTypeTags();
			provider.init(part);
			return provider;
		}
