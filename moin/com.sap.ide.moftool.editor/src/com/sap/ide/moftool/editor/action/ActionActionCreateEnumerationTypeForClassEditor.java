 ...
 * @generated modified
 */
public class ActionActionCreateEnumerationTypeForClassEditor extends AbstractMoftoolAction<MofClass> {

	public ActionActionCreateEnumerationTypeForClassEditor(IStructuredSelection selection, MofClass inputObject) {
		super(selection, inputObject, Messages.ActionActionCreateEnumerationTypeForClassEditor_0_xbut,
				"ACTION_ActionCreateEnumerationTypeForClassEditor"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public ActionActionCreateEnumerationTypeForClassEditor() {
	...
	public void runWithSelection(MofClass inputObject, IStructuredSelection structuredSelection) {
		...
		MOFToolEditorPlugin.getDefault().getExecMOFToolDefault().execActionCreateEnumerationTypeForClassEditor(
