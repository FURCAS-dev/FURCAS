 ...
 * @generated modified
 */
public class ActionActionCreateAttribute extends AbstractMoftoolAction<MofClass> {

	public ActionActionCreateAttribute(IStructuredSelection selection, MofClass inputObject) {
		super(selection, inputObject, Messages.ActionActionCreateAttribute_0_xbut, "ACTION_ActionCreateAttribute"); //$NON-NLS-1$
	}

	public ActionActionCreateAttribute() {
	...
	public void runWithSelection(MofClass inputObject, IStructuredSelection structuredSelection) {
		MOFToolEditorPlugin.getDefault().getExecMOFToolDefault().execActionCreateAttribute(inputObject);
	}
}
