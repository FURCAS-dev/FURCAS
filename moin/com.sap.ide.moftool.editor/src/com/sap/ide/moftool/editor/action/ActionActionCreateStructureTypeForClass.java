 ...
 * @generated
 */
public class ActionActionCreateStructureTypeForClass extends AbstractFilteredMoftoolAction<MofClass> {

	private static AbstractFilteredMoftoolAction<MofClass> actionActionCreateStructureTypeForClass = new ActionActionCreateStructureTypeForClass();

	/**
	 * @generated
	 */
	public ActionActionCreateStructureTypeForClass() {
	 ...
	 * @generated
	 */
	public ActionActionCreateStructureTypeForClass(IStructuredSelection selection) {

		super(selection, Messages.ActionActionCreateStructureTypeForClass_0_xbut, MOFToolEditorPlugin.getDefault()
				.getImageDescriptor("ACTION_ActionCreateStructureTypeForClass")); //$NON-NLS-1$
	...
	public void runSingleWithContext(MofClass context) {
		...
		MOFToolEditorPlugin.getDefault().getExecMOFToolDefault().execActionCreateStructureTypeForClass(context);
	...
	public static IAction createActionForSelection(IStructuredSelection selection) {
		if (!actionActionCreateStructureTypeForClass.visibleForSelection(selection)) {
			return null;
		}
		return new ActionActionCreateStructureTypeForClass(selection);
	}
