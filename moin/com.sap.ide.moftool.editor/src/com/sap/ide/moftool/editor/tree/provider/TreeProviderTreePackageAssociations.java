...
public class TreeProviderTreePackageAssociations extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof MofPackage) {
			ITreeNode<?> newNode = new NodeTPA_NodePackage(inputElement, (MofPackage) inputElement);
