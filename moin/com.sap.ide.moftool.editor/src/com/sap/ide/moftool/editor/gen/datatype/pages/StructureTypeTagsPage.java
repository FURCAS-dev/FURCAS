...
public class StructureTypeTagsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "datatype.pages.structureTypeTags"; //$NON-NLS-1$

	public StructureTypeTagsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new StructureTypeTagsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.StructureTypeTagsPage_Tags);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeStructureTypeTags();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeStructureTypeTags();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTStructureTypeTags provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTStructureTypeTags();
			provider.init(part);
			return provider;
		}
