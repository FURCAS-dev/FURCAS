 ...
 * @generated modified
 */
public class ActionActionCreateConstraintForAssociation implements IObjectActionDelegate {
	 ...
	 * @generated
	 */
	private static final TracerI sTracer = TracingManager.getTracer(ActionActionCreateConstraintForAssociation.class);
	 ...
	 * @generated
	 */
	public ActionActionCreateConstraintForAssociation() {
		super();
	}
...

		{
			...
			if (ro instanceof RefBaseObject) {
				...
				MOFToolEditorPlugin.getDefault().getExecMOFToolDefault()
						.execActionCreateConstraintForAssociation((Association) rbo);
