...
public class PackageConstraintsPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "pkg.pages.packageConstraints"; //$NON-NLS-1$

	public PackageConstraintsPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new PackageConstraintsPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.PackageConstraintsPage_Constraints);
		}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreePackageConstraints();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreePackageConstraints();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageConstraints provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTPackageConstraints();
			provider.init(part);
			return provider;
		}
