...
import com.sap.ide.moftool.editor.action.ActionActionCreateImport;
 ...
 * @generated
 */
public class ActProvAPTPackageImports extends AbstractActionProvider {

	@Override
	protected void createActionsInternal(ActionContext context) {
		addToContextMenu(new ActionActionCreateImport((IStructuredSelection) context.getSelection(), (MofPackage) context
				.getInput()));		
	}
