...
import com.sap.ide.moftool.editor.tree.tpc.men.NodeTPC_NodePackage;
...
public class TreeProviderTreePackageConstraints extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof MofPackage) {
			ITreeNode<?> newNode = new NodeTPC_NodePackage(inputElement, (MofPackage) inputElement);
