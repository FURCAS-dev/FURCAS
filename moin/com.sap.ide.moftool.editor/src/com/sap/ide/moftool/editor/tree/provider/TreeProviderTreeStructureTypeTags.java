...
import com.sap.ide.moftool.editor.tree.tstt.men.NodeTSTT_NodeStructureType;
...
public class TreeProviderTreeStructureTypeTags extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof StructureType) {
			ITreeNode<?> newNode = new NodeTSTT_NodeStructureType(inputElement, (StructureType)inputElement);
