...
import com.sap.ide.moftool.editor.tree.tpi.men.NodeTPI_NodePackage;
...
public class TreeProviderTreePackageImports extends TreeNodeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof MofPackage) {
			ITreeNode<?> newNode = new NodeTPI_NodePackage(inputElement, (MofPackage) inputElement);
