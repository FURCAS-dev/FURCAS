 ...
 * @generated modified
 */
public class NodeTCA_NodeAttribute extends TreeNodeRefObject<Attribute> implements IThisTreeNode {

	/**
	 * @modified
	 */
	public NodeTCA_NodeAttribute(Attribute modelElement) {
		super(modelElement);
	 ...
	 * @modified
	 */
	public NodeTCA_NodeAttribute(Object parent, Attribute modelElement) {
