 ...
 * @generated modified
 */
public class NodeTCO_NodeInOutParameter extends TreeNodeRefObject<Parameter> implements IThisTreeNode {

	/**
	 * @modified
	 */
	public NodeTCO_NodeInOutParameter(Parameter modelElement) {
		super(modelElement);
		//initialize the parent for this node using the method setParent(Object) 		
		setParent(new NodeTCO_NodeInOutParameters((Operation)modelElement.getContainer()));
	}

	/**
	 * @modified
	 */
	public NodeTCO_NodeInOutParameter(Object parent, Parameter modelElement) {
