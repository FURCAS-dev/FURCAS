 ...
 * @generated modified
 */
public class ActionActionCreateTag extends AbstractMoftoolAction<Namespace> {

	public ActionActionCreateTag(IStructuredSelection selection, Namespace inputObject) {
		super(selection, inputObject, Messages.ActionActionCreateTag_0_xbut, "ACTION_ActionCreateTag"); //$NON-NLS-1$
	}

	/**
	 * @generated
	 */
	public ActionActionCreateTag() {
		this(StructuredSelection.EMPTY, null);
	}

	public void runWithSelection(Namespace inputObject, IStructuredSelection structuredSelection) {

		MOFToolEditorPlugin.getDefault().getExecMOFToolDefault().execActionCreateTag((Namespace) inputObject);
