package com.sap.ide.moftool.editor.gen.datatype.structuretype.pages;
...
public class StructureFieldPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "datatype.structuretype.pages.structureField"; //$NON-NLS-1$

	public StructureFieldPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new StructureFieldPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.StructureFieldPage_StructureField);
		}
	...
	private class DetailsPageProvider extends ModelDetailsPageProvider {
		...
		public IDetailsPage getPage(Object key) {
			...
			if (com.sap.tc.moin.repository.mmi.model.StructureField.class.equals(key)) {
				return new com.sap.ide.moftool.editor.gen.sections.StructureFieldSection.DetailsPage(getManagedForm());
			}
		...
		public Object getPageKeyInternal(RefObject object) {
			...
			if (object instanceof com.sap.tc.moin.repository.mmi.model.StructureField) {
				return com.sap.tc.moin.repository.mmi.model.StructureField.class;
			}
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeStructureTypeFields();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeStructureTypeFields();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTStructureTypeFields provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTStructureTypeFields();
			provider.init(part);
			return provider;
		}
