...
public class ClassAttributesPage extends TableLayoutedModelFormMasterDetailPage {

	private static final String ID = "cls.pages.classAttributes"; //$NON-NLS-1$

	public ClassAttributesPage(FormEditor editor, String title) {
	...
	private class MasterDetailPart extends ModelMasterDetailBlock {
		...
		protected SectionPart createMasterPartInternal(Composite parent, IManagedForm managedForm) {
			return new ClassAttributesPage.TreeSectionImpl(getPage(), parent, managedForm,
					Messages.ClassAttributesPage_Attributes);
		}
	...
	private class DetailsPageProvider extends ModelDetailsPageProvider {
		...
		public IDetailsPage getPage(Object key) {
			...
			if (com.sap.tc.moin.repository.mmi.model.Attribute.class.equals(key)) {
				return new com.sap.ide.moftool.editor.gen.sections.AttributeSection.DetailsPage(getManagedForm());
			}
		...
		public Object getPageKeyInternal(RefObject object) {
			...
			if (object instanceof com.sap.tc.moin.repository.mmi.model.Attribute) {
	...
	private class TreeSectionImpl extends TreeSection {
		...
		protected IBaseLabelProvider createLabelProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeLabelProviderTreeClassAttributes();
		}

		protected ITreeContentProvider createContentProvider() {
			return new com.sap.ide.moftool.editor.tree.provider.TreeProviderTreeClassAttributes();
		}

		protected org.eclipse.ui.actions.ActionGroup getActionProvider(IWorkbenchPart part) {
			com.sap.ide.moftool.editor.action.prov.ActProvAPTClassAttributes provider = new com.sap.ide.moftool.editor.action.prov.ActProvAPTClassAttributes();
			provider.init(part);
			return provider;
		}
