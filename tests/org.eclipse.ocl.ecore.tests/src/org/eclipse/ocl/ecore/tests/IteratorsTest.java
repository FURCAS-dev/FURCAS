 ...
 * </copyright>
 *
 * $Id: IteratorsTest.java,v 1.1 2007/01/25 18:32:35 cdamus Exp $
 */
...
public class IteratorsTest
    ...
    public void test_invalidMultipleIteratorVariables() {
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->exists(e1, e2, e3 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->forAll(e1, e2, e3 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->collect(e1, e2 |" + //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->any(e1, e2 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->one(e1, e2 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->select(e1, e2 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->reject(e1, e2 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
        ...
        try {
            helper.createQuery(
                "Sequence{'a', 'b', 'c'}->isUnique(e1, e2 |" + //$NON-NLS-1$
                " e1 = e2)"); //$NON-NLS-1$
