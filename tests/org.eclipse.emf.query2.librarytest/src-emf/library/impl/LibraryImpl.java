 ...
 * </copyright>
 *
 * $Id: LibraryImpl.java,v 1.1 2009/10/08 15:02:51 bkolb Exp $
 */
...
public class LibraryImpl extends EObjectImpl implements Library {
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.LIBRARY__LOCATION, oldLocation, location));
	}
