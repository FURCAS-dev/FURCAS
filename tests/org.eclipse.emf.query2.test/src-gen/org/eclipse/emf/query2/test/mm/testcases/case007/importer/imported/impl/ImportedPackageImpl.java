...
import org.eclipse.emf.query2.test.mm.testcases.case007.importer.imported.ImportedFactory;
 ...
 * @generated
 */
public class ImportedPackageImpl extends EPackageImpl implements ImportedPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass importedAEClass = null;
	 ...
	 * @generated
	 */
	private EClass importedBEClass = null;
	 ...
	 * @generated
	 */
	private EClass importedAReferencesImportedBEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case007.importer.imported.ImportedPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ImportedPackageImpl() {
		super(eNS_URI, ImportedFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ImportedPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ImportedPackage init() {
		if (isInited) return (ImportedPackage)EPackage.Registry.INSTANCE.getEPackage(ImportedPackage.eNS_URI);

		// Obtain or create and register package
		ImportedPackageImpl theImportedPackage = (ImportedPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ImportedPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ImportedPackageImpl());
		...
		theImportedPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ImportedPackage.eNS_URI, theImportedPackage);
		return theImportedPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getImportedA() {
		return importedAEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getImportedB() {
		return importedBEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getImportedAReferencesImportedB() {
		return importedAReferencesImportedBEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getImportedAReferencesImportedB_ImportedB() {
		return (EReference)importedAReferencesImportedBEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getImportedAReferencesImportedB_ImportedA() {
		return (EReference)importedAReferencesImportedBEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public ImportedFactory getImportedFactory() {
		return (ImportedFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		importedAEClass = createEClass(IMPORTED_A);

		importedBEClass = createEClass(IMPORTED_B);

		importedAReferencesImportedBEClass = createEClass(IMPORTED_AREFERENCES_IMPORTED_B);
		createEReference(importedAReferencesImportedBEClass, IMPORTED_AREFERENCES_IMPORTED_B__IMPORTED_B);
		createEReference(importedAReferencesImportedBEClass, IMPORTED_AREFERENCES_IMPORTED_B__IMPORTED_A);
	}
