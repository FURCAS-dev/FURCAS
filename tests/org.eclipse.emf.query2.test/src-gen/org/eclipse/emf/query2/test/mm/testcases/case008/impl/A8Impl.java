...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>A8</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case008.impl.A8Impl#getOneEnumerationE <em>One Enumeration E</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case008.impl.A8Impl#getOneStructureS <em>One Structure S</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case008.impl.A8Impl#getOneStructureT <em>One Structure T</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case008.impl.A8Impl#getOneStructureV <em>One Structure V</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case008.impl.A8Impl#getManyEnumerationE <em>Many Enumeration E</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case008.impl.A8Impl#getManyStructureS <em>Many Structure S</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class A8Impl extends EObjectImpl implements A8 {
	/**
	...
	protected EClass eStaticClass() {
		return Case008Package.Literals.A8;
	}
	...
	public void setOneEnumerationE(E8 newOneEnumerationE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_ENUMERATION_E, oldOneEnumerationE, oneEnumerationE));
	}
	...
	public S8 getOneStructureS() {
		if (oneStructureS != null && oneStructureS.eIsProxy()) {
			...
			if (oneStructureS != oldOneStructureS) {
				...
				NotificationChain msgs = oldOneStructureS.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_S, null, null);
				if (newOneStructureS.eInternalContainer() == null) {
					msgs = newOneStructureS.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_S, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Case008Package.A8__ONE_STRUCTURE_S, oldOneStructureS, oneStructureS));
			}
		}
	...
	public NotificationChain basicSetOneStructureS(S8 newOneStructureS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_STRUCTURE_S, oldOneStructureS, newOneStructureS);
	...
	public void setOneStructureS(S8 newOneStructureS) {
		if (newOneStructureS != oneStructureS) {
			...
			if (oneStructureS != null)
				msgs = ((InternalEObject)oneStructureS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_S, null, msgs);
			if (newOneStructureS != null)
				msgs = ((InternalEObject)newOneStructureS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_S, null, msgs);
			msgs = basicSetOneStructureS(newOneStructureS, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_STRUCTURE_S, newOneStructureS, newOneStructureS));
	}
	...
	public T8 getOneStructureT() {
		if (oneStructureT != null && oneStructureT.eIsProxy()) {
			...
			if (oneStructureT != oldOneStructureT) {
				...
				NotificationChain msgs = oldOneStructureT.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_T, null, null);
				if (newOneStructureT.eInternalContainer() == null) {
					msgs = newOneStructureT.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_T, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Case008Package.A8__ONE_STRUCTURE_T, oldOneStructureT, oneStructureT));
			}
		}
	...
	public NotificationChain basicSetOneStructureT(T8 newOneStructureT, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_STRUCTURE_T, oldOneStructureT, newOneStructureT);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOneStructureT(T8 newOneStructureT) {
		if (newOneStructureT != oneStructureT) {
			...
			if (oneStructureT != null)
				msgs = ((InternalEObject)oneStructureT).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_T, null, msgs);
			if (newOneStructureT != null)
				msgs = ((InternalEObject)newOneStructureT).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_T, null, msgs);
			msgs = basicSetOneStructureT(newOneStructureT, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_STRUCTURE_T, newOneStructureT, newOneStructureT));
	}
	...
	public V8 getOneStructureV() {
		if (oneStructureV != null && oneStructureV.eIsProxy()) {
			...
			if (oneStructureV != oldOneStructureV) {
				...
				NotificationChain msgs = oldOneStructureV.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_V, null, null);
				if (newOneStructureV.eInternalContainer() == null) {
					msgs = newOneStructureV.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_V, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Case008Package.A8__ONE_STRUCTURE_V, oldOneStructureV, oneStructureV));
			}
		}
	...
	public NotificationChain basicSetOneStructureV(V8 newOneStructureV, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_STRUCTURE_V, oldOneStructureV, newOneStructureV);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOneStructureV(V8 newOneStructureV) {
		if (newOneStructureV != oneStructureV) {
			...
			if (oneStructureV != null)
				msgs = ((InternalEObject)oneStructureV).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_V, null, msgs);
			if (newOneStructureV != null)
				msgs = ((InternalEObject)newOneStructureV).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Case008Package.A8__ONE_STRUCTURE_V, null, msgs);
			msgs = basicSetOneStructureV(newOneStructureV, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Case008Package.A8__ONE_STRUCTURE_V, newOneStructureV, newOneStructureV));
	}
	...
	public EList<E8> getManyEnumerationE() {
		if (manyEnumerationE == null) {
			manyEnumerationE = new EDataTypeEList<E8>(E8.class, this, Case008Package.A8__MANY_ENUMERATION_E);
		}
	...
	public EList<S8> getManyStructureS() {
		if (manyStructureS == null) {
			manyStructureS = new EObjectContainmentEList.Resolving<S8>(S8.class, this, Case008Package.A8__MANY_STRUCTURE_S);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Case008Package.A8__ONE_STRUCTURE_S:
				return basicSetOneStructureS(null, msgs);
			case Case008Package.A8__ONE_STRUCTURE_T:
				return basicSetOneStructureT(null, msgs);
			case Case008Package.A8__ONE_STRUCTURE_V:
				return basicSetOneStructureV(null, msgs);
			case Case008Package.A8__MANY_STRUCTURE_S:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Case008Package.A8__ONE_ENUMERATION_E:
			...
			case Case008Package.A8__MANY_ENUMERATION_E:
