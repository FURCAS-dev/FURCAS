...
import org.eclipse.emf.query2.test.mm.testcases.case009.Case009Factory;
import org.eclipse.emf.query2.test.mm.testcases.case009.Case009Package;
import org.eclipse.emf.query2.test.mm.testcases.case009.ClassThrowsException;
 ...
 * @generated
 */
public class Case009PackageImpl extends EPackageImpl implements Case009Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass classThrowsExceptionEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case009.Case009Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case009PackageImpl() {
		super(eNS_URI, Case009Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case009Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case009Package init() {
		if (isInited) return (Case009Package)EPackage.Registry.INSTANCE.getEPackage(Case009Package.eNS_URI);

		// Obtain or create and register package
		Case009PackageImpl theCase009Package = (Case009PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case009PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case009PackageImpl());
		...
		theCase009Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case009Package.eNS_URI, theCase009Package);
		return theCase009Package;
	}
	 ...
	 * @generated
	 */
	public EClass getClassThrowsException() {
		return classThrowsExceptionEClass;
	}
	 ...
	 * @generated
	 */
	public Case009Factory getCase009Factory() {
		return (Case009Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		classThrowsExceptionEClass = createEClass(CLASS_THROWS_EXCEPTION);
