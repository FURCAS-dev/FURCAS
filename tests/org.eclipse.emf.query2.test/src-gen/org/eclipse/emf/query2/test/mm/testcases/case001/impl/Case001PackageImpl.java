...
import org.eclipse.emf.query2.test.mm.testcases.case001.Super;
 ...
 * @generated
 */
public class Case001PackageImpl extends EPackageImpl implements Case001Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass aReferencesBEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case001.Case001Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case001PackageImpl() {
		super(eNS_URI, Case001Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case001Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case001Package init() {
		if (isInited) return (Case001Package)EPackage.Registry.INSTANCE.getEPackage(Case001Package.eNS_URI);

		// Obtain or create and register package
		Case001PackageImpl theCase001Package = (Case001PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case001PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case001PackageImpl());
		...
		theCase001Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case001Package.eNS_URI, theCase001Package);
		return theCase001Package;
	}
	 ...
	 * @generated
	 */
	public EClass getAReferencesB() {
		return aReferencesBEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAReferencesB_B() {
		return (EReference)aReferencesBEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAReferencesB_A() {
		return (EReference)aReferencesBEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case001Factory getCase001Factory() {
		return (Case001Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(a1EClass, A1__BS);

		b1EClass = createEClass(B1);

		superEClass = createEClass(SUPER);

		aReferencesBEClass = createEClass(AREFERENCES_B);
		createEReference(aReferencesBEClass, AREFERENCES_B__B);
		createEReference(aReferencesBEClass, AREFERENCES_B__A);
	}
