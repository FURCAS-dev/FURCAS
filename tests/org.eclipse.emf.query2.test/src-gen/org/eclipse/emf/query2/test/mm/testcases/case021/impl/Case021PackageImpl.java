 ...
 *******************************************************************************/
package org.eclipse.emf.query2.test.mm.testcases.case021.impl;
...
import org.eclipse.emf.query2.test.mm.testcases.case021.A21Abstract;
import org.eclipse.emf.query2.test.mm.testcases.case021.Case021Factory;
 ...
 * @generated
 */
public class Case021PackageImpl extends EPackageImpl implements Case021Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a21AbstractEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case021.Case021Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case021PackageImpl() {
		super(eNS_URI, Case021Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case021Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case021Package init() {
		if (isInited) return (Case021Package)EPackage.Registry.INSTANCE.getEPackage(Case021Package.eNS_URI);

		// Obtain or create and register package
		Case021PackageImpl theCase021Package = (Case021PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case021PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case021PackageImpl());
		...
		theCase021Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case021Package.eNS_URI, theCase021Package);
		return theCase021Package;
	}
	 ...
	 * @generated
	 */
	public EClass getA21Abstract() {
		return a21AbstractEClass;
	}
	 ...
	 * @generated
	 */
	public Case021Factory getCase021Factory() {
		return (Case021Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a21AbstractEClass = createEClass(A21_ABSTRACT);
	}
