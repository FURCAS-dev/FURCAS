...
import org.eclipse.emf.query2.test.mm.testcases.case005.p3.P3Factory;
 ...
 * @generated
 */
public class P3PackageImpl extends EPackageImpl implements P3Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass c5EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case005.p3.P3Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private P3PackageImpl() {
		super(eNS_URI, P3Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link P3Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static P3Package init() {
		if (isInited) return (P3Package)EPackage.Registry.INSTANCE.getEPackage(P3Package.eNS_URI);

		// Obtain or create and register package
		P3PackageImpl theP3Package = (P3PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof P3PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new P3PackageImpl());
		...
		EPackage.Registry.INSTANCE.put(P3Package.eNS_URI, theP3Package);
		return theP3Package;
	}
	 ...
	 * @generated
	 */
	public P3Factory getP3Factory() {
		return (P3Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		P4Package theP4Package = (P4Package)EPackage.Registry.INSTANCE.getEPackage(P4Package.eNS_URI);
		P2Package theP2Package = (P2Package)EPackage.Registry.INSTANCE.getEPackage(P2Package.eNS_URI);

		// Add subpackages
		getESubpackages().add(theP4Package);
