...
import org.eclipse.emf.query2.test.mm.testcases.case005.p1.P1Factory;
 ...
 * @generated
 */
public class P1PackageImpl extends EPackageImpl implements P1Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case005.p1.P1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private P1PackageImpl() {
		super(eNS_URI, P1Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link P1Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static P1Package init() {
		if (isInited) return (P1Package)EPackage.Registry.INSTANCE.getEPackage(P1Package.eNS_URI);

		// Obtain or create and register package
		P1PackageImpl theP1Package = (P1PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof P1PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new P1PackageImpl());
		...
		EPackage.Registry.INSTANCE.put(P1Package.eNS_URI, theP1Package);
		return theP1Package;
	}
	 ...
	 * @generated
	 */
	public EReference getA5_X() {
		return (EReference)a5EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public P1Factory getP1Factory() {
		return (P1Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(a5EClass, A5__X);
	}
