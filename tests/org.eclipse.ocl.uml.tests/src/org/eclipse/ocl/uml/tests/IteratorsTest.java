 ...
 * </copyright>
 *
 * $Id: IteratorsTest.java,v 1.1 2007/01/25 18:41:55 cdamus Exp $
 */
...
public class IteratorsTest
	...
	public void test_closure_cycles() {
		...
		Property nestedPackage = packageMetaclass.getAttribute("nestedPackage", packageMetaclass); //$NON-NLS-1$
		Property nestingPackage = packageMetaclass.getAttribute("nestingPackage", packageMetaclass); //$NON-NLS-1$
