 ...
 * </copyright>
 *
 * $Id: ProfilesTest.java,v 1.1 2007/01/25 18:41:55 cdamus Exp $
 */
...
public class ProfilesTest
	...
	public void test_parseStereotypeConstraint() {
		...
		try {
			Constraint constraint = helper.createInvariant(
					"base_Classifier.name = 'Fruit' implies" + //$NON-NLS-1$
	...
	private static void initTestProfile() {
		...
		URI uri = res.getURI().trimSegments(1).appendSegment("OCLTest.profile.uml"); //$NON-NLS-1$
