...
public class RunletHTTPHandler implements HttpHandler, Executor {
    ...
    public RunletHTTPHandler(RunletInterpreter theInterpreter) {
	...
	try {
	    ...
	    RunletInterpreter requestInterpreter = interpreter.spawn();
	    ...
	    // Invoke function
	    RunletObject<AssociationEnd, TypeDefinition, ClassTypeDefinition> result = callTarget.evaluate(requestInterpreter);
	    // Marshall response
	...
	for (Parameter parameter : formalParameters) {
	    ...
	    RunletObject<AssociationEnd, TypeDefinition, ClassTypeDefinition> nativeObject = null;
