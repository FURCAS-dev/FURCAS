...
public final class LandscapePackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    // constructors    
    public LandscapePackageImpl()
    {
        super();
    }
    public LandscapePackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<deployment.landscape.__impl.LandscapePackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new deployment.landscape.__impl.LandscapePackageWrapper(conn, this, synchronize);
    }
