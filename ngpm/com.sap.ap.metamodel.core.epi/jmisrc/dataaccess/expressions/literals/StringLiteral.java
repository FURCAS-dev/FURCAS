 ...
 */
public interface StringLiteral extends dataaccess.expressions.literals.Literal {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.literals.StringLiteral> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.literals.StringLiteral>("E075D95551F05DEC3E4B11DE81280018DE1146FF", "sap.com/moin/mm/ap/core", "dataaccess", "expressions", "literals", "StringLiteral"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
