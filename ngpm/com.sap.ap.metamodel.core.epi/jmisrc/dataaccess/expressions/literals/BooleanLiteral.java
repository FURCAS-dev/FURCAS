 ...
 */
public interface BooleanLiteral extends dataaccess.expressions.literals.Literal {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.literals.BooleanLiteral> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.literals.BooleanLiteral>("E075D95551F05DEF3E4B11DE9E310018DE1146FF", "sap.com/moin/mm/ap/core", "dataaccess", "expressions", "literals", "BooleanLiteral"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,dataaccess.expressions.literals.Literal,java.lang.String> LITERAL( ) {
            return dataaccess.expressions.literals.Literal.DESCRIPTORS.LITERAL( );
        }
        /**
