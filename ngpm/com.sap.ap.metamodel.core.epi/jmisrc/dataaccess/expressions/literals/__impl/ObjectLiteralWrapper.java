...
public class ObjectLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.literals.__impl.ObjectLiteralImpl> implements dataaccess.expressions.literals.ObjectLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public ObjectLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.literals.__impl.ObjectLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.literals.__impl.ObjectLiteralImpl getCastWrappedObject() {
        return (dataaccess.expressions.literals.__impl.ObjectLiteralImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.literals.__impl.ObjectLiteralImpl unwrap() {
        return (dataaccess.expressions.literals.__impl.ObjectLiteralImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.SapClass) wrapResult(getCastWrappedObject().getValueClass(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setValueClass(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<dataaccess.expressions.literals.ValueInit>) wrapResult(getCastWrappedObject().getPropertyValues(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public boolean isEqualTo(dataaccess.expressions.literals.ObjectLiteral o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            parameterList.add(o);
            return (java.lang.Boolean)___invokeOperation(connection, 4, "E075D955CB4A2DA2413211DEACB500155883529C", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private boolean invoke__isEqualTo(com.sap.tc.moin.repository.core.CoreConnection connection, dataaccess.expressions.literals.ObjectLiteral o) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            // delegating to the OCL service org.omg.sap2mof.OperationCodeOcl
            java.util.Map operationParameters = new java.util.HashMap();
            operationParameters.put("o", unwrapArg(o));
            return ((java.lang.Boolean)wrapResult(connection.getSession().getOclService().evaluateOclBodyExpression(connection, "isEqualTo", getCastWrappedObject( ), operationParameters))).booleanValue();
            // end of implementation provided in tag org.omg.sap2mof.OperationCodeOcl
        } catch(com.sap.tc.moin.repository.exception.MoinBaseException ex) {
                throw new com.sap.tc.moin.repository.mmi.reflect.JmiException(ex);
        }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 4:
                return ___invokeOperation( connection, operationId, "E075D955CB4A2DA2413211DEACB500155883529C", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 4:
                return invoke__isEqualTo(connection, (dataaccess.expressions.literals.ObjectLiteral) args.get(0));    
            default:
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.literals.ObjectLiteral (Java Type)\ndataaccess.expressions.literals.ObjectLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}