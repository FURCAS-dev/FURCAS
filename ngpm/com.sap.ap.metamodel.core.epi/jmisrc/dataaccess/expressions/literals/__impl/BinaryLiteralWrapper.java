...
public class BinaryLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.literals.__impl.BinaryLiteralImpl> implements dataaccess.expressions.literals.BinaryLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public BinaryLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.literals.__impl.BinaryLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.literals.__impl.BinaryLiteralImpl getCastWrappedObject() {
        return (dataaccess.expressions.literals.__impl.BinaryLiteralImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.literals.__impl.BinaryLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.literals.__impl.BinaryLiteralImpl) resolved;
    }
    
    public dataaccess.expressions.literals.__impl.BinaryLiteralImpl unwrap() {
        return (dataaccess.expressions.literals.__impl.BinaryLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.literals.BinaryLiteral (Java Type)\ndataaccess.expressions.literals.BinaryLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}