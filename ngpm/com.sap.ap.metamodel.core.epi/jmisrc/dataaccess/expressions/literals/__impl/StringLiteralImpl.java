...
public final class StringLiteralImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<dataaccess.expressions.literals.__impl.StringLiteralImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new dataaccess.expressions.literals.__impl.StringLiteralWrapper(conn, this, synchronize);
    }
