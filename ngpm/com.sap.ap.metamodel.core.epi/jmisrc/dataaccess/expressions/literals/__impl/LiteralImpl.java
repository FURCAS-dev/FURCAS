...
public final class LiteralImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    public java.lang.Class<dataaccess.expressions.literals.Literal> get___JmiInterface() {
        return dataaccess.expressions.literals.Literal.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<dataaccess.expressions.literals.__impl.LiteralImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new dataaccess.expressions.literals.__impl.LiteralWrapper(conn, this, synchronize);
    }
