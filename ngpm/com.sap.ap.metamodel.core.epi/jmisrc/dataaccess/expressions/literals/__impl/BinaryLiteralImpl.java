...
public final class BinaryLiteralImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    public java.lang.Class<dataaccess.expressions.literals.BinaryLiteral> get___JmiInterface() {
        return dataaccess.expressions.literals.BinaryLiteral.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<dataaccess.expressions.literals.__impl.BinaryLiteralImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new dataaccess.expressions.literals.__impl.BinaryLiteralWrapper(conn, this, synchronize);
    }
