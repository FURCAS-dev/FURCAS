...
public class NumberLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.literals.__impl.NumberLiteralImpl> implements dataaccess.expressions.literals.NumberLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public NumberLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.literals.__impl.NumberLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.literals.__impl.NumberLiteralImpl getCastWrappedObject() {
        return (dataaccess.expressions.literals.__impl.NumberLiteralImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.literals.__impl.NumberLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.literals.__impl.NumberLiteralImpl) resolved;
    }
    
    public dataaccess.expressions.literals.__impl.NumberLiteralImpl unwrap() {
        return (dataaccess.expressions.literals.__impl.NumberLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.literals.NumberLiteral (Java Type)\ndataaccess.expressions.literals.NumberLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}