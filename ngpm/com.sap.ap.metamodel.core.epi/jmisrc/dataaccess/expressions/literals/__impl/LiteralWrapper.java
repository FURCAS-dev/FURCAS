...
public class LiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.literals.__impl.LiteralImpl> implements dataaccess.expressions.literals.Literal,com.sap.tc.moin.repository.Partitionable {
    ...
    public LiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.literals.__impl.LiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.literals.__impl.LiteralImpl getCastWrappedObject() {
        return (dataaccess.expressions.literals.__impl.LiteralImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.literals.__impl.LiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.literals.__impl.LiteralImpl) resolved;
    }
    
    public dataaccess.expressions.literals.__impl.LiteralImpl unwrap() {
        return (dataaccess.expressions.literals.__impl.LiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.literals.Literal (Java Type)\ndataaccess.expressions.literals.Literal (MOF Type)"; //$NON-NLS-1$
    }    
}