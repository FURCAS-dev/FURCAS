...
public class TimePointLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.literals.__impl.TimePointLiteralImpl> implements dataaccess.expressions.literals.TimePointLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public TimePointLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.literals.__impl.TimePointLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.literals.__impl.TimePointLiteralImpl getCastWrappedObject() {
        return (dataaccess.expressions.literals.__impl.TimePointLiteralImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.literals.__impl.TimePointLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.literals.__impl.TimePointLiteralImpl) resolved;
    }
    
    public dataaccess.expressions.literals.__impl.TimePointLiteralImpl unwrap() {
        return (dataaccess.expressions.literals.__impl.TimePointLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.literals.TimePointLiteral (Java Type)\ndataaccess.expressions.literals.TimePointLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}