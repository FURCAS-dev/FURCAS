...
public final class TimePointLiteralImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("literal", Integer.valueOf(1)); //$NON-NLS-1$
    ...
    // default constructor
    public TimePointLiteralImpl() {
        super();
    }
    
    // specific constructor
    public TimePointLiteralImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 1, "E075D95551F05DE93E4B11DE8F940018DE1146FF", __literal, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 1, "E075D95551F05DE93E4B11DE8F940018DE1146FF", __literal, newValue); //$NON-NLS-1$
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 1:
                ___changeDataTypeAttribute(connection, 1, "E075D95551F05DE93E4B11DE8F940018DE1146FF", __literal, value); //$NON-NLS-1$
                break;
    ...
    public java.lang.Class<dataaccess.expressions.literals.TimePointLiteral> get___JmiInterface() {
        return dataaccess.expressions.literals.TimePointLiteral.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<dataaccess.expressions.literals.__impl.TimePointLiteralImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new dataaccess.expressions.literals.__impl.TimePointLiteralWrapper(conn, this, synchronize);
    }
