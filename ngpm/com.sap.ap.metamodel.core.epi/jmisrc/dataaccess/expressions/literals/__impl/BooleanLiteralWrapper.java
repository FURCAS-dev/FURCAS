...
public class BooleanLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.literals.__impl.BooleanLiteralImpl> implements dataaccess.expressions.literals.BooleanLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public BooleanLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.literals.__impl.BooleanLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.literals.__impl.BooleanLiteralImpl getCastWrappedObject() {
        return (dataaccess.expressions.literals.__impl.BooleanLiteralImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.literals.__impl.BooleanLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.literals.__impl.BooleanLiteralImpl) resolved;
    }
    
    public dataaccess.expressions.literals.__impl.BooleanLiteralImpl unwrap() {
        return (dataaccess.expressions.literals.__impl.BooleanLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.literals.BooleanLiteral (Java Type)\ndataaccess.expressions.literals.BooleanLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}