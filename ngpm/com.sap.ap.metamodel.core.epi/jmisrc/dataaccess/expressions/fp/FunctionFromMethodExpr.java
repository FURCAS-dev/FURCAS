 ...
 */
public interface FunctionFromMethodExpr extends dataaccess.expressions.ObjectBasedExpression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.fp.FunctionFromMethodExpr> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.fp.FunctionFromMethodExpr>("E075D95551F2A7C33E4B11DE9EC00018DE1146FF", "sap.com/moin/mm/ap/core", "dataaccess", "expressions", "fp", "FunctionFromMethodExpr"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public data.classes.MethodSignature getMethod() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setMethod(data.classes.MethodSignature newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.fp.FunctionFromMethodExpr,data.classes.MethodSignature> __method;
        /**
         * Returns the descriptor for the <code>method</code> reference.
         * @return  the descriptor for the <code>method</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.fp.FunctionFromMethodExpr,data.classes.MethodSignature> METHOD( ) {
            if ( __method == null ) {
                __method = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.fp.FunctionFromMethodExpr,data.classes.MethodSignature>( "E075D95551F2A7C23E4B11DEA37E0018DE1146FF", "sap.com/moin/mm/ap/core", new java.lang.String[] { "dataaccess", "expressions", "fp", "FunctionFromMethodExpr", "method" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __method;
        }
        /**
