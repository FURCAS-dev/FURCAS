...
public class FunctionFromMethodExprWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.fp.__impl.FunctionFromMethodExprImpl> implements dataaccess.expressions.fp.FunctionFromMethodExpr,com.sap.tc.moin.repository.Partitionable {
    ...
    public FunctionFromMethodExprWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.fp.__impl.FunctionFromMethodExprImpl baseObject, boolean synchronize) {
    ...
    public dataaccess.expressions.fp.__impl.FunctionFromMethodExprImpl unwrap() {
        return (dataaccess.expressions.fp.__impl.FunctionFromMethodExprImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.MethodSignature) wrapResult(getCastWrappedObject().getMethod(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.fp.FunctionFromMethodExpr (Java Type)\ndataaccess.expressions.fp.FunctionFromMethodExpr (MOF Type)"; //$NON-NLS-1$
    }    
}