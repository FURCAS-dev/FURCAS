...
public class AnonymousFunctionExprWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.fp.__impl.AnonymousFunctionExprImpl> implements dataaccess.expressions.fp.AnonymousFunctionExpr,com.sap.tc.moin.repository.Partitionable {
    ...
    public AnonymousFunctionExprWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.fp.__impl.AnonymousFunctionExprImpl baseObject, boolean synchronize) {
    ...
    public dataaccess.expressions.fp.__impl.AnonymousFunctionExprImpl unwrap() {
        return (dataaccess.expressions.fp.__impl.AnonymousFunctionExprImpl) getWrappedObject();
    }
    ...
    public data.classes.FunctionSignatureImplementation getImplementation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (data.classes.FunctionSignatureImplementation)___invokeOperation(connection, 5, "E075D95551F2A7BF3E4B11DEB56F0018DE1146FF", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private data.classes.FunctionSignatureImplementation invoke__getImplementation(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            // delegating to the OCL service org.omg.sap2mof.OperationCodeOcl
            java.util.Map operationParameters = new java.util.HashMap();
            return (data.classes.FunctionSignatureImplementation)wrapResult(connection.getSession().getOclService().evaluateOclBodyExpression(connection, "getImplementation", getCastWrappedObject( ), operationParameters));
            // end of implementation provided in tag org.omg.sap2mof.OperationCodeOcl
        } catch(com.sap.tc.moin.repository.exception.MoinBaseException ex) {
                throw new com.sap.tc.moin.repository.mmi.reflect.JmiException(ex);
        }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 5:
                return ___invokeOperation( connection, operationId, "E075D95551F2A7BF3E4B11DEB56F0018DE1146FF", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 5:
                return invoke__getImplementation(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.fp.AnonymousFunctionExpr (Java Type)\ndataaccess.expressions.fp.AnonymousFunctionExpr (MOF Type)"; //$NON-NLS-1$
    }    
}