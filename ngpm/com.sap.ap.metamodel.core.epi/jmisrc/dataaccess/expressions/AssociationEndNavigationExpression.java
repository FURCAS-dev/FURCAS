 ...
 */
public interface AssociationEndNavigationExpression extends dataaccess.expressions.ObjectBasedExpression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.AssociationEndNavigationExpression> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.AssociationEndNavigationExpression>("E075D95551F2A7E23E4B11DEC08B0018DE1146FF", "sap.com/moin/mm/ap/core", "dataaccess", "expressions", "AssociationEndNavigationExpression"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 

    
    // references
    public data.classes.AssociationEnd getToEnd() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setToEnd(data.classes.AssociationEnd newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.AssociationEndNavigationExpression,data.classes.AssociationEnd> __toEnd;
        /**
         * Returns the descriptor for the <code>toEnd</code> reference.
         * @return  the descriptor for the <code>toEnd</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.AssociationEndNavigationExpression,data.classes.AssociationEnd> TO_END( ) {
            if ( __toEnd == null ) {
                __toEnd = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.AssociationEndNavigationExpression,data.classes.AssociationEnd>( "E075D95551F2A7E13E4B11DEC8060018DE1146FF", "sap.com/moin/mm/ap/core", new java.lang.String[] { "dataaccess", "expressions", "AssociationEndNavigationExpression", "toEnd" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __toEnd;
        }
        /**
