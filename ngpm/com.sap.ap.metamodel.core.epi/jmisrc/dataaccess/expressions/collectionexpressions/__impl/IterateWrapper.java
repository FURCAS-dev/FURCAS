...
public class IterateWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.collectionexpressions.__impl.IterateImpl> implements dataaccess.expressions.collectionexpressions.Iterate,com.sap.tc.moin.repository.Partitionable {
    ...
    private dataaccess.expressions.collectionexpressions.__impl.IterateImpl getCastWrappedObject() {
        return (dataaccess.expressions.collectionexpressions.__impl.IterateImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.collectionexpressions.__impl.IterateImpl unwrap() {
        return (dataaccess.expressions.collectionexpressions.__impl.IterateImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<behavioral.actions.Iterator>) wrapResult(getCastWrappedObject().getIterators(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavioral.actions.Constant) wrapResult(getCastWrappedObject().getAccumulator(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setAccumulator(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getIteratorExpression(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setIteratorExpression(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.collectionexpressions.Iterate (Java Type)\ndataaccess.expressions.collectionExpressions.Iterate (MOF Type)"; //$NON-NLS-1$
    }    
}