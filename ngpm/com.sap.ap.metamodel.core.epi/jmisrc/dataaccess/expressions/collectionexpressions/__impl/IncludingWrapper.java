...
public class IncludingWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.collectionexpressions.__impl.IncludingImpl> implements dataaccess.expressions.collectionexpressions.Including,com.sap.tc.moin.repository.Partitionable {
    ...
    public IncludingWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.collectionexpressions.__impl.IncludingImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.collectionexpressions.__impl.IncludingImpl getCastWrappedObject() {
        return (dataaccess.expressions.collectionexpressions.__impl.IncludingImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.collectionexpressions.__impl.IncludingImpl unwrap() {
        return (dataaccess.expressions.collectionexpressions.__impl.IncludingImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.collectionexpressions.Including (Java Type)\ndataaccess.expressions.collectionExpressions.Including (MOF Type)"; //$NON-NLS-1$
    }    
}