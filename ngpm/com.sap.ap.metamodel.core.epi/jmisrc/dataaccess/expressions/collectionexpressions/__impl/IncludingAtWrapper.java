...
public class IncludingAtWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl> implements dataaccess.expressions.collectionexpressions.IncludingAt,com.sap.tc.moin.repository.Partitionable {
    ...
    public IncludingAtWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl getCastWrappedObject() {
        return (dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl) resolved;
    }
    
    public dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl unwrap() {
        return (dataaccess.expressions.collectionexpressions.__impl.IncludingAtImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.collectionexpressions.IncludingAt (Java Type)\ndataaccess.expressions.collectionExpressions.IncludingAt (MOF Type)"; //$NON-NLS-1$
    }    
}