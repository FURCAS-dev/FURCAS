...
public class ExcludingWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.collectionexpressions.__impl.ExcludingImpl> implements dataaccess.expressions.collectionexpressions.Excluding,com.sap.tc.moin.repository.Partitionable {
    ...
    public ExcludingWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.collectionexpressions.__impl.ExcludingImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.collectionexpressions.__impl.ExcludingImpl getCastWrappedObject() {
        return (dataaccess.expressions.collectionexpressions.__impl.ExcludingImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.collectionexpressions.__impl.ExcludingImpl unwrap() {
        return (dataaccess.expressions.collectionexpressions.__impl.ExcludingImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.collectionexpressions.Excluding (Java Type)\ndataaccess.expressions.collectionExpressions.Excluding (MOF Type)"; //$NON-NLS-1$
    }    
}