 ...
 */
public interface ObjectCount extends dataaccess.expressions.ObjectBasedExpression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.ObjectCount> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.ObjectCount>("E075D95551F2A7E83E4B11DE8D2F0018DE1146FF", "sap.com/moin/mm/ap/core", "dataaccess", "expressions", "ObjectCount"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
