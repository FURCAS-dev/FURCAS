 ...
 */
public interface ObjectBasedExpression extends dataaccess.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.ObjectBasedExpression> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, dataaccess.expressions.ObjectBasedExpression>("E075D95551F2A7D63E4B11DECDDB0018DE1146FF", "sap.com/moin/mm/ap/core", "dataaccess", "expressions", "ObjectBasedExpression"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.ObjectBasedExpression,dataaccess.expressions.Expression> __object;
        /**
         * Returns the descriptor for the <code>object</code> reference.
         * @return  the descriptor for the <code>object</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.ObjectBasedExpression,dataaccess.expressions.Expression> OBJECT( ) {
            if ( __object == null ) {
                __object = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,dataaccess.expressions.ObjectBasedExpression,dataaccess.expressions.Expression>( "E075D95551F2A7D53E4B11DEB1C20018DE1146FF", "sap.com/moin/mm/ap/core", new java.lang.String[] { "dataaccess", "expressions", "ObjectBasedExpression", "object" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __object;
        }
        /**
