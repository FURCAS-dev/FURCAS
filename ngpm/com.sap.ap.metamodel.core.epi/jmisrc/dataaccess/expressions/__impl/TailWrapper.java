...
public class TailWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.TailImpl> implements dataaccess.expressions.Tail,com.sap.tc.moin.repository.Partitionable {
    ...
    public TailWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.TailImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.TailImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.TailImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.TailImpl unwrap() {
        return (dataaccess.expressions.__impl.TailImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.Tail (Java Type)\ndataaccess.expressions.Tail (MOF Type)"; //$NON-NLS-1$
    }    
}