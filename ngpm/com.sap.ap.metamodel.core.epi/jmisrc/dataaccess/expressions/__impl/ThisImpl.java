...
public final class ThisImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    public java.lang.Class<dataaccess.expressions.This> get___JmiInterface() {
        return dataaccess.expressions.This.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<dataaccess.expressions.__impl.ThisImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new dataaccess.expressions.__impl.ThisWrapper(conn, this, synchronize);
    }
