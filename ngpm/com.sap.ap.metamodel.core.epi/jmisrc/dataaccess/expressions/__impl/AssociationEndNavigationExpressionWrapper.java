...
public class AssociationEndNavigationExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.AssociationEndNavigationExpressionImpl> implements dataaccess.expressions.AssociationEndNavigationExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public AssociationEndNavigationExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.AssociationEndNavigationExpressionImpl baseObject, boolean synchronize) {
    ...
    public dataaccess.expressions.__impl.AssociationEndNavigationExpressionImpl unwrap() {
        return (dataaccess.expressions.__impl.AssociationEndNavigationExpressionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.AssociationEnd) wrapResult(getCastWrappedObject().getToEnd(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setToEnd(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.AssociationEndNavigationExpression (Java Type)\ndataaccess.expressions.AssociationEndNavigationExpression (MOF Type)"; //$NON-NLS-1$
    }    
}