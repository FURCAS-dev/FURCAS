...
public class AsListWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.AsListImpl> implements dataaccess.expressions.AsList,com.sap.tc.moin.repository.Partitionable {
    ...
    public AsListWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.AsListImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.AsListImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.AsListImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.AsListImpl unwrap() {
        return (dataaccess.expressions.__impl.AsListImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.AsList (Java Type)\ndataaccess.expressions.AsList (MOF Type)"; //$NON-NLS-1$
    }    
}