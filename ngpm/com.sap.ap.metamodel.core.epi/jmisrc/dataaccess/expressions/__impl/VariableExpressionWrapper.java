...
public class VariableExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.VariableExpressionImpl> implements dataaccess.expressions.VariableExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public VariableExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.VariableExpressionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.VariableExpressionImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.VariableExpressionImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.VariableExpressionImpl unwrap() {
        return (dataaccess.expressions.__impl.VariableExpressionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.NamedValue) wrapResult(getCastWrappedObject().getVariable(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.VariableExpression (Java Type)\ndataaccess.expressions.VariableExpression (MOF Type)"; //$NON-NLS-1$
    }    
}