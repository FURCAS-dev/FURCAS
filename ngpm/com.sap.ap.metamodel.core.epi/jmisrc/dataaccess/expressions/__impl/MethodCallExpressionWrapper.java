...
public class MethodCallExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.MethodCallExpressionImpl> implements dataaccess.expressions.MethodCallExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public MethodCallExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.MethodCallExpressionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.MethodCallExpressionImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.MethodCallExpressionImpl) getWrappedObject();
    }
    
    private dataaccess.expressions.__impl.MethodCallExpressionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (dataaccess.expressions.__impl.MethodCallExpressionImpl) resolved;
    }
    
    public dataaccess.expressions.__impl.MethodCallExpressionImpl unwrap() {
        return (dataaccess.expressions.__impl.MethodCallExpressionImpl) getWrappedObject();
    }
    ...
    public boolean isAsynchronous() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        if (resolved != null) {
            return getCastWrappedObject(resolved).isAsynchronous();
        }
            try {
            if (synchronize) {
                ...
                try {
                    ...
                    return getCastWrappedObject().isAsynchronous();
                } finally {
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setAsynchronous(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public dataaccess.expressions.Expression getObject() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getObject(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setObject(dataaccess.expressions.Expression newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setObject(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<dataaccess.expressions.Expression>) wrapResult(getCastWrappedObject().getParameters(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.MethodSignature) wrapResult(getCastWrappedObject().getMethodSignature(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setMethodSignature(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public data.classes.Signature getSignature() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (data.classes.Signature)___invokeOperation(connection, 4, "E075D95551F2A7E53E4B11DE97EC0018DE1146FF", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public data.classes.Multiplicity getMultiplicityOfCallTarget() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (data.classes.Multiplicity)___invokeOperation(connection, 5, "E075D9559CE61A11B80011DEA13B001A6BCDC3B3", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private data.classes.Signature invoke__getSignature(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            // delegating to the OCL service org.omg.sap2mof.OperationCodeOcl
            java.util.Map operationParameters = new java.util.HashMap();
            return (data.classes.Signature)wrapResult(connection.getSession().getOclService().evaluateOclBodyExpression(connection, "getSignature", getCastWrappedObject( ), operationParameters));
            // end of implementation provided in tag org.omg.sap2mof.OperationCodeOcl
        } catch(com.sap.tc.moin.repository.exception.MoinBaseException ex) {
                throw new com.sap.tc.moin.repository.mmi.reflect.JmiException(ex);
        }
    }
    private data.classes.Multiplicity invoke__getMultiplicityOfCallTarget(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            // delegating to the OCL service org.omg.sap2mof.OperationCodeOcl
            java.util.Map operationParameters = new java.util.HashMap();
            return (data.classes.Multiplicity)wrapResult(connection.getSession().getOclService().evaluateOclBodyExpression(connection, "getMultiplicityOfCallTarget", getCastWrappedObject( ), operationParameters));
            // end of implementation provided in tag org.omg.sap2mof.OperationCodeOcl
        } catch(com.sap.tc.moin.repository.exception.MoinBaseException ex) {
                throw new com.sap.tc.moin.repository.mmi.reflect.JmiException(ex);
        }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 4:
                return ___invokeOperation( connection, operationId, "E075D95551F2A7E53E4B11DE97EC0018DE1146FF", args ); //$NON-NLS-1$    
                
            case 5:
                return ___invokeOperation( connection, operationId, "E075D9559CE61A11B80011DEA13B001A6BCDC3B3", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 4:
                return invoke__getSignature(connection);    
                
            case 5:
                return invoke__getMultiplicityOfCallTarget(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.MethodCallExpression (Java Type)\ndataaccess.expressions.MethodCallExpression (MOF Type)"; //$NON-NLS-1$
    }    
}