...
public class ContentEqualsWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.ContentEqualsImpl> implements dataaccess.expressions.ContentEquals,com.sap.tc.moin.repository.Partitionable {
    ...
    public ContentEqualsWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.ContentEqualsImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.__impl.ContentEqualsImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.ContentEqualsImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.ContentEqualsImpl unwrap() {
        return (dataaccess.expressions.__impl.ContentEqualsImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getLeft(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getRight(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.ContentEquals (Java Type)\ndataaccess.expressions.ContentEquals (MOF Type)"; //$NON-NLS-1$
    }    
}