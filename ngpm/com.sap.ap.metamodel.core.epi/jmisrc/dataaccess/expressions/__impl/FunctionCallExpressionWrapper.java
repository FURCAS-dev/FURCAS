...
public class FunctionCallExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.FunctionCallExpressionImpl> implements dataaccess.expressions.FunctionCallExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public FunctionCallExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.FunctionCallExpressionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.FunctionCallExpressionImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.FunctionCallExpressionImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.FunctionCallExpressionImpl unwrap() {
        return (dataaccess.expressions.__impl.FunctionCallExpressionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getCalledBlock(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setCalledBlock(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.FunctionCallExpression (Java Type)\ndataaccess.expressions.FunctionCallExpression (MOF Type)"; //$NON-NLS-1$
    }    
}