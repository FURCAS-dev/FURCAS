...
public class ThisWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.ThisImpl> implements dataaccess.expressions.This,com.sap.tc.moin.repository.Partitionable {
    ...
    public ThisWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.ThisImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.ThisImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.ThisImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.ThisImpl unwrap() {
        return (dataaccess.expressions.__impl.ThisImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.This (Java Type)\ndataaccess.expressions.This (MOF Type)"; //$NON-NLS-1$
    }    
}