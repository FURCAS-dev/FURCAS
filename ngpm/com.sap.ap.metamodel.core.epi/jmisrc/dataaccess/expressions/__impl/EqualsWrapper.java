...
public class EqualsWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.EqualsImpl> implements dataaccess.expressions.Equals,com.sap.tc.moin.repository.Partitionable {
    ...
    public EqualsWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.EqualsImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.__impl.EqualsImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.EqualsImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.EqualsImpl unwrap() {
        return (dataaccess.expressions.__impl.EqualsImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.Equals (Java Type)\ndataaccess.expressions.Equals (MOF Type)"; //$NON-NLS-1$
    }    
}