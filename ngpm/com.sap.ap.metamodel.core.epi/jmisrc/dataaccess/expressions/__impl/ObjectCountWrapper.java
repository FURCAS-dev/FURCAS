...
public class ObjectCountWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.ObjectCountImpl> implements dataaccess.expressions.ObjectCount,com.sap.tc.moin.repository.Partitionable {
    ...
    public ObjectCountWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.ObjectCountImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.__impl.ObjectCountImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.ObjectCountImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.ObjectCountImpl unwrap() {
        return (dataaccess.expressions.__impl.ObjectCountImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.ObjectCount (Java Type)\ndataaccess.expressions.ObjectCount (MOF Type)"; //$NON-NLS-1$
    }    
}