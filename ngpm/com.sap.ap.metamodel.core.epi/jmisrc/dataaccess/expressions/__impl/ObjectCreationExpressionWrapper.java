...
public class ObjectCreationExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.ObjectCreationExpressionImpl> implements dataaccess.expressions.ObjectCreationExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public ObjectCreationExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.ObjectCreationExpressionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.ObjectCreationExpressionImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.ObjectCreationExpressionImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.ObjectCreationExpressionImpl unwrap() {
        return (dataaccess.expressions.__impl.ObjectCreationExpressionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.SapClass) wrapResult(getCastWrappedObject().getClassToInstantiate(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.ObjectCreationExpression (Java Type)\ndataaccess.expressions.ObjectCreationExpression (MOF Type)"; //$NON-NLS-1$
    }    
}