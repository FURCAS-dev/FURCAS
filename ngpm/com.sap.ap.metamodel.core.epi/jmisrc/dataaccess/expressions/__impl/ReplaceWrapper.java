...
public class ReplaceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.ReplaceImpl> implements dataaccess.expressions.Replace,com.sap.tc.moin.repository.Partitionable {
    ...
    public ReplaceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.ReplaceImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private dataaccess.expressions.__impl.ReplaceImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.ReplaceImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.ReplaceImpl unwrap() {
        return (dataaccess.expressions.__impl.ReplaceImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<dataaccess.expressions.NavigationStep>) wrapResult(getCastWrappedObject().getSteps(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getWith(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setWith(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.Replace (Java Type)\ndataaccess.expressions.Replace (MOF Type)"; //$NON-NLS-1$
    }    
}