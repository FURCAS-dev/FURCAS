...
public class HeadWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.expressions.__impl.HeadImpl> implements dataaccess.expressions.Head,com.sap.tc.moin.repository.Partitionable {
    ...
    public HeadWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.expressions.__impl.HeadImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.expressions.__impl.HeadImpl getCastWrappedObject() {
        return (dataaccess.expressions.__impl.HeadImpl) getWrappedObject();
    }
    
    public dataaccess.expressions.__impl.HeadImpl unwrap() {
        return (dataaccess.expressions.__impl.HeadImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "dataaccess.expressions.Head (Java Type)\ndataaccess.expressions.Head (MOF Type)"; //$NON-NLS-1$
    }    
}