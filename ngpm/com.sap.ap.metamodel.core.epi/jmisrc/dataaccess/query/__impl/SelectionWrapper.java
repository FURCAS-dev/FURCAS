...
public class SelectionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<dataaccess.query.__impl.SelectionImpl> implements dataaccess.query.Selection,com.sap.tc.moin.repository.Partitionable {
    ...
    public SelectionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, dataaccess.query.__impl.SelectionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private dataaccess.query.__impl.SelectionImpl getCastWrappedObject() {
        return (dataaccess.query.__impl.SelectionImpl) getWrappedObject();
    }
    
    public dataaccess.query.__impl.SelectionImpl unwrap() {
        return (dataaccess.query.__impl.SelectionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavioral.actions.Iterator) wrapResult(getCastWrappedObject().getIterator(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setIterator(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (dataaccess.expressions.Expression) wrapResult(getCastWrappedObject().getSelectionExpr(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setSelectionExpr(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "dataaccess.query.Selection (Java Type)\ndataaccess.query.Selection (MOF Type)"; //$NON-NLS-1$
    }    
}