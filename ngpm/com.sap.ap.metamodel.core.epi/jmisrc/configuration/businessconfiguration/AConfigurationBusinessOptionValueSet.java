 ...
 */
public interface AConfigurationBusinessOptionValueSet extends com.sap.tc.moin.repository.mmi.reflect.RefAssociation
{
    // association extent descriptor
    /**
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.AssociationDescriptor<configuration.businessconfiguration.AConfigurationBusinessOptionValueSet> ASSOCIATION_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.AssociationDescriptor<configuration.businessconfiguration.AConfigurationBusinessOptionValueSet>("E0DDC76451FC44A43E4B11DE9F820018DE1146FF", "sap.com/moin/mm/ap/core", "configuration", "businessconfiguration", "A_configurationBusinessOption_valueSet"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public java.util.Collection<configuration.businessconfiguration.ValueSet> getValueSet(configuration.businessconfiguration.BusinessOption _ConfigurationBusinessOption) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
