 ...
 */
public interface Snapshot extends dataaccess.expressions.ObjectBasedExpression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, persistence.expressions.Snapshot> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, persistence.expressions.Snapshot>("E00C881E520349A63E4B11DE8A450018DE1146FF", "sap.com/moin/mm/ap/core", "persistence", "expressions", "Snapshot"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
