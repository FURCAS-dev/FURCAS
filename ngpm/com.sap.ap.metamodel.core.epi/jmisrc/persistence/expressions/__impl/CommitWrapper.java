...
public class CommitWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<persistence.expressions.__impl.CommitImpl> implements persistence.expressions.Commit,com.sap.tc.moin.repository.Partitionable {
    ...
    public CommitWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, persistence.expressions.__impl.CommitImpl baseObject, boolean synchronize) {
    ...
    public persistence.expressions.__impl.CommitImpl unwrap() {
        return (persistence.expressions.__impl.CommitImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "persistence.expressions.Commit (Java Type)\npersistence.expressions.Commit (MOF Type)"; //$NON-NLS-1$
    }    
}