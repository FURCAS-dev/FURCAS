...
public class SnapshotWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<persistence.expressions.__impl.SnapshotImpl> implements persistence.expressions.Snapshot,com.sap.tc.moin.repository.Partitionable {
    ...
    public SnapshotWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, persistence.expressions.__impl.SnapshotImpl baseObject, boolean synchronize) {
    ...
    public persistence.expressions.__impl.SnapshotImpl unwrap() {
        return (persistence.expressions.__impl.SnapshotImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "persistence.expressions.Snapshot (Java Type)\npersistence.expressions.Snapshot (MOF Type)"; //$NON-NLS-1$
    }    
}