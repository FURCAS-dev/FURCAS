...
public class PackageWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<modelmanagement.__impl.PackageImpl> implements modelmanagement.Package,com.sap.tc.moin.repository.Partitionable {


    static {
    }

    public PackageWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, modelmanagement.__impl.PackageImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private modelmanagement.__impl.PackageImpl getCastWrappedObject() {
        return (modelmanagement.__impl.PackageImpl) getWrappedObject();
    }
    
    private modelmanagement.__impl.PackageImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (modelmanagement.__impl.PackageImpl) resolved;
    }
    
    public modelmanagement.__impl.PackageImpl unwrap() {
        return (modelmanagement.__impl.PackageImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<data.classes.SapClass>) wrapResult(getCastWrappedObject().getClasses(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "modelmanagement.Package (Java Type)\nmodelmanagement.Package (MOF Type)"; //$NON-NLS-1$
    }    
}