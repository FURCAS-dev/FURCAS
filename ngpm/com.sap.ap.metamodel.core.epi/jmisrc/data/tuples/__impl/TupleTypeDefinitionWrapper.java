...
public class TupleTypeDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<data.tuples.__impl.TupleTypeDefinitionImpl> implements data.tuples.TupleTypeDefinition,com.sap.tc.moin.repository.Partitionable {
    ...
    public TupleTypeDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, data.tuples.__impl.TupleTypeDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private data.tuples.__impl.TupleTypeDefinitionImpl getCastWrappedObject() {
        return (data.tuples.__impl.TupleTypeDefinitionImpl) getWrappedObject();
    }
    
    private data.tuples.__impl.TupleTypeDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (data.tuples.__impl.TupleTypeDefinitionImpl) resolved;
    }
    
    public data.tuples.__impl.TupleTypeDefinitionImpl unwrap() {
        return (data.tuples.__impl.TupleTypeDefinitionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<data.tuples.TupleElement>) wrapResult(getCastWrappedObject().getElements(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "data.tuples.TupleTypeDefinition (Java Type)\ndata.tuples.TupleTypeDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}