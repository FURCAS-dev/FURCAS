...
public class FunctionSignatureTypeDefinitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<data.classes.__impl.FunctionSignatureTypeDefinitionImpl> implements data.classes.FunctionSignatureTypeDefinition,com.sap.tc.moin.repository.Partitionable {
    ...
    public FunctionSignatureTypeDefinitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, data.classes.__impl.FunctionSignatureTypeDefinitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private data.classes.__impl.FunctionSignatureTypeDefinitionImpl getCastWrappedObject() {
        return (data.classes.__impl.FunctionSignatureTypeDefinitionImpl) getWrappedObject();
    }
    
    private data.classes.__impl.FunctionSignatureTypeDefinitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (data.classes.__impl.FunctionSignatureTypeDefinitionImpl) resolved;
    }
    
    public data.classes.__impl.FunctionSignatureTypeDefinitionImpl unwrap() {
        return (data.classes.__impl.FunctionSignatureTypeDefinitionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.Signature) wrapResult(getCastWrappedObject().getSignature(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.Signature) wrapResult(getCastWrappedObject().getOwnedSignature(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setOwnedSignature(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "data.classes.FunctionSignatureTypeDefinition (Java Type)\ndata.classes.FunctionSignatureTypeDefinition (MOF Type)"; //$NON-NLS-1$
    }    
}