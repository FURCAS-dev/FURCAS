...
public class ContextWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<data.classes.__impl.ContextImpl> implements data.classes.Context,com.sap.tc.moin.repository.Partitionable {
    ...
    public ContextWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, data.classes.__impl.ContextImpl baseObject, boolean synchronize) {
    ...
    private data.classes.__impl.ContextImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (data.classes.__impl.ContextImpl) resolved;
    }
    
    public data.classes.__impl.ContextImpl unwrap() {
        return (data.classes.__impl.ContextImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.SapClass) wrapResult(getCastWrappedObject().getFor(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setFor(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<data.constraints.Constraint>) wrapResult(getCastWrappedObject().getConstraints(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "data.classes.Context (Java Type)\ndata.classes.Context (MOF Type)"; //$NON-NLS-1$
    }    
}