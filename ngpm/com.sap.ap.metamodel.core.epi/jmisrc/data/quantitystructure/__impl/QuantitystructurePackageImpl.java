...
public final class QuantitystructurePackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    // constructors    
    public QuantitystructurePackageImpl()
    {
        super();
    }
    public QuantitystructurePackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    protected java.lang.Object create___Extent(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
        ...
        try {
            switch (FEATURE_IDS.get(name)) {
                case 0:
                    return new com.sap.tc.moin.repository.core.jmi.reflect.RefClassImpl(workspace, mofId, immediatePackage, metaObject, Class.forName("data.quantitystructure.__impl.DummyImpl")); //$NON-NLS-1$
                default:
    ...
    protected void initialize() {
        ...
        if (___refClasses == null) {
            ...
            rcan = new RefClassAndName(name, "data.quantitystructure.Dummy"); //$NON-NLS-1$
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<data.quantitystructure.__impl.QuantitystructurePackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new data.quantitystructure.__impl.QuantitystructurePackageWrapper(conn, this, synchronize);
    }
