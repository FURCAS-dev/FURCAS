...
public class FormalTypeParameterWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<data.generics.__impl.FormalTypeParameterImpl> implements data.generics.FormalTypeParameter,com.sap.tc.moin.repository.Partitionable {
    ...
    public FormalTypeParameterWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, data.generics.__impl.FormalTypeParameterImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private data.generics.__impl.FormalTypeParameterImpl getCastWrappedObject() {
        return (data.generics.__impl.FormalTypeParameterImpl) getWrappedObject();
    }
    
    private data.generics.__impl.FormalTypeParameterImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (data.generics.__impl.FormalTypeParameterImpl) resolved;
    }
    
    public data.generics.__impl.FormalTypeParameterImpl unwrap() {
        return (data.generics.__impl.FormalTypeParameterImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.generics.ClassParameterization) wrapResult(getCastWrappedObject().getParameterOf(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setParameterOf(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.SapClass) wrapResult(getCastWrappedObject().getTypeConstraint(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setTypeConstraint(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<data.generics.ActualTypeParameter>) wrapResult(getCastWrappedObject().getActualTypeParameters(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "data.generics.FormalTypeParameter (Java Type)\ndata.generics.FormalTypeParameter (MOF Type)"; //$NON-NLS-1$
    }    
}