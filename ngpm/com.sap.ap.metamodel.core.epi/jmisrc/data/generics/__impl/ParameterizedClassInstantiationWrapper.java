...
public class ParameterizedClassInstantiationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<data.generics.__impl.ParameterizedClassInstantiationImpl> implements data.generics.ParameterizedClassInstantiation,com.sap.tc.moin.repository.Partitionable {
    ...
    public ParameterizedClassInstantiationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, data.generics.__impl.ParameterizedClassInstantiationImpl baseObject, boolean synchronize) {
    ...
    private data.generics.__impl.ParameterizedClassInstantiationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (data.generics.__impl.ParameterizedClassInstantiationImpl) resolved;
    }
    
    public data.generics.__impl.ParameterizedClassInstantiationImpl unwrap() {
        return (data.generics.__impl.ParameterizedClassInstantiationImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<data.generics.ActualTypeParameter>) wrapResult(getCastWrappedObject().getActualTypeParametersForInstantiation(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (data.classes.SapClass) wrapResult(getCastWrappedObject().getParameterizedClass(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setParameterizedClass(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public data.classes.SapClass resolveFormalTypeParameter(data.generics.FormalTypeParameter ftp) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(1);
        try {
            parameterList.add(ftp);
            return (data.classes.SapClass)___invokeOperation(connection, 20, "E0234C8C51F05DB73E4B11DE9B000018DE1146FF", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public data.generics.ClassParameterization getClassParameterization() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (data.generics.ClassParameterization)___invokeOperation(connection, 21, "E0234C8C51F05DB93E4B11DEC8B40018DE1146FF", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private data.classes.SapClass invoke__resolveFormalTypeParameter(com.sap.tc.moin.repository.core.CoreConnection connection, data.generics.FormalTypeParameter ftp) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            // delegating to the OCL service org.omg.sap2mof.OperationCodeOcl
            java.util.Map operationParameters = new java.util.HashMap();
            operationParameters.put("ftp", unwrapArg(ftp));
            return (data.classes.SapClass)wrapResult(connection.getSession().getOclService().evaluateOclBodyExpression(connection, "resolveFormalTypeParameter", getCastWrappedObject( ), operationParameters));
            // end of implementation provided in tag org.omg.sap2mof.OperationCodeOcl
        } catch(com.sap.tc.moin.repository.exception.MoinBaseException ex) {
                throw new com.sap.tc.moin.repository.mmi.reflect.JmiException(ex);
        }
    }
    private data.generics.ClassParameterization invoke__getClassParameterization(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            // delegating to the OCL service org.omg.sap2mof.OperationCodeOcl
            java.util.Map operationParameters = new java.util.HashMap();
            return (data.generics.ClassParameterization)wrapResult(connection.getSession().getOclService().evaluateOclBodyExpression(connection, "getClassParameterization", getCastWrappedObject( ), operationParameters));
            // end of implementation provided in tag org.omg.sap2mof.OperationCodeOcl
        } catch(com.sap.tc.moin.repository.exception.MoinBaseException ex) {
                throw new com.sap.tc.moin.repository.mmi.reflect.JmiException(ex);
        }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 20:
                return ___invokeOperation( connection, operationId, "E0234C8C51F05DB73E4B11DE9B000018DE1146FF", args ); //$NON-NLS-1$    
                
            case 21:
                return ___invokeOperation( connection, operationId, "E0234C8C51F05DB93E4B11DEC8B40018DE1146FF", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 20:
                return invoke__resolveFormalTypeParameter(connection, (data.generics.FormalTypeParameter) args.get(0));    
                
            case 21:
                return invoke__getClassParameterization(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "data.generics.ParameterizedClassInstantiation (Java Type)\ndata.generics.ParameterizedClassInstantiation (MOF Type)"; //$NON-NLS-1$
    }    
}