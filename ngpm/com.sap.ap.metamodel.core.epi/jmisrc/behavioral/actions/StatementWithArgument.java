 ...
 */
public interface StatementWithArgument extends dataaccess.expressions.WithArgument,behavioral.actions.Statement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavioral.actions.StatementWithArgument> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavioral.actions.StatementWithArgument>("E0BC871351C57D2A3E4B11DECB380018DE1146FF", "sap.com/moin/mm/ap/core", "behavioral", "actions", "StatementWithArgument"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
