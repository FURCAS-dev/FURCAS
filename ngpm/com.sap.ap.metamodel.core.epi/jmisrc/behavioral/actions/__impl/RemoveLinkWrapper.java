...
public class RemoveLinkWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavioral.actions.__impl.RemoveLinkImpl> implements behavioral.actions.RemoveLink,com.sap.tc.moin.repository.Partitionable {
    ...
    public RemoveLinkWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavioral.actions.__impl.RemoveLinkImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavioral.actions.__impl.RemoveLinkImpl getCastWrappedObject() {
        return (behavioral.actions.__impl.RemoveLinkImpl) getWrappedObject();
    }
    
    private behavioral.actions.__impl.RemoveLinkImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavioral.actions.__impl.RemoveLinkImpl) resolved;
    }
    
    public behavioral.actions.__impl.RemoveLinkImpl unwrap() {
        return (behavioral.actions.__impl.RemoveLinkImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavioral.actions.RemoveLink (Java Type)\nbehavioral.actions.RemoveLink (MOF Type)"; //$NON-NLS-1$
    }    
}