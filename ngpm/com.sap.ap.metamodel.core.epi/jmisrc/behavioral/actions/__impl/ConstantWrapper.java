...
public class ConstantWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavioral.actions.__impl.ConstantImpl> implements behavioral.actions.Constant,com.sap.tc.moin.repository.Partitionable {
    ...
    public ConstantWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavioral.actions.__impl.ConstantImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavioral.actions.__impl.ConstantImpl getCastWrappedObject() {
        return (behavioral.actions.__impl.ConstantImpl) getWrappedObject();
    }
    
    private behavioral.actions.__impl.ConstantImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavioral.actions.__impl.ConstantImpl) resolved;
    }
    
    public behavioral.actions.__impl.ConstantImpl unwrap() {
        return (behavioral.actions.__impl.ConstantImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavioral.actions.Constant (Java Type)\nbehavioral.actions.Constant (MOF Type)"; //$NON-NLS-1$
    }    
}