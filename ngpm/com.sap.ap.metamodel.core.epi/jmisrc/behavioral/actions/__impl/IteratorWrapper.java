...
public class IteratorWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavioral.actions.__impl.IteratorImpl> implements behavioral.actions.Iterator,com.sap.tc.moin.repository.Partitionable {
    ...
    public IteratorWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavioral.actions.__impl.IteratorImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavioral.actions.__impl.IteratorImpl getCastWrappedObject() {
        return (behavioral.actions.__impl.IteratorImpl) getWrappedObject();
    }
    
    private behavioral.actions.__impl.IteratorImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavioral.actions.__impl.IteratorImpl) resolved;
    }
    
    public behavioral.actions.__impl.IteratorImpl unwrap() {
        return (behavioral.actions.__impl.IteratorImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavioral.actions.Foreach) wrapResult(getCastWrappedObject().getBoundToFor(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setBoundToFor(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "behavioral.actions.Iterator (Java Type)\nbehavioral.actions.Iterator (MOF Type)"; //$NON-NLS-1$
    }    
}