...
public class OrOperatorWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavioral.statusandaction.assembly.__impl.OrOperatorImpl> implements behavioral.statusandaction.assembly.OrOperator,com.sap.tc.moin.repository.Partitionable {
    ...
    public OrOperatorWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavioral.statusandaction.assembly.__impl.OrOperatorImpl baseObject, boolean synchronize) {
    ...
    private behavioral.statusandaction.assembly.__impl.OrOperatorImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavioral.statusandaction.assembly.__impl.OrOperatorImpl) resolved;
    }
    
    public behavioral.statusandaction.assembly.__impl.OrOperatorImpl unwrap() {
        return (behavioral.statusandaction.assembly.__impl.OrOperatorImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavioral.statusandaction.assembly.OrOperator (Java Type)\nbehavioral.status_and_action.assembly.OrOperator (MOF Type)"; //$NON-NLS-1$
    }    
}