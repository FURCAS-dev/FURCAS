...
public final class BusinesstasksPackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    static {
        ...
        FEATURE_IDS.put("TaskAgent", Integer.valueOf(0)); //$NON-NLS-1$
    }

    // constructors    
    public BusinesstasksPackageImpl()
    {
        super();
    }
    public BusinesstasksPackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    // nested packages
    // classes
    public com.sap.tc.moin.repository.mmi.reflect.RefClass getTaskAgent(com.sap.tc.moin.repository.core.CoreConnection connection) {
        return  refClass(connection, "TaskAgent"); //$NON-NLS-1$
    }
    // associations
    ...
    protected java.lang.Object create___Extent(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
        ...
        try {
            switch (FEATURE_IDS.get(name)) {
                case 0:
                    return new com.sap.tc.moin.repository.core.jmi.reflect.RefClassImpl(workspace, mofId, immediatePackage, metaObject, Class.forName("behavioral.businesstasks.__impl.TaskAgentImpl")); //$NON-NLS-1$
                default:
    ...
    protected void initialize() {
        ...
        if (___refClasses == null) {
            ...
            name = "TaskAgent"; //$NON-NLS-1$
            rcan = new RefClassAndName(name, "behavioral.businesstasks.TaskAgent"); //$NON-NLS-1$
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavioral.businesstasks.__impl.BusinesstasksPackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavioral.businesstasks.__impl.BusinesstasksPackageWrapper(conn, this, synchronize);
    }
