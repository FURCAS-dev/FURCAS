...
public class SequenceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<integration.xsd.__impl.SequenceImpl> implements integration.xsd.Sequence,com.sap.tc.moin.repository.Partitionable {

    
    static {
    }

    public SequenceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, integration.xsd.__impl.SequenceImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private integration.xsd.__impl.SequenceImpl getCastWrappedObject() {
        return (integration.xsd.__impl.SequenceImpl) getWrappedObject();
    }
    
    private integration.xsd.__impl.SequenceImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (integration.xsd.__impl.SequenceImpl) resolved;
    }
    
    public integration.xsd.__impl.SequenceImpl unwrap() {
        return (integration.xsd.__impl.SequenceImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<integration.xsd.Containable>) wrapResult(getCastWrappedObject().getChildren(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "integration.xsd.Sequence (Java Type)\nintegration.xsd.Sequence (MOF Type)"; //$NON-NLS-1$
    }    
}