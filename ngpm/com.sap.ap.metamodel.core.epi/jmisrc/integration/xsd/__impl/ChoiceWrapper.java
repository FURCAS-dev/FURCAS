...
public class ChoiceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<integration.xsd.__impl.ChoiceImpl> implements integration.xsd.Choice,com.sap.tc.moin.repository.Partitionable {
    ...
    public ChoiceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, integration.xsd.__impl.ChoiceImpl baseObject, boolean synchronize) {
    ...
    private integration.xsd.__impl.ChoiceImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (integration.xsd.__impl.ChoiceImpl) resolved;
    }
    
    public integration.xsd.__impl.ChoiceImpl unwrap() {
        return (integration.xsd.__impl.ChoiceImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<integration.xsd.Containable>) wrapResult(getCastWrappedObject().getChildren(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "integration.xsd.Choice (Java Type)\nintegration.xsd.Choice (MOF Type)"; //$NON-NLS-1$
    }    
}