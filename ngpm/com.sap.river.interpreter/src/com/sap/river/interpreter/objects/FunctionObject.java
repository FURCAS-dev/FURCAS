 ...
 */
public class FunctionObject extends RiverObject {
     ...
     * {@link RiverInterpreter#convert(ValueObject, data.classes.ClassTypeDefinition)}.
     */
	...
	RiverObject result;
        RiverObject unconvertedResult = interpreter.evaluate(getImplementation());
