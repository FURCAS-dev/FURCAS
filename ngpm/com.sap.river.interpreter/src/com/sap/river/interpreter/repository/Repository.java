...
public interface Repository {
     ...
     */
    Collection<Link> all(Association association, SnapshotIdentifier fromSnapshot);
     ...
     */
    Collection<EntityObject> all(SapClass clazz, SnapshotIdentifier fromSnapshot);
     ...
     */
    Snapshot apply(ChangeSet changeset, SnapshotIdentifier applyTo);
     ...
     */
    Collection<Link> loadLinks(ClassTypedObject from, AssociationEnd otherEnd);
