...
public interface DebugListener {
    ...
    void started(RiverInterpreter interpreter);

    void resumed(RiverInterpreter interpreter, ResumeReason reason);

    void suspended(RiverInterpreter interpreter, SuspendReason reason);

    void terminated(RiverInterpreter interpreter);

    void hitBreakpoint(RiverInterpreter interpreter, RefObject element);
}
