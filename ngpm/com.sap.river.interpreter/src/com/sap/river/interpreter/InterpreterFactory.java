 ...
 */
public abstract class InterpreterFactory<C, T extends RefObject> extends GenericFactory<C, T, Interpreter<? extends T>> {
    public void registerInterpreter(Class<? extends Interpreter<? extends T>> handlerClass, C... classes) {
	registerHandlerClass(handlerClass, classes);
    }
    
    public Interpreter<? extends T> getInterpreterFor(T o) throws SecurityException, IllegalArgumentException,
