...
public class PathExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.PathExpressionImpl> implements behavior.expressions.PathExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public PathExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.PathExpressionImpl baseObject, boolean synchronize) {
    ...
    public behavior.expressions.__impl.PathExpressionImpl unwrap() {
        return (behavior.expressions.__impl.PathExpressionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (structure.Field) wrapResult(getCastWrappedObject().getField(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setField(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.PathExpression (Java Type)\nbehavior.expressions.PathExpression (MOF Type)"; //$NON-NLS-1$
    }    
}