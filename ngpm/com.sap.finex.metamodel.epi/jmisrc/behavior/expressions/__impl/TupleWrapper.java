...
public class TupleWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.TupleImpl> implements behavior.expressions.Tuple,com.sap.tc.moin.repository.Partitionable {
    ...
    public TupleWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.TupleImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.__impl.TupleImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.TupleImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.TupleImpl unwrap() {
        return (behavior.expressions.__impl.TupleImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.Tuple (Java Type)\nbehavior.expressions.Tuple (MOF Type)"; //$NON-NLS-1$
    }    
}