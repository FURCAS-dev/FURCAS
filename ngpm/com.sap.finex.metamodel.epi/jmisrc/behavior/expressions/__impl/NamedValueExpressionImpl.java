...
public final class NamedValueExpressionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("namedValue", Integer.valueOf(8)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C;
    ...
    // default constructor
    public NamedValueExpressionImpl() {
        super();
    }
    
    // specific constructor
    public NamedValueExpressionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getNamedValue() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getNamedValue(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C);
       
    }
    public void setNamedValue(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "E0003E7B0520A952D9B811DEC86D00155883529C", /* mofId of reference */ "E0003E7B051BC750D9B811DEA56D00155883529C" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    
    }
    public void setNamedValue(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "E0003E7B0520A952D9B811DEC86D00155883529C", /* mofId of reference */ "E0003E7B051BC750D9B811DEA56D00155883529C" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 7: 
                ...
                break;
            case 8: 
                result = getNamedValue(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 8:
                ___changeReference(connection, "E0003E7B0520A952D9B811DEC86D00155883529C" /* mofId of association */, "E0003E7B051BC750D9B811DEA56D00155883529C" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "E0003E7B0520A950D9B811DE991E00155883529C" ) { __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "E0003E7B0520A950D9B811DE991E00155883529C" ) { return __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C); } 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C); __A_namedValue_namedValueExpression_namedValue_E0003E7B0520A950D9B811DE991E00155883529C = null; } 
    ...
    public java.lang.Class<behavior.expressions.NamedValueExpression> get___JmiInterface() {
        return behavior.expressions.NamedValueExpression.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.__impl.NamedValueExpressionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.__impl.NamedValueExpressionWrapper(conn, this, synchronize);
    }
