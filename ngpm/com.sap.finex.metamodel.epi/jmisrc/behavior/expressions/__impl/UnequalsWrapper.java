...
public class UnequalsWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.UnequalsImpl> implements behavior.expressions.Unequals,com.sap.tc.moin.repository.Partitionable {
    ...
    public UnequalsWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.UnequalsImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavior.expressions.__impl.UnequalsImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.UnequalsImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.UnequalsImpl unwrap() {
        return (behavior.expressions.__impl.UnequalsImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.Unequals (Java Type)\nbehavior.expressions.Unequals (MOF Type)"; //$NON-NLS-1$
    }    
}