...
public class UnaryMinusWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.UnaryMinusImpl> implements behavior.expressions.UnaryMinus,com.sap.tc.moin.repository.Partitionable {
    ...
    public UnaryMinusWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.UnaryMinusImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.__impl.UnaryMinusImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.__impl.UnaryMinusImpl) resolved;
    }
    
    public behavior.expressions.__impl.UnaryMinusImpl unwrap() {
        return (behavior.expressions.__impl.UnaryMinusImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.UnaryMinus (Java Type)\nbehavior.expressions.UnaryMinus (MOF Type)"; //$NON-NLS-1$
    }    
}