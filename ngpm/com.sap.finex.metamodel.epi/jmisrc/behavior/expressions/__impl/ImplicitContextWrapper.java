...
public class ImplicitContextWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.ImplicitContextImpl> implements behavior.expressions.ImplicitContext,com.sap.tc.moin.repository.Partitionable {
    ...
    public ImplicitContextWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.ImplicitContextImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.__impl.ImplicitContextImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.ImplicitContextImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.ImplicitContextImpl unwrap() {
        return (behavior.expressions.__impl.ImplicitContextImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.ImplicitContext (Java Type)\nbehavior.expressions.ImplicitContext (MOF Type)"; //$NON-NLS-1$
    }    
}