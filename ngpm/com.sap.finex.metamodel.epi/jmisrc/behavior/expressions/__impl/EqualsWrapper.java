...
public class EqualsWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.EqualsImpl> implements behavior.expressions.Equals,com.sap.tc.moin.repository.Partitionable {
    ...
    public EqualsWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.EqualsImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavior.expressions.__impl.EqualsImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.EqualsImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.EqualsImpl unwrap() {
        return (behavior.expressions.__impl.EqualsImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.Equals (Java Type)\nbehavior.expressions.Equals (MOF Type)"; //$NON-NLS-1$
    }    
}