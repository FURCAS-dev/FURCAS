...
public class NumericAggregateWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.NumericAggregateImpl> implements behavior.expressions.NumericAggregate,com.sap.tc.moin.repository.Partitionable {
    ...
    public NumericAggregateWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.NumericAggregateImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.__impl.NumericAggregateImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.NumericAggregateImpl) getWrappedObject();
    }
    
    private behavior.expressions.__impl.NumericAggregateImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.__impl.NumericAggregateImpl) resolved;
    }
    
    public behavior.expressions.__impl.NumericAggregateImpl unwrap() {
        return (behavior.expressions.__impl.NumericAggregateImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavior.expressions.Expression) wrapResult(getCastWrappedObject().getOperand(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setOperand(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.NumericAggregate (Java Type)\nbehavior.expressions.NumericAggregate (MOF Type)"; //$NON-NLS-1$
    }    
}