...
public final class ObjectCreationExpressionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("classToInstantiate", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("fieldInitializers", Integer.valueOf(8)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3;
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3);
    ...
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "E0003E7B9F8E2702D38811DEADFA001A6BCDC3B3" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.Collection getFieldInitializers(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "E0003E7B9F8E2702D38811DEADFA001A6BCDC3B3" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 7: 
                ...
                break;
            case 8: 
                result = getFieldInitializers(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 7:
                ___changeReference(connection, "E0003E7B5D7C25C3D38211DEA788001A6BCDC3B3" /* mofId of association */, "E0003E7B5D61E700D38211DECC9B001A6BCDC3B3" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 8:
                ___changeReference(connection, "E0003E7B9F8E2702D38811DEADFA001A6BCDC3B3" /* mofId of association */, "E0003E7B9F8BB600D38811DE88C9001A6BCDC3B3" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3" ) { __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3 = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3" ) { return __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3); } 
        ...
        if ( __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3" ) { return __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3" ) { __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3 = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3); __A_classToInstantiate_objectCreationExpression_classToInstantiate_E0003E7B5D7C25C1D38211DEB385001A6BCDC3B3 = null; } 
        ...
        if ( __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3 != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3); __A_fieldInitializers_creationExpression_fieldInitializers_E0003E7B9F8E2700D38811DEC8EC001A6BCDC3B3 = null; } 
        return result;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.__impl.ObjectCreationExpressionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.__impl.ObjectCreationExpressionWrapper(conn, this, synchronize);
    }
