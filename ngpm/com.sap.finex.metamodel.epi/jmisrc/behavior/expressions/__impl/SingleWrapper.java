...
public class SingleWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.SingleImpl> implements behavior.expressions.Single,com.sap.tc.moin.repository.Partitionable {
    ...
    public behavior.expressions.__impl.SingleImpl unwrap() {
        return (behavior.expressions.__impl.SingleImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.Single (Java Type)\nbehavior.expressions.Single (MOF Type)"; //$NON-NLS-1$
    }    
}