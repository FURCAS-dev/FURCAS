...
public class ObjectCreationExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.ObjectCreationExpressionImpl> implements behavior.expressions.ObjectCreationExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public ObjectCreationExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.ObjectCreationExpressionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.__impl.ObjectCreationExpressionImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.ObjectCreationExpressionImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.ObjectCreationExpressionImpl unwrap() {
        return (behavior.expressions.__impl.ObjectCreationExpressionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (structure.FinexClass) wrapResult(getCastWrappedObject().getClassToInstantiate(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setClassToInstantiate(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<behavior.expressions.FieldInitializer>) wrapResult(getCastWrappedObject().getFieldInitializers(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.ObjectCreationExpression (Java Type)\nbehavior.expressions.ObjectCreationExpression (MOF Type)"; //$NON-NLS-1$
    }    
}