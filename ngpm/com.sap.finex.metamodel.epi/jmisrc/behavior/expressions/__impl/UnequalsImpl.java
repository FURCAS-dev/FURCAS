...
public final class UnequalsImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("left", Integer.valueOf(7)); //$NON-NLS-1$
        FEATURE_IDS.put("right", Integer.valueOf(8)); //$NON-NLS-1$
    ...
    public UnequalsImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    public java.lang.Class<behavior.expressions.Unequals> get___JmiInterface() {
        return behavior.expressions.Unequals.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.__impl.UnequalsImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.__impl.UnequalsWrapper(conn, this, synchronize);
    }
