...
public final class EqualsImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    public java.lang.Class<behavior.expressions.Equals> get___JmiInterface() {
        return behavior.expressions.Equals.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.__impl.EqualsImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.__impl.EqualsWrapper(conn, this, synchronize);
    }
