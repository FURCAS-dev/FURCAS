...
public class NotWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.NotImpl> implements behavior.expressions.Not,com.sap.tc.moin.repository.Partitionable {
    ...
    public NotWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.NotImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.__impl.NotImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.__impl.NotImpl) resolved;
    }
    
    public behavior.expressions.__impl.NotImpl unwrap() {
        return (behavior.expressions.__impl.NotImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.Not (Java Type)\nbehavior.expressions.Not (MOF Type)"; //$NON-NLS-1$
    }    
}