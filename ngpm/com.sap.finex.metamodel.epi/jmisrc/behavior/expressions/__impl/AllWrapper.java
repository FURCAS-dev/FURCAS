...
public class AllWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.AllImpl> implements behavior.expressions.All,com.sap.tc.moin.repository.Partitionable {
    ...
    public AllWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.AllImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavior.expressions.__impl.AllImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.AllImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.AllImpl unwrap() {
        return (behavior.expressions.__impl.AllImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.All (Java Type)\nbehavior.expressions.All (MOF Type)"; //$NON-NLS-1$
    }    
}