...
public class NamedValueExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.NamedValueExpressionImpl> implements behavior.expressions.NamedValueExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public NamedValueExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.NamedValueExpressionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavior.expressions.__impl.NamedValueExpressionImpl getCastWrappedObject() {
        return (behavior.expressions.__impl.NamedValueExpressionImpl) getWrappedObject();
    }
    
    public behavior.expressions.__impl.NamedValueExpressionImpl unwrap() {
        return (behavior.expressions.__impl.NamedValueExpressionImpl) getWrappedObject();
    }
    ...
    public behavior.actions.NamedValue getNamedValue() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavior.actions.NamedValue) wrapResult(getCastWrappedObject().getNamedValue(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setNamedValue(behavior.actions.NamedValue newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.NamedValueExpression (Java Type)\nbehavior.expressions.NamedValueExpression (MOF Type)"; //$NON-NLS-1$
    }    
}