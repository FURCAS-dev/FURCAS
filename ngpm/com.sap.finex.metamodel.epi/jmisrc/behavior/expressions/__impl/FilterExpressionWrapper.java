...
public class FilterExpressionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.FilterExpressionImpl> implements behavior.expressions.FilterExpression,com.sap.tc.moin.repository.Partitionable {
    ...
    public FilterExpressionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.FilterExpressionImpl baseObject, boolean synchronize) {
    ...
    public behavior.expressions.__impl.FilterExpressionImpl unwrap() {
        return (behavior.expressions.__impl.FilterExpressionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.FilterExpression (Java Type)\nbehavior.expressions.FilterExpression (MOF Type)"; //$NON-NLS-1$
    }    
}