...
public class BinaryNumericOperatorWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.BinaryNumericOperatorImpl> implements behavior.expressions.BinaryNumericOperator,com.sap.tc.moin.repository.Partitionable {
    ...
    public BinaryNumericOperatorWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.BinaryNumericOperatorImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.__impl.BinaryNumericOperatorImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.__impl.BinaryNumericOperatorImpl) resolved;
    }
    
    public behavior.expressions.__impl.BinaryNumericOperatorImpl unwrap() {
        return (behavior.expressions.__impl.BinaryNumericOperatorImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.BinaryNumericOperator (Java Type)\nbehavior.expressions.BinaryNumericOperator (MOF Type)"; //$NON-NLS-1$
    }    
}