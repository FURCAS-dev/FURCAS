...
public class ThisWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.ThisImpl> implements behavior.expressions.This,com.sap.tc.moin.repository.Partitionable {
    ...
    public ThisWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.ThisImpl baseObject, boolean synchronize) {
    ...
    public behavior.expressions.__impl.ThisImpl unwrap() {
        return (behavior.expressions.__impl.ThisImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.This (Java Type)\nbehavior.expressions.This (MOF Type)"; //$NON-NLS-1$
    }    
}