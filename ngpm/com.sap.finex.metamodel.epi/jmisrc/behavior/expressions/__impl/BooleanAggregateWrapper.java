...
public class BooleanAggregateWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.BooleanAggregateImpl> implements behavior.expressions.BooleanAggregate,com.sap.tc.moin.repository.Partitionable {
    ...
    public BooleanAggregateWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.BooleanAggregateImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.__impl.BooleanAggregateImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.__impl.BooleanAggregateImpl) resolved;
    }
    
    public behavior.expressions.__impl.BooleanAggregateImpl unwrap() {
        return (behavior.expressions.__impl.BooleanAggregateImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.BooleanAggregate (Java Type)\nbehavior.expressions.BooleanAggregate (MOF Type)"; //$NON-NLS-1$
    }    
}