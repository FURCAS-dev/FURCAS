...
public class CountWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.__impl.CountImpl> implements behavior.expressions.Count,com.sap.tc.moin.repository.Partitionable {
    ...
    public CountWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.__impl.CountImpl baseObject, boolean synchronize) {
    ...
    public behavior.expressions.__impl.CountImpl unwrap() {
        return (behavior.expressions.__impl.CountImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.Count (Java Type)\nbehavior.expressions.Count (MOF Type)"; //$NON-NLS-1$
    }    
}