...
public final class FirstPathExpressionImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("operand", Integer.valueOf(5)); //$NON-NLS-1$
        FEATURE_IDS.put("field", Integer.valueOf(6)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C;
    private com.sap.tc.moin.repository.core.EndStorageLink __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C;

    // default constructor
    public FirstPathExpressionImpl() {
        super();
    }
    
    // specific constructor
    public FirstPathExpressionImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getOperand(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C);
    ...
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getField() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C);
       
    }
    public com.sap.tc.moin.repository.mmi.reflect.RefBaseObject getField(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C);
       
    }
    public void setField(com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "E0003E7BA21E5A02B74811DEBA0100155883529C", /* mofId of reference */ "E0003E7BA2127320B74811DE9B7400155883529C" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    
    }
    public void setField(com.sap.tc.moin.repository.core.CoreConnection connection, com.sap.tc.moin.repository.mmi.reflect.RefBaseObject newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
          ___changeReference(connection, /* mofId of association */ "E0003E7BA21E5A02B74811DEBA0100155883529C", /* mofId of reference */ "E0003E7BA2127320B74811DE9B7400155883529C" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                result = getOperand(connection);
                break;
            case 6: 
                result = getField(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 5:
                ___changeReference(connection, "E0003E7BC4631A81B74111DEABD500155883529C" /* mofId of association */, "E0003E7BB308C962B4A311DEC1680019D29902CC" /* mofId of reference */, value, 1); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 6:
                ___changeReference(connection, "E0003E7BA21E5A02B74811DEBA0100155883529C" /* mofId of association */, "E0003E7BA2127320B74811DE9B7400155883529C" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "E0003E7BA21E5A00B74811DE9DB300155883529C" ) { __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C = value; return; } //$NON-NLS-1$ 
        if ( associationEndMofId == "E0003E7BC4631A80B74111DEC5CF00155883529C" ) { __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C = value; return; } //$NON-NLS-1$ 
    }
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "E0003E7BA21E5A00B74811DE9DB300155883529C" ) { return __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C; } //$NON-NLS-1$ 
        if ( associationEndMofId == "E0003E7BC4631A80B74111DEC5CF00155883529C" ) { return __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C; } //$NON-NLS-1$ 
        return null;
    }
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C); } 
        if ( __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C); } 
        return result;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C); __A_field_pathExpression_field_E0003E7BA21E5A00B74811DE9DB300155883529C = null; } 
        if ( __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C); __A_operandOf_operand_operand_E0003E7BC4631A80B74111DEC5CF00155883529C = null; } 
        return result;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.__impl.FirstPathExpressionImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.__impl.FirstPathExpressionWrapper(conn, this, synchronize);
    }
