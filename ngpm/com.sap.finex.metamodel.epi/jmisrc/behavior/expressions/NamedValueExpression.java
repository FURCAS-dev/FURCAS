 ...
 */
public interface NamedValueExpression extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.NamedValueExpression> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.NamedValueExpression>("E0003E7B051E3850D9B811DECA0A00155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "NamedValueExpression"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.NamedValueExpression,behavior.actions.NamedValue> __namedValue;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.NamedValueExpression,behavior.actions.NamedValue> NAMED_VALUE( ) {
            if ( __namedValue == null ) {
                __namedValue = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.NamedValueExpression,behavior.actions.NamedValue>( "E0003E7B051BC750D9B811DEA56D00155883529C", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "NamedValueExpression", "namedValue" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __namedValue;
        }
        /**
