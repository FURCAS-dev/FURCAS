 ...
 */
public interface All extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.All> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.All>("E0003E7BBEA107E1DD9A11DEA92BEAE40A140E7A", "sap.com/finex/metamodel", "behavior", "expressions", "All"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.All,structure.FinexClass> __clazz;
        /**
         * Returns the descriptor for the <code>clazz</code> reference.
         * @return  the descriptor for the <code>clazz</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.All,structure.FinexClass> CLAZZ( ) {
            if ( __clazz == null ) {
                __clazz = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.All,structure.FinexClass>( "E0003E7BBEA107E0DD9A11DEA693EAE40A140E7A", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "All", "clazz" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __clazz;
        }
        /**
