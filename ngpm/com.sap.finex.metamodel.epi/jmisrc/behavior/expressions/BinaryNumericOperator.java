 ...
 */
public interface BinaryNumericOperator extends behavior.expressions.NumericOperatorExpression,behavior.expressions.BinaryOperator {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.BinaryNumericOperator> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.BinaryNumericOperator>("E0003E7BDB8D8F7CB27C11DEAA1C00155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "BinaryNumericOperator"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
