 ...
 */
public interface Literal extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.Literal> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.Literal>("E0003E7B7484E777B1A911DEADF900155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "literals", "Literal"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,behavior.expressions.literals.Literal,java.lang.String> __literal;
        /**
         * Returns the descriptor for the <code>literal</code> attribute.
         * @return  the descriptor for the <code>literal</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,behavior.expressions.literals.Literal,java.lang.String> LITERAL( ) {
            if ( __literal == null ) {
                __literal = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,behavior.expressions.literals.Literal,java.lang.String>( "E0003E7B7484E776B1A911DEB12900155883529C", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "literals", "Literal", "literal" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __literal;
        }
        /**
