 ...
 */
public interface BinaryLiteral extends behavior.expressions.literals.Literal {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.BinaryLiteral> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.BinaryLiteral>("E0003E7BF5682398B1C511DEACE0001A6BCDC3B3", "sap.com/finex/metamodel", "behavior", "expressions", "literals", "BinaryLiteral"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
