 ...
 */
public interface MultiObjectLiteral extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.MultiObjectLiteral> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.MultiObjectLiteral>("E0003E7BBAB3A351DA7411DEA1A900155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "literals", "MultiObjectLiteral"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.literals.MultiObjectLiteral,java.util.Collection<behavior.expressions.Expression>> __elements;
        /**
         * Returns the descriptor for the <code>elements</code> reference.
         * @return  the descriptor for the <code>elements</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.literals.MultiObjectLiteral,java.util.Collection<behavior.expressions.Expression>> ELEMENTS( ) {
            if ( __elements == null ) {
                __elements = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.literals.MultiObjectLiteral,java.util.Collection<behavior.expressions.Expression>>( "E0003E7BBAB3A350DA7411DEBA5300155883529C", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "literals", "MultiObjectLiteral", "elements" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __elements;
        }
        /**
