 ...
 */
public interface IntegerLiteral extends behavior.expressions.literals.Literal {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.IntegerLiteral> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.IntegerLiteral>("E0003E7BF5682395B1C511DE9DE2001A6BCDC3B3", "sap.com/finex/metamodel", "behavior", "expressions", "literals", "IntegerLiteral"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
