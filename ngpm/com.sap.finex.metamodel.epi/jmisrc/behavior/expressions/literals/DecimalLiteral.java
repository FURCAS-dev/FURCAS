 ...
 */
public interface DecimalLiteral extends behavior.expressions.literals.Literal {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.DecimalLiteral> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.literals.DecimalLiteral>("E0003E7BF5682396B1C511DECE88001A6BCDC3B3", "sap.com/finex/metamodel", "behavior", "expressions", "literals", "DecimalLiteral"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
