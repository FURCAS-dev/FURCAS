...
public class IntegerLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.literals.__impl.IntegerLiteralImpl> implements behavior.expressions.literals.IntegerLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public IntegerLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.literals.__impl.IntegerLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.literals.__impl.IntegerLiteralImpl getCastWrappedObject() {
        return (behavior.expressions.literals.__impl.IntegerLiteralImpl) getWrappedObject();
    }
    
    private behavior.expressions.literals.__impl.IntegerLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.literals.__impl.IntegerLiteralImpl) resolved;
    }
    
    public behavior.expressions.literals.__impl.IntegerLiteralImpl unwrap() {
        return (behavior.expressions.literals.__impl.IntegerLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.literals.IntegerLiteral (Java Type)\nbehavior.expressions.literals.IntegerLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}