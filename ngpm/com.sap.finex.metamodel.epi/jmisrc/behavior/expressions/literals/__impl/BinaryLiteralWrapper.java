...
public class BinaryLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.literals.__impl.BinaryLiteralImpl> implements behavior.expressions.literals.BinaryLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public BinaryLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.literals.__impl.BinaryLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private behavior.expressions.literals.__impl.BinaryLiteralImpl getCastWrappedObject() {
        return (behavior.expressions.literals.__impl.BinaryLiteralImpl) getWrappedObject();
    }
    
    private behavior.expressions.literals.__impl.BinaryLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.literals.__impl.BinaryLiteralImpl) resolved;
    }
    
    public behavior.expressions.literals.__impl.BinaryLiteralImpl unwrap() {
        return (behavior.expressions.literals.__impl.BinaryLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.literals.BinaryLiteral (Java Type)\nbehavior.expressions.literals.BinaryLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}