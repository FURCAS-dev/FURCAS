...
public class MultiObjectLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.literals.__impl.MultiObjectLiteralImpl> implements behavior.expressions.literals.MultiObjectLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public MultiObjectLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.literals.__impl.MultiObjectLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.literals.__impl.MultiObjectLiteralImpl getCastWrappedObject() {
        return (behavior.expressions.literals.__impl.MultiObjectLiteralImpl) getWrappedObject();
    }
    
    public behavior.expressions.literals.__impl.MultiObjectLiteralImpl unwrap() {
        return (behavior.expressions.literals.__impl.MultiObjectLiteralImpl) getWrappedObject();
    }
    ...
    public java.util.Collection<behavior.expressions.Expression> getElements() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<behavior.expressions.Expression>) wrapResult(getCastWrappedObject().getElements(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.literals.MultiObjectLiteral (Java Type)\nbehavior.expressions.literals.MultiObjectLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}