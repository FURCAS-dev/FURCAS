...
public class DecimalLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.literals.__impl.DecimalLiteralImpl> implements behavior.expressions.literals.DecimalLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public DecimalLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.literals.__impl.DecimalLiteralImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.literals.__impl.DecimalLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.literals.__impl.DecimalLiteralImpl) resolved;
    }
    
    public behavior.expressions.literals.__impl.DecimalLiteralImpl unwrap() {
        return (behavior.expressions.literals.__impl.DecimalLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.literals.DecimalLiteral (Java Type)\nbehavior.expressions.literals.DecimalLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}