...
public class DateLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.literals.__impl.DateLiteralImpl> implements behavior.expressions.literals.DateLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public DateLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.literals.__impl.DateLiteralImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.literals.__impl.DateLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.literals.__impl.DateLiteralImpl) resolved;
    }
    
    public behavior.expressions.literals.__impl.DateLiteralImpl unwrap() {
        return (behavior.expressions.literals.__impl.DateLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.literals.DateLiteral (Java Type)\nbehavior.expressions.literals.DateLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}