...
public class BooleanLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.literals.__impl.BooleanLiteralImpl> implements behavior.expressions.literals.BooleanLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public BooleanLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.literals.__impl.BooleanLiteralImpl baseObject, boolean synchronize) {
    ...
    private behavior.expressions.literals.__impl.BooleanLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.expressions.literals.__impl.BooleanLiteralImpl) resolved;
    }
    
    public behavior.expressions.literals.__impl.BooleanLiteralImpl unwrap() {
        return (behavior.expressions.literals.__impl.BooleanLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.literals.BooleanLiteral (Java Type)\nbehavior.expressions.literals.BooleanLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}