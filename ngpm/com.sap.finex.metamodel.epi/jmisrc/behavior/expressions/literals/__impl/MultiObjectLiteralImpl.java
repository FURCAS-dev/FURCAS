...
public final class MultiObjectLiteralImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C;

    // default constructor
    public MultiObjectLiteralImpl() {
        super();
    }
    
    // specific constructor
    public MultiObjectLiteralImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "E0003E7BBAB3A354DA7411DE82E600155883529C" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    {
        return (java.util.Collection) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "E0003E7BBAB3A354DA7411DE82E600155883529C" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 8:
                ___changeReference(connection, "E0003E7BBAB3A354DA7411DE82E600155883529C" /* mofId of association */, "E0003E7BBAB3A350DA7411DEBA5300155883529C" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "E0003E7BBAB3A352DA7411DEB23200155883529C" ) { return __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "E0003E7BBAB3A352DA7411DEB23200155883529C" ) { __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C); __A_elements_literal_elements_E0003E7BBAB3A352DA7411DEB23200155883529C = null; } 
        return result;

    }
    // get the JMI interface
    public java.lang.Class<behavior.expressions.literals.MultiObjectLiteral> get___JmiInterface() {
        return behavior.expressions.literals.MultiObjectLiteral.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.literals.__impl.MultiObjectLiteralImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.literals.__impl.MultiObjectLiteralWrapper(conn, this, synchronize);
    }
