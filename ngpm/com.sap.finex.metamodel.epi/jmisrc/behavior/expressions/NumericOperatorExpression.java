 ...
 */
public interface NumericOperatorExpression extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.NumericOperatorExpression> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.NumericOperatorExpression>("E0003E7BDB8D8F84B27C11DEBBB100155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "NumericOperatorExpression"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,behavior.expressions.NumericOperatorExpression,java.lang.String> __operator;
        /**
         * Returns the descriptor for the <code>operator</code> attribute.
         * @return  the descriptor for the <code>operator</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,behavior.expressions.NumericOperatorExpression,java.lang.String> OPERATOR( ) {
            if ( __operator == null ) {
                __operator = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,behavior.expressions.NumericOperatorExpression,java.lang.String>( "E0003E7BB308C960B4A311DE888A0019D29902CC", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "NumericOperatorExpression", "operator" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
            }
            return __operator;
        }
        /**
