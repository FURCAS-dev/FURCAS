...
/**
 * Evaluates to the object of the enclosing entity/class on which the currently executing function, action, determination, validation, each block or condition is being executed. Its type can be determined by calling getEnclosingType().
 * This interface is not intended to be implemented by clients.
 */
public interface This extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.This> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.This>("E0003E7BB92CE450B72A11DE971700155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "This"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
