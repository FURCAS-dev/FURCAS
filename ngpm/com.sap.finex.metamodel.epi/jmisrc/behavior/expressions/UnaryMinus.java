 ...
 */
public interface UnaryMinus extends behavior.expressions.UnaryNumericOperator {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.UnaryMinus> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.UnaryMinus>("E0003E7B2B5FC100B4A611DEB2420019D29902CC", "sap.com/finex/metamodel", "behavior", "expressions", "UnaryMinus"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
