...
public class OqlQueryWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.expressions.oql.__impl.OqlQueryImpl> implements behavior.expressions.oql.OqlQuery,com.sap.tc.moin.repository.Partitionable {
    ...
    public OqlQueryWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.expressions.oql.__impl.OqlQueryImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private behavior.expressions.oql.__impl.OqlQueryImpl getCastWrappedObject() {
        return (behavior.expressions.oql.__impl.OqlQueryImpl) getWrappedObject();
    }
    
    public behavior.expressions.oql.__impl.OqlQueryImpl unwrap() {
        return (behavior.expressions.oql.__impl.OqlQueryImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavior.expressions.Expression) wrapResult(getCastWrappedObject().getCondition(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public java.util.List<behavior.expressions.oql.FromClause> getFromClauses() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<behavior.expressions.oql.FromClause>) wrapResult(getCastWrappedObject().getFromClauses(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "behavior.expressions.oql.OqlQuery (Java Type)\nbehavior.expressions.oql.OqlQuery (MOF Type)"; //$NON-NLS-1$
    }    
}