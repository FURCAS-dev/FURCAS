...
public final class OqlQueryImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    static {
        ...
        FEATURE_IDS.put("fromClauses", Integer.valueOf(9)); //$NON-NLS-1$
    ...
    private com.sap.tc.moin.repository.core.EndStorageLink __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A;
    ...
    private java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A;
    ...
    public OqlQueryImpl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( get___CurrentConnection(), __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A);
    ...
    {
        return (com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) ___getElementAtOtherLinkEnd( connection, __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A);
    ...
    {
          ___changeReference(get___CurrentConnection(), /* mofId of association */ "E0003E7B51BED7DAE31A11DEB03BE86A0A140E7A", /* mofId of reference */ "E0003E7B51BC66D1E31A11DE9379E86A0A140E7A" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    {
          ___changeReference(connection, /* mofId of association */ "E0003E7B51BED7DAE31A11DEB03BE86A0A140E7A", /* mofId of reference */ "E0003E7B51BC66D1E31A11DE9379E86A0A140E7A" , newValue, 0); //$NON-NLS-1$ //$NON-NLS-2$
    
    }
    public java.util.List getFromClauses() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( get___CurrentConnection(), this, get___EndAndMetaObject( "E0003E7B51BED7D7E31A11DE805EE86A0A140E7A" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
       
    }
    public java.util.List getFromClauses(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        return (java.util.List) ___getElementsAtOtherLinkEnd( connection, this, get___EndAndMetaObject( "E0003E7B51BED7D7E31A11DE805EE86A0A140E7A" /* attribute or association */, 0 ) ) ; //$NON-NLS-1$
    ...
    public java.lang.Object refGetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName) {
        ...
        switch (featureId) {
            ...
            case 8: 
                ...
                break;
            case 9: 
                result = getFromClauses(connection);
                break;
        default:
            throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(featureName, refMetaObject(), "refGetValue(String)"); //$NON-NLS-1$
        }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            ...
            case 8:
                ___changeReference(connection, "E0003E7B51BED7DAE31A11DEB03BE86A0A140E7A" /* mofId of association */, "E0003E7B51BC66D1E31A11DE9379E86A0A140E7A" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
                    
            case 9:
                ___changeReference(connection, "E0003E7B51BED7D7E31A11DE805EE86A0A140E7A" /* mofId of association */, "E0003E7B51BC66D0E31A11DE8EABE86A0A140E7A" /* mofId of reference */, value, 0); //$NON-NLS-1$ //$NON-NLS-2$     
                break;
    ...
    public void set___AssociationLink( String associationEndMofId, com.sap.tc.moin.repository.core.EndStorageLink value ) {
        ...
        if ( associationEndMofId == "E0003E7B51BED7D8E31A11DEA178E86A0A140E7A" ) { __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A = value; return; } //$NON-NLS-1$ 
    ...
    public com.sap.tc.moin.repository.core.EndStorageLink get___AssociationLink( String associationEndMofId ) {
        ...
        if ( associationEndMofId == "E0003E7B51BED7D8E31A11DEA178E86A0A140E7A" ) { return __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A; } //$NON-NLS-1$ 
    ...
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> get___AllStoredLinks( ) {
        ...
        if ( __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A); } 
        ...
        if ( __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A); } 
        return result;
    ...
    public java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> get___AssociationLinks( String associationEndMofId ) {
        if ( associationEndMofId == "E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A" ) { return __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A; } //$NON-NLS-1$ 
        return null;
    }
    ...
    public void set___AssociationLinks( java.util.Collection<com.sap.tc.moin.repository.core.EndStorageLink> links, String associationEndMofId ) {
        if ( associationEndMofId == "E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A" ) { __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A = links; return; } //$NON-NLS-1$ 
    }    
    public java.util.List<com.sap.tc.moin.repository.core.EndStorageLink> clear___AllLinks( ) {
        ...
        if ( __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.add( __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A); __A_condition_conditionOfOqlQuery_condition_E0003E7B51BED7D8E31A11DEA178E86A0A140E7A = null; } 
        ...
        if ( __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A != null ) { if ( result == null ) result = new java.util.ArrayList<com.sap.tc.moin.repository.core.EndStorageLink>( ); result.addAll( __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A); __A_fromClauses_fromClauseOfOqlQuery_fromClauses_E0003E7B51BED7D5E31A11DE9FDFE86A0A140E7A = null; } 
        return result;

    }
    // get the JMI interface
    public java.lang.Class<behavior.expressions.oql.OqlQuery> get___JmiInterface() {
        return behavior.expressions.oql.OqlQuery.class;
    }

    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<behavior.expressions.oql.__impl.OqlQueryImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new behavior.expressions.oql.__impl.OqlQueryWrapper(conn, this, synchronize);
    }
