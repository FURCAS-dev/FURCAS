 ...
 */
public interface OqlQuery extends behavior.expressions.Expression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.oql.OqlQuery> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.oql.OqlQuery>("E0003E7B51BC66D2E31A11DEAB01E86A0A140E7A", "sap.com/finex/metamodel", "behavior", "expressions", "oql", "OqlQuery"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.oql.OqlQuery,behavior.expressions.Expression> __condition;
        /**
         * Returns the descriptor for the <code>condition</code> reference.
         * @return  the descriptor for the <code>condition</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.oql.OqlQuery,behavior.expressions.Expression> CONDITION( ) {
            if ( __condition == null ) {
                __condition = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.oql.OqlQuery,behavior.expressions.Expression>( "E0003E7B51BC66D1E31A11DE9379E86A0A140E7A", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "oql", "OqlQuery", "condition" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __condition;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.oql.OqlQuery,java.util.List<behavior.expressions.oql.FromClause>> __fromClauses;
        /**
         * Returns the descriptor for the <code>fromClauses</code> reference.
         * @return  the descriptor for the <code>fromClauses</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.oql.OqlQuery,java.util.List<behavior.expressions.oql.FromClause>> FROM_CLAUSES( ) {
            if ( __fromClauses == null ) {
                __fromClauses = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.oql.OqlQuery,java.util.List<behavior.expressions.oql.FromClause>>( "E0003E7B51BC66D0E31A11DE8EABE86A0A140E7A", "sap.com/finex/metamodel", new java.lang.String[] { "behavior", "expressions", "oql", "OqlQuery", "fromClauses" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __fromClauses;
        }
        /**
