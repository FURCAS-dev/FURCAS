 ...
 */
public interface FirstPathExpression extends behavior.expressions.PathExpression {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.FirstPathExpression> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, behavior.expressions.FirstPathExpression>("E0003E7B218D9BF0B73211DE91F500155883529C", "sap.com/finex/metamodel", "behavior", "expressions", "FirstPathExpression"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,behavior.expressions.PathExpression,structure.Field> FIELD( ) {
            return behavior.expressions.PathExpression.DESCRIPTORS.FIELD( );
        }
        /**
