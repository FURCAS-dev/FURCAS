...
public class ParameterWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.functions.__impl.ParameterImpl> implements behavior.functions.Parameter,com.sap.tc.moin.repository.Partitionable {
    ...
    public ParameterWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.functions.__impl.ParameterImpl baseObject, boolean synchronize) {
    ...
    private behavior.functions.__impl.ParameterImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.functions.__impl.ParameterImpl) resolved;
    }
    
    public behavior.functions.__impl.ParameterImpl unwrap() {
        return (behavior.functions.__impl.ParameterImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<behavior.expressions.Expression>) wrapResult(getCastWrappedObject().getExpression(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public structure.Type getEnclosingType() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            return (structure.Type)___invokeOperation(connection, 0, "E0001D0AC44D96B1B74111DEACE300155883529C", parameterList); //$NON-NLS-1$
    ...
    public structure.Type getImpliedType(java.lang.String name) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            ...
            return (structure.Type)___invokeOperation(connection, 1, "E0001D0AF446B591B1E711DECB850019D29902CC", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    protected String metaObjectToString() {
        return "behavior.functions.Parameter (Java Type)\nbehavior.functions.Parameter (MOF Type)"; //$NON-NLS-1$
    }    
}