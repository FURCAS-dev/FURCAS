...
public class FunctionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.functions.__impl.FunctionImpl> implements behavior.functions.Function,com.sap.tc.moin.repository.Partitionable {
    ...
    public FunctionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.functions.__impl.FunctionImpl baseObject, boolean synchronize) {
    ...
    private behavior.functions.__impl.FunctionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (behavior.functions.__impl.FunctionImpl) resolved;
    }
    
    public behavior.functions.__impl.FunctionImpl unwrap() {
        return (behavior.functions.__impl.FunctionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<behavior.functions.Parameter>) wrapResult(getCastWrappedObject().getParameters(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public boolean isSideEffectFree() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        ...
        try {
            return (java.lang.Boolean)___invokeOperation(connection, 0, "E0003E7B7E47C4A1B96D11DE932A001A6BCDC3B3", parameterList); //$NON-NLS-1$
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 0:
                return ___invokeOperation( connection, operationId, "E0003E7B7E47C4A1B96D11DE932A001A6BCDC3B3", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    protected String metaObjectToString() {
        return "behavior.functions.Function (Java Type)\nbehavior.functions.Function (MOF Type)"; //$NON-NLS-1$
    }    
}