...
public class ExpressionStatementWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.actions.__impl.ExpressionStatementImpl> implements behavior.actions.ExpressionStatement,com.sap.tc.moin.repository.Partitionable {
    ...
    public ExpressionStatementWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.actions.__impl.ExpressionStatementImpl baseObject, boolean synchronize) {
    ...
    public behavior.actions.__impl.ExpressionStatementImpl unwrap() {
        return (behavior.actions.__impl.ExpressionStatementImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavior.expressions.Expression) wrapResult(getCastWrappedObject().getExpression(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "behavior.actions.ExpressionStatement (Java Type)\nbehavior.actions.ExpressionStatement (MOF Type)"; //$NON-NLS-1$
    }    
}