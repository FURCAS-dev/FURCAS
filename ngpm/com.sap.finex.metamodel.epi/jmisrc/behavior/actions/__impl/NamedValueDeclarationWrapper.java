...
public class NamedValueDeclarationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<behavior.actions.__impl.NamedValueDeclarationImpl> implements behavior.actions.NamedValueDeclaration,com.sap.tc.moin.repository.Partitionable {
    ...
    public NamedValueDeclarationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, behavior.actions.__impl.NamedValueDeclarationImpl baseObject, boolean synchronize) {
    ...
    public behavior.actions.__impl.NamedValueDeclarationImpl unwrap() {
        return (behavior.actions.__impl.NamedValueDeclarationImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (behavior.actions.NamedValueWithOptionalInitExpression) wrapResult(getCastWrappedObject().getNamedValue(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "behavior.actions.NamedValueDeclaration (Java Type)\nbehavior.actions.NamedValueDeclaration (MOF Type)"; //$NON-NLS-1$
    }    
}