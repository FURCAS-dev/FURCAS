...
public class RiverConsoleView extends ViewPart {
	...
	output.setText(Messages.RiverConsoleView_3);
	...
	evaluateButton.setText(Messages.RiverConsoleView_5);
	...
	parent.getDisplay().asyncExec(new Runnable() {
	    public void run() {
		try {
		    evaluator = new Main("ngpm.stdlib", //$NON-NLS-1$
			    com.sap.river.interpreter.Activator.getDefault().getRunletDataStore());
		    initializeHTTPServer();
		    evaluateButton.setEnabled(true);
		    output.setText(Messages.RiverConsoleView_7);
		} catch (Exception e) {
		    output.setText(Messages.RiverConsoleView_8);
	...
	try {
	    ...
	    RunletHTTPHandler handler = new RunletHTTPHandler(evaluator.getInterpreter());
	...
	if (statement.equals("!context")) { //$NON-NLS-1$
	    BlockWrapper block = evaluator.getInterpreterOutermostBlockWrapper();
	    output.append(Messages.RiverConsoleView_2);
	    for (NamedValue variable : block.getVariables()) {
		output.append(variable.getName());
		output.append(" <" + variable.getType().toString() + ">\n"); //$NON-NLS-1$ //$NON-NLS-2$
	    }
	    output.append(Messages.RiverConsoleView_16);
	    for (Statement stmnt : block.getStatements()) {
		output.append(stmnt.getClass().toString() + "\n"); //$NON-NLS-1$
	    }
	} else if (statement.equals("!stack")) { //$NON-NLS-1$
	    output.append(Messages.RiverConsoleView_1);
	    ...
	    output.append(Messages.RiverConsoleView_23);
	    output.append(Messages.RiverConsoleView_24);
	    output.append(Messages.RiverConsoleView_25);
	    output.append(Messages.RiverConsoleView_26);
	    output.append(Messages.RiverConsoleView_27);
	    output.append(Messages.RiverConsoleView_28);
	    output.append(Messages.RiverConsoleView_29);
	    output.append(Messages.RiverConsoleView_30);
	    output.append(Messages.RiverConsoleView_42);
	} else {
	    output.append(Messages.RiverConsoleView_31 + statement + Messages.RiverConsoleView_32);
	}
	output.append(Messages.RiverConsoleView_33);
    }

    private void doRiverEvaluation(String statement) throws RecognitionException {
	ExecuteResult result = evaluator.execute(statement);
	...
	for (RiverObject riverObject : result.getResult()) {
	...
	output.append(Messages.RiverConsoleView_38);
    }
	...
	history.clear();
	shutdownHTTPServer();
	evaluator = new Main("ngpm.stdlib", com.sap.river.interpreter.Activator.getDefault().getRunletDataStore()); //$NON-NLS-1$
	initializeHTTPServer();
	evaluateButton.setEnabled(true);
	output.append(Messages.RiverConsoleView_40);
	evaluateButton.setEnabled(true);
	errorOutput.setText("");
    }
}