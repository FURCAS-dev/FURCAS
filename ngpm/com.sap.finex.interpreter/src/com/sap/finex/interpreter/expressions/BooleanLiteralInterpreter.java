...
implements Interpreter<BooleanLiteral, FinexClass, Type, FinexClass, Association, Field, Statement, Expression,
SignatureImplementation, FinexStackFrame, NativeImpl, FinexInterpreter> {
	...
	return new FinexNativeObject((FinexClass) literal.getType(),
		new Boolean(literal.getLiteral()), interpreter.getDefaultSnapshot(), interpreter);
    }
