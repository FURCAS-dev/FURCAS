...
public class DateLiteralInterpreter implements Interpreter<DateLiteral, FinexClass, Type, FinexClass,
Association, Field, Statement, Expression, SignatureImplementation, FinexStackFrame, NativeImpl, FinexInterpreter> {
    private DateLiteral literal;
    
    public DateLiteralInterpreter(DateLiteral literal) {
	...
	try {
	    return new FinexNativeObject((FinexClass) literal.getType(), DateParser.parse(literal.getLiteral()),
