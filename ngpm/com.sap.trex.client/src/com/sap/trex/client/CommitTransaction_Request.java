...
//
// created from CommitTransaction_Request.xsd/wsdl.  ! do not edit !
//
...
public class CommitTransaction_Request extends Request
{
    private ArrayList <String> itsIndexIds;
    private long               itsTransactionId;

    public CommitTransaction_Request ()
    {
    ...
    {
        throw new TrexException(Error.TDBC_WRITE_ONLY,"CommitTransaction_Request");
    }
    ...
    /**
     * \class CommitTransaction_Request
     *
     * \var indexIds       -
     * \var transactionId  -
     */
