...
//
// created from OlapGuidedNavSearch_Request.xsd/wsdl.  ! do not edit !
//
...
public class OlapGuidedNavSearch_Request extends Request
{
    ...
    private int                             itsGnavNumBestAttributes;
    private boolean                         itsGnavRestValue;
    private ArrayList <PlaceHolder>         itsPlaceHolders;

    public OlapGuidedNavSearch_Request ()
    {
        ...
        itsGnavNumBestAttributes = 0;
        itsGnavRestValue = false;
    ...
    {
        throw new TrexException(Error.TDBC_WRITE_ONLY,"OlapGuidedNavSearch_Request");
    }
    ...
    public void write(OutputStream theStream) throws IOException, TrexException
    {
        ...
        theStream.writeInt(itsGnavNumBestAttributes);
        theStream.writeBoolean(itsGnavRestValue);
    ...
    /**
     * \class OlapGuidedNavSearch_Request
     *
     * \var indexNames             -
     * \var commitId               -
     * \var transactionId          -
     ...
     * \var indexAliases           -
     * \var gnavNumBestAttributes  if set returen best n attributes, else return all
     *                             requested attributes
     * \var gnavRestValue          generate value for rest
     * \var placeHolders           -
     */
    ...
    public int getGnavNumBestAttributes() 
    {
        return itsGnavNumBestAttributes;
    }

    public void setGnavNumBestAttributes(int theGnavNumBestAttributes)
    {
        itsGnavNumBestAttributes = theGnavNumBestAttributes; 
    }


    public boolean getGnavRestValue() 
    {
        return itsGnavRestValue;
    }

    public void setGnavRestValue(boolean theGnavRestValue)
    {
        itsGnavRestValue = theGnavRestValue; 
    }
