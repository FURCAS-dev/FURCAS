 ...
 *
 * $Id: MinLengthSection.java,v 1.4 2008/05/26 12:28:57 jlescot Exp $
 **********************************************************************/
...
public class MinLengthSection extends AbstractTabbedPropertySection {
	...
	public void refresh() {
		...
		lengthTxt.setText("" + ExtendedMetaData.INSTANCE.getMinLengthFacet((EDataType) getEObject())); //$NON-NLS-1$
