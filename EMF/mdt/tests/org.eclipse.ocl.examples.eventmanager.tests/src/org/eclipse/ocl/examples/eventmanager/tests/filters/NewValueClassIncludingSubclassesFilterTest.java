 ...
 */
public class NewValueClassIncludingSubclassesFilterTest extends ClassFilterTest {
    ...
    public void setUp() {
    	...
    	setFixture(EventManagerFactory.eINSTANCE.createNewValueClassFilterIncludingSubclasses(cls));
    }
	...
	public EventFilter giveTestFilter() {
		return EventManagerFactory.eINSTANCE.createNewValueClassFilterIncludingSubclasses(testSuperCls);
	}
