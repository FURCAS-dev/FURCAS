...
/*	protected void reconcileChangedModel() {
		BaseDocument editorDocument = getEditorDocument();
...
/*	private class EcoreOCLFactory implements IOCLFactory {
...
/*    private class UMLOCLFactory implements IOCLFactory {
        public TargetMetamodel getTargetMetamodel() {
