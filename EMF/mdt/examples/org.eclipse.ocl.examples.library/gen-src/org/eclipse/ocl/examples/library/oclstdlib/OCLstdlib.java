 ...
 * Do not edit it.
 *
 * $Id: OCLstdlib.java,v 1.6 2011/02/19 12:00:34 ewillink Exp $
 */
...
public class OCLstdlib extends XMLResourceImpl
{
	...
	public static Library create()
	{
		...
		Package symbol_109 = PivotFactory.eINSTANCE.createPackage(); // orphanage
		...
		BagType symbol_112 = PivotFactory.eINSTANCE.createBagType(); // ocl!Bag[ocl!Collection{T}?T]
		
		BagType symbol_113 = PivotFactory.eINSTANCE.createBagType(); // ocl!Bag[ocl!NonOrderedCollection{T}?T]
		
		BagType symbol_114 = PivotFactory.eINSTANCE.createBagType(); // ocl!Bag[ocl!Bag{T}!flatten{T2}()?T2]
		
		CollectionType symbol_115 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!OclAny]
		...
		CollectionType symbol_119 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!NonOrderedCollection{T}?T]
		
		CollectionType symbol_120 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Collection{T}!includesAll{T2}(ocl!Collection[T2])?T2]
		
		CollectionType symbol_121 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Sequence{T}?T]
		
		CollectionType symbol_122 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!UniqueCollection{T}?T]
		
		CollectionType symbol_123 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Collection{T}?T]
		
		CollectionType symbol_124 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!OclInvalid]
		
		CollectionType symbol_125 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Collection{T}!collect{V}(ocl!Collection{T}?T|Lambda~T()V)?V]
		
		CollectionType symbol_126 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		
		CollectionType symbol_127 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		
		CollectionType symbol_128 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2]
		...
		CollectionType symbol_131 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		
		CollectionType symbol_132 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!NonUniqueCollection{T}?T]
		
		CollectionType symbol_133 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Bag{T}!flatten{T2}()?T2]
		
		CollectionType symbol_134 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!OrderedSet{T}?T]
		
		CollectionType symbol_135 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[Boolean]
		
		CollectionType symbol_136 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		
		CollectionType symbol_137 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Bag{T}?T]
		
		CollectionType symbol_138 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Set{T}?T]
		
		CollectionType symbol_139 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Collection{T}!excludesAll{T2}(ocl!Collection[T2])?T2]
		
		CollectionType symbol_140 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Collection{T}!flatten{T2}()?T2]
		
		CollectionType symbol_141 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!Sequence{T}!flatten{T2}()?T2]
		
		CollectionType symbol_142 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!Collection[ocl!OclVoid]
		
		LambdaType symbol_143 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~ocl!OrderedCollection{T}?T()ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_144 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~ocl!Collection{T}?T()ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_145 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~ocl!NonOrderedCollection{T}?T()ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		
		CollectionType symbol_146 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Bag{T}?T]
		
		CollectionType symbol_147 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		
		CollectionType symbol_148 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Set{T}?T]
		
		CollectionType symbol_149 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Bag{T}!flatten{T2}()?T2]
		
		CollectionType symbol_150 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!OclVoid]
		
		CollectionType symbol_151 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		
		CollectionType symbol_152 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[Boolean]
		
		CollectionType symbol_153 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Set{T}!flatten{T2}()?T2]
		
		CollectionType symbol_154 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!OrderedSet{T}?T]
		
		CollectionType symbol_155 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!OclAny]
		
		CollectionType symbol_156 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
		
		CollectionType symbol_157 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Collection{T}?T]
		
		CollectionType symbol_158 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!OclInvalid]
		
		CollectionType symbol_159 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		
		CollectionType symbol_160 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!Enumeration]
		
		CollectionType symbol_161 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}?T]
		
		CollectionType symbol_162 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!Bag{T}!flatten{T2}()?T2]
		
		CollectionType symbol_163 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		
		CollectionType symbol_164 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!NonUniqueCollection{T}?T]
		
		CollectionType symbol_165 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!Bag{T}?T]
		
		CollectionType symbol_166 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		
		CollectionType symbol_167 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!NonOrderedCollection{T}?T]
		
		CollectionType symbol_168 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!Collection{T}?T]
		
		CollectionType symbol_169 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[String]
		...
		CollectionType symbol_171 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!OrderedCollection{T}?T]
		
		CollectionType symbol_172 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!NonUniqueCollection[ocl!Sequence{T}?T]
		
		CollectionType symbol_173 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!OrderedCollection[ocl!OrderedSet{T}?T]
		
		CollectionType symbol_174 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!OrderedCollection[ocl!UniqueCollection{T}?T]
		
		CollectionType symbol_175 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!OrderedCollection[String]
		
		CollectionType symbol_176 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!OrderedCollection[ocl!Sequence{T}?T]
		
		CollectionType symbol_177 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!OrderedCollection[ocl!OrderedCollection{T}?T]
		
		CollectionType symbol_178 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!OrderedCollection[ocl!NonUniqueCollection{T}?T]
		...
		OrderedSetType symbol_183 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl!OrderedSet[ocl!OrderedSet{T}?T]
		
		OrderedSetType symbol_184 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl!OrderedSet[ocl!UniqueCollection{T}?T]
		
		OrderedSetType symbol_185 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl!OrderedSet[ocl!Collection{T}?T]
		
		SequenceType symbol_186 = PivotFactory.eINSTANCE.createSequenceType(); // ocl!Sequence[ocl!NonUniqueCollection{T}?T]
		
		SequenceType symbol_187 = PivotFactory.eINSTANCE.createSequenceType(); // ocl!Sequence[ocl!Sequence{T}!flatten{T2}()?T2]
		...
		SequenceType symbol_190 = PivotFactory.eINSTANCE.createSequenceType(); // ocl!Sequence[String]
		
		SequenceType symbol_191 = PivotFactory.eINSTANCE.createSequenceType(); // ocl!Sequence[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		
		SequenceType symbol_192 = PivotFactory.eINSTANCE.createSequenceType(); // ocl!Sequence[ocl!Collection{T}?T]
		
		SetType symbol_193 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[Boolean]
		
		SetType symbol_194 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!OclVoid]
		
		SetType symbol_195 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!Enumeration]
		
		SetType symbol_196 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!Set{T}?T]
		
		SetType symbol_197 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!Set{T}!flatten{T2}()?T2]
		
		SetType symbol_198 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!OclInvalid]
		
		SetType symbol_199 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		
		SetType symbol_200 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!NonOrderedCollection{T}?T]
		
		SetType symbol_201 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!Collection{T}?T]
		
		SetType symbol_202 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
		
		SetType symbol_203 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!OclAny]
		
		SetType symbol_204 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!OrderedSet{T}?T]
		
		SetType symbol_205 = PivotFactory.eINSTANCE.createSetType(); // ocl!Set[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		...
		CollectionType symbol_209 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!OclVoid]
		
		CollectionType symbol_210 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!OclInvalid]
		
		CollectionType symbol_211 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!OclAny]
		
		CollectionType symbol_212 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!Enumeration]
		
		CollectionType symbol_213 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!Set{T}!flatten{T2}()?T2]
		
		CollectionType symbol_214 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		
		CollectionType symbol_215 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!Collection{T}?T]
		
		CollectionType symbol_216 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!OrderedCollection{T}?T]
		...
		CollectionType symbol_218 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[Boolean]
		...
		CollectionType symbol_221 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!OrderedSet{T}?T]
		
		CollectionType symbol_222 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!UniqueCollection{T}?T]
		
		CollectionType symbol_223 = PivotFactory.eINSTANCE.createCollectionType(); // ocl!UniqueCollection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		...
		symbol_12.getSuperClasses().add(symbol_146); // ocl!NonOrderedCollection[ocl!Bag{T}?T]
		symbol_12.getSuperClasses().add(symbol_165); // ocl!NonUniqueCollection[ocl!Bag{T}?T]
		{	// ocl::Bag::<>() ocl!Bag{T}!<>(ocl!OclAny)
			Operation symbol_224 = PivotFactory.eINSTANCE.createOperation();
			symbol_224.setName("<>");
			//symbol_224.setMoniker("ocl!Bag{T}!<>(ocl!OclAny)");
			...
			//symbol_225.setMoniker("ocl!Bag{T}!<>(ocl!OclAny)!object2");
		...
		{	// ocl::Bag::=() ocl!Bag{T}!=(ocl!OclAny)
			...
			symbol_226.setName("=");
			//symbol_226.setMoniker("ocl!Bag{T}!=(ocl!OclAny)");
			...
			//symbol_227.setMoniker("ocl!Bag{T}!=(ocl!OclAny)!object2");
		...
		{	// ocl::Bag::excluding() ocl!Bag{T}!excluding(ocl!OclAny)
			...
			//symbol_228.setMoniker("ocl!Bag{T}!excluding(ocl!OclAny)");
			...
			//symbol_229.setMoniker("ocl!Bag{T}!excluding(ocl!OclAny)!object");
		...
		{	// ocl::Bag::flatten() ocl!Bag{T}!flatten{T2}()
			...
			//symbol_230.setMoniker("ocl!Bag{T}!flatten{T2}()");
			symbol_230.setType(symbol_114);  // ocl!Bag[ocl!Bag{T}!flatten{T2}()?T2]
		...
		{	// ocl::Bag::including() ocl!Bag{T}!including(ocl!Bag{T}?T)
			...
			//symbol_231.setMoniker("ocl!Bag{T}!including(ocl!Bag{T}?T)");
			symbol_231.setType(symbol_110);  // ocl!Bag[ocl!Bag{T}?T]
			...
			//symbol_232.setMoniker("ocl!Bag{T}!including(ocl!Bag{T}?T)!object");
		...
		{	// ocl::Bag::reject() ocl!Bag{T}!reject(ocl!Bag{T}?T)
			...
			//symbol_233.setMoniker("ocl!Bag{T}!reject(ocl!Bag{T}?T)");
			symbol_233.setType(symbol_110);  // ocl!Bag[ocl!Bag{T}?T]
		...
		{	// ocl::Bag::select() ocl!Bag{T}!select(ocl!Bag{T}?T)
			...
			//symbol_235.setMoniker("ocl!Bag{T}!select(ocl!Bag{T}?T)");
			symbol_235.setType(symbol_110);  // ocl!Bag[ocl!Bag{T}?T]
		...
		{	// ocl::Boolean::<>() Boolean!<>(ocl!OclAny)
			...
			symbol_237.setName("<>");
			//symbol_237.setMoniker("Boolean!<>(ocl!OclAny)");
			...
			//symbol_238.setMoniker("Boolean!<>(ocl!OclAny)!object2");
		...
		{	// ocl::Boolean::=() Boolean!=(ocl!OclAny)
			...
			symbol_239.setName("=");
			//symbol_239.setMoniker("Boolean!=(ocl!OclAny)");
			...
			//symbol_240.setMoniker("Boolean!=(ocl!OclAny)!object2");
		...
		{	// ocl::Boolean::allInstances() Boolean!allInstances()
			...
			//symbol_241.setMoniker("Boolean!allInstances()");
			symbol_241.setType(symbol_193);  // ocl!Set[Boolean]
		...
		{	// ocl::Boolean::and() Boolean!and(Boolean)
			...
			//symbol_242.setMoniker("Boolean!and(Boolean)");
			...
			//symbol_243.setMoniker("Boolean!and(Boolean)!b");
		...
		{	// ocl::Boolean::implies() Boolean!implies(Boolean)
			...
			//symbol_244.setMoniker("Boolean!implies(Boolean)");
			...
			//symbol_245.setMoniker("Boolean!implies(Boolean)!b");
		...
		{	// ocl::Boolean::not() Boolean!not()
			...
			//symbol_246.setMoniker("Boolean!not()");
		...
		{	// ocl::Boolean::or() Boolean!or(Boolean)
			...
			//symbol_247.setMoniker("Boolean!or(Boolean)");
			...
			//symbol_248.setMoniker("Boolean!or(Boolean)!b");
		...
		{	// ocl::Boolean::toString() Boolean!toString()
			...
			//symbol_249.setMoniker("Boolean!toString()");
		...
		{	// ocl::Boolean::xor() Boolean!xor(Boolean)
			...
			//symbol_250.setMoniker("Boolean!xor(Boolean)");
			...
			//symbol_251.setMoniker("Boolean!xor(Boolean)!b");
		...
		{	// ocl::Classifier::allInstances() ocl!Classifier!allInstances{OclSelf}()
			...
			//symbol_252.setMoniker("ocl!Classifier!allInstances{OclSelf}()");
			symbol_252.setType(symbol_199);  // ocl!Set[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		...
		{	// ocl::Collection::<>() ocl!Collection{T}!<>(ocl!OclAny)
			...
			symbol_253.setName("<>");
			//symbol_253.setMoniker("ocl!Collection{T}!<>(ocl!OclAny)");
			...
			//symbol_254.setMoniker("ocl!Collection{T}!<>(ocl!OclAny)!object2");
		...
		{	// ocl::Collection::=() ocl!Collection{T}!=(ocl!OclAny)
			...
			symbol_255.setName("=");
			//symbol_255.setMoniker("ocl!Collection{T}!=(ocl!OclAny)");
			...
			//symbol_256.setMoniker("ocl!Collection{T}!=(ocl!OclAny)!object2");
		...
		{	// ocl::Collection::any() ocl!Collection{T}!any(ocl!Collection{T}?T)
			...
			//symbol_257.setMoniker("ocl!Collection{T}!any(ocl!Collection{T}?T)");
		...
		{	// ocl::Collection::asBag() ocl!Collection{T}!asBag()
			...
			//symbol_259.setMoniker("ocl!Collection{T}!asBag()");
			symbol_259.setType(symbol_112);  // ocl!Bag[ocl!Collection{T}?T]
		...
		{	// ocl::Collection::asOrderedSet() ocl!Collection{T}!asOrderedSet()
			...
			//symbol_260.setMoniker("ocl!Collection{T}!asOrderedSet()");
			symbol_260.setType(symbol_185);  // ocl!OrderedSet[ocl!Collection{T}?T]
		...
		{	// ocl::Collection::asSequence() ocl!Collection{T}!asSequence()
			...
			//symbol_261.setMoniker("ocl!Collection{T}!asSequence()");
		...
		{	// ocl::Collection::asSet() ocl!Collection{T}!asSet()
			...
			//symbol_262.setMoniker("ocl!Collection{T}!asSet()");
			symbol_262.setType(symbol_201);  // ocl!Set[ocl!Collection{T}?T]
		...
		{	// ocl::Collection::collect() ocl!Collection{T}!collect{V}(ocl!Collection{T}?T|Lambda~T()V)
			...
			//symbol_263.setMoniker("ocl!Collection{T}!collect{V}(ocl!Collection{T}?T|Lambda~T()V)");
			symbol_263.setType(symbol_125);  // ocl!Collection[ocl!Collection{T}!collect{V}(ocl!Collection{T}?T|Lambda~T()V)?V]
			...
			//symbol_265.setMoniker("ocl!Collection{T}!collect{V}(ocl!Collection{T}?T|Lambda~T()V)!body");
			symbol_265.setType(symbol_144);  // Lambda~ocl!Collection{T}?T()ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V
		...
		{	// ocl::Collection::collectNested() ocl!Collection{T}!collectNested(ocl!Collection{T}?T)
			...
			//symbol_266.setMoniker("ocl!Collection{T}!collectNested(ocl!Collection{T}?T)");
			symbol_266.setType(symbol_123);  // ocl!Collection[ocl!Collection{T}?T]
		...
		{	// ocl::Collection::count() ocl!Collection{T}!count(ocl!OclAny)
			...
			//symbol_268.setMoniker("ocl!Collection{T}!count(ocl!OclAny)");
			...
			//symbol_269.setMoniker("ocl!Collection{T}!count(ocl!OclAny)!object");
		...
		{	// ocl::Collection::excludes() ocl!Collection{T}!excludes(ocl!OclAny)
			...
			//symbol_270.setMoniker("ocl!Collection{T}!excludes(ocl!OclAny)");
			...
			//symbol_271.setMoniker("ocl!Collection{T}!excludes(ocl!OclAny)!object");
		...
		{	// ocl::Collection::excludesAll() ocl!Collection{T}!excludesAll{T2}(ocl!Collection[T2])
			...
			//symbol_272.setMoniker("ocl!Collection{T}!excludesAll{T2}(ocl!Collection[T2])");
			...
			//symbol_273.setMoniker("ocl!Collection{T}!excludesAll{T2}(ocl!Collection[T2])!c2");
			symbol_273.setType(symbol_139);  // ocl!Collection[ocl!Collection{T}!excludesAll{T2}(ocl!Collection[T2])?T2]
		...
		{	// ocl::Collection::excluding() ocl!Collection{T}!excluding(ocl!OclAny)
			...
			//symbol_274.setMoniker("ocl!Collection{T}!excluding(ocl!OclAny)");
			symbol_274.setType(symbol_123);  // ocl!Collection[ocl!Collection{T}?T]
			...
			//symbol_275.setMoniker("ocl!Collection{T}!excluding(ocl!OclAny)!object");
		...
		{	// ocl::Collection::exists() ocl!Collection{T}!exists(ocl!Collection{T}?T)
			...
			//symbol_276.setMoniker("ocl!Collection{T}!exists(ocl!Collection{T}?T)");
		...
		{	// ocl::Collection::flatten() ocl!Collection{T}!flatten{T2}()
			...
			//symbol_281.setMoniker("ocl!Collection{T}!flatten{T2}()");
			symbol_281.setType(symbol_140);  // ocl!Collection[ocl!Collection{T}!flatten{T2}()?T2]
		...
		{	// ocl::Collection::forAll() ocl!Collection{T}!forAll(ocl!Collection{T}?T)
			...
			//symbol_282.setMoniker("ocl!Collection{T}!forAll(ocl!Collection{T}?T)");
		...
		{	// ocl::Collection::forAll() ocl!Collection{T}!forAll(ocl!Collection{T}?T,T)
			...
			//symbol_284.setMoniker("ocl!Collection{T}!forAll(ocl!Collection{T}?T,T)");
		...
		{	// ocl::Collection::includes() ocl!Collection{T}!includes(ocl!OclAny)
			...
			//symbol_287.setMoniker("ocl!Collection{T}!includes(ocl!OclAny)");
			...
			//symbol_288.setMoniker("ocl!Collection{T}!includes(ocl!OclAny)!object");
		...
		{	// ocl::Collection::includesAll() ocl!Collection{T}!includesAll{T2}(ocl!Collection[T2])
			...
			//symbol_289.setMoniker("ocl!Collection{T}!includesAll{T2}(ocl!Collection[T2])");
			...
			//symbol_290.setMoniker("ocl!Collection{T}!includesAll{T2}(ocl!Collection[T2])!c2");
			symbol_290.setType(symbol_120);  // ocl!Collection[ocl!Collection{T}!includesAll{T2}(ocl!Collection[T2])?T2]
		...
		{	// ocl::Collection::including() ocl!Collection{T}!including(ocl!Collection{T}?T)
			...
			//symbol_291.setMoniker("ocl!Collection{T}!including(ocl!Collection{T}?T)");
			symbol_291.setType(symbol_123);  // ocl!Collection[ocl!Collection{T}?T]
			...
			//symbol_292.setMoniker("ocl!Collection{T}!including(ocl!Collection{T}?T)!object");
		...
		{	// ocl::Collection::isEmpty() ocl!Collection{T}!isEmpty()
			...
			//symbol_293.setMoniker("ocl!Collection{T}!isEmpty()");
		...
		{	// ocl::Collection::isUnique() ocl!Collection{T}!isUnique(ocl!Collection{T}?T)
			...
			//symbol_294.setMoniker("ocl!Collection{T}!isUnique(ocl!Collection{T}?T)");
		...
		{	// ocl::Collection::iterate() ocl!Collection{T}!iterate{Tacc}(ocl!Collection{T}?T;Tacc)
			...
			//symbol_296.setMoniker("ocl!Collection{T}!iterate{Tacc}(ocl!Collection{T}?T;Tacc)");
		...
		{	// ocl::Collection::max() ocl!Collection{T}!max()
			...
			//symbol_299.setMoniker("ocl!Collection{T}!max()");
		...
		{	// ocl::Collection::min() ocl!Collection{T}!min()
			...
			//symbol_300.setMoniker("ocl!Collection{T}!min()");
		...
		{	// ocl::Collection::notEmpty() ocl!Collection{T}!notEmpty()
			...
			//symbol_301.setMoniker("ocl!Collection{T}!notEmpty()");
		...
		{	// ocl::Collection::one() ocl!Collection{T}!one(ocl!Collection{T}?T)
			...
			//symbol_302.setMoniker("ocl!Collection{T}!one(ocl!Collection{T}?T)");
		...
		{	// ocl::Collection::product() ocl!Collection{T}!product{T2}(ocl!Collection[T2])
			...
			//symbol_304.setMoniker("ocl!Collection{T}!product{T2}(ocl!Collection[T2])");
			symbol_304.setType(symbol_202);  // ocl!Set[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
			symbol_304.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_305 = PivotFactory.eINSTANCE.createParameter();
			symbol_305.setName("c2");
			//symbol_305.setMoniker("ocl!Collection{T}!product{T2}(ocl!Collection[T2])!c2");
			symbol_305.setType(symbol_128);  // ocl!Collection[ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2]
		...
		{	// ocl::Collection::reject() ocl!Collection{T}!reject(ocl!Collection{T}?T)
			...
			//symbol_306.setMoniker("ocl!Collection{T}!reject(ocl!Collection{T}?T)");
			symbol_306.setType(symbol_123);  // ocl!Collection[ocl!Collection{T}?T]
		...
		{	// ocl::Collection::select() ocl!Collection{T}!select(ocl!Collection{T}?T)
			...
			//symbol_308.setMoniker("ocl!Collection{T}!select(ocl!Collection{T}?T)");
			symbol_308.setType(symbol_123);  // ocl!Collection[ocl!Collection{T}?T]
		...
		{	// ocl::Collection::size() ocl!Collection{T}!size()
			...
			//symbol_310.setMoniker("ocl!Collection{T}!size()");
		...
		{	// ocl::Collection::sortedBy() ocl!Collection{T}!sortedBy(ocl!Collection{T}?T)
			...
			//symbol_311.setMoniker("ocl!Collection{T}!sortedBy(ocl!Collection{T}?T)");
		...
		{	// ocl::Collection::sum() ocl!Collection{T}!sum()
			...
			//symbol_313.setMoniker("ocl!Collection{T}!sum()");
		...
		{	// ocl::Enumeration::allInstances() ocl!Enumeration!allInstances()
			...
			//symbol_314.setMoniker("ocl!Enumeration!allInstances()");
			symbol_314.setType(symbol_195);  // ocl!Set[ocl!Enumeration]
		...
		{	// ocl::Integer::*() Integer!*(Integer)
			...
			symbol_315.setName("*");
			//symbol_315.setMoniker("Integer!*(Integer)");
			...
			//symbol_316.setMoniker("Integer!*(Integer)!i");
		...
		{	// ocl::Integer::/() Integer!/(Integer)
			...
			symbol_322.setName("/");
			//symbol_322.setMoniker("Integer!/(Integer)");
			...
			//symbol_323.setMoniker("Integer!/(Integer)!i");
		...
		{	// ocl::Integer::abs() Integer!abs()
			...
			//symbol_324.setMoniker("Integer!abs()");
		...
		{	// ocl::Integer::div() Integer!div(Integer)
			...
			//symbol_325.setMoniker("Integer!div(Integer)");
			...
			//symbol_326.setMoniker("Integer!div(Integer)!i");
		...
		{	// ocl::Integer::max() Integer!max(Integer)
			...
			//symbol_327.setMoniker("Integer!max(Integer)");
			...
			//symbol_328.setMoniker("Integer!max(Integer)!i");
		...
		{	// ocl::Integer::min() Integer!min(Integer)
			...
			//symbol_329.setMoniker("Integer!min(Integer)");
			...
			//symbol_330.setMoniker("Integer!min(Integer)!i");
		...
		{	// ocl::Integer::mod() Integer!mod(Integer)
			...
			//symbol_331.setMoniker("Integer!mod(Integer)");
			...
			//symbol_332.setMoniker("Integer!mod(Integer)!i");
		...
		{	// ocl::Integer::toString() Integer!toString()
			...
			//symbol_333.setMoniker("Integer!toString()");
		...
		symbol_48.getSuperClasses().add(symbol_119); // ocl!Collection[ocl!NonOrderedCollection{T}?T]
		{	// ocl::NonOrderedCollection::closure() ocl!NonOrderedCollection{T}!closure(ocl!NonOrderedCollection{T}?T)
			...
			//symbol_334.setMoniker("ocl!NonOrderedCollection{T}!closure(ocl!NonOrderedCollection{T}?T)");
			symbol_334.setType(symbol_200);  // ocl!Set[ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::collect() ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)
			...
			//symbol_336.setMoniker("ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)");
			...
			//symbol_338.setMoniker("ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)!body");
			symbol_338.setType(symbol_145);  // Lambda~ocl!NonOrderedCollection{T}?T()ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		...
		{	// ocl::NonOrderedCollection::collectNested() ocl!NonOrderedCollection{T}!collectNested(ocl!NonOrderedCollection{T}?T)
			...
			//symbol_339.setMoniker("ocl!NonOrderedCollection{T}!collectNested(ocl!NonOrderedCollection{T}?T)");
			symbol_339.setType(symbol_113);  // ocl!Bag[ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::intersection() ocl!NonOrderedCollection{T}!intersection(ocl!Bag[ocl!NonOrderedCollection{T}?T])
			...
			//symbol_341.setMoniker("ocl!NonOrderedCollection{T}!intersection(ocl!Bag[ocl!NonOrderedCollection{T}?T])");
			symbol_341.setType(symbol_113);  // ocl!Bag[ocl!NonOrderedCollection{T}?T]
			...
			//symbol_342.setMoniker("ocl!NonOrderedCollection{T}!intersection(ocl!Bag[ocl!NonOrderedCollection{T}?T])!bag");
			symbol_342.setType(symbol_113);  // ocl!Bag[ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::intersection() ocl!NonOrderedCollection{T}!intersection(ocl!Set[ocl!NonOrderedCollection{T}?T])
			...
			//symbol_343.setMoniker("ocl!NonOrderedCollection{T}!intersection(ocl!Set[ocl!NonOrderedCollection{T}?T])");
			symbol_343.setType(symbol_200);  // ocl!Set[ocl!NonOrderedCollection{T}?T]
			symbol_343.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_344 = PivotFactory.eINSTANCE.createParameter();
			symbol_344.setName("s");
			//symbol_344.setMoniker("ocl!NonOrderedCollection{T}!intersection(ocl!Set[ocl!NonOrderedCollection{T}?T])!s");
			symbol_344.setType(symbol_200);  // ocl!Set[ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::union() ocl!NonOrderedCollection{T}!union(ocl!Bag[ocl!NonOrderedCollection{T}?T])
			...
			//symbol_345.setMoniker("ocl!NonOrderedCollection{T}!union(ocl!Bag[ocl!NonOrderedCollection{T}?T])");
			symbol_345.setType(symbol_113);  // ocl!Bag[ocl!NonOrderedCollection{T}?T]
			...
			//symbol_346.setMoniker("ocl!NonOrderedCollection{T}!union(ocl!Bag[ocl!NonOrderedCollection{T}?T])!bag");
			symbol_346.setType(symbol_113);  // ocl!Bag[ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::union() ocl!NonOrderedCollection{T}!union(ocl!Set[ocl!NonOrderedCollection{T}?T])
			...
			//symbol_347.setMoniker("ocl!NonOrderedCollection{T}!union(ocl!Set[ocl!NonOrderedCollection{T}?T])");
			symbol_347.setType(symbol_200);  // ocl!Set[ocl!NonOrderedCollection{T}?T]
			symbol_347.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_348 = PivotFactory.eINSTANCE.createParameter();
			symbol_348.setName("s");
			//symbol_348.setMoniker("ocl!NonOrderedCollection{T}!union(ocl!Set[ocl!NonOrderedCollection{T}?T])!s");
			symbol_348.setType(symbol_200);  // ocl!Set[ocl!NonOrderedCollection{T}?T]
		...
		symbol_55.getSuperClasses().add(symbol_132); // ocl!Collection[ocl!NonUniqueCollection{T}?T]
		{	// ocl::NonUniqueCollection::sortedBy() ocl!NonUniqueCollection{T}!sortedBy(ocl!NonUniqueCollection{T}?T)
			...
			//symbol_349.setMoniker("ocl!NonUniqueCollection{T}!sortedBy(ocl!NonUniqueCollection{T}?T)");
			symbol_349.setType(symbol_186);  // ocl!Sequence[ocl!NonUniqueCollection{T}?T]
		...
		{	// ocl::OclAny::<>() ocl!OclAny!<>(ocl!OclAny)
			...
			symbol_351.setName("<>");
			//symbol_351.setMoniker("ocl!OclAny!<>(ocl!OclAny)");
			...
			//symbol_352.setMoniker("ocl!OclAny!<>(ocl!OclAny)!object2");
		...
		{	// ocl::OclAny::=() ocl!OclAny!=(ocl!OclAny)
			...
			symbol_353.setName("=");
			//symbol_353.setMoniker("ocl!OclAny!=(ocl!OclAny)");
			...
			//symbol_354.setMoniker("ocl!OclAny!=(ocl!OclAny)!object2");
		...
		{	// ocl::OclAny::oclAsSet() ocl!OclAny!oclAsSet{OclSelf}()
			...
			//symbol_355.setMoniker("ocl!OclAny!oclAsSet{OclSelf}()");
			symbol_355.setType(symbol_205);  // ocl!Set[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		...
		{	// ocl::OclAny::oclAsType() ocl!OclAny!oclAsType{T}(ocl!Classifier)
			...
			//symbol_356.setMoniker("ocl!OclAny!oclAsType{T}(ocl!Classifier)");
			...
			//symbol_357.setMoniker("ocl!OclAny!oclAsType{T}(ocl!Classifier)!type");
		...
		{	// ocl::OclAny::oclIsInState() ocl!OclAny!oclIsInState(ocl!OclState)
			...
			//symbol_358.setMoniker("ocl!OclAny!oclIsInState(ocl!OclState)");
			...
			//symbol_359.setMoniker("ocl!OclAny!oclIsInState(ocl!OclState)!statespec");
		...
		{	// ocl::OclAny::oclIsInvalid() ocl!OclAny!oclIsInvalid()
			...
			//symbol_360.setMoniker("ocl!OclAny!oclIsInvalid()");
		...
		{	// ocl::OclAny::oclIsKindOf() ocl!OclAny!oclIsKindOf(ocl!Classifier)
			...
			//symbol_361.setMoniker("ocl!OclAny!oclIsKindOf(ocl!Classifier)");
			...
			//symbol_362.setMoniker("ocl!OclAny!oclIsKindOf(ocl!Classifier)!type");
		...
		{	// ocl::OclAny::oclIsNew() ocl!OclAny!oclIsNew()
			...
			//symbol_363.setMoniker("ocl!OclAny!oclIsNew()");
		...
		{	// ocl::OclAny::oclIsTypeOf() ocl!OclAny!oclIsTypeOf(ocl!Classifier)
			...
			//symbol_364.setMoniker("ocl!OclAny!oclIsTypeOf(ocl!Classifier)");
			...
			//symbol_365.setMoniker("ocl!OclAny!oclIsTypeOf(ocl!Classifier)!type");
		...
		{	// ocl::OclAny::oclIsUndefined() ocl!OclAny!oclIsUndefined()
			...
			//symbol_366.setMoniker("ocl!OclAny!oclIsUndefined()");
		...
		{	// ocl::OclAny::oclType() ocl!OclAny!oclType{OclSelf}()
			...
			//symbol_367.setMoniker("ocl!OclAny!oclType{OclSelf}()");
		...
		//symbol_69.setMoniker("ocl!OclInvalid");
		...
		{	// ocl::OclInvalid::<>() ocl!OclInvalid!<>(ocl!OclAny)
			...
			symbol_368.setName("<>");
			//symbol_368.setMoniker("ocl!OclInvalid!<>(ocl!OclAny)");
			...
			//symbol_369.setMoniker("ocl!OclInvalid!<>(ocl!OclAny)!object2");
		...
		{	// ocl::OclInvalid::=() ocl!OclInvalid!=(ocl!OclAny)
			...
			symbol_370.setName("=");
			//symbol_370.setMoniker("ocl!OclInvalid!=(ocl!OclAny)");
			...
			//symbol_371.setMoniker("ocl!OclInvalid!=(ocl!OclAny)!object2");
		...
		{	// ocl::OclInvalid::allInstances() ocl!OclInvalid!allInstances()
			...
			//symbol_372.setMoniker("ocl!OclInvalid!allInstances()");
			symbol_372.setType(symbol_198);  // ocl!Set[ocl!OclInvalid]
		...
		{	// ocl::OclInvalid::toString() ocl!OclInvalid!toString()
			...
			//symbol_373.setMoniker("ocl!OclInvalid!toString()");
		...
		//symbol_70.setMoniker("ocl!OclMessage");
		...
		{	// ocl::OclMessage::hasReturned() ocl!OclMessage!hasReturned()
			...
			//symbol_374.setMoniker("ocl!OclMessage!hasReturned()");
		...
		{	// ocl::OclMessage::isOperationCall() ocl!OclMessage!isOperationCall()
			...
			//symbol_375.setMoniker("ocl!OclMessage!isOperationCall()");
		...
		{	// ocl::OclMessage::isSignalSent() ocl!OclMessage!isSignalSent()
			...
			//symbol_376.setMoniker("ocl!OclMessage!isSignalSent()");
		...
		{	// ocl::OclMessage::result() ocl!OclMessage!result()
			...
			//symbol_377.setMoniker("ocl!OclMessage!result()");
		...
		//symbol_71.setMoniker("ocl!OclState");
		...
		//symbol_72.setMoniker("ocl!OclTuple");
		...
		{	// ocl::OclTuple::<>() ocl!OclTuple!<>(ocl!OclAny)
			...
			symbol_378.setName("<>");
			//symbol_378.setMoniker("ocl!OclTuple!<>(ocl!OclAny)");
			...
			//symbol_379.setMoniker("ocl!OclTuple!<>(ocl!OclAny)!object2");
		...
		{	// ocl::OclTuple::=() ocl!OclTuple!=(ocl!OclAny)
			...
			symbol_380.setName("=");
			//symbol_380.setMoniker("ocl!OclTuple!=(ocl!OclAny)");
			...
			//symbol_381.setMoniker("ocl!OclTuple!=(ocl!OclAny)!object2");
		...
		//symbol_73.setMoniker("ocl!OclVoid");
		...
		{	// ocl::OclVoid::<>() ocl!OclVoid!<>(ocl!OclAny)
			...
			symbol_382.setName("<>");
			//symbol_382.setMoniker("ocl!OclVoid!<>(ocl!OclAny)");
			...
			//symbol_383.setMoniker("ocl!OclVoid!<>(ocl!OclAny)!object2");
		...
		{	// ocl::OclVoid::=() ocl!OclVoid!=(ocl!OclAny)
			...
			symbol_384.setName("=");
			//symbol_384.setMoniker("ocl!OclVoid!=(ocl!OclAny)");
			...
			//symbol_385.setMoniker("ocl!OclVoid!=(ocl!OclAny)!object2");
		...
		{	// ocl::OclVoid::allInstances() ocl!OclVoid!allInstances()
			...
			//symbol_386.setMoniker("ocl!OclVoid!allInstances()");
			symbol_386.setType(symbol_194);  // ocl!Set[ocl!OclVoid]
		...
		{	// ocl::OclVoid::and() ocl!OclVoid!and(Boolean)
			...
			//symbol_387.setMoniker("ocl!OclVoid!and(Boolean)");
			...
			//symbol_388.setMoniker("ocl!OclVoid!and(Boolean)!b");
		...
		{	// ocl::OclVoid::implies() ocl!OclVoid!implies(Boolean)
			...
			//symbol_389.setMoniker("ocl!OclVoid!implies(Boolean)");
			...
			//symbol_390.setMoniker("ocl!OclVoid!implies(Boolean)!b");
		...
		{	// ocl::OclVoid::or() ocl!OclVoid!or(Boolean)
			...
			//symbol_391.setMoniker("ocl!OclVoid!or(Boolean)");
			...
			//symbol_392.setMoniker("ocl!OclVoid!or(Boolean)!b");
		...
		{	// ocl::OclVoid::toString() ocl!OclVoid!toString()
			...
			//symbol_393.setMoniker("ocl!OclVoid!toString()");
		...
		//symbol_74.setMoniker("ocl!OrderedCollection{T}");
		...
		symbol_74.getSuperClasses().add(symbol_130); // ocl!Collection[ocl!OrderedCollection{T}?T]
		{	// ocl::OrderedCollection::at() ocl!OrderedCollection{T}!at(Integer)
			...
			//symbol_394.setMoniker("ocl!OrderedCollection{T}!at(Integer)");
			...
			//symbol_395.setMoniker("ocl!OrderedCollection{T}!at(Integer)!index");
		...
		{	// ocl::OrderedCollection::closure() ocl!OrderedCollection{T}!closure(ocl!OrderedCollection{T}?T)
			...
			//symbol_396.setMoniker("ocl!OrderedCollection{T}!closure(ocl!OrderedCollection{T}?T)");
			symbol_396.setType(symbol_182);  // ocl!OrderedSet[ocl!OrderedCollection{T}?T]
		...
		{	// ocl::OrderedCollection::collect() ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)
			...
			//symbol_398.setMoniker("ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)");
			symbol_398.setType(symbol_191);  // ocl!Sequence[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
			...
			//symbol_400.setMoniker("ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)!body");
			symbol_400.setType(symbol_143);  // Lambda~ocl!OrderedCollection{T}?T()ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		...
		{	// ocl::OrderedCollection::collectNested() ocl!OrderedCollection{T}!collectNested(ocl!OrderedCollection{T}?T)
			...
			//symbol_401.setMoniker("ocl!OrderedCollection{T}!collectNested(ocl!OrderedCollection{T}?T)");
			symbol_401.setType(symbol_189);  // ocl!Sequence[ocl!OrderedCollection{T}?T]
		...
		{	// ocl::OrderedCollection::first() ocl!OrderedCollection{T}!first()
			...
			//symbol_403.setMoniker("ocl!OrderedCollection{T}!first()");
		...
		{	// ocl::OrderedCollection::indexOf() ocl!OrderedCollection{T}!indexOf(ocl!OclAny)
			...
			//symbol_404.setMoniker("ocl!OrderedCollection{T}!indexOf(ocl!OclAny)");
			...
			//symbol_405.setMoniker("ocl!OrderedCollection{T}!indexOf(ocl!OclAny)!obj");
		...
		{	// ocl::OrderedCollection::last() ocl!OrderedCollection{T}!last()
			...
			//symbol_406.setMoniker("ocl!OrderedCollection{T}!last()");
		...
		{	// ocl::OrderedCollection::reverse() ocl!OrderedCollection{T}!reverse()
			...
			//symbol_407.setMoniker("ocl!OrderedCollection{T}!reverse()");
			symbol_407.setType(symbol_177);  // ocl!OrderedCollection[ocl!OrderedCollection{T}?T]
		...
		//symbol_81.setMoniker("ocl!OrderedSet{T}");
		...
		symbol_81.getSuperClasses().add(symbol_221); // ocl!UniqueCollection[ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::-() ocl!OrderedSet{T}!-(ocl!Set[ocl!OclAny])
			...
			symbol_408.setName("-");
			//symbol_408.setMoniker("ocl!OrderedSet{T}!-(ocl!Set[ocl!OclAny])");
			symbol_408.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			symbol_408.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_409 = PivotFactory.eINSTANCE.createParameter();
			symbol_409.setName("s");
			//symbol_409.setMoniker("ocl!OrderedSet{T}!-(ocl!Set[ocl!OclAny])!s");
			symbol_409.setType(symbol_203);  // ocl!Set[ocl!OclAny]
		...
		{	// ocl::OrderedSet::<>() ocl!OrderedSet{T}!<>(ocl!OclAny)
			...
			symbol_410.setName("<>");
			//symbol_410.setMoniker("ocl!OrderedSet{T}!<>(ocl!OclAny)");
			...
			//symbol_411.setMoniker("ocl!OrderedSet{T}!<>(ocl!OclAny)!object2");
		...
		{	// ocl::OrderedSet::=() ocl!OrderedSet{T}!=(ocl!OclAny)
			...
			symbol_412.setName("=");
			//symbol_412.setMoniker("ocl!OrderedSet{T}!=(ocl!OclAny)");
			...
			//symbol_413.setMoniker("ocl!OrderedSet{T}!=(ocl!OclAny)!object2");
		...
		{	// ocl::OrderedSet::append() ocl!OrderedSet{T}!append(ocl!OrderedSet{T}?T)
			...
			//symbol_414.setMoniker("ocl!OrderedSet{T}!append(ocl!OrderedSet{T}?T)");
			symbol_414.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			...
			//symbol_415.setMoniker("ocl!OrderedSet{T}!append(ocl!OrderedSet{T}?T)!object");
		...
		{	// ocl::OrderedSet::excluding() ocl!OrderedSet{T}!excluding(ocl!OclAny)
			...
			//symbol_416.setMoniker("ocl!OrderedSet{T}!excluding(ocl!OclAny)");
			symbol_416.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			...
			//symbol_417.setMoniker("ocl!OrderedSet{T}!excluding(ocl!OclAny)!object");
		...
		{	// ocl::OrderedSet::including() ocl!OrderedSet{T}!including(ocl!OrderedSet{T}?T)
			...
			//symbol_418.setMoniker("ocl!OrderedSet{T}!including(ocl!OrderedSet{T}?T)");
			symbol_418.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			...
			//symbol_419.setMoniker("ocl!OrderedSet{T}!including(ocl!OrderedSet{T}?T)!object");
		...
		{	// ocl::OrderedSet::insertAt() ocl!OrderedSet{T}!insertAt(Integer,ocl!OrderedSet{T}?T)
			...
			//symbol_420.setMoniker("ocl!OrderedSet{T}!insertAt(Integer,ocl!OrderedSet{T}?T)");
			symbol_420.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			...
			//symbol_421.setMoniker("ocl!OrderedSet{T}!insertAt(Integer,ocl!OrderedSet{T}?T)!index");
			...
			//symbol_422.setMoniker("ocl!OrderedSet{T}!insertAt(Integer,ocl!OrderedSet{T}?T)!object");
		...
		{	// ocl::OrderedSet::intersection() ocl!OrderedSet{T}!intersection(ocl!Set[ocl!OrderedSet{T}?T])
			...
			//symbol_423.setMoniker("ocl!OrderedSet{T}!intersection(ocl!Set[ocl!OrderedSet{T}?T])");
			symbol_423.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			symbol_423.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_424 = PivotFactory.eINSTANCE.createParameter();
			symbol_424.setName("o");
			//symbol_424.setMoniker("ocl!OrderedSet{T}!intersection(ocl!Set[ocl!OrderedSet{T}?T])!o");
			symbol_424.setType(symbol_204);  // ocl!Set[ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::prepend() ocl!OrderedSet{T}!prepend(ocl!OrderedSet{T}?T)
			...
			//symbol_425.setMoniker("ocl!OrderedSet{T}!prepend(ocl!OrderedSet{T}?T)");
			symbol_425.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			...
			//symbol_426.setMoniker("ocl!OrderedSet{T}!prepend(ocl!OrderedSet{T}?T)!object");
		...
		{	// ocl::OrderedSet::reject() ocl!OrderedSet{T}!reject(ocl!OrderedSet{T}?T)
			...
			//symbol_427.setMoniker("ocl!OrderedSet{T}!reject(ocl!OrderedSet{T}?T)");
			symbol_427.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::reverse() ocl!OrderedSet{T}!reverse()
			...
			//symbol_429.setMoniker("ocl!OrderedSet{T}!reverse()");
			symbol_429.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::select() ocl!OrderedSet{T}!select(ocl!OrderedSet{T}?T)
			...
			//symbol_430.setMoniker("ocl!OrderedSet{T}!select(ocl!OrderedSet{T}?T)");
			symbol_430.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::subOrderedSet() ocl!OrderedSet{T}!subOrderedSet(Integer,Integer)
			...
			//symbol_432.setMoniker("ocl!OrderedSet{T}!subOrderedSet(Integer,Integer)");
			symbol_432.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			...
			//symbol_433.setMoniker("ocl!OrderedSet{T}!subOrderedSet(Integer,Integer)!lower");
			...
			//symbol_434.setMoniker("ocl!OrderedSet{T}!subOrderedSet(Integer,Integer)!upper");
		...
		{	// ocl::OrderedSet::symmetricDifference() ocl!OrderedSet{T}!symmetricDifference(ocl!Set[ocl!OclAny])
			...
			//symbol_435.setMoniker("ocl!OrderedSet{T}!symmetricDifference(ocl!Set[ocl!OclAny])");
			symbol_435.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			symbol_435.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_436 = PivotFactory.eINSTANCE.createParameter();
			symbol_436.setName("s");
			//symbol_436.setMoniker("ocl!OrderedSet{T}!symmetricDifference(ocl!Set[ocl!OclAny])!s");
			symbol_436.setType(symbol_203);  // ocl!Set[ocl!OclAny]
		...
		{	// ocl::OrderedSet::union() ocl!OrderedSet{T}!union(ocl!OrderedSet[ocl!OrderedSet{T}?T])
			...
			//symbol_437.setMoniker("ocl!OrderedSet{T}!union(ocl!OrderedSet[ocl!OrderedSet{T}?T])");
			symbol_437.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
			symbol_437.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_438 = PivotFactory.eINSTANCE.createParameter();
			symbol_438.setName("o");
			//symbol_438.setMoniker("ocl!OrderedSet{T}!union(ocl!OrderedSet[ocl!OrderedSet{T}?T])!o");
			symbol_438.setType(symbol_183);  // ocl!OrderedSet[ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::union() ocl!OrderedSet{T}!union(ocl!Set[ocl!OrderedSet{T}?T])
			...
			//symbol_439.setMoniker("ocl!OrderedSet{T}!union(ocl!Set[ocl!OrderedSet{T}?T])");
			symbol_439.setType(symbol_204);  // ocl!Set[ocl!OrderedSet{T}?T]
			symbol_439.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_440 = PivotFactory.eINSTANCE.createParameter();
			symbol_440.setName("s");
			//symbol_440.setMoniker("ocl!OrderedSet{T}!union(ocl!Set[ocl!OrderedSet{T}?T])!s");
			symbol_440.setType(symbol_204);  // ocl!Set[ocl!OrderedSet{T}?T]
		...
		{	// ocl::Real::*() Real!*(Real)
			...
			//symbol_442.setMoniker("Real!*(Real)!r");
		...
		{	// ocl::Real::+() Real!+(Real)
			...
			symbol_443.setName("+");
			//symbol_443.setMoniker("Real!+(Real)");
			...
			//symbol_444.setMoniker("Real!+(Real)!r");
		...
		{	// ocl::Real::<() Real!<(Real)
			...
			symbol_450.setName("<");
			//symbol_450.setMoniker("Real!<(Real)");
			...
			//symbol_451.setMoniker("Real!<(Real)!r");
		...
		{	// ocl::Real::<=() Real!<=(Real)
			...
			symbol_452.setName("<=");
			//symbol_452.setMoniker("Real!<=(Real)");
			...
			//symbol_453.setMoniker("Real!<=(Real)!r");
		...
		{	// ocl::Real::<>() Real!<>(ocl!OclAny)
			...
			symbol_454.setName("<>");
			//symbol_454.setMoniker("Real!<>(ocl!OclAny)");
			...
			//symbol_455.setMoniker("Real!<>(ocl!OclAny)!object2");
		...
		{	// ocl::Real::=() Real!=(ocl!OclAny)
			...
			symbol_456.setName("=");
			//symbol_456.setMoniker("Real!=(ocl!OclAny)");
			...
			//symbol_457.setMoniker("Real!=(ocl!OclAny)!object2");
		...
		{	// ocl::Real::abs() Real!abs()
			...
			//symbol_462.setMoniker("Real!abs()");
		...
		{	// ocl::Real::floor() Real!floor()
			...
			//symbol_463.setMoniker("Real!floor()");
		...
		{	// ocl::Real::max() Real!max(Real)
			...
			//symbol_464.setMoniker("Real!max(Real)");
			...
			//symbol_465.setMoniker("Real!max(Real)!r");
		...
		{	// ocl::Real::min() Real!min(Real)
			...
			//symbol_466.setMoniker("Real!min(Real)");
			...
			//symbol_467.setMoniker("Real!min(Real)!r");
		...
		{	// ocl::Real::oclAsType() Real!oclAsType{T}(ocl!Classifier)
			...
			//symbol_468.setMoniker("Real!oclAsType{T}(ocl!Classifier)");
			...
			//symbol_469.setMoniker("Real!oclAsType{T}(ocl!Classifier)!type");
		...
		{	// ocl::Real::round() Real!round()
			...
			//symbol_470.setMoniker("Real!round()");
		...
		{	// ocl::Real::toString() Real!toString()
			...
			//symbol_471.setMoniker("Real!toString()");
		...
		//symbol_89.setMoniker("ocl!Sequence{T}");
		...
		symbol_89.getSuperClasses().add(symbol_176); // ocl!OrderedCollection[ocl!Sequence{T}?T]
		symbol_89.getSuperClasses().add(symbol_172); // ocl!NonUniqueCollection[ocl!Sequence{T}?T]
		{	// ocl::Sequence::<>() ocl!Sequence{T}!<>(ocl!OclAny)
			Operation symbol_472 = PivotFactory.eINSTANCE.createOperation();
			symbol_472.setName("<>");
			//symbol_472.setMoniker("ocl!Sequence{T}!<>(ocl!OclAny)");
			...
			//symbol_473.setMoniker("ocl!Sequence{T}!<>(ocl!OclAny)!object2");
		...
		{	// ocl::Sequence::=() ocl!Sequence{T}!=(ocl!OclAny)
			...
			symbol_474.setName("=");
			//symbol_474.setMoniker("ocl!Sequence{T}!=(ocl!OclAny)");
			...
			//symbol_475.setMoniker("ocl!Sequence{T}!=(ocl!OclAny)!object2");
		...
		{	// ocl::Sequence::append() ocl!Sequence{T}!append(ocl!Sequence{T}?T)
			...
			//symbol_476.setMoniker("ocl!Sequence{T}!append(ocl!Sequence{T}?T)");
			symbol_476.setType(symbol_188);  // ocl!Sequence[ocl!Sequence{T}?T]
			...
			//symbol_477.setMoniker("ocl!Sequence{T}!append(ocl!Sequence{T}?T)!object");
		...
		{	// ocl::Sequence::excluding() ocl!Sequence{T}!excluding(ocl!OclAny)
			...
			//symbol_478.setMoniker("ocl!Sequence{T}!excluding(ocl!OclAny)");
			...
			//symbol_479.setMoniker("ocl!Sequence{T}!excluding(ocl!OclAny)!object");
		...
		{	// ocl::Sequence::flatten() ocl!Sequence{T}!flatten{T2}()
			...
			//symbol_480.setMoniker("ocl!Sequence{T}!flatten{T2}()");
			symbol_480.setType(symbol_187);  // ocl!Sequence[ocl!Sequence{T}!flatten{T2}()?T2]
		...
		{	// ocl::Sequence::including() ocl!Sequence{T}!including(ocl!Sequence{T}?T)
			...
			//symbol_481.setMoniker("ocl!Sequence{T}!including(ocl!Sequence{T}?T)");
			symbol_481.setType(symbol_188);  // ocl!Sequence[ocl!Sequence{T}?T]
			...
			//symbol_482.setMoniker("ocl!Sequence{T}!including(ocl!Sequence{T}?T)!object");
		...
		{	// ocl::Sequence::insertAt() ocl!Sequence{T}!insertAt(Integer,ocl!Sequence{T}?T)
			...
			//symbol_483.setMoniker("ocl!Sequence{T}!insertAt(Integer,ocl!Sequence{T}?T)");
			...
			//symbol_484.setMoniker("ocl!Sequence{T}!insertAt(Integer,ocl!Sequence{T}?T)!index");
			...
			//symbol_485.setMoniker("ocl!Sequence{T}!insertAt(Integer,ocl!Sequence{T}?T)!object");
		...
		{	// ocl::Sequence::prepend() ocl!Sequence{T}!prepend(ocl!Sequence{T}?T)
			...
			//symbol_486.setMoniker("ocl!Sequence{T}!prepend(ocl!Sequence{T}?T)");
			symbol_486.setType(symbol_188);  // ocl!Sequence[ocl!Sequence{T}?T]
			...
			//symbol_487.setMoniker("ocl!Sequence{T}!prepend(ocl!Sequence{T}?T)!object");
		...
		{	// ocl::Sequence::reject() ocl!Sequence{T}!reject(ocl!Sequence{T}?T)
			...
			//symbol_488.setMoniker("ocl!Sequence{T}!reject(ocl!Sequence{T}?T)");
		...
		{	// ocl::Sequence::reverse() ocl!Sequence{T}!reverse()
			...
			//symbol_490.setMoniker("ocl!Sequence{T}!reverse()");
		...
		{	// ocl::Sequence::select() ocl!Sequence{T}!select(ocl!Sequence{T}?T)
			...
			//symbol_491.setMoniker("ocl!Sequence{T}!select(ocl!Sequence{T}?T)");
			symbol_491.setType(symbol_188);  // ocl!Sequence[ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::subSequence() ocl!Sequence{T}!subSequence(Integer,Integer)
			...
			//symbol_493.setMoniker("ocl!Sequence{T}!subSequence(Integer,Integer)");
			...
			//symbol_494.setMoniker("ocl!Sequence{T}!subSequence(Integer,Integer)!lower");
			...
			//symbol_495.setMoniker("ocl!Sequence{T}!subSequence(Integer,Integer)!upper");
		...
		{	// ocl::Sequence::union() ocl!Sequence{T}!union(ocl!Sequence[ocl!Sequence{T}?T])
			...
			//symbol_496.setMoniker("ocl!Sequence{T}!union(ocl!Sequence[ocl!Sequence{T}?T])");
			symbol_496.setType(symbol_188);  // ocl!Sequence[ocl!Sequence{T}?T]
			symbol_496.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_497 = PivotFactory.eINSTANCE.createParameter();
			symbol_497.setName("s");
			//symbol_497.setMoniker("ocl!Sequence{T}!union(ocl!Sequence[ocl!Sequence{T}?T])!s");
			symbol_497.setType(symbol_188);  // ocl!Sequence[ocl!Sequence{T}?T]
		...
		//symbol_96.setMoniker("ocl!Set{T}");
		...
		symbol_96.getSuperClasses().add(symbol_148); // ocl!NonOrderedCollection[ocl!Set{T}?T]
		symbol_96.getSuperClasses().add(symbol_220); // ocl!UniqueCollection[ocl!Set{T}?T]
		{	// ocl::Set::-() ocl!Set{T}!-(ocl!Set[ocl!OclAny])
			Operation symbol_498 = PivotFactory.eINSTANCE.createOperation();
			symbol_498.setName("-");
			//symbol_498.setMoniker("ocl!Set{T}!-(ocl!Set[ocl!OclAny])");
			symbol_498.setType(symbol_196);  // ocl!Set[ocl!Set{T}?T]
			symbol_498.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_499 = PivotFactory.eINSTANCE.createParameter();
			symbol_499.setName("s");
			//symbol_499.setMoniker("ocl!Set{T}!-(ocl!Set[ocl!OclAny])!s");
			symbol_499.setType(symbol_203);  // ocl!Set[ocl!OclAny]
		...
		{	// ocl::Set::<>() ocl!Set{T}!<>(ocl!OclAny)
			...
			symbol_500.setName("<>");
			//symbol_500.setMoniker("ocl!Set{T}!<>(ocl!OclAny)");
			...
			//symbol_501.setMoniker("ocl!Set{T}!<>(ocl!OclAny)!object2");
		...
		{	// ocl::Set::=() ocl!Set{T}!=(ocl!OclAny)
			...
			symbol_502.setName("=");
			//symbol_502.setMoniker("ocl!Set{T}!=(ocl!OclAny)");
			...
			//symbol_503.setMoniker("ocl!Set{T}!=(ocl!OclAny)!object2");
		...
		{	// ocl::Set::excluding() ocl!Set{T}!excluding(ocl!OclAny)
			...
			//symbol_504.setMoniker("ocl!Set{T}!excluding(ocl!OclAny)");
			...
			//symbol_505.setMoniker("ocl!Set{T}!excluding(ocl!OclAny)!object");
		...
		{	// ocl::Set::flatten() ocl!Set{T}!flatten{T2}()
			...
			//symbol_506.setMoniker("ocl!Set{T}!flatten{T2}()");
			symbol_506.setType(symbol_197);  // ocl!Set[ocl!Set{T}!flatten{T2}()?T2]
		...
		{	// ocl::Set::including() ocl!Set{T}!including(ocl!Set{T}?T)
			...
			//symbol_507.setMoniker("ocl!Set{T}!including(ocl!Set{T}?T)");
			...
			//symbol_508.setMoniker("ocl!Set{T}!including(ocl!Set{T}?T)!object");
		...
		{	// ocl::Set::intersection() ocl!Set{T}!intersection(ocl!Set[ocl!Set{T}?T])
			...
			//symbol_509.setMoniker("ocl!Set{T}!intersection(ocl!Set[ocl!Set{T}?T])");
			symbol_509.setType(symbol_196);  // ocl!Set[ocl!Set{T}?T]
			symbol_509.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_510 = PivotFactory.eINSTANCE.createParameter();
			symbol_510.setName("s");
			//symbol_510.setMoniker("ocl!Set{T}!intersection(ocl!Set[ocl!Set{T}?T])!s");
		...
		{	// ocl::Set::reject() ocl!Set{T}!reject(ocl!Set{T}?T)
			...
			//symbol_511.setMoniker("ocl!Set{T}!reject(ocl!Set{T}?T)");
			symbol_511.setType(symbol_196);  // ocl!Set[ocl!Set{T}?T]
		...
		{	// ocl::Set::select() ocl!Set{T}!select(ocl!Set{T}?T)
			...
			//symbol_513.setMoniker("ocl!Set{T}!select(ocl!Set{T}?T)");
			symbol_513.setType(symbol_196);  // ocl!Set[ocl!Set{T}?T]
		...
		{	// ocl::Set::symmetricDifference() ocl!Set{T}!symmetricDifference(ocl!Set[ocl!OclAny])
			...
			//symbol_515.setMoniker("ocl!Set{T}!symmetricDifference(ocl!Set[ocl!OclAny])");
			symbol_515.setType(symbol_196);  // ocl!Set[ocl!Set{T}?T]
			symbol_515.setLower(BigInteger.valueOf(0));
			
			Parameter symbol_516 = PivotFactory.eINSTANCE.createParameter();
			symbol_516.setName("s");
			//symbol_516.setMoniker("ocl!Set{T}!symmetricDifference(ocl!Set[ocl!OclAny])!s");
			symbol_516.setType(symbol_203);  // ocl!Set[ocl!OclAny]
		...
		{	// ocl::String::+() String!+(String)
			...
			symbol_517.setName("+");
			//symbol_517.setMoniker("String!+(String)");
			...
			//symbol_518.setMoniker("String!+(String)!s");
		...
		{	// ocl::String::<() String!<(String)
			...
			symbol_519.setName("<");
			//symbol_519.setMoniker("String!<(String)");
			...
			//symbol_520.setMoniker("String!<(String)!s");
		...
		{	// ocl::String::<=() String!<=(String)
			...
			symbol_521.setName("<=");
			//symbol_521.setMoniker("String!<=(String)");
			...
			//symbol_522.setMoniker("String!<=(String)!s");
		...
		{	// ocl::String::<>() String!<>(ocl!OclAny)
			...
			symbol_523.setName("<>");
			//symbol_523.setMoniker("String!<>(ocl!OclAny)");
			...
			//symbol_524.setMoniker("String!<>(ocl!OclAny)!object2");
		...
		{	// ocl::String::=() String!=(ocl!OclAny)
			...
			symbol_525.setName("=");
			//symbol_525.setMoniker("String!=(ocl!OclAny)");
			...
			//symbol_526.setMoniker("String!=(ocl!OclAny)!object2");
		...
		{	// ocl::String::>() String!>(String)
			...
			symbol_527.setName(">");
			//symbol_527.setMoniker("String!>(String)");
			...
			//symbol_528.setMoniker("String!>(String)!s");
		...
		{	// ocl::String::>=() String!>=(String)
			...
			symbol_529.setName(">=");
			//symbol_529.setMoniker("String!>=(String)");
			...
			//symbol_530.setMoniker("String!>=(String)!s");
		...
		{	// ocl::String::at() String!at(Integer)
			...
			//symbol_531.setMoniker("String!at(Integer)");
			...
			//symbol_532.setMoniker("String!at(Integer)!i");
		...
		{	// ocl::String::characters() String!characters()
			...
			//symbol_533.setMoniker("String!characters()");
			symbol_533.setType(symbol_190);  // ocl!Sequence[String]
		...
		{	// ocl::String::concat() String!concat(String)
			...
			//symbol_534.setMoniker("String!concat(String)");
			...
			//symbol_535.setMoniker("String!concat(String)!s");
		...
		{	// ocl::String::equalsIgnoreCase() String!equalsIgnoreCase(String)
			...
			//symbol_536.setMoniker("String!equalsIgnoreCase(String)");
			...
			//symbol_537.setMoniker("String!equalsIgnoreCase(String)!s");
		...
		{	// ocl::String::indexOf() String!indexOf(String)
			...
			//symbol_538.setMoniker("String!indexOf(String)");
			...
			//symbol_539.setMoniker("String!indexOf(String)!s");
		...
		{	// ocl::String::size() String!size()
			...
			//symbol_540.setMoniker("String!size()");
		...
		{	// ocl::String::substring() String!substring(Integer,Integer)
			...
			//symbol_541.setMoniker("String!substring(Integer,Integer)");
			...
			//symbol_542.setMoniker("String!substring(Integer,Integer)!lower");
			...
			//symbol_543.setMoniker("String!substring(Integer,Integer)!upper");
		...
		{	// ocl::String::toBoolean() String!toBoolean()
			...
			//symbol_544.setMoniker("String!toBoolean()");
		...
		{	// ocl::String::toInteger() String!toInteger()
			...
			//symbol_545.setMoniker("String!toInteger()");
		...
		{	// ocl::String::toLowerCase() String!toLowerCase()
			...
			//symbol_546.setMoniker("String!toLowerCase()");
		...
		{	// ocl::String::toReal() String!toReal()
			...
			//symbol_547.setMoniker("String!toReal()");
		...
		{	// ocl::String::toString() String!toString()
			...
			//symbol_548.setMoniker("String!toString()");
		...
		{	// ocl::String::toUpperCase() String!toUpperCase()
			...
			//symbol_549.setMoniker("String!toUpperCase()");
		...
		//symbol_104.setMoniker("ocl!UniqueCollection{T}");
		...
		symbol_104.getSuperClasses().add(symbol_122); // ocl!Collection[ocl!UniqueCollection{T}?T]
		{	// ocl::UniqueCollection::sortedBy() ocl!UniqueCollection{T}!sortedBy(ocl!UniqueCollection{T}?T)
			...
			//symbol_550.setMoniker("ocl!UniqueCollection{T}!sortedBy(ocl!UniqueCollection{T}?T)");
			symbol_550.setType(symbol_184);  // ocl!OrderedSet[ocl!UniqueCollection{T}?T]
		...
		//symbol_108.setMoniker("UnlimitedNatural");
		...
		symbol_109.setMoniker("orphanage");
		//
		...
		symbol_110.setElementType(symbol_15);
		{
			...
			symbol_552.setSignature(symbol_13);
			{
				...
				symbol_553.setActual(symbol_15);	
				symbol_552.getParameterSubstitutions().add(symbol_553);
			}
			symbol_110.getTemplateBindings().add(symbol_552);
		}
		symbol_110.getSuperClasses().add(symbol_146); // ocl!NonOrderedCollection[ocl!Bag{T}?T]
		symbol_110.getSuperClasses().add(symbol_165); // ocl!NonUniqueCollection[ocl!Bag{T}?T]
		...
		//symbol_111.setMoniker("ocl!Bag[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]");
		...
		symbol_111.getSuperClasses().add(symbol_163); // ocl!NonUniqueCollection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		symbol_111.getSuperClasses().add(symbol_151); // ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		symbol_109.getOwnedTypes().add(symbol_111);
		//
		// ocl::orphanage::Bag ocl!Bag[ocl!Collection{T}?T]
		//
		symbol_112.setName("Bag");
		//symbol_112.setMoniker("ocl!Bag[ocl!Collection{T}?T]");
		symbol_112.setElementType(symbol_27);
		{
		...
		symbol_112.getSuperClasses().add(symbol_157); // ocl!NonOrderedCollection[ocl!Collection{T}?T]
		symbol_112.getSuperClasses().add(symbol_168); // ocl!NonUniqueCollection[ocl!Collection{T}?T]
		symbol_109.getOwnedTypes().add(symbol_112);
		//
		// ocl::orphanage::Bag ocl!Bag[ocl!NonOrderedCollection{T}?T]
		//
		symbol_113.setName("Bag");
		//symbol_113.setMoniker("ocl!Bag[ocl!NonOrderedCollection{T}?T]");
		symbol_113.setElementType(symbol_51);
		{
			...
			symbol_558.setSignature(symbol_13);
			{
				...
				symbol_559.setActual(symbol_51);	
				symbol_558.getParameterSubstitutions().add(symbol_559);
			}
			symbol_113.getTemplateBindings().add(symbol_558);
		}
		symbol_113.getSuperClasses().add(symbol_161); // ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}?T]
		symbol_113.getSuperClasses().add(symbol_167); // ocl!NonUniqueCollection[ocl!NonOrderedCollection{T}?T]
		symbol_109.getOwnedTypes().add(symbol_113);
		//
		// ocl::orphanage::Bag ocl!Bag[ocl!Bag{T}!flatten{T2}()?T2]
		//
		symbol_114.setName("Bag");
		//symbol_114.setMoniker("ocl!Bag[ocl!Bag{T}!flatten{T2}()?T2]");
		symbol_114.setElementType(symbol_18);
		{
			...
			symbol_560.setSignature(symbol_13);
			{
				...
				symbol_561.setActual(symbol_18);	
				symbol_560.getParameterSubstitutions().add(symbol_561);
			}
			symbol_114.getTemplateBindings().add(symbol_560);
		}
		symbol_114.getSuperClasses().add(symbol_149); // ocl!NonOrderedCollection[ocl!Bag{T}!flatten{T2}()?T2]
		symbol_114.getSuperClasses().add(symbol_162); // ocl!NonUniqueCollection[ocl!Bag{T}!flatten{T2}()?T2]
		symbol_109.getOwnedTypes().add(symbol_114);
		//
		// ocl::orphanage::Collection ocl!Collection[ocl!OclAny]
		//
		symbol_115.setName("Collection");
		//symbol_115.setMoniker("ocl!Collection[ocl!OclAny]");
		symbol_115.setElementType(symbol_59);
		{
			...
			symbol_562.setSignature(symbol_25);
			{
				...
				symbol_563.setActual(symbol_59);	
		...
		//symbol_116.setMoniker("ocl!Collection[ocl!Enumeration]");
		symbol_116.setElementType(symbol_46);
		{
			...
			symbol_564.setSignature(symbol_25);
			{
				...
				symbol_565.setActual(symbol_46);	
		...
		symbol_117.setElementType(symbol_102);
		{
			...
			symbol_566.setSignature(symbol_25);
			{
				...
				symbol_567.setActual(symbol_102);	
		...
		//symbol_118.setMoniker("ocl!Collection[String]");
		symbol_118.setElementType(symbol_103);
		{
			...
			symbol_568.setSignature(symbol_25);
			{
				...
				symbol_569.setActual(symbol_103);	
		...
		//symbol_119.setMoniker("ocl!Collection[ocl!NonOrderedCollection{T}?T]");
		symbol_119.setElementType(symbol_51);
		{
			...
			symbol_570.setSignature(symbol_25);
			{
				...
				symbol_571.setActual(symbol_51);	
		...
		//symbol_120.setMoniker("ocl!Collection[ocl!Collection{T}!includesAll{T2}(ocl!Collection[T2])?T2]");
		symbol_120.setElementType(symbol_39);
		{
			...
			symbol_572.setSignature(symbol_25);
			{
				...
				symbol_573.setActual(symbol_39);	
		...
		//symbol_121.setMoniker("ocl!Collection[ocl!Sequence{T}?T]");
		symbol_121.setElementType(symbol_92);
		{
			...
			symbol_574.setSignature(symbol_25);
			{
				...
				symbol_575.setActual(symbol_92);	
		...
		//symbol_122.setMoniker("ocl!Collection[ocl!UniqueCollection{T}?T]");
		symbol_122.setElementType(symbol_107);
		{
			...
			symbol_576.setSignature(symbol_25);
			{
				...
				symbol_577.setActual(symbol_107);	
		...
		//symbol_123.setMoniker("ocl!Collection[ocl!Collection{T}?T]");
		symbol_123.setElementType(symbol_27);
		{
			...
			symbol_578.setSignature(symbol_25);
			{
				...
				symbol_579.setActual(symbol_27);	
		...
		symbol_124.setElementType(symbol_69);
		{
			...
			symbol_580.setSignature(symbol_25);
			{
				...
				symbol_581.setActual(symbol_69);	
		...
		//symbol_125.setMoniker("ocl!Collection[ocl!Collection{T}!collect{V}(ocl!Collection{T}?T|Lambda~T()V)?V]");
		symbol_125.setElementType(symbol_30);
		{
			...
			symbol_582.setSignature(symbol_25);
			{
				...
				symbol_583.setActual(symbol_30);	
		...
		//symbol_126.setMoniker("ocl!Collection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]");
		symbol_126.setElementType(symbol_23);
		{
			...
			symbol_584.setSignature(symbol_25);
			{
				...
				symbol_585.setActual(symbol_23);	
		...
		//symbol_127.setMoniker("ocl!Collection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]");
		symbol_127.setElementType(symbol_62);
		{
			...
			symbol_586.setSignature(symbol_25);
			{
				...
				symbol_587.setActual(symbol_62);	
		...
		//symbol_128.setMoniker("ocl!Collection[ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2]");
		symbol_128.setElementType(symbol_45);
		{
			...
			symbol_588.setSignature(symbol_25);
			{
				...
				symbol_589.setActual(symbol_45);	
		...
		//symbol_129.setMoniker("ocl!Collection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]");
		symbol_129.setElementType(symbol_206);
		{
			...
			symbol_590.setSignature(symbol_25);
			{
				...
				symbol_591.setActual(symbol_206);	
		...
		symbol_130.setElementType(symbol_77);
		{
			...
			symbol_592.setSignature(symbol_25);
			{
				...
				symbol_593.setActual(symbol_77);	
		...
		//symbol_131.setMoniker("ocl!Collection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]");
		symbol_131.setElementType(symbol_54);
		{
			...
			symbol_594.setSignature(symbol_25);
			{
				...
				symbol_595.setActual(symbol_54);	
		...
		//symbol_132.setMoniker("ocl!Collection[ocl!NonUniqueCollection{T}?T]");
		symbol_132.setElementType(symbol_58);
		{
			...
			symbol_596.setSignature(symbol_25);
			{
				...
				symbol_597.setActual(symbol_58);	
		...
		symbol_133.setElementType(symbol_18);
		{
			...
			symbol_598.setSignature(symbol_25);
			{
				...
				symbol_599.setActual(symbol_18);	
		...
		//symbol_134.setMoniker("ocl!Collection[ocl!OrderedSet{T}?T]");
		symbol_134.setElementType(symbol_84);
		{
			...
			symbol_600.setSignature(symbol_25);
			{
				...
				symbol_601.setActual(symbol_84);	
		...
		//symbol_135.setMoniker("ocl!Collection[Boolean]");
		symbol_135.setElementType(symbol_19);
		{
			...
			symbol_602.setSignature(symbol_25);
			{
				...
				symbol_603.setActual(symbol_19);	
		...
		//symbol_136.setMoniker("ocl!Collection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]");
		symbol_136.setElementType(symbol_80);
		{
			...
			symbol_604.setSignature(symbol_25);
			{
				...
				symbol_605.setActual(symbol_80);	
		...
		//symbol_137.setMoniker("ocl!Collection[ocl!Bag{T}?T]");
		symbol_137.setElementType(symbol_15);
		{
			...
			symbol_606.setSignature(symbol_25);
			{
				...
				symbol_607.setActual(symbol_15);	
		...
		//symbol_138.setMoniker("ocl!Collection[ocl!Set{T}?T]");
		symbol_138.setElementType(symbol_99);
		{
			...
			symbol_608.setSignature(symbol_25);
			{
				...
				symbol_609.setActual(symbol_99);	
		...
		//symbol_139.setMoniker("ocl!Collection[ocl!Collection{T}!excludesAll{T2}(ocl!Collection[T2])?T2]");
		symbol_139.setElementType(symbol_33);
		{
			...
			symbol_610.setSignature(symbol_25);
			{
				...
				symbol_611.setActual(symbol_33);	
		...
		//symbol_140.setMoniker("ocl!Collection[ocl!Collection{T}!flatten{T2}()?T2]");
		symbol_140.setElementType(symbol_36);
		{
			...
			symbol_612.setSignature(symbol_25);
			{
				...
				symbol_613.setActual(symbol_36);	
		...
		//symbol_141.setMoniker("ocl!Collection[ocl!Sequence{T}!flatten{T2}()?T2]");
		symbol_141.setElementType(symbol_95);
		{
			...
			symbol_614.setSignature(symbol_25);
			{
				...
				symbol_615.setActual(symbol_95);	
		...
		//symbol_142.setMoniker("ocl!Collection[ocl!OclVoid]");
		symbol_142.setElementType(symbol_73);
		{
			...
			symbol_616.setSignature(symbol_25);
			{
				...
				symbol_617.setActual(symbol_73);	
		...
		//symbol_143.setMoniker("Lambda~ocl!OrderedCollection{T}?T()ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V");
		symbol_143.setContextType(symbol_77);
		symbol_143.setResultType(symbol_80);
		...
		//symbol_144.setMoniker("Lambda~ocl!Collection{T}?T()ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V");
		symbol_144.setContextType(symbol_27);
		symbol_144.setResultType(symbol_30);
		...
		//symbol_145.setMoniker("Lambda~ocl!NonOrderedCollection{T}?T()ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V");
		symbol_145.setContextType(symbol_51);
		symbol_145.setResultType(symbol_54);
		...
		//symbol_146.setMoniker("ocl!NonOrderedCollection[ocl!Bag{T}?T]");
		symbol_146.setElementType(symbol_15);
		{
			...
			symbol_618.setSignature(symbol_49);
			{
				...
				symbol_619.setActual(symbol_15);	
				symbol_618.getParameterSubstitutions().add(symbol_619);
			}
			symbol_146.getTemplateBindings().add(symbol_618);
		}
		symbol_146.getSuperClasses().add(symbol_137); // ocl!Collection[ocl!Bag{T}?T]
		...
		//symbol_147.setMoniker("ocl!NonOrderedCollection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]");
		symbol_147.setElementType(symbol_62);
		{
			...
			symbol_620.setSignature(symbol_49);
			{
				...
				symbol_621.setActual(symbol_62);	
				symbol_620.getParameterSubstitutions().add(symbol_621);
			}
			symbol_147.getTemplateBindings().add(symbol_620);
		}
		symbol_147.getSuperClasses().add(symbol_127); // ocl!Collection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		...
		//symbol_148.setMoniker("ocl!NonOrderedCollection[ocl!Set{T}?T]");
		symbol_148.setElementType(symbol_99);
		{
			...
			symbol_622.setSignature(symbol_49);
			{
				...
				symbol_623.setActual(symbol_99);	
				symbol_622.getParameterSubstitutions().add(symbol_623);
			}
			symbol_148.getTemplateBindings().add(symbol_622);
		}
		symbol_148.getSuperClasses().add(symbol_138); // ocl!Collection[ocl!Set{T}?T]
		...
		//symbol_149.setMoniker("ocl!NonOrderedCollection[ocl!Bag{T}!flatten{T2}()?T2]");
		symbol_149.setElementType(symbol_18);
		{
			...
			symbol_624.setSignature(symbol_49);
			{
				...
				symbol_625.setActual(symbol_18);	
				symbol_624.getParameterSubstitutions().add(symbol_625);
			}
			symbol_149.getTemplateBindings().add(symbol_624);
		}
		symbol_149.getSuperClasses().add(symbol_133); // ocl!Collection[ocl!Bag{T}!flatten{T2}()?T2]
		...
		//symbol_150.setMoniker("ocl!NonOrderedCollection[ocl!OclVoid]");
		symbol_150.setElementType(symbol_73);
		{
			...
			symbol_626.setSignature(symbol_49);
			{
				...
				symbol_627.setActual(symbol_73);	
				symbol_626.getParameterSubstitutions().add(symbol_627);
			}
			symbol_150.getTemplateBindings().add(symbol_626);
		}
		symbol_150.getSuperClasses().add(symbol_142); // ocl!Collection[ocl!OclVoid]
		...
		//symbol_151.setMoniker("ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]");
		symbol_151.setElementType(symbol_54);
		{
			...
			symbol_628.setSignature(symbol_49);
			{
				...
				symbol_629.setActual(symbol_54);	
				symbol_628.getParameterSubstitutions().add(symbol_629);
			}
			symbol_151.getTemplateBindings().add(symbol_628);
		}
		symbol_151.getSuperClasses().add(symbol_131); // ocl!Collection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		...
		//symbol_152.setMoniker("ocl!NonOrderedCollection[Boolean]");
		symbol_152.setElementType(symbol_19);
		{
		...
		//symbol_153.setMoniker("ocl!NonOrderedCollection[ocl!Set{T}!flatten{T2}()?T2]");
		symbol_153.setElementType(symbol_102);
		{
			...
			symbol_632.setSignature(symbol_49);
			{
				...
				symbol_633.setActual(symbol_102);	
				symbol_632.getParameterSubstitutions().add(symbol_633);
			}
			symbol_153.getTemplateBindings().add(symbol_632);
		}
		symbol_153.getSuperClasses().add(symbol_117); // ocl!Collection[ocl!Set{T}!flatten{T2}()?T2]
		...
		//symbol_154.setMoniker("ocl!NonOrderedCollection[ocl!OrderedSet{T}?T]");
		symbol_154.setElementType(symbol_84);
		{
			...
			symbol_634.setSignature(symbol_49);
			{
				...
				symbol_635.setActual(symbol_84);	
				symbol_634.getParameterSubstitutions().add(symbol_635);
			}
			symbol_154.getTemplateBindings().add(symbol_634);
		}
		symbol_154.getSuperClasses().add(symbol_134); // ocl!Collection[ocl!OrderedSet{T}?T]
		...
		//symbol_155.setMoniker("ocl!NonOrderedCollection[ocl!OclAny]");
		symbol_155.setElementType(symbol_59);
		{
			...
			symbol_636.setSignature(symbol_49);
			{
				...
				symbol_637.setActual(symbol_59);	
				symbol_636.getParameterSubstitutions().add(symbol_637);
			}
			symbol_155.getTemplateBindings().add(symbol_636);
		}
		symbol_155.getSuperClasses().add(symbol_115); // ocl!Collection[ocl!OclAny]
		...
		//symbol_156.setMoniker("ocl!NonOrderedCollection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]");
		symbol_156.setElementType(symbol_206);
		{
			...
			symbol_638.setSignature(symbol_49);
			{
				...
				symbol_639.setActual(symbol_206);	
				symbol_638.getParameterSubstitutions().add(symbol_639);
			}
			symbol_156.getTemplateBindings().add(symbol_638);
		}
		symbol_156.getSuperClasses().add(symbol_129); // ocl!Collection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
		...
		symbol_157.setElementType(symbol_27);
		{
			...
			symbol_640.setSignature(symbol_49);
			{
				...
				symbol_641.setActual(symbol_27);	
				symbol_640.getParameterSubstitutions().add(symbol_641);
			}
			symbol_157.getTemplateBindings().add(symbol_640);
		}
		symbol_157.getSuperClasses().add(symbol_123); // ocl!Collection[ocl!Collection{T}?T]
		...
		//symbol_158.setMoniker("ocl!NonOrderedCollection[ocl!OclInvalid]");
		symbol_158.setElementType(symbol_69);
		{
			...
			symbol_642.setSignature(symbol_49);
			{
				...
				symbol_643.setActual(symbol_69);	
				symbol_642.getParameterSubstitutions().add(symbol_643);
			}
			symbol_158.getTemplateBindings().add(symbol_642);
		}
		symbol_158.getSuperClasses().add(symbol_124); // ocl!Collection[ocl!OclInvalid]
		...
		//symbol_159.setMoniker("ocl!NonOrderedCollection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]");
		symbol_159.setElementType(symbol_23);
		{
			...
			symbol_644.setSignature(symbol_49);
			{
				...
				symbol_645.setActual(symbol_23);	
				symbol_644.getParameterSubstitutions().add(symbol_645);
			}
			symbol_159.getTemplateBindings().add(symbol_644);
		}
		symbol_159.getSuperClasses().add(symbol_126); // ocl!Collection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		...
		//symbol_160.setMoniker("ocl!NonOrderedCollection[ocl!Enumeration]");
		symbol_160.setElementType(symbol_46);
		{
			...
			symbol_646.setSignature(symbol_49);
			{
				...
				symbol_647.setActual(symbol_46);	
				symbol_646.getParameterSubstitutions().add(symbol_647);
			}
			symbol_160.getTemplateBindings().add(symbol_646);
		}
		symbol_160.getSuperClasses().add(symbol_116); // ocl!Collection[ocl!Enumeration]
		...
		//symbol_161.setMoniker("ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}?T]");
		symbol_161.setElementType(symbol_51);
		{
			...
			symbol_648.setSignature(symbol_49);
			{
				...
				symbol_649.setActual(symbol_51);	
				symbol_648.getParameterSubstitutions().add(symbol_649);
			}
			symbol_161.getTemplateBindings().add(symbol_648);
		}
		symbol_161.getSuperClasses().add(symbol_119); // ocl!Collection[ocl!NonOrderedCollection{T}?T]
		...
		//symbol_162.setMoniker("ocl!NonUniqueCollection[ocl!Bag{T}!flatten{T2}()?T2]");
		symbol_162.setElementType(symbol_18);
		{
			...
			symbol_650.setSignature(symbol_56);
			{
				...
				symbol_651.setActual(symbol_18);	
				symbol_650.getParameterSubstitutions().add(symbol_651);
			}
			symbol_162.getTemplateBindings().add(symbol_650);
		}
		symbol_162.getSuperClasses().add(symbol_133); // ocl!Collection[ocl!Bag{T}!flatten{T2}()?T2]
		...
		//symbol_163.setMoniker("ocl!NonUniqueCollection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]");
		symbol_163.setElementType(symbol_54);
		{
			...
			symbol_652.setSignature(symbol_56);
			{
				...
				symbol_653.setActual(symbol_54);	
				symbol_652.getParameterSubstitutions().add(symbol_653);
			}
			symbol_163.getTemplateBindings().add(symbol_652);
		}
		symbol_163.getSuperClasses().add(symbol_131); // ocl!Collection[ocl!NonOrderedCollection{T}!collect{V}(ocl!NonOrderedCollection{T}?T|Lambda~T()V)?V]
		...
		//symbol_164.setMoniker("ocl!NonUniqueCollection[ocl!NonUniqueCollection{T}?T]");
		...
		symbol_164.getSuperClasses().add(symbol_132); // ocl!Collection[ocl!NonUniqueCollection{T}?T]
		...
		//symbol_165.setMoniker("ocl!NonUniqueCollection[ocl!Bag{T}?T]");
		symbol_165.setElementType(symbol_15);
		{
			...
			symbol_656.setSignature(symbol_56);
			{
				...
				symbol_657.setActual(symbol_15);	
				symbol_656.getParameterSubstitutions().add(symbol_657);
			}
			symbol_165.getTemplateBindings().add(symbol_656);
		}
		symbol_165.getSuperClasses().add(symbol_137); // ocl!Collection[ocl!Bag{T}?T]
		...
		//symbol_166.setMoniker("ocl!NonUniqueCollection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]");
		symbol_166.setElementType(symbol_80);
		{
			...
			symbol_658.setSignature(symbol_56);
			{
				...
				symbol_659.setActual(symbol_80);	
				symbol_658.getParameterSubstitutions().add(symbol_659);
			}
			symbol_166.getTemplateBindings().add(symbol_658);
		}
		symbol_166.getSuperClasses().add(symbol_136); // ocl!Collection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		...
		//symbol_167.setMoniker("ocl!NonUniqueCollection[ocl!NonOrderedCollection{T}?T]");
		symbol_167.setElementType(symbol_51);
		{
			...
			symbol_660.setSignature(symbol_56);
			{
				...
				symbol_661.setActual(symbol_51);	
				symbol_660.getParameterSubstitutions().add(symbol_661);
			}
			symbol_167.getTemplateBindings().add(symbol_660);
		}
		symbol_167.getSuperClasses().add(symbol_119); // ocl!Collection[ocl!NonOrderedCollection{T}?T]
		...
		symbol_168.setElementType(symbol_27);
		{
			...
			symbol_662.setSignature(symbol_56);
			{
				...
				symbol_663.setActual(symbol_27);	
				symbol_662.getParameterSubstitutions().add(symbol_663);
			}
			symbol_168.getTemplateBindings().add(symbol_662);
		}
		symbol_168.getSuperClasses().add(symbol_123); // ocl!Collection[ocl!Collection{T}?T]
		...
		//symbol_169.setMoniker("ocl!NonUniqueCollection[String]");
		symbol_169.setElementType(symbol_103);
		{
		...
		//symbol_170.setMoniker("ocl!NonUniqueCollection[ocl!Sequence{T}!flatten{T2}()?T2]");
		...
		symbol_170.getSuperClasses().add(symbol_141); // ocl!Collection[ocl!Sequence{T}!flatten{T2}()?T2]
		...
		//symbol_171.setMoniker("ocl!NonUniqueCollection[ocl!OrderedCollection{T}?T]");
		symbol_171.setElementType(symbol_77);
		{
		...
		//symbol_172.setMoniker("ocl!NonUniqueCollection[ocl!Sequence{T}?T]");
		symbol_172.setElementType(symbol_92);
		{
			...
			symbol_670.setSignature(symbol_56);
			{
				...
				symbol_671.setActual(symbol_92);	
				symbol_670.getParameterSubstitutions().add(symbol_671);
			}
			symbol_172.getTemplateBindings().add(symbol_670);
		}
		symbol_172.getSuperClasses().add(symbol_121); // ocl!Collection[ocl!Sequence{T}?T]
		...
		symbol_173.getSuperClasses().add(symbol_134); // ocl!Collection[ocl!OrderedSet{T}?T]
		...
		//symbol_174.setMoniker("ocl!OrderedCollection[ocl!UniqueCollection{T}?T]");
		symbol_174.setElementType(symbol_107);
		{
			...
			symbol_674.setSignature(symbol_75);
			{
				...
				symbol_675.setActual(symbol_107);	
				symbol_674.getParameterSubstitutions().add(symbol_675);
			}
			symbol_174.getTemplateBindings().add(symbol_674);
		}
		symbol_174.getSuperClasses().add(symbol_122); // ocl!Collection[ocl!UniqueCollection{T}?T]
		...
		//symbol_175.setMoniker("ocl!OrderedCollection[String]");
		symbol_175.setElementType(symbol_103);
		{
		...
		symbol_176.setElementType(symbol_92);
		{
			...
			symbol_678.setSignature(symbol_75);
			{
				...
				symbol_679.setActual(symbol_92);	
				symbol_678.getParameterSubstitutions().add(symbol_679);
			}
			symbol_176.getTemplateBindings().add(symbol_678);
		}
		symbol_176.getSuperClasses().add(symbol_121); // ocl!Collection[ocl!Sequence{T}?T]
		...
		//symbol_177.setMoniker("ocl!OrderedCollection[ocl!OrderedCollection{T}?T]");
		symbol_177.setElementType(symbol_77);
		{
			...
			symbol_680.setSignature(symbol_75);
			{
				...
				symbol_681.setActual(symbol_77);	
				symbol_680.getParameterSubstitutions().add(symbol_681);
			}
			symbol_177.getTemplateBindings().add(symbol_680);
		}
		symbol_177.getSuperClasses().add(symbol_130); // ocl!Collection[ocl!OrderedCollection{T}?T]
		...
		//symbol_178.setMoniker("ocl!OrderedCollection[ocl!NonUniqueCollection{T}?T]");
		symbol_178.setElementType(symbol_58);
		{
			...
			symbol_682.setSignature(symbol_75);
			{
				...
				symbol_683.setActual(symbol_58);	
				symbol_682.getParameterSubstitutions().add(symbol_683);
			}
			symbol_178.getTemplateBindings().add(symbol_682);
		}
		symbol_178.getSuperClasses().add(symbol_132); // ocl!Collection[ocl!NonUniqueCollection{T}?T]
		...
		//symbol_179.setMoniker("ocl!OrderedCollection[ocl!Sequence{T}!flatten{T2}()?T2]");
		...
		symbol_179.getSuperClasses().add(symbol_141); // ocl!Collection[ocl!Sequence{T}!flatten{T2}()?T2]
		...
		//symbol_180.setMoniker("ocl!OrderedCollection[ocl!Collection{T}?T]");
		...
		symbol_180.getSuperClasses().add(symbol_123); // ocl!Collection[ocl!Collection{T}?T]
		...
		//symbol_181.setMoniker("ocl!OrderedCollection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]");
		...
		symbol_181.getSuperClasses().add(symbol_136); // ocl!Collection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		...
		symbol_182.setElementType(symbol_77);
		{
			...
			symbol_690.setSignature(symbol_82);
			{
				...
				symbol_691.setActual(symbol_77);	
				symbol_690.getParameterSubstitutions().add(symbol_691);
			}
			symbol_182.getTemplateBindings().add(symbol_690);
		}
		symbol_182.getSuperClasses().add(symbol_216); // ocl!UniqueCollection[ocl!OrderedCollection{T}?T]
		symbol_182.getSuperClasses().add(symbol_177); // ocl!OrderedCollection[ocl!OrderedCollection{T}?T]
		...
		//symbol_183.setMoniker("ocl!OrderedSet[ocl!OrderedSet{T}?T]");
		symbol_183.setElementType(symbol_84);
		{
			...
			symbol_692.setSignature(symbol_82);
			{
				...
				symbol_693.setActual(symbol_84);	
				symbol_692.getParameterSubstitutions().add(symbol_693);
			}
			symbol_183.getTemplateBindings().add(symbol_692);
		}
		symbol_183.getSuperClasses().add(symbol_221); // ocl!UniqueCollection[ocl!OrderedSet{T}?T]
		symbol_183.getSuperClasses().add(symbol_173); // ocl!OrderedCollection[ocl!OrderedSet{T}?T]
		...
		//symbol_184.setMoniker("ocl!OrderedSet[ocl!UniqueCollection{T}?T]");
		symbol_184.setElementType(symbol_107);
		{
			...
			symbol_694.setSignature(symbol_82);
			{
				...
				symbol_695.setActual(symbol_107);	
				symbol_694.getParameterSubstitutions().add(symbol_695);
			}
			symbol_184.getTemplateBindings().add(symbol_694);
		}
		symbol_184.getSuperClasses().add(symbol_174); // ocl!OrderedCollection[ocl!UniqueCollection{T}?T]
		symbol_184.getSuperClasses().add(symbol_222); // ocl!UniqueCollection[ocl!UniqueCollection{T}?T]
		...
		//symbol_185.setMoniker("ocl!OrderedSet[ocl!Collection{T}?T]");
		symbol_185.setElementType(symbol_27);
		{
			...
			symbol_696.setSignature(symbol_82);
			{
				...
				symbol_697.setActual(symbol_27);	
				symbol_696.getParameterSubstitutions().add(symbol_697);
			}
			symbol_185.getTemplateBindings().add(symbol_696);
		}
		symbol_185.getSuperClasses().add(symbol_215); // ocl!UniqueCollection[ocl!Collection{T}?T]
		symbol_185.getSuperClasses().add(symbol_180); // ocl!OrderedCollection[ocl!Collection{T}?T]
		...
		symbol_186.setElementType(symbol_58);
		{
			...
			symbol_698.setSignature(symbol_90);
			{
				...
				symbol_699.setActual(symbol_58);	
				symbol_698.getParameterSubstitutions().add(symbol_699);
			}
			symbol_186.getTemplateBindings().add(symbol_698);
		}
		symbol_186.getSuperClasses().add(symbol_178); // ocl!OrderedCollection[ocl!NonUniqueCollection{T}?T]
		symbol_186.getSuperClasses().add(symbol_164); // ocl!NonUniqueCollection[ocl!NonUniqueCollection{T}?T]
		...
		//symbol_187.setMoniker("ocl!Sequence[ocl!Sequence{T}!flatten{T2}()?T2]");
		symbol_187.setElementType(symbol_95);
		{
			...
			symbol_700.setSignature(symbol_90);
			{
				...
				symbol_701.setActual(symbol_95);	
				symbol_700.getParameterSubstitutions().add(symbol_701);
			}
			symbol_187.getTemplateBindings().add(symbol_700);
		}
		symbol_187.getSuperClasses().add(symbol_179); // ocl!OrderedCollection[ocl!Sequence{T}!flatten{T2}()?T2]
		symbol_187.getSuperClasses().add(symbol_170); // ocl!NonUniqueCollection[ocl!Sequence{T}!flatten{T2}()?T2]
		...
		symbol_188.setElementType(symbol_92);
		{
			...
			symbol_702.setSignature(symbol_90);
			{
				...
				symbol_703.setActual(symbol_92);	
		...
		symbol_188.getSuperClasses().add(symbol_172); // ocl!NonUniqueCollection[ocl!Sequence{T}?T]
		...
		symbol_189.setElementType(symbol_77);
		{
			...
			symbol_704.setSignature(symbol_90);
			{
				...
				symbol_705.setActual(symbol_77);	
				symbol_704.getParameterSubstitutions().add(symbol_705);
			}
			symbol_189.getTemplateBindings().add(symbol_704);
		}
		symbol_189.getSuperClasses().add(symbol_177); // ocl!OrderedCollection[ocl!OrderedCollection{T}?T]
		symbol_189.getSuperClasses().add(symbol_171); // ocl!NonUniqueCollection[ocl!OrderedCollection{T}?T]
		symbol_109.getOwnedTypes().add(symbol_189);
		//
		// ocl::orphanage::Sequence ocl!Sequence[String]
		//
		symbol_190.setName("Sequence");
		//symbol_190.setMoniker("ocl!Sequence[String]");
		symbol_190.setElementType(symbol_103);
		{
			...
			symbol_706.setSignature(symbol_90);
			{
				...
				symbol_707.setActual(symbol_103);	
				symbol_706.getParameterSubstitutions().add(symbol_707);
			}
			symbol_190.getTemplateBindings().add(symbol_706);
		}
		symbol_190.getSuperClasses().add(symbol_169); // ocl!NonUniqueCollection[String]
		symbol_190.getSuperClasses().add(symbol_175); // ocl!OrderedCollection[String]
		...
		//symbol_191.setMoniker("ocl!Sequence[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]");
		symbol_191.setElementType(symbol_80);
		{
			...
			symbol_708.setSignature(symbol_90);
			{
				...
				symbol_709.setActual(symbol_80);	
				symbol_708.getParameterSubstitutions().add(symbol_709);
			}
			symbol_191.getTemplateBindings().add(symbol_708);
		}
		symbol_191.getSuperClasses().add(symbol_166); // ocl!NonUniqueCollection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		symbol_191.getSuperClasses().add(symbol_181); // ocl!OrderedCollection[ocl!OrderedCollection{T}!collect{V}(ocl!OrderedCollection{T}?T|Lambda~T()V)?V]
		symbol_109.getOwnedTypes().add(symbol_191);
		//
		// ocl::orphanage::Sequence ocl!Sequence[ocl!Collection{T}?T]
		//
		symbol_192.setName("Sequence");
		//symbol_192.setMoniker("ocl!Sequence[ocl!Collection{T}?T]");
		...
		symbol_192.getSuperClasses().add(symbol_168); // ocl!NonUniqueCollection[ocl!Collection{T}?T]
		symbol_109.getOwnedTypes().add(symbol_192);
		//
		// ocl::orphanage::Set ocl!Set[Boolean]
		//
		symbol_193.setName("Set");
		//symbol_193.setMoniker("ocl!Set[Boolean]");
		symbol_193.setElementType(symbol_19);
		{
		...
		symbol_193.getSuperClasses().add(symbol_152); // ocl!NonOrderedCollection[Boolean]
		symbol_193.getSuperClasses().add(symbol_218); // ocl!UniqueCollection[Boolean]
		symbol_109.getOwnedTypes().add(symbol_193);
		//
		// ocl::orphanage::Set ocl!Set[ocl!OclVoid]
		//
		symbol_194.setName("Set");
		//symbol_194.setMoniker("ocl!Set[ocl!OclVoid]");
		symbol_194.setElementType(symbol_73);
		{
			...
			symbol_714.setSignature(symbol_97);
			{
				...
				symbol_715.setActual(symbol_73);	
				symbol_714.getParameterSubstitutions().add(symbol_715);
			}
			symbol_194.getTemplateBindings().add(symbol_714);
		}
		symbol_194.getSuperClasses().add(symbol_209); // ocl!UniqueCollection[ocl!OclVoid]
		symbol_194.getSuperClasses().add(symbol_150); // ocl!NonOrderedCollection[ocl!OclVoid]
		symbol_109.getOwnedTypes().add(symbol_194);
		//
		// ocl::orphanage::Set ocl!Set[ocl!Enumeration]
		//
		symbol_195.setName("Set");
		//symbol_195.setMoniker("ocl!Set[ocl!Enumeration]");
		symbol_195.setElementType(symbol_46);
		{
		...
		symbol_195.getSuperClasses().add(symbol_160); // ocl!NonOrderedCollection[ocl!Enumeration]
		symbol_195.getSuperClasses().add(symbol_212); // ocl!UniqueCollection[ocl!Enumeration]
		...
		symbol_196.setElementType(symbol_99);
		{
			...
			symbol_718.setSignature(symbol_97);
			{
				...
				symbol_719.setActual(symbol_99);	
				symbol_718.getParameterSubstitutions().add(symbol_719);
			}
			symbol_196.getTemplateBindings().add(symbol_718);
		}
		symbol_196.getSuperClasses().add(symbol_148); // ocl!NonOrderedCollection[ocl!Set{T}?T]
		symbol_196.getSuperClasses().add(symbol_220); // ocl!UniqueCollection[ocl!Set{T}?T]
		symbol_109.getOwnedTypes().add(symbol_196);
		//
		// ocl::orphanage::Set ocl!Set[ocl!Set{T}!flatten{T2}()?T2]
		//
		symbol_197.setName("Set");
		//symbol_197.setMoniker("ocl!Set[ocl!Set{T}!flatten{T2}()?T2]");
		symbol_197.setElementType(symbol_102);
		{
			...
			symbol_720.setSignature(symbol_97);
			{
				...
				symbol_721.setActual(symbol_102);	
				symbol_720.getParameterSubstitutions().add(symbol_721);
			}
			symbol_197.getTemplateBindings().add(symbol_720);
		}
		symbol_197.getSuperClasses().add(symbol_153); // ocl!NonOrderedCollection[ocl!Set{T}!flatten{T2}()?T2]
		symbol_197.getSuperClasses().add(symbol_213); // ocl!UniqueCollection[ocl!Set{T}!flatten{T2}()?T2]
		...
		symbol_198.setElementType(symbol_69);
		{
			...
			symbol_722.setSignature(symbol_97);
			{
				...
				symbol_723.setActual(symbol_69);	
				symbol_722.getParameterSubstitutions().add(symbol_723);
			}
			symbol_198.getTemplateBindings().add(symbol_722);
		}
		symbol_198.getSuperClasses().add(symbol_158); // ocl!NonOrderedCollection[ocl!OclInvalid]
		symbol_198.getSuperClasses().add(symbol_210); // ocl!UniqueCollection[ocl!OclInvalid]
		...
		//symbol_199.setMoniker("ocl!Set[ocl!Classifier!allInstances{OclSelf}()?OclSelf]");
		symbol_199.setElementType(symbol_23);
		{
			...
			symbol_724.setSignature(symbol_97);
			{
				...
				symbol_725.setActual(symbol_23);	
				symbol_724.getParameterSubstitutions().add(symbol_725);
			}
			symbol_199.getTemplateBindings().add(symbol_724);
		}
		symbol_199.getSuperClasses().add(symbol_159); // ocl!NonOrderedCollection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		symbol_199.getSuperClasses().add(symbol_223); // ocl!UniqueCollection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
		symbol_109.getOwnedTypes().add(symbol_199);
		//
		// ocl::orphanage::Set ocl!Set[ocl!NonOrderedCollection{T}?T]
		//
		symbol_200.setName("Set");
		//symbol_200.setMoniker("ocl!Set[ocl!NonOrderedCollection{T}?T]");
		symbol_200.setElementType(symbol_51);
		{
			...
			symbol_726.setSignature(symbol_97);
			{
				...
				symbol_727.setActual(symbol_51);	
				symbol_726.getParameterSubstitutions().add(symbol_727);
			}
			symbol_200.getTemplateBindings().add(symbol_726);
		}
		symbol_200.getSuperClasses().add(symbol_161); // ocl!NonOrderedCollection[ocl!NonOrderedCollection{T}?T]
		symbol_200.getSuperClasses().add(symbol_219); // ocl!UniqueCollection[ocl!NonOrderedCollection{T}?T]
		symbol_109.getOwnedTypes().add(symbol_200);
		//
		// ocl::orphanage::Set ocl!Set[ocl!Collection{T}?T]
		//
		symbol_201.setName("Set");
		//symbol_201.setMoniker("ocl!Set[ocl!Collection{T}?T]");
		symbol_201.setElementType(symbol_27);
		{
			...
			symbol_728.setSignature(symbol_97);
			{
				...
				symbol_729.setActual(symbol_27);	
				symbol_728.getParameterSubstitutions().add(symbol_729);
			}
			symbol_201.getTemplateBindings().add(symbol_728);
		}
		symbol_201.getSuperClasses().add(symbol_215); // ocl!UniqueCollection[ocl!Collection{T}?T]
		symbol_201.getSuperClasses().add(symbol_157); // ocl!NonOrderedCollection[ocl!Collection{T}?T]
		...
		//symbol_202.setMoniker("ocl!Set[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]");
		symbol_202.setElementType(symbol_206);
		{
			...
			symbol_730.setSignature(symbol_97);
			{
				...
				symbol_731.setActual(symbol_206);	
				symbol_730.getParameterSubstitutions().add(symbol_731);
			}
			symbol_202.getTemplateBindings().add(symbol_730);
		}
		symbol_202.getSuperClasses().add(symbol_156); // ocl!NonOrderedCollection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
		symbol_202.getSuperClasses().add(symbol_217); // ocl!UniqueCollection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
		symbol_109.getOwnedTypes().add(symbol_202);
		//
		// ocl::orphanage::Set ocl!Set[ocl!OclAny]
		//
		symbol_203.setName("Set");
		//symbol_203.setMoniker("ocl!Set[ocl!OclAny]");
		symbol_203.setElementType(symbol_59);
		{
			...
			symbol_732.setSignature(symbol_97);
			{
				...
				symbol_733.setActual(symbol_59);	
				symbol_732.getParameterSubstitutions().add(symbol_733);
			}
			symbol_203.getTemplateBindings().add(symbol_732);
		}
		symbol_203.getSuperClasses().add(symbol_155); // ocl!NonOrderedCollection[ocl!OclAny]
		symbol_203.getSuperClasses().add(symbol_211); // ocl!UniqueCollection[ocl!OclAny]
		symbol_109.getOwnedTypes().add(symbol_203);
		//
		// ocl::orphanage::Set ocl!Set[ocl!OrderedSet{T}?T]
		//
		symbol_204.setName("Set");
		//symbol_204.setMoniker("ocl!Set[ocl!OrderedSet{T}?T]");
		symbol_204.setElementType(symbol_84);
		{
			...
			symbol_734.setSignature(symbol_97);
			{
				...
				symbol_735.setActual(symbol_84);	
				symbol_734.getParameterSubstitutions().add(symbol_735);
			}
			symbol_204.getTemplateBindings().add(symbol_734);
		}
		symbol_204.getSuperClasses().add(symbol_221); // ocl!UniqueCollection[ocl!OrderedSet{T}?T]
		symbol_204.getSuperClasses().add(symbol_154); // ocl!NonOrderedCollection[ocl!OrderedSet{T}?T]
		...
		//symbol_205.setMoniker("ocl!Set[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]");
		symbol_205.setElementType(symbol_62);
		{
			...
			symbol_736.setSignature(symbol_97);
			{
				...
				symbol_737.setActual(symbol_62);	
				symbol_736.getParameterSubstitutions().add(symbol_737);
			}
			symbol_205.getTemplateBindings().add(symbol_736);
		}
		symbol_205.getSuperClasses().add(symbol_214); // ocl!UniqueCollection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		symbol_205.getSuperClasses().add(symbol_147); // ocl!NonOrderedCollection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		...
		//symbol_209.setMoniker("ocl!UniqueCollection[ocl!OclVoid]");
		symbol_209.setElementType(symbol_73);
		{
			...
			symbol_738.setSignature(symbol_105);
			{
				...
				symbol_739.setActual(symbol_73);	
				symbol_738.getParameterSubstitutions().add(symbol_739);
			}
			symbol_209.getTemplateBindings().add(symbol_738);
		}
		symbol_209.getSuperClasses().add(symbol_142); // ocl!Collection[ocl!OclVoid]
		...
		//symbol_210.setMoniker("ocl!UniqueCollection[ocl!OclInvalid]");
		symbol_210.setElementType(symbol_69);
		{
			...
			symbol_740.setSignature(symbol_105);
			{
				...
				symbol_741.setActual(symbol_69);	
				symbol_740.getParameterSubstitutions().add(symbol_741);
			}
			symbol_210.getTemplateBindings().add(symbol_740);
		}
		symbol_210.getSuperClasses().add(symbol_124); // ocl!Collection[ocl!OclInvalid]
		...
		//symbol_211.setMoniker("ocl!UniqueCollection[ocl!OclAny]");
		symbol_211.setElementType(symbol_59);
		{
			...
			symbol_742.setSignature(symbol_105);
			{
				...
				symbol_743.setActual(symbol_59);	
				symbol_742.getParameterSubstitutions().add(symbol_743);
			}
			symbol_211.getTemplateBindings().add(symbol_742);
		}
		symbol_211.getSuperClasses().add(symbol_115); // ocl!Collection[ocl!OclAny]
		...
		//symbol_212.setMoniker("ocl!UniqueCollection[ocl!Enumeration]");
		symbol_212.setElementType(symbol_46);
		{
			...
			symbol_744.setSignature(symbol_105);
			{
				...
				symbol_745.setActual(symbol_46);	
				symbol_744.getParameterSubstitutions().add(symbol_745);
			}
			symbol_212.getTemplateBindings().add(symbol_744);
		}
		symbol_212.getSuperClasses().add(symbol_116); // ocl!Collection[ocl!Enumeration]
		...
		symbol_213.setElementType(symbol_102);
		{
			...
			symbol_746.setSignature(symbol_105);
			{
				...
				symbol_747.setActual(symbol_102);	
		...
		//symbol_214.setMoniker("ocl!UniqueCollection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]");
		symbol_214.setElementType(symbol_62);
		{
			...
			symbol_748.setSignature(symbol_105);
			{
				...
				symbol_749.setActual(symbol_62);	
				symbol_748.getParameterSubstitutions().add(symbol_749);
			}
			symbol_214.getTemplateBindings().add(symbol_748);
		}
		symbol_214.getSuperClasses().add(symbol_127); // ocl!Collection[ocl!OclAny!oclAsSet{OclSelf}()?OclSelf]
		...
		//symbol_215.setMoniker("ocl!UniqueCollection[ocl!Collection{T}?T]");
		symbol_215.setElementType(symbol_27);
		{
			...
			symbol_750.setSignature(symbol_105);
			{
				...
				symbol_751.setActual(symbol_27);	
				symbol_750.getParameterSubstitutions().add(symbol_751);
			}
			symbol_215.getTemplateBindings().add(symbol_750);
		}
		symbol_215.getSuperClasses().add(symbol_123); // ocl!Collection[ocl!Collection{T}?T]
		...
		//symbol_216.setMoniker("ocl!UniqueCollection[ocl!OrderedCollection{T}?T]");
		symbol_216.setElementType(symbol_77);
		{
			...
			symbol_752.setSignature(symbol_105);
			{
				...
				symbol_753.setActual(symbol_77);	
				symbol_752.getParameterSubstitutions().add(symbol_753);
			}
			symbol_216.getTemplateBindings().add(symbol_752);
		}
		symbol_216.getSuperClasses().add(symbol_130); // ocl!Collection[ocl!OrderedCollection{T}?T]
		...
		symbol_217.setElementType(symbol_206);
		{
			...
			symbol_754.setSignature(symbol_105);
			{
				...
				symbol_755.setActual(symbol_206);	
				symbol_754.getParameterSubstitutions().add(symbol_755);
			}
			symbol_217.getTemplateBindings().add(symbol_754);
		}
		symbol_217.getSuperClasses().add(symbol_129); // ocl!Collection[Tuple{first:ocl!Collection{T}?T,second:ocl!Collection{T}!product{T2}(ocl!Collection[T2])?T2}]
		...
		//symbol_218.setMoniker("ocl!UniqueCollection[Boolean]");
		symbol_218.setElementType(symbol_19);
		{
		...
		symbol_219.setElementType(symbol_51);
		{
			...
			symbol_758.setSignature(symbol_105);
			{
				...
				symbol_759.setActual(symbol_51);	
				symbol_758.getParameterSubstitutions().add(symbol_759);
			}
			symbol_219.getTemplateBindings().add(symbol_758);
		}
		symbol_219.getSuperClasses().add(symbol_119); // ocl!Collection[ocl!NonOrderedCollection{T}?T]
		...
		symbol_220.setElementType(symbol_99);
		{
			...
			symbol_760.setSignature(symbol_105);
			{
				...
				symbol_761.setActual(symbol_99);	
				symbol_760.getParameterSubstitutions().add(symbol_761);
			}
			symbol_220.getTemplateBindings().add(symbol_760);
		}
		symbol_220.getSuperClasses().add(symbol_138); // ocl!Collection[ocl!Set{T}?T]
		...
		//symbol_221.setMoniker("ocl!UniqueCollection[ocl!OrderedSet{T}?T]");
		symbol_221.setElementType(symbol_84);
		{
			...
			symbol_762.setSignature(symbol_105);
			{
				...
				symbol_763.setActual(symbol_84);	
				symbol_762.getParameterSubstitutions().add(symbol_763);
			}
			symbol_221.getTemplateBindings().add(symbol_762);
		}
		symbol_221.getSuperClasses().add(symbol_134); // ocl!Collection[ocl!OrderedSet{T}?T]
		...
		//symbol_222.setMoniker("ocl!UniqueCollection[ocl!UniqueCollection{T}?T]");
		symbol_222.setElementType(symbol_107);
		{
			...
			symbol_764.setSignature(symbol_105);
			{
				...
				symbol_765.setActual(symbol_107);	
				symbol_764.getParameterSubstitutions().add(symbol_765);
			}
			symbol_222.getTemplateBindings().add(symbol_764);
		}
		symbol_222.getSuperClasses().add(symbol_122); // ocl!Collection[ocl!UniqueCollection{T}?T]
		...
		//symbol_223.setMoniker("ocl!UniqueCollection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]");
		symbol_223.setElementType(symbol_23);
		{
			...
			symbol_766.setSignature(symbol_105);
			{
				...
				symbol_767.setActual(symbol_23);	
				symbol_766.getParameterSubstitutions().add(symbol_767);
			}
			symbol_223.getTemplateBindings().add(symbol_766);
		}
		symbol_223.getSuperClasses().add(symbol_126); // ocl!Collection[ocl!Classifier!allInstances{OclSelf}()?OclSelf]
