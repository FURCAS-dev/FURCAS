		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeNameExpCSAccess().getAlternatives_1(), "rule__TypeNameExpCS__Alternatives_1");
					...
					put(grammarAccess.getNameExpCSAccess().getAlternatives_1(), "rule__NameExpCS__Alternatives_1");
					...
					put(grammarAccess.getTypeNameExpCSAccess().getGroup_1_0(), "rule__TypeNameExpCS__Group_1_0__0");
					put(grammarAccess.getTypeNameExpCSAccess().getGroup_1_0_0(), "rule__TypeNameExpCS__Group_1_0_0__0");
					put(grammarAccess.getTypeNameExpCSAccess().getGroup_1_0_0_2(), "rule__TypeNameExpCS__Group_1_0_0_2__0");
					...
					put(grammarAccess.getNameExpCSAccess().getGroup_1_0(), "rule__NameExpCS__Group_1_0__0");
					put(grammarAccess.getNameExpCSAccess().getGroup_1_0_0(), "rule__NameExpCS__Group_1_0_0__0");
					put(grammarAccess.getNameExpCSAccess().getGroup_1_0_0_2(), "rule__NameExpCS__Group_1_0_0_2__0");
					...
					put(grammarAccess.getTypeNameExpCSAccess().getNamespaceAssignment_1_0_0_0(), "rule__TypeNameExpCS__NamespaceAssignment_1_0_0_0");
					put(grammarAccess.getTypeNameExpCSAccess().getNamespaceAssignment_1_0_0_2_0(), "rule__TypeNameExpCS__NamespaceAssignment_1_0_0_2_0");
					put(grammarAccess.getTypeNameExpCSAccess().getElementAssignment_1_0_1(), "rule__TypeNameExpCS__ElementAssignment_1_0_1");
					put(grammarAccess.getTypeNameExpCSAccess().getElementAssignment_1_1(), "rule__TypeNameExpCS__ElementAssignment_1_1");
					...
					put(grammarAccess.getNameExpCSAccess().getNamespaceAssignment_1_0_0_0(), "rule__NameExpCS__NamespaceAssignment_1_0_0_0");
					put(grammarAccess.getNameExpCSAccess().getNamespaceAssignment_1_0_0_2_0(), "rule__NameExpCS__NamespaceAssignment_1_0_0_2_0");
					put(grammarAccess.getNameExpCSAccess().getElementAssignment_1_0_1(), "rule__NameExpCS__ElementAssignment_1_0_1");
					put(grammarAccess.getNameExpCSAccess().getElementAssignment_1_1(), "rule__NameExpCS__ElementAssignment_1_1");
