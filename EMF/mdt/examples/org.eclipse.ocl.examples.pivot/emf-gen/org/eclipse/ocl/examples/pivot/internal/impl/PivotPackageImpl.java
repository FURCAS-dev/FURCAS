 ...
 * </copyright>
 *
 * $Id: PivotPackageImpl.java,v 1.7 2011/03/01 08:47:18 ewillink Exp $
 */
...
public class PivotPackageImpl
	...
	public EReference getCompleteOperation_CompleteParameter() {
        return (EReference)getCompleteOperation().getEStructuralFeatures().get(3);
	}
	...
	{
        return (EReference)getCompletePackage().getEStructuralFeatures().get(4);
	}
	...
	public EReference getCompleteProperty_CompleteEnvironment() {
        return (EReference)getCompleteProperty().getEStructuralFeatures().get(2);
	}
	...
	{
        return (EReference)getCompleteType().getEStructuralFeatures().get(5);
	}
	...
	{
        return (EReference)getExpressionInOcl().getEStructuralFeatures().get(4);
	}
	...
	public EClass getIntegerLiteralExp() {
		...
		{
			integerLiteralExpEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(42);
		}
	...
	public EClass getInvalidLiteralExp() {
		...
		{
			invalidLiteralExpEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(43);
		}
	...
	public EClass getInvalidType() {
		...
		{
			invalidTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(44);
		}
	...
	public EClass getIterateExp()
	{
		...
		{
			iterateExpEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(45);
		}
	...
	public EClass getIteration()
	{
		...
		{
			iterationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(46);
		}
	...
	public EClass getIteratorExp()
	{
		...
		{
			iteratorExpEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(47);
		}
	...
	{
		if (lambdaTypeEClass == null)
		{
			lambdaTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(48);
		}
	...
	{
        return (EReference)getLambdaType().getEStructuralFeatures().get(0);
	}
	...
	{
        return (EReference)getLambdaType().getEStructuralFeatures().get(1);
	}
	...
	{
        return (EReference)getLambdaType().getEStructuralFeatures().get(2);
	}
	...
	{
		if (unspecifiedTypeEClass == null)
		{
			unspecifiedTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PivotPackage.eNS_URI).getEClassifiers().get(102);
		}
	...
	{
        return (EReference)getUnspecifiedType().getEStructuralFeatures().get(0);
	}
	...
	{
        return (EReference)getUnspecifiedType().getEStructuralFeatures().get(1);
	}
