...
/**
 *<b>
 *<li>Rule 75:  joinWhereEntry ::= identifier = identifier
 *</b>
 */
public class AliasComparisonClause extends Node implements IjoinWhereEntry
{
    ...
    public AliasComparisonClause(IToken leftIToken, IToken rightIToken,
                                 Ident _identifier,
                                 Ident _identifier3)
    {
