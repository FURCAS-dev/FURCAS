...
/**
 *<b>
 *<li>Rule 85:  nonLinkPredicate ::= like literal
 *</b>
 */
public class ComparisonLikePredicate extends Node implements InonLinkPredicate
{
    private Iliteral _literal;

    public Iliteral getliteral() { return _literal; }

    public ComparisonLikePredicate(IToken leftIToken, IToken rightIToken,
                                   Iliteral _literal)
    {
