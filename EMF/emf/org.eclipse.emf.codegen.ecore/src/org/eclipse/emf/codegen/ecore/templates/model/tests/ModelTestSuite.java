...
public class ModelTestSuite
{
  ...
  protected final String TEXT_9 = "</b></em>' model." + NL + " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */" + NL + "public class ";
  ...
  protected final String TEXT_21 = NL + "\t\tsuite.addTest(";
  protected final String TEXT_22 = ".suite());";
