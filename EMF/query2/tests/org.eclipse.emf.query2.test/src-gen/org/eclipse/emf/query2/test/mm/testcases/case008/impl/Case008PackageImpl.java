...
import org.eclipse.emf.query2.test.mm.testcases.case008.Case008Factory;
 ...
 * @generated
 */
public class Case008PackageImpl extends EPackageImpl implements Case008Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass s8EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case008.Case008Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case008PackageImpl() {
		super(eNS_URI, Case008Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case008Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case008Package init() {
		if (isInited) return (Case008Package)EPackage.Registry.INSTANCE.getEPackage(Case008Package.eNS_URI);

		// Obtain or create and register package
		Case008PackageImpl theCase008Package = (Case008PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case008PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case008PackageImpl());
		...
		theCase008Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case008Package.eNS_URI, theCase008Package);
		return theCase008Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getS8_Field1() {
		return (EAttribute)s8EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getS8_Field2() {
		return (EAttribute)s8EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getS8_Structure1() {
		return (EReference)s8EClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getT8_Field1() {
		return (EAttribute)t8EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getT8_Field2() {
		return (EAttribute)t8EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getA8_OneEnumerationE() {
		return (EAttribute)a8EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getA8_OneStructureS() {
		return (EReference)a8EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getA8_OneStructureT() {
		return (EReference)a8EClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getA8_OneStructureV() {
		return (EReference)a8EClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getA8_ManyEnumerationE() {
		return (EAttribute)a8EClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getA8_ManyStructureS() {
		return (EReference)a8EClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getU8_SubField1() {
		return (EAttribute)u8EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getV8_Structure1() {
		return (EReference)v8EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Case008Factory getCase008Factory() {
		return (Case008Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		s8EClass = createEClass(S8);
		createEAttribute(s8EClass, S8__FIELD1);
		createEAttribute(s8EClass, S8__FIELD2);
		createEReference(s8EClass, S8__STRUCTURE1);

		t8EClass = createEClass(T8);
		createEAttribute(t8EClass, T8__FIELD1);
		createEAttribute(t8EClass, T8__FIELD2);

		a8EClass = createEClass(A8);
		createEAttribute(a8EClass, A8__ONE_ENUMERATION_E);
		createEReference(a8EClass, A8__ONE_STRUCTURE_S);
		createEReference(a8EClass, A8__ONE_STRUCTURE_T);
		createEReference(a8EClass, A8__ONE_STRUCTURE_V);
		createEAttribute(a8EClass, A8__MANY_ENUMERATION_E);
		createEReference(a8EClass, A8__MANY_STRUCTURE_S);

		u8EClass = createEClass(U8);
		createEAttribute(u8EClass, U8__SUB_FIELD1);

		v8EClass = createEClass(V8);
		createEReference(v8EClass, V8__STRUCTURE1);

		// Create enums
		e8EEnum = createEEnum(E8);
	}
