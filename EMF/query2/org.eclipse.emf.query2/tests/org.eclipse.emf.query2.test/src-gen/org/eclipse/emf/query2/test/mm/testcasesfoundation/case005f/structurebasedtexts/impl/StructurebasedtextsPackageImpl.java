...
import org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.structurebasedtexts.StructurebasedtextsFactory;
 ...
 * @generated
 */
public class StructurebasedtextsPackageImpl extends EPackageImpl implements StructurebasedtextsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass generalTranslatableTextEClass = null;
	 ...
	 * @generated
	 */
	private EClass specializedTranslatableTextEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.structurebasedtexts.StructurebasedtextsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private StructurebasedtextsPackageImpl() {
		super(eNS_URI, StructurebasedtextsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link StructurebasedtextsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static StructurebasedtextsPackage init() {
		if (isInited) return (StructurebasedtextsPackage)EPackage.Registry.INSTANCE.getEPackage(StructurebasedtextsPackage.eNS_URI);

		// Obtain or create and register package
		StructurebasedtextsPackageImpl theStructurebasedtextsPackage = (StructurebasedtextsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof StructurebasedtextsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new StructurebasedtextsPackageImpl());
		...
		theStructurebasedtextsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(StructurebasedtextsPackage.eNS_URI, theStructurebasedtextsPackage);
		return theStructurebasedtextsPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getGeneralTranslatableText() {
		return generalTranslatableTextEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getSpecializedTranslatableText() {
		return specializedTranslatableTextEClass;
	}
	 ...
	 * @generated
	 */
	public StructurebasedtextsFactory getStructurebasedtextsFactory() {
		return (StructurebasedtextsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		generalTranslatableTextEClass = createEClass(GENERAL_TRANSLATABLE_TEXT);

		specializedTranslatableTextEClass = createEClass(SPECIALIZED_TRANSLATABLE_TEXT);
	}
	...
	public void initializePackageContents() {
		...
		generalTranslatableTextEClass.getESuperTypes().add(theTextverticalizationPackage.getTranslatableText());
