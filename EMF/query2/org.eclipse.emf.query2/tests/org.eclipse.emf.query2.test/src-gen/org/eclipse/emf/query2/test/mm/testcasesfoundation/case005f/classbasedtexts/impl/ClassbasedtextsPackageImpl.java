...
import org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.classbasedtexts.ClassbasedtextsFactory;
 ...
 * @generated
 */
public class ClassbasedtextsPackageImpl extends EPackageImpl implements ClassbasedtextsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass specializedTextEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.classbasedtexts.ClassbasedtextsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ClassbasedtextsPackageImpl() {
		super(eNS_URI, ClassbasedtextsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ClassbasedtextsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ClassbasedtextsPackage init() {
		if (isInited) return (ClassbasedtextsPackage)EPackage.Registry.INSTANCE.getEPackage(ClassbasedtextsPackage.eNS_URI);

		// Obtain or create and register package
		ClassbasedtextsPackageImpl theClassbasedtextsPackage = (ClassbasedtextsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ClassbasedtextsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ClassbasedtextsPackageImpl());
		...
		theClassbasedtextsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ClassbasedtextsPackage.eNS_URI, theClassbasedtextsPackage);
		return theClassbasedtextsPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getSpecializedText() {
		return specializedTextEClass;
	}
	 ...
	 * @generated
	 */
	public ClassbasedtextsFactory getClassbasedtextsFactory() {
		return (ClassbasedtextsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		generalTextEClass = createEClass(GENERAL_TEXT);

		specializedTextEClass = createEClass(SPECIALIZED_TEXT);
	}
	...
	public void initializePackageContents() {
		...
		generalTextEClass.getESuperTypes().add(theTextverticalizationfPackage.getTextF());
