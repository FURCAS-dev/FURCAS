 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.test.mm.testcases.case002.impl.C2Impl#getB <em>B</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class C2Impl extends A2Impl implements C2 {
	/**
	...
	protected EClass eStaticClass() {
		return Case002Package.Literals.C2;
	}
		...
		if (b != null && b.eIsProxy()) {
			...
			if (b != oldB) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Case002Package.C2__B, oldB, b));
			}
		}
		return b;
	}
	...
	public void setB(B2 newB) {
		...
		b = newB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Case002Package.C2__B, oldB, b));
	}
