...
import org.eclipse.emf.query2.test.mm.testcases.case019.translatabletexts.TranslatabletextsFactory;
 ...
 * @generated
 */
public class TranslatabletextsPackageImpl extends EPackageImpl implements TranslatabletextsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a19TranslatableTextEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case019.translatabletexts.TranslatabletextsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TranslatabletextsPackageImpl() {
		super(eNS_URI, TranslatabletextsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TranslatabletextsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TranslatabletextsPackage init() {
		if (isInited) return (TranslatabletextsPackage)EPackage.Registry.INSTANCE.getEPackage(TranslatabletextsPackage.eNS_URI);

		// Obtain or create and register package
		TranslatabletextsPackageImpl theTranslatabletextsPackage = (TranslatabletextsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TranslatabletextsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TranslatabletextsPackageImpl());
		...
		theTranslatabletextsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TranslatabletextsPackage.eNS_URI, theTranslatabletextsPackage);
		return theTranslatabletextsPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getA19TranslatableText() {
		return a19TranslatableTextEClass;
	}
	 ...
	 * @generated
	 */
	public TranslatabletextsFactory getTranslatabletextsFactory() {
		return (TranslatabletextsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a19TranslatableTextEClass = createEClass(A19_TRANSLATABLE_TEXT);
	}
