...
import org.eclipse.emf.query2.test.mm.testcases.case019.Case019Factory;
 ...
 * @generated
 */
public class Case019PackageImpl extends EPackageImpl implements Case019Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass b19EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case019.Case019Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case019PackageImpl() {
		super(eNS_URI, Case019Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case019Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case019Package init() {
		if (isInited) return (Case019Package)EPackage.Registry.INSTANCE.getEPackage(Case019Package.eNS_URI);

		// Obtain or create and register package
		Case019PackageImpl theCase019Package = (Case019PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case019PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case019PackageImpl());
		...
		theCase019Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case019Package.eNS_URI, theCase019Package);
		return theCase019Package;
	}
	 ...
	 * @generated
	 */
	public EReference getB19_TranslatableTextShort1() {
		return (EReference)b19EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getB19_TranslatableTextVeryShort1() {
		return (EReference)b19EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getB19_TranslatableButtons() {
		return (EReference)b19EClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public Case019Factory getCase019Factory() {
		return (Case019Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		b19EClass = createEClass(B19);
		createEReference(b19EClass, B19__TRANSLATABLE_TEXT_SHORT1);
		createEReference(b19EClass, B19__TRANSLATABLE_TEXT_VERY_SHORT1);
		createEReference(b19EClass, B19__TRANSLATABLE_BUTTONS);
	}
	...
	public void initializePackageContents() {
		...
		SerializationcallbackPackage theSerializationcallbackPackage = (SerializationcallbackPackage)EPackage.Registry.INSTANCE.getEPackage(SerializationcallbackPackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(theSerializationcallbackPackage);
		getESubpackages().add(theTranslatabletextsPackage);
