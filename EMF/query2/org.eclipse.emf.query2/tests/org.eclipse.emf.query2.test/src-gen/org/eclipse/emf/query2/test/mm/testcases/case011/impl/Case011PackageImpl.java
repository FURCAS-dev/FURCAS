...
import org.eclipse.emf.query2.test.mm.testcases.case011.Case011Factory;
 ...
 * @generated
 */
public class Case011PackageImpl extends EPackageImpl implements Case011Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case011.Case011Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case011PackageImpl() {
		super(eNS_URI, Case011Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case011Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case011Package init() {
		if (isInited) return (Case011Package)EPackage.Registry.INSTANCE.getEPackage(Case011Package.eNS_URI);

		// Obtain or create and register package
		Case011PackageImpl theCase011Package = (Case011PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case011PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case011PackageImpl());
		...
		theCase011Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case011Package.eNS_URI, theCase011Package);
		return theCase011Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getA11_Attribute1() {
		return (EAttribute)a11EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getA11_Attribute2() {
		return (EAttribute)a11EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case011Factory getCase011Factory() {
		return (Case011Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(a11EClass, A11__ATTRIBUTE1);
		createEAttribute(a11EClass, A11__ATTRIBUTE2);
	}
