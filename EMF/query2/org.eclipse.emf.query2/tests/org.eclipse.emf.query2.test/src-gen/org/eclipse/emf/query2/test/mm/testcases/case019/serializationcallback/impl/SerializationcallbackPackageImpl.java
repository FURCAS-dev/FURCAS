...
import org.eclipse.emf.query2.test.mm.testcases.case019.serializationcallback.SerializationcallbackFactory;
 ...
 * @generated
 */
public class SerializationcallbackPackageImpl extends EPackageImpl implements SerializationcallbackPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a19SerializationEClass = null;
	 ...
	 * @generated
	 */
	private EClass b19SerializationEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case019.serializationcallback.SerializationcallbackPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SerializationcallbackPackageImpl() {
		super(eNS_URI, SerializationcallbackFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SerializationcallbackPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SerializationcallbackPackage init() {
		if (isInited) return (SerializationcallbackPackage)EPackage.Registry.INSTANCE.getEPackage(SerializationcallbackPackage.eNS_URI);

		// Obtain or create and register package
		SerializationcallbackPackageImpl theSerializationcallbackPackage = (SerializationcallbackPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SerializationcallbackPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SerializationcallbackPackageImpl());
		...
		theSerializationcallbackPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SerializationcallbackPackage.eNS_URI, theSerializationcallbackPackage);
		return theSerializationcallbackPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getA19Serialization() {
		return a19SerializationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getA19Serialization_TestTranslatableTextF() {
		return (EReference)a19SerializationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getB19Serialization() {
		return b19SerializationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getB19Serialization_TestTranslatableText() {
		return (EReference)b19SerializationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public SerializationcallbackFactory getSerializationcallbackFactory() {
		return (SerializationcallbackFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a19SerializationEClass = createEClass(A19_SERIALIZATION);
		createEReference(a19SerializationEClass, A19_SERIALIZATION__TEST_TRANSLATABLE_TEXT_F);

		b19SerializationEClass = createEClass(B19_SERIALIZATION);
		createEReference(b19SerializationEClass, B19_SERIALIZATION__TEST_TRANSLATABLE_TEXT);
	}
	...
	public void initializePackageContents() {
		...
		Case004fPackage theCase004fPackage = (Case004fPackage)EPackage.Registry.INSTANCE.getEPackage(Case004fPackage.eNS_URI);
		TranslatabletextsPackage theTranslatabletextsPackage = (TranslatabletextsPackage)EPackage.Registry.INSTANCE.getEPackage(TranslatabletextsPackage.eNS_URI);
