...
import org.eclipse.emf.query2.test.mm.testcases.case018.Case018Factory;
 ...
 * @generated
 */
public class Case018PackageImpl extends EPackageImpl implements Case018Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a18EClass = null;
	 ...
	 * @generated
	 */
	private EClass usesA1FromFoundationEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case018.Case018Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case018PackageImpl() {
		super(eNS_URI, Case018Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case018Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case018Package init() {
		if (isInited) return (Case018Package)EPackage.Registry.INSTANCE.getEPackage(Case018Package.eNS_URI);

		// Obtain or create and register package
		Case018PackageImpl theCase018Package = (Case018PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case018PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case018PackageImpl());
		...
		theCase018Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case018Package.eNS_URI, theCase018Package);
		return theCase018Package;
	}
	 ...
	 * @generated
	 */
	public EReference getA18_FoundationAttributeA1f() {
		return (EReference)a18EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB18_SpecialOnePrimitive() {
		return (EAttribute)b18EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getusesA1FromFoundation() {
		return usesA1FromFoundationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getusesA1FromFoundation_A1FromFoundation() {
		return (EReference)usesA1FromFoundationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getusesA1FromFoundation_A18() {
		return (EReference)usesA1FromFoundationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case018Factory getCase018Factory() {
		return (Case018Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a18EClass = createEClass(A18);
		createEReference(a18EClass, A18__FOUNDATION_ATTRIBUTE_A1F);

		b18EClass = createEClass(B18);
		createEAttribute(b18EClass, B18__SPECIAL_ONE_PRIMITIVE);

		usesA1FromFoundationEClass = createEClass(USES_A1_FROM_FOUNDATION);
		createEReference(usesA1FromFoundationEClass, USES_A1_FROM_FOUNDATION__A1_FROM_FOUNDATION);
		createEReference(usesA1FromFoundationEClass, USES_A1_FROM_FOUNDATION__A18);
	}
	...
	public void initializePackageContents() {
		...
		Case001fPackage theCase001fPackage = (Case001fPackage)EPackage.Registry.INSTANCE.getEPackage(Case001fPackage.eNS_URI);
