...
public class Case001Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Case001Package.A1: {
				A1 a1 = (A1)theEObject;
				T result = caseA1(a1);
				if (result == null) result = caseSuper(a1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Case001Package.B1: {
				B1 b1 = (B1)theEObject;
				T result = caseB1(b1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Case001Package.SUPER: {
				Super super_ = (Super)theEObject;
				T result = caseSuper(super_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Case001Package.AREFERENCES_B: {
				AReferencesB aReferencesB = (AReferencesB)theEObject;
				T result = caseAReferencesB(aReferencesB);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AReferences B</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AReferences B</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAReferencesB(AReferencesB object) {
		return null;
	}
