...
import org.eclipse.emf.query2.test.mm.testcases.case017.Case017Factory;
 ...
 * @generated
 */
public class Case017PackageImpl extends EPackageImpl implements Case017Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a17EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case017.Case017Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case017PackageImpl() {
		super(eNS_URI, Case017Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case017Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case017Package init() {
		if (isInited) return (Case017Package)EPackage.Registry.INSTANCE.getEPackage(Case017Package.eNS_URI);

		// Obtain or create and register package
		Case017PackageImpl theCase017Package = (Case017PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case017PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case017PackageImpl());
		...
		theCase017Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case017Package.eNS_URI, theCase017Package);
		return theCase017Package;
	}
	 ...
	 * @generated
	 */
	public EReference getA17_ToEnd() {
		return (EReference)a17EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getA17_FromEnd() {
		return (EReference)a17EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case017Factory getCase017Factory() {
		return (Case017Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a17EClass = createEClass(A17);
		createEReference(a17EClass, A17__TO_END);
		createEReference(a17EClass, A17__FROM_END);
	}
