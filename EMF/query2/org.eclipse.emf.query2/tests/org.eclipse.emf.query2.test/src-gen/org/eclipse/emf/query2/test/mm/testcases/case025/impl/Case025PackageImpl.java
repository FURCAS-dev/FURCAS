...
import org.eclipse.emf.query2.test.mm.testcases.case025.Case025Factory;
 ...
 * @generated
 */
public class Case025PackageImpl extends EPackageImpl implements Case025Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a25EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case025.Case025Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case025PackageImpl() {
		super(eNS_URI, Case025Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case025Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case025Package init() {
		if (isInited) return (Case025Package)EPackage.Registry.INSTANCE.getEPackage(Case025Package.eNS_URI);

		// Obtain or create and register package
		Case025PackageImpl theCase025Package = (Case025PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case025PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case025PackageImpl());
		...
		theCase025Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case025Package.eNS_URI, theCase025Package);
		return theCase025Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getA25_ExternalId() {
		return (EAttribute)a25EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Case025Factory getCase025Factory() {
		return (Case025Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a25EClass = createEClass(A25);
		createEAttribute(a25EClass, A25__EXTERNAL_ID);

		c25EClass = createEClass(C25);

		b25EClass = createEClass(B25);

		d25EClass = createEClass(D25);
	}
	...
	public void initializePackageContents() {
		...
		Case017Package theCase017Package = (Case017Package)EPackage.Registry.INSTANCE.getEPackage(Case017Package.eNS_URI);
		Case004Package theCase004Package = (Case004Package)EPackage.Registry.INSTANCE.getEPackage(Case004Package.eNS_URI);
		Case008Package theCase008Package = (Case008Package)EPackage.Registry.INSTANCE.getEPackage(Case008Package.eNS_URI);
		...
		c25EClass.getESuperTypes().add(theCase017Package.getA17());
		c25EClass.getESuperTypes().add(this.getA25());
		b25EClass.getESuperTypes().add(theCase004Package.getA4());
		b25EClass.getESuperTypes().add(this.getA25());
		d25EClass.getESuperTypes().add(this.getA25());
		d25EClass.getESuperTypes().add(theCase008Package.getA8());

		// Initialize classes and features; add operations and parameters
		initEClass(a25EClass, org.eclipse.emf.query2.test.mm.testcases.case025.A25.class, "A25", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getA25_ExternalId(), ecorePackage.getEString(), "externalId", null, 1, 1, org.eclipse.emf.query2.test.mm.testcases.case025.A25.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$

		initEClass(c25EClass, org.eclipse.emf.query2.test.mm.testcases.case025.C25.class, "C25", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(b25EClass, org.eclipse.emf.query2.test.mm.testcases.case025.B25.class, "B25", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(d25EClass, org.eclipse.emf.query2.test.mm.testcases.case025.D25.class, "D25", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
	...
	protected void createMOINAnnotations() {
		...
		addAnnotation
		  (a25EClass, 
		   ...
		   new String[] {
			 ...
			 "metaObject", "testcases.case025.A25", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "48875B19BD88B62158D311DDB22200155883508E", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation
		  (c25EClass, 
		   ...
		   new String[] {
			 "metamodels", "test.sap.com/tc/moin/metamodel/testcases[1.0.0]", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObject", "testcases.case025.C25", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "48875D1BEFDD6D4058D411DDC4D300155883508E", //$NON-NLS-1$ //$NON-NLS-2$
			 "isStructureType", "false" //$NON-NLS-1$ //$NON-NLS-2$
		   });		
		addAnnotation
		  (b25EClass, 
		   ...
		   new String[] {
			 "metamodels", "test.sap.com/tc/moin/metamodel/testcases[1.0.0]", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObject", "testcases.case025.B25", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "48875D1BEFDD6D4158D411DDC63600155883508E", //$NON-NLS-1$ //$NON-NLS-2$
			 "isStructureType", "false", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation
		  (d25EClass, 
		   ...
		   new String[] {
			 "metamodels", "test.sap.com/tc/moin/metamodel/testcases[1.0.0]", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObject", "testcases.case025.D25", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "48875D1BEFDD6D4258D411DD8B1000155883508E", //$NON-NLS-1$ //$NON-NLS-2$
			 "isStructureType", "false" //$NON-NLS-1$ //$NON-NLS-2$
		   });
	}
