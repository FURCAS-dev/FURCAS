...
import org.eclipse.emf.query2.test.mm.testcases.case007.top.nestedOfTop.NestedOfTopFactory;
 ...
 * @generated
 */
public class NestedOfTopPackageImpl extends EPackageImpl implements NestedOfTopPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass nestedOfTopAEClass = null;
	 ...
	 * @generated
	 */
	private EClass nestedOfTopBEClass = null;
	 ...
	 * @generated
	 */
	private EClass nestedOfTopAReferencesNestedOfTopBEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case007.top.nestedOfTop.NestedOfTopPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NestedOfTopPackageImpl() {
		super(eNS_URI, NestedOfTopFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link NestedOfTopPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NestedOfTopPackage init() {
		if (isInited) return (NestedOfTopPackage)EPackage.Registry.INSTANCE.getEPackage(NestedOfTopPackage.eNS_URI);

		// Obtain or create and register package
		NestedOfTopPackageImpl theNestedOfTopPackage = (NestedOfTopPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof NestedOfTopPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new NestedOfTopPackageImpl());
		...
		theNestedOfTopPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NestedOfTopPackage.eNS_URI, theNestedOfTopPackage);
		return theNestedOfTopPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getNestedOfTopA() {
		return nestedOfTopAEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getNestedOfTopB() {
		return nestedOfTopBEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getNestedOfTopAReferencesNestedOfTopB() {
		return nestedOfTopAReferencesNestedOfTopBEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getNestedOfTopAReferencesNestedOfTopB_NestedOfTopB() {
		return (EReference)nestedOfTopAReferencesNestedOfTopBEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getNestedOfTopAReferencesNestedOfTopB_NestedOfTopA() {
		return (EReference)nestedOfTopAReferencesNestedOfTopBEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public NestedOfTopFactory getNestedOfTopFactory() {
		return (NestedOfTopFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		nestedOfTopAEClass = createEClass(NESTED_OF_TOP_A);

		nestedOfTopBEClass = createEClass(NESTED_OF_TOP_B);

		nestedOfTopAReferencesNestedOfTopBEClass = createEClass(NESTED_OF_TOP_AREFERENCES_NESTED_OF_TOP_B);
		createEReference(nestedOfTopAReferencesNestedOfTopBEClass, NESTED_OF_TOP_AREFERENCES_NESTED_OF_TOP_B__NESTED_OF_TOP_B);
		createEReference(nestedOfTopAReferencesNestedOfTopBEClass, NESTED_OF_TOP_AREFERENCES_NESTED_OF_TOP_B__NESTED_OF_TOP_A);
	}
