...
import org.eclipse.emf.query2.test.mm.testcases.case007.top.TopFactory;
...
public class TopPackageImpl extends EPackageImpl implements TopPackage {
	 ...
	 * @generated
	 */
	private EClass topAEClass = null;
	 ...
	 * @generated
	 */
	private EClass topBEClass = null;
	 ...
	 * @generated
	 */
	private EClass topAReferencesTopBEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case007.top.TopPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link TopPackage#eINSTANCE} when that field is accessed.
	...
	public static TopPackage init() {
		...
		TopPackageImpl theTopPackage = (TopPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TopPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TopPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(TopPackage.eNS_URI, theTopPackage);
	 ...
	 * @generated
	 */
	public EClass getTopAReferencesTopB() {
		return topAReferencesTopBEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTopAReferencesTopB_TopB() {
		return (EReference)topAReferencesTopBEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTopAReferencesTopB_TopA() {
		return (EReference)topAReferencesTopBEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		topAEClass = createEClass(TOP_A);

		topBEClass = createEClass(TOP_B);

		topAReferencesTopBEClass = createEClass(TOP_AREFERENCES_TOP_B);
		createEReference(topAReferencesTopBEClass, TOP_AREFERENCES_TOP_B__TOP_B);
		createEReference(topAReferencesTopBEClass, TOP_AREFERENCES_TOP_B__TOP_A);
	}
	...
	public void initializePackageContents() {
		...
		NestedOfTopPackage theNestedOfTopPackage = (NestedOfTopPackage)EPackage.Registry.INSTANCE.getEPackage(NestedOfTopPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theNestedOfTopPackage);
		...
		initEClass(topAEClass, TopA.class, "TopA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(topBEClass, TopB.class, "TopB", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(topAReferencesTopBEClass, TopAReferencesTopB.class, "TopAReferencesTopB", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getTopAReferencesTopB_TopB(), this.getTopB(), null, "topB", null, 0, 1, TopAReferencesTopB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
		initEReference(getTopAReferencesTopB_TopA(), this.getTopA(), null, "topA", null, 0, -1, TopAReferencesTopB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
	...
	protected void createMOINAnnotations() {
		...
		addAnnotation
		  (topAEClass, 
		   ...
		   new String[] {
			 ...
			 "metaObject", "testcases.case007.top.TopA", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "476118E36F917572A96F11DCAD0A001558C93B47", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation
		  (topBEClass, 
		   ...
		   new String[] {
			 "metamodels", "test.sap.com/tc/moin/metamodel/testcases[1.0.0]", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObject", "testcases.case007.top.TopB", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "476118E36F917573A96F11DC8839001558C93B47", //$NON-NLS-1$ //$NON-NLS-2$
			 "isStructureType", "false" //$NON-NLS-1$ //$NON-NLS-2$
		   });		
		addAnnotation
		  (getTopAReferencesTopB_TopB(), 
		   source, 
		   new String[] {
			 "metamodels", "test.sap.com/tc/moin/metamodel/testcases[1.0.0]", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObject", "testcases.case007.top.TopAReferencesTopB", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "476118E36F917576A96F11DCBB1E001558C93B47", //$NON-NLS-1$ //$NON-NLS-2$
