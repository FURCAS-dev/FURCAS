...
import org.eclipse.emf.query2.test.mm.testcases.case005.p3.p4.P4Factory;
 ...
 * @generated
 */
public class P4PackageImpl extends EPackageImpl implements P4Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass d5EClass = null;
	 ...
	 * @generated
	 */
	private EClass association2EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case005.p3.p4.P4Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private P4PackageImpl() {
		super(eNS_URI, P4Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link P4Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static P4Package init() {
		if (isInited) return (P4Package)EPackage.Registry.INSTANCE.getEPackage(P4Package.eNS_URI);

		// Obtain or create and register package
		P4PackageImpl theP4Package = (P4PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof P4PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new P4PackageImpl());
		...
		EPackage.Registry.INSTANCE.put(P4Package.eNS_URI, theP4Package);
		return theP4Package;
	}
	 ...
	 * @generated
	 */
	public EClass getAssociation2() {
		return association2EClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAssociation2_Y() {
		return (EReference)association2EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAssociation2_D5() {
		return (EReference)association2EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public P4Factory getP4Factory() {
		return (P4Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		d5EClass = createEClass(D5);

		association2EClass = createEClass(ASSOCIATION2);
		createEReference(association2EClass, ASSOCIATION2__Y);
		createEReference(association2EClass, ASSOCIATION2__D5);
	}
	...
	public void initializePackageContents() {
		...
		P1Package theP1Package = (P1Package)EPackage.Registry.INSTANCE.getEPackage(P1Package.eNS_URI);
		...
		initEClass(d5EClass, org.eclipse.emf.query2.test.mm.testcases.case005.p3.p4.D5.class, "D5", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(association2EClass, Association2.class, "Association2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getAssociation2_Y(), theP1Package.getA5(), null, "Y", null, 0, 1, Association2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
		initEReference(getAssociation2_D5(), this.getD5(), null, "d5", null, 0, 1, Association2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED); //$NON-NLS-1$
	...
	protected void createMOINAnnotations() {
		...
		addAnnotation
		  (d5EClass, 
		   ...
		   new String[] {
			 ...
			 "metaObject", "testcases.case005.p3.p4.D5", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "45F120A5EFC8410A569D474E20FF95F185CF2BA3", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation
		  (getAssociation2_Y(), 
		   ...
		   new String[] {
			 "metamodels", "test.sap.com/tc/moin/metamodel/testcases[1.0.0]", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObject", "testcases.case005.p3.p4.Association2", //$NON-NLS-1$ //$NON-NLS-2$
			 "metaObjectMofId", "45F120A5F42E369C47F94BF235129C103A6B5A13", //$NON-NLS-1$ //$NON-NLS-2$
