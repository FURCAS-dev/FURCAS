...
import org.eclipse.emf.query2.test.mm.testcasesfoundation.case003f.Case003fFactory;
 ...
 * @generated
 */
public class Case003fPackageImpl extends EPackageImpl implements Case003fPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass b3fEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcasesfoundation.case003f.Case003fPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case003fPackageImpl() {
		super(eNS_URI, Case003fFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case003fPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case003fPackage init() {
		if (isInited) return (Case003fPackage)EPackage.Registry.INSTANCE.getEPackage(Case003fPackage.eNS_URI);

		// Obtain or create and register package
		Case003fPackageImpl theCase003fPackage = (Case003fPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case003fPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case003fPackageImpl());
		...
		theCase003fPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case003fPackage.eNS_URI, theCase003fPackage);
		return theCase003fPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getB3f_TextName() {
		return (EAttribute)b3fEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Case003fFactory getCase003fFactory() {
		return (Case003fFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		b3fEClass = createEClass(B3F);
		createEAttribute(b3fEClass, B3F__TEXT_NAME);
	}
