...
import org.eclipse.emf.query2.test.mm.testcases.case006.Case006Factory;
 ...
 * @generated
 */
public class Case006PackageImpl extends EPackageImpl implements Case006Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case006.Case006Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case006PackageImpl() {
		super(eNS_URI, Case006Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case006Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case006Package init() {
		if (isInited) return (Case006Package)EPackage.Registry.INSTANCE.getEPackage(Case006Package.eNS_URI);

		// Obtain or create and register package
		Case006PackageImpl theCase006Package = (Case006PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case006PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case006PackageImpl());
		...
		theCase006Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case006Package.eNS_URI, theCase006Package);
		return theCase006Package;
	}
	 ...
	 * @generated
	 */
	public EReference getC6_X() {
		return (EReference)c6EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getC6_W() {
		return (EReference)c6EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case006Factory getCase006Factory() {
		return (Case006Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		c6EClass = createEClass(C6);
		createEReference(c6EClass, C6__X);
		createEReference(c6EClass, C6__W);

		d6EClass = createEClass(D6);
	}
