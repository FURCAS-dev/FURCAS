...
import org.eclipse.emf.query2.test.mm.testcases.case007.clustered.nestedOfClustered.NestedOfClusteredFactory;
 ...
 * @generated
 */
public class NestedOfClusteredPackageImpl extends EPackageImpl implements NestedOfClusteredPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass nestedOfClusteredAEClass = null;
	 ...
	 * @generated
	 */
	private EClass nestedOfClusteredBEClass = null;
	 ...
	 * @generated
	 */
	private EClass nestedOfClusteredAReferencesNestedOfClusteredBEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case007.clustered.nestedOfClustered.NestedOfClusteredPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NestedOfClusteredPackageImpl() {
		super(eNS_URI, NestedOfClusteredFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link NestedOfClusteredPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NestedOfClusteredPackage init() {
		if (isInited) return (NestedOfClusteredPackage)EPackage.Registry.INSTANCE.getEPackage(NestedOfClusteredPackage.eNS_URI);

		// Obtain or create and register package
		NestedOfClusteredPackageImpl theNestedOfClusteredPackage = (NestedOfClusteredPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof NestedOfClusteredPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new NestedOfClusteredPackageImpl());
		...
		theNestedOfClusteredPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NestedOfClusteredPackage.eNS_URI, theNestedOfClusteredPackage);
		return theNestedOfClusteredPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getnestedOfClusteredA() {
		return nestedOfClusteredAEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getnestedOfClusteredB() {
		return nestedOfClusteredBEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getNestedOfClusteredAReferencesNestedOfClusteredB() {
		return nestedOfClusteredAReferencesNestedOfClusteredBEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getNestedOfClusteredAReferencesNestedOfClusteredB_NestedOfClusteredB() {
		return (EReference)nestedOfClusteredAReferencesNestedOfClusteredBEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getNestedOfClusteredAReferencesNestedOfClusteredB_NestedOfClusteredA() {
		return (EReference)nestedOfClusteredAReferencesNestedOfClusteredBEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public NestedOfClusteredFactory getNestedOfClusteredFactory() {
		return (NestedOfClusteredFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		nestedOfClusteredAEClass = createEClass(NESTED_OF_CLUSTERED_A);

		nestedOfClusteredBEClass = createEClass(NESTED_OF_CLUSTERED_B);

		nestedOfClusteredAReferencesNestedOfClusteredBEClass = createEClass(NESTED_OF_CLUSTERED_AREFERENCES_NESTED_OF_CLUSTERED_B);
		createEReference(nestedOfClusteredAReferencesNestedOfClusteredBEClass, NESTED_OF_CLUSTERED_AREFERENCES_NESTED_OF_CLUSTERED_B__NESTED_OF_CLUSTERED_B);
		createEReference(nestedOfClusteredAReferencesNestedOfClusteredBEClass, NESTED_OF_CLUSTERED_AREFERENCES_NESTED_OF_CLUSTERED_B__NESTED_OF_CLUSTERED_A);
	}
