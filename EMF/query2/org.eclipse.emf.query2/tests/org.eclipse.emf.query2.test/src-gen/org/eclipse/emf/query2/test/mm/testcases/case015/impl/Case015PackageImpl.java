 ...
 *******************************************************************************/
package org.eclipse.emf.query2.test.mm.testcases.case015.impl;
...
import org.eclipse.emf.query2.test.mm.testcases.case015.Case015Factory;
 ...
 * @generated
 */
public class Case015PackageImpl extends EPackageImpl implements Case015Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a15EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case015.Case015Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case015PackageImpl() {
		super(eNS_URI, Case015Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case015Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case015Package init() {
		if (isInited) return (Case015Package)EPackage.Registry.INSTANCE.getEPackage(Case015Package.eNS_URI);

		// Obtain or create and register package
		Case015PackageImpl theCase015Package = (Case015PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case015PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case015PackageImpl());
		...
		theCase015Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case015Package.eNS_URI, theCase015Package);
		return theCase015Package;
	}
	 ...
	 * @generated
	 */
	public Case015Factory getCase015Factory() {
		return (Case015Factory)getEFactoryInstance();
	}
