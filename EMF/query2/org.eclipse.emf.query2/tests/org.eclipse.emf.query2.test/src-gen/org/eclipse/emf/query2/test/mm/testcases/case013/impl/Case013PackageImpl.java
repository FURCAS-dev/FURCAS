...
import org.eclipse.emf.query2.test.mm.testcases.case013.B13Sub1;
import org.eclipse.emf.query2.test.mm.testcases.case013.B13Sub1Sub2;
import org.eclipse.emf.query2.test.mm.testcases.case013.B13Sub2;
import org.eclipse.emf.query2.test.mm.testcases.case013.B13Sub2Sub;
import org.eclipse.emf.query2.test.mm.testcases.case013.C13Abstract;
import org.eclipse.emf.query2.test.mm.testcases.case013.C13Sub;
import org.eclipse.emf.query2.test.mm.testcases.case013.Case013Factory;
 ...
 * @generated
 */
public class Case013PackageImpl extends EPackageImpl implements Case013Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a13EClass = null;
	 ...
	 * @generated
	 */
	private EClass b13Sub2EClass = null;
	 ...
	 * @generated
	 */
	private EClass b13Sub2SubEClass = null;
	 ...
	 * @generated
	 */
	private EClass b13Sub1EClass = null;
	 ...
	 * @generated
	 */
	private EClass b13Sub1Sub2EClass = null;
	 ...
	 * @generated
	 */
	private EClass c13AbstractEClass = null;
	 ...
	 * @generated
	 */
	private EClass c13SubEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case013.Case013Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case013PackageImpl() {
		super(eNS_URI, Case013Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case013Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case013Package init() {
		if (isInited) return (Case013Package)EPackage.Registry.INSTANCE.getEPackage(Case013Package.eNS_URI);

		// Obtain or create and register package
		Case013PackageImpl theCase013Package = (Case013PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case013PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case013PackageImpl());
		...
		theCase013Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case013Package.eNS_URI, theCase013Package);
		return theCase013Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getA13_ConstrainedAttribute1() {
		return (EAttribute)a13EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getA13_ConstrainedAttributeMany1() {
		return (EReference)a13EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB13_InitializedIntegerAttribute1() {
		return (EAttribute)b13EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB13_InitializedStringAttribute1() {
		return (EAttribute)b13EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB13_InitializedBooleanAttribute1() {
		return (EAttribute)b13EClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB13_InitializedDoubleAttribute1() {
		return (EAttribute)b13EClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB13_NotInitializedStringAttribute1() {
		return (EAttribute)b13EClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB13_InitializedEnumerationAttribute1() {
		return (EAttribute)b13EClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EClass getB13Sub2() {
		return b13Sub2EClass;
	}
	 ...
	 * @generated
	 */
	public EClass getB13Sub2Sub() {
		return b13Sub2SubEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getB13Sub1() {
		return b13Sub1EClass;
	}
	 ...
	 * @generated
	 */
	public EClass getB13Sub1Sub2() {
		return b13Sub1Sub2EClass;
	}
	 ...
	 * @generated
	 */
	public EClass getC13Abstract() {
		return c13AbstractEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getC13Abstract_Attribute1() {
		return (EAttribute)c13AbstractEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Case013Factory getCase013Factory() {
		return (Case013Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a13EClass = createEClass(A13);
		createEAttribute(a13EClass, A13__CONSTRAINED_ATTRIBUTE1);
		createEReference(a13EClass, A13__CONSTRAINED_ATTRIBUTE_MANY1);

		b13EClass = createEClass(B13);
		createEAttribute(b13EClass, B13__INITIALIZED_INTEGER_ATTRIBUTE1);
		createEAttribute(b13EClass, B13__INITIALIZED_STRING_ATTRIBUTE1);
		createEAttribute(b13EClass, B13__INITIALIZED_BOOLEAN_ATTRIBUTE1);
		createEAttribute(b13EClass, B13__INITIALIZED_DOUBLE_ATTRIBUTE1);
		createEAttribute(b13EClass, B13__NOT_INITIALIZED_STRING_ATTRIBUTE1);
		createEAttribute(b13EClass, B13__INITIALIZED_ENUMERATION_ATTRIBUTE1);

		b13Sub2EClass = createEClass(B13_SUB2);

		b13Sub2SubEClass = createEClass(B13_SUB2_SUB);

		b13Sub1EClass = createEClass(B13_SUB1);

		b13Sub1Sub2EClass = createEClass(B13_SUB1_SUB2);

		c13AbstractEClass = createEClass(C13_ABSTRACT);
		createEAttribute(c13AbstractEClass, C13_ABSTRACT__ATTRIBUTE1);

		c13SubEClass = createEClass(C13_SUB);

		// Create enums
		e13EEnum = createEEnum(E13);
	}
	...
	public void initializePackageContents() {
		...
		b13Sub2EClass.getESuperTypes().add(this.getB13());
		b13Sub2SubEClass.getESuperTypes().add(this.getB13Sub2());
		b13Sub1EClass.getESuperTypes().add(this.getB13());
		b13Sub1Sub2EClass.getESuperTypes().add(this.getB13Sub1());
		b13Sub1Sub2EClass.getESuperTypes().add(this.getB13Sub2());
