...
import org.eclipse.emf.query2.test.mm.testcases.case022.Case022Factory;
 ...
 * @generated
 */
public class Case022PackageImpl extends EPackageImpl implements Case022Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a22JavadocEClass = null;
	 ...
	 * @generated
	 */
	private EClass b22JavadocSpecialCharactersEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case022.Case022Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case022PackageImpl() {
		super(eNS_URI, Case022Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case022Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case022Package init() {
		if (isInited) return (Case022Package)EPackage.Registry.INSTANCE.getEPackage(Case022Package.eNS_URI);

		// Obtain or create and register package
		Case022PackageImpl theCase022Package = (Case022PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case022PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case022PackageImpl());
		...
		theCase022Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case022Package.eNS_URI, theCase022Package);
		return theCase022Package;
	}
	 ...
	 * @generated
	 */
	public EClass getA22Javadoc() {
		return a22JavadocEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getA22Javadoc_AttributeJavadoc() {
		return (EAttribute)a22JavadocEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getB22JavadocSpecialCharacters() {
		return b22JavadocSpecialCharactersEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getB22JavadocSpecialCharacters_JavadocCommentEndSign() {
		return (EAttribute)b22JavadocSpecialCharactersEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB22JavadocSpecialCharacters_HttpAddress() {
		return (EAttribute)b22JavadocSpecialCharactersEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case022Factory getCase022Factory() {
		return (Case022Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a22JavadocEClass = createEClass(A22_JAVADOC);
		createEAttribute(a22JavadocEClass, A22_JAVADOC__ATTRIBUTE_JAVADOC);

		b22JavadocSpecialCharactersEClass = createEClass(B22_JAVADOC_SPECIAL_CHARACTERS);
		createEAttribute(b22JavadocSpecialCharactersEClass, B22_JAVADOC_SPECIAL_CHARACTERS__JAVADOC_COMMENT_END_SIGN);
		createEAttribute(b22JavadocSpecialCharactersEClass, B22_JAVADOC_SPECIAL_CHARACTERS__HTTP_ADDRESS);
	}
