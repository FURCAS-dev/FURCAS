...
import org.eclipse.emf.query2.test.mm.testcases.case014.Case014Factory;
 ...
 * @generated
 */
public class Case014PackageImpl extends EPackageImpl implements Case014Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a14EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case014.Case014Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case014PackageImpl() {
		super(eNS_URI, Case014Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case014Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case014Package init() {
		if (isInited) return (Case014Package)EPackage.Registry.INSTANCE.getEPackage(Case014Package.eNS_URI);

		// Obtain or create and register package
		Case014PackageImpl theCase014Package = (Case014PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case014PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case014PackageImpl());
		...
		theCase014Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case014Package.eNS_URI, theCase014Package);
		return theCase014Package;
	}
	 ...
	 * @generated
	 */
	public Case014Factory getCase014Factory() {
		return (Case014Factory)getEFactoryInstance();
	}
