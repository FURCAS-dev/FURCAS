...
import org.eclipse.emf.query2.test.mm.testcases.case007.clustered.ClusteredFactory;
 ...
 * @generated
 */
public class ClusteredPackageImpl extends EPackageImpl implements ClusteredPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass clusteredAEClass = null;
	 ...
	 * @generated
	 */
	private EClass clusteredBEClass = null;
	 ...
	 * @generated
	 */
	private EClass clusteredAReferencesClusteredBEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case007.clustered.ClusteredPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ClusteredPackageImpl() {
		super(eNS_URI, ClusteredFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ClusteredPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ClusteredPackage init() {
		if (isInited) return (ClusteredPackage)EPackage.Registry.INSTANCE.getEPackage(ClusteredPackage.eNS_URI);

		// Obtain or create and register package
		ClusteredPackageImpl theClusteredPackage = (ClusteredPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ClusteredPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ClusteredPackageImpl());
		...
		theClusteredPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ClusteredPackage.eNS_URI, theClusteredPackage);
		return theClusteredPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getClusteredA() {
		return clusteredAEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getClusteredB() {
		return clusteredBEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getClusteredAReferencesClusteredB() {
		return clusteredAReferencesClusteredBEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getClusteredAReferencesClusteredB_ClusteredB() {
		return (EReference)clusteredAReferencesClusteredBEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getClusteredAReferencesClusteredB_ClusteredA() {
		return (EReference)clusteredAReferencesClusteredBEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public ClusteredFactory getClusteredFactory() {
		return (ClusteredFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		clusteredAEClass = createEClass(CLUSTERED_A);

		clusteredBEClass = createEClass(CLUSTERED_B);

		clusteredAReferencesClusteredBEClass = createEClass(CLUSTERED_AREFERENCES_CLUSTERED_B);
		createEReference(clusteredAReferencesClusteredBEClass, CLUSTERED_AREFERENCES_CLUSTERED_B__CLUSTERED_B);
		createEReference(clusteredAReferencesClusteredBEClass, CLUSTERED_AREFERENCES_CLUSTERED_B__CLUSTERED_A);
	}
	...
	public void initializePackageContents() {
		...
		NestedOfClusteredPackage theNestedOfClusteredPackage = (NestedOfClusteredPackage)EPackage.Registry.INSTANCE.getEPackage(NestedOfClusteredPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theNestedOfClusteredPackage);
