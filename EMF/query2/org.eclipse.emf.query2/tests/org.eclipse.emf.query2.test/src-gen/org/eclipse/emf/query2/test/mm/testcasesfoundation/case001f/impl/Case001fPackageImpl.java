...
import org.eclipse.emf.query2.test.mm.testcasesfoundation.case001f.Case001fFactory;
 ...
 * @generated
 */
public class Case001fPackageImpl extends EPackageImpl implements Case001fPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a1fEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcasesfoundation.case001f.Case001fPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case001fPackageImpl() {
		super(eNS_URI, Case001fFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case001fPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case001fPackage init() {
		if (isInited) return (Case001fPackage)EPackage.Registry.INSTANCE.getEPackage(Case001fPackage.eNS_URI);

		// Obtain or create and register package
		Case001fPackageImpl theCase001fPackage = (Case001fPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case001fPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case001fPackageImpl());
		...
		theCase001fPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case001fPackage.eNS_URI, theCase001fPackage);
		return theCase001fPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getA1f_TranslatableText() {
		return (EReference)a1fEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getB1f_OnePrimitive() {
		return (EAttribute)b1fEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Case001fFactory getCase001fFactory() {
		return (Case001fFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a1fEClass = createEClass(A1F);
		createEReference(a1fEClass, A1F__TRANSLATABLE_TEXT);

		b1fEClass = createEClass(B1F);
		createEAttribute(b1fEClass, B1F__ONE_PRIMITIVE);
	}
