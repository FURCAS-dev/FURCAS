...
/**
 *<b>
 *<li>Rule 62:  operationPart ::= <= literal
 *</b>
 */
public class OpSmallerEqual extends Node implements IoperationPart
{
    private Iliteral _literal;

    public Iliteral getliteral() { return _literal; }

    public OpSmallerEqual(IToken leftIToken, IToken rightIToken,
                          Iliteral _literal)
    {
