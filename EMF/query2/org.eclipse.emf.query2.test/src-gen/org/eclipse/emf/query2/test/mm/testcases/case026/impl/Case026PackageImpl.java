...
import org.eclipse.emf.query2.test.mm.testcases.case026.Case026Factory;
 ...
 * @generated
 */
public class Case026PackageImpl extends EPackageImpl implements Case026Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a26EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case026.Case026Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case026PackageImpl() {
		super(eNS_URI, Case026Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case026Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case026Package init() {
		if (isInited) return (Case026Package)EPackage.Registry.INSTANCE.getEPackage(Case026Package.eNS_URI);

		// Obtain or create and register package
		Case026PackageImpl theCase026Package = (Case026PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case026PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case026PackageImpl());
		...
		theCase026Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case026Package.eNS_URI, theCase026Package);
		return theCase026Package;
	}
	 ...
	 * @generated
	 */
	public EReference getA26_ReflectToOne() {
		return (EReference)a26EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getA26_ReflectToMany() {
		return (EReference)a26EClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public Case026Factory getCase026Factory() {
		return (Case026Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a26EClass = createEClass(A26);
		createEReference(a26EClass, A26__REFLECT_TO_ONE);
		createEReference(a26EClass, A26__REFLECT_TO_MANY);
	}
