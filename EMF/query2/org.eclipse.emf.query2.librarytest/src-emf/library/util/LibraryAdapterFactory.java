 ...
 * </copyright>
 *
 * $Id: LibraryAdapterFactory.java,v 1.2 2009/10/09 20:08:23 bkolb Exp $
 */
...
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	protected LibrarySwitch<Adapter> modelSwitch =
		new LibrarySwitch<Adapter>() {
			...
			@Override
			public Adapter caseManuscript(Manuscript object) {
				return createManuscriptAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Publisher <em>Publisher</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Manuscript <em>Manuscript</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createManuscriptAdapter() {
		return null;
	}
