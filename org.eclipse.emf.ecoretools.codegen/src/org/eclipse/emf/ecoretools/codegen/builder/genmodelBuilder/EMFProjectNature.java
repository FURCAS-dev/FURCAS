 ...
 * 
 * EcoreProjectNature.java
 * 
 * Contributors:
 *    Daniel Weber - initial API and implementation
 *    Lucas Bigeardel - IP integration
 * 
 * $Id: EMFProjectNature.java,v 1.3 2008/04/28 12:23:25 jlescot Exp $
 **********************************************************************/
...
public class EMFProjectNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(GenModelBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(GenModelBuilder.BUILDER_ID);
