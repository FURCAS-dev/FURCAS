 ...
 * @generated
 */
public class OppositePropertyCallExpItemProvider extends NavigationCallExpItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addReferredOppositePropertyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ...
                        ExpressionsPackage.Literals.OPPOSITE_PROPERTY_CALL_EXP__REFERRED_OPPOSITE_PROPERTY, true, false, true,
                        null, null, null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/OppositePropertyCallExp")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        OppositePropertyCallExp<?, ?> oppositePropertyCallExp = (OppositePropertyCallExp<?, ?>) object;
        return getString("_UI_OppositePropertyCallExp_type") + " " + oppositePropertyCallExp.getStartPosition(); //$NON-NLS-1$ //$NON-NLS-2$
    }
