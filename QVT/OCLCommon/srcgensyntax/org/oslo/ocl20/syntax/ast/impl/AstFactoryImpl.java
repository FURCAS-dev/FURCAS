...
public class AstFactoryImpl extends EFactoryImpl implements AstFactory {
	...
	public static AstFactory init() {
		try {
			AstFactory theAstFactory = (AstFactory)EPackage.Registry.INSTANCE.getEFactory("urn:ast.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AstPackage.VISITABLE: return createVisitable();
			case AstPackage.VISITOR: return createVisitor();
			default:
