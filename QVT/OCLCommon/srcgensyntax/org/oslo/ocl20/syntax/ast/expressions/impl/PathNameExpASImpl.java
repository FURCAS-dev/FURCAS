...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Path Name Exp AS</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oslo.ocl20.syntax.ast.expressions.impl.PathNameExpASImpl#getPathName <em>Path Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PathNameExpASImpl extends PrimaryExpASImpl implements PathNameExpAS {
	/**
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.Literals.PATH_NAME_EXP_AS;
	}
	...
	public EList getPathName() {
		if (pathName == null) {
			pathName = new EDataTypeUniqueEList(String.class, this, ExpressionsPackage.PATH_NAME_EXP_AS__PATH_NAME);
		}
		return pathName;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionsPackage.PATH_NAME_EXP_AS__PATH_NAME:
				return getPathName();
		}
