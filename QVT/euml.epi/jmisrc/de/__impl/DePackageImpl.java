...
public final class DePackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    static {
        ...
        FEATURE_IDS.put("ikv", Integer.valueOf(0)); //$NON-NLS-1$
    }

    // constructors    
    public DePackageImpl()
    {
        super();
    }
    public DePackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    // nested packages
    public com.sap.tc.moin.repository.mmi.reflect.RefPackage getIkv(com.sap.tc.moin.repository.core.CoreConnection connection) {
        return  refPackage(connection, "ikv"); //$NON-NLS-1$
    }
    // classes
    // associations
    ...
    protected java.lang.Object create___Extent(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
        ...
        try {
            switch (FEATURE_IDS.get(name)) {
                case 0:
                    return new de.ikv.__impl.IkvPackageImpl(workspace, mofId, immediatePackage, metaObject);
                default:
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<de.__impl.DePackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new de.__impl.DePackageWrapper(conn, this, synchronize);
    }
