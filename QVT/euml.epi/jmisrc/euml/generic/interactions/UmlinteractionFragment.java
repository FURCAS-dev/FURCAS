 ...
 */
public interface UmlinteractionFragment extends euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlinteractionFragment> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlinteractionFragment>("497EF5D02AF407E0EC6911DD92F0000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLInteractionFragment"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlinteractionFragment,java.util.Collection<euml.generic.interactions.Umllifeline>> __covered;
        /**
         * Returns the descriptor for the <code>covered</code> reference.
         * @return  the descriptor for the <code>covered</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlinteractionFragment,java.util.Collection<euml.generic.interactions.Umllifeline>> COVERED( ) {
            if ( __covered == null ) {
                __covered = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlinteractionFragment,java.util.Collection<euml.generic.interactions.Umllifeline>>( "498659D8E7C4C883F0D011DD8C79000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteractionFragment", "covered" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __covered;
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.UmlinteractionFragment,java.util.List<euml.generic.relationships.Umlgeneralization>> __getgeneralOrdering;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.UmlinteractionFragment,java.util.List<euml.generic.relationships.Umlgeneralization>> GETGENERAL_ORDERING( ) {
            if ( __getgeneralOrdering == null ) {
                __getgeneralOrdering = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.UmlinteractionFragment,java.util.List<euml.generic.relationships.Umlgeneralization>>( "497EF5E93A00E000EC6911DD863A000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteractionFragment", "getgeneralOrdering" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getgeneralOrdering;
        }
    }
}    