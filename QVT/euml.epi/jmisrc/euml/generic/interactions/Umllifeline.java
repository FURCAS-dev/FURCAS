 ...
 */
public interface Umllifeline extends euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.Umllifeline> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.Umllifeline>("497EF6A9ABE9CB50EC6911DD9B7A000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLLifeline"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public java.util.Collection<euml.generic.interactions.UmlinteractionFragment> getCoveredBy() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public euml.generic.compositestructures.UmlconnectableElement getUmlconnectableelement() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setUmlconnectableelement(euml.generic.compositestructures.UmlconnectableElement newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public euml.generic.interactions.UmlpartDecomposition getDecomposedAs() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setDecomposedAs(euml.generic.interactions.UmlpartDecomposition newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,java.util.Collection<euml.generic.interactions.UmlinteractionFragment>> __coveredBy;
        /**
         * Returns the descriptor for the <code>coveredBy</code> reference.
         * @return  the descriptor for the <code>coveredBy</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,java.util.Collection<euml.generic.interactions.UmlinteractionFragment>> COVERED_BY( ) {
            if ( __coveredBy == null ) {
                __coveredBy = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,java.util.Collection<euml.generic.interactions.UmlinteractionFragment>>( "498659F2F79788B0F0D011DDC1B9000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLLifeline", "coveredBy" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __coveredBy;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,euml.generic.compositestructures.UmlconnectableElement> __umlconnectableelement;
        /**
         * Returns the descriptor for the <code>umlconnectableelement</code> reference.
         * @return  the descriptor for the <code>umlconnectableelement</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,euml.generic.compositestructures.UmlconnectableElement> UMLCONNECTABLEELEMENT( ) {
            if ( __umlconnectableelement == null ) {
                __umlconnectableelement = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,euml.generic.compositestructures.UmlconnectableElement>( "49865A4B2C255C63F0D111DDC947000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLLifeline", "umlconnectableelement" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __umlconnectableelement;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,euml.generic.interactions.UmlpartDecomposition> __decomposedAs;
        /**
         * Returns the descriptor for the <code>decomposedAs</code> reference.
         * @return  the descriptor for the <code>decomposedAs</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,euml.generic.interactions.UmlpartDecomposition> DECOMPOSED_AS( ) {
            if ( __decomposedAs == null ) {
                __decomposedAs = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.Umllifeline,euml.generic.interactions.UmlpartDecomposition>( "49865A9A5B4A25C3F0D111DDCC00000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLLifeline", "decomposedAs" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __decomposedAs;
        }
        /**
