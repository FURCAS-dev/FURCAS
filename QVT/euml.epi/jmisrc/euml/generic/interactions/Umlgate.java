 ...
 */
public interface Umlgate extends euml.generic.interactions.UmlmessageEnd {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.Umlgate> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.Umlgate>("497EF8D7F8A7FBF0EC6A11DDB1CA000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLGate"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
