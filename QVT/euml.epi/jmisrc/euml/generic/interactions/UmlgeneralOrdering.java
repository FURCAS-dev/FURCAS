 ...
 */
public interface UmlgeneralOrdering extends euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlgeneralOrdering> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlgeneralOrdering>("497EF92929693740EC6B11DD8361000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLGeneralOrdering"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public euml.generic.interactions.UmloccurrenceSpecification getAfter() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setAfter(euml.generic.interactions.UmloccurrenceSpecification newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public euml.generic.interactions.UmloccurrenceSpecification getBefore() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setBefore(euml.generic.interactions.UmloccurrenceSpecification newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlgeneralOrdering,euml.generic.interactions.UmloccurrenceSpecification> __after;
        /**
         * Returns the descriptor for the <code>after</code> reference.
         * @return  the descriptor for the <code>after</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlgeneralOrdering,euml.generic.interactions.UmloccurrenceSpecification> AFTER( ) {
            if ( __after == null ) {
                __after = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlgeneralOrdering,euml.generic.interactions.UmloccurrenceSpecification>( "498658D84F1B35B0F0D011DDAAEE000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLGeneralOrdering", "after" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __after;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlgeneralOrdering,euml.generic.interactions.UmloccurrenceSpecification> __before;
        /**
         * Returns the descriptor for the <code>before</code> reference.
         * @return  the descriptor for the <code>before</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlgeneralOrdering,euml.generic.interactions.UmloccurrenceSpecification> BEFORE( ) {
            if ( __before == null ) {
                __before = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlgeneralOrdering,euml.generic.interactions.UmloccurrenceSpecification>( "498658DC51DA7CC0F0D011DD8AA4000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLGeneralOrdering", "before" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __before;
        }
        /**
