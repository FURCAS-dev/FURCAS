 ...
 */
public interface UmlexecutionOccurrenceSpecification extends euml.generic.interactions.UmloccurrenceSpecification {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlexecutionOccurrenceSpecification> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlexecutionOccurrenceSpecification>("498663DCE0650F90F0D611DD90A6000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLExecutionOccurrenceSpecification"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public euml.generic.interactions.UmlexecutionSpecification getExecution() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setExecution(euml.generic.interactions.UmlexecutionSpecification newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlexecutionOccurrenceSpecification,euml.generic.interactions.UmlexecutionSpecification> __execution;
        /**
         * Returns the descriptor for the <code>execution</code> reference.
         * @return  the descriptor for the <code>execution</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlexecutionOccurrenceSpecification,euml.generic.interactions.UmlexecutionSpecification> EXECUTION( ) {
            if ( __execution == null ) {
                __execution = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlexecutionOccurrenceSpecification,euml.generic.interactions.UmlexecutionSpecification>( "4986645D2D03C6C3F0D711DDB7E2000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLExecutionOccurrenceSpecification", "execution" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __execution;
        }
        /**
