 ...
 */
public interface Umlinteraction extends euml.generic.commonbehaviors.Umlbehaviror,euml.generic.interactions.UmlinteractionFragment {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.Umlinteraction> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.Umlinteraction>("497EF70BE6701810EC6911DDB55F000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLInteraction"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // operations
    public java.util.List<euml.generic.interactions.Umllifeline> getlifeline() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.interactions.UmlinteractionFragment> getfragment() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.interactions.Umlmessage> getmessage() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.interactions.Umlgate> getformalGate() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.activities.Umlaction> getaction() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        /**
         * Returns the descriptor for the <code>specification</code> reference.
         * @return  the descriptor for the <code>specification</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.commonbehaviors.UmlbehavioralFeature> SPECIFICATION( ) {
            return euml.generic.commonbehaviors.Umlbehaviror.DESCRIPTORS.SPECIFICATION( );
        }
        /**
         * Returns the descriptor for the <code>theBehavioredClassifier</code> reference.
         * @return  the descriptor for the <code>theBehavioredClassifier</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlclassifier> THE_BEHAVIORED_CLASSIFIER( ) {
            return euml.generic.commonbehaviors.Umlbehaviror.DESCRIPTORS.THE_BEHAVIORED_CLASSIFIER( );
        }
        /**
        ...
        /**
         * Returns the descriptor for the <code>getownedParameters</code> operation.
         * @return  the descriptor for the <code>getownedParameters</code> operation
         */
        public com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlparameter> GETOWNED_PARAMETERS( ) {
            return euml.generic.commonbehaviors.Umlbehaviror.DESCRIPTORS.GETOWNED_PARAMETERS( );
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umllifeline>> __getlifeline;
        /**
         * Returns the descriptor for the <code>getlifeline</code> operation.
         * @return  the descriptor for the <code>getlifeline</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umllifeline>> GETLIFELINE( ) {
            if ( __getlifeline == null ) {
                __getlifeline = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umllifeline>>( "497EF73B036BAE20EC6A11DD8A03000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteraction", "getlifeline" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getlifeline;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.UmlinteractionFragment>> __getfragment;
        /**
         * Returns the descriptor for the <code>getfragment</code> operation.
         * @return  the descriptor for the <code>getfragment</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.UmlinteractionFragment>> GETFRAGMENT( ) {
            if ( __getfragment == null ) {
                __getfragment = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.UmlinteractionFragment>>( "497EF74C0D1FF6B0EC6A11DDB0B1000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteraction", "getfragment" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getfragment;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umlmessage>> __getmessage;
        /**
         * Returns the descriptor for the <code>getmessage</code> operation.
         * @return  the descriptor for the <code>getmessage</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umlmessage>> GETMESSAGE( ) {
            if ( __getmessage == null ) {
                __getmessage = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umlmessage>>( "497EF75D179C9850EC6A11DDCB97000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteraction", "getmessage" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getmessage;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umlgate>> __getformalGate;
        /**
         * Returns the descriptor for the <code>getformalGate</code> operation.
         * @return  the descriptor for the <code>getformalGate</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umlgate>> GETFORMAL_GATE( ) {
            if ( __getformalGate == null ) {
                __getformalGate = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.interactions.Umlgate>>( "497EF8EC0554EB10EC6B11DD8730000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteraction", "getformalGate" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getformalGate;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.activities.Umlaction>> __getaction;
        /**
         * Returns the descriptor for the <code>getaction</code> operation.
         * @return  the descriptor for the <code>getaction</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.activities.Umlaction>> GETACTION( ) {
            if ( __getaction == null ) {
                __getaction = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.Umlinteraction,java.util.List<euml.generic.activities.Umlaction>>( "497EF90312E1D9F0EC6B11DD90BD000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteraction", "getaction" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getaction;
        }
    }
