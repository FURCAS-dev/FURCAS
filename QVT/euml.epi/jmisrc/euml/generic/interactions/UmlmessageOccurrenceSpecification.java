 ...
 */
public interface UmlmessageOccurrenceSpecification extends euml.generic.interactions.UmloccurrenceSpecification,euml.generic.interactions.UmlmessageEnd {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlmessageOccurrenceSpecification> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlmessageOccurrenceSpecification>("4986648343BFA190F0D711DD9AE8000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLMessageOccurrenceSpecification"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public euml.generic.commonbehaviors.UmlmessageEvent getOccurringMessageEvent() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setOccurringMessageEvent(euml.generic.commonbehaviors.UmlmessageEvent newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>> TO_AFTER( ) {
            return euml.generic.interactions.UmloccurrenceSpecification.DESCRIPTORS.TO_AFTER( );
        }
        /**
         * Returns the descriptor for the <code>toBefore</code> reference.
         * @return  the descriptor for the <code>toBefore</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>> TO_BEFORE( ) {
            return euml.generic.interactions.UmloccurrenceSpecification.DESCRIPTORS.TO_BEFORE( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>> START_EXECUTIOIN( ) {
            return euml.generic.interactions.UmloccurrenceSpecification.DESCRIPTORS.START_EXECUTIOIN( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>> FINISH_EXECUTION( ) {
            return euml.generic.interactions.UmloccurrenceSpecification.DESCRIPTORS.FINISH_EXECUTION( );
        }
        /**
         * Returns the descriptor for the <code>message</code> reference.
         * @return  the descriptor for the <code>message</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlmessageEnd,euml.generic.interactions.Umlmessage> MESSAGE( ) {
            return euml.generic.interactions.UmlmessageEnd.DESCRIPTORS.MESSAGE( );
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlmessageOccurrenceSpecification,euml.generic.commonbehaviors.UmlmessageEvent> __occurringMessageEvent;
        /**
         * Returns the descriptor for the <code>occurringMessageEvent</code> reference.
         * @return  the descriptor for the <code>occurringMessageEvent</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlmessageOccurrenceSpecification,euml.generic.commonbehaviors.UmlmessageEvent> OCCURRING_MESSAGE_EVENT( ) {
            if ( __occurringMessageEvent == null ) {
                __occurringMessageEvent = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlmessageOccurrenceSpecification,euml.generic.commonbehaviors.UmlmessageEvent>( "4986651A9D931580F0D711DDB9C2000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLMessageOccurrenceSpecification", "occurringMessageEvent" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __occurringMessageEvent;
        }
        /**
