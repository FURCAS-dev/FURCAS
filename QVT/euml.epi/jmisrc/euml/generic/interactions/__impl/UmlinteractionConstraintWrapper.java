...
public class UmlinteractionConstraintWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmlinteractionConstraintImpl> implements euml.generic.interactions.UmlinteractionConstraint,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinteractionConstraintWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmlinteractionConstraintImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.interactions.__impl.UmlinteractionConstraintImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmlinteractionConstraintImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmlinteractionConstraintImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmlinteractionConstraintImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmlinteractionConstraintImpl unwrap() {
        return (euml.generic.interactions.__impl.UmlinteractionConstraintImpl) getWrappedObject();
    }
    ...
    public java.lang.String getConstraint() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getConstraint();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getConstraint();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setConstraint(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.String getConstraintLanguage() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getConstraintLanguage();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getConstraintLanguage();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setConstraintLanguage(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.UmlinteractionConstraint (Java Type)\nEUML.Generic.Interactions.UMLInteractionConstraint (MOF Type)"; //$NON-NLS-1$
    }    
}