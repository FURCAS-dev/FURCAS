...
public class UmlexecutionOccurrenceSpecificationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl> implements euml.generic.interactions.UmlexecutionOccurrenceSpecification,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlexecutionOccurrenceSpecificationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl unwrap() {
        return (euml.generic.interactions.__impl.UmlexecutionOccurrenceSpecificationImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.interactions.UmlexecutionSpecification) wrapResult(getCastWrappedObject().getExecution(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setExecution(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.UmlexecutionOccurrenceSpecification (Java Type)\nEUML.Generic.Interactions.UMLExecutionOccurrenceSpecification (MOF Type)"; //$NON-NLS-1$
    }    
}