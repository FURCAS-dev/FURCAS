...
public class UmlcontinuationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmlcontinuationImpl> implements euml.generic.interactions.Umlcontinuation,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlcontinuationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmlcontinuationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.interactions.__impl.UmlcontinuationImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmlcontinuationImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmlcontinuationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmlcontinuationImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmlcontinuationImpl unwrap() {
        return (euml.generic.interactions.__impl.UmlcontinuationImpl) getWrappedObject();
    }
    ...
    public boolean isSetting() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isSetting();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isSetting();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setSetting(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.Umlcontinuation (Java Type)\nEUML.Generic.Interactions.UMLContinuation (MOF Type)"; //$NON-NLS-1$
    }    
}