...
public class UmlactionExecutionSpecificationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl> implements euml.generic.interactions.UmlactionExecutionSpecification,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlactionExecutionSpecificationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl unwrap() {
        return (euml.generic.interactions.__impl.UmlactionExecutionSpecificationImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.interactions.UmloccurrenceSpecification) wrapResult(getCastWrappedObject().getStart(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.interactions.UmloccurrenceSpecification) wrapResult(getCastWrappedObject().getFinish(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setFinish(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public euml.generic.activities.Umlaction getExecutingAction() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.activities.Umlaction) wrapResult(getCastWrappedObject().getExecutingAction(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setExecutingAction(euml.generic.activities.Umlaction newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setExecutingAction(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.UmlactionExecutionSpecification (Java Type)\nEUML.Generic.Interactions.UMLActionExecutionSpecification (MOF Type)"; //$NON-NLS-1$
    }    
}