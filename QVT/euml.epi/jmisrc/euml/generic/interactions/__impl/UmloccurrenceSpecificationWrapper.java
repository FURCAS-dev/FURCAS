...
public class UmloccurrenceSpecificationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl> implements euml.generic.interactions.UmloccurrenceSpecification,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmloccurrenceSpecificationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl unwrap() {
        return (euml.generic.interactions.__impl.UmloccurrenceSpecificationImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.UmloccurrenceSpecification (Java Type)\nEUML.Generic.Interactions.UMLOccurrenceSpecification (MOF Type)"; //$NON-NLS-1$
    }    
}