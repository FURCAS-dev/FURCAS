...
public class UmlinteractionOperandWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmlinteractionOperandImpl> implements euml.generic.interactions.UmlinteractionOperand,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinteractionOperandWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmlinteractionOperandImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.interactions.__impl.UmlinteractionOperandImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmlinteractionOperandImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmlinteractionOperandImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmlinteractionOperandImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmlinteractionOperandImpl unwrap() {
        return (euml.generic.interactions.__impl.UmlinteractionOperandImpl) getWrappedObject();
    }
    ...
    public java.util.Collection<euml.generic.interactions.UmlinteractionConstraint> getguard() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.Collection<euml.generic.interactions.UmlinteractionConstraint>)___invokeOperation(connection, 7, "49865D8F1ED9D160F0D311DD9089000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.Collection<euml.generic.interactions.UmlinteractionConstraint> invoke__getguard(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 7:
                return ___invokeOperation( connection, operationId, "49865D8F1ED9D160F0D311DD9089000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 7:
                return invoke__getguard(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.UmlinteractionOperand (Java Type)\nEUML.Generic.Interactions.UMLInteractionOperand (MOF Type)"; //$NON-NLS-1$
    }    
}