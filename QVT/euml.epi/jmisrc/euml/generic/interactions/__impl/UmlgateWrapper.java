...
public class UmlgateWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmlgateImpl> implements euml.generic.interactions.Umlgate,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlgateWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmlgateImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.interactions.__impl.UmlgateImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmlgateImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmlgateImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmlgateImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmlgateImpl unwrap() {
        return (euml.generic.interactions.__impl.UmlgateImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.Umlgate (Java Type)\nEUML.Generic.Interactions.UMLGate (MOF Type)"; //$NON-NLS-1$
    }    
}