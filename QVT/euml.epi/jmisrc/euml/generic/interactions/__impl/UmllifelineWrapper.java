...
public class UmllifelineWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.interactions.__impl.UmllifelineImpl> implements euml.generic.interactions.Umllifeline,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmllifelineWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.interactions.__impl.UmllifelineImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.interactions.__impl.UmllifelineImpl getCastWrappedObject() {
        return (euml.generic.interactions.__impl.UmllifelineImpl) getWrappedObject();
    }
    
    private euml.generic.interactions.__impl.UmllifelineImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.interactions.__impl.UmllifelineImpl) resolved;
    }
    
    public euml.generic.interactions.__impl.UmllifelineImpl unwrap() {
        return (euml.generic.interactions.__impl.UmllifelineImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<euml.generic.interactions.UmlinteractionFragment>) wrapResult(getCastWrappedObject().getCoveredBy(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.compositestructures.UmlconnectableElement) wrapResult(getCastWrappedObject().getUmlconnectableelement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setUmlconnectableelement(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.interactions.UmlpartDecomposition) wrapResult(getCastWrappedObject().getDecomposedAs(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDecomposedAs(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.interactions.Umllifeline (Java Type)\nEUML.Generic.Interactions.UMLLifeline (MOF Type)"; //$NON-NLS-1$
    }    
}