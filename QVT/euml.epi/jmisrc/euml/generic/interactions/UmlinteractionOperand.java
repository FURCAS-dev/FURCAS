 ...
 */
public interface UmlinteractionOperand extends euml.generic.interactions.UmlinteractionFragment,euml.generic.kernel.Umlnamespace {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlinteractionOperand> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlinteractionOperand>("49865D6404FA9680F0D311DDB3FB000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLInteractionOperand"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.UmlinteractionOperand,java.util.Collection<euml.generic.interactions.UmlinteractionConstraint>> __getguard;
        /**
         * Returns the descriptor for the <code>getguard</code> operation.
         * @return  the descriptor for the <code>getguard</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.UmlinteractionOperand,java.util.Collection<euml.generic.interactions.UmlinteractionConstraint>> GETGUARD( ) {
            if ( __getguard == null ) {
                __getguard = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.interactions.UmlinteractionOperand,java.util.Collection<euml.generic.interactions.UmlinteractionConstraint>>( "49865D8F1ED9D160F0D311DD9089000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLInteractionOperand", "getguard" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getguard;
        }
    }
