 ...
 */
public interface UmloccurrenceSpecification extends euml.generic.interactions.UmlinteractionFragment {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmloccurrenceSpecification> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmloccurrenceSpecification>("4986581FE0D40230F0CF11DDCC54000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLOccurrenceSpecification"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public java.util.List<euml.generic.interactions.UmlgeneralOrdering> getToAfter() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.interactions.UmlgeneralOrdering> getToBefore() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.Collection<euml.generic.interactions.UmlexecutionSpecification> getStartExecutioin() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.Collection<euml.generic.interactions.UmlexecutionSpecification> getFinishExecution() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>> __toAfter;
        /**
         * Returns the descriptor for the <code>toAfter</code> reference.
         * @return  the descriptor for the <code>toAfter</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>> TO_AFTER( ) {
            if ( __toAfter == null ) {
                __toAfter = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>>( "498658801ADBD023F0D011DDAF05000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLOccurrenceSpecification", "toAfter" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __toAfter;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>> __toBefore;
        /**
         * Returns the descriptor for the <code>toBefore</code> reference.
         * @return  the descriptor for the <code>toBefore</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>> TO_BEFORE( ) {
            if ( __toBefore == null ) {
                __toBefore = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.List<euml.generic.interactions.UmlgeneralOrdering>>( "498658AB343A6953F0D011DD80C8000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLOccurrenceSpecification", "toBefore" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __toBefore;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>> __startExecutioin;
        /**
         * Returns the descriptor for the <code>startExecutioin</code> reference.
         * @return  the descriptor for the <code>startExecutioin</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>> START_EXECUTIOIN( ) {
            if ( __startExecutioin == null ) {
                __startExecutioin = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>>( "498659287F083113F0D011DD8552000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLOccurrenceSpecification", "startExecutioin" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __startExecutioin;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>> __finishExecution;
        /**
         * Returns the descriptor for the <code>finishExecution</code> reference.
         * @return  the descriptor for the <code>finishExecution</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>> FINISH_EXECUTION( ) {
            if ( __finishExecution == null ) {
                __finishExecution = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmloccurrenceSpecification,java.util.Collection<euml.generic.interactions.UmlexecutionSpecification>>( "4986596FA952C2A2F0D011DDBF3C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLOccurrenceSpecification", "finishExecution" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __finishExecution;
        }
        /**
