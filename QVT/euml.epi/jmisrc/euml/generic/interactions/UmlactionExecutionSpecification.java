 ...
 */
public interface UmlactionExecutionSpecification extends euml.generic.interactions.UmlexecutionSpecification {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlactionExecutionSpecification> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.interactions.UmlactionExecutionSpecification>("497EF65D7EEE4A90EC6911DD89FE000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Interactions", "UMLActionExecutionSpecification"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlexecutionSpecification,euml.generic.interactions.UmloccurrenceSpecification> START( ) {
            return euml.generic.interactions.UmlexecutionSpecification.DESCRIPTORS.START( );
        }
        /**
         * Returns the descriptor for the <code>finish</code> reference.
         * @return  the descriptor for the <code>finish</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlexecutionSpecification,euml.generic.interactions.UmloccurrenceSpecification> FINISH( ) {
            return euml.generic.interactions.UmlexecutionSpecification.DESCRIPTORS.FINISH( );
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlactionExecutionSpecification,euml.generic.activities.Umlaction> __executingAction;
        /**
         * Returns the descriptor for the <code>executingAction</code> reference.
         * @return  the descriptor for the <code>executingAction</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlactionExecutionSpecification,euml.generic.activities.Umlaction> EXECUTING_ACTION( ) {
            if ( __executingAction == null ) {
                __executingAction = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.interactions.UmlactionExecutionSpecification,euml.generic.activities.Umlaction>( "498657D2B2DE1BE3F0CF11DD840D000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Interactions", "UMLActionExecutionSpecification", "executingAction" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __executingAction;
        }
        /**
