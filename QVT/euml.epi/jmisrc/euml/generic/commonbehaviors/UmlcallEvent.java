 ...
 */
public interface UmlcallEvent extends euml.generic.commonbehaviors.UmlmessageEvent {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlcallEvent> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlcallEvent>("497EE962C2555CE0EC6111DDCB06000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CommonBehaviors", "UMLCallEvent"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlcallEvent,euml.generic.kernel.Umloperation> __operation;
        /**
         * Returns the descriptor for the <code>operation</code> reference.
         * @return  the descriptor for the <code>operation</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlcallEvent,euml.generic.kernel.Umloperation> OPERATION( ) {
            if ( __operation == null ) {
                __operation = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlcallEvent,euml.generic.kernel.Umloperation>( "498647A40E0D5AD0F0C611DDA7EB000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLCallEvent", "operation" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __operation;
        }
        /**
