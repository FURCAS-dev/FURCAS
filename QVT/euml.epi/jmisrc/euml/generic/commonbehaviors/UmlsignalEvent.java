 ...
 */
public interface UmlsignalEvent extends euml.generic.commonbehaviors.UmlmessageEvent {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlsignalEvent> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlsignalEvent>("497EEA0C276DA470EC6211DD9A2C000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CommonBehaviors", "UMLSignalEvent"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlsignalEvent,euml.generic.commonbehaviors.Umlsignal> __signal;
        /**
         * Returns the descriptor for the <code>signal</code> reference.
         * @return  the descriptor for the <code>signal</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlsignalEvent,euml.generic.commonbehaviors.Umlsignal> SIGNAL( ) {
            if ( __signal == null ) {
                __signal = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlsignalEvent,euml.generic.commonbehaviors.Umlsignal>( "4986480A4B3183F3F0C611DDC42E000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLSignalEvent", "signal" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __signal;
        }
        /**
