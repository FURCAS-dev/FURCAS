 ...
 */
public interface Umlbehaviror extends euml.generic.kernel.Umlclass {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.Umlbehaviror> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.Umlbehaviror>("497EDD358093E210EC5A11DDC5B0000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CommonBehaviors", "UMLBehaviror"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.commonbehaviors.UmlbehavioralFeature> __specification;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.commonbehaviors.UmlbehavioralFeature> SPECIFICATION( ) {
            if ( __specification == null ) {
                __specification = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.commonbehaviors.UmlbehavioralFeature>( "4986440FEBFB0B10F0C311DDA6CD000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLBehaviror", "specification" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __specification;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlclassifier> __theBehavioredClassifier;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlclassifier> THE_BEHAVIORED_CLASSIFIER( ) {
            if ( __theBehavioredClassifier == null ) {
                __theBehavioredClassifier = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlclassifier>( "49866E793399F7B3F0DD11DD8312000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLBehaviror", "theBehavioredClassifier" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theBehavioredClassifier;
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlparameter> __getownedParameters;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlparameter> GETOWNED_PARAMETERS( ) {
            if ( __getownedParameters == null ) {
                __getownedParameters = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.Umlbehaviror,euml.generic.kernel.Umlparameter>( "497EEAF8B3ED81E0EC6211DDCE02000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLBehaviror", "getownedParameters" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedParameters;
        }
    }
}    