 ...
 */
public interface UmltimeEvent extends euml.generic.commonbehaviors.Umlevent {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmltimeEvent> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmltimeEvent>("497EEA2636B89700EC6211DD9250000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CommonBehaviors", "UMLTimeEvent"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    // operations
    public euml.generic.kernel.UmlvalueSpecification getwhen() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.commonbehaviors.UmltimeEvent,java.lang.Boolean> __isRelative;
        /**
         * Returns the descriptor for the <code>isRelative</code> attribute.
         * @return  the descriptor for the <code>isRelative</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.commonbehaviors.UmltimeEvent,java.lang.Boolean> IS_RELATIVE( ) {
            if ( __isRelative == null ) {
                __isRelative = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.commonbehaviors.UmltimeEvent,java.lang.Boolean>( "497EEA5854AE6B90EC6211DDC9F7000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLTimeEvent", "isRelative" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __isRelative;
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.UmltimeEvent,euml.generic.kernel.UmlvalueSpecification> __getwhen;
        /**
         * Returns the descriptor for the <code>getwhen</code> operation.
         * @return  the descriptor for the <code>getwhen</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.UmltimeEvent,euml.generic.kernel.UmlvalueSpecification> GETWHEN( ) {
            if ( __getwhen == null ) {
                __getwhen = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.commonbehaviors.UmltimeEvent,euml.generic.kernel.UmlvalueSpecification>( "497EEA36407FF260EC6211DDC31D000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLTimeEvent", "getwhen" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getwhen;
        }
    }
