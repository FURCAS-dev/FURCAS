 ...
 */
public interface UmlmessageEvent extends euml.generic.commonbehaviors.Umlevent {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlmessageEvent> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlmessageEvent>("497EE946B1990000EC6111DDB95A000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CommonBehaviors", "UMLMessageEvent"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
