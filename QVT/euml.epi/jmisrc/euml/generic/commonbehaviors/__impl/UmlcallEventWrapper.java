...
public class UmlcallEventWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.commonbehaviors.__impl.UmlcallEventImpl> implements euml.generic.commonbehaviors.UmlcallEvent,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlcallEventWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.commonbehaviors.__impl.UmlcallEventImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.commonbehaviors.__impl.UmlcallEventImpl getCastWrappedObject() {
        return (euml.generic.commonbehaviors.__impl.UmlcallEventImpl) getWrappedObject();
    }
    
    private euml.generic.commonbehaviors.__impl.UmlcallEventImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.commonbehaviors.__impl.UmlcallEventImpl) resolved;
    }
    
    public euml.generic.commonbehaviors.__impl.UmlcallEventImpl unwrap() {
        return (euml.generic.commonbehaviors.__impl.UmlcallEventImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.commonbehaviors.UmlcallEvent (Java Type)\nEUML.Generic.CommonBehaviors.UMLCallEvent (MOF Type)"; //$NON-NLS-1$
    }    
}