...
public class UmltriggerWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.commonbehaviors.__impl.UmltriggerImpl> implements euml.generic.commonbehaviors.Umltrigger,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmltriggerWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.commonbehaviors.__impl.UmltriggerImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.commonbehaviors.__impl.UmltriggerImpl getCastWrappedObject() {
        return (euml.generic.commonbehaviors.__impl.UmltriggerImpl) getWrappedObject();
    }
    
    private euml.generic.commonbehaviors.__impl.UmltriggerImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.commonbehaviors.__impl.UmltriggerImpl) resolved;
    }
    
    public euml.generic.commonbehaviors.__impl.UmltriggerImpl unwrap() {
        return (euml.generic.commonbehaviors.__impl.UmltriggerImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.commonbehaviors.Umlevent) wrapResult(getCastWrappedObject().getEvent(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setEvent(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.commonbehaviors.Umltrigger (Java Type)\nEUML.Generic.CommonBehaviors.UMLTrigger (MOF Type)"; //$NON-NLS-1$
    }    
}