...
public class UmltimeEventWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.commonbehaviors.__impl.UmltimeEventImpl> implements euml.generic.commonbehaviors.UmltimeEvent,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmltimeEventWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.commonbehaviors.__impl.UmltimeEventImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.commonbehaviors.__impl.UmltimeEventImpl getCastWrappedObject() {
        return (euml.generic.commonbehaviors.__impl.UmltimeEventImpl) getWrappedObject();
    }
    
    private euml.generic.commonbehaviors.__impl.UmltimeEventImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.commonbehaviors.__impl.UmltimeEventImpl) resolved;
    }
    
    public euml.generic.commonbehaviors.__impl.UmltimeEventImpl unwrap() {
        return (euml.generic.commonbehaviors.__impl.UmltimeEventImpl) getWrappedObject();
    }
    ...
    public boolean isRelative() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isRelative();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isRelative();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setRelative(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public euml.generic.kernel.UmlvalueSpecification getwhen() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (euml.generic.kernel.UmlvalueSpecification)___invokeOperation(connection, 5, "497EEA36407FF260EC6211DDC31D000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private euml.generic.kernel.UmlvalueSpecification invoke__getwhen(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 5:
                return ___invokeOperation( connection, operationId, "497EEA36407FF260EC6211DDC31D000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 5:
                return invoke__getwhen(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.commonbehaviors.UmltimeEvent (Java Type)\nEUML.Generic.CommonBehaviors.UMLTimeEvent (MOF Type)"; //$NON-NLS-1$
    }    
}