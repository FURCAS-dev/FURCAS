...
public class UmlreceptionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.commonbehaviors.__impl.UmlreceptionImpl> implements euml.generic.commonbehaviors.Umlreception,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlreceptionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.commonbehaviors.__impl.UmlreceptionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.commonbehaviors.__impl.UmlreceptionImpl getCastWrappedObject() {
        return (euml.generic.commonbehaviors.__impl.UmlreceptionImpl) getWrappedObject();
    }
    
    private euml.generic.commonbehaviors.__impl.UmlreceptionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.commonbehaviors.__impl.UmlreceptionImpl) resolved;
    }
    
    public euml.generic.commonbehaviors.__impl.UmlreceptionImpl unwrap() {
        return (euml.generic.commonbehaviors.__impl.UmlreceptionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.commonbehaviors.Umlreception (Java Type)\nEUML.Generic.CommonBehaviors.UMLReception (MOF Type)"; //$NON-NLS-1$
    }    
}