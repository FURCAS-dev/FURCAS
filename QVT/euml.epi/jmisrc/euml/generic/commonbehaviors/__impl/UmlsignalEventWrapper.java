...
public class UmlsignalEventWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.commonbehaviors.__impl.UmlsignalEventImpl> implements euml.generic.commonbehaviors.UmlsignalEvent,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlsignalEventWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.commonbehaviors.__impl.UmlsignalEventImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.commonbehaviors.__impl.UmlsignalEventImpl getCastWrappedObject() {
        return (euml.generic.commonbehaviors.__impl.UmlsignalEventImpl) getWrappedObject();
    }
    
    private euml.generic.commonbehaviors.__impl.UmlsignalEventImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.commonbehaviors.__impl.UmlsignalEventImpl) resolved;
    }
    
    public euml.generic.commonbehaviors.__impl.UmlsignalEventImpl unwrap() {
        return (euml.generic.commonbehaviors.__impl.UmlsignalEventImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.commonbehaviors.UmlsignalEvent (Java Type)\nEUML.Generic.CommonBehaviors.UMLSignalEvent (MOF Type)"; //$NON-NLS-1$
    }    
}