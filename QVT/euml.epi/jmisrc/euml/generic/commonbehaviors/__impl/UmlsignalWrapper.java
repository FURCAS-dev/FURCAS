...
public class UmlsignalWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.commonbehaviors.__impl.UmlsignalImpl> implements euml.generic.commonbehaviors.Umlsignal,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlsignalWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.commonbehaviors.__impl.UmlsignalImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.commonbehaviors.__impl.UmlsignalImpl getCastWrappedObject() {
        return (euml.generic.commonbehaviors.__impl.UmlsignalImpl) getWrappedObject();
    }
    
    private euml.generic.commonbehaviors.__impl.UmlsignalImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.commonbehaviors.__impl.UmlsignalImpl) resolved;
    }
    
    public euml.generic.commonbehaviors.__impl.UmlsignalImpl unwrap() {
        return (euml.generic.commonbehaviors.__impl.UmlsignalImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.kernel.Umlproperty> getownedProperties() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlproperty>)___invokeOperation(connection, 11, "497EE9ABEDC079A0EC6111DD97D4000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 11:
                return ___invokeOperation( connection, operationId, "497EE9ABEDC079A0EC6111DD97D4000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.commonbehaviors.Umlsignal (Java Type)\nEUML.Generic.CommonBehaviors.UMLSignal (MOF Type)"; //$NON-NLS-1$
    }    
}