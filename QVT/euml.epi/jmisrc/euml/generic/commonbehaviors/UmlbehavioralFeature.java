 ...
 */
public interface UmlbehavioralFeature extends euml.generic.kernel.Umlfeature {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlbehavioralFeature> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.commonbehaviors.UmlbehavioralFeature>("497EDD5E98D6AB00EC5A11DDA4C9000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CommonBehaviors", "UMLBehavioralFeature"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlbehavioralFeature,java.util.List<euml.generic.commonbehaviors.Umlbehaviror>> __method;
        /**
         * Returns the descriptor for the <code>method</code> reference.
         * @return  the descriptor for the <code>method</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlbehavioralFeature,java.util.List<euml.generic.commonbehaviors.Umlbehaviror>> METHOD( ) {
            if ( __method == null ) {
                __method = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlbehavioralFeature,java.util.List<euml.generic.commonbehaviors.Umlbehaviror>>( "498643738E919F23F0C311DDCB65000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CommonBehaviors", "UMLBehavioralFeature", "method" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __method;
        }
        /**
