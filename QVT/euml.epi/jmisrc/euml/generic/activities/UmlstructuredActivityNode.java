 ...
 */
public interface UmlstructuredActivityNode extends euml.generic.activities.Umlaction,euml.generic.kernel.Umlnamespace,euml.generic.activities.UmlactivityGroup {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlstructuredActivityNode> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlstructuredActivityNode>("497EF31C8E335BA0EC6711DD90E8000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLStructuredActivityNode"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.UmlstructuredActivityNode,java.lang.Boolean> __mustIsolate;
        /**
         * Returns the descriptor for the <code>mustIsolate</code> attribute.
         * @return  the descriptor for the <code>mustIsolate</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.UmlstructuredActivityNode,java.lang.Boolean> MUST_ISOLATE( ) {
            if ( __mustIsolate == null ) {
                __mustIsolate = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.UmlstructuredActivityNode,java.lang.Boolean>( "497EF37BC7112880EC6711DDA330000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLStructuredActivityNode", "mustIsolate" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.UmlstructuredActivityNode,java.util.List<euml.generic.activities.UmlactivityNode>> __getownedActivityNodes;
        /**
         * Returns the descriptor for the <code>getownedActivityNodes</code> operation.
         * @return  the descriptor for the <code>getownedActivityNodes</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.UmlstructuredActivityNode,java.util.List<euml.generic.activities.UmlactivityNode>> GETOWNED_ACTIVITY_NODES( ) {
            if ( __getownedActivityNodes == null ) {
                __getownedActivityNodes = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.UmlstructuredActivityNode,java.util.List<euml.generic.activities.UmlactivityNode>>( "497EF345A6DEF880EC6711DD9759000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLStructuredActivityNode", "getownedActivityNodes" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedActivityNodes;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.UmlstructuredActivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>> __getownedActivityEdges;
        /**
         * Returns the descriptor for the <code>getownedActivityEdges</code> operation.
         * @return  the descriptor for the <code>getownedActivityEdges</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.UmlstructuredActivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>> GETOWNED_ACTIVITY_EDGES( ) {
            if ( __getownedActivityEdges == null ) {
                __getownedActivityEdges = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.UmlstructuredActivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>>( "497EF359B2691280EC6711DD940C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLStructuredActivityNode", "getownedActivityEdges" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedActivityEdges;
        }
    }
}    