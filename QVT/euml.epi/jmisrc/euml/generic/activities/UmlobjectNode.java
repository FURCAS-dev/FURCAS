 ...
 */
public interface UmlobjectNode extends euml.generic.activities.UmlactivityNode,euml.generic.kernel.UmltypedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlobjectNode> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlobjectNode>("497EEE53B41961F0EC6411DD88DF000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLObjectNode"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlobjectNode,euml.generic.kernel.UmlvalueSpecification> __allocationscheme;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlobjectNode,euml.generic.kernel.UmlvalueSpecification> ALLOCATIONSCHEME( ) {
            if ( __allocationscheme == null ) {
                __allocationscheme = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlobjectNode,euml.generic.kernel.UmlvalueSpecification>( "49865605A0898840F0CE11DDCE2C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLObjectNode", "allocationscheme" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __allocationscheme;
        }
        /**
