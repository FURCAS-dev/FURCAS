 ...
 */
public interface UmldecisionMergeNode extends euml.generic.activities.UmlcontrolNode {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmldecisionMergeNode> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmldecisionMergeNode>("497EF216F21C6770EC6611DDADDF000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLDecisionMergeNode"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmldecisionMergeNode,euml.generic.commonbehaviors.Umlbehaviror> __decisionInput;
        /**
         * Returns the descriptor for the <code>decisionInput</code> reference.
         * @return  the descriptor for the <code>decisionInput</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmldecisionMergeNode,euml.generic.commonbehaviors.Umlbehaviror> DECISION_INPUT( ) {
            if ( __decisionInput == null ) {
                __decisionInput = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmldecisionMergeNode,euml.generic.commonbehaviors.Umlbehaviror>( "4986544796BA8130F0CD11DD9EC1000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLDecisionMergeNode", "decisionInput" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __decisionInput;
        }
        /**
