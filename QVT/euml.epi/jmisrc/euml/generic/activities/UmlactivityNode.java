 ...
 */
public interface UmlactivityNode extends euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlactivityNode> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlactivityNode>("497EEDE673511000EC6411DDC816000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLActivityNode"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>> __theIncomingEdge;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>> THE_INCOMING_EDGE( ) {
            if ( __theIncomingEdge == null ) {
                __theIncomingEdge = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>>( "49864F2D8C2B9773F0CA11DDAFA6000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivityNode", "theIncomingEdge" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theIncomingEdge;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>> __theOutgoingEdge;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>> THE_OUTGOING_EDGE( ) {
            if ( __theOutgoingEdge == null ) {
                __theOutgoingEdge = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,java.util.List<euml.generic.activities.UmlactivityEdge>>( "49864FACD7EA4EE0F0CA11DDA8AB000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivityNode", "theOutgoingEdge" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theOutgoingEdge;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,euml.generic.activities.UmlactivityGroup> __thegroupofthenode;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,euml.generic.activities.UmlactivityGroup> THEGROUPOFTHENODE( ) {
            if ( __thegroupofthenode == null ) {
                __thegroupofthenode = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityNode,euml.generic.activities.UmlactivityGroup>( "498650BA789D6070F0CB11DDC808000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivityNode", "thegroupofthenode" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __thegroupofthenode;
        }
        /**
