 ...
 */
public interface ClassifierPin extends euml.generic.activities.UmlinputPin {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.ClassifierPin> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.ClassifierPin>("497EEEC2F6582740EC6411DDC5D0000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "ClassifierPin"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
