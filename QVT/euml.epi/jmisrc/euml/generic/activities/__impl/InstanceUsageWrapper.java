...
public class InstanceUsageWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.InstanceUsageImpl> implements euml.generic.activities.InstanceUsage,com.sap.tc.moin.repository.Partitionable {
    ...
    public InstanceUsageWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.InstanceUsageImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.InstanceUsageImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.InstanceUsageImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.InstanceUsageImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.InstanceUsageImpl) resolved;
    }
    
    public euml.generic.activities.__impl.InstanceUsageImpl unwrap() {
        return (euml.generic.activities.__impl.InstanceUsageImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.InstanceUsage (Java Type)\nEUML.Generic.Activities.InstanceUsage (MOF Type)"; //$NON-NLS-1$
    }    
}