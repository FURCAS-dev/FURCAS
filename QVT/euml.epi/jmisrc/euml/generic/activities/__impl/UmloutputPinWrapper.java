...
public class UmloutputPinWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmloutputPinImpl> implements euml.generic.activities.UmloutputPin,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmloutputPinWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmloutputPinImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmloutputPinImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmloutputPinImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmloutputPinImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmloutputPinImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmloutputPinImpl unwrap() {
        return (euml.generic.activities.__impl.UmloutputPinImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmloutputPin (Java Type)\nEUML.Generic.Activities.UMLOutputPin (MOF Type)"; //$NON-NLS-1$
    }    
}