...
public class UmlactionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlactionImpl> implements euml.generic.activities.Umlaction,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlactionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlactionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmlactionImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlactionImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlactionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlactionImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlactionImpl unwrap() {
        return (euml.generic.activities.__impl.UmlactionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.Umlaction (Java Type)\nEUML.Generic.Activities.UMLAction (MOF Type)"; //$NON-NLS-1$
    }    
}