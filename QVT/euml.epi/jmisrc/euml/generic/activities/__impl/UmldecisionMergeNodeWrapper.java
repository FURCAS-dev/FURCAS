...
public class UmldecisionMergeNodeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmldecisionMergeNodeImpl> implements euml.generic.activities.UmldecisionMergeNode,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmldecisionMergeNodeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmldecisionMergeNodeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.activities.__impl.UmldecisionMergeNodeImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmldecisionMergeNodeImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmldecisionMergeNodeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmldecisionMergeNodeImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmldecisionMergeNodeImpl unwrap() {
        return (euml.generic.activities.__impl.UmldecisionMergeNodeImpl) getWrappedObject();
    }
    ...
    public euml.generic.commonbehaviors.Umlbehaviror getDecisionInput() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.commonbehaviors.Umlbehaviror) wrapResult(getCastWrappedObject().getDecisionInput(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setDecisionInput(euml.generic.commonbehaviors.Umlbehaviror newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDecisionInput(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmldecisionMergeNode (Java Type)\nEUML.Generic.Activities.UMLDecisionMergeNode (MOF Type)"; //$NON-NLS-1$
    }    
}