...
public class UmlobjectFlowWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlobjectFlowImpl> implements euml.generic.activities.UmlobjectFlow,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlobjectFlowWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlobjectFlowImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmlobjectFlowImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlobjectFlowImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlobjectFlowImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlobjectFlowImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlobjectFlowImpl unwrap() {
        return (euml.generic.activities.__impl.UmlobjectFlowImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlobjectFlow (Java Type)\nEUML.Generic.Activities.UMLObjectFlow (MOF Type)"; //$NON-NLS-1$
    }    
}