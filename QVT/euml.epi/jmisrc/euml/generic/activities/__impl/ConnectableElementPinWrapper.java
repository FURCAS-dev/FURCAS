...
public class ConnectableElementPinWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.ConnectableElementPinImpl> implements euml.generic.activities.ConnectableElementPin,com.sap.tc.moin.repository.Partitionable {
    ...
    public ConnectableElementPinWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.ConnectableElementPinImpl baseObject, boolean synchronize) {
    ...
    private euml.generic.activities.__impl.ConnectableElementPinImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.ConnectableElementPinImpl) resolved;
    }
    
    public euml.generic.activities.__impl.ConnectableElementPinImpl unwrap() {
        return (euml.generic.activities.__impl.ConnectableElementPinImpl) getWrappedObject();
    }
    ...
    public euml.generic.kernel.UmlvalueSpecification getAllocationscheme() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.UmlvalueSpecification) wrapResult(getCastWrappedObject().getAllocationscheme(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setAllocationscheme(euml.generic.kernel.UmlvalueSpecification newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setAllocationscheme(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public euml.generic.compositestructures.UmlconnectableElement getTargetElement() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.compositestructures.UmlconnectableElement) wrapResult(getCastWrappedObject().getTargetElement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setTargetElement(euml.generic.compositestructures.UmlconnectableElement newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setTargetElement(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.ConnectableElementPin (Java Type)\nEUML.Generic.Activities.ConnectableElementPin (MOF Type)"; //$NON-NLS-1$
    }    
}