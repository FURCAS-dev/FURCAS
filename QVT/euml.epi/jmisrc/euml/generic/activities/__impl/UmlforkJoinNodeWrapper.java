...
public class UmlforkJoinNodeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlforkJoinNodeImpl> implements euml.generic.activities.UmlforkJoinNode,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlforkJoinNodeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlforkJoinNodeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmlforkJoinNodeImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlforkJoinNodeImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlforkJoinNodeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlforkJoinNodeImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlforkJoinNodeImpl unwrap() {
        return (euml.generic.activities.__impl.UmlforkJoinNodeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlforkJoinNode (Java Type)\nEUML.Generic.Activities.UMLForkJoinNode (MOF Type)"; //$NON-NLS-1$
    }    
}