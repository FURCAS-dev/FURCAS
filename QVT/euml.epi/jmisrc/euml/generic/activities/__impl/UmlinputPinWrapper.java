...
public class UmlinputPinWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlinputPinImpl> implements euml.generic.activities.UmlinputPin,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinputPinWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlinputPinImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.activities.__impl.UmlinputPinImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlinputPinImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlinputPinImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlinputPinImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlinputPinImpl unwrap() {
        return (euml.generic.activities.__impl.UmlinputPinImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlinputPin (Java Type)\nEUML.Generic.Activities.UMLInputPin (MOF Type)"; //$NON-NLS-1$
    }    
}