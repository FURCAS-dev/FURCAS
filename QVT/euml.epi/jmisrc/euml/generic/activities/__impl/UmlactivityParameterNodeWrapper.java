...
public class UmlactivityParameterNodeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlactivityParameterNodeImpl> implements euml.generic.activities.UmlactivityParameterNode,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlactivityParameterNodeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlactivityParameterNodeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.activities.__impl.UmlactivityParameterNodeImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlactivityParameterNodeImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlactivityParameterNodeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlactivityParameterNodeImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlactivityParameterNodeImpl unwrap() {
        return (euml.generic.activities.__impl.UmlactivityParameterNodeImpl) getWrappedObject();
    }
    ...
    public euml.generic.kernel.Umlparameter getParameter() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlparameter) wrapResult(getCastWrappedObject().getParameter(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setParameter(euml.generic.kernel.Umlparameter newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setParameter(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlactivityParameterNode (Java Type)\nEUML.Generic.Activities.UMLActivityParameterNode (MOF Type)"; //$NON-NLS-1$
    }    
}