...
public class UmldataStoreNodeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmldataStoreNodeImpl> implements euml.generic.activities.UmldataStoreNode,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmldataStoreNodeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmldataStoreNodeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmldataStoreNodeImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmldataStoreNodeImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmldataStoreNodeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmldataStoreNodeImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmldataStoreNodeImpl unwrap() {
        return (euml.generic.activities.__impl.UmldataStoreNodeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmldataStoreNode (Java Type)\nEUML.Generic.Activities.UMLDataStoreNode (MOF Type)"; //$NON-NLS-1$
    }    
}