...
public class UmlactivityPartitionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlactivityPartitionImpl> implements euml.generic.activities.UmlactivityPartition,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlactivityPartitionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlactivityPartitionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.activities.__impl.UmlactivityPartitionImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlactivityPartitionImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlactivityPartitionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlactivityPartitionImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlactivityPartitionImpl unwrap() {
        return (euml.generic.activities.__impl.UmlactivityPartitionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.UmlnamedElement) wrapResult(getCastWrappedObject().getRepresentsElement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setRepresentsElement(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.util.List<euml.generic.activities.UmlactivityGroup> getownedGroups() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmlactivityGroup>)___invokeOperation(connection, 5, "497EEFC4900F3270EC6511DD9985000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.activities.UmlactivityPartition> getownedPartitioins() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmlactivityPartition>)___invokeOperation(connection, 6, "497EF14D7A3B2A20EC6611DDA828000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.activities.UmlactivityPartition> invoke__getownedPartitioins(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 6:
                return ___invokeOperation( connection, operationId, "497EF14D7A3B2A20EC6611DDA828000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 6:
                return invoke__getownedPartitioins(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlactivityPartition (Java Type)\nEUML.Generic.Activities.UMLActivityPartition (MOF Type)"; //$NON-NLS-1$
    }    
}