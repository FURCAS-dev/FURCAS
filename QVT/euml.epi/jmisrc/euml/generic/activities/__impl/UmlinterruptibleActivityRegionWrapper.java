...
public class UmlinterruptibleActivityRegionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl> implements euml.generic.activities.UmlinterruptibleActivityRegion,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinterruptibleActivityRegionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl unwrap() {
        return (euml.generic.activities.__impl.UmlinterruptibleActivityRegionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.activities.UmlactivityEdge>) wrapResult(getCastWrappedObject().getInterruptingEdges(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public java.util.List<euml.generic.activities.UmlactivityGroup> getownedGroups() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmlactivityGroup>)___invokeOperation(connection, 2, "497EEFC4900F3270EC6511DD9985000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlinterruptibleActivityRegion (Java Type)\nEUML.Generic.Activities.UMLInterruptibleActivityRegion (MOF Type)"; //$NON-NLS-1$
    }    
}