...
public class UmlinitialNodeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.activities.__impl.UmlinitialNodeImpl> implements euml.generic.activities.UmlinitialNode,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinitialNodeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.activities.__impl.UmlinitialNodeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.activities.__impl.UmlinitialNodeImpl getCastWrappedObject() {
        return (euml.generic.activities.__impl.UmlinitialNodeImpl) getWrappedObject();
    }
    
    private euml.generic.activities.__impl.UmlinitialNodeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.activities.__impl.UmlinitialNodeImpl) resolved;
    }
    
    public euml.generic.activities.__impl.UmlinitialNodeImpl unwrap() {
        return (euml.generic.activities.__impl.UmlinitialNodeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.activities.UmlinitialNode (Java Type)\nEUML.Generic.Activities.UMLInitialNode (MOF Type)"; //$NON-NLS-1$
    }    
}