 ...
 */
public interface ConnectableElementPin extends euml.generic.activities.UmlinputPin {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.ConnectableElementPin> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.ConnectableElementPin>("497EEEE108E0B8A0EC6511DD839C000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "ConnectableElementPin"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        /**
         * Returns the descriptor for the <code>allocationscheme</code> reference.
         * @return  the descriptor for the <code>allocationscheme</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlobjectNode,euml.generic.kernel.UmlvalueSpecification> ALLOCATIONSCHEME( ) {
            return euml.generic.activities.UmlobjectNode.DESCRIPTORS.ALLOCATIONSCHEME( );
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.ConnectableElementPin,euml.generic.compositestructures.UmlconnectableElement> __targetElement;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.ConnectableElementPin,euml.generic.compositestructures.UmlconnectableElement> TARGET_ELEMENT( ) {
            if ( __targetElement == null ) {
                __targetElement = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.ConnectableElementPin,euml.generic.compositestructures.UmlconnectableElement>( "49864E751EACBD03F0CA11DD9EF9000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "ConnectableElementPin", "targetElement" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
