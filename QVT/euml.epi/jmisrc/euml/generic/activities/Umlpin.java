 ...
 */
public interface Umlpin extends euml.generic.activities.UmlobjectNode,euml.generic.kernel.UmlmultiplicityElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.Umlpin> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.Umlpin>("497EEE84D17DF300EC6411DD86CD000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLPin"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
