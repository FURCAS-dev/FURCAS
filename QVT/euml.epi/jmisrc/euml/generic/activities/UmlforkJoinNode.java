 ...
 */
public interface UmlforkJoinNode extends euml.generic.activities.UmlcontrolNode {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlforkJoinNode> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlforkJoinNode>("497EF2B5510A5080EC6711DDCD9D000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLForkJoinNode"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
