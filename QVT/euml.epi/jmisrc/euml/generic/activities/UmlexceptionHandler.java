 ...
 */
public interface UmlexceptionHandler extends euml.generic.kernel.Umlelement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlexceptionHandler> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlexceptionHandler>("497EEFFCB19AFF00EC6511DDC1DC000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLExceptionHandler"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,euml.generic.activities.Umlaction> __handlerBody;
        /**
         * Returns the descriptor for the <code>handlerBody</code> reference.
         * @return  the descriptor for the <code>handlerBody</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,euml.generic.activities.Umlaction> HANDLER_BODY( ) {
            if ( __handlerBody == null ) {
                __handlerBody = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,euml.generic.activities.Umlaction>( "4986523158517173F0CC11DD99AE000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLExceptionHandler", "handlerBody" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __handlerBody;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,euml.generic.activities.UmlobjectNode> __exceptionInput;
        /**
         * Returns the descriptor for the <code>exceptionInput</code> reference.
         * @return  the descriptor for the <code>exceptionInput</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,euml.generic.activities.UmlobjectNode> EXCEPTION_INPUT( ) {
            if ( __exceptionInput == null ) {
                __exceptionInput = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,euml.generic.activities.UmlobjectNode>( "4986527D858FEEA0F0CC11DDCC5F000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLExceptionHandler", "exceptionInput" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __exceptionInput;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,java.util.Collection<euml.generic.kernel.Umlclassifier>> __exceptionType;
        /**
         * Returns the descriptor for the <code>exceptionType</code> reference.
         * @return  the descriptor for the <code>exceptionType</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,java.util.Collection<euml.generic.kernel.Umlclassifier>> EXCEPTION_TYPE( ) {
            if ( __exceptionType == null ) {
                __exceptionType = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlexceptionHandler,java.util.Collection<euml.generic.kernel.Umlclassifier>>( "498652C8B2229B73F0CC11DDBBCD000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLExceptionHandler", "exceptionType" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __exceptionType;
        }
        /**
