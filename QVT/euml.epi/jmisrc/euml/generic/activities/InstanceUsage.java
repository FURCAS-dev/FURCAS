 ...
 */
public interface InstanceUsage extends euml.generic.activities.UmlobjectNode {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.InstanceUsage> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.InstanceUsage>("497EEEFD197BAAD0EC6511DDB33B000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "InstanceUsage"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
