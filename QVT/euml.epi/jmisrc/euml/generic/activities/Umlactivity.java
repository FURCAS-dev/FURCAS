 ...
 */
public interface Umlactivity extends euml.generic.commonbehaviors.Umlbehaviror {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.Umlactivity> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.Umlactivity>("497EF04FE2F25FD0EC6511DDC971000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLActivity"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.Umlactivity,java.lang.Boolean> __isSingleExecution;
        /**
         * Returns the descriptor for the <code>isSingleExecution</code> attribute.
         * @return  the descriptor for the <code>isSingleExecution</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.Umlactivity,java.lang.Boolean> IS_SINGLE_EXECUTION( ) {
            if ( __isSingleExecution == null ) {
                __isSingleExecution = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.Umlactivity,java.lang.Boolean>( "497EF08F092FCD90EC6611DDA72D000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivity", "isSingleExecution" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityEdge>> __getedges;
        /**
         * Returns the descriptor for the <code>getedges</code> operation.
         * @return  the descriptor for the <code>getedges</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityEdge>> GETEDGES( ) {
            if ( __getedges == null ) {
                __getedges = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityEdge>>( "497EF05DEB0EF160EC6511DD8C26000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivity", "getedges" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getedges;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityNode>> __getnodes;
        /**
         * Returns the descriptor for the <code>getnodes</code> operation.
         * @return  the descriptor for the <code>getnodes</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityNode>> GETNODES( ) {
            if ( __getnodes == null ) {
                __getnodes = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityNode>>( "497EF069F2B47E30EC6511DDCAED000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivity", "getnodes" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getnodes;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityGroup>> __getgroups;
        /**
         * Returns the descriptor for the <code>getgroups</code> operation.
         * @return  the descriptor for the <code>getgroups</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityGroup>> GETGROUPS( ) {
            if ( __getgroups == null ) {
                __getgroups = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.activities.Umlactivity,java.util.List<euml.generic.activities.UmlactivityGroup>>( "497EF076FA610FE0EC6511DDC8F8000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Activities", "UMLActivity", "getgroups" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getgroups;
        }
    }
