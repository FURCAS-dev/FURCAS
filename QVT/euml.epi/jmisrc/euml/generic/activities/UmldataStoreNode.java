 ...
 */
public interface UmldataStoreNode extends euml.generic.activities.UmlobjectNode {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmldataStoreNode> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmldataStoreNode>("497EF1F7DFFCAA00EC6611DD8FE1000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLDataStoreNode"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
