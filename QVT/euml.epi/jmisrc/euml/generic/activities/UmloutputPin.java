 ...
 */
public interface UmloutputPin extends euml.generic.activities.Umlpin {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmloutputPin> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmloutputPin>("497EEFA97FDAA330EC6511DDADC0000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLOutputPin"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
