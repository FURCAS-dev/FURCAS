 ...
 */
public interface UmlcontrolFlow extends euml.generic.activities.UmlactivityEdge {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlcontrolFlow> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.activities.UmlcontrolFlow>("497EF1BBBBB65150EC6611DDCA5F000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Activities", "UMLControlFlow"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.activities.UmlactivityEdge,java.lang.String> GUARD_CONDITION( ) {
            return euml.generic.activities.UmlactivityEdge.DESCRIPTORS.GUARD_CONDITION( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityEdge,euml.generic.activities.UmlactivityNode> THE_NODE_OF_THE_INCOMING_EDGE( ) {
            return euml.generic.activities.UmlactivityEdge.DESCRIPTORS.THE_NODE_OF_THE_INCOMING_EDGE( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityEdge,euml.generic.activities.UmlactivityNode> THE_NODE_OF_THE_OUTGOING_EDGE( ) {
            return euml.generic.activities.UmlactivityEdge.DESCRIPTORS.THE_NODE_OF_THE_OUTGOING_EDGE( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityEdge,euml.generic.activities.UmlactivityGroup> THE_GROUP_OF_THE_EDGE( ) {
            return euml.generic.activities.UmlactivityEdge.DESCRIPTORS.THE_GROUP_OF_THE_EDGE( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.activities.UmlactivityEdge,euml.generic.activities.UmlinterruptibleActivityRegion> INTERRUPTS( ) {
            return euml.generic.activities.UmlactivityEdge.DESCRIPTORS.INTERRUPTS( );
        }
        /**
