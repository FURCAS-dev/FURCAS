 ...
 */
public interface UmlconnectableElement extends euml.generic.kernel.UmltypedElement,euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.compositestructures.UmlconnectableElement> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.compositestructures.UmlconnectableElement>("497EE0364AEB3DA0EC5C11DDC077000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CompositeStructures", "UMLConnectableElement"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.UmlconnectableElement,java.util.List<euml.generic.compositestructures.UmlconnectorEnd>> __end;
        /**
         * Returns the descriptor for the <code>end</code> reference.
         * @return  the descriptor for the <code>end</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.UmlconnectableElement,java.util.List<euml.generic.compositestructures.UmlconnectorEnd>> END( ) {
            if ( __end == null ) {
                __end = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.UmlconnectableElement,java.util.List<euml.generic.compositestructures.UmlconnectorEnd>>( "49864D3F65D84D33F0C911DD9545000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CompositeStructures", "UMLConnectableElement", "end" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __end;
        }
        /**
