...
public class UmlpartWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.compositestructures.__impl.UmlpartImpl> implements euml.generic.compositestructures.Umlpart,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlpartWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.compositestructures.__impl.UmlpartImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.compositestructures.__impl.UmlpartImpl getCastWrappedObject() {
        return (euml.generic.compositestructures.__impl.UmlpartImpl) getWrappedObject();
    }
    
    private euml.generic.compositestructures.__impl.UmlpartImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.compositestructures.__impl.UmlpartImpl) resolved;
    }
    
    public euml.generic.compositestructures.__impl.UmlpartImpl unwrap() {
        return (euml.generic.compositestructures.__impl.UmlpartImpl) getWrappedObject();
    }
    ...
    public euml.generic.compositestructures.PortUsage getportUsages() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (euml.generic.compositestructures.PortUsage)___invokeOperation(connection, 7, "497EEC0956F70690EC6311DDCE9C000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private euml.generic.compositestructures.PortUsage invoke__getportUsages(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 7:
                return ___invokeOperation( connection, operationId, "497EEC0956F70690EC6311DDCE9C000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.compositestructures.Umlpart (Java Type)\nEUML.Generic.CompositeStructures.UMLPart (MOF Type)"; //$NON-NLS-1$
    }    
}