...
public class UmlcollaborationUseWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.compositestructures.__impl.UmlcollaborationUseImpl> implements euml.generic.compositestructures.UmlcollaborationUse,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlcollaborationUseWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.compositestructures.__impl.UmlcollaborationUseImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.compositestructures.__impl.UmlcollaborationUseImpl getCastWrappedObject() {
        return (euml.generic.compositestructures.__impl.UmlcollaborationUseImpl) getWrappedObject();
    }
    
    private euml.generic.compositestructures.__impl.UmlcollaborationUseImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.compositestructures.__impl.UmlcollaborationUseImpl) resolved;
    }
    
    public euml.generic.compositestructures.__impl.UmlcollaborationUseImpl unwrap() {
        return (euml.generic.compositestructures.__impl.UmlcollaborationUseImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.compositestructures.Umlcollaboration) wrapResult(getCastWrappedObject().getTheType(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.relationships.UmldirectedRelationship>) wrapResult(getCastWrappedObject().getRoleBinding(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "euml.generic.compositestructures.UmlcollaborationUse (Java Type)\nEUML.Generic.CompositeStructures.UMLCollaborationUse (MOF Type)"; //$NON-NLS-1$
    }    
}