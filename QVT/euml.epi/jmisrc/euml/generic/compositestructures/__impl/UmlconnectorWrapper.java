...
public class UmlconnectorWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.compositestructures.__impl.UmlconnectorImpl> implements euml.generic.compositestructures.Umlconnector,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlconnectorWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.compositestructures.__impl.UmlconnectorImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.compositestructures.__impl.UmlconnectorImpl getCastWrappedObject() {
        return (euml.generic.compositestructures.__impl.UmlconnectorImpl) getWrappedObject();
    }
    
    private euml.generic.compositestructures.__impl.UmlconnectorImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.compositestructures.__impl.UmlconnectorImpl) resolved;
    }
    
    public euml.generic.compositestructures.__impl.UmlconnectorImpl unwrap() {
        return (euml.generic.compositestructures.__impl.UmlconnectorImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.compositestructures.UmlconnectorEnd>) wrapResult(getCastWrappedObject().getTheCnnectorEnd(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "euml.generic.compositestructures.Umlconnector (Java Type)\nEUML.Generic.CompositeStructures.UMLConnector (MOF Type)"; //$NON-NLS-1$
    }    
}