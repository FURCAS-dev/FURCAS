...
public class UmlcollaborationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.compositestructures.__impl.UmlcollaborationImpl> implements euml.generic.compositestructures.Umlcollaboration,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlcollaborationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.compositestructures.__impl.UmlcollaborationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.compositestructures.__impl.UmlcollaborationImpl getCastWrappedObject() {
        return (euml.generic.compositestructures.__impl.UmlcollaborationImpl) getWrappedObject();
    }
    
    private euml.generic.compositestructures.__impl.UmlcollaborationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.compositestructures.__impl.UmlcollaborationImpl) resolved;
    }
    
    public euml.generic.compositestructures.__impl.UmlcollaborationImpl unwrap() {
        return (euml.generic.compositestructures.__impl.UmlcollaborationImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.compositestructures.Umlcollaboration (Java Type)\nEUML.Generic.CompositeStructures.UMLCollaboration (MOF Type)"; //$NON-NLS-1$
    }    
}