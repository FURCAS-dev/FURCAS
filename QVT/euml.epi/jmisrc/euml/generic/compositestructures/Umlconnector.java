 ...
 */
public interface Umlconnector extends euml.generic.kernel.Umlfeature {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.compositestructures.Umlconnector> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.compositestructures.Umlconnector>("497EEBBA27F15DF0EC6311DD92FC000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CompositeStructures", "UMLConnector"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public java.util.List<euml.generic.compositestructures.UmlconnectorEnd> getTheCnnectorEnd() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.Umlconnector,java.util.List<euml.generic.compositestructures.UmlconnectorEnd>> __theCnnectorEnd;
        /**
         * Returns the descriptor for the <code>theCnnectorEnd</code> reference.
         * @return  the descriptor for the <code>theCnnectorEnd</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.Umlconnector,java.util.List<euml.generic.compositestructures.UmlconnectorEnd>> THE_CNNECTOR_END( ) {
            if ( __theCnnectorEnd == null ) {
                __theCnnectorEnd = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.Umlconnector,java.util.List<euml.generic.compositestructures.UmlconnectorEnd>>( "49864C9A03592713F0C911DDA7A9000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CompositeStructures", "UMLConnector", "theCnnectorEnd" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theCnnectorEnd;
        }
        /**
