 ...
 */
public interface PortUsage extends euml.generic.compositestructures.UmlconnectableElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.compositestructures.PortUsage> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.compositestructures.PortUsage>("497EEB52E9EA9D00EC6211DDB2B3000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "CompositeStructures", "PortUsage"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.PortUsage,euml.generic.compositestructures.Umlport> __represents;
        /**
         * Returns the descriptor for the <code>represents</code> reference.
         * @return  the descriptor for the <code>represents</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.PortUsage,euml.generic.compositestructures.Umlport> REPRESENTS( ) {
            if ( __represents == null ) {
                __represents = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.compositestructures.PortUsage,euml.generic.compositestructures.Umlport>( "49864C19B6838160F0C811DDB100000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "CompositeStructures", "PortUsage", "represents" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __represents;
        }
        /**
