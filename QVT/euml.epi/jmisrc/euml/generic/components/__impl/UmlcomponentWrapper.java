...
public class UmlcomponentWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.components.__impl.UmlcomponentImpl> implements euml.generic.components.Umlcomponent,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlcomponentWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.components.__impl.UmlcomponentImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.components.__impl.UmlcomponentImpl getCastWrappedObject() {
        return (euml.generic.components.__impl.UmlcomponentImpl) getWrappedObject();
    }
    
    private euml.generic.components.__impl.UmlcomponentImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.components.__impl.UmlcomponentImpl) resolved;
    }
    
    public euml.generic.components.__impl.UmlcomponentImpl unwrap() {
        return (euml.generic.components.__impl.UmlcomponentImpl) getWrappedObject();
    }
    ...
    public boolean isExternal() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isExternal();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isExternal();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setExternal(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.components.Umlcomponent (Java Type)\nEUML.Generic.Components.UMLComponent (MOF Type)"; //$NON-NLS-1$
    }    
}