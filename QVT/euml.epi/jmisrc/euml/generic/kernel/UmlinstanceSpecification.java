 ...
 */
public interface UmlinstanceSpecification extends euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.UmlinstanceSpecification> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.UmlinstanceSpecification>("497ED29F31352F40EC5411DD9ED0000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLInstanceSpecification"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public java.util.List<euml.generic.kernel.Umlclassifier> getTheClassifiers() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;

    // operations
    public java.util.List<euml.generic.kernel.Umlslot> getslot() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlinstanceSpecification,java.util.List<euml.generic.kernel.Umlclassifier>> __theClassifiers;
        /**
         * Returns the descriptor for the <code>theClassifiers</code> reference.
         * @return  the descriptor for the <code>theClassifiers</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlinstanceSpecification,java.util.List<euml.generic.kernel.Umlclassifier>> THE_CLASSIFIERS( ) {
            if ( __theClassifiers == null ) {
                __theClassifiers = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlinstanceSpecification,java.util.List<euml.generic.kernel.Umlclassifier>>( "498671FF4D7A3213F0DF11DDA28C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInstanceSpecification", "the_classifiers" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theClassifiers;
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.UmlinstanceSpecification,java.util.List<euml.generic.kernel.Umlslot>> __getslot;
        /**
         * Returns the descriptor for the <code>getslot</code> operation.
         * @return  the descriptor for the <code>getslot</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.UmlinstanceSpecification,java.util.List<euml.generic.kernel.Umlslot>> GETSLOT( ) {
            if ( __getslot == null ) {
                __getslot = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.UmlinstanceSpecification,java.util.List<euml.generic.kernel.Umlslot>>( "497ED2BC422FA690EC5411DD9150000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInstanceSpecification", "getslot" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getslot;
        }
    }
