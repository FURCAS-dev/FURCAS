 ...
 */
public interface Umlannotation extends euml.generic.kernel.Umlelement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlannotation> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlannotation>("497EC21C594F57D0EC4A11DDCA61000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLAnnotation"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    // references
    public java.util.Collection<euml.generic.kernel.Umlelement> getTheelementoftheannotation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.kernel.Umlannotation,java.lang.String> __annotation;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.kernel.Umlannotation,java.lang.String> ANNOTATION( ) {
            if ( __annotation == null ) {
                __annotation = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.kernel.Umlannotation,java.lang.String>( "497EC2406EB89AF0EC4A11DDB966000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLAnnotation", "annotation" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __annotation;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.kernel.Umlannotation,java.lang.String> __annotationKind;
        /**
         * Returns the descriptor for the <code>annotationKind</code> attribute.
         * @return  the descriptor for the <code>annotationKind</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.kernel.Umlannotation,java.lang.String> ANNOTATION_KIND( ) {
            if ( __annotationKind == null ) {
                __annotationKind = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.kernel.Umlannotation,java.lang.String>( "497EC24873FE17B0EC4A11DDC38C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLAnnotation", "annotationKind" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.Umlannotation,java.util.Collection<euml.generic.kernel.Umlelement>> __theelementoftheannotation;
        /**
         * Returns the descriptor for the <code>theelementoftheannotation</code> reference.
         * @return  the descriptor for the <code>theelementoftheannotation</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.Umlannotation,java.util.Collection<euml.generic.kernel.Umlelement>> THEELEMENTOFTHEANNOTATION( ) {
            if ( __theelementoftheannotation == null ) {
                __theelementoftheannotation = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.Umlannotation,java.util.Collection<euml.generic.kernel.Umlelement>>( "4986679819ED3B50F0D911DDBFD7000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLAnnotation", "theelementoftheannotation" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theelementoftheannotation;
        }
        /**
