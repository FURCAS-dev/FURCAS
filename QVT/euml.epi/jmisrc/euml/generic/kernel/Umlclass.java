 ...
 */
public interface Umlclass extends euml.generic.compositestructures.UmlstructuredClassifier {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlclass> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlclass>("497ED52FB7D9EA30EC5511DDAA60000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLClass"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.kernel.Umloperation>> __getownedOperation;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.kernel.Umloperation>> GETOWNED_OPERATION( ) {
            if ( __getownedOperation == null ) {
                __getownedOperation = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.kernel.Umloperation>>( "497ED545C53011A0EC5511DD93BF000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLClass", "getownedOperation" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedOperation;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.commonbehaviors.Umlreception>> __getownedReceptions;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.commonbehaviors.Umlreception>> GETOWNED_RECEPTIONS( ) {
            if ( __getownedReceptions == null ) {
                __getownedReceptions = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.commonbehaviors.Umlreception>>( "497ED6767ADC6670EC5611DDA41D000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLClass", "getownedReceptions" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedReceptions;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.kernel.Umlclassifier>> __getnestedClassifiers;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.kernel.Umlclassifier>> GETNESTED_CLASSIFIERS( ) {
            if ( __getnestedClassifiers == null ) {
                __getnestedClassifiers = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlclass,java.util.List<euml.generic.kernel.Umlclassifier>>( "497ED6958D26DD60EC5611DDA53C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLClass", "getnestedClassifiers" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getnestedClassifiers;
        }
    }
}    