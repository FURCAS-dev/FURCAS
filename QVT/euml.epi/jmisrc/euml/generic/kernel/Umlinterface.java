 ...
 */
public interface Umlinterface extends euml.generic.kernel.Umlclassifier {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlinterface> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlinterface>("497ED1043BFD9C60EC5311DD87B7000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLInterface"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public java.util.List<euml.generic.kernel.Umloperation> getownedOperations() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public java.util.List<euml.generic.kernel.Umlinterface> getnestedInterface() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umlproperty>> __getownedProperties;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umlproperty>> GETOWNED_PROPERTIES( ) {
            if ( __getownedProperties == null ) {
                __getownedProperties = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umlproperty>>( "497ED83D8A2EDDA0EC5711DDC9B2000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInterface", "getownedProperties" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedProperties;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umloperation>> __getownedOperations;
        /**
         * Returns the descriptor for the <code>getownedOperations</code> operation.
         * @return  the descriptor for the <code>getownedOperations</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umloperation>> GETOWNED_OPERATIONS( ) {
            if ( __getownedOperations == null ) {
                __getownedOperations = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umloperation>>( "497ED869A450EDE0EC5711DD99C0000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInterface", "getownedOperations" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedOperations;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.commonbehaviors.Umlreception>> __getownedReceptions;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.commonbehaviors.Umlreception>> GETOWNED_RECEPTIONS( ) {
            if ( __getownedReceptions == null ) {
                __getownedReceptions = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.commonbehaviors.Umlreception>>( "497ED88EBA505680EC5711DD873F000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInterface", "getownedReceptions" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedReceptions;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umlinterface>> __getnestedInterface;
        /**
         * Returns the descriptor for the <code>getnestedInterface</code> operation.
         * @return  the descriptor for the <code>getnestedInterface</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umlinterface>> GETNESTED_INTERFACE( ) {
            if ( __getnestedInterface == null ) {
                __getnestedInterface = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlinterface,java.util.List<euml.generic.kernel.Umlinterface>>( "497ED8ADCD146A40EC5711DDCFE9000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInterface", "getnestedInterface" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getnestedInterface;
        }
    }
}    