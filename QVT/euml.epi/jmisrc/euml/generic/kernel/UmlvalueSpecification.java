 ...
 */
public interface UmlvalueSpecification extends euml.generic.kernel.UmltypedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.UmlvalueSpecification> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.UmlvalueSpecification>("497ED01FB3993AA0EC5211DDA495000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLValueSpecification"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlvalueSpecification,java.util.List<euml.generic.activities.UmlobjectNode>> __allocatedBy;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlvalueSpecification,java.util.List<euml.generic.activities.UmlobjectNode>> ALLOCATED_BY( ) {
            if ( __allocatedBy == null ) {
                __allocatedBy = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlvalueSpecification,java.util.List<euml.generic.activities.UmlobjectNode>>( "498655D784D6ECF3F0CE11DDB420000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLValueSpecification", "allocatedBy" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __allocatedBy;
        }
        /**
