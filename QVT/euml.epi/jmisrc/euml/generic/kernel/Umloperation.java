 ...
 */
public interface Umloperation extends euml.generic.commonbehaviors.UmlbehavioralFeature,euml.generic.kernel.UmltypedElement,euml.generic.kernel.UmlmultiplicityElement,euml.generic.kernel.Umlnamespace {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umloperation> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umloperation>("497ED62B4E284EF0EC5611DDB208000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLOperation"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public java.util.Collection<euml.generic.kernel.Umlclassifier> getTheexceptions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;

    // operations
    public java.util.List<euml.generic.kernel.Umlparameter> getparameters() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.commonbehaviors.UmlbehavioralFeature,java.util.List<euml.generic.commonbehaviors.Umlbehaviror>> METHOD( ) {
            return euml.generic.commonbehaviors.UmlbehavioralFeature.DESCRIPTORS.METHOD( );
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.Umloperation,java.util.Collection<euml.generic.kernel.Umlclassifier>> __theexceptions;
        /**
         * Returns the descriptor for the <code>theexceptions</code> reference.
         * @return  the descriptor for the <code>theexceptions</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.Umloperation,java.util.Collection<euml.generic.kernel.Umlclassifier>> THEEXCEPTIONS( ) {
            if ( __theexceptions == null ) {
                __theexceptions = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.Umloperation,java.util.Collection<euml.generic.kernel.Umlclassifier>>( "49866F89D5917020F0DD11DDB12F000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLOperation", "theexceptions" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theexceptions;
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umloperation,java.util.List<euml.generic.kernel.Umlparameter>> __getparameters;
        /**
         * Returns the descriptor for the <code>getparameters</code> operation.
         * @return  the descriptor for the <code>getparameters</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umloperation,java.util.List<euml.generic.kernel.Umlparameter>> GETPARAMETERS( ) {
            if ( __getparameters == null ) {
                __getparameters = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umloperation,java.util.List<euml.generic.kernel.Umlparameter>>( "497ED97D49139440EC5811DDC7B2000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLOperation", "getparameters" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getparameters;
        }
    }
}    