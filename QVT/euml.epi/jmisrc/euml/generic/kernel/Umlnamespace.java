 ...
 */
public interface Umlnamespace extends euml.generic.kernel.UmlnamedElement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlnamespace> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlnamespace>("497EC33B045DA050EC4B11DDA2D3000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLNamespace"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlnamespace,java.util.List<euml.generic.kernel.UmlnamedElement>> __gettheContainedElements;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlnamespace,java.util.List<euml.generic.kernel.UmlnamedElement>> GETTHE_CONTAINED_ELEMENTS( ) {
            if ( __gettheContainedElements == null ) {
                __gettheContainedElements = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlnamespace,java.util.List<euml.generic.kernel.UmlnamedElement>>( "497EC59168D6CC40EC4C11DD91C0000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLNamespace", "gettheContainedElements" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __gettheContainedElements;
        }
    }
}    