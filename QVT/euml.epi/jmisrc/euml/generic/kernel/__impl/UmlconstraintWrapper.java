...
public class UmlconstraintWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlconstraintImpl> implements euml.generic.kernel.Umlconstraint,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlconstraintWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlconstraintImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlconstraintImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlconstraintImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlconstraintImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlconstraintImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlconstraintImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlconstraintImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlconstraint (Java Type)\nEUML.Generic.Kernel.UMLConstraint (MOF Type)"; //$NON-NLS-1$
    }    
}