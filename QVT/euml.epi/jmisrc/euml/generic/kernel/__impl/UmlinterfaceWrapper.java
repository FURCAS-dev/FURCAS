...
public class UmlinterfaceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlinterfaceImpl> implements euml.generic.kernel.Umlinterface,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinterfaceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlinterfaceImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.kernel.__impl.UmlinterfaceImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlinterfaceImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlinterfaceImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlinterfaceImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlinterfaceImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlinterfaceImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.kernel.Umlproperty> getownedProperties() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlproperty>)___invokeOperation(connection, 11, "497ED83D8A2EDDA0EC5711DDC9B2000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.kernel.Umloperation> getownedOperations() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umloperation>)___invokeOperation(connection, 12, "497ED869A450EDE0EC5711DD99C0000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.commonbehaviors.Umlreception> getownedReceptions() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.commonbehaviors.Umlreception>)___invokeOperation(connection, 13, "497ED88EBA505680EC5711DD873F000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.kernel.Umlinterface> getnestedInterface() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlinterface>)___invokeOperation(connection, 14, "497ED8ADCD146A40EC5711DDCFE9000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.kernel.Umloperation> invoke__getownedOperations(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    private java.util.List<euml.generic.kernel.Umlinterface> invoke__getnestedInterface(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 11:
                return ___invokeOperation( connection, operationId, "497ED83D8A2EDDA0EC5711DDC9B2000E35A783E4", args ); //$NON-NLS-1$    
                
            case 12:
                return ___invokeOperation( connection, operationId, "497ED869A450EDE0EC5711DD99C0000E35A783E4", args ); //$NON-NLS-1$    
                
            case 13:
                return ___invokeOperation( connection, operationId, "497ED88EBA505680EC5711DD873F000E35A783E4", args ); //$NON-NLS-1$    
                
            case 14:
                return ___invokeOperation( connection, operationId, "497ED8ADCD146A40EC5711DDCFE9000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 12:
                return invoke__getownedOperations(connection);    
                
            case 13:
                return invoke__getownedReceptions(connection);    
                
            case 14:
                return invoke__getnestedInterface(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlinterface (Java Type)\nEUML.Generic.Kernel.UMLInterface (MOF Type)"; //$NON-NLS-1$
    }    
}