...
public class UmlenumerationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlenumerationImpl> implements euml.generic.kernel.Umlenumeration,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlenumerationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlenumerationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlenumerationImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlenumerationImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlenumerationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlenumerationImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlenumerationImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlenumerationImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.kernel.UmlenumerationLiteral> getenumerators() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.UmlenumerationLiteral>)___invokeOperation(connection, 6, "497ED324806D2EF0EC5411DD9989000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.kernel.UmlenumerationLiteral> invoke__getenumerators(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 6:
                return ___invokeOperation( connection, operationId, "497ED324806D2EF0EC5411DD9989000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 6:
                return invoke__getenumerators(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlenumeration (Java Type)\nEUML.Generic.Kernel.UMLEnumeration (MOF Type)"; //$NON-NLS-1$
    }    
}