...
public class UmlclassWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlclassImpl> implements euml.generic.kernel.Umlclass,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlclassWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlclassImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.kernel.__impl.UmlclassImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlclassImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlclassImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlclassImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlclassImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlclassImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlclass (Java Type)\nEUML.Generic.Kernel.UMLClass (MOF Type)"; //$NON-NLS-1$
    }    
}