...
public class UmlenumerationLiteralWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlenumerationLiteralImpl> implements euml.generic.kernel.UmlenumerationLiteral,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlenumerationLiteralWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlenumerationLiteralImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlenumerationLiteralImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlenumerationLiteralImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlenumerationLiteralImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlenumerationLiteralImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlenumerationLiteralImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlenumerationLiteralImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.UmlenumerationLiteral (Java Type)\nEUML.Generic.Kernel.UMLEnumerationLiteral (MOF Type)"; //$NON-NLS-1$
    }    
}