...
public class UmlinstanceValueWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlinstanceValueImpl> implements euml.generic.kernel.UmlinstanceValue,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinstanceValueWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlinstanceValueImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.kernel.__impl.UmlinstanceValueImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlinstanceValueImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlinstanceValueImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlinstanceValueImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlinstanceValueImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlinstanceValueImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.activities.UmlobjectNode> getAllocatedBy() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.activities.UmlobjectNode>) wrapResult(getCastWrappedObject().getAllocatedBy(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.UmlinstanceSpecification) wrapResult(getCastWrappedObject().getUmlinstancespecification(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setUmlinstancespecification(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.UmlinstanceValue (Java Type)\nEUML.Generic.Kernel.UMLInstanceValue (MOF Type)"; //$NON-NLS-1$
    }    
}