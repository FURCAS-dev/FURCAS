...
public class LiteralValueWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.LiteralValueImpl> implements euml.generic.kernel.LiteralValue,com.sap.tc.moin.repository.Partitionable {
    ...
    public LiteralValueWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.LiteralValueImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.LiteralValueImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.LiteralValueImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.LiteralValueImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.LiteralValueImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.LiteralValueImpl unwrap() {
        return (euml.generic.kernel.__impl.LiteralValueImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.LiteralValue (Java Type)\nEUML.Generic.Kernel.LiteralValue (MOF Type)"; //$NON-NLS-1$
    }    
}