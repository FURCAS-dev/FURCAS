...
public class UmlpropertyWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlpropertyImpl> implements euml.generic.kernel.Umlproperty,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlpropertyWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlpropertyImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlpropertyImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlpropertyImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlpropertyImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlpropertyImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlpropertyImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlpropertyImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlproperty (Java Type)\nEUML.Generic.Kernel.UMLProperty (MOF Type)"; //$NON-NLS-1$
    }    
}