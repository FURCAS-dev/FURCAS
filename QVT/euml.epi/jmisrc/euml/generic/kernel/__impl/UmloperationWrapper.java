...
public class UmloperationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmloperationImpl> implements euml.generic.kernel.Umloperation,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmloperationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmloperationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmloperationImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmloperationImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmloperationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmloperationImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmloperationImpl unwrap() {
        return (euml.generic.kernel.__impl.UmloperationImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.commonbehaviors.Umlbehaviror> getMethod() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.commonbehaviors.Umlbehaviror>) wrapResult(getCastWrappedObject().getMethod(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<euml.generic.kernel.Umlclassifier>) wrapResult(getCastWrappedObject().getTheexceptions(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public java.util.List<euml.generic.kernel.UmlnamedElement> gettheContainedElements() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.UmlnamedElement>)___invokeOperation(connection, 6, "497EC59168D6CC40EC4C11DD91C0000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.kernel.Umlparameter> getparameters() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlparameter>)___invokeOperation(connection, 7, "497ED97D49139440EC5811DDC7B2000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.kernel.Umlparameter> invoke__getparameters(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 7:
                return ___invokeOperation( connection, operationId, "497ED97D49139440EC5811DDC7B2000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 7:
                return invoke__getparameters(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umloperation (Java Type)\nEUML.Generic.Kernel.UMLOperation (MOF Type)"; //$NON-NLS-1$
    }    
}