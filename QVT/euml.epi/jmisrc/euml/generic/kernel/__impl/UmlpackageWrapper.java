...
public class UmlpackageWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlpackageImpl> implements euml.generic.kernel.Umlpackage,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlpackageWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlpackageImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.kernel.__impl.UmlpackageImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlpackageImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlpackageImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlpackageImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlpackageImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlpackageImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.kernel.Umlpackage> getownedPackages() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlpackage>)___invokeOperation(connection, 6, "498672A7B1748680F0DF11DDBDA0000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.kernel.Umlclassifier> getownedClassifier() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlclassifier>)___invokeOperation(connection, 7, "498672BCBE263090F0DF11DD9AA5000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.kernel.Umlpackage> invoke__getownedPackages(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    private java.util.List<euml.generic.kernel.Umlclassifier> invoke__getownedClassifier(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 6:
                return ___invokeOperation( connection, operationId, "498672A7B1748680F0DF11DDBDA0000E35A783E4", args ); //$NON-NLS-1$    
                
            case 7:
                return ___invokeOperation( connection, operationId, "498672BCBE263090F0DF11DD9AA5000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 6:
                return invoke__getownedPackages(connection);    
                
            case 7:
                return invoke__getownedClassifier(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlpackage (Java Type)\nEUML.Generic.Kernel.UMLPackage (MOF Type)"; //$NON-NLS-1$
    }    
}