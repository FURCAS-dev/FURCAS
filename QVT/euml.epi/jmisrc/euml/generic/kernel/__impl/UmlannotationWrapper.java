...
public class UmlannotationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlannotationImpl> implements euml.generic.kernel.Umlannotation,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlannotationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlannotationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlannotationImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlannotationImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlannotationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlannotationImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlannotationImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlannotationImpl) getWrappedObject();
    }
    ...
    public java.lang.String getAnnotationKind() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getAnnotationKind();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getAnnotationKind();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setAnnotationKind(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<euml.generic.kernel.Umlelement>) wrapResult(getCastWrappedObject().getTheelementoftheannotation(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlannotation (Java Type)\nEUML.Generic.Kernel.UMLAnnotation (MOF Type)"; //$NON-NLS-1$
    }    
}