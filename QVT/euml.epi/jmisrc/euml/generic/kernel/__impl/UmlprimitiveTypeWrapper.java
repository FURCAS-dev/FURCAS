...
public class UmlprimitiveTypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlprimitiveTypeImpl> implements euml.generic.kernel.UmlprimitiveType,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlprimitiveTypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlprimitiveTypeImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlprimitiveTypeImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlprimitiveTypeImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlprimitiveTypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlprimitiveTypeImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlprimitiveTypeImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlprimitiveTypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.UmlprimitiveType (Java Type)\nEUML.Generic.Kernel.UMLPrimitiveType (MOF Type)"; //$NON-NLS-1$
    }    
}