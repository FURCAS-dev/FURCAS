...
public class UmlassociationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlassociationImpl> implements euml.generic.kernel.Umlassociation,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlassociationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlassociationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlassociationImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlassociationImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlassociationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlassociationImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlassociationImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlassociationImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlproperty) wrapResult(getCastWrappedObject().getTheEndTwo(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setTheEndTwo(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlproperty) wrapResult(getCastWrappedObject().getUmlproperty1(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setUmlproperty1(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlassociation (Java Type)\nEUML.Generic.Kernel.UMLAssociation (MOF Type)"; //$NON-NLS-1$
    }    
}