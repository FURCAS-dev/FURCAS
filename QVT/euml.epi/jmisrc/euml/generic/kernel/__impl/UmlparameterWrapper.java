...
public class UmlparameterWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlparameterImpl> implements euml.generic.kernel.Umlparameter,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlparameterWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlparameterImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.kernel.__impl.UmlparameterImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlparameterImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlparameterImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlparameterImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlparameterImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlparameterImpl) getWrappedObject();
    }
    ...
    public euml.generic.kernel.UmlparamDirectionKind getDirectionKind() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getDirectionKind();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getDirectionKind();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDirectionKind(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlparameter (Java Type)\nEUML.Generic.Kernel.UMLParameter (MOF Type)"; //$NON-NLS-1$
    }    
}