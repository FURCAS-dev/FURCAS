...
public class UmlslotWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlslotImpl> implements euml.generic.kernel.Umlslot,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlslotWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlslotImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlslotImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlslotImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlslotImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlslotImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlslotImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlslotImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlproperty) wrapResult(getCastWrappedObject().getDefiningFeature(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDefiningFeature(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.util.List<euml.generic.kernel.UmlvalueSpecification> getvaluesOfTheSlot() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.UmlvalueSpecification>)___invokeOperation(connection, 2, "497ED242F98B0060EC5311DD8C73000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.kernel.UmlvalueSpecification> invoke__getvaluesOfTheSlot(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 2:
                return ___invokeOperation( connection, operationId, "497ED242F98B0060EC5311DD8C73000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 2:
                return invoke__getvaluesOfTheSlot(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.Umlslot (Java Type)\nEUML.Generic.Kernel.UMLSlot (MOF Type)"; //$NON-NLS-1$
    }    
}