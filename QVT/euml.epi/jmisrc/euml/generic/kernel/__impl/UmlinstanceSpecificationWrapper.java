...
public class UmlinstanceSpecificationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.kernel.__impl.UmlinstanceSpecificationImpl> implements euml.generic.kernel.UmlinstanceSpecification,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlinstanceSpecificationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.kernel.__impl.UmlinstanceSpecificationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.kernel.__impl.UmlinstanceSpecificationImpl getCastWrappedObject() {
        return (euml.generic.kernel.__impl.UmlinstanceSpecificationImpl) getWrappedObject();
    }
    
    private euml.generic.kernel.__impl.UmlinstanceSpecificationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.kernel.__impl.UmlinstanceSpecificationImpl) resolved;
    }
    
    public euml.generic.kernel.__impl.UmlinstanceSpecificationImpl unwrap() {
        return (euml.generic.kernel.__impl.UmlinstanceSpecificationImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.kernel.Umlclassifier>) wrapResult(getCastWrappedObject().getTheClassifiers(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public java.util.List<euml.generic.kernel.Umlslot> getslot() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.kernel.Umlslot>)___invokeOperation(connection, 5, "497ED2BC422FA690EC5411DD9150000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.kernel.Umlslot> invoke__getslot(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 5:
                return ___invokeOperation( connection, operationId, "497ED2BC422FA690EC5411DD9150000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 5:
                return invoke__getslot(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.kernel.UmlinstanceSpecification (Java Type)\nEUML.Generic.Kernel.UMLInstanceSpecification (MOF Type)"; //$NON-NLS-1$
    }    
}