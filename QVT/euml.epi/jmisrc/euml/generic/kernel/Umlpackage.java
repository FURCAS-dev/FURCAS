 ...
 */
public interface Umlpackage extends euml.generic.kernel.Umlnamespace {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlpackage> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlpackage>("49867291A4493FA0F0DF11DD8A8A000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLPackage"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // operations
    public java.util.List<euml.generic.kernel.Umlpackage> getownedPackages() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.kernel.Umlclassifier> getownedClassifier() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlpackage,java.util.List<euml.generic.kernel.Umlpackage>> __getownedPackages;
        /**
         * Returns the descriptor for the <code>getownedPackages</code> operation.
         * @return  the descriptor for the <code>getownedPackages</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlpackage,java.util.List<euml.generic.kernel.Umlpackage>> GETOWNED_PACKAGES( ) {
            if ( __getownedPackages == null ) {
                __getownedPackages = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlpackage,java.util.List<euml.generic.kernel.Umlpackage>>( "498672A7B1748680F0DF11DDBDA0000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLPackage", "getownedPackages" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedPackages;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlpackage,java.util.List<euml.generic.kernel.Umlclassifier>> __getownedClassifier;
        /**
         * Returns the descriptor for the <code>getownedClassifier</code> operation.
         * @return  the descriptor for the <code>getownedClassifier</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlpackage,java.util.List<euml.generic.kernel.Umlclassifier>> GETOWNED_CLASSIFIER( ) {
            if ( __getownedClassifier == null ) {
                __getownedClassifier = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlpackage,java.util.List<euml.generic.kernel.Umlclassifier>>( "498672BCBE263090F0DF11DD9AA5000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLPackage", "getownedClassifier" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getownedClassifier;
        }
    }
}    