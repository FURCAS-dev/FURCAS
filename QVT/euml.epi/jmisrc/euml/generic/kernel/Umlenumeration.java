 ...
 */
public interface Umlenumeration extends euml.generic.kernel.Umltype,euml.generic.kernel.Umlnamespace {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlenumeration> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.Umlenumeration>("497ED3056DF7B060EC5411DD9637000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLEnumeration"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // operations
    public java.util.List<euml.generic.kernel.UmlenumerationLiteral> getenumerators() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlenumeration,java.util.List<euml.generic.kernel.UmlenumerationLiteral>> __getenumerators;
        /**
         * Returns the descriptor for the <code>getenumerators</code> operation.
         * @return  the descriptor for the <code>getenumerators</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlenumeration,java.util.List<euml.generic.kernel.UmlenumerationLiteral>> GETENUMERATORS( ) {
            if ( __getenumerators == null ) {
                __getenumerators = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.kernel.Umlenumeration,java.util.List<euml.generic.kernel.UmlenumerationLiteral>>( "497ED324806D2EF0EC5411DD9989000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLEnumeration", "getenumerators" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getenumerators;
        }
    }
}    