 ...
 */
public interface UmlinstanceValue extends euml.generic.kernel.UmlvalueSpecification {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.UmlinstanceValue> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.kernel.UmlinstanceValue>("497ED1F6CC4EF430EC5311DDC189000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Kernel", "UMLInstanceValue"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public euml.generic.kernel.UmlinstanceSpecification getUmlinstancespecification() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setUmlinstancespecification(euml.generic.kernel.UmlinstanceSpecification newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        /**
         * Returns the descriptor for the <code>allocatedBy</code> reference.
         * @return  the descriptor for the <code>allocatedBy</code> reference
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlvalueSpecification,java.util.List<euml.generic.activities.UmlobjectNode>> ALLOCATED_BY( ) {
            return euml.generic.kernel.UmlvalueSpecification.DESCRIPTORS.ALLOCATED_BY( );
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlinstanceValue,euml.generic.kernel.UmlinstanceSpecification> __umlinstancespecification;
        /**
         * Returns the descriptor for the <code>umlinstancespecification</code> reference.
         * @return  the descriptor for the <code>umlinstancespecification</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlinstanceValue,euml.generic.kernel.UmlinstanceSpecification> UMLINSTANCESPECIFICATION( ) {
            if ( __umlinstancespecification == null ) {
                __umlinstancespecification = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.kernel.UmlinstanceValue,euml.generic.kernel.UmlinstanceSpecification>( "4986726087336AD3F0DF11DDA12C000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Kernel", "UMLInstanceValue", "umlinstancespecification" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __umlinstancespecification;
        }
        /**
