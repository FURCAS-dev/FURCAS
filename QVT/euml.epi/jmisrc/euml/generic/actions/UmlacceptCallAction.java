 ...
 */
public interface UmlacceptCallAction extends euml.generic.actions.UmlacceptEventAction {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlacceptCallAction> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlacceptCallAction>("497EF40519334FD0EC6811DDAB83000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Actions", "UMLAcceptCallAction"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlacceptEventAction,java.util.Collection<euml.generic.commonbehaviors.Umltrigger>> TRIGGER( ) {
            return euml.generic.actions.UmlacceptEventAction.DESCRIPTORS.TRIGGER( );
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptEventAction,java.util.List<euml.generic.activities.UmloutputPin>> GETRESULT( ) {
            return euml.generic.actions.UmlacceptEventAction.DESCRIPTORS.GETRESULT( );
        }
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptCallAction,euml.generic.activities.UmloutputPin> __getreturnInformation;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptCallAction,euml.generic.activities.UmloutputPin> GETRETURN_INFORMATION( ) {
            if ( __getreturnInformation == null ) {
                __getreturnInformation = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptCallAction,euml.generic.activities.UmloutputPin>( "497EF41F28B298D0EC6811DD8E7D000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLAcceptCallAction", "getreturnInformation" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
