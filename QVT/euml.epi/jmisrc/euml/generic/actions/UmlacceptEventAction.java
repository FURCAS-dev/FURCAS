 ...
 */
public interface UmlacceptEventAction extends euml.generic.activities.Umlaction {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlacceptEventAction> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlacceptEventAction>("497EF3BEEF07B7F0EC6711DDCE51000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Actions", "UMLAcceptEventAction"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlacceptEventAction,java.util.Collection<euml.generic.commonbehaviors.Umltrigger>> __trigger;
        /**
         * Returns the descriptor for the <code>trigger</code> reference.
         * @return  the descriptor for the <code>trigger</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlacceptEventAction,java.util.Collection<euml.generic.commonbehaviors.Umltrigger>> TRIGGER( ) {
            if ( __trigger == null ) {
                __trigger = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlacceptEventAction,java.util.Collection<euml.generic.commonbehaviors.Umltrigger>>( "49863E2A688E5B92F0C011DDBC1E000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLAcceptEventAction", "trigger" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __trigger;
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptEventAction,java.util.List<euml.generic.activities.UmloutputPin>> __getresult;
        /**
         * Returns the descriptor for the <code>getresult</code> operation.
         * @return  the descriptor for the <code>getresult</code> operation
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptEventAction,java.util.List<euml.generic.activities.UmloutputPin>> GETRESULT( ) {
            if ( __getresult == null ) {
                __getresult = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlacceptEventAction,java.util.List<euml.generic.activities.UmloutputPin>>( "497EF3D8FE4B5780EC6711DDB93E000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLAcceptEventAction", "getresult" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __getresult;
        }
    }
