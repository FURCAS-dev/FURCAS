 ...
 */
public interface UmlinvocationAction extends euml.generic.activities.Umlaction {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlinvocationAction> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlinvocationAction>("497EF4484129DF40EC6811DD9565000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Actions", "UMLInvocationAction"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlinvocationAction,java.util.List<euml.generic.activities.UmlinputPin>> __getargument;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlinvocationAction,java.util.List<euml.generic.activities.UmlinputPin>> GETARGUMENT( ) {
            if ( __getargument == null ) {
                __getargument = new com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlinvocationAction,java.util.List<euml.generic.activities.UmlinputPin>>( "497EF4604FB133B0EC6811DDAA74000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLInvocationAction", "getargument" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
