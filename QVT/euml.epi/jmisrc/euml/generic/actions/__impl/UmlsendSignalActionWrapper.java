...
public class UmlsendSignalActionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.actions.__impl.UmlsendSignalActionImpl> implements euml.generic.actions.UmlsendSignalAction,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlsendSignalActionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.actions.__impl.UmlsendSignalActionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.actions.__impl.UmlsendSignalActionImpl getCastWrappedObject() {
        return (euml.generic.actions.__impl.UmlsendSignalActionImpl) getWrappedObject();
    }
    
    private euml.generic.actions.__impl.UmlsendSignalActionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.actions.__impl.UmlsendSignalActionImpl) resolved;
    }
    
    public euml.generic.actions.__impl.UmlsendSignalActionImpl unwrap() {
        return (euml.generic.actions.__impl.UmlsendSignalActionImpl) getWrappedObject();
    }
    ...
    public euml.generic.commonbehaviors.Umlsignal getSignal() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.commonbehaviors.Umlsignal) wrapResult(getCastWrappedObject().getSignal(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setSignal(euml.generic.commonbehaviors.Umlsignal newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setSignal(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.actions.UmlsendSignalAction (Java Type)\nEUML.Generic.Actions.UMLSendSignalAction (MOF Type)"; //$NON-NLS-1$
    }    
}