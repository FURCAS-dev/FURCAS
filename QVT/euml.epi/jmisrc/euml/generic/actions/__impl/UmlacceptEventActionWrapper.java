...
public class UmlacceptEventActionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.actions.__impl.UmlacceptEventActionImpl> implements euml.generic.actions.UmlacceptEventAction,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlacceptEventActionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.actions.__impl.UmlacceptEventActionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.actions.__impl.UmlacceptEventActionImpl getCastWrappedObject() {
        return (euml.generic.actions.__impl.UmlacceptEventActionImpl) getWrappedObject();
    }
    
    private euml.generic.actions.__impl.UmlacceptEventActionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.actions.__impl.UmlacceptEventActionImpl) resolved;
    }
    
    public euml.generic.actions.__impl.UmlacceptEventActionImpl unwrap() {
        return (euml.generic.actions.__impl.UmlacceptEventActionImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.actions.UmlacceptEventAction (Java Type)\nEUML.Generic.Actions.UMLAcceptEventAction (MOF Type)"; //$NON-NLS-1$
    }    
}