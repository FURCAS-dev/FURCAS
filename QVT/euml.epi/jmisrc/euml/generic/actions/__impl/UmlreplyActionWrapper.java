...
public class UmlreplyActionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.actions.__impl.UmlreplyActionImpl> implements euml.generic.actions.UmlreplyAction,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlreplyActionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.actions.__impl.UmlreplyActionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.actions.__impl.UmlreplyActionImpl getCastWrappedObject() {
        return (euml.generic.actions.__impl.UmlreplyActionImpl) getWrappedObject();
    }
    
    private euml.generic.actions.__impl.UmlreplyActionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.actions.__impl.UmlreplyActionImpl) resolved;
    }
    
    public euml.generic.actions.__impl.UmlreplyActionImpl unwrap() {
        return (euml.generic.actions.__impl.UmlreplyActionImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.commonbehaviors.UmlcallEvent) wrapResult(getCastWrappedObject().getReplyToCall(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setReplyToCall(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public euml.generic.activities.UmlinputPin getreturnInformation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (euml.generic.activities.UmlinputPin)___invokeOperation(connection, 8, "497EF52AC7AC88B0EC6811DDCE79000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.activities.UmlinputPin> getreplyValue() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmlinputPin>)___invokeOperation(connection, 9, "497EF53ED3D3F420EC6811DD8CC2000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private euml.generic.activities.UmlinputPin invoke__getreturnInformation(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    private java.util.List<euml.generic.activities.UmlinputPin> invoke__getreplyValue(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 8:
                return ___invokeOperation( connection, operationId, "497EF52AC7AC88B0EC6811DDCE79000E35A783E4", args ); //$NON-NLS-1$    
                
            case 9:
                return ___invokeOperation( connection, operationId, "497EF53ED3D3F420EC6811DD8CC2000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 8:
                return invoke__getreturnInformation(connection);    
                
            case 9:
                return invoke__getreplyValue(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.actions.UmlreplyAction (Java Type)\nEUML.Generic.Actions.UMLReplyAction (MOF Type)"; //$NON-NLS-1$
    }    
}