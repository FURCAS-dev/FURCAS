...
public class UmlcallOperationActionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.actions.__impl.UmlcallOperationActionImpl> implements euml.generic.actions.UmlcallOperationAction,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlcallOperationActionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.actions.__impl.UmlcallOperationActionImpl baseObject, boolean synchronize) {
    ...
    private euml.generic.actions.__impl.UmlcallOperationActionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.actions.__impl.UmlcallOperationActionImpl) resolved;
    }
    
    public euml.generic.actions.__impl.UmlcallOperationActionImpl unwrap() {
        return (euml.generic.actions.__impl.UmlcallOperationActionImpl) getWrappedObject();
    }
    ...
    public boolean isSynchronous() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).isSynchronous();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().isSynchronous();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setSynchronous(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public euml.generic.kernel.Umloperation getOperation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umloperation) wrapResult(getCastWrappedObject().getOperation(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setOperation(euml.generic.kernel.Umloperation newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
    ...
    public euml.generic.activities.UmlinputPin getTarget() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.activities.UmlinputPin) wrapResult(getCastWrappedObject().getTarget(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public void setTarget(euml.generic.activities.UmlinputPin newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
    ...
    public java.util.List<euml.generic.activities.UmlinputPin> getargument() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmlinputPin>)___invokeOperation(connection, 8, "497EF4604FB133B0EC6811DDAA74000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public java.util.List<euml.generic.activities.UmloutputPin> getresult() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmloutputPin>)___invokeOperation(connection, 9, "497EF4C88D8A7C00EC6811DDB789000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private java.util.List<euml.generic.activities.UmlinputPin> invoke__getargument(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    private java.util.List<euml.generic.activities.UmloutputPin> invoke__getresult(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 8:
                return ___invokeOperation( connection, operationId, "497EF4604FB133B0EC6811DDAA74000E35A783E4", args ); //$NON-NLS-1$    
                
            case 9:
                return ___invokeOperation( connection, operationId, "497EF4C88D8A7C00EC6811DDB789000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 8:
                return invoke__getargument(connection);    
                
            case 9:
                return invoke__getresult(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.actions.UmlcallOperationAction (Java Type)\nEUML.Generic.Actions.UMLCallOperationAction (MOF Type)"; //$NON-NLS-1$
    }    
}