...
public class UmlacceptCallActionWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.actions.__impl.UmlacceptCallActionImpl> implements euml.generic.actions.UmlacceptCallAction,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlacceptCallActionWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.actions.__impl.UmlacceptCallActionImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.actions.__impl.UmlacceptCallActionImpl getCastWrappedObject() {
        return (euml.generic.actions.__impl.UmlacceptCallActionImpl) getWrappedObject();
    }
    
    private euml.generic.actions.__impl.UmlacceptCallActionImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.actions.__impl.UmlacceptCallActionImpl) resolved;
    }
    
    public euml.generic.actions.__impl.UmlacceptCallActionImpl unwrap() {
        return (euml.generic.actions.__impl.UmlacceptCallActionImpl) getWrappedObject();
    }
    ...
    public java.util.Collection<euml.generic.commonbehaviors.Umltrigger> getTrigger() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<euml.generic.commonbehaviors.Umltrigger>) wrapResult(getCastWrappedObject().getTrigger(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public java.util.List<euml.generic.activities.UmloutputPin> getresult() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (java.util.List<euml.generic.activities.UmloutputPin>)___invokeOperation(connection, 8, "497EF3D8FE4B5780EC6711DDB93E000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }

    public euml.generic.activities.UmloutputPin getreturnInformation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (euml.generic.activities.UmloutputPin)___invokeOperation(connection, 9, "497EF41F28B298D0EC6811DD8E7D000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private euml.generic.activities.UmloutputPin invoke__getreturnInformation(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 8:
                return ___invokeOperation( connection, operationId, "497EF3D8FE4B5780EC6711DDB93E000E35A783E4", args ); //$NON-NLS-1$    
                
            case 9:
                return ___invokeOperation( connection, operationId, "497EF41F28B298D0EC6811DD8E7D000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.actions.UmlacceptCallAction (Java Type)\nEUML.Generic.Actions.UMLAcceptCallAction (MOF Type)"; //$NON-NLS-1$
    }    
}