 ...
 */
public interface UmlcallOperationAction extends euml.generic.actions.UmlcallAction {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlcallOperationAction> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlcallOperationAction>("497EF47B5F6E7010EC6811DDA954000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Actions", "UMLCallOperationAction"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,euml.generic.actions.UmlcallAction,java.lang.Boolean> IS_SYNCHRONOUS( ) {
            return euml.generic.actions.UmlcallAction.DESCRIPTORS.IS_SYNCHRONOUS( );
        }
        /**
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlcallOperationAction,euml.generic.kernel.Umloperation> __operation;
        /**
         * Returns the descriptor for the <code>operation</code> reference.
         * @return  the descriptor for the <code>operation</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlcallOperationAction,euml.generic.kernel.Umloperation> OPERATION( ) {
            if ( __operation == null ) {
                __operation = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlcallOperationAction,euml.generic.kernel.Umloperation>( "49863EB8BD048503F0C011DD8C61000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLCallOperationAction", "operation" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __operation;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlcallOperationAction,euml.generic.activities.UmlinputPin> __target;
        /**
         * Returns the descriptor for the <code>target</code> reference.
         * @return  the descriptor for the <code>target</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlcallOperationAction,euml.generic.activities.UmlinputPin> TARGET( ) {
            if ( __target == null ) {
                __target = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlcallOperationAction,euml.generic.activities.UmlinputPin>( "49863EEBDB27AB23F0C011DDB9FA000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLCallOperationAction", "target" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __target;
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.OperationDescriptor<com.sap.tc.moin.repository.mmi.model.Operation,euml.generic.actions.UmlcallAction,java.util.List<euml.generic.activities.UmloutputPin>> GETRESULT( ) {
            return euml.generic.actions.UmlcallAction.DESCRIPTORS.GETRESULT( );
        }
    }
}    