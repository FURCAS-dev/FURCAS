 ...
 */
public interface UmlsendSignalAction extends euml.generic.actions.UmlinvocationAction {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlsendSignalAction> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.actions.UmlsendSignalAction>("497EF564EA2DFFE0EC6811DDB892000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Actions", "UMLSendSignalAction"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlsendSignalAction,euml.generic.activities.UmlinputPin> __target;
        /**
         * Returns the descriptor for the <code>target</code> reference.
         * @return  the descriptor for the <code>target</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlsendSignalAction,euml.generic.activities.UmlinputPin> TARGET( ) {
            if ( __target == null ) {
                __target = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlsendSignalAction,euml.generic.activities.UmlinputPin>( "49863F5A1D771243F0C111DDA39A000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLSendSignalAction", "target" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __target;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlsendSignalAction,euml.generic.commonbehaviors.Umlsignal> __signal;
        /**
         * Returns the descriptor for the <code>signal</code> reference.
         * @return  the descriptor for the <code>signal</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlsendSignalAction,euml.generic.commonbehaviors.Umlsignal> SIGNAL( ) {
            if ( __signal == null ) {
                __signal = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.actions.UmlsendSignalAction,euml.generic.commonbehaviors.Umlsignal>( "49863F772ECE76A2F0C111DDC626000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Actions", "UMLSendSignalAction", "signal" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __signal;
        }
        /**
