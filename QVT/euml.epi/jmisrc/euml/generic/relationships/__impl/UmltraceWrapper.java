...
public class UmltraceWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.relationships.__impl.UmltraceImpl> implements euml.generic.relationships.Umltrace,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmltraceWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.relationships.__impl.UmltraceImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.relationships.__impl.UmltraceImpl getCastWrappedObject() {
        return (euml.generic.relationships.__impl.UmltraceImpl) getWrappedObject();
    }
    
    private euml.generic.relationships.__impl.UmltraceImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.relationships.__impl.UmltraceImpl) resolved;
    }
    
    public euml.generic.relationships.__impl.UmltraceImpl unwrap() {
        return (euml.generic.relationships.__impl.UmltraceImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlelement) wrapResult(getCastWrappedObject().getTargetelement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlelement) wrapResult(getCastWrappedObject().getSourceElement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setSourceElement(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.relationships.Umltrace (Java Type)\nEUML.Generic.Relationships.UMLTrace (MOF Type)"; //$NON-NLS-1$
    }    
}