...
public class UmlgeneralizationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.relationships.__impl.UmlgeneralizationImpl> implements euml.generic.relationships.Umlgeneralization,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlgeneralizationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.relationships.__impl.UmlgeneralizationImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    @SuppressWarnings("unused")
    private euml.generic.relationships.__impl.UmlgeneralizationImpl getCastWrappedObject() {
        return (euml.generic.relationships.__impl.UmlgeneralizationImpl) getWrappedObject();
    }
    
    private euml.generic.relationships.__impl.UmlgeneralizationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.relationships.__impl.UmlgeneralizationImpl) resolved;
    }
    
    public euml.generic.relationships.__impl.UmlgeneralizationImpl unwrap() {
        return (euml.generic.relationships.__impl.UmlgeneralizationImpl) getWrappedObject();
    }
    ...
    public java.util.List<euml.generic.kernel.Umlelement> getTheRelatedElements() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.kernel.Umlelement>) wrapResult(getCastWrappedObject().getTheRelatedElements(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlelement) wrapResult(getCastWrappedObject().getTheSourceElement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setTheSourceElement(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.kernel.Umlelement>) wrapResult(getCastWrappedObject().getTheTargetElement(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    public euml.generic.kernel.Umlclassifier getgeneral() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (euml.generic.kernel.Umlclassifier)___invokeOperation(connection, 2, "497EE4E414E604D0EC5F11DD978C000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    public euml.generic.kernel.Umlclassifier getspecific() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        java.util.List<java.lang.Object> parameterList = new java.util.ArrayList<java.lang.Object>(0);
        try {
            return (euml.generic.kernel.Umlclassifier)___invokeOperation(connection, 3, "497EE50025836800EC5F11DD90B7000E35A783E4", parameterList); //$NON-NLS-1$
        } catch ( com.sap.tc.moin.repository.mmi.reflect.RefException ex ) {
            throw new com.sap.tc.moin.repository.mmi.reflect.JmiException( ex );
        }
    }
    ...
    private euml.generic.kernel.Umlclassifier invoke__getgeneral(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    private euml.generic.kernel.Umlclassifier invoke__getspecific(com.sap.tc.moin.repository.core.CoreConnection connection) throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        // missing an implementation provided in either tag org.omg.sap2mof.OperationCodeJava or org.omg.sap2mof.OperationCodeOcl
        return null;
    }
    ...
    public Object refInvokeOperation(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String requestedOperation, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        ...
        switch (operationId) {
            ...
            case 2:
                return ___invokeOperation( connection, operationId, "497EE4E414E604D0EC5F11DD978C000E35A783E4", args ); //$NON-NLS-1$    
                
            case 3:
                return ___invokeOperation( connection, operationId, "497EE50025836800EC5F11DD90B7000E35A783E4", args ); //$NON-NLS-1$    
            default:
                throw new com.sap.tc.moin.repository.mmi.reflect.InvalidCallException(requestedOperation, refMetaObject(), "refInvokeOperation(String)"); //$NON-NLS-1$
        }
    }
    ...
    public Object invoke___Operation(com.sap.tc.moin.repository.core.CoreConnection connection, int operationId, java.util.List<? extends Object> args) throws com.sap.tc.moin.repository.mmi.reflect.RefException {
        switch (operationId) {
            ...
            case 2:
                return invoke__getgeneral(connection);    
                
            case 3:
                return invoke__getspecific(connection);    
            default:
    ...
    protected String metaObjectToString() {
        return "euml.generic.relationships.Umlgeneralization (Java Type)\nEUML.Generic.Relationships.UMLGeneralization (MOF Type)"; //$NON-NLS-1$
    }    
}