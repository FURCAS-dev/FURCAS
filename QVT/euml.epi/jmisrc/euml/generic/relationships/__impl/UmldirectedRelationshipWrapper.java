...
public class UmldirectedRelationshipWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.relationships.__impl.UmldirectedRelationshipImpl> implements euml.generic.relationships.UmldirectedRelationship,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmldirectedRelationshipWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.relationships.__impl.UmldirectedRelationshipImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.relationships.__impl.UmldirectedRelationshipImpl getCastWrappedObject() {
        return (euml.generic.relationships.__impl.UmldirectedRelationshipImpl) getWrappedObject();
    }
    
    private euml.generic.relationships.__impl.UmldirectedRelationshipImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.relationships.__impl.UmldirectedRelationshipImpl) resolved;
    }
    
    public euml.generic.relationships.__impl.UmldirectedRelationshipImpl unwrap() {
        return (euml.generic.relationships.__impl.UmldirectedRelationshipImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "euml.generic.relationships.UmldirectedRelationship (Java Type)\nEUML.Generic.Relationships.UMLDirectedRelationship (MOF Type)"; //$NON-NLS-1$
    }    
}