 ...
 */
public interface Umlrelationship extends euml.generic.kernel.Umlelement {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.relationships.Umlrelationship> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.relationships.Umlrelationship>("497ED45133790F50EC5511DD9370000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "Relationships", "UMLRelationship"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.relationships.Umlrelationship,java.util.List<euml.generic.kernel.Umlelement>> __theRelatedElements;
        /**
         ...
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.relationships.Umlrelationship,java.util.List<euml.generic.kernel.Umlelement>> THE_RELATED_ELEMENTS( ) {
            if ( __theRelatedElements == null ) {
                __theRelatedElements = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.relationships.Umlrelationship,java.util.List<euml.generic.kernel.Umlelement>>( "498644DA64C5E513F0C411DD8213000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "Relationships", "UMLRelationship", "the_related_elements" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theRelatedElements;
        }
        /**
