...
public class UmluseCaseWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.usecases.__impl.UmluseCaseImpl> implements euml.generic.usecases.UmluseCase,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmluseCaseWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.usecases.__impl.UmluseCaseImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.usecases.__impl.UmluseCaseImpl getCastWrappedObject() {
        return (euml.generic.usecases.__impl.UmluseCaseImpl) getWrappedObject();
    }
    
    private euml.generic.usecases.__impl.UmluseCaseImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.usecases.__impl.UmluseCaseImpl) resolved;
    }
    
    public euml.generic.usecases.__impl.UmluseCaseImpl unwrap() {
        return (euml.generic.usecases.__impl.UmluseCaseImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.usecases.UmluseCase>) wrapResult(getCastWrappedObject().getTheExtendedCase(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.List<euml.generic.usecases.UmluseCase>) wrapResult(getCastWrappedObject().getTheIncludedUseCase(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (java.util.Collection<euml.generic.kernel.Umlclassifier>) wrapResult(getCastWrappedObject().getThesubject(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
    ...
    protected String metaObjectToString() {
        return "euml.generic.usecases.UmluseCase (Java Type)\nEUML.Generic.UseCases.UMLUseCase (MOF Type)"; //$NON-NLS-1$
    }    
}