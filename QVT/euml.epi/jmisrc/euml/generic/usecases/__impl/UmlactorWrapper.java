...
public class UmlactorWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<euml.generic.usecases.__impl.UmlactorImpl> implements euml.generic.usecases.Umlactor,com.sap.tc.moin.repository.Partitionable {
    ...
    public UmlactorWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, euml.generic.usecases.__impl.UmlactorImpl baseObject, boolean synchronize) {
        super(conn, baseObject, synchronize);
    }

    private euml.generic.usecases.__impl.UmlactorImpl getCastWrappedObject() {
        return (euml.generic.usecases.__impl.UmlactorImpl) getWrappedObject();
    }
    
    private euml.generic.usecases.__impl.UmlactorImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (euml.generic.usecases.__impl.UmlactorImpl) resolved;
    }
    
    public euml.generic.usecases.__impl.UmlactorImpl unwrap() {
        return (euml.generic.usecases.__impl.UmlactorImpl) getWrappedObject();
    }
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (euml.generic.kernel.Umlclassifier) wrapResult(getCastWrappedObject().getActorIsSystem(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setActorIsSystem(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "euml.generic.usecases.Umlactor (Java Type)\nEUML.Generic.UseCases.UMLActor (MOF Type)"; //$NON-NLS-1$
    }    
}