 ...
 */
public interface Umlactor extends euml.generic.kernel.Umlclassifier {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.usecases.Umlactor> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.usecases.Umlactor>("497EEC9FB010A060EC6311DDACE4000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "UseCases", "UMLActor"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public euml.generic.kernel.Umlclassifier getActorIsSystem() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public void setActorIsSystem(euml.generic.kernel.Umlclassifier newValue) throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.Umlactor,euml.generic.kernel.Umlclassifier> __actorIsSystem;
        /**
         * Returns the descriptor for the <code>actorIsSystem</code> reference.
         * @return  the descriptor for the <code>actorIsSystem</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.Umlactor,euml.generic.kernel.Umlclassifier> ACTOR_IS_SYSTEM( ) {
            if ( __actorIsSystem == null ) {
                __actorIsSystem = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.Umlactor,euml.generic.kernel.Umlclassifier>( "498656FB32CD1322F0CF11DD9D97000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "UseCases", "UMLActor", "actorIsSystem" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __actorIsSystem;
        }
        /**
