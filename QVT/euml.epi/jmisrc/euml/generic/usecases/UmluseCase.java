 ...
 */
public interface UmluseCase extends euml.generic.kernel.Umlclassifier {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.usecases.UmluseCase> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, euml.generic.usecases.UmluseCase>("497EECC4C6579950EC6311DDAFED000E35A783E4", "sap.com/moin/mm/euml", "EUML", "Generic", "UseCases", "UMLUseCase"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ 

    
    // references
    public java.util.List<euml.generic.usecases.UmluseCase> getTheExtendedCase() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.List<euml.generic.usecases.UmluseCase> getTheIncludedUseCase() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    public java.util.Collection<euml.generic.kernel.Umlclassifier> getThesubject() throws com.sap.tc.moin.repository.mmi.reflect.JmiException;
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.List<euml.generic.usecases.UmluseCase>> __theExtendedCase;
        /**
         * Returns the descriptor for the <code>theExtendedCase</code> reference.
         * @return  the descriptor for the <code>theExtendedCase</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.List<euml.generic.usecases.UmluseCase>> THE_EXTENDED_CASE( ) {
            if ( __theExtendedCase == null ) {
                __theExtendedCase = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.List<euml.generic.usecases.UmluseCase>>( "4986565BD3C9A643F0CE11DDA31E000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "UseCases", "UMLUseCase", "theExtendedCase" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theExtendedCase;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.List<euml.generic.usecases.UmluseCase>> __theIncludedUseCase;
        /**
         * Returns the descriptor for the <code>theIncludedUseCase</code> reference.
         * @return  the descriptor for the <code>theIncludedUseCase</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.List<euml.generic.usecases.UmluseCase>> THE_INCLUDED_USE_CASE( ) {
            if ( __theIncludedUseCase == null ) {
                __theIncludedUseCase = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.List<euml.generic.usecases.UmluseCase>>( "4986567EE890B5F3F0CE11DDBC6A000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "UseCases", "UMLUseCase", "theIncludedUseCase" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __theIncludedUseCase;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.Collection<euml.generic.kernel.Umlclassifier>> __thesubject;
        /**
         * Returns the descriptor for the <code>thesubject</code> reference.
         * @return  the descriptor for the <code>thesubject</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.Collection<euml.generic.kernel.Umlclassifier>> THESUBJECT( ) {
            if ( __thesubject == null ) {
                __thesubject = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,euml.generic.usecases.UmluseCase,java.util.Collection<euml.generic.kernel.Umlclassifier>>( "4986577179202830F0CF11DDB722000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "EUML", "Generic", "UseCases", "UMLUseCase", "thesubject" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ 
            }
            return __thesubject;
        }
        /**
