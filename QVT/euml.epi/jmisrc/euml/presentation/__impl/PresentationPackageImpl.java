...
public final class PresentationPackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    static {
        ...
        FEATURE_IDS.put("Graphic", Integer.valueOf(0)); //$NON-NLS-1$
    }

    // constructors    
    public PresentationPackageImpl()
    {
        super();
    }
    public PresentationPackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    // nested packages
    public com.sap.tc.moin.repository.mmi.reflect.RefPackage getGraphic(com.sap.tc.moin.repository.core.CoreConnection connection) {
        return  refPackage(connection, "Graphic"); //$NON-NLS-1$
    }
    // classes
    // associations
    ...
    protected java.lang.Object create___Extent(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
        ...
        try {
            switch (FEATURE_IDS.get(name)) {
                case 0:
                    return new euml.presentation.graphic.__impl.GraphicPackageImpl(workspace, mofId, immediatePackage, metaObject);
                default:
    ...
    protected void initialize() {
        if (___refPackages == null) {
            ...
            name = "Graphic"; //$NON-NLS-1$
            rpan = new RefPackageAndName(name, "euml.presentation.graphic.GraphicPackage", false); //$NON-NLS-1$
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<euml.presentation.__impl.PresentationPackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new euml.presentation.__impl.PresentationPackageWrapper(conn, this, synchronize);
    }
