 ...
 */
public interface Association extends uml.Classifier,uml.Relationship {
     ...
     * Extent descriptor
     */
    public final com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, uml.Association> CLASS_DESCRIPTOR = new com.sap.tc.moin.repository.mmi.descriptors.ClassDescriptor<com.sap.tc.moin.repository.mmi.reflect.RefClass, uml.Association>("49868A36BC3AD2F0F0ED11DDC3B9000E35A783E4", "sap.com/moin/mm/euml", "uml", "Association"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ 
    ...
    public static final class Descriptors {
        ...
        private com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,uml.Association,java.lang.Boolean> __isDerived;
        /**
         * Returns the descriptor for the <code>isDerived</code> attribute.
         * @return  the descriptor for the <code>isDerived</code> attribute
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,uml.Association,java.lang.Boolean> IS_DERIVED( ) {
            if ( __isDerived == null ) {
                __isDerived = new com.sap.tc.moin.repository.mmi.descriptors.AttributeDescriptor<com.sap.tc.moin.repository.mmi.model.Attribute,uml.Association,java.lang.Boolean>( "49868A83EA201770F0ED11DDAD3E000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "uml", "Association", "isDerived" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __isDerived;
        }
        /**
         ...
         */
        public com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Relationship,java.util.Collection<uml.Element>> RELATED_ELEMENT( ) {
            return uml.Relationship.DESCRIPTORS.RELATED_ELEMENT( );
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Property>> __ownedEnd;
        /**
         * Returns the descriptor for the <code>ownedEnd</code> reference.
         * @return  the descriptor for the <code>ownedEnd</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Property>> OWNED_END( ) {
            if ( __ownedEnd == null ) {
                __ownedEnd = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Property>>( "49868A94F3FCF6A3F0ED11DDA317000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "uml", "Association", "ownedEnd" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __ownedEnd;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Property>> __memberEnd;
        /**
         * Returns the descriptor for the <code>memberEnd</code> reference.
         * @return  the descriptor for the <code>memberEnd</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Property>> MEMBER_END( ) {
            if ( __memberEnd == null ) {
                __memberEnd = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Property>>( "49868AD91D865B10F0EE11DDB275000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "uml", "Association", "memberEnd" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __memberEnd;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Type>> __endType;
        /**
         * Returns the descriptor for the <code>endType</code> reference.
         * @return  the descriptor for the <code>endType</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Type>> END_TYPE( ) {
            if ( __endType == null ) {
                __endType = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.List<uml.Type>>( "49868B3151B4F7C3F0EE11DD8A9B000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "uml", "Association", "endType" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __endType;
        }
        private com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.Collection<uml.Property>> __navigableOwnedEnd;
        /**
         * Returns the descriptor for the <code>navigableOwnedEnd</code> reference.
         * @return  the descriptor for the <code>navigableOwnedEnd</code> reference
         */
        public synchronized com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.Collection<uml.Property>> NAVIGABLE_OWNED_END( ) {
            if ( __navigableOwnedEnd == null ) {
                __navigableOwnedEnd = new com.sap.tc.moin.repository.mmi.descriptors.ReferenceDescriptor<com.sap.tc.moin.repository.mmi.model.Reference,uml.Association,java.util.Collection<uml.Property>>( "49868B68725998A3F0EE11DDAD43000E35A783E4", "sap.com/moin/mm/euml", new java.lang.String[] { "uml", "Association", "navigableOwnedEnd" } ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ 
            }
            return __navigableOwnedEnd;
        }
    }
}    