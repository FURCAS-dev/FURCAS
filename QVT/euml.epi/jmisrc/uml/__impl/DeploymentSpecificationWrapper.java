...
public class DeploymentSpecificationWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<uml.__impl.DeploymentSpecificationImpl> implements uml.DeploymentSpecification,com.sap.tc.moin.repository.Partitionable {
    ...
    public DeploymentSpecificationWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, uml.__impl.DeploymentSpecificationImpl baseObject, boolean synchronize) {
    ...
    private uml.__impl.DeploymentSpecificationImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (uml.__impl.DeploymentSpecificationImpl) resolved;
    }
    
    public uml.__impl.DeploymentSpecificationImpl unwrap() {
        return (uml.__impl.DeploymentSpecificationImpl) getWrappedObject();
    }
    ...
    public java.lang.String getDeploymentLocation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getDeploymentLocation();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getDeploymentLocation();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDeploymentLocation(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
    ...
    public java.lang.String getExecutionLocation() throws com.sap.tc.moin.repository.mmi.reflect.JmiException
    {
        com.sap.tc.moin.repository.core.CorePartitionable resolved = mriReference.getIfResolved();
        if (resolved != null) {
            return getCastWrappedObject(resolved).getExecutionLocation();
        }
            try {
            if (synchronize) {
                synchronizationManager.acquireReadLock();
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return getCastWrappedObject().getExecutionLocation();
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setExecutionLocation(connection, newValue);
                }       
            }
            else {
                assertConnectionAlive();
        ...
        try {
            if (synchronize) {
                ...
                try {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    return (uml.Deployment) wrapResult(getCastWrappedObject().getDeployment(connection));
                } finally {
                    synchronizationManager.releaseReadLock();
                }
        ...
        try {
            if (synchronize) {
                synchronized (synchronizationManager.getProhibitWriteSyncObject()) {
                    assertConnectionAlive();
                    attachConnectionIfRequired();
                    getCastWrappedObject().setDeployment(connection, unwrapArg((com.sap.tc.moin.repository.mmi.reflect.RefBaseObject) newValue));
                }       
            }
            else {
                assertConnectionAlive();
    ...
    protected String metaObjectToString() {
        return "uml.DeploymentSpecification (Java Type)\numl.DeploymentSpecification (MOF Type)"; //$NON-NLS-1$
    }    
}