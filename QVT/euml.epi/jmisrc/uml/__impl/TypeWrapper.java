...
public class TypeWrapper extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectWrapperImpl<uml.__impl.TypeImpl> implements uml.Type,com.sap.tc.moin.repository.Partitionable {
    ...
    public TypeWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, uml.__impl.TypeImpl baseObject, boolean synchronize) {
    ...
    private uml.__impl.TypeImpl getCastWrappedObject(com.sap.tc.moin.repository.core.CorePartitionable resolved) {
        return (uml.__impl.TypeImpl) resolved;
    }
    
    public uml.__impl.TypeImpl unwrap() {
        return (uml.__impl.TypeImpl) getWrappedObject();
    }
    ...
    protected String metaObjectToString() {
        return "uml.Type (Java Type)\numl.Type (MOF Type)"; //$NON-NLS-1$
    }    
}