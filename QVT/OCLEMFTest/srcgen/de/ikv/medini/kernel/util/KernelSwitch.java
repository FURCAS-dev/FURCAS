 ...
 * $Id$
 */
package de.ikv.medini.kernel.util;
 ...
 * <!-- end-user-doc -->
 * @see de.ikv.medini.kernel.KernelPackage
 * @generated
 */
public class KernelSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KernelPackage.MEDINI_OBJECT: {
				MediniObject mediniObject = (MediniObject)theEObject;
				Object result = caseMediniObject(mediniObject);
