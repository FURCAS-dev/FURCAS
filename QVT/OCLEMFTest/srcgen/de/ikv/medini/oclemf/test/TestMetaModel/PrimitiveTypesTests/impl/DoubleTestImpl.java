...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Double Test</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.ikv.medini.oclemf.test.TestMetaModel.PrimitiveTypesTests.impl.DoubleTestImpl#getBagAttribute <em>Bag Attribute</em>}</li>
 *   <li>{@link de.ikv.medini.oclemf.test.TestMetaModel.PrimitiveTypesTests.impl.DoubleTestImpl#getOptionalSimpleAttribute <em>Optional Simple Attribute</em>}</li>
 *   <li>{@link de.ikv.medini.oclemf.test.TestMetaModel.PrimitiveTypesTests.impl.DoubleTestImpl#getOrderedSetAttribute <em>Ordered Set Attribute</em>}</li>
 *   <li>{@link de.ikv.medini.oclemf.test.TestMetaModel.PrimitiveTypesTests.impl.DoubleTestImpl#getSequenceAttribute <em>Sequence Attribute</em>}</li>
 *   <li>{@link de.ikv.medini.oclemf.test.TestMetaModel.PrimitiveTypesTests.impl.DoubleTestImpl#getSetAttribute <em>Set Attribute</em>}</li>
 *   <li>{@link de.ikv.medini.oclemf.test.TestMetaModel.PrimitiveTypesTests.impl.DoubleTestImpl#getSimpleAttribute <em>Simple Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleTestImpl extends MediniObjectImpl implements DoubleTest {
	...
	public EList getBagAttribute() {
		if (bagAttribute == null) {
			bagAttribute = new EDataTypeEList(Double.class, this, PrimitiveTypesTestsPackage.DOUBLE_TEST__BAG_ATTRIBUTE);
		}
		return bagAttribute;
	}
	...
	public void setOptionalSimpleAttribute(double newOptionalSimpleAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimitiveTypesTestsPackage.DOUBLE_TEST__OPTIONAL_SIMPLE_ATTRIBUTE, oldOptionalSimpleAttribute, optionalSimpleAttribute));
	}
	...
	public EList getOrderedSetAttribute() {
		if (orderedSetAttribute == null) {
			orderedSetAttribute = new EDataTypeUniqueEList(Double.class, this, PrimitiveTypesTestsPackage.DOUBLE_TEST__ORDERED_SET_ATTRIBUTE);
		}
	...
	public EList getSequenceAttribute() {
		if (sequenceAttribute == null) {
			sequenceAttribute = new EDataTypeEList(Double.class, this, PrimitiveTypesTestsPackage.DOUBLE_TEST__SEQUENCE_ATTRIBUTE);
		}
	...
	public EList getSetAttribute() {
		if (setAttribute == null) {
			setAttribute = new EDataTypeUniqueEList(Double.class, this, PrimitiveTypesTestsPackage.DOUBLE_TEST__SET_ATTRIBUTE);
		}
		return setAttribute;
	}
	...
	public void setSimpleAttribute(double newSimpleAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimitiveTypesTestsPackage.DOUBLE_TEST__SIMPLE_ATTRIBUTE, oldSimpleAttribute, simpleAttribute));
	}
