...
public final class IkvPackageImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefPackageImpl
{
    ...
    static {
        ...
        FEATURE_IDS.put("medini", Integer.valueOf(0)); //$NON-NLS-1$
    }

    // constructors    
    public IkvPackageImpl()
    {
        super();
    }
    public IkvPackageImpl(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject)
    {
    ...
    // nested packages
    public com.sap.tc.moin.repository.mmi.reflect.RefPackage getMedini(com.sap.tc.moin.repository.core.CoreConnection connection) {
        return  refPackage(connection, "medini"); //$NON-NLS-1$
    }
    // classes
    // associations
    ...
    protected java.lang.Object create___Extent(java.lang.Object workspace, java.lang.String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
        ...
        try {
            switch (FEATURE_IDS.get(name)) {
                case 0:
                    return new de.ikv.medini.__impl.MediniPackageImpl(workspace, mofId, immediatePackage, metaObject);
                default:
    ...
    protected void initialize() {
        if (___refPackages == null) {
            ...
            name = "medini"; //$NON-NLS-1$
            rpan = new RefPackageAndName(name, "de.ikv.medini.MediniPackage", false); //$NON-NLS-1$
    ...
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<de.ikv.__impl.IkvPackageImpl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new de.ikv.__impl.IkvPackageWrapper(conn, this, synchronize);
    }
