...
For a quick demonstration of the utility of OCL, you may create the "Simple Example project":#SimpleExample ........ or follow the "OCLinEcore tutorial":#OCLinEcoreTutorial, which also provides "Installation":#Installation instructions.
...
* programmatic entry and evaluation using the "Java API":#JavaAPI
...
* constraints, operation bodies and property initializers using the "Java API":#JavaAPI
...
As a specification language, OCL is frequently used when the behaviour of models is formally specified.
