...
public interface IModelProvider {
    ...
    /**
     * Adds the specified <code>eObject</code> to the list of objects to exclude from selection for mutation.
     * 
     * @param eObject
     *            to exclude.
     * @param excludeChildren
     *            specifies whether the children of the specified <code>eObject</code> should be excluded as well.
     */
    public abstract void addToExcludedObjects(EObject eObject, boolean excludeChildren);

    /**
     * Adds the specified <code>listOfEObject</code> to the list of objects to exclude from selection for mutation.
     * 
     * @param listOfEObject
     *            to exclude.
     * @param excludeChildren
     *            specifies whether the children of the objects in the specified <code>listOfEObject</code> should be excluded as
     *            well.
     */
    public abstract void addToExcludedObjects(Collection<EObject> listOfEObject, boolean excludeChildren);
    ...
    /**
     * Returns a random leave {@link EObject}, i.e., an object without any children.
     * 
     * @return a random leave {@link EObject}.
     */
    public abstract EObject getRandomEObjectNotContainingMoreObjectsThan(int objectCount);
     ...
     *            feature.
     */
    public abstract EObject getRandomEObjectHavingFeature(EStructuralFeature feature);
    ...
    /**
     * Returns a random feature of the specified <code>eObject</code>. Will only return {@link EStructuralFeature}s that are
    ...
    /**
     * Returns a random multi-valued (isMany is <code>true</code>) feature of the specified <code>eObject</code>. Furthermore, the
     ...
     * @return random feature.
     */
    public abstract EStructuralFeature getRandomMultiValuedFeature(EObject eObject);

    /**
     * Returns a random single-valued (isMany is <code>false</code>) feature of the specified <code>eObject</code>. Furthermore,
    ...
    /**
     * Returns all {@link EStructuralFeature}s defined in the package defining the meta classes of the current model instance.
     * 
    ...
    /**
     * Returns a random feature having the type ( {@link EStructuralFeature#getEType()}) <code>eClass</code>. Furthermore, the
     ...
     * @return random feature having <code>eClass</code> as type.
     */
    public abstract EStructuralFeature getRandomFeatureHavingType(EClass eClass, boolean isContainment);

    /**
     * Returns the children {@link EModelElement}s of the specified <code>eObject</code>.
     * 
     * @param eObject
     ...
     * list of values.
     * 
     * If the type ({@link EStructuralFeature#getEType()}) of the feature is {@link EClass}, this method will return a random
     * existing instance of this class (as far as it is available).
     * 
     * If it is {@link EEnum} it will return a random {@link EEnumLiteral} from {@link EEnum#getELiterals()}.
     * 
