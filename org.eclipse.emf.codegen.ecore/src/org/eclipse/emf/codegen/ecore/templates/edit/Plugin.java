...
public class Plugin
{
  ...
  protected final String TEXT_24 = NL + "\t\t * @param descriptor the description of the plugin.";
  protected final String TEXT_25 = NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic Implementation(";
  protected final String TEXT_26 = " descriptor";
  protected final String TEXT_27 = ")" + NL + "\t\t{" + NL + "\t\t\tsuper(";
  protected final String TEXT_28 = "descriptor";
  protected final String TEXT_29 = ");" + NL + "" + NL + "\t\t\t// Remember the static instance." + NL + "\t\t\t//" + NL + "\t\t\tplugin = this;" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "}";
