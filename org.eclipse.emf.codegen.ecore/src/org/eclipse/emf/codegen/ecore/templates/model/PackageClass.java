...
public class PackageClass
{
  ...
  protected final String TEXT_277 = NL + "\t\t((EReference) ";
  protected final String TEXT_278 = ".getEStructuralFeatures().get(";
  protected final String TEXT_279 = ".getEStructuralFeatures().size()-1)).setOwnedOpposite(ecoreFactory.createEReference());";
  protected final String TEXT_280 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_281 = ", ";
  protected final String TEXT_282 = ");";
  protected final String TEXT_283 = NL;
  protected final String TEXT_284 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_285 = NL + "\t\t";
  protected final String TEXT_286 = " = createEEnum(";
  protected final String TEXT_287 = ");";
  protected final String TEXT_288 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_289 = NL + "\t\t";
  protected final String TEXT_290 = " = createEDataType(";
  protected final String TEXT_291 = ");";
  protected final String TEXT_292 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_293 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_294 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_295 = NL + "\t\t";
  protected final String TEXT_296 = " ";
  protected final String TEXT_297 = " = (";
  protected final String TEXT_298 = ")";
  protected final String TEXT_299 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_300 = ".eNS_URI);";
  protected final String TEXT_301 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_302 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_303 = ");";
  protected final String TEXT_304 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_305 = NL + "\t\t";
  protected final String TEXT_306 = " ";
  protected final String TEXT_307 = "_";
  protected final String TEXT_308 = " = addETypeParameter(";
  protected final String TEXT_309 = ", \"";
  protected final String TEXT_310 = "\");";
  protected final String TEXT_311 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_312 = ", \"";
  protected final String TEXT_313 = "\");";
  protected final String TEXT_314 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_315 = NL + "\t\t";
  protected final String TEXT_316 = "g";
  protected final String TEXT_317 = " = createEGenericType(";
  protected final String TEXT_318 = ");";
  protected final String TEXT_319 = NL + "\t\tg";
  protected final String TEXT_320 = ".";
  protected final String TEXT_321 = "(g";
  protected final String TEXT_322 = ");";
  protected final String TEXT_323 = NL + "\t\t";
  protected final String TEXT_324 = "_";
  protected final String TEXT_325 = ".getEBounds().add(g1);";
  protected final String TEXT_326 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_327 = NL + "\t\t";
  protected final String TEXT_328 = ".getESuperTypes().add(";
  protected final String TEXT_329 = ".get";
  protected final String TEXT_330 = "());";
  protected final String TEXT_331 = NL + "\t\t";
  protected final String TEXT_332 = "g";
  protected final String TEXT_333 = " = createEGenericType(";
  protected final String TEXT_334 = ");";
  protected final String TEXT_335 = NL + "\t\tg";
  protected final String TEXT_336 = ".";
  protected final String TEXT_337 = "(g";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + "\t\t";
  protected final String TEXT_340 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_341 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_342 = ", features, and operations; add parameters";
  protected final String TEXT_343 = " and features; add operations and parameters";
  protected final String TEXT_344 = NL + "\t\tinitEClass(";
  protected final String TEXT_345 = ", ";
  protected final String TEXT_346 = "null";
  protected final String TEXT_347 = ".class";
  ...
  protected final String TEXT_363 = NL + "\t\tinitEReference(get";
  protected final String TEXT_364 = "(), ";
  protected final String TEXT_365 = "g1";
  ...
  protected final String TEXT_386 = "().getOwnedOpposite(), ";
  ...
  protected final String TEXT_564 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(eNS_URI);";
  ...
  protected final String TEXT_615 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  ...
  protected final String TEXT_648 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL + "\t";
 ...
 */
    ...
    if (genFeature.getOwnedOpposite() != null) {
...
int maxGenericTypeAssignment = 0;
    ...
    if (genFeature.isReferenceType()) { GenFeature reverseGenFeature = genFeature.getReverseIncludingHidden();
    String reverse = reverseGenFeature == null ? "null" : (reverseGenFeature.eContainer() instanceof GenFeature ? "get"+genFeature.getFeatureAccessorName()+"().getOwnedOpposite()" : genPackage.getPackageInstanceVariable(reverseGenFeature.getGenPackage()) + ".get" + reverseGenFeature.getFeatureAccessorName() + "()");
    ...
    if (genFeature.getOwnedOpposite().hasGenericType()) {
    stringBuffer.append(TEXT_387);
    } else {
    stringBuffer.append(genPackage.getPackageInstanceVariable(genFeature.getOwnedOpposite().getTypeGenPackage()));
    stringBuffer.append(TEXT_388);
    stringBuffer.append(genFeature.getOwnedOpposite().getTypeClassifierAccessorName());
    stringBuffer.append(TEXT_389);
    }
    stringBuffer.append(TEXT_390);
    stringBuffer.append(genFeature.getFeatureAccessorName());
    stringBuffer.append(TEXT_391);
    stringBuffer.append(genFeature.getOwnedOpposite().getName());
    stringBuffer.append(TEXT_392);
    stringBuffer.append(genFeature.getOwnedOpposite().getDefaultValue());
    stringBuffer.append(TEXT_393);
    stringBuffer.append(genFeature.getOwnedOpposite().getLowerBound());
    stringBuffer.append(TEXT_394);
    stringBuffer.append(genFeature.getOwnedOpposite().getUpperBound());
    stringBuffer.append(TEXT_395);
    stringBuffer.append(genFeature.getOwnedOpposite().getContainerClass());
    stringBuffer.append(TEXT_396);
    stringBuffer.append(genFeature.getOwnedOpposite().getTransientFlag());
    stringBuffer.append(TEXT_397);
    stringBuffer.append(genFeature.getOwnedOpposite().getVolatileFlag());
    stringBuffer.append(TEXT_398);
    stringBuffer.append(genFeature.getOwnedOpposite().getChangeableFlag());
    stringBuffer.append(TEXT_399);
    stringBuffer.append(genFeature.getOwnedOpposite().getContainmentFlag());
    stringBuffer.append(TEXT_400);
    stringBuffer.append(genFeature.getOwnedOpposite().getResolveProxiesFlag());
    stringBuffer.append(TEXT_401);
    stringBuffer.append(genFeature.getOwnedOpposite().getUnsettableFlag());
    stringBuffer.append(TEXT_402);
    stringBuffer.append(genFeature.getOwnedOpposite().getUniqueFlag());
    stringBuffer.append(TEXT_403);
    stringBuffer.append(genFeature.getOwnedOpposite().getDerivedFlag());
    stringBuffer.append(TEXT_404);
    stringBuffer.append(genFeature.getOwnedOpposite().getOrderedFlag());
    stringBuffer.append(TEXT_405);
    stringBuffer.append(genModel.getNonNLS());
    stringBuffer.append(genModel.getNonNLS(genFeature.getOwnedOpposite().getDefaultValue(), 2));
