 ...
 *
 * $Id: EStringToStringMapEntryEditPart.java,v 1.4 2009/03/25 11:22:17 jlescot Exp $
 **********************************************************************/
...
public class EStringToStringMapEntryEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EStringToStringMapEntry_2007, getParserElement(), EcoreVisualIDRegistry
					.getType(org.eclipse.emf.ecoretools.diagram.edit.parts.EStringToStringMapEntryEditPart.VISUAL_ID));
		}
		return parser;
	}
