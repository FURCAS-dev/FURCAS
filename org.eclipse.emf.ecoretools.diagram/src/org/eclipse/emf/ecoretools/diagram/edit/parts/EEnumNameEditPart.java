 ...
 *
 * $Id: EEnumNameEditPart.java,v 1.3 2009/02/02 08:39:05 jlescot Exp $
 **********************************************************************/
...
public class EEnumNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EEnum_1005, getParserElement(), EcoreVisualIDRegistry
					.getType(org.eclipse.emf.ecoretools.diagram.edit.parts.EEnumNameEditPart.VISUAL_ID));
		}
		return parser;
	}
