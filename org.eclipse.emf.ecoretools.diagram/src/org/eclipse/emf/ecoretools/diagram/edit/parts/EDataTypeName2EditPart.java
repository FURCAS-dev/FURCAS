 ...
 *
 * $Id: EDataTypeName2EditPart.java,v 1.3 2009/02/02 08:39:05 jlescot Exp $
 **********************************************************************/
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EDataType_2004, getParserElement(), EcoreVisualIDRegistry
					.getType(org.eclipse.emf.ecoretools.diagram.edit.parts.EDataTypeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
