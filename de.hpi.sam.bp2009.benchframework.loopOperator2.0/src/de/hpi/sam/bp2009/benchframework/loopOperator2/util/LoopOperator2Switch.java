 ...
 * @generated
 */
public class LoopOperator2Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LoopOperator2Package.START_LOOP: {
				StartLoop startLoop = (StartLoop)theEObject;
				T result = caseStartLoop(startLoop);
				if (result == null) result = caseStartOperator(startLoop);
				if (result == null) result = caseOperator(startLoop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LoopOperator2Package.END_LOOP: {
				EndLoop endLoop = (EndLoop)theEObject;
				T result = caseEndLoop(endLoop);
				if (result == null) result = caseEndOperator(endLoop);
				if (result == null) result = caseOperator(endLoop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LoopOperator2Package.LOOP_OPTION: {
				LoopOption loopOption = (LoopOption)theEObject;
				T result = caseLoopOption(loopOption);
				if (result == null) result = caseOptionObject(loopOption);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Start Loop</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Start Loop</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStartLoop(StartLoop object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Loop Option</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Loop Option</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLoopOption(LoopOption object) {
		return null;
	}
