 ...
 * </copyright>
 *
 * $Id: IntegerLiteralExpOperations.java,v 1.1 2008/03/28 20:33:32 cdamus Exp $
 */
                ...
                diagnostics.add
                    (new BasicDiagnostic
                        (Diagnostic.ERROR,
                         ...
                         org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "checkIntegerType", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(integerLiteralExp, context) }), //$NON-NLS-1$ //$NON-NLS-2$
