 ...
 * </copyright>
 *
 * $Id: OCLLexer.java,v 1.5 2007/04/24 23:27:58 cdamus Exp $
 */
...
public class OCLLexer
    ...
    implements OCLLPGParsersym, OCLLexersym, RuleAction {
    ...
    public OCLLexer(String filename, int tab)
    ...
    public void lexer(Monitor monitor, PrsStream prsStream) {
        ...
        prsStream.makeToken(0, 0, 0); // Token list must start with a bad
                                        // token

        lexParser.parseCharacters(monitor); // Lex the input characters

        int i = getStreamIndex();
        prsStream.makeToken(i, i, TK_EOF_TOKEN); // and end with the end of
                                                    // file token
    ...
    public OCLLexer(String filename)
        throws java.io.IOException {
    ...
    //
    //
    public final static int tokenKind[] = {Char_CtlCharNotWS, // 000 0x00
