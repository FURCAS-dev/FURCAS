...
public class OCLBacktrackingParser extends AbstractOCLParser implements RuleAction
{
	...
	public void ruleAction(int ruleNumber)
	{
		switch (ruleNumber) {
			...
			//
			// Rule 285:  attrOrNavCallExpCS ::= simpleNameCS [ argumentsCS ERROR_TOKEN
			//
			case 285: {
			...
			//
			// Rule 286:  collectionTypeCS ::= collectionTypeIdentifierCS ( typeCS ERROR_TOKEN
			//
			case 286: {
			...
			//
			// Rule 287:  collectionTypeCS ::= collectionTypeIdentifierCS ERROR_TOKEN
			//
			case 287: {
			...
			//
			// Rule 288:  dotArrowExpCS ::= pathNameCS :: ERROR_SimpleNameCS ( argumentsCSopt )
			//
			case 288: {
			...
			//
			// Rule 290:  featureCallExpCS ::= unaryName ERROR_IsMarkedPreCS ( argumentsCSopt )
			//
			case 290:
 
			//
			// Rule 291:  keywordOperationCallExpCS ::= keywordAsName ERROR_IsMarkedPreCS ( argumentsCSopt )
			//
			case 291:
 
			//
			// Rule 292:  operationCallExpCS ::= binaryName ERROR_IsMarkedPreCS ( argumentsCSopt )
			//
			case 292: {
			...
			//
			// Rule 293:  operationCallExpCS ::= oclIsInStateName ERROR_IsMarkedPreCS ( stateExpCS )
			//
			case 293: {
			...
			//
			// Rule 298:  messageExpCS ::= ^ simpleNameCS ERROR_TOKEN
			//
			case 298:
 
			//
			// Rule 299:  messageExpCS ::= ^^ simpleNameCS ERROR_TOKEN
			//
			case 299: {
			...
			//
			// Rule 300:  messageExpCS ::= ^ ERROR_SimpleNameCS
			//
			case 300:
 
			//
			// Rule 301:  messageExpCS ::= ^^ ERROR_SimpleNameCS
			//
			case 301: {
			...
			//
			// Rule 304:  operationCS1 ::= IDENTIFIER ( parametersCSopt ) ERROR_Colon
			//
			case 304: {
			...
			//
			// Rule 305:  operationCS1 ::= IDENTIFIER ( parametersCSopt ERROR_TOKEN
			//
			case 305: {
			...
			//
			// Rule 306:  operationCS1 ::= IDENTIFIER ERROR_TOKEN
			//
			case 306: {
			...
			//
			// Rule 308:  operationCS2 ::= pathNameCS :: simpleNameCS ( parametersCSopt ) ERROR_Colon
			//
			case 308: {
			...
			//
			// Rule 309:  operationCS2 ::= pathNameCS :: simpleNameCS ( parametersCSopt ERROR_TOKEN
			//
			case 309: {
			...
			//
			// Rule 310:  operationCS2 ::= pathNameCS :: simpleNameCS ERROR_TOKEN
			//
			case 310: {
			...
			//
			// Rule 317:  variableCS ::= IDENTIFIER ERROR_TOKEN
			//
			case 317: {
			...
			//
			// Rule 318:  variableExpCS ::= simpleNameCS [ argumentsCS ERROR_TOKEN
			//
			case 318:
 
			//
			// Rule 319:  variableExpCS ::= keywordAsName1 [ argumentsCS ERROR_TOKEN
			//
			case 319: {
