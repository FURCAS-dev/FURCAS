 ...
 * </copyright>
 *
 * $Id: ExpressionInOCL.java,v 1.1 2007/01/25 18:24:32 cdamus Exp $
 */
...
public interface ExpressionInOCL<C, PM> extends Visitable {
     ...
     * @see #setBodyExpression(OCLExpression<C>)
     ...
     * @see #setContextVariable(Variable<C, PM>)
     ...
     * @see #setResultVariable(Variable<C, PM>)
