...
public class XmlresultprocessorAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	public XmlresultprocessorAdapterFactory() {
	 ...
	 * @generated
	 */
	protected XmlresultprocessorSwitch<Adapter> modelSwitch =
		new XmlresultprocessorSwitch<Adapter>() {
			@Override
			public Adapter caseXMLResultProcessor(XMLResultProcessor object) {
				return createXMLResultProcessorAdapter();
			}
			@Override
...
} //XmlresultprocessorAdapterFactory
