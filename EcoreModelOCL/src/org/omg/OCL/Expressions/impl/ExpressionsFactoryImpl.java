...
public class ExpressionsFactoryImpl extends EFactoryImpl implements ExpressionsFactory {
	...
	public static ExpressionsFactory init() {
		try {
			ExpressionsFactory theExpressionsFactory = (ExpressionsFactory)EPackage.Registry.INSTANCE.getEFactory("http://sap.com/moin/OCL/Expressions"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ExpressionsPackage.VARIABLE_DECLARATION: return createVariableDeclaration();
			case ExpressionsPackage.ATTRIBUTE_CALL_EXP: return createAttributeCallExp();
			case ExpressionsPackage.NAVIGATION_CALL_EXP: return createNavigationCallExp();
			case ExpressionsPackage.OPERATION_CALL_EXP: return createOperationCallExp();
			case ExpressionsPackage.ASSOCIATION_END_CALL_EXP: return createAssociationEndCallExp();
			...
			case ExpressionsPackage.OCL_NAMED_ELEMENT: return createOclNamedElement();
			default:
	 ...
	 * @generated
	 */
	public OclNamedElement createOclNamedElement() {
		OclNamedElementImpl oclNamedElement = new OclNamedElementImpl();
		return oclNamedElement;
	}
