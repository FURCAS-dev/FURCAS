 ...
 * $Id$
 */
package org.omg.OCL.Attaching.util;
 ...
 * @generated
 */
public class AttachingSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static AttachingPackage modelPackage;
	 ...
	 * @generated
	 */
	public AttachingSwitch() {
		if (modelPackage == null) {
			modelPackage = AttachingPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AttachingPackage.OCL_CONSTRAINT: {
				...
				if (result == null) result = caseModelElement(oclConstraint);
