...
public class StartOperatorImpl extends EObjectImpl implements StartOperator {
		...
		if (option != null && option.eIsProxy()) {
			...
			if (option != oldOption) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BenchframeworkPackage.START_OPERATOR__OPTION, oldOption, option));
			}
		}
		return option;
	}
	...
	public void setOption(OptionObject newOption) {
		...
		option = newOption;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchframeworkPackage.START_OPERATOR__OPTION, oldOption, option));
	}
	...
	public ResultObject getResult() {
		if (result != null && result.eIsProxy()) {
			...
			if (result != oldResult) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BenchframeworkPackage.START_OPERATOR__RESULT, oldResult, result));
			}
		}
		return result;
	}
	...
	public void setResult(ResultObject newResult) {
		...
		result = newResult;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BenchframeworkPackage.START_OPERATOR__RESULT, oldResult, result));
	}
	...
	public TestRun getTestRun() {
		if (testRun != null && testRun.eIsProxy()) {
			...
			if (testRun != oldTestRun) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BenchframeworkPackage.START_OPERATOR__TEST_RUN, oldTestRun, testRun));
			}
		}
		return testRun;
	}
	...
	public NotificationChain basicSetTestRun(TestRun newTestRun, NotificationChain msgs) {
		...
		testRun = newTestRun;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BenchframeworkPackage.START_OPERATOR__TEST_RUN, oldTestRun, newTestRun);
