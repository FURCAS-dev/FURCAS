 ...
 * @generated
 */
public class ModifiedImpactAnalyzerAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static ModifiedImpactAnalyzerPackage modelPackage;
	 ...
	 * @generated
	 */
	public ModifiedImpactAnalyzerAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = ModifiedImpactAnalyzerPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected ModifiedImpactAnalyzerSwitch<Adapter> modelSwitch =
		new ModifiedImpactAnalyzerSwitch<Adapter>() {
			@Override
			public Adapter caseModifiedImpactAnalyzer(ModifiedImpactAnalyzer object) {
				return createModifiedImpactAnalyzerAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseOutgoingResultNotification(OutgoingResultNotification object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.benchframework.modifiedImpactAnalyzer.ModifiedImpactAnalyzer <em>Modified Impact Analyzer</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createModifiedImpactAnalyzerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.benchframework.modifiedImpactAnalyzer.IncomingEventNotification <em>Incoming Event Notification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.benchframework.modifiedImpactAnalyzer.OutgoingResultNotification <em>Outgoing Result Notification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOutgoingResultNotificationAdapter() {
		return null;
	}
...
} //ModifiedImpactAnalyzerAdapterFactory
