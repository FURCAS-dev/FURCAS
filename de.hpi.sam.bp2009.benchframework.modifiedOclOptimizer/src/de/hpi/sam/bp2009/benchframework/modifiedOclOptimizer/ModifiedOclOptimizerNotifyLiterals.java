 ...
 * <!-- end-user-doc -->
 * @see de.hpi.sam.bp2009.benchframework.modifiedOclOptimizer.ModifiedOclOptimizerPackage#getModifiedOclOptimizerNotifyLiterals()
 * @model
 * @generated
 */
public enum ModifiedOclOptimizerNotifyLiterals implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final ModifiedOclOptimizerNotifyLiterals[] VALUES_ARRAY =
		new ModifiedOclOptimizerNotifyLiterals[] {
	 ...
	 * @generated
	 */
	public static final List<ModifiedOclOptimizerNotifyLiterals> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static ModifiedOclOptimizerNotifyLiterals get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ModifiedOclOptimizerNotifyLiterals result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ModifiedOclOptimizerNotifyLiterals getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ModifiedOclOptimizerNotifyLiterals result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ModifiedOclOptimizerNotifyLiterals get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ModifiedOclOptimizerNotifyLiterals(int value, String name, String literal) {
		this.value = value;
		this.name = name;
...
} //ModifiedOclOptimizerNotifyLiterals
