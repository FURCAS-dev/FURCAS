...
public class PagingResourceDescriptorMap<K, V extends ResourceDescriptorInternal> implements ResourceDescriptorMap<K, V> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.emf.query.index.impl.ResourceDescriptorMap#put(V)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.emf.query.index.impl.ResourceDescriptorMap#delete(V)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.emf.query.index.impl.ResourceDescriptorMap#aquire(K)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.emf.query.index.impl.ResourceDescriptorMap#release(V)
	 */
