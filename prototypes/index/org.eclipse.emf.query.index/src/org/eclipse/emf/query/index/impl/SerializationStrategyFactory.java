...
import org.eclipse.emf.query.index.maps.SerializationStrategy;
...
public class SerializationStrategyFactory {
	...
	private static class IncomingLinkMapStrategy extends BaseStrategy<String, IncomingReferenceDescriptorImpl> {
		...
		@Override
		public IncomingReferenceDescriptorImpl readElement(String key) {
			String tarRes = channel.getString();
			String fragment = channel.getString();
		...
		@Override
		public void writeElement(IncomingReferenceDescriptorImpl element) {
	...
	public SerializationStrategy<String, IncomingReferenceDescriptorImpl> createIncomingLinkMapStrategy(
			SingleMap<String, EObjectDescriptorImpl> eObjectMap, SingleMap<String, PageableResourceDescriptorImpl> resourceMap) {
