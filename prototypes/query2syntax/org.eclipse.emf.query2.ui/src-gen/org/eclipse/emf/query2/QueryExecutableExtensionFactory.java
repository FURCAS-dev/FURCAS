 ...
 * generated
 */
public class QueryExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(QueryExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		org.eclipse.emf.query2.internal.QueryActivator instance = org.eclipse.emf.query2.internal.QueryActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = org.eclipse.emf.query2.internal.QueryActivator.getInstance().getInjector("org.eclipse.emf.query2.Query");
