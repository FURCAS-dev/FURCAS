 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.query.impl.VariableWhereEntryImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.query.impl.VariableWhereEntryImpl#getRightAlias <em>Right Alias</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.query.impl.VariableWhereEntryImpl#getRightAttribute <em>Right Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableWhereEntryImpl extends AttributeWhereEntryImpl implements VariableWhereEntry
{
  ...
  {
    return QueryPackage.Literals.VARIABLE_WHERE_ENTRY;
  }
  ...
  public void setOperator(NumericOperator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.VARIABLE_WHERE_ENTRY__OPERATOR, oldOperator, operator));
  }
  ...
  public FromEntry getRightAlias()
  {
    if (rightAlias != null && rightAlias.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.VARIABLE_WHERE_ENTRY__RIGHT_ALIAS, oldRightAlias, rightAlias));
      }
    }
    return rightAlias;
  }
  ...
  public void setRightAlias(FromEntry newRightAlias)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.VARIABLE_WHERE_ENTRY__RIGHT_ALIAS, oldRightAlias, rightAlias));
  }
  ...
  public EAttribute getRightAttribute()
  {
    if (rightAttribute != null && rightAttribute.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.VARIABLE_WHERE_ENTRY__RIGHT_ATTRIBUTE, oldRightAttribute, rightAttribute));
      }
    }
  ...
  public void setRightAttribute(EAttribute newRightAttribute)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.VARIABLE_WHERE_ENTRY__RIGHT_ATTRIBUTE, oldRightAttribute, rightAttribute));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QueryPackage.VARIABLE_WHERE_ENTRY__OPERATOR:
        return getOperator();
      case QueryPackage.VARIABLE_WHERE_ENTRY__RIGHT_ALIAS:
        if (resolve) return getRightAlias();
        return basicGetRightAlias();
      case QueryPackage.VARIABLE_WHERE_ENTRY__RIGHT_ATTRIBUTE:
