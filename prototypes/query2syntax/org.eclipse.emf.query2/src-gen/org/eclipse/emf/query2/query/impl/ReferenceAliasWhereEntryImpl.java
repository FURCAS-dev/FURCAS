 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.query.impl.ReferenceAliasWhereEntryImpl#getRightAlias <em>Right Alias</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReferenceAliasWhereEntryImpl extends ReferenceWhereEntryImpl implements ReferenceAliasWhereEntry
{
  /**
  ...
  {
    return QueryPackage.Literals.REFERENCE_ALIAS_WHERE_ENTRY;
  }
    ...
    if (rightAlias != null && rightAlias.eIsProxy())
    {
      ...
      if (rightAlias != oldRightAlias)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.REFERENCE_ALIAS_WHERE_ENTRY__RIGHT_ALIAS, oldRightAlias, rightAlias));
      }
    }
    return rightAlias;
  }
  ...
  public void setRightAlias(FromEntry newRightAlias)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.REFERENCE_ALIAS_WHERE_ENTRY__RIGHT_ALIAS, oldRightAlias, rightAlias));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QueryPackage.REFERENCE_ALIAS_WHERE_ENTRY__RIGHT_ALIAS:
