 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.query.impl.StringAttributeWhereEntryImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.query.impl.StringAttributeWhereEntryImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringAttributeWhereEntryImpl extends AttributeWhereEntryImpl implements StringAttributeWhereEntry
{
  ...
  {
    return QueryPackage.Literals.STRING_ATTRIBUTE_WHERE_ENTRY;
  }
  ...
  public void setOperator(StringOperator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.STRING_ATTRIBUTE_WHERE_ENTRY__OPERATOR, oldOperator, operator));
  }
  ...
  public void setPattern(String newPattern)
  {
    ...
    pattern = newPattern;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.STRING_ATTRIBUTE_WHERE_ENTRY__PATTERN, oldPattern, pattern));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QueryPackage.STRING_ATTRIBUTE_WHERE_ENTRY__OPERATOR:
        return getOperator();
      case QueryPackage.STRING_ATTRIBUTE_WHERE_ENTRY__PATTERN:
        return getPattern();
    }
