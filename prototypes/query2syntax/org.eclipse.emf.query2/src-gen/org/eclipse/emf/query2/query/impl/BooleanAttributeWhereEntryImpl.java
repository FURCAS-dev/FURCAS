 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.query2.query.impl.BooleanAttributeWhereEntryImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipse.emf.query2.query.impl.BooleanAttributeWhereEntryImpl#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanAttributeWhereEntryImpl extends AttributeWhereEntryImpl implements BooleanAttributeWhereEntry
{
  ...
  {
    return QueryPackage.Literals.BOOLEAN_ATTRIBUTE_WHERE_ENTRY;
  }
  ...
  public void setOperator(BooleanOperator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.BOOLEAN_ATTRIBUTE_WHERE_ENTRY__OPERATOR, oldOperator, operator));
  }
  ...
  public void setIsTrue(boolean newIsTrue)
  {
    ...
    isTrue = newIsTrue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.BOOLEAN_ATTRIBUTE_WHERE_ENTRY__IS_TRUE, oldIsTrue, isTrue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QueryPackage.BOOLEAN_ATTRIBUTE_WHERE_ENTRY__OPERATOR:
        return getOperator();
      case QueryPackage.BOOLEAN_ATTRIBUTE_WHERE_ENTRY__IS_TRUE:
        return isIsTrue();
    }
