 ...
 * @generated
 */
public class RandomModelModifierSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public RandomModelModifierSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RandomModelModifierPackage.RANDOM_MODEL_MODIFIER: {
				RandomModelModifier randomModelModifier = (RandomModelModifier)theEObject;
				T result = caseRandomModelModifier(randomModelModifier);
				if (result == null) result = caseOperator(randomModelModifier);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Random Model Modifier</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Random Model Modifier</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRandomModelModifier(RandomModelModifier object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRandomModelModifierOptionObject(RandomModelModifierOptionObject object) {
		return null;
	}
