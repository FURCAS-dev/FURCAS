 ...
 * <ul>
 *   <li>{@link usecase.impl.ActorImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActorImpl extends ElementImpl implements Actor {
	...
	public EList<Association> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList.ManyInverse<Association>(Association.class, this, UsecasePackage.ACTOR__OUTGOING, UsecasePackage.ASSOCIATION__ACTORS);
		}
		return outgoing;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UsecasePackage.ACTOR__OUTGOING:
