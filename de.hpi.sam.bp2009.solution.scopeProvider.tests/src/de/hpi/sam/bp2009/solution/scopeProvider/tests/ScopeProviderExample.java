...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>scopeProvider</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ScopeProviderExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ScopeProviderPackage.eNS_URI, 
			 ScopeProviderPackage.eINSTANCE);
