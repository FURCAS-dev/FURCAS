 ...
 * </p>
 *
 * @see org.eclipse.emf.query2.query.QueryPackage#getFromEntry()
 * @model
 * @generated
 */
public interface FromEntry extends EObject
{
   ...
   * @see #setType(EClass)
   * @see org.eclipse.emf.query2.query.QueryPackage#getFromEntry_Type()
   * @model
   * @generated
   */
  EClass getType();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.query2.query.FromEntry#getType <em>Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.emf.query2.query.QueryPackage#getFromEntry_Withoutsubtypes()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.query2.query.FromEntry#isWithoutsubtypes <em>Withoutsubtypes</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setAlias(String)
   * @see org.eclipse.emf.query2.query.QueryPackage#getFromEntry_Alias()
   * @model
   * @generated
   */
  String getAlias();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.query2.query.FromEntry#getAlias <em>Alias</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.emf.query2.query.QueryPackage#getFromEntry_ScopeClause()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.query2.query.FromEntry#getScopeClause <em>Scope Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
