 ...
 * </p>
 *
 * @see org.eclipse.emf.query2.query.QueryPackage#getMQLquery()
 * @model
 * @generated
 */
public interface MQLquery extends EObject
{
   ...
   * @see org.eclipse.emf.query2.query.QueryPackage#getMQLquery_FromEntries()
   ...
   * @see org.eclipse.emf.query2.query.QueryPackage#getMQLquery_WhereEntry()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.query2.query.MQLquery#getWhereEntry <em>Where Entry</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
