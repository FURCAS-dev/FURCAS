...
/**
 * Tests the the creation of a retarded link with a wrong end B classifier. This
 * will cause an Exception at the end of the parsing.
 */
@SuppressWarnings( "nls" )
public class ParserHelperApiTestRetardedLinkWrongEndBClassifier extends com.sap.tc.moin.repository.xm.parser.XmParserHandlerAbstract {
     ...
     */
    public ParserHelperApiTestRetardedLinkWrongEndBClassifier( ) {
...
/**
     * Creates a retarded intra-partition link with a wrong end B classifier.
