...
/**
 * Tests the creation of a retarded intra-partition link with a wrong end A type
 * in the. This will cause an Exception at the end of the parsing.
 */
@SuppressWarnings( "nls" )
public class ParserHelperApiTestRetardedLinkWrongEndAType extends com.sap.tc.moin.repository.xm.parser.XmParserHandlerAbstract {
     ...
     */
    public ParserHelperApiTestRetardedLinkWrongEndAType( ) {
...
/**
     * Creates a retarded intra-partition link with a wrong end A type.
    ...
    private void testCreateLinkLogicalKey( ) throws XmException {
        ...
        PModelElementHandle logSys = helper.getOrCreateModelElement( LogicalSystem.CLASS_DESCRIPTOR );
        // wrong endBname, retarded link creation
        try {
            helper.createLink( ServiceReferenceAssociation.ASSOCIATION_DESCRIPTOR, "logicalSystem", logSys, ServiceReference.CLASS_DESCRIPTOR, "test" );
            // retarded with cached model element
