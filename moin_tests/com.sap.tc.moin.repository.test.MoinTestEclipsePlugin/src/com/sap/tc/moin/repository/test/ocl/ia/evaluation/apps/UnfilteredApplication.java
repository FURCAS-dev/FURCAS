 ...
 */
public class UnfilteredApplication extends IAApplication {
     ...
     */
    public UnfilteredApplication( CoreConnection connection, Set<OclStatement> statements, boolean evaluate ) throws OclManagerException {
    ...
    public void notify( ChangeEvent event ) {
        ...
        startClock( );
        Set<EvaluationUnit> units = this.ia.filterForClasses( new HashSet<Classifier>( ) );
    ...
    public void initialize( ) throws Exception {
        ...
        this.dataSet.setName( "Unfiltered Application" );
        startClock( );
