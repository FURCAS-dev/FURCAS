...
public final class GeneralTranslatableTextImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.testcasesfoundation.case005f.structurebasedtexts.GeneralTranslatableText
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "testcasesfoundation", "case005f", "structurebasedtexts", "GeneralTranslatableText" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    // default constructor
    public GeneralTranslatableTextImpl() {
        super();
    }
    // JMI constructor
    public GeneralTranslatableTextImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
