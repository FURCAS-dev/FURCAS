...
public final class SpecializedTranslatableTextFragmentImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.testcasesfoundation.case005f.structurebasedtexts.SpecializedTranslatableTextFragment
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "testcasesfoundation", "case005f", "structurebasedtexts", "SpecializedTranslatableTextFragment" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    // default constructor
    public SpecializedTranslatableTextFragmentImpl() {
        super();
    }
    // JMI constructor
    public SpecializedTranslatableTextFragmentImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
