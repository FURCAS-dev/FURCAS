...
public final class B3fImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.testcasesfoundation.case003f.B3f
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "testcasesfoundation", "case003f", "B3f" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    
    private static final java.util.List<String> STRUCTURE_FIELD_NAMES = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "maxWidth", "originalText", "resType", "translate", "transUnitId", "resName", "textName" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    ...
    static {
        ...
        FEATURE_IDS.put("textName", Integer.valueOf(6)); //$NON-NLS-1$
    }
    ...
    // JMI constructor
    public B3fImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
    ...
    private java.lang.String __textName;
    // fields
    ...
    public void initialize___Values(com.sap.tc.moin.repository.core.CoreConnection connection) {
        set__MaxWidth(255);
        set__ResType("B3FResType");
        set__Translate(true);
        set__ResName("B3FResName");
    }
    ...
    public void set__TextName(java.lang.String newValue) {
        __textName = newValue;
    }
    ...
    public void set___Value(String featureName, Object value) {
        switch (FEATURE_IDS.get(featureName)) {
            ...
            case 5:
                ...
                break;
            case 6:
                set__TextName((java.lang.String) value);     
                break;
            default:
