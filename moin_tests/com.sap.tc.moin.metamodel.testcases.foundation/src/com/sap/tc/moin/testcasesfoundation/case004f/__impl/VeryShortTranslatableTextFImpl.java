...
public final class VeryShortTranslatableTextFImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.testcasesfoundation.case004f.VeryShortTranslatableTextF
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "testcasesfoundation", "case004f", "VeryShortTranslatableTextF" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    // default constructor
    public VeryShortTranslatableTextFImpl() {
        super();
    }
    // JMI constructor
    public VeryShortTranslatableTextFImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
