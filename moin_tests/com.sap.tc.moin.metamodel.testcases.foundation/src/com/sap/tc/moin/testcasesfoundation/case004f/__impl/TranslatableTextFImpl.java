...
public final class TranslatableTextFImpl extends com.sap.tc.moin.repository.core.jmi.reflect.RefStructImpl implements com.sap.tc.moin.testcasesfoundation.case004f.TranslatableTextF
{
    private static final long serialVersionUID = 1L;

    private static final java.util.List<String> QUALIFIED_NAME = java.util.Collections.unmodifiableList(java.util.Arrays.asList(new String[] { "testcasesfoundation", "case004f", "TranslatableTextF" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    // default constructor
    public TranslatableTextFImpl() {
        super();
    }
    // JMI constructor
    public TranslatableTextFImpl(java.lang.Object workspace, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject) {
