...
public final class B4Impl extends com.sap.tc.moin.repository.core.jmi.reflect.RefObjectImpl {
    ...
    public B4Impl(java.lang.Object workspace, String mofId, com.sap.tc.moin.repository.mmi.reflect.RefPackage immediatePackage, com.sap.tc.moin.repository.mmi.reflect.RefObject metaObject, com.sap.tc.moin.repository.mmi.reflect.RefClass refClass) {
    ...
    {
          ___changeDataTypeAttribute(get___CurrentConnection(), 0, "45F120A507F88073EE7541B33099AADC74C4A048", __onePrimitive, newValue); //$NON-NLS-1$
    }
    ...
    {
          ___changeDataTypeAttribute(connection, 0, "45F120A507F88073EE7541B33099AADC74C4A048", __onePrimitive, newValue); //$NON-NLS-1$
    }
    ...
    public void refSetValue(com.sap.tc.moin.repository.core.CoreConnection connection, java.lang.String featureName, java.lang.Object value) {
        ...
        switch (featureId) {
            case 0:
                ___changeDataTypeAttribute(connection, 0, "45F120A507F88073EE7541B33099AADC74C4A048", __onePrimitive, value); //$NON-NLS-1$
                break;
    ...
    // create the wrapper
    @Override
    public com.sap.tc.moin.repository.spi.core.Wrapper<com.sap.tc.moin.testcases.case004.__impl.B4Impl> createWrapper(com.sap.tc.moin.repository.core.CoreConnection conn, boolean synchronize) {
        return new com.sap.tc.moin.testcases.case004.__impl.B4Wrapper(conn, this, synchronize);
    }
