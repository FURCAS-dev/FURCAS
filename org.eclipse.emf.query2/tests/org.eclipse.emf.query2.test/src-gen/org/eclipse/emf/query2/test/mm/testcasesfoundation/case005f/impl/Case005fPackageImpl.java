...
import org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.Case005fFactory;
 ...
 * @generated
 */
public class Case005fPackageImpl extends EPackageImpl implements Case005fPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a5fMigrationAttributeTypeTranslatableTextEClass = null;
	 ...
	 * @generated
	 */
	private EClass a5fMigrationAttributeTypeTextEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.Case005fPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case005fPackageImpl() {
		super(eNS_URI, Case005fFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case005fPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case005fPackage init() {
		if (isInited) return (Case005fPackage)EPackage.Registry.INSTANCE.getEPackage(Case005fPackage.eNS_URI);

		// Obtain or create and register package
		Case005fPackageImpl theCase005fPackage = (Case005fPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case005fPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case005fPackageImpl());
		...
		theCase005fPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case005fPackage.eNS_URI, theCase005fPackage);
		return theCase005fPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getA5fMigrationAttributeTypeTranslatableText() {
		return a5fMigrationAttributeTypeTranslatableTextEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getA5fMigrationAttributeTypeTranslatableText_TranslatableText() {
		return (EReference)a5fMigrationAttributeTypeTranslatableTextEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getA5fMigrationAttributeTypeTranslatableText_GeneralTranslatableText() {
		return (EReference)a5fMigrationAttributeTypeTranslatableTextEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getA5fMigrationAttributeTypeTranslatableText_SpecializedTranslatableText() {
		return (EReference)a5fMigrationAttributeTypeTranslatableTextEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getA5fMigrationAttributeTypeText() {
		return a5fMigrationAttributeTypeTextEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getA5fMigrationAttributeTypeText_TranslatableText() {
		return (EReference)a5fMigrationAttributeTypeTextEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getA5fMigrationAttributeTypeText_GeneralText() {
		return (EReference)a5fMigrationAttributeTypeTextEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getA5fMigrationAttributeTypeText_SpecializedText() {
		return (EReference)a5fMigrationAttributeTypeTextEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public Case005fFactory getCase005fFactory() {
		return (Case005fFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		a5fMigrationAttributeTypeTranslatableTextEClass = createEClass(A5F_MIGRATION_ATTRIBUTE_TYPE_TRANSLATABLE_TEXT);
		createEReference(a5fMigrationAttributeTypeTranslatableTextEClass, A5F_MIGRATION_ATTRIBUTE_TYPE_TRANSLATABLE_TEXT__TRANSLATABLE_TEXT);
		createEReference(a5fMigrationAttributeTypeTranslatableTextEClass, A5F_MIGRATION_ATTRIBUTE_TYPE_TRANSLATABLE_TEXT__GENERAL_TRANSLATABLE_TEXT);
		createEReference(a5fMigrationAttributeTypeTranslatableTextEClass, A5F_MIGRATION_ATTRIBUTE_TYPE_TRANSLATABLE_TEXT__SPECIALIZED_TRANSLATABLE_TEXT);

		a5fMigrationAttributeTypeTextEClass = createEClass(A5F_MIGRATION_ATTRIBUTE_TYPE_TEXT);
		createEReference(a5fMigrationAttributeTypeTextEClass, A5F_MIGRATION_ATTRIBUTE_TYPE_TEXT__TRANSLATABLE_TEXT);
		createEReference(a5fMigrationAttributeTypeTextEClass, A5F_MIGRATION_ATTRIBUTE_TYPE_TEXT__GENERAL_TEXT);
		createEReference(a5fMigrationAttributeTypeTextEClass, A5F_MIGRATION_ATTRIBUTE_TYPE_TEXT__SPECIALIZED_TEXT);
	}
	...
	public void initializePackageContents() {
		...
		StructurebasedtextsPackage theStructurebasedtextsPackage = (StructurebasedtextsPackage)EPackage.Registry.INSTANCE.getEPackage(StructurebasedtextsPackage.eNS_URI);
		ClassbasedtextsPackage theClassbasedtextsPackage = (ClassbasedtextsPackage)EPackage.Registry.INSTANCE.getEPackage(ClassbasedtextsPackage.eNS_URI);
		TextverticalizationfPackage theTextverticalizationfPackage = (TextverticalizationfPackage)EPackage.Registry.INSTANCE.getEPackage(TextverticalizationfPackage.eNS_URI);
		TextverticalizationPackage theTextverticalizationPackage = (TextverticalizationPackage)EPackage.Registry.INSTANCE.getEPackage(TextverticalizationPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theStructurebasedtextsPackage);
		getESubpackages().add(theClassbasedtextsPackage);
		getESubpackages().add(theTextverticalizationfPackage);
