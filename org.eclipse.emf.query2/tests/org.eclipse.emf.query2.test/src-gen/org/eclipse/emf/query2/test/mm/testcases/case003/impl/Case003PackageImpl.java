...
import org.eclipse.emf.query2.test.mm.testcases.case003.B3Sub;
import org.eclipse.emf.query2.test.mm.testcases.case003.Case003Factory;
 ...
 * @generated
 */
public class Case003PackageImpl extends EPackageImpl implements Case003Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass b3SubEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case003.Case003Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case003PackageImpl() {
		super(eNS_URI, Case003Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case003Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case003Package init() {
		if (isInited) return (Case003Package)EPackage.Registry.INSTANCE.getEPackage(Case003Package.eNS_URI);

		// Obtain or create and register package
		Case003PackageImpl theCase003Package = (Case003PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case003PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case003PackageImpl());
		...
		theCase003Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case003Package.eNS_URI, theCase003Package);
		return theCase003Package;
	}
	 ...
	 * @generated
	 */
	public EReference getB3_Z() {
		return (EReference)b3EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getD3_RefD3ToY() {
		return (EReference)d3EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Case003Factory getCase003Factory() {
		return (Case003Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(b3EClass, B3__Z);

		c3EClass = createEClass(C3);
		createEReference(c3EClass, C3__Y);

		d3EClass = createEClass(D3);
		createEReference(d3EClass, D3__REF_D3_TO_Y);

		e3EClass = createEClass(E3);

		f3EClass = createEClass(F3);

		b3SubEClass = createEClass(B3_SUB);
	}
	...
	public void initializePackageContents() {
		...
		c3EClass.getESuperTypes().add(this.getA3());
		d3EClass.getESuperTypes().add(this.getA3());
		e3EClass.getESuperTypes().add(this.getD3());
		f3EClass.getESuperTypes().add(this.getC3());
		f3EClass.getESuperTypes().add(this.getE3());
