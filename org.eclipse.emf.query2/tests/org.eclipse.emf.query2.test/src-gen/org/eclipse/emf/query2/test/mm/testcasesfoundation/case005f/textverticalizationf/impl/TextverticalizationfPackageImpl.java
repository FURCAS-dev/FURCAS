...
import org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.textverticalizationf.TextverticalizationfFactory;
 ...
 * @generated
 */
public class TextverticalizationfPackageImpl extends EPackageImpl implements TextverticalizationfPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass textFEClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcasesfoundation.case005f.textverticalizationf.TextverticalizationfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TextverticalizationfPackageImpl() {
		super(eNS_URI, TextverticalizationfFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TextverticalizationfPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TextverticalizationfPackage init() {
		if (isInited) return (TextverticalizationfPackage)EPackage.Registry.INSTANCE.getEPackage(TextverticalizationfPackage.eNS_URI);

		// Obtain or create and register package
		TextverticalizationfPackageImpl theTextverticalizationfPackage = (TextverticalizationfPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TextverticalizationfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TextverticalizationfPackageImpl());
		...
		theTextverticalizationfPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TextverticalizationfPackage.eNS_URI, theTextverticalizationfPackage);
		return theTextverticalizationfPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTextF_MaxWidth() {
		return (EAttribute)textFEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTextF_OriginalText() {
		return (EAttribute)textFEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTextF_ResName() {
		return (EAttribute)textFEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTextF_ResType() {
		return (EAttribute)textFEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTextF_Translate() {
		return (EAttribute)textFEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTextF_TransUnitId() {
		return (EAttribute)textFEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public TextverticalizationfFactory getTextverticalizationfFactory() {
		return (TextverticalizationfFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		textFEClass = createEClass(TEXT_F);
		createEAttribute(textFEClass, TEXT_F__MAX_WIDTH);
		createEAttribute(textFEClass, TEXT_F__ORIGINAL_TEXT);
		createEAttribute(textFEClass, TEXT_F__RES_NAME);
		createEAttribute(textFEClass, TEXT_F__RES_TYPE);
		createEAttribute(textFEClass, TEXT_F__TRANSLATE);
		createEAttribute(textFEClass, TEXT_F__TRANS_UNIT_ID);
	}
...
} //TextverticalizationfPackageImpl
