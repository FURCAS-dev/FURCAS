 ...
 *******************************************************************************/
package org.eclipse.emf.query2.test.mm.testcases.case024.impl;
...
import org.eclipse.emf.query2.test.mm.testcases.case024.Case024Factory;
 ...
 * @generated
 */
public class Case024PackageImpl extends EPackageImpl implements Case024Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass a24EClass = null;
	 ...
	 * @see org.eclipse.emf.query2.test.mm.testcases.case024.Case024Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Case024PackageImpl() {
		super(eNS_URI, Case024Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Case024Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Case024Package init() {
		if (isInited) return (Case024Package)EPackage.Registry.INSTANCE.getEPackage(Case024Package.eNS_URI);

		// Obtain or create and register package
		Case024PackageImpl theCase024Package = (Case024PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Case024PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Case024PackageImpl());
		...
		theCase024Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Case024Package.eNS_URI, theCase024Package);
		return theCase024Package;
	}
	 ...
	 * @generated
	 */
	public Case024Factory getCase024Factory() {
		return (Case024Factory)getEFactoryInstance();
	}
