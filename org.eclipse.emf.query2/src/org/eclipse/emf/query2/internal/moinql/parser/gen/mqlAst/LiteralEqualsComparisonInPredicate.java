...
/**
 *<b>
 *<li>Rule 87:  comparisonPostElementEquals ::= literal
 *</b>
 */
public class LiteralEqualsComparisonInPredicate extends Node implements IcomparisonPostElementEquals
{
    private Iliteral _literal;

    public Iliteral getliteral() { return _literal; }

    public LiteralEqualsComparisonInPredicate(IToken leftIToken, IToken rightIToken,
                                              Iliteral _literal)
    {
