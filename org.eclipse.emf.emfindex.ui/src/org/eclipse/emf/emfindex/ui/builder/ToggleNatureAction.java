...
//				FindInstanceByNameDialog findInstanceByNameDialog = new FindInstanceByNameDialog(Display.getCurrent().getActiveShell(), EcorePackage.Literals.ECLASS, DefaultIndexFactory.createIndex());
//				findInstanceByNameDialog.open();
	}
