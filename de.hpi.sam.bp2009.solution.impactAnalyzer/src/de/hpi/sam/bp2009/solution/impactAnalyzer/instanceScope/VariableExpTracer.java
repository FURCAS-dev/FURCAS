...
public class VariableExpTracer extends AbstractTracer<VariableExp> {
    ...
    private VariableDefiningNavigationStep tracebackOperationParameter(EClass context, PathCache pathCache,
        ...
        for (OperationCallExp call : operationBodyToCallMapper.getCallsOf(rootExpression)) {
            ...
            stepForCall.addEnteringScopes(AbstractTracer.scopeCreatingExpressions(argumentExpression,
                    OclHelper.getRootExpression(argumentExpression), /* inclusive */ true));
        ...
        if (op != null) {
            ...
            for (OperationCallExp call : calls) {
                ...
                stepForCall.addEnteringScopes(AbstractTracer.scopeCreatingExpressions(callSource,
                        OclHelper.getRootExpression(callSource), /* inclusive */ true));
    ...
    protected Set<OCLExpression> calculateLeavingScopes(OperationBodyToCallMapper operationBodyToCallMapper) {
        ...
        if (isLetVariable()) {
            ...
            result = scopeCreatingExpressions(parent, /* inclusive */ true);
            return result;
            ...
            // leaving all scopes
            result = scopeCreatingExpressions(getRootExpression(), /* inclusive */ true);
        } else {
