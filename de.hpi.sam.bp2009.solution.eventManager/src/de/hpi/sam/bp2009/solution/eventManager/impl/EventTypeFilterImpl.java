 ...
 * <ul>
 *   <li>{@link de.hpi.sam.bp2009.solution.eventManager.impl.EventTypeFilterImpl#getFilters <em>Filters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventTypeFilterImpl extends EObjectImpl implements EventTypeFilter {
	...
	protected EventTypeFilterImpl() {
		...
		this.setFilterMatcher(new FilterMatcher() {
			...
			public boolean matchesForFilterType(ModelChangeEvent event,
				...
				if((crit instanceof EClass) && (event.eClass().equals(crit))){
					return true;
				}
				return false;
			}
		...
		if (filters != null && filters.eIsProxy()) {
			...
			if (filters != oldFilters) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventManagerPackage.EVENT_TYPE_FILTER__FILTERS, oldFilters, filters));
			}
		}
		return filters;
	}
	...
	public void setFilters(EventFilter newFilters) {
		...
		filters = newFilters;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventManagerPackage.EVENT_TYPE_FILTER__FILTERS, oldFilters, filters));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventManagerPackage.EVENT_TYPE_FILTER__FILTERS:
