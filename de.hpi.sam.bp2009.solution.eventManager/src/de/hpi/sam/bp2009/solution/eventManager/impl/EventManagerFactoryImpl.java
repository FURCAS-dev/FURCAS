...
public class EventManagerFactoryImpl extends EFactoryImpl implements EventManagerFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EventManagerPackage.NOTIFICATION_IDENTIFIER: return createNotificationIdentifier();
			case EventManagerPackage.NOTIFICATION_IDENTIFIER_BUILDER: return createNotificationIdentifierBuilder();
	...
	public NotificationIdentifier createNotificationIdentifier() {
		NotificationIdentifierImpl notificationIdentifier = new NotificationIdentifierImpl();
	...
	public NotificationIdentifierBuilder createNotificationIdentifierBuilder() {
		NotificationIdentifierBuilderImpl notificationIdentifierBuilder = new NotificationIdentifierBuilderImpl();
