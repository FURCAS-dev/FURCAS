...
public class EventManagerAdapterFactory extends AdapterFactoryImpl {
	...
	protected EventManagerSwitch<Adapter> modelSwitch =
		new EventManagerSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNotificationIdentifier(NotificationIdentifier object) {
				return createNotificationIdentifierAdapter();
			}
			@Override
			public Adapter caseNotificationIdentifierBuilder(NotificationIdentifierBuilder object) {
				return createNotificationIdentifierBuilderAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.eventManager.NotificationIdentifier <em>Notification Identifier</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNotificationIdentifierAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.eventManager.NotificationIdentifierBuilder <em>Notification Identifier Builder</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNotificationIdentifierBuilderAdapter() {
		return null;
	}
