...
public class EventManagerSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EventManagerPackage.NOTIFICATION_IDENTIFIER: {
				NotificationIdentifier notificationIdentifier = (NotificationIdentifier)theEObject;
				T result = caseNotificationIdentifier(notificationIdentifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventManagerPackage.NOTIFICATION_IDENTIFIER_BUILDER: {
				NotificationIdentifierBuilder notificationIdentifierBuilder = (NotificationIdentifierBuilder)theEObject;
				T result = caseNotificationIdentifierBuilder(notificationIdentifierBuilder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Notification Identifier</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Notification Identifier</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNotificationIdentifier(NotificationIdentifier object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Notification Identifier Builder</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Notification Identifier Builder</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNotificationIdentifierBuilder(NotificationIdentifierBuilder object) {
		return null;
	}
