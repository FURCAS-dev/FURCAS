...
public class OclEvaluatorPackageImpl extends EPackageImpl implements OclEvaluatorPackage {
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(oclEvaluatorEClass, null, "evaluate", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theSolutionPackage.getOclQuery(), "queryobject", 0, 1, IS_UNIQUE, IS_ORDERED);
