...
public class SolutionSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SolutionPackage.IMPACT_ANALYZER: {
			...
			case SolutionPackage.OCL_EVALUATOR: {
				OclEvaluator oclEvaluator = (OclEvaluator)theEObject;
				T result = caseOclEvaluator(oclEvaluator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SolutionPackage.PERSISTENZ: {
				Persistenz persistenz = (Persistenz)theEObject;
				T result = casePersistenz(persistenz);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SolutionPackage.EVENT_LISTENER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Persistenz</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Persistenz</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePersistenz(Persistenz object) {
		return null;
	}
