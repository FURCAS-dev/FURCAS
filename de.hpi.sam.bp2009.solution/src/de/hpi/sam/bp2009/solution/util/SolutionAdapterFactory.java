 ...
 * $Id$
 */
package de.hpi.sam.bp2009.solution.util;
...
public class SolutionAdapterFactory extends AdapterFactoryImpl {
	...
	protected SolutionSwitch<Adapter> modelSwitch =
		new SolutionSwitch<Adapter>() {
			@Override
			public Adapter caseExpressionSupplier(ExpressionSupplier object) {
				return createExpressionSupplierAdapter();
			}
			@Override
			...
			@Override
			public Adapter casePersistenz(Persistenz object) {
				return createPersistenzAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.ExpressionSupplier <em>Expression Supplier</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExpressionSupplierAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.ImpactAnalyzer <em>Impact Analyzer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.OclEvaluator <em>Ocl Evaluator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.Persistenz <em>Persistenz</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPersistenzAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.hpi.sam.bp2009.solution.EventListener <em>Event Listener</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
