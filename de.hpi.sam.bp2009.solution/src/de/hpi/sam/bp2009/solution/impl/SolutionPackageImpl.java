...
import de.hpi.sam.bp2009.solution.Persistenz;
...
public class SolutionPackageImpl extends EPackageImpl implements SolutionPackage {
	 ...
	 * @generated
	 */
	private EClass persistenzEClass = null;
	 ...
	 * @generated
	 */
	public EClass getPersistenz() {
		return persistenzEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getPersistenz_EventManager() {
		return (EReference)persistenzEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		persistenzEClass = createEClass(PERSISTENZ);
		createEReference(persistenzEClass, PERSISTENZ__EVENT_MANAGER);
	...
	public void initializePackageContents() {
		...
		impactAnalyzerEClass.getESuperTypes().add(this.getEventListener());
		...
		initEReference(getExpressionSupplier_IA(), this.getImpactAnalyzer(), null, "IA", null, 0, 1, ExpressionSupplier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImpactAnalyzer_OclEvaluator(), this.getOclEvaluator(), null, "oclEvaluator", null, 0, 1, ImpactAnalyzer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEParameter(op, g1, "ExpressionSet", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(persistenzEClass, Persistenz.class, "Persistenz", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPersistenz_EventManager(), theEventManagerPackage.getEventManager(), null, "eventManager", null, 0, 1, Persistenz.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eventListenerEClass, EventListener.class, "EventListener", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(eventListenerEClass, null, "callback", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEventsPackage.getModelChangeEvent(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);

		// Initialize data types
		initEDataType(oclQueryEDataType, AbstractOCLCondition.class, "OclQuery", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
