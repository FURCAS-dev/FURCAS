...
public class OCLstdlib extends XMLResourceImpl
{
	...
	public static Library create()
	{
		...
		ClassifierType symbol_137 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[Real!oclAsType{TT}($ocl!Classifier[TT])?TT]
		
		ClassifierType symbol_138 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[$ocl!OclAny!oclIsKindOf{T}($ocl!Classifier[T])?T]
		
		ClassifierType symbol_139 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[$ocl!Classifier{T}!oclContainer{U}()?U]
		
		ClassifierType symbol_140 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]
		
		ClassifierType symbol_141 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[$ocl!OclAny!oclAsType{TT}($ocl!Classifier[TT])?TT]
		
		ClassifierType symbol_142 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[$ocl!OclSelf]
		
		ClassifierType symbol_143 = PivotFactory.eINSTANCE.createClassifierType(); // $ocl!Classifier[$ocl!OclAny!oclIsTypeOf{T}($ocl!Classifier[T])?T]
		
		CollectionType symbol_144 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!NonUniqueCollection{T}?T]
		
		CollectionType symbol_145 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		
		CollectionType symbol_146 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Set{T}!flatten{T2}()?T2]
		
		CollectionType symbol_147 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!NonOrderedCollection{T}?T]
		
		CollectionType symbol_148 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!OrderedSet{T}?T]
		
		CollectionType symbol_149 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V]
		
		CollectionType symbol_150 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		
		CollectionType symbol_151 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		
		CollectionType symbol_152 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Collection{T}!includesAll{T2}($ocl!Collection[T2])?T2]
		
		CollectionType symbol_153 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Collection{T}!flatten{T2}()?T2]
		
		CollectionType symbol_154 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Bag{T}!flatten{T2}()?T2]
		
		CollectionType symbol_155 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Collection{T}?T]
		
		CollectionType symbol_156 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Set{T}?T]
		
		CollectionType symbol_157 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[String]
		
		CollectionType symbol_158 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Sequence{T}!flatten{T2}()?T2]
		
		CollectionType symbol_159 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!UniqueCollection{T}?T]
		
		CollectionType symbol_160 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!OclSelf]
		
		CollectionType symbol_161 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Sequence{T}?T]
		
		CollectionType symbol_162 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2]
		
		CollectionType symbol_163 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!OclAny]
		
		CollectionType symbol_164 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Bag{T}?T]
		
		CollectionType symbol_165 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!Collection{T}!excludesAll{T2}($ocl!Collection[T2])?T2]
		...
		CollectionType symbol_167 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!Collection[$ocl!OrderedCollection{T}?T]
		...
		LambdaType symbol_169 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!NonUniqueCollection{T}?T()$ocl!OclAny
		
		LambdaType symbol_170 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!Set[T]
		
		LambdaType symbol_171 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!NonOrderedCollection{T}!collectNested{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_172 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_173 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Collection{T}?T()$ocl!OclAny
		
		LambdaType symbol_174 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedSet[T]
		
		LambdaType symbol_175 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Sequence{T}?T()Boolean
		
		LambdaType symbol_176 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Collection{T}?T()Boolean
		...
		LambdaType symbol_178 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!UniqueCollection{T}?T()$ocl!OclAny
		
		LambdaType symbol_179 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Collection{T}?T()$ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_180 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Collection{T}?T()$ocl!Collection{T}!collectNested{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_181 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Bag{T}?T()Boolean
		
		LambdaType symbol_182 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!OrderedSet{T}?T()Boolean
		
		LambdaType symbol_183 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		
		LambdaType symbol_184 = PivotFactory.eINSTANCE.createLambdaType(); // Lambda~$ocl!Set{T}?T()Boolean
		
		CollectionType symbol_185 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!Set{T}!flatten{T2}()?T2]
		
		CollectionType symbol_186 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		
		CollectionType symbol_187 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		
		CollectionType symbol_188 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!OclSelf]
		...
		CollectionType symbol_191 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!OclAny]
		
		CollectionType symbol_192 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!OrderedSet{T}?T]
		
		CollectionType symbol_193 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!Set{T}?T]
		
		CollectionType symbol_194 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonOrderedCollection[$ocl!Collection{T}?T]
		...
		CollectionType symbol_196 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!Bag{T}!flatten{T2}()?T2]
		
		CollectionType symbol_197 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[String]
		
		CollectionType symbol_198 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!NonOrderedCollection{T}?T]
		
		CollectionType symbol_199 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!OrderedCollection{T}?T]
		
		CollectionType symbol_200 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!Sequence{T}?T]
		
		CollectionType symbol_201 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		
		CollectionType symbol_202 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!Sequence{T}!flatten{T2}()?T2]
		
		CollectionType symbol_203 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!Collection{T}?T]
		
		CollectionType symbol_204 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!Bag{T}?T]
		
		CollectionType symbol_205 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!NonUniqueCollection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		
		CollectionType symbol_206 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!NonUniqueCollection{T}?T]
		
		CollectionType symbol_207 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[String]
		
		CollectionType symbol_208 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!UniqueCollection{T}?T]
		
		CollectionType symbol_209 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!Sequence{T}!flatten{T2}()?T2]
		
		CollectionType symbol_210 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!OrderedCollection{T}?T]
		
		CollectionType symbol_211 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		
		CollectionType symbol_212 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!Sequence{T}?T]
		
		CollectionType symbol_213 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!Collection{T}?T]
		
		CollectionType symbol_214 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!OrderedCollection[$ocl!OrderedSet{T}?T]
		...
		OrderedSetType symbol_216 = PivotFactory.eINSTANCE.createOrderedSetType(); // $ocl!OrderedSet[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		...
		OrderedSetType symbol_219 = PivotFactory.eINSTANCE.createOrderedSetType(); // $ocl!OrderedSet[$ocl!UniqueCollection{T}?T]
		
		OrderedSetType symbol_220 = PivotFactory.eINSTANCE.createOrderedSetType(); // $ocl!OrderedSet[$ocl!OrderedCollection{T}?T]
		
		SequenceType symbol_221 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		
		SequenceType symbol_222 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[$ocl!Sequence{T}!flatten{T2}()?T2]
		
		SequenceType symbol_223 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[String]
		
		SequenceType symbol_224 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[$ocl!OrderedCollection{T}?T]
		
		SequenceType symbol_225 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[$ocl!NonUniqueCollection{T}?T]
		
		SequenceType symbol_226 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[$ocl!Collection{T}?T]
		
		SequenceType symbol_227 = PivotFactory.eINSTANCE.createSequenceType(); // $ocl!Sequence[$ocl!Sequence{T}?T]
		
		SetType symbol_228 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!OclAny]
		
		SetType symbol_229 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
		
		SetType symbol_230 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!NonOrderedCollection{T}?T]
		
		SetType symbol_231 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		
		SetType symbol_232 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!Set{T}?T]
		
		SetType symbol_233 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!Collection{T}?T]
		
		SetType symbol_234 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!OrderedSet{T}?T]
		
		SetType symbol_235 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!OclSelf]
		
		SetType symbol_236 = PivotFactory.eINSTANCE.createSetType(); // $ocl!Set[$ocl!Set{T}!flatten{T2}()?T2]
		...
		CollectionType symbol_240 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!OclSelf]
		
		CollectionType symbol_241 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!NonOrderedCollection{T}?T]
		
		CollectionType symbol_242 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!Set{T}?T]
		
		CollectionType symbol_243 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!Collection{T}?T]
		
		CollectionType symbol_244 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!Set{T}!flatten{T2}()?T2]
		
		CollectionType symbol_245 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
		
		CollectionType symbol_246 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		
		CollectionType symbol_247 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!OrderedSet{T}?T]
		
		CollectionType symbol_248 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!OclAny]
		
		CollectionType symbol_249 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		
		CollectionType symbol_250 = PivotFactory.eINSTANCE.createCollectionType(); // $ocl!UniqueCollection[$ocl!OrderedCollection{T}?T]
		...
		symbol_12.getSuperClasses().add(symbol_204); // $ocl!NonUniqueCollection[$ocl!Bag{T}?T]
		...
		{	// ocl::Bag::<>() $ocl!Bag{T}!<>($ocl!OclAny)
			...
			symbol_251.setName("<>");
			//symbol_251.setMoniker("$ocl!Bag{T}!<>($ocl!OclAny)");
			...
			//symbol_252.setMoniker("$ocl!Bag{T}!<>($ocl!OclAny)!object2");
			symbol_252.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Bag::=() $ocl!Bag{T}!=($ocl!OclAny)
			...
			symbol_253.setName("=");
			//symbol_253.setMoniker("$ocl!Bag{T}!=($ocl!OclAny)");
			...
			//symbol_254.setMoniker("$ocl!Bag{T}!=($ocl!OclAny)!object2");
			symbol_254.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Bag::excluding() $ocl!Bag{T}!excluding($ocl!OclAny)
			...
			symbol_255.setType(symbol_134);  // $ocl!Bag[$ocl!Bag{T}?T]
		...
		{	// ocl::Bag::including() $ocl!Bag{T}!including(T)
			...
			symbol_258.setType(symbol_134);  // $ocl!Bag[$ocl!Bag{T}?T]
		...
		{	// ocl::Bag::reject() $ocl!Bag{T}!reject(T|Lambda~T()Boolean)
			...
			symbol_260.setType(symbol_134);  // $ocl!Bag[$ocl!Bag{T}?T]
			...
			symbol_262.setType(symbol_181);  // Lambda~$ocl!Bag{T}?T()Boolean
		...
		{	// ocl::Bag::select() $ocl!Bag{T}!select(T|Lambda~T()Boolean)
			...
			symbol_263.setType(symbol_134);  // $ocl!Bag[$ocl!Bag{T}?T]
			...
			symbol_265.setType(symbol_181);  // Lambda~$ocl!Bag{T}?T()Boolean
		...
		{	// ocl::Boolean::<>() Boolean!<>($ocl!OclAny)
			...
			symbol_266.setName("<>");
			//symbol_266.setMoniker("Boolean!<>($ocl!OclAny)");
			...
			//symbol_267.setMoniker("Boolean!<>($ocl!OclAny)!object2");
			symbol_267.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Boolean::=() Boolean!=($ocl!OclAny)
			...
			symbol_268.setName("=");
			//symbol_268.setMoniker("Boolean!=($ocl!OclAny)");
			...
			//symbol_269.setMoniker("Boolean!=($ocl!OclAny)!object2");
			symbol_269.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Classifier::oclContainer() $ocl!Classifier{T}!oclContainer{U}()
			...
			symbol_282.setType(symbol_139);  // $ocl!Classifier[$ocl!Classifier{T}!oclContainer{U}()?U]
		...
		{	// ocl::Classifier::oclContents() $ocl!Classifier{T}!oclContents{U}()
			...
			symbol_283.setType(symbol_231);  // $ocl!Set[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		...
		{	// ocl::Collection::<>() $ocl!Collection{T}!<>($ocl!OclAny)
			...
			symbol_284.setName("<>");
			//symbol_284.setMoniker("$ocl!Collection{T}!<>($ocl!OclAny)");
			...
			//symbol_285.setMoniker("$ocl!Collection{T}!<>($ocl!OclAny)!object2");
			symbol_285.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Collection::=() $ocl!Collection{T}!=($ocl!OclAny)
			...
			symbol_286.setName("=");
			//symbol_286.setMoniker("$ocl!Collection{T}!=($ocl!OclAny)");
			...
			//symbol_287.setMoniker("$ocl!Collection{T}!=($ocl!OclAny)!object2");
			symbol_287.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Collection::any() $ocl!Collection{T}!any(T|Lambda~T()Boolean)
			...
			symbol_290.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::asBag() $ocl!Collection{T}!asBag()
			...
			symbol_291.setType(symbol_133);  // $ocl!Bag[$ocl!Collection{T}?T]
		...
		{	// ocl::Collection::asSet() $ocl!Collection{T}!asSet()
			...
			symbol_294.setType(symbol_233);  // $ocl!Set[$ocl!Collection{T}?T]
		...
		{	// ocl::Collection::collect() $ocl!Collection{T}!collect{V}(T|Lambda~T()V)
			...
			symbol_295.setType(symbol_149);  // $ocl!Collection[$ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V]
			...
			symbol_297.setType(symbol_179);  // Lambda~$ocl!Collection{T}?T()$ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V
		...
		{	// ocl::Collection::collectNested() $ocl!Collection{T}!collectNested{V}(T|Lambda~T()V)
			...
			symbol_298.setType(symbol_155);  // $ocl!Collection[$ocl!Collection{T}?T]
			...
			symbol_300.setType(symbol_180);  // Lambda~$ocl!Collection{T}?T()$ocl!Collection{T}!collectNested{V}(T|Lambda~T()V)?V
		...
		{	// ocl::Collection::excludesAll() $ocl!Collection{T}!excludesAll{T2}($ocl!Collection[T2])
			...
			symbol_306.setType(symbol_165);  // $ocl!Collection[$ocl!Collection{T}!excludesAll{T2}($ocl!Collection[T2])?T2]
		...
		{	// ocl::Collection::excluding() $ocl!Collection{T}!excluding($ocl!OclAny)
			...
			symbol_307.setType(symbol_155);  // $ocl!Collection[$ocl!Collection{T}?T]
		...
		{	// ocl::Collection::exists() $ocl!Collection{T}!exists(T|Lambda~T()Boolean)
			...
			symbol_311.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::exists() $ocl!Collection{T}!exists(T,T|Lambda~T()Boolean)
			...
			symbol_315.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::flatten() $ocl!Collection{T}!flatten{T2}()
			...
			symbol_316.setType(symbol_153);  // $ocl!Collection[$ocl!Collection{T}!flatten{T2}()?T2]
		...
		{	// ocl::Collection::forAll() $ocl!Collection{T}!forAll(T|Lambda~T()Boolean)
			...
			symbol_319.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::forAll() $ocl!Collection{T}!forAll(T,T|Lambda~T()Boolean)
			...
			symbol_323.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::includesAll() $ocl!Collection{T}!includesAll{T2}($ocl!Collection[T2])
			...
			symbol_327.setType(symbol_152);  // $ocl!Collection[$ocl!Collection{T}!includesAll{T2}($ocl!Collection[T2])?T2]
		...
		{	// ocl::Collection::including() $ocl!Collection{T}!including(T)
			...
			symbol_328.setType(symbol_155);  // $ocl!Collection[$ocl!Collection{T}?T]
		...
		{	// ocl::Collection::isUnique() $ocl!Collection{T}!isUnique(T|Lambda~T()$ocl!OclAny)
			...
			symbol_333.setType(symbol_173);  // Lambda~$ocl!Collection{T}?T()$ocl!OclAny
		...
		{	// ocl::Collection::one() $ocl!Collection{T}!one(T|Lambda~T()Boolean)
			...
			symbol_342.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::product() $ocl!Collection{T}!product{T2}($ocl!Collection[T2])
			...
			symbol_343.setType(symbol_229);  // $ocl!Set[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
			...
			symbol_344.setType(symbol_162);  // $ocl!Collection[$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2]
		...
		{	// ocl::Collection::reject() $ocl!Collection{T}!reject(T|Lambda~T()Boolean)
			...
			symbol_345.setType(symbol_155);  // $ocl!Collection[$ocl!Collection{T}?T]
			...
			symbol_347.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::select() $ocl!Collection{T}!select(T|Lambda~T()Boolean)
			...
			symbol_348.setType(symbol_155);  // $ocl!Collection[$ocl!Collection{T}?T]
			...
			symbol_350.setType(symbol_176);  // Lambda~$ocl!Collection{T}?T()Boolean
		...
		{	// ocl::Collection::sortedBy() $ocl!Collection{T}!sortedBy(T|Lambda~T()$ocl!OclAny)
			...
			symbol_352.setType(symbol_213);  // $ocl!OrderedCollection[$ocl!Collection{T}?T]
			...
			symbol_354.setType(symbol_173);  // Lambda~$ocl!Collection{T}?T()$ocl!OclAny
		...
		symbol_57.getSuperClasses().add(symbol_147); // $ocl!Collection[$ocl!NonOrderedCollection{T}?T]
		{	// ocl::NonOrderedCollection::closure() $ocl!NonOrderedCollection{T}!closure(T|Lambda~T()$ocl!Set[T])
			...
			symbol_376.setType(symbol_230);  // $ocl!Set[$ocl!NonOrderedCollection{T}?T]
			...
			symbol_378.setType(symbol_170);  // Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!Set[T]
		...
		{	// ocl::NonOrderedCollection::collect() $ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)
			...
			symbol_379.setType(symbol_135);  // $ocl!Bag[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
			...
			symbol_381.setType(symbol_172);  // Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		...
		{	// ocl::NonOrderedCollection::collectNested() $ocl!NonOrderedCollection{T}!collectNested{V}(T|Lambda~T()V)
			...
			symbol_382.setType(symbol_136);  // $ocl!Bag[$ocl!NonOrderedCollection{T}?T]
			...
			symbol_384.setType(symbol_171);  // Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!NonOrderedCollection{T}!collectNested{V}(T|Lambda~T()V)?V
		...
		{	// ocl::NonOrderedCollection::intersection() $ocl!NonOrderedCollection{T}!intersection($ocl!Bag[T])
			...
			symbol_385.setType(symbol_136);  // $ocl!Bag[$ocl!NonOrderedCollection{T}?T]
			...
			symbol_386.setType(symbol_136);  // $ocl!Bag[$ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::intersection() $ocl!NonOrderedCollection{T}!intersection($ocl!Set[T])
			...
			symbol_387.setType(symbol_230);  // $ocl!Set[$ocl!NonOrderedCollection{T}?T]
			...
			symbol_388.setType(symbol_230);  // $ocl!Set[$ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::union() $ocl!NonOrderedCollection{T}!union($ocl!Bag[T])
			...
			symbol_389.setType(symbol_136);  // $ocl!Bag[$ocl!NonOrderedCollection{T}?T]
			...
			symbol_390.setType(symbol_136);  // $ocl!Bag[$ocl!NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::union() $ocl!NonOrderedCollection{T}!union($ocl!Set[T])
			...
			symbol_391.setType(symbol_230);  // $ocl!Set[$ocl!NonOrderedCollection{T}?T]
			...
			symbol_392.setType(symbol_230);  // $ocl!Set[$ocl!NonOrderedCollection{T}?T]
		...
		symbol_67.getSuperClasses().add(symbol_144); // $ocl!Collection[$ocl!NonUniqueCollection{T}?T]
		{	// ocl::NonUniqueCollection::sortedBy() $ocl!NonUniqueCollection{T}!sortedBy(T|Lambda~T()$ocl!OclAny)
			...
			symbol_393.setType(symbol_225);  // $ocl!Sequence[$ocl!NonUniqueCollection{T}?T]
			...
			symbol_395.setType(symbol_169);  // Lambda~$ocl!NonUniqueCollection{T}?T()$ocl!OclAny
		...
		{	// ocl::OclAny::<>() $ocl!OclAny!<>($ocl!OclAny)
			...
			symbol_396.setName("<>");
			//symbol_396.setMoniker("$ocl!OclAny!<>($ocl!OclAny)");
			...
			//symbol_397.setMoniker("$ocl!OclAny!<>($ocl!OclAny)!object2");
			symbol_397.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclAny::=() $ocl!OclAny!=($ocl!OclAny)
			...
			symbol_398.setName("=");
			//symbol_398.setMoniker("$ocl!OclAny!=($ocl!OclAny)");
			...
			//symbol_399.setMoniker("$ocl!OclAny!=($ocl!OclAny)!object2");
			symbol_399.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclAny::oclAsType() $ocl!OclAny!oclAsType{TT}($ocl!Classifier[TT])
			...
			symbol_402.setType(symbol_141);  // $ocl!Classifier[$ocl!OclAny!oclAsType{TT}($ocl!Classifier[TT])?TT]
		...
		{	// ocl::OclAny::oclIsKindOf() $ocl!OclAny!oclIsKindOf{T}($ocl!Classifier[T])
			...
			symbol_407.setType(symbol_138);  // $ocl!Classifier[$ocl!OclAny!oclIsKindOf{T}($ocl!Classifier[T])?T]
		...
		{	// ocl::OclAny::oclIsTypeOf() $ocl!OclAny!oclIsTypeOf{T}($ocl!Classifier[T])
			...
			symbol_410.setType(symbol_143);  // $ocl!Classifier[$ocl!OclAny!oclIsTypeOf{T}($ocl!Classifier[T])?T]
		...
		{	// ocl::OclAny::oclType() $ocl!OclAny!oclType()
			...
			symbol_412.setType(symbol_142);  // $ocl!Classifier[$ocl!OclSelf]
		...
		{	// ocl::OclInvalid::<>() $ocl!OclInvalid!<>($ocl!OclAny)
			...
			symbol_413.setName("<>");
			//symbol_413.setMoniker("$ocl!OclInvalid!<>($ocl!OclAny)");
			...
			//symbol_414.setMoniker("$ocl!OclInvalid!<>($ocl!OclAny)!object2");
			symbol_414.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclInvalid::=() $ocl!OclInvalid!=($ocl!OclAny)
			...
			symbol_415.setName("=");
			//symbol_415.setMoniker("$ocl!OclInvalid!=($ocl!OclAny)");
			...
			//symbol_416.setMoniker("$ocl!OclInvalid!=($ocl!OclAny)!object2");
			symbol_416.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclTuple::<>() $ocl!OclTuple!<>($ocl!OclAny)
			...
			symbol_424.setName("<>");
			//symbol_424.setMoniker("$ocl!OclTuple!<>($ocl!OclAny)");
			...
			//symbol_425.setMoniker("$ocl!OclTuple!<>($ocl!OclAny)!object2");
			symbol_425.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclTuple::=() $ocl!OclTuple!=($ocl!OclAny)
			...
			symbol_426.setName("=");
			//symbol_426.setMoniker("$ocl!OclTuple!=($ocl!OclAny)");
			...
			//symbol_427.setMoniker("$ocl!OclTuple!=($ocl!OclAny)!object2");
			symbol_427.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclVoid::<>() $ocl!OclVoid!<>($ocl!OclAny)
			...
			symbol_428.setName("<>");
			//symbol_428.setMoniker("$ocl!OclVoid!<>($ocl!OclAny)");
			...
			//symbol_429.setMoniker("$ocl!OclVoid!<>($ocl!OclAny)!object2");
			symbol_429.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OclVoid::=() $ocl!OclVoid!=($ocl!OclAny)
			...
			symbol_430.setName("=");
			//symbol_430.setMoniker("$ocl!OclVoid!=($ocl!OclAny)");
			...
			//symbol_431.setMoniker("$ocl!OclVoid!=($ocl!OclAny)!object2");
			symbol_431.setType(symbol_71);  // $ocl!OclAny
		...
		symbol_88.getSuperClasses().add(symbol_167); // $ocl!Collection[$ocl!OrderedCollection{T}?T]
		...
		{	// ocl::OrderedCollection::closure() $ocl!OrderedCollection{T}!closure(T|Lambda~T()$ocl!OrderedSet[T])
			...
			symbol_442.setType(symbol_220);  // $ocl!OrderedSet[$ocl!OrderedCollection{T}?T]
			...
			symbol_444.setType(symbol_174);  // Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedSet[T]
		...
		{	// ocl::OrderedCollection::collect() $ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)
			...
			symbol_445.setType(symbol_221);  // $ocl!Sequence[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
			...
			symbol_447.setType(symbol_183);  // Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V
		...
		{	// ocl::OrderedCollection::collectNested() $ocl!OrderedCollection{T}!collectNested{V}(T|Lambda~T()V)
			...
			symbol_450.setType(symbol_177);  // Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedCollection{T}!collectNested{V}(T|Lambda~T()V)?V
		...
		{	// ocl::OrderedCollection::reverse() $ocl!OrderedCollection{T}!reverse()
			...
			symbol_455.setType(symbol_210);  // $ocl!OrderedCollection[$ocl!OrderedCollection{T}?T]
		...
		symbol_98.getSuperClasses().add(symbol_247); // $ocl!UniqueCollection[$ocl!OrderedSet{T}?T]
		symbol_98.getSuperClasses().add(symbol_214); // $ocl!OrderedCollection[$ocl!OrderedSet{T}?T]
		{	// ocl::OrderedSet::-() $ocl!OrderedSet{T}!-($ocl!Set[$ocl!OclAny])
			...
			symbol_456.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
			...
			symbol_457.setType(symbol_228);  // $ocl!Set[$ocl!OclAny]
		...
		{	// ocl::OrderedSet::<>() $ocl!OrderedSet{T}!<>($ocl!OclAny)
			...
			symbol_458.setName("<>");
			//symbol_458.setMoniker("$ocl!OrderedSet{T}!<>($ocl!OclAny)");
			...
			//symbol_459.setMoniker("$ocl!OrderedSet{T}!<>($ocl!OclAny)!object2");
			symbol_459.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OrderedSet::=() $ocl!OrderedSet{T}!=($ocl!OclAny)
			...
			symbol_460.setName("=");
			//symbol_460.setMoniker("$ocl!OrderedSet{T}!=($ocl!OclAny)");
			...
			//symbol_461.setMoniker("$ocl!OrderedSet{T}!=($ocl!OclAny)!object2");
			symbol_461.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::OrderedSet::append() $ocl!OrderedSet{T}!append(T)
			...
			symbol_462.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::excluding() $ocl!OrderedSet{T}!excluding($ocl!OclAny)
			...
			symbol_464.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::flatten() $ocl!OrderedSet{T}!flatten{T2}()
			...
			symbol_466.setType(symbol_216);  // $ocl!OrderedSet[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		...
		{	// ocl::OrderedSet::including() $ocl!OrderedSet{T}!including(T)
			...
			symbol_467.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::intersection() $ocl!OrderedSet{T}!intersection($ocl!Set[T])
			...
			symbol_472.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
			...
			symbol_473.setType(symbol_234);  // $ocl!Set[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::prepend() $ocl!OrderedSet{T}!prepend(T)
			...
			symbol_474.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::reject() $ocl!OrderedSet{T}!reject(T|Lambda~T()Boolean)
			...
			symbol_476.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::reverse() $ocl!OrderedSet{T}!reverse()
			...
			symbol_479.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::subOrderedSet() $ocl!OrderedSet{T}!subOrderedSet(Integer,Integer)
			...
			symbol_483.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::symmetricDifference() $ocl!OrderedSet{T}!symmetricDifference($ocl!Set[$ocl!OclAny])
			...
			symbol_487.setType(symbol_228);  // $ocl!Set[$ocl!OclAny]
		...
		{	// ocl::OrderedSet::union() $ocl!OrderedSet{T}!union($ocl!OrderedSet[T])
			...
			symbol_488.setType(symbol_217);  // $ocl!OrderedSet[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::union() $ocl!OrderedSet{T}!union($ocl!Set[T])
			...
			symbol_490.setType(symbol_234);  // $ocl!Set[$ocl!OrderedSet{T}?T]
			...
			symbol_491.setType(symbol_234);  // $ocl!Set[$ocl!OrderedSet{T}?T]
		...
		{	// ocl::Real::<() Real!<(Real)
			...
			symbol_502.setType(symbol_105);  // Real
		...
		{	// ocl::Real::<=() Real!<=(Real)
			...
			symbol_504.setType(symbol_105);  // Real
		...
		{	// ocl::Real::<>() Real!<>($ocl!OclAny)
			...
			symbol_505.setName("<>");
			//symbol_505.setMoniker("Real!<>($ocl!OclAny)");
			...
			//symbol_506.setMoniker("Real!<>($ocl!OclAny)!object2");
			symbol_506.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Real::=() Real!=($ocl!OclAny)
			...
			symbol_507.setName("=");
			//symbol_507.setMoniker("Real!=($ocl!OclAny)");
			...
			//symbol_508.setMoniker("Real!=($ocl!OclAny)!object2");
			symbol_508.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Real::>() Real!>(Real)
			...
			symbol_510.setType(symbol_105);  // Real
		...
		{	// ocl::Real::oclAsType() Real!oclAsType{TT}($ocl!Classifier[TT])
			...
			symbol_520.setType(symbol_137);  // $ocl!Classifier[Real!oclAsType{TT}($ocl!Classifier[TT])?TT]
		...
		symbol_109.getSuperClasses().add(symbol_200); // $ocl!NonUniqueCollection[$ocl!Sequence{T}?T]
		symbol_109.getSuperClasses().add(symbol_212); // $ocl!OrderedCollection[$ocl!Sequence{T}?T]
		{	// ocl::Sequence::<>() $ocl!Sequence{T}!<>($ocl!OclAny)
			Operation symbol_523 = PivotFactory.eINSTANCE.createOperation();
			symbol_523.setName("<>");
			//symbol_523.setMoniker("$ocl!Sequence{T}!<>($ocl!OclAny)");
			...
			//symbol_524.setMoniker("$ocl!Sequence{T}!<>($ocl!OclAny)!object2");
			symbol_524.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Sequence::=() $ocl!Sequence{T}!=($ocl!OclAny)
			...
			symbol_525.setName("=");
			//symbol_525.setMoniker("$ocl!Sequence{T}!=($ocl!OclAny)");
			...
			//symbol_526.setMoniker("$ocl!Sequence{T}!=($ocl!OclAny)!object2");
			symbol_526.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Sequence::append() $ocl!Sequence{T}!append(T)
			...
			symbol_527.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::excluding() $ocl!Sequence{T}!excluding($ocl!OclAny)
			...
			symbol_529.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::including() $ocl!Sequence{T}!including(T)
			...
			symbol_532.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::insertAt() $ocl!Sequence{T}!insertAt(Integer,T)
			...
			symbol_534.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::prepend() $ocl!Sequence{T}!prepend(T)
			...
			symbol_537.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::reject() $ocl!Sequence{T}!reject(T|Lambda~T()Boolean)
			...
			symbol_539.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
			...
			symbol_541.setType(symbol_175);  // Lambda~$ocl!Sequence{T}?T()Boolean
		...
		{	// ocl::Sequence::reverse() $ocl!Sequence{T}!reverse()
			...
			symbol_542.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::select() $ocl!Sequence{T}!select(T|Lambda~T()Boolean)
			...
			symbol_543.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
			...
			symbol_545.setType(symbol_175);  // Lambda~$ocl!Sequence{T}?T()Boolean
		...
		{	// ocl::Sequence::subSequence() $ocl!Sequence{T}!subSequence(Integer,Integer)
			...
			symbol_546.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		{	// ocl::Sequence::union() $ocl!Sequence{T}!union($ocl!Sequence[T])
			...
			symbol_549.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
			...
			symbol_550.setType(symbol_227);  // $ocl!Sequence[$ocl!Sequence{T}?T]
		...
		symbol_116.getSuperClasses().add(symbol_242); // $ocl!UniqueCollection[$ocl!Set{T}?T]
		symbol_116.getSuperClasses().add(symbol_193); // $ocl!NonOrderedCollection[$ocl!Set{T}?T]
		{	// ocl::Set::-() $ocl!Set{T}!-($ocl!Set[$ocl!OclAny])
			...
			symbol_551.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
			...
			symbol_552.setType(symbol_228);  // $ocl!Set[$ocl!OclAny]
		...
		{	// ocl::Set::<>() $ocl!Set{T}!<>($ocl!OclAny)
			...
			symbol_553.setName("<>");
			//symbol_553.setMoniker("$ocl!Set{T}!<>($ocl!OclAny)");
			...
			//symbol_554.setMoniker("$ocl!Set{T}!<>($ocl!OclAny)!object2");
			symbol_554.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Set::=() $ocl!Set{T}!=($ocl!OclAny)
			...
			symbol_555.setName("=");
			//symbol_555.setMoniker("$ocl!Set{T}!=($ocl!OclAny)");
			...
			//symbol_556.setMoniker("$ocl!Set{T}!=($ocl!OclAny)!object2");
			symbol_556.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::Set::excluding() $ocl!Set{T}!excluding($ocl!OclAny)
			...
			symbol_557.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
		...
		{	// ocl::Set::flatten() $ocl!Set{T}!flatten{T2}()
			...
			symbol_559.setType(symbol_236);  // $ocl!Set[$ocl!Set{T}!flatten{T2}()?T2]
		...
		{	// ocl::Set::including() $ocl!Set{T}!including(T)
			...
			symbol_560.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
		...
		{	// ocl::Set::intersection() $ocl!Set{T}!intersection($ocl!Set[T])
			...
			symbol_562.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
			...
			symbol_563.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
		...
		{	// ocl::Set::reject() $ocl!Set{T}!reject(T|Lambda~T()Boolean)
			...
			symbol_564.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
			...
			symbol_566.setType(symbol_184);  // Lambda~$ocl!Set{T}?T()Boolean
		...
		{	// ocl::Set::select() $ocl!Set{T}!select(T|Lambda~T()Boolean)
			...
			symbol_567.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
			...
			symbol_569.setType(symbol_184);  // Lambda~$ocl!Set{T}?T()Boolean
		...
		{	// ocl::Set::symmetricDifference() $ocl!Set{T}!symmetricDifference($ocl!Set[$ocl!OclAny])
			...
			symbol_570.setType(symbol_232);  // $ocl!Set[$ocl!Set{T}?T]
			...
			symbol_571.setType(symbol_228);  // $ocl!Set[$ocl!OclAny]
		...
		{	// ocl::String::<() String!<(String)
			...
			symbol_575.setType(symbol_123);  // String
		...
		{	// ocl::String::<>() String!<>($ocl!OclAny)
			...
			symbol_578.setName("<>");
			//symbol_578.setMoniker("String!<>($ocl!OclAny)");
			...
			//symbol_579.setMoniker("String!<>($ocl!OclAny)!object2");
			symbol_579.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::String::=() String!=($ocl!OclAny)
			...
			symbol_580.setName("=");
			//symbol_580.setMoniker("String!=($ocl!OclAny)");
			...
			//symbol_581.setMoniker("String!=($ocl!OclAny)!object2");
			symbol_581.setType(symbol_71);  // $ocl!OclAny
		...
		{	// ocl::String::>() String!>(String)
			...
			symbol_583.setType(symbol_123);  // String
		...
		{	// ocl::String::characters() String!characters()
			...
			symbol_588.setType(symbol_223);  // $ocl!Sequence[String]
		...
		symbol_125.getSuperClasses().add(symbol_159); // $ocl!Collection[$ocl!UniqueCollection{T}?T]
		{	// ocl::UniqueCollection::sortedBy() $ocl!UniqueCollection{T}!sortedBy(T|Lambda~T()$ocl!OclAny)
			...
			symbol_607.setType(symbol_219);  // $ocl!OrderedSet[$ocl!UniqueCollection{T}?T]
			...
			symbol_609.setType(symbol_178);  // Lambda~$ocl!UniqueCollection{T}?T()$ocl!OclAny
		...
		symbol_132.getSuperClasses().add(symbol_196); // $ocl!NonUniqueCollection[$ocl!Bag{T}!flatten{T2}()?T2]
		symbol_132.getSuperClasses().add(symbol_190); // $ocl!NonOrderedCollection[$ocl!Bag{T}!flatten{T2}()?T2]
		...
		symbol_133.setElementType(symbol_33);
		symbol_133.setUnspecializedElement(symbol_12);
		{
			...
			symbol_612.setSignature(symbol_13);
			{
				...
				symbol_613.setActual(symbol_33);	
				symbol_612.getParameterSubstitutions().add(symbol_613);
			}
			symbol_133.getTemplateBindings().add(symbol_612);
		}
		symbol_133.getSuperClasses().add(symbol_203); // $ocl!NonUniqueCollection[$ocl!Collection{T}?T]
		symbol_133.getSuperClasses().add(symbol_194); // $ocl!NonOrderedCollection[$ocl!Collection{T}?T]
		...
		symbol_134.setUnspecializedElement(symbol_12);
		{
			...
			symbol_614.setSignature(symbol_13);
			{
				...
				symbol_615.setActual(symbol_15);	
				symbol_614.getParameterSubstitutions().add(symbol_615);
			}
			symbol_134.getTemplateBindings().add(symbol_614);
		}
		symbol_134.getSuperClasses().add(symbol_204); // $ocl!NonUniqueCollection[$ocl!Bag{T}?T]
		symbol_134.getSuperClasses().add(symbol_189); // $ocl!NonOrderedCollection[$ocl!Bag{T}?T]
		...
		symbol_135.setElementType(symbol_63);
		symbol_135.setUnspecializedElement(symbol_12);
		{
			...
			symbol_616.setSignature(symbol_13);
			{
				...
				symbol_617.setActual(symbol_63);	
				symbol_616.getParameterSubstitutions().add(symbol_617);
			}
			symbol_135.getTemplateBindings().add(symbol_616);
		}
		symbol_135.getSuperClasses().add(symbol_186); // $ocl!NonOrderedCollection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		symbol_135.getSuperClasses().add(symbol_201); // $ocl!NonUniqueCollection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		...
		symbol_136.setElementType(symbol_60);
		symbol_136.setUnspecializedElement(symbol_12);
		{
			...
			symbol_618.setSignature(symbol_13);
			{
				...
				symbol_619.setActual(symbol_60);	
				symbol_618.getParameterSubstitutions().add(symbol_619);
			}
			symbol_136.getTemplateBindings().add(symbol_618);
		}
		symbol_136.getSuperClasses().add(symbol_57); // $ocl!NonOrderedCollection{T}
		symbol_136.getSuperClasses().add(symbol_198); // $ocl!NonUniqueCollection[$ocl!NonOrderedCollection{T}?T]
		...
		//symbol_137.setMoniker("$ocl!Classifier[Real!oclAsType{TT}($ocl!Classifier[TT])?TT]");
		symbol_137.setInstanceType(symbol_108);
		symbol_137.setUnspecializedElement(symbol_20);
		{
			...
			symbol_620.setSignature(symbol_21);
			{
				...
				symbol_621.setActual(symbol_108);	
		...
		//symbol_138.setMoniker("$ocl!Classifier[$ocl!OclAny!oclIsKindOf{T}($ocl!Classifier[T])?T]");
		symbol_138.setInstanceType(symbol_77);
		symbol_138.setUnspecializedElement(symbol_20);
		{
			...
			symbol_622.setSignature(symbol_21);
			{
				...
				symbol_623.setActual(symbol_77);	
		...
		//symbol_139.setMoniker("$ocl!Classifier[$ocl!Classifier{T}!oclContainer{U}()?U]");
		symbol_139.setInstanceType(symbol_26);
		symbol_139.setUnspecializedElement(symbol_20);
		{
			...
			symbol_624.setSignature(symbol_21);
			{
				...
				symbol_625.setActual(symbol_26);	
		...
		//symbol_140.setMoniker("$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]");
		symbol_140.setInstanceType(symbol_29);
		symbol_140.setUnspecializedElement(symbol_20);
		{
			...
			symbol_626.setSignature(symbol_21);
			{
				...
				symbol_627.setActual(symbol_29);	
		...
		//symbol_141.setMoniker("$ocl!Classifier[$ocl!OclAny!oclAsType{TT}($ocl!Classifier[TT])?TT]");
		symbol_141.setInstanceType(symbol_74);
		symbol_141.setUnspecializedElement(symbol_20);
		{
			...
			symbol_628.setSignature(symbol_21);
			{
				...
				symbol_629.setActual(symbol_74);	
		...
		symbol_142.setInstanceType(symbol_84);
		symbol_142.setUnspecializedElement(symbol_20);
		{
			...
			symbol_630.setSignature(symbol_21);
			{
				...
				symbol_631.setActual(symbol_84);	
		...
		//symbol_143.setMoniker("$ocl!Classifier[$ocl!OclAny!oclIsTypeOf{T}($ocl!Classifier[T])?T]");
		symbol_143.setInstanceType(symbol_80);
		symbol_143.setUnspecializedElement(symbol_20);
		{
			...
			symbol_632.setSignature(symbol_21);
			{
				...
				symbol_633.setActual(symbol_80);	
		...
		//symbol_144.setMoniker("$ocl!Collection[$ocl!NonUniqueCollection{T}?T]");
		symbol_144.setElementType(symbol_70);
		symbol_144.setUnspecializedElement(symbol_30);
		{
			...
			symbol_634.setSignature(symbol_31);
			{
				...
				symbol_635.setActual(symbol_70);	
		...
		//symbol_145.setMoniker("$ocl!Collection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_145.setElementType(symbol_94);
		symbol_145.setUnspecializedElement(symbol_30);
		{
			...
			symbol_636.setSignature(symbol_31);
			{
				...
				symbol_637.setActual(symbol_94);	
		...
		//symbol_146.setMoniker("$ocl!Collection[$ocl!Set{T}!flatten{T2}()?T2]");
		symbol_146.setElementType(symbol_122);
		symbol_146.setUnspecializedElement(symbol_30);
		{
			...
			symbol_638.setSignature(symbol_31);
			{
				...
				symbol_639.setActual(symbol_122);	
		...
		//symbol_147.setMoniker("$ocl!Collection[$ocl!NonOrderedCollection{T}?T]");
		symbol_147.setElementType(symbol_60);
		symbol_147.setUnspecializedElement(symbol_30);
		{
			...
			symbol_640.setSignature(symbol_31);
			{
				...
				symbol_641.setActual(symbol_60);	
		...
		//symbol_148.setMoniker("$ocl!Collection[$ocl!OrderedSet{T}?T]");
		symbol_148.setElementType(symbol_101);
		symbol_148.setUnspecializedElement(symbol_30);
		{
			...
			symbol_642.setSignature(symbol_31);
			{
				...
				symbol_643.setActual(symbol_101);	
		...
		//symbol_149.setMoniker("$ocl!Collection[$ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_149.setElementType(symbol_36);
		symbol_149.setUnspecializedElement(symbol_30);
		{
			...
			symbol_644.setSignature(symbol_31);
			{
				...
				symbol_645.setActual(symbol_36);	
		...
		//symbol_150.setMoniker("$ocl!Collection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]");
		symbol_150.setElementType(symbol_140);
		symbol_150.setUnspecializedElement(symbol_30);
		{
			...
			symbol_646.setSignature(symbol_31);
			{
				...
				symbol_647.setActual(symbol_140);	
		...
		//symbol_151.setMoniker("$ocl!Collection[$ocl!OrderedSet{T}!flatten{T2}()?T2]");
		symbol_151.setElementType(symbol_104);
		symbol_151.setUnspecializedElement(symbol_30);
		{
			...
			symbol_648.setSignature(symbol_31);
			{
				...
				symbol_649.setActual(symbol_104);	
		...
		//symbol_152.setMoniker("$ocl!Collection[$ocl!Collection{T}!includesAll{T2}($ocl!Collection[T2])?T2]");
		symbol_152.setElementType(symbol_48);
		symbol_152.setUnspecializedElement(symbol_30);
		{
			...
			symbol_650.setSignature(symbol_31);
			{
				...
				symbol_651.setActual(symbol_48);	
		...
		//symbol_153.setMoniker("$ocl!Collection[$ocl!Collection{T}!flatten{T2}()?T2]");
		...
		symbol_153.setUnspecializedElement(symbol_30);
		{
			...
			symbol_652.setSignature(symbol_31);
			{
				...
				symbol_653.setActual(symbol_45);	
		...
		//symbol_154.setMoniker("$ocl!Collection[$ocl!Bag{T}!flatten{T2}()?T2]");
		symbol_154.setElementType(symbol_18);
		symbol_154.setUnspecializedElement(symbol_30);
		{
			...
			symbol_654.setSignature(symbol_31);
			{
				...
				symbol_655.setActual(symbol_18);	
		...
		//symbol_155.setMoniker("$ocl!Collection[$ocl!Collection{T}?T]");
		symbol_155.setElementType(symbol_33);
		symbol_155.setUnspecializedElement(symbol_30);
		{
			...
			symbol_656.setSignature(symbol_31);
			{
				...
				symbol_657.setActual(symbol_33);	
		...
		//symbol_156.setMoniker("$ocl!Collection[$ocl!Set{T}?T]");
		symbol_156.setElementType(symbol_119);
		symbol_156.setUnspecializedElement(symbol_30);
		{
			...
			symbol_658.setSignature(symbol_31);
			{
				...
				symbol_659.setActual(symbol_119);	
		...
		//symbol_157.setMoniker("$ocl!Collection[String]");
		symbol_157.setElementType(symbol_123);
		symbol_157.setUnspecializedElement(symbol_30);
		{
			...
			symbol_660.setSignature(symbol_31);
			{
				...
				symbol_661.setActual(symbol_123);	
		...
		//symbol_158.setMoniker("$ocl!Collection[$ocl!Sequence{T}!flatten{T2}()?T2]");
		symbol_158.setElementType(symbol_115);
		symbol_158.setUnspecializedElement(symbol_30);
		{
			...
			symbol_662.setSignature(symbol_31);
			{
				...
				symbol_663.setActual(symbol_115);	
		...
		symbol_159.setElementType(symbol_128);
		symbol_159.setUnspecializedElement(symbol_30);
		{
			...
			symbol_664.setSignature(symbol_31);
			{
				...
				symbol_665.setActual(symbol_128);	
		...
		//symbol_160.setMoniker("$ocl!Collection[$ocl!OclSelf]");
		...
		symbol_160.setUnspecializedElement(symbol_30);
		{
			...
			symbol_666.setSignature(symbol_31);
			{
				...
				symbol_667.setActual(symbol_84);	
		...
		//symbol_161.setMoniker("$ocl!Collection[$ocl!Sequence{T}?T]");
		symbol_161.setElementType(symbol_112);
		symbol_161.setUnspecializedElement(symbol_30);
		{
			...
			symbol_668.setSignature(symbol_31);
			{
				...
				symbol_669.setActual(symbol_112);	
		...
		//symbol_162.setMoniker("$ocl!Collection[$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2]");
		symbol_162.setElementType(symbol_54);
		symbol_162.setUnspecializedElement(symbol_30);
		{
			...
			symbol_670.setSignature(symbol_31);
			{
				...
				symbol_671.setActual(symbol_54);	
		...
		//symbol_163.setMoniker("$ocl!Collection[$ocl!OclAny]");
		...
		symbol_163.setUnspecializedElement(symbol_30);
		{
			...
			symbol_672.setSignature(symbol_31);
			{
				...
				symbol_673.setActual(symbol_71);	
		...
		//symbol_164.setMoniker("$ocl!Collection[$ocl!Bag{T}?T]");
		...
		symbol_164.setUnspecializedElement(symbol_30);
		{
			...
			symbol_674.setSignature(symbol_31);
			{
				...
				symbol_675.setActual(symbol_15);	
		...
		//symbol_165.setMoniker("$ocl!Collection[$ocl!Collection{T}!excludesAll{T2}($ocl!Collection[T2])?T2]");
		symbol_165.setElementType(symbol_42);
		symbol_165.setUnspecializedElement(symbol_30);
		{
			...
			symbol_676.setSignature(symbol_31);
			{
				...
				symbol_677.setActual(symbol_42);	
		...
		symbol_166.setElementType(symbol_63);
		symbol_166.setUnspecializedElement(symbol_30);
		{
			...
			symbol_678.setSignature(symbol_31);
			{
				...
				symbol_679.setActual(symbol_63);	
		...
		//symbol_167.setMoniker("$ocl!Collection[$ocl!OrderedCollection{T}?T]");
		symbol_167.setElementType(symbol_91);
		symbol_167.setUnspecializedElement(symbol_30);
		{
			...
			symbol_680.setSignature(symbol_31);
			{
				...
				symbol_681.setActual(symbol_91);	
		...
		symbol_168.setElementType(symbol_237);
		symbol_168.setUnspecializedElement(symbol_30);
		{
			...
			symbol_682.setSignature(symbol_31);
			{
				...
				symbol_683.setActual(symbol_237);	
		...
		//symbol_169.setMoniker("Lambda~$ocl!NonUniqueCollection{T}?T()$ocl!OclAny");
		symbol_169.setContextType(symbol_70);
		symbol_169.setResultType(symbol_71);
		symbol_130.getOwnedTypes().add(symbol_169);
		//
		// ocl::$$::Lambda Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!Set[T]
		//
		symbol_170.setName("Lambda");
		//symbol_170.setMoniker("Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!Set[T]");
		symbol_170.setContextType(symbol_60);
		symbol_170.setResultType(symbol_230);
		...
		//symbol_171.setMoniker("Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!NonOrderedCollection{T}!collectNested{V}(T|Lambda~T()V)?V");
		symbol_171.setContextType(symbol_60);
		symbol_171.setResultType(symbol_66);
		...
		//symbol_172.setMoniker("Lambda~$ocl!NonOrderedCollection{T}?T()$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V");
		symbol_172.setContextType(symbol_60);
		symbol_172.setResultType(symbol_63);
		symbol_130.getOwnedTypes().add(symbol_172);
		//
		// ocl::$$::Lambda Lambda~$ocl!Collection{T}?T()$ocl!OclAny
		//
		symbol_173.setName("Lambda");
		//symbol_173.setMoniker("Lambda~$ocl!Collection{T}?T()$ocl!OclAny");
		symbol_173.setContextType(symbol_33);
		symbol_173.setResultType(symbol_71);
		...
		//symbol_174.setMoniker("Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedSet[T]");
		symbol_174.setContextType(symbol_91);
		symbol_174.setResultType(symbol_220);
		symbol_130.getOwnedTypes().add(symbol_174);
		//
		// ocl::$$::Lambda Lambda~$ocl!Sequence{T}?T()Boolean
		//
		symbol_175.setName("Lambda");
		//symbol_175.setMoniker("Lambda~$ocl!Sequence{T}?T()Boolean");
		symbol_175.setContextType(symbol_112);
		...
		//symbol_176.setMoniker("Lambda~$ocl!Collection{T}?T()Boolean");
		symbol_176.setContextType(symbol_33);
		...
		symbol_177.setContextType(symbol_91);
		symbol_177.setResultType(symbol_97);
		symbol_130.getOwnedTypes().add(symbol_177);
		//
		// ocl::$$::Lambda Lambda~$ocl!UniqueCollection{T}?T()$ocl!OclAny
		//
		symbol_178.setName("Lambda");
		//symbol_178.setMoniker("Lambda~$ocl!UniqueCollection{T}?T()$ocl!OclAny");
		symbol_178.setContextType(symbol_128);
		symbol_178.setResultType(symbol_71);
		...
		//symbol_179.setMoniker("Lambda~$ocl!Collection{T}?T()$ocl!Collection{T}!collect{V}(T|Lambda~T()V)?V");
		...
		//symbol_180.setMoniker("Lambda~$ocl!Collection{T}?T()$ocl!Collection{T}!collectNested{V}(T|Lambda~T()V)?V");
		symbol_180.setContextType(symbol_33);
		symbol_180.setResultType(symbol_39);
		symbol_130.getOwnedTypes().add(symbol_180);
		//
		// ocl::$$::Lambda Lambda~$ocl!Bag{T}?T()Boolean
		//
		symbol_181.setName("Lambda");
		//symbol_181.setMoniker("Lambda~$ocl!Bag{T}?T()Boolean");
		symbol_181.setContextType(symbol_15);
		symbol_181.setResultType(symbol_19);
		...
		//symbol_183.setMoniker("Lambda~$ocl!OrderedCollection{T}?T()$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V");
		symbol_183.setContextType(symbol_91);
		symbol_183.setResultType(symbol_94);
		symbol_130.getOwnedTypes().add(symbol_183);
		//
		// ocl::$$::Lambda Lambda~$ocl!Set{T}?T()Boolean
		//
		symbol_184.setName("Lambda");
		//symbol_184.setMoniker("Lambda~$ocl!Set{T}?T()Boolean");
		symbol_184.setContextType(symbol_119);
		symbol_184.setResultType(symbol_19);
		...
		//symbol_185.setMoniker("$ocl!NonOrderedCollection[$ocl!Set{T}!flatten{T2}()?T2]");
		symbol_185.setElementType(symbol_122);
		symbol_185.setUnspecializedElement(symbol_57);
		{
			...
			symbol_684.setSignature(symbol_58);
			{
				...
				symbol_685.setActual(symbol_122);	
				symbol_684.getParameterSubstitutions().add(symbol_685);
			}
			symbol_185.getTemplateBindings().add(symbol_684);
		}
		symbol_185.getSuperClasses().add(symbol_146); // $ocl!Collection[$ocl!Set{T}!flatten{T2}()?T2]
		...
		//symbol_186.setMoniker("$ocl!NonOrderedCollection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_186.setElementType(symbol_63);
		symbol_186.setUnspecializedElement(symbol_57);
		{
			...
			symbol_686.setSignature(symbol_58);
			{
				...
				symbol_687.setActual(symbol_63);	
				symbol_686.getParameterSubstitutions().add(symbol_687);
			}
			symbol_186.getTemplateBindings().add(symbol_686);
		}
		symbol_186.getSuperClasses().add(symbol_166); // $ocl!Collection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		...
		//symbol_187.setMoniker("$ocl!NonOrderedCollection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]");
		symbol_187.setElementType(symbol_140);
		symbol_187.setUnspecializedElement(symbol_57);
		{
			...
			symbol_688.setSignature(symbol_58);
			{
				...
				symbol_689.setActual(symbol_140);	
				symbol_688.getParameterSubstitutions().add(symbol_689);
			}
			symbol_187.getTemplateBindings().add(symbol_688);
		}
		symbol_187.getSuperClasses().add(symbol_150); // $ocl!Collection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		...
		//symbol_188.setMoniker("$ocl!NonOrderedCollection[$ocl!OclSelf]");
		...
		symbol_188.setUnspecializedElement(symbol_57);
		{
			...
			symbol_690.setSignature(symbol_58);
			{
				...
				symbol_691.setActual(symbol_84);	
				symbol_690.getParameterSubstitutions().add(symbol_691);
			}
			symbol_188.getTemplateBindings().add(symbol_690);
		}
		symbol_188.getSuperClasses().add(symbol_160); // $ocl!Collection[$ocl!OclSelf]
		...
		symbol_189.getSuperClasses().add(symbol_164); // $ocl!Collection[$ocl!Bag{T}?T]
		...
		symbol_190.setUnspecializedElement(symbol_57);
		{
			...
			symbol_694.setSignature(symbol_58);
			{
				...
				symbol_695.setActual(symbol_18);	
				symbol_694.getParameterSubstitutions().add(symbol_695);
			}
			symbol_190.getTemplateBindings().add(symbol_694);
		}
		symbol_190.getSuperClasses().add(symbol_154); // $ocl!Collection[$ocl!Bag{T}!flatten{T2}()?T2]
		...
		//symbol_191.setMoniker("$ocl!NonOrderedCollection[$ocl!OclAny]");
		symbol_191.setElementType(symbol_71);
		...
		symbol_191.getSuperClasses().add(symbol_163); // $ocl!Collection[$ocl!OclAny]
		...
		//symbol_192.setMoniker("$ocl!NonOrderedCollection[$ocl!OrderedSet{T}?T]");
		...
		symbol_192.setUnspecializedElement(symbol_57);
		{
			...
			symbol_698.setSignature(symbol_58);
			{
				...
				symbol_699.setActual(symbol_101);	
				symbol_698.getParameterSubstitutions().add(symbol_699);
			}
			symbol_192.getTemplateBindings().add(symbol_698);
		}
		symbol_192.getSuperClasses().add(symbol_148); // $ocl!Collection[$ocl!OrderedSet{T}?T]
		...
		//symbol_193.setMoniker("$ocl!NonOrderedCollection[$ocl!Set{T}?T]");
		symbol_193.setElementType(symbol_119);
		symbol_193.setUnspecializedElement(symbol_57);
		{
			...
			symbol_700.setSignature(symbol_58);
			{
				...
				symbol_701.setActual(symbol_119);	
				symbol_700.getParameterSubstitutions().add(symbol_701);
			}
			symbol_193.getTemplateBindings().add(symbol_700);
		}
		symbol_193.getSuperClasses().add(symbol_156); // $ocl!Collection[$ocl!Set{T}?T]
		...
		//symbol_194.setMoniker("$ocl!NonOrderedCollection[$ocl!Collection{T}?T]");
		symbol_194.setElementType(symbol_33);
		...
		symbol_195.setElementType(symbol_237);
		symbol_195.setUnspecializedElement(symbol_57);
		{
			...
			symbol_704.setSignature(symbol_58);
			{
				...
				symbol_705.setActual(symbol_237);	
				symbol_704.getParameterSubstitutions().add(symbol_705);
			}
			symbol_195.getTemplateBindings().add(symbol_704);
		}
		symbol_195.getSuperClasses().add(symbol_168); // $ocl!Collection[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
		...
		//symbol_196.setMoniker("$ocl!NonUniqueCollection[$ocl!Bag{T}!flatten{T2}()?T2]");
		symbol_196.setElementType(symbol_18);
		...
		symbol_196.getSuperClasses().add(symbol_154); // $ocl!Collection[$ocl!Bag{T}!flatten{T2}()?T2]
		...
		//symbol_197.setMoniker("$ocl!NonUniqueCollection[String]");
		symbol_197.setElementType(symbol_123);
		...
		//symbol_198.setMoniker("$ocl!NonUniqueCollection[$ocl!NonOrderedCollection{T}?T]");
		symbol_198.setElementType(symbol_60);
		symbol_198.setUnspecializedElement(symbol_67);
		{
			...
			symbol_710.setSignature(symbol_68);
			{
				...
				symbol_711.setActual(symbol_60);	
				symbol_710.getParameterSubstitutions().add(symbol_711);
			}
			symbol_198.getTemplateBindings().add(symbol_710);
		}
		symbol_198.getSuperClasses().add(symbol_147); // $ocl!Collection[$ocl!NonOrderedCollection{T}?T]
		...
		//symbol_199.setMoniker("$ocl!NonUniqueCollection[$ocl!OrderedCollection{T}?T]");
		...
		symbol_199.setUnspecializedElement(symbol_67);
		{
			...
			symbol_712.setSignature(symbol_68);
			{
				...
				symbol_713.setActual(symbol_91);	
				symbol_712.getParameterSubstitutions().add(symbol_713);
			}
			symbol_199.getTemplateBindings().add(symbol_712);
		}
		symbol_199.getSuperClasses().add(symbol_167); // $ocl!Collection[$ocl!OrderedCollection{T}?T]
		...
		//symbol_200.setMoniker("$ocl!NonUniqueCollection[$ocl!Sequence{T}?T]");
		symbol_200.setElementType(symbol_112);
		symbol_200.setUnspecializedElement(symbol_67);
		{
			...
			symbol_714.setSignature(symbol_68);
			{
				...
				symbol_715.setActual(symbol_112);	
				symbol_714.getParameterSubstitutions().add(symbol_715);
			}
			symbol_200.getTemplateBindings().add(symbol_714);
		}
		symbol_200.getSuperClasses().add(symbol_161); // $ocl!Collection[$ocl!Sequence{T}?T]
		...
		//symbol_201.setMoniker("$ocl!NonUniqueCollection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_201.setElementType(symbol_63);
		symbol_201.setUnspecializedElement(symbol_67);
		{
			...
			symbol_716.setSignature(symbol_68);
			{
				...
				symbol_717.setActual(symbol_63);	
				symbol_716.getParameterSubstitutions().add(symbol_717);
			}
			symbol_201.getTemplateBindings().add(symbol_716);
		}
		symbol_201.getSuperClasses().add(symbol_166); // $ocl!Collection[$ocl!NonOrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		...
		//symbol_202.setMoniker("$ocl!NonUniqueCollection[$ocl!Sequence{T}!flatten{T2}()?T2]");
		symbol_202.setElementType(symbol_115);
		symbol_202.setUnspecializedElement(symbol_67);
		{
			...
			symbol_718.setSignature(symbol_68);
			{
				...
				symbol_719.setActual(symbol_115);	
				symbol_718.getParameterSubstitutions().add(symbol_719);
			}
			symbol_202.getTemplateBindings().add(symbol_718);
		}
		symbol_202.getSuperClasses().add(symbol_158); // $ocl!Collection[$ocl!Sequence{T}!flatten{T2}()?T2]
		...
		//symbol_203.setMoniker("$ocl!NonUniqueCollection[$ocl!Collection{T}?T]");
		symbol_203.setElementType(symbol_33);
		...
		symbol_203.getSuperClasses().add(symbol_30); // $ocl!Collection{T}
		...
		//symbol_204.setMoniker("$ocl!NonUniqueCollection[$ocl!Bag{T}?T]");
		symbol_204.setElementType(symbol_15);
		symbol_204.setUnspecializedElement(symbol_67);
		{
			...
			symbol_722.setSignature(symbol_68);
			{
				...
				symbol_723.setActual(symbol_15);	
				symbol_722.getParameterSubstitutions().add(symbol_723);
			}
			symbol_204.getTemplateBindings().add(symbol_722);
		}
		symbol_204.getSuperClasses().add(symbol_164); // $ocl!Collection[$ocl!Bag{T}?T]
		...
		//symbol_205.setMoniker("$ocl!NonUniqueCollection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_205.setElementType(symbol_94);
		symbol_205.setUnspecializedElement(symbol_67);
		{
			...
			symbol_724.setSignature(symbol_68);
			{
				...
				symbol_725.setActual(symbol_94);	
				symbol_724.getParameterSubstitutions().add(symbol_725);
			}
			symbol_205.getTemplateBindings().add(symbol_724);
		}
		symbol_205.getSuperClasses().add(symbol_145); // $ocl!Collection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		...
		symbol_206.setUnspecializedElement(symbol_88);
		{
			...
			symbol_726.setSignature(symbol_89);
			{
				...
				symbol_727.setActual(symbol_70);	
				symbol_726.getParameterSubstitutions().add(symbol_727);
			}
			symbol_206.getTemplateBindings().add(symbol_726);
		}
		symbol_206.getSuperClasses().add(symbol_144); // $ocl!Collection[$ocl!NonUniqueCollection{T}?T]
		...
		//symbol_207.setMoniker("$ocl!OrderedCollection[String]");
		symbol_207.setElementType(symbol_123);
		...
		//symbol_208.setMoniker("$ocl!OrderedCollection[$ocl!UniqueCollection{T}?T]");
		symbol_208.setElementType(symbol_128);
		symbol_208.setUnspecializedElement(symbol_88);
		{
			...
			symbol_730.setSignature(symbol_89);
			{
				...
				symbol_731.setActual(symbol_128);	
				symbol_730.getParameterSubstitutions().add(symbol_731);
			}
			symbol_208.getTemplateBindings().add(symbol_730);
		}
		symbol_208.getSuperClasses().add(symbol_159); // $ocl!Collection[$ocl!UniqueCollection{T}?T]
		...
		//symbol_209.setMoniker("$ocl!OrderedCollection[$ocl!Sequence{T}!flatten{T2}()?T2]");
		symbol_209.setElementType(symbol_115);
		symbol_209.setUnspecializedElement(symbol_88);
		{
			...
			symbol_732.setSignature(symbol_89);
			{
				...
				symbol_733.setActual(symbol_115);	
				symbol_732.getParameterSubstitutions().add(symbol_733);
			}
			symbol_209.getTemplateBindings().add(symbol_732);
		}
		symbol_209.getSuperClasses().add(symbol_158); // $ocl!Collection[$ocl!Sequence{T}!flatten{T2}()?T2]
		...
		symbol_210.setElementType(symbol_91);
		symbol_210.setUnspecializedElement(symbol_88);
		{
			...
			symbol_734.setSignature(symbol_89);
			{
				...
				symbol_735.setActual(symbol_91);	
				symbol_734.getParameterSubstitutions().add(symbol_735);
			}
			symbol_210.getTemplateBindings().add(symbol_734);
		}
		symbol_210.getSuperClasses().add(symbol_167); // $ocl!Collection[$ocl!OrderedCollection{T}?T]
		...
		//symbol_211.setMoniker("$ocl!OrderedCollection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_211.setElementType(symbol_94);
		symbol_211.setUnspecializedElement(symbol_88);
		{
			...
			symbol_736.setSignature(symbol_89);
			{
				...
				symbol_737.setActual(symbol_94);	
				symbol_736.getParameterSubstitutions().add(symbol_737);
			}
			symbol_211.getTemplateBindings().add(symbol_736);
		}
		symbol_211.getSuperClasses().add(symbol_145); // $ocl!Collection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		...
		//symbol_212.setMoniker("$ocl!OrderedCollection[$ocl!Sequence{T}?T]");
		symbol_212.setElementType(symbol_112);
		symbol_212.setUnspecializedElement(symbol_88);
		{
			...
			symbol_738.setSignature(symbol_89);
			{
				...
				symbol_739.setActual(symbol_112);	
				symbol_738.getParameterSubstitutions().add(symbol_739);
			}
			symbol_212.getTemplateBindings().add(symbol_738);
		}
		symbol_212.getSuperClasses().add(symbol_161); // $ocl!Collection[$ocl!Sequence{T}?T]
		...
		//symbol_213.setMoniker("$ocl!OrderedCollection[$ocl!Collection{T}?T]");
		symbol_213.setElementType(symbol_33);
		...
		//symbol_214.setMoniker("$ocl!OrderedCollection[$ocl!OrderedSet{T}?T]");
		...
		symbol_214.setUnspecializedElement(symbol_88);
		{
			...
			symbol_742.setSignature(symbol_89);
			{
				...
				symbol_743.setActual(symbol_101);	
				symbol_742.getParameterSubstitutions().add(symbol_743);
			}
			symbol_214.getTemplateBindings().add(symbol_742);
		}
		symbol_214.getSuperClasses().add(symbol_148); // $ocl!Collection[$ocl!OrderedSet{T}?T]
		...
		symbol_215.getSuperClasses().add(symbol_151); // $ocl!Collection[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		...
		//symbol_216.setMoniker("$ocl!OrderedSet[$ocl!OrderedSet{T}!flatten{T2}()?T2]");
		symbol_216.setElementType(symbol_104);
		symbol_216.setUnspecializedElement(symbol_98);
		{
			...
			symbol_746.setSignature(symbol_99);
			{
				...
				symbol_747.setActual(symbol_104);	
				symbol_746.getParameterSubstitutions().add(symbol_747);
			}
			symbol_216.getTemplateBindings().add(symbol_746);
		}
		symbol_216.getSuperClasses().add(symbol_215); // $ocl!OrderedCollection[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		symbol_216.getSuperClasses().add(symbol_246); // $ocl!UniqueCollection[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		...
		symbol_217.setElementType(symbol_101);
		symbol_217.setUnspecializedElement(symbol_98);
		{
			...
			symbol_748.setSignature(symbol_99);
			{
				...
				symbol_749.setActual(symbol_101);	
				symbol_748.getParameterSubstitutions().add(symbol_749);
			}
			symbol_217.getTemplateBindings().add(symbol_748);
		}
		symbol_217.getSuperClasses().add(symbol_247); // $ocl!UniqueCollection[$ocl!OrderedSet{T}?T]
		symbol_217.getSuperClasses().add(symbol_214); // $ocl!OrderedCollection[$ocl!OrderedSet{T}?T]
		...
		symbol_218.getSuperClasses().add(symbol_213); // $ocl!OrderedCollection[$ocl!Collection{T}?T]
		symbol_218.getSuperClasses().add(symbol_243); // $ocl!UniqueCollection[$ocl!Collection{T}?T]
		...
		//symbol_219.setMoniker("$ocl!OrderedSet[$ocl!UniqueCollection{T}?T]");
		symbol_219.setElementType(symbol_128);
		symbol_219.setUnspecializedElement(symbol_98);
		{
			...
			symbol_752.setSignature(symbol_99);
			{
				...
				symbol_753.setActual(symbol_128);	
				symbol_752.getParameterSubstitutions().add(symbol_753);
			}
			symbol_219.getTemplateBindings().add(symbol_752);
		}
		symbol_219.getSuperClasses().add(symbol_125); // $ocl!UniqueCollection{T}
		symbol_219.getSuperClasses().add(symbol_208); // $ocl!OrderedCollection[$ocl!UniqueCollection{T}?T]
		...
		//symbol_220.setMoniker("$ocl!OrderedSet[$ocl!OrderedCollection{T}?T]");
		symbol_220.setElementType(symbol_91);
		symbol_220.setUnspecializedElement(symbol_98);
		{
			...
			symbol_754.setSignature(symbol_99);
			{
				...
				symbol_755.setActual(symbol_91);	
				symbol_754.getParameterSubstitutions().add(symbol_755);
			}
			symbol_220.getTemplateBindings().add(symbol_754);
		}
		symbol_220.getSuperClasses().add(symbol_250); // $ocl!UniqueCollection[$ocl!OrderedCollection{T}?T]
		symbol_220.getSuperClasses().add(symbol_88); // $ocl!OrderedCollection{T}
		...
		//symbol_221.setMoniker("$ocl!Sequence[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]");
		symbol_221.setElementType(symbol_94);
		symbol_221.setUnspecializedElement(symbol_109);
		{
			...
			symbol_756.setSignature(symbol_110);
			{
				...
				symbol_757.setActual(symbol_94);	
				symbol_756.getParameterSubstitutions().add(symbol_757);
			}
			symbol_221.getTemplateBindings().add(symbol_756);
		}
		symbol_221.getSuperClasses().add(symbol_205); // $ocl!NonUniqueCollection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		symbol_221.getSuperClasses().add(symbol_211); // $ocl!OrderedCollection[$ocl!OrderedCollection{T}!collect{V}(T|Lambda~T()V)?V]
		...
		symbol_222.getSuperClasses().add(symbol_202); // $ocl!NonUniqueCollection[$ocl!Sequence{T}!flatten{T2}()?T2]
		symbol_222.getSuperClasses().add(symbol_209); // $ocl!OrderedCollection[$ocl!Sequence{T}!flatten{T2}()?T2]
		symbol_130.getOwnedTypes().add(symbol_222);
		//
		// ocl::$$::Sequence $ocl!Sequence[String]
		//
		symbol_223.setName("Sequence");
		//symbol_223.setMoniker("$ocl!Sequence[String]");
		symbol_223.setElementType(symbol_123);
		symbol_223.setUnspecializedElement(symbol_109);
		{
			...
			symbol_760.setSignature(symbol_110);
			{
				...
				symbol_761.setActual(symbol_123);	
				symbol_760.getParameterSubstitutions().add(symbol_761);
			}
			symbol_223.getTemplateBindings().add(symbol_760);
		}
		symbol_223.getSuperClasses().add(symbol_197); // $ocl!NonUniqueCollection[String]
		symbol_223.getSuperClasses().add(symbol_207); // $ocl!OrderedCollection[String]
		...
		symbol_224.getSuperClasses().add(symbol_199); // $ocl!NonUniqueCollection[$ocl!OrderedCollection{T}?T]
		...
		//symbol_225.setMoniker("$ocl!Sequence[$ocl!NonUniqueCollection{T}?T]");
		symbol_225.setElementType(symbol_70);
		symbol_225.setUnspecializedElement(symbol_109);
		{
			...
			symbol_764.setSignature(symbol_110);
			{
				...
				symbol_765.setActual(symbol_70);	
				symbol_764.getParameterSubstitutions().add(symbol_765);
			}
			symbol_225.getTemplateBindings().add(symbol_764);
		}
		symbol_225.getSuperClasses().add(symbol_206); // $ocl!OrderedCollection[$ocl!NonUniqueCollection{T}?T]
		symbol_225.getSuperClasses().add(symbol_67); // $ocl!NonUniqueCollection{T}
		...
		symbol_226.getSuperClasses().add(symbol_203); // $ocl!NonUniqueCollection[$ocl!Collection{T}?T]
		symbol_226.getSuperClasses().add(symbol_213); // $ocl!OrderedCollection[$ocl!Collection{T}?T]
		symbol_130.getOwnedTypes().add(symbol_226);
		//
		// ocl::$$::Sequence $ocl!Sequence[$ocl!Sequence{T}?T]
		//
		symbol_227.setName("Sequence");
		//symbol_227.setMoniker("$ocl!Sequence[$ocl!Sequence{T}?T]");
		symbol_227.setElementType(symbol_112);
		symbol_227.setUnspecializedElement(symbol_109);
		{
			...
			symbol_768.setSignature(symbol_110);
			{
				...
				symbol_769.setActual(symbol_112);	
				symbol_768.getParameterSubstitutions().add(symbol_769);
			}
			symbol_227.getTemplateBindings().add(symbol_768);
		}
		symbol_227.getSuperClasses().add(symbol_200); // $ocl!NonUniqueCollection[$ocl!Sequence{T}?T]
		symbol_227.getSuperClasses().add(symbol_212); // $ocl!OrderedCollection[$ocl!Sequence{T}?T]
		...
		symbol_228.setUnspecializedElement(symbol_116);
		{
			...
			symbol_770.setSignature(symbol_117);
			{
				...
				symbol_771.setActual(symbol_71);	
				symbol_770.getParameterSubstitutions().add(symbol_771);
			}
			symbol_228.getTemplateBindings().add(symbol_770);
		}
		symbol_228.getSuperClasses().add(symbol_191); // $ocl!NonOrderedCollection[$ocl!OclAny]
		symbol_228.getSuperClasses().add(symbol_248); // $ocl!UniqueCollection[$ocl!OclAny]
		...
		//symbol_229.setMoniker("$ocl!Set[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]");
		symbol_229.setElementType(symbol_237);
		symbol_229.setUnspecializedElement(symbol_116);
		{
			...
			symbol_772.setSignature(symbol_117);
			{
				...
				symbol_773.setActual(symbol_237);	
				symbol_772.getParameterSubstitutions().add(symbol_773);
			}
			symbol_229.getTemplateBindings().add(symbol_772);
		}
		symbol_229.getSuperClasses().add(symbol_195); // $ocl!NonOrderedCollection[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
		symbol_229.getSuperClasses().add(symbol_245); // $ocl!UniqueCollection[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
		symbol_130.getOwnedTypes().add(symbol_229);
		//
		// ocl::$$::Set $ocl!Set[$ocl!NonOrderedCollection{T}?T]
		//
		symbol_230.setName("Set");
		//symbol_230.setMoniker("$ocl!Set[$ocl!NonOrderedCollection{T}?T]");
		symbol_230.setElementType(symbol_60);
		symbol_230.setUnspecializedElement(symbol_116);
		{
			...
			symbol_774.setSignature(symbol_117);
			{
				...
				symbol_775.setActual(symbol_60);	
				symbol_774.getParameterSubstitutions().add(symbol_775);
			}
			symbol_230.getTemplateBindings().add(symbol_774);
		}
		symbol_230.getSuperClasses().add(symbol_57); // $ocl!NonOrderedCollection{T}
		symbol_230.getSuperClasses().add(symbol_241); // $ocl!UniqueCollection[$ocl!NonOrderedCollection{T}?T]
		...
		//symbol_231.setMoniker("$ocl!Set[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]");
		symbol_231.setElementType(symbol_140);
		symbol_231.setUnspecializedElement(symbol_116);
		{
			...
			symbol_776.setSignature(symbol_117);
			{
				...
				symbol_777.setActual(symbol_140);	
				symbol_776.getParameterSubstitutions().add(symbol_777);
			}
			symbol_231.getTemplateBindings().add(symbol_776);
		}
		symbol_231.getSuperClasses().add(symbol_187); // $ocl!NonOrderedCollection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		symbol_231.getSuperClasses().add(symbol_249); // $ocl!UniqueCollection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		symbol_130.getOwnedTypes().add(symbol_231);
		//
		// ocl::$$::Set $ocl!Set[$ocl!Set{T}?T]
		//
		symbol_232.setName("Set");
		//symbol_232.setMoniker("$ocl!Set[$ocl!Set{T}?T]");
		symbol_232.setElementType(symbol_119);
		symbol_232.setUnspecializedElement(symbol_116);
		{
			...
			symbol_778.setSignature(symbol_117);
			{
				...
				symbol_779.setActual(symbol_119);	
				symbol_778.getParameterSubstitutions().add(symbol_779);
			}
			symbol_232.getTemplateBindings().add(symbol_778);
		}
		symbol_232.getSuperClasses().add(symbol_242); // $ocl!UniqueCollection[$ocl!Set{T}?T]
		symbol_232.getSuperClasses().add(symbol_193); // $ocl!NonOrderedCollection[$ocl!Set{T}?T]
		symbol_130.getOwnedTypes().add(symbol_232);
		//
		// ocl::$$::Set $ocl!Set[$ocl!Collection{T}?T]
		//
		symbol_233.setName("Set");
		//symbol_233.setMoniker("$ocl!Set[$ocl!Collection{T}?T]");
		...
		symbol_233.setUnspecializedElement(symbol_116);
		{
			...
			symbol_780.setSignature(symbol_117);
			{
				...
				symbol_781.setActual(symbol_33);	
				symbol_780.getParameterSubstitutions().add(symbol_781);
			}
			symbol_233.getTemplateBindings().add(symbol_780);
		}
		symbol_233.getSuperClasses().add(symbol_243); // $ocl!UniqueCollection[$ocl!Collection{T}?T]
		symbol_233.getSuperClasses().add(symbol_194); // $ocl!NonOrderedCollection[$ocl!Collection{T}?T]
		symbol_130.getOwnedTypes().add(symbol_233);
		//
		// ocl::$$::Set $ocl!Set[$ocl!OrderedSet{T}?T]
		//
		symbol_234.setName("Set");
		//symbol_234.setMoniker("$ocl!Set[$ocl!OrderedSet{T}?T]");
		symbol_234.setElementType(symbol_101);
		symbol_234.setUnspecializedElement(symbol_116);
		{
			...
			symbol_782.setSignature(symbol_117);
			{
				...
				symbol_783.setActual(symbol_101);	
				symbol_782.getParameterSubstitutions().add(symbol_783);
			}
			symbol_234.getTemplateBindings().add(symbol_782);
		}
		symbol_234.getSuperClasses().add(symbol_247); // $ocl!UniqueCollection[$ocl!OrderedSet{T}?T]
		symbol_234.getSuperClasses().add(symbol_192); // $ocl!NonOrderedCollection[$ocl!OrderedSet{T}?T]
		...
		symbol_235.getSuperClasses().add(symbol_188); // $ocl!NonOrderedCollection[$ocl!OclSelf]
		symbol_235.getSuperClasses().add(symbol_240); // $ocl!UniqueCollection[$ocl!OclSelf]
		symbol_130.getOwnedTypes().add(symbol_235);
		//
		// ocl::$$::Set $ocl!Set[$ocl!Set{T}!flatten{T2}()?T2]
		//
		symbol_236.setName("Set");
		//symbol_236.setMoniker("$ocl!Set[$ocl!Set{T}!flatten{T2}()?T2]");
		symbol_236.setElementType(symbol_122);
		symbol_236.setUnspecializedElement(symbol_116);
		{
			...
			symbol_786.setSignature(symbol_117);
			{
				...
				symbol_787.setActual(symbol_122);	
				symbol_786.getParameterSubstitutions().add(symbol_787);
			}
			symbol_236.getTemplateBindings().add(symbol_786);
		}
		symbol_236.getSuperClasses().add(symbol_185); // $ocl!NonOrderedCollection[$ocl!Set{T}!flatten{T2}()?T2]
		symbol_236.getSuperClasses().add(symbol_244); // $ocl!UniqueCollection[$ocl!Set{T}!flatten{T2}()?T2]
		...
		//symbol_240.setMoniker("$ocl!UniqueCollection[$ocl!OclSelf]");
		symbol_240.setElementType(symbol_84);
		symbol_240.setUnspecializedElement(symbol_125);
		{
			...
			symbol_788.setSignature(symbol_126);
			{
				...
				symbol_789.setActual(symbol_84);	
				symbol_788.getParameterSubstitutions().add(symbol_789);
			}
			symbol_240.getTemplateBindings().add(symbol_788);
		}
		symbol_240.getSuperClasses().add(symbol_160); // $ocl!Collection[$ocl!OclSelf]
		...
		//symbol_241.setMoniker("$ocl!UniqueCollection[$ocl!NonOrderedCollection{T}?T]");
		symbol_241.setElementType(symbol_60);
		symbol_241.setUnspecializedElement(symbol_125);
		{
			...
			symbol_790.setSignature(symbol_126);
			{
				...
				symbol_791.setActual(symbol_60);	
				symbol_790.getParameterSubstitutions().add(symbol_791);
			}
			symbol_241.getTemplateBindings().add(symbol_790);
		}
		symbol_241.getSuperClasses().add(symbol_147); // $ocl!Collection[$ocl!NonOrderedCollection{T}?T]
		...
		//symbol_242.setMoniker("$ocl!UniqueCollection[$ocl!Set{T}?T]");
		symbol_242.setElementType(symbol_119);
		symbol_242.setUnspecializedElement(symbol_125);
		{
			...
			symbol_792.setSignature(symbol_126);
			{
				...
				symbol_793.setActual(symbol_119);	
				symbol_792.getParameterSubstitutions().add(symbol_793);
			}
			symbol_242.getTemplateBindings().add(symbol_792);
		}
		symbol_242.getSuperClasses().add(symbol_156); // $ocl!Collection[$ocl!Set{T}?T]
		...
		//symbol_243.setMoniker("$ocl!UniqueCollection[$ocl!Collection{T}?T]");
		symbol_243.setElementType(symbol_33);
		...
		//symbol_244.setMoniker("$ocl!UniqueCollection[$ocl!Set{T}!flatten{T2}()?T2]");
		symbol_244.setElementType(symbol_122);
		symbol_244.setUnspecializedElement(symbol_125);
		{
			...
			symbol_796.setSignature(symbol_126);
			{
				...
				symbol_797.setActual(symbol_122);	
				symbol_796.getParameterSubstitutions().add(symbol_797);
			}
			symbol_244.getTemplateBindings().add(symbol_796);
		}
		symbol_244.getSuperClasses().add(symbol_146); // $ocl!Collection[$ocl!Set{T}!flatten{T2}()?T2]
		...
		//symbol_245.setMoniker("$ocl!UniqueCollection[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]");
		symbol_245.setElementType(symbol_237);
		symbol_245.setUnspecializedElement(symbol_125);
		{
			...
			symbol_798.setSignature(symbol_126);
			{
				...
				symbol_799.setActual(symbol_237);	
				symbol_798.getParameterSubstitutions().add(symbol_799);
			}
			symbol_245.getTemplateBindings().add(symbol_798);
		}
		symbol_245.getSuperClasses().add(symbol_168); // $ocl!Collection[Tuple{first:$ocl!Collection{T}?T,second:$ocl!Collection{T}!product{T2}($ocl!Collection[T2])?T2}]
		...
		//symbol_246.setMoniker("$ocl!UniqueCollection[$ocl!OrderedSet{T}!flatten{T2}()?T2]");
		symbol_246.setElementType(symbol_104);
		symbol_246.setUnspecializedElement(symbol_125);
		{
			...
			symbol_800.setSignature(symbol_126);
			{
				...
				symbol_801.setActual(symbol_104);	
				symbol_800.getParameterSubstitutions().add(symbol_801);
			}
			symbol_246.getTemplateBindings().add(symbol_800);
		}
		symbol_246.getSuperClasses().add(symbol_151); // $ocl!Collection[$ocl!OrderedSet{T}!flatten{T2}()?T2]
		...
		//symbol_247.setMoniker("$ocl!UniqueCollection[$ocl!OrderedSet{T}?T]");
		symbol_247.setElementType(symbol_101);
		symbol_247.setUnspecializedElement(symbol_125);
		{
			...
			symbol_802.setSignature(symbol_126);
			{
				...
				symbol_803.setActual(symbol_101);	
				symbol_802.getParameterSubstitutions().add(symbol_803);
			}
			symbol_247.getTemplateBindings().add(symbol_802);
		}
		symbol_247.getSuperClasses().add(symbol_148); // $ocl!Collection[$ocl!OrderedSet{T}?T]
		...
		//symbol_248.setMoniker("$ocl!UniqueCollection[$ocl!OclAny]");
		symbol_248.setElementType(symbol_71);
		symbol_248.setUnspecializedElement(symbol_125);
		{
			...
			symbol_804.setSignature(symbol_126);
			{
				...
				symbol_805.setActual(symbol_71);	
				symbol_804.getParameterSubstitutions().add(symbol_805);
			}
			symbol_248.getTemplateBindings().add(symbol_804);
		}
		symbol_248.getSuperClasses().add(symbol_163); // $ocl!Collection[$ocl!OclAny]
		...
		//symbol_249.setMoniker("$ocl!UniqueCollection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]");
		symbol_249.setElementType(symbol_140);
		symbol_249.setUnspecializedElement(symbol_125);
		{
			...
			symbol_806.setSignature(symbol_126);
			{
				...
				symbol_807.setActual(symbol_140);	
				symbol_806.getParameterSubstitutions().add(symbol_807);
			}
			symbol_249.getTemplateBindings().add(symbol_806);
		}
		symbol_249.getSuperClasses().add(symbol_150); // $ocl!Collection[$ocl!Classifier[$ocl!Classifier{T}!oclContents{U}()?U]]
		...
		//symbol_250.setMoniker("$ocl!UniqueCollection[$ocl!OrderedCollection{T}?T]");
		symbol_250.setElementType(symbol_91);
		symbol_250.setUnspecializedElement(symbol_125);
		{
			...
			symbol_808.setSignature(symbol_126);
			{
				...
				symbol_809.setActual(symbol_91);	
				symbol_808.getParameterSubstitutions().add(symbol_809);
			}
			symbol_250.getTemplateBindings().add(symbol_808);
		}
		symbol_250.getSuperClasses().add(symbol_167); // $ocl!Collection[$ocl!OrderedCollection{T}?T]
