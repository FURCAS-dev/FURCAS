...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getLambdaKeyword_18()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getTupleKeyword_19()); 
    }
)
    ;
