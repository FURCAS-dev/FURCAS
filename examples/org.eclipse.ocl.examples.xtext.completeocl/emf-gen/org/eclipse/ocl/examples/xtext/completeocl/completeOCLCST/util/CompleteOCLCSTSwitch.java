 ...
 * </copyright>
 *
 * $Id: CompleteOCLCSTSwitch.java,v 1.1 2010/04/13 06:38:27 ewillink Exp $
 */
...
public class CompleteOCLCSTSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CompleteOCLCSTPackage.DOCUMENT_CS: {
				DocumentCS documentCS = (DocumentCS)theEObject;
				T result = caseDocumentCS(documentCS);
				if (result == null) result = caseOclExpressionCS(documentCS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CompleteOCLCSTPackage.IMPORT_CS: {
			...
			case CompleteOCLCSTPackage.OCL_MESSAGE_ARG_CS: {
				...
				if (result == null) result = caseOclExpressionCS(oclMessageArgCS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CompleteOCLCSTPackage.OCL_MESSAGE_CS: {
				...
				if (result == null) result = caseOclExpressionCS(oclMessageCS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
