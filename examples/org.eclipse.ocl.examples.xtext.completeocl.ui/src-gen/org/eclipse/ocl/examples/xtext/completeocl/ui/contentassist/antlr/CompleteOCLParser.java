		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMessageExpCSAccess().getAlternatives(), "rule__MessageExpCS__Alternatives");
					...
					put(grammarAccess.getPreExpCSAccess().getGroup_1(), "rule__PreExpCS__Group_1__0");
					...
					put(grammarAccess.getPreExpCSAccess().getOpAssignment_1_2(), "rule__PreExpCS__OpAssignment_1_2");
