...
/**
 * Entry point of the 'GenerateOCLcommon' generation module.
 *
 * @generated
 */
public class GenerateOclCommon extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateOCLcommon";
	 ...
	 * @generated
	 */
	public GenerateOclCommon(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateOclCommon(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				GenerateOclCommon generator = new GenerateOclCommon(modelURI, folder, arguments);
