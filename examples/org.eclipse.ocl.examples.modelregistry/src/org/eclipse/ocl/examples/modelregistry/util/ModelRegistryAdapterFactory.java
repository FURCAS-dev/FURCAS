...
public class ModelRegistryAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ModelRegistrySwitch<Adapter> modelSwitch =
		new ModelRegistrySwitch<Adapter>() {
			@Override
			public Adapter caseModelRegistration(ModelRegistration object) {
				return createModelRegistrationAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseModelRegistrySettings(ModelRegistrySettings object) {
				return createModelRegistrySettingsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.modelregistry.ModelRegistry <em>Model Registry</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.modelregistry.ModelRegistration <em>Model Registration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.modelregistry.ModelRegistrySettings <em>Settings</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
