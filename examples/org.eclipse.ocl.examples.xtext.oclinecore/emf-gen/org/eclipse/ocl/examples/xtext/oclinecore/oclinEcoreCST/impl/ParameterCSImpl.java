 ...
 * </copyright>
 *
 * $Id: ParameterCSImpl.java,v 1.2 2010/04/16 18:05:31 ewillink Exp $
 */
...
public class ParameterCSImpl extends MinimalEObjectImpl.Container implements ParameterCS {
	...
	public EList<AnnotationElementCS> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<AnnotationElementCS>(AnnotationElementCS.class, this, OCLinEcoreCSTPackage.PARAMETER_CS__ANNOTATIONS);
		}
		return annotations;
	}
