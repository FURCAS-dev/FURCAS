 ...
 * </copyright>
 *
 * $Id: TypeCSImpl.java,v 1.1 2010/04/13 06:44:11 ewillink Exp $
 */
...
public abstract class TypeCSImpl extends MinimalEObjectImpl.Container implements TypeCS {
	...
	public EList<AnnotationCS> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<AnnotationCS>(AnnotationCS.class, this, OCLinEcoreCSTPackage.TYPE_CS__ANNOTATIONS);
		}
		return annotations;
	}
