 ...
 * </copyright>
 *
 * $Id: AttributeCSImpl.java,v 1.1 2010/04/13 06:44:11 ewillink Exp $
 */
...
public class AttributeCSImpl extends MinimalEObjectImpl.Container implements AttributeCS {
	...
	public EList<AnnotationCS> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<AnnotationCS>(AnnotationCS.class, this, OCLinEcoreCSTPackage.ATTRIBUTE_CS__ANNOTATIONS);
		}
		return annotations;
	}
