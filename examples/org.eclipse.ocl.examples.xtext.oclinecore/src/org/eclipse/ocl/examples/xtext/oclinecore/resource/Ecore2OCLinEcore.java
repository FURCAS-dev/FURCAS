...
public class Ecore2OCLinEcore extends AbstractConversion
{
	...
	public static OCLinEcoreDocumentCS importFromEcore(ResourceSet resourceSet, String alias, Resource ecoreResource) {
		...
		Ecore2OCLinEcore converter = new Ecore2OCLinEcore(resourceSet);
		return converter.importResource(ecoreResource, alias);
	}
	...
	public static ModelElementCS importFromEcore(ResourceSet resourceSet, String alias, EObject eObject) {
		...
		Ecore2OCLinEcore converter = new Ecore2OCLinEcore(resourceSet);
		OCLinEcoreDocumentCS importedResource = converter.importResource(ecoreResource, alias);
		if (importedResource ==  null) {
			return null;
		}
		return converter.createMap.get(eObject);
	}
	...
	//					csTypeRef.setSuper(doSwitchAll(eGenericType.getSuper()));
			...
			public void setOriginalMapping(ModelElementCS csModelElement, EObject eModelElement) {
				...
				if (resource instanceof XMLResource) {
					String xmiId = ((XMLResource)resource).getID(eModelElement);
					if (xmiId != null) {
	...
	//				csTypedElement.setUpper(1);
		...
		//				}
			...
			protected ModelElementCSRef copyObjectRef(EObject eObject) {
				...
				ModelElementCS csObject = (ModelElementCS) createMap.get(eObject);
				if (csObject != null) {
		...
		protected OCLinEcoreDocumentCS importResource() {
			...
			OCLinEcoreDocumentCS documentCS = OCLinEcoreCSTFactory.eINSTANCE.createOCLinEcoreDocumentCS();
